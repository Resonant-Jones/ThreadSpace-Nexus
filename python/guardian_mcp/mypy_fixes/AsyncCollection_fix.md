# 🧠 Mypy Fix Guide: `AsyncCollection.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/models/AsyncCollection.py`
**Lines:** `411`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/models/AsyncCollection.py --strict
```

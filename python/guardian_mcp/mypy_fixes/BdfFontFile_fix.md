...
**File:** `.venv/lib/python3.13/site-packages/PIL/BdfFontFile.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/BdfFontFile.py --strict
```

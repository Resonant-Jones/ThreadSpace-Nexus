# 🧠 Mypy Fix Guide: `BlpImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/BlpImagePlugin.py`
**Lines:** `488`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/BlpImagePlugin.py --strict
```

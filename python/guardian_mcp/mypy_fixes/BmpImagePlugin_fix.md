# 🧠 Mypy Fix Guide: `BmpImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/BmpImagePlugin.py`
**Lines:** `489`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/BmpImagePlugin.py --strict
```

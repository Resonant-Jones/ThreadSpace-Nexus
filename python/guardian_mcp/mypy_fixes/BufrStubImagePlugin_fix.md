# 🧠 Mypy Fix Guide: `BufrStubImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/BufrStubImagePlugin.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/BufrStubImagePlugin.py --strict
```

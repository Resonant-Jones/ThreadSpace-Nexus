# 🧠 Mypy Fix Guide: `CollectionCommon.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/models/CollectionCommon.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/models/CollectionCommon.py --strict
```

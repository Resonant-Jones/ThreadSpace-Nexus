...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/models/Collection.py`
**Lines:** `415`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/models/Collection.py --strict
```

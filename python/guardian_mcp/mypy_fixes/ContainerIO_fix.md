...
**File:** `.venv/lib/python3.13/site-packages/PIL/ContainerIO.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ContainerIO.py --strict
```

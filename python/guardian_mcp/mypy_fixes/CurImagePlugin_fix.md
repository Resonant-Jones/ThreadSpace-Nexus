# 🧠 Mypy Fix Guide: `CurImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/CurImagePlugin.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/CurImagePlugin.py --strict
```

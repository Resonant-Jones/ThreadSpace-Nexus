# 🧠 Mypy Fix Guide: `DcxImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/DcxImagePlugin.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/DcxImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `DdsImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/DdsImagePlugin.py`
**Lines:** `575`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/DdsImagePlugin.py --strict
```

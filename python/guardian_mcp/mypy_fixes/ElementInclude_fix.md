# 🧠 Mypy Fix Guide: `ElementInclude.py`
...
**File:** `.venv/lib/python3.13/site-packages/lxml/ElementInclude.py`
**Lines:** `244`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/ElementInclude.py --strict
```

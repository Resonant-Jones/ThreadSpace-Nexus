...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/ElementSoup.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/ElementSoup.py --strict
```

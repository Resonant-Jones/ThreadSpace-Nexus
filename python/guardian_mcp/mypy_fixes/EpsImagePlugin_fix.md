# 🧠 Mypy Fix Guide: `EpsImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/EpsImagePlugin.py`
**Lines:** `478`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/EpsImagePlugin.py --strict
```

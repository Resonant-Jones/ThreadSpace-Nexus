# 🧠 Mypy Fix Guide: `FitsImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/FitsImagePlugin.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/FitsImagePlugin.py --strict
```

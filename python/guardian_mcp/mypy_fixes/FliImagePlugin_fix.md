# 🧠 Mypy Fix Guide: `FliImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/FliImagePlugin.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/FliImagePlugin.py --strict
```

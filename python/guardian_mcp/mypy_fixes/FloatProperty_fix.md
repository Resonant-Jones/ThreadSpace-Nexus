# 🧠 Mypy Fix Guide: `FloatProperty.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/ort_format_model/ort_flatbuffers_py/fbs/FloatProperty.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/ort_format_model/ort_flatbuffers_py/fbs/FloatProperty.py --strict
```

# 🧠 Mypy Fix Guide: `FpxImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/FpxImagePlugin.py`
**Lines:** `255`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/FpxImagePlugin.py --strict
```

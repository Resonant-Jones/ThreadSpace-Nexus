# 🧠 Mypy Fix Guide: `FtexImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/FtexImagePlugin.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/FtexImagePlugin.py --strict
```

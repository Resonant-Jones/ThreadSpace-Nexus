# 🧠 Mypy Fix Guide: `GbrImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/GbrImagePlugin.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/GbrImagePlugin.py --strict
```

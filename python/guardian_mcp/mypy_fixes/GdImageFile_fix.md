...
**File:** `.venv/lib/python3.13/site-packages/PIL/GdImageFile.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/GdImageFile.py --strict
```

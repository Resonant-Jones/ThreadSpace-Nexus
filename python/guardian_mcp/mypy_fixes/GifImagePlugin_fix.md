# 🧠 Mypy Fix Guide: `GifImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/GifImagePlugin.py`
**Lines:** `1159`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/GifImagePlugin.py --strict
```

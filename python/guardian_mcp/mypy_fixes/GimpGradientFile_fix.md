# 🧠 Mypy Fix Guide: `GimpGradientFile.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/GimpGradientFile.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/GimpGradientFile.py --strict
```

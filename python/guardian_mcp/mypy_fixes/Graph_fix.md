...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/graph.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/graph.py --strict
```

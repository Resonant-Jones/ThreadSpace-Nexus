# 🧠 Mypy Fix Guide: `GribStubImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/GribStubImagePlugin.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/GribStubImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `Hdf5StubImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/Hdf5StubImagePlugin.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/Hdf5StubImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `IcnsImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/IcnsImagePlugin.py`
**Lines:** `399`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/IcnsImagePlugin.py --strict
```

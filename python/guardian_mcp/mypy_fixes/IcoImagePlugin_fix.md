# 🧠 Mypy Fix Guide: `IcoImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/IcoImagePlugin.py`
**Lines:** `360`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/IcoImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `ImImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/ImImagePlugin.py`
**Lines:** `374`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ImImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `ImageEnhance.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/ImageEnhance.py`
**Lines:** `107`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ImageEnhance.py --strict
```

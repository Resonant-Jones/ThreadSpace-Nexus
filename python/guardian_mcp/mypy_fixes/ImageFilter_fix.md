...
**File:** `.venv/lib/python3.13/site-packages/PIL/ImageFilter.py`
**Lines:** `604`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ImageFilter.py --strict
```

# 🧠 Mypy Fix Guide: `ImageSequence.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/ImageSequence.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ImageSequence.py --strict
```

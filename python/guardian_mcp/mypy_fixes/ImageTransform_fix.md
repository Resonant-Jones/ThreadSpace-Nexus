# 🧠 Mypy Fix Guide: `ImageTransform.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/ImageTransform.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ImageTransform.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/image.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/image.py --strict
```

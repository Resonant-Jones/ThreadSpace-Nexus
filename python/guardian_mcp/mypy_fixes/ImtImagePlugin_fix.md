# 🧠 Mypy Fix Guide: `ImtImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/ImtImagePlugin.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/ImtImagePlugin.py --strict
```

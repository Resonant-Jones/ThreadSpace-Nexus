# 🧠 Mypy Fix Guide: `IptcImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/IptcImagePlugin.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/IptcImagePlugin.py --strict
```

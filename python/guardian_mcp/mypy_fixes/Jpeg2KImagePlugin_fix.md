# 🧠 Mypy Fix Guide: `Jpeg2KImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/Jpeg2KImagePlugin.py`
**Lines:** `408`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/Jpeg2KImagePlugin.py --strict
```

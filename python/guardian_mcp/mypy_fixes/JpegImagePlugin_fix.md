# 🧠 Mypy Fix Guide: `JpegImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/JpegImagePlugin.py`
**Lines:** `861`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/JpegImagePlugin.py --strict
```

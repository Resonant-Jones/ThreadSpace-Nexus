...
**File:** `.venv/lib/python3.13/site-packages/PIL/JpegPresets.py`
**Lines:** `242`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/JpegPresets.py --strict
```

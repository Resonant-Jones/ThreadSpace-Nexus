# 🧠 Mypy Fix Guide: `McIdasImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/McIdasImagePlugin.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/McIdasImagePlugin.py --strict
```

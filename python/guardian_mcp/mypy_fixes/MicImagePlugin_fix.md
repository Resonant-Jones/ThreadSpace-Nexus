# 🧠 Mypy Fix Guide: `MicImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/MicImagePlugin.py`
**Lines:** `107`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/MicImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `MpegImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/MpegImagePlugin.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/MpegImagePlugin.py --strict
```

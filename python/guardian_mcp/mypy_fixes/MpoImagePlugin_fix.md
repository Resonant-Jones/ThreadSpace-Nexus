# 🧠 Mypy Fix Guide: `MpoImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/MpoImagePlugin.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/MpoImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `MspImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/MspImagePlugin.py`
**Lines:** `200`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/MspImagePlugin.py --strict
```

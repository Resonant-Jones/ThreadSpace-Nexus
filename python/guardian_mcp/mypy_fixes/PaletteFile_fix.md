...
**File:** `.venv/lib/python3.13/site-packages/PIL/PaletteFile.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PaletteFile.py --strict
```

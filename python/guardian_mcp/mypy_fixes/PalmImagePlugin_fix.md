# 🧠 Mypy Fix Guide: `PalmImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PalmImagePlugin.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PalmImagePlugin.py --strict
```

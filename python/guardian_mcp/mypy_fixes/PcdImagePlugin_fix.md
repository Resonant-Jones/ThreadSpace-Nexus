# 🧠 Mypy Fix Guide: `PcdImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PcdImagePlugin.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PcdImagePlugin.py --strict
```

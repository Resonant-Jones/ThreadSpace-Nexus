...
**File:** `.venv/lib/python3.13/site-packages/PIL/PcfFontFile.py`
**Lines:** `254`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PcfFontFile.py --strict
```

# 🧠 Mypy Fix Guide: `PcxImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PcxImagePlugin.py`
**Lines:** `227`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PcxImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `PdfImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PdfImagePlugin.py`
**Lines:** `304`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PdfImagePlugin.py --strict
```

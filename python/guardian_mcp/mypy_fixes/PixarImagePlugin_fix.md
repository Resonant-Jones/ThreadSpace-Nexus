# 🧠 Mypy Fix Guide: `PixarImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PixarImagePlugin.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PixarImagePlugin.py --strict
```

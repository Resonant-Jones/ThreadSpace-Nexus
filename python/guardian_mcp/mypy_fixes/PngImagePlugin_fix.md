# 🧠 Mypy Fix Guide: `PngImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PngImagePlugin.py`
**Lines:** `1489`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PngImagePlugin.py --strict
```

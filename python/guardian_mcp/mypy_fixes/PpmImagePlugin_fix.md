# 🧠 Mypy Fix Guide: `PpmImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PpmImagePlugin.py`
**Lines:** `371`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PpmImagePlugin.py --strict
```

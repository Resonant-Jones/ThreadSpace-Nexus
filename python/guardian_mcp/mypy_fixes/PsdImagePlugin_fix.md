# 🧠 Mypy Fix Guide: `PsdImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/PsdImagePlugin.py`
**Lines:** `326`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/PsdImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `QoiImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/QoiImagePlugin.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/QoiImagePlugin.py --strict
```

# 🧠 Mypy Fix Guide: `SgiImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/SgiImagePlugin.py`
**Lines:** `238`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/SgiImagePlugin.py --strict
```

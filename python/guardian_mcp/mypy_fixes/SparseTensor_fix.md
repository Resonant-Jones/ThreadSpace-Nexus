# 🧠 Mypy Fix Guide: `SparseTensor.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/ort_format_model/ort_flatbuffers_py/fbs/SparseTensor.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/ort_format_model/ort_flatbuffers_py/fbs/SparseTensor.py --strict
```

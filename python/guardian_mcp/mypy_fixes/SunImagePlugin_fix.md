# 🧠 Mypy Fix Guide: `SunImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/SunImagePlugin.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/SunImagePlugin.py --strict
```

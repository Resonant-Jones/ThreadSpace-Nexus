...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/tensor.py`
**Lines:** `5265`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/tensor.py --strict
```

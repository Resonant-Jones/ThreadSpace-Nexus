# 🧠 Mypy Fix Guide: `TgaImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/TgaImagePlugin.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/TgaImagePlugin.py --strict
```

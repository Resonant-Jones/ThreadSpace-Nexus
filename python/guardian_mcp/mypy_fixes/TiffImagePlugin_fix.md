# 🧠 Mypy Fix Guide: `TiffImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/TiffImagePlugin.py`
**Lines:** `2200`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/TiffImagePlugin.py --strict
```

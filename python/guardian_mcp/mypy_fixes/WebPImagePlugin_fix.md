# 🧠 Mypy Fix Guide: `WebPImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/WebPImagePlugin.py`
**Lines:** `363`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/WebPImagePlugin.py --strict
```

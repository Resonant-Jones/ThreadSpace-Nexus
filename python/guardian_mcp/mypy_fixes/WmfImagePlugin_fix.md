# 🧠 Mypy Fix Guide: `WmfImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/WmfImagePlugin.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/WmfImagePlugin.py --strict
```

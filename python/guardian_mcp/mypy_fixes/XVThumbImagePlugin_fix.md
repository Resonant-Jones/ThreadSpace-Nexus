# 🧠 Mypy Fix Guide: `XVThumbImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/XVThumbImagePlugin.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/XVThumbImagePlugin.py --strict
```

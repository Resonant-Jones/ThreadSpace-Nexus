# 🧠 Mypy Fix Guide: `XbmImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/XbmImagePlugin.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/XbmImagePlugin.py --strict
```

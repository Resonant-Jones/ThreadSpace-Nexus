# 🧠 Mypy Fix Guide: `XpmImagePlugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/XpmImagePlugin.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/XpmImagePlugin.py --strict
```

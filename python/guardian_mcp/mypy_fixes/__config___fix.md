...
**File:** `.venv/lib/python3.13/site-packages/numpy/__config__.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/__config__.py --strict
```

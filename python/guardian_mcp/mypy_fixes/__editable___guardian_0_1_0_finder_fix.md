# 🧠 Mypy Fix Guide: `__editable___guardian_0_1_0_finder.py`
...
**File:** `.venv/lib/python3.13/site-packages/__editable___guardian_0_1_0_finder.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/__editable___guardian_0_1_0_finder.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google_auth_oauthlib/tool/__main__.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/google_auth_oauthlib/tool/__main__.py --strict
```

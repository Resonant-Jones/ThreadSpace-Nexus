...
**File:** `.venv/lib/python3.13/site-packages/soupsieve/__meta__.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/soupsieve/__meta__.py --strict
```

# 🧠 Mypy Fix Guide: `__pip-runner__.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/__pip-runner__.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/__pip-runner__.py --strict
```

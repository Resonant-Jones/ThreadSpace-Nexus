...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/__version__.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/__version__.py --strict
```

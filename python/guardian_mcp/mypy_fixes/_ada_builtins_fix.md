# 🧠 Mypy Fix Guide: `_ada_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_ada_builtins.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_ada_builtins.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/importlib_metadata/_adapters.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/importlib_metadata/_adapters.py --strict
```

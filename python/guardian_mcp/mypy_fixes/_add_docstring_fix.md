# 🧠 Mypy Fix Guide: `_add_docstring.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_add_docstring.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_add_docstring.py --strict
```

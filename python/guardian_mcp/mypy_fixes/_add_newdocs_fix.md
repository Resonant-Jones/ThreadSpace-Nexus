# 🧠 Mypy Fix Guide: `_add_newdocs.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_add_newdocs.py`
**Lines:** `6967`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_add_newdocs.py --strict
```

# 🧠 Mypy Fix Guide: `_add_newdocs_scalars.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_add_newdocs_scalars.py`
**Lines:** `390`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_add_newdocs_scalars.py --strict
```

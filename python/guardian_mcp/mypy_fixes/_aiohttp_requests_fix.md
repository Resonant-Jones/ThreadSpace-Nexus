# 🧠 Mypy Fix Guide: `_aiohttp_requests.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/_aiohttp_requests.py`
**Lines:** `398`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/_aiohttp_requests.py --strict
```

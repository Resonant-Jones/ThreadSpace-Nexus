...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/truststore/_api.py`
**Lines:** `333`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/truststore/_api.py --strict
```

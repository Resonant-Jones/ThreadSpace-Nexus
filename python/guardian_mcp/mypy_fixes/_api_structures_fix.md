# 🧠 Mypy Fix Guide: `_api_structures.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_api_structures.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_api_structures.py --strict
```

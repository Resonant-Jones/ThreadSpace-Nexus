# 🧠 Mypy Fix Guide: `_apply_pyprojecttoml.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/config/_apply_pyprojecttoml.py`
**Lines:** `526`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/config/_apply_pyprojecttoml.py --strict
```

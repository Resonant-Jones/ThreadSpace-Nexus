# 🧠 Mypy Fix Guide: `_argcomplete.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/_argcomplete.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/_argcomplete.py --strict
```

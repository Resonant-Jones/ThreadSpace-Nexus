# 🧠 Mypy Fix Guide: `_array_api_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_array_api_info.py`
**Lines:** `346`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_array_api_info.py --strict
```

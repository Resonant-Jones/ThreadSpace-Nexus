...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_array_like.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_array_like.py --strict
```

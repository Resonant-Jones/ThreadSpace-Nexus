# 🧠 Mypy Fix Guide: `_array_utils_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_array_utils_impl.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_array_utils_impl.py --strict
```

# 🧠 Mypy Fix Guide: `_arraypad_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_arraypad_impl.py`
**Lines:** `890`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_arraypad_impl.py --strict
```

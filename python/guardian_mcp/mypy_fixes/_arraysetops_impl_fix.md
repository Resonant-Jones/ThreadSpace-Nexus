# 🧠 Mypy Fix Guide: `_arraysetops_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_arraysetops_impl.py`
**Lines:** `1260`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_arraysetops_impl.py --strict
```

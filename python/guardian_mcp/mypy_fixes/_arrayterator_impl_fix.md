# 🧠 Mypy Fix Guide: `_arrayterator_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_arrayterator_impl.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_arrayterator_impl.py --strict
```

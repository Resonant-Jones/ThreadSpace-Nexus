# 🧠 Mypy Fix Guide: `_arrow_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/arrow/_arrow_utils.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/arrow/_arrow_utils.py --strict
```

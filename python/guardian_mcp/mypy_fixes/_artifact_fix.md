...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_artifact.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_artifact.py --strict
```

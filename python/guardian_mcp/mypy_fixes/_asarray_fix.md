...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_asarray.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_asarray.py --strict
```

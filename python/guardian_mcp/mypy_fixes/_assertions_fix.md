...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_assertions.py`
**Lines:** `974`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_assertions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/streaming/_assistants.py`
**Lines:** `1038`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/streaming/_assistants.py --strict
```

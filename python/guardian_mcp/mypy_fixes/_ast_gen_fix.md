...
**File:** `.venv/lib/python3.13/site-packages/pycparser/_ast_gen.py`
**Lines:** `336`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/_ast_gen.py --strict
```

# 🧠 Mypy Fix Guide: `_asy_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_asy_builtins.py`
**Lines:** `1644`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_asy_builtins.py --strict
```

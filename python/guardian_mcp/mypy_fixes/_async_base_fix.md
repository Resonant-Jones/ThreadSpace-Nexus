...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_async_base.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_async_base.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/grpc_status/_async.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc_status/_async.py --strict
```

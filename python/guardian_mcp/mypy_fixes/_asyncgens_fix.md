...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_asyncgens.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_asyncgens.py --strict
```

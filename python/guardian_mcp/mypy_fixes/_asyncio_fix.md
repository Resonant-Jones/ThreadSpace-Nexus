...
**File:** `.venv/lib/python3.13/site-packages/anyio/_backends/_asyncio.py`
**Lines:** `2816`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_backends/_asyncio.py --strict
```

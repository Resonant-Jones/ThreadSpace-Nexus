# 🧠 Mypy Fix Guide: `_asyncio_selector_thread.py`
...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_asyncio_selector_thread.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_asyncio_selector_thread.py --strict
```

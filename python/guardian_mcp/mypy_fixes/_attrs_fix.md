...
**File:** `.venv/lib/python3.13/site-packages/referencing/_attrs.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/referencing/_attrs.py --strict
```

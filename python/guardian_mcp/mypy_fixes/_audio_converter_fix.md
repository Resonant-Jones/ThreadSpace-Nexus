# 🧠 Mypy Fix Guide: `_audio_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_audio_converter.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_audio_converter.py --strict
```

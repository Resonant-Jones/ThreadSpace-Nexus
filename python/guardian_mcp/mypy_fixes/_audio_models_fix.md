# 🧠 Mypy Fix Guide: `_audio_models.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/audio_models/_audio_models.py`
**Lines:** `3`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/audio_models/_audio_models.py --strict
```

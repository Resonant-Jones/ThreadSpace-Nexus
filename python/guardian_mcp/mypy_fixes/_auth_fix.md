...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_auth.py`
**Lines:** `214`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_auth.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/_backends/_backend.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/_backends/_backend.py --strict
```

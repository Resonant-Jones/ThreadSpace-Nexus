...
**File:** `.venv/lib/python3.13/site-packages/grpc/aio/_base_call.py`
**Lines:** `257`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/aio/_base_call.py --strict
```

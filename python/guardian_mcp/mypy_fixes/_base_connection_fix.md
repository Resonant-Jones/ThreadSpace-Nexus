# 🧠 Mypy Fix Guide: `_base_connection.py`
...
**File:** `.venv/lib/python3.13/site-packages/urllib3/_base_connection.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/urllib3/_base_connection.py --strict
```

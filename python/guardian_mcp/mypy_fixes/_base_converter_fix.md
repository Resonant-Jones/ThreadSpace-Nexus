# 🧠 Mypy Fix Guide: `_base_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/_base_converter.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/_base_converter.py --strict
```

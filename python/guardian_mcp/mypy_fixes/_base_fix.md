...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/serialization/_base.py`
**Lines:** `210`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/serialization/_base.py --strict
```

# 🧠 Mypy Fix Guide: `_base_server.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/aio/_base_server.py`
**Lines:** `385`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/aio/_base_server.py --strict
```

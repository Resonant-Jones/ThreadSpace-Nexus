# 🧠 Mypy Fix Guide: `_bdist_wheel.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/wheel/_bdist_wheel.py`
**Lines:** `613`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/wheel/_bdist_wheel.py --strict
```

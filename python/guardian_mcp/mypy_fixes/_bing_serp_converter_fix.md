# 🧠 Mypy Fix Guide: `_bing_serp_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_bing_serp_converter.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_bing_serp_converter.py --strict
```

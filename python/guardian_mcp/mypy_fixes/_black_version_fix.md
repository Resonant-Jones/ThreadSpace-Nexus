# 🧠 Mypy Fix Guide: `_black_version.py`
...
**File:** `.venv/lib/python3.13/site-packages/_black_version.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/_black_version.py --strict
```

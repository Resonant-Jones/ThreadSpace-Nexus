# 🧠 Mypy Fix Guide: `_browser_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_browser_context.py`
**Lines:** `745`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_browser_context.py --strict
```

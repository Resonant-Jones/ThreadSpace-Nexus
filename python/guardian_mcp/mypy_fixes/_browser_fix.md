...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_browser.py`
**Lines:** `268`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_browser.py --strict
```

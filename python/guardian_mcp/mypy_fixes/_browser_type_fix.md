# 🧠 Mypy Fix Guide: `_browser_type.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_browser_type.py`
**Lines:** `306`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_browser_type.py --strict
```

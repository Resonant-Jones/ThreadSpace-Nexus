# 🧠 Mypy Fix Guide: `_build_autolev_antlr.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/_build_autolev_antlr.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/_build_autolev_antlr.py --strict
```

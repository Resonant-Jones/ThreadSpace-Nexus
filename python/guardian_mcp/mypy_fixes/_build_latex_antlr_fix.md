# 🧠 Mypy Fix Guide: `_build_latex_antlr.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/_build_latex_antlr.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/_build_latex_antlr.py --strict
```

# 🧠 Mypy Fix Guide: `_build_tables.py`
...
**File:** `.venv/lib/python3.13/site-packages/pycparser/_build_tables.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/_build_tables.py --strict
```

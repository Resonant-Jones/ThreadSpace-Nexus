# 🧠 Mypy Fix Guide: `_cache_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_cache_manager.py`
**Lines:** `896`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_cache_manager.py --strict
```

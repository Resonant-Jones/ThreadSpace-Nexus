...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_calamine.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_calamine.py --strict
```

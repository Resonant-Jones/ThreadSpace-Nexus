# 🧠 Mypy Fix Guide: `_cdp_session.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_cdp_session.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_cdp_session.py --strict
```

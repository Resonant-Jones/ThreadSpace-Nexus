# 🧠 Mypy Fix Guide: `_cell_widths.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_cell_widths.py`
**Lines:** `454`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_cell_widths.py --strict
```

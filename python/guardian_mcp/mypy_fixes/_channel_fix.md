...
**File:** `.venv/lib/python3.13/site-packages/grpc/aio/_channel.py`
**Lines:** `627`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/aio/_channel.py --strict
```

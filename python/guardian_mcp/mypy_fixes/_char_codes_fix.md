...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_char_codes.py`
**Lines:** `213`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_char_codes.py --strict
```

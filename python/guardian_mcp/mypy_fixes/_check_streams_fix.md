# 🧠 Mypy Fix Guide: `_check_streams.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_check_streams.py`
**Lines:** `569`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_check_streams.py --strict
```

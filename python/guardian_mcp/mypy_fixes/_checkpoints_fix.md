# 🧠 Mypy Fix Guide: `_checkpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_checkpoints.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_checkpoints.py --strict
```

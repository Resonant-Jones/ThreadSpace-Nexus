# 🧠 Mypy Fix Guide: `_chunk_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_chunk_utils.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_chunk_utils.py --strict
```

# 🧠 Mypy Fix Guide: `_cipheralgorithm.py`
...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/_cipheralgorithm.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/_cipheralgorithm.py --strict
```

# 🧠 Mypy Fix Guide: `_cl_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_cl_builtins.py`
**Lines:** `231`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_cl_builtins.py --strict
```

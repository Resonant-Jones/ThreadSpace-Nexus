...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/_cli_hacks.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/_cli_hacks.py --strict
```

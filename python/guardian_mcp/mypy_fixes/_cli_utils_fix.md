...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/_cli_utils.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/_cli_utils.py --strict
```

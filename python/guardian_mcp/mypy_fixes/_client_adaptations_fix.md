# 🧠 Mypy Fix Guide: `_client_adaptations.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/beta/_client_adaptations.py`
**Lines:** `1015`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/beta/_client_adaptations.py --strict
```

# 🧠 Mypy Fix Guide: `_client_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/_client_async.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/_client_async.py --strict
```

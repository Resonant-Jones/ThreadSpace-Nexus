...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_client.py`
**Lines:** `3474`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_client.py --strict
```

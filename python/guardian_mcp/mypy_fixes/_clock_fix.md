...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_clock.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_clock.py --strict
```

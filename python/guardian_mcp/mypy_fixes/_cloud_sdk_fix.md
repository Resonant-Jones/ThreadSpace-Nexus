...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_cloud_sdk.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_cloud_sdk.py --strict
```

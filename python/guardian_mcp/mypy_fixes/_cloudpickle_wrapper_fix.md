# 🧠 Mypy Fix Guide: `_cloudpickle_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/_cloudpickle_wrapper.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/_cloudpickle_wrapper.py --strict
```

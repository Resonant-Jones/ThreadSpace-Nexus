...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/_cmd.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/_cmd.py --strict
```

# 🧠 Mypy Fix Guide: `_cocoa_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_cocoa_builtins.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_cocoa_builtins.py --strict
```

# 🧠 Mypy Fix Guide: `_collections.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/_collections.py`
**Lines:** `717`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/_collections.py --strict
```

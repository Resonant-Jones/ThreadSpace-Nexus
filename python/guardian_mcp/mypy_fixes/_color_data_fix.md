...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/formats/_color_data.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/formats/_color_data.py --strict
```

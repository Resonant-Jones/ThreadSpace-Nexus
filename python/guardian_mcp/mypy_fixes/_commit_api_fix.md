...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_commit_api.py`
**Lines:** `915`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_commit_api.py --strict
```

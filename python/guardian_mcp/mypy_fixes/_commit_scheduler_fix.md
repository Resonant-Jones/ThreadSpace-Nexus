# 🧠 Mypy Fix Guide: `_commit_scheduler.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_commit_scheduler.py`
**Lines:** `353`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_commit_scheduler.py --strict
```

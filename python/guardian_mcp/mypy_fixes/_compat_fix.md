...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/metadata/importlib/_compat.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/metadata/importlib/_compat.py --strict
```

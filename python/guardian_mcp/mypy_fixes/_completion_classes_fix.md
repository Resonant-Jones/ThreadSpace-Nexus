# 🧠 Mypy Fix Guide: `_completion_classes.py`
...
**File:** `.venv/lib/python3.13/site-packages/typer/_completion_classes.py`
**Lines:** `211`
...
```bash
mypy .venv/lib/python3.13/site-packages/typer/_completion_classes.py --strict
```

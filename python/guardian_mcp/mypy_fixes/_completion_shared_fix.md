# 🧠 Mypy Fix Guide: `_completion_shared.py`
...
**File:** `.venv/lib/python3.13/site-packages/typer/_completion_shared.py`
**Lines:** `240`
...
```bash
mypy .venv/lib/python3.13/site-packages/typer/_completion_shared.py --strict
```

# 🧠 Mypy Fix Guide: `_completions.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/streaming/chat/_completions.py`
**Lines:** `770`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/streaming/chat/_completions.py --strict
```

# 🧠 Mypy Fix Guide: `_compression.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/_compression.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/_compression.py --strict
```

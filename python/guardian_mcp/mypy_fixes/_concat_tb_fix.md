...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_concat_tb.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_concat_tb.py --strict
```

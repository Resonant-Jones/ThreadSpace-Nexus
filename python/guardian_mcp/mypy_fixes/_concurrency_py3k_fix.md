# 🧠 Mypy Fix Guide: `_concurrency_py3k.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/_concurrency_py3k.py`
**Lines:** `288`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/_concurrency_py3k.py --strict
```

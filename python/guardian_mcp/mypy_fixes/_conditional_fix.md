# 🧠 Mypy Fix Guide: `_conditional.py`
...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/bindings/openssl/_conditional.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/bindings/openssl/_conditional.py --strict
```

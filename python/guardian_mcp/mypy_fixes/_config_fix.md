...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_config.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_config.py --strict
```

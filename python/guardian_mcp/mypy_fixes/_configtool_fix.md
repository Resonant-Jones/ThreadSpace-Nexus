...
**File:** `.venv/lib/python3.13/site-packages/numpy/_configtool.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_configtool.py --strict
```

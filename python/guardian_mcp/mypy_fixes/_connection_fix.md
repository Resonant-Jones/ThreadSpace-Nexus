...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_connection.py`
**Lines:** `622`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_connection.py --strict
```

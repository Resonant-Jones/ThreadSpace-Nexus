# 🧠 Mypy Fix Guide: `_console_message.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_console_message.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_console_message.py --strict
```

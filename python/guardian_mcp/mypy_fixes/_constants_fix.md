...
**File:** `.venv/lib/python3.13/site-packages/pandas/compat/_constants.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/compat/_constants.py --strict
```

# 🧠 Mypy Fix Guide: `_context_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/sync_api/_context_manager.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/sync_api/_context_manager.py --strict
```

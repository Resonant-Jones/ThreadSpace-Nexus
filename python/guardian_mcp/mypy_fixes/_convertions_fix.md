# 🧠 Mypy Fix Guide: `_convertions.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_utils/_convertions.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_utils/_convertions.py --strict
```

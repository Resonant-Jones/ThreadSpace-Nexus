# 🧠 Mypy Fix Guide: `_cookie_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_cookie_helpers.py`
**Lines:** `309`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_cookie_helpers.py --strict
```

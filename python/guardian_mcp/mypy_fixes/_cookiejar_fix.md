...
**File:** `.venv/lib/python3.13/site-packages/websocket/_cookiejar.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/websocket/_cookiejar.py --strict
```

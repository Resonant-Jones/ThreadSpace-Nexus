...
**File:** `.venv/lib/python3.13/site-packages/shellingham/posix/_core.py`
**Lines:** `3`
...
```bash
mypy .venv/lib/python3.13/site-packages/shellingham/posix/_core.py --strict
```

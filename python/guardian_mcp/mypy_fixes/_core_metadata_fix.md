# 🧠 Mypy Fix Guide: `_core_metadata.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_core_metadata.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_core_metadata.py --strict
```

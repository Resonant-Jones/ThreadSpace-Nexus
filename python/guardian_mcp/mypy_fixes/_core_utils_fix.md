...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_core_utils.py`
**Lines:** `182`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_core_utils.py --strict
```

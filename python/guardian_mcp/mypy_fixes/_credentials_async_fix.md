# 🧠 Mypy Fix Guide: `_credentials_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/_credentials_async.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/_credentials_async.py --strict
```

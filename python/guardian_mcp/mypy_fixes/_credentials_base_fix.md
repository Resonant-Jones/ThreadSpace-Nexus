# 🧠 Mypy Fix Guide: `_credentials_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_credentials_base.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_credentials_base.py --strict
```

# 🧠 Mypy Fix Guide: `_cryptography_rsa.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/crypt/_cryptography_rsa.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/crypt/_cryptography_rsa.py --strict
```

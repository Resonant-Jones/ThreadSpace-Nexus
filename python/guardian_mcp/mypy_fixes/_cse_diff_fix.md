...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/_cse_diff.py`
**Lines:** `291`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/_cse_diff.py --strict
```

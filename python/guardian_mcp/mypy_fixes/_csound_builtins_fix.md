# 🧠 Mypy Fix Guide: `_csound_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_csound_builtins.py`
**Lines:** `1780`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_csound_builtins.py --strict
```

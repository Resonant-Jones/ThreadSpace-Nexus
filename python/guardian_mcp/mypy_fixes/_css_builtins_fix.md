# 🧠 Mypy Fix Guide: `_css_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_css_builtins.py`
**Lines:** `558`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_css_builtins.py --strict
```

# 🧠 Mypy Fix Guide: `_csv_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_csv_converter.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_csv_converter.py --strict
```

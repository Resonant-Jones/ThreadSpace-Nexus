...
**File:** `.venv/lib/python3.13/site-packages/numpy/ctypeslib/_ctypeslib.py`
**Lines:** `603`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/ctypeslib/_ctypeslib.py --strict
```

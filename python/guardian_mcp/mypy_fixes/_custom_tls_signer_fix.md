# 🧠 Mypy Fix Guide: `_custom_tls_signer.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/_custom_tls_signer.py`
**Lines:** `283`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/_custom_tls_signer.py --strict
```

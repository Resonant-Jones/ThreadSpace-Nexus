...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_datasource.py`
**Lines:** `700`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_datasource.py --strict
```

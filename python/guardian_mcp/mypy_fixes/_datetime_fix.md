...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_datetime.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_datetime.py --strict
```

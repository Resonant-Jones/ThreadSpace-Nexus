...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/serialization/_dduf.py`
**Lines:** `387`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/serialization/_dduf.py --strict
```

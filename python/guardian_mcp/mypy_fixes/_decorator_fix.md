...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/util/_decorator.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/util/_decorator.py --strict
```

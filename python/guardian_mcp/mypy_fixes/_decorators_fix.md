...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_decorators.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_decorators.py --strict
```

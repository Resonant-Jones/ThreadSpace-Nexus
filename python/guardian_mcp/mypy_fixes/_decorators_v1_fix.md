# 🧠 Mypy Fix Guide: `_decorators_v1.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_decorators_v1.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_decorators_v1.py --strict
```

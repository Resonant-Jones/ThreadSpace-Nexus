# 🧠 Mypy Fix Guide: `_default_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_default_async.py`
**Lines:** `282`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_default_async.py --strict
```

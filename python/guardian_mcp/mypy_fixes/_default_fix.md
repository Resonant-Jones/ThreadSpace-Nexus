...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_default.py`
**Lines:** `685`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_default.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/streaming/_deltas.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/streaming/_deltas.py --strict
```

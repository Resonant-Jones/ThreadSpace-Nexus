# 🧠 Mypy Fix Guide: `_deprecation.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_deprecation.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_deprecation.py --strict
```

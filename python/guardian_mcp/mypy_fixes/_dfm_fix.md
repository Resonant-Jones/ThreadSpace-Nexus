...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/_dfm.py`
**Lines:** `951`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/_dfm.py --strict
```

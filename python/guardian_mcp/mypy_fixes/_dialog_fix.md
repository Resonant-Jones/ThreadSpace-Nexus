...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_dialog.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_dialog.py --strict
```

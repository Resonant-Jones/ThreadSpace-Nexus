# 🧠 Mypy Fix Guide: `_diffcommand.py`
...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/_diffcommand.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/_diffcommand.py --strict
```

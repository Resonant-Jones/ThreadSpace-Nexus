...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_discovery.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_discovery.py --strict
```

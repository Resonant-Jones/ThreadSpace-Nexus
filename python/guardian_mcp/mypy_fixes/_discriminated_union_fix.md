# 🧠 Mypy Fix Guide: `_discriminated_union.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_discriminated_union.py`
**Lines:** `479`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_discriminated_union.py --strict
```

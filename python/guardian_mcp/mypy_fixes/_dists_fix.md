...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/metadata/importlib/_dists.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/metadata/importlib/_dists.py --strict
```

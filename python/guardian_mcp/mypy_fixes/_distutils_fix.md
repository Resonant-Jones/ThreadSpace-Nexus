...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/_backends/_distutils.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/_backends/_distutils.py --strict
```

# 🧠 Mypy Fix Guide: `_dml_constructors.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/_dml_constructors.py`
**Lines:** `132`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/_dml_constructors.py --strict
```

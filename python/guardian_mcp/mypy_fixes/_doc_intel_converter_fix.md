# 🧠 Mypy Fix Guide: `_doc_intel_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_doc_intel_converter.py`
**Lines:** `249`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_doc_intel_converter.py --strict
```

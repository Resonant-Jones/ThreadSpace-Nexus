# 🧠 Mypy Fix Guide: `_docs_extraction.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_docs_extraction.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_docs_extraction.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/util/_doctools.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/util/_doctools.py --strict
```

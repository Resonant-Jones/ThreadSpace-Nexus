# 🧠 Mypy Fix Guide: `_docx_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_docx_converter.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_docx_converter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_download.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_download.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_driver.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_driver.py --strict
```

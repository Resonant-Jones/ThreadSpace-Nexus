# 🧠 Mypy Fix Guide: `_dtype_ctypes.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_dtype_ctypes.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_dtype_ctypes.py --strict
```

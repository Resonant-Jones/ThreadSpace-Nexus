...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_dtype.py`
**Lines:** `366`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_dtype.py --strict
```

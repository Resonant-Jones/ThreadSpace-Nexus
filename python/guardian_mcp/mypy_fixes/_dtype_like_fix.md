...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_dtype_like.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_dtype_like.py --strict
```

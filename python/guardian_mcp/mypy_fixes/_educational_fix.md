# 🧠 Mypy Fix Guide: `_educational.py`
...
**File:** `.venv/lib/python3.13/site-packages/tiktoken/_educational.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/tiktoken/_educational.py --strict
```

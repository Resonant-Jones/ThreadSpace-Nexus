# 🧠 Mypy Fix Guide: `_elementpath.py`
...
**File:** `.venv/lib/python3.13/site-packages/lxml/_elementpath.py`
**Lines:** `341`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/_elementpath.py --strict
```

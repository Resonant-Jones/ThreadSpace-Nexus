# 🧠 Mypy Fix Guide: `_elements_constructors.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/_elements_constructors.py`
**Lines:** `1872`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/_elements_constructors.py --strict
```

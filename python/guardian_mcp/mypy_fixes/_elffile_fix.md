...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/_elffile.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/_elffile.py --strict
```

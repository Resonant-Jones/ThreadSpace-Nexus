# 🧠 Mypy Fix Guide: `_emoji_codes.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_emoji_codes.py`
**Lines:** `3610`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_emoji_codes.py --strict
```

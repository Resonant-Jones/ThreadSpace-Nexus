# 🧠 Mypy Fix Guide: `_emoji_replace.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_emoji_replace.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_emoji_replace.py --strict
```

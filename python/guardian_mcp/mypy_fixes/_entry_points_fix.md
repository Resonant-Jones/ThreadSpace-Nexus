# 🧠 Mypy Fix Guide: `_entry_points.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_entry_points.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_entry_points.py --strict
```

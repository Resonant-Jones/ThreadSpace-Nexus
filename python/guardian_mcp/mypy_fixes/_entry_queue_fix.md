# 🧠 Mypy Fix Guide: `_entry_queue.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_entry_queue.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_entry_queue.py --strict
```

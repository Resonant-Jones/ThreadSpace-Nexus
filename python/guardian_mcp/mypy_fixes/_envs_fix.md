...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/metadata/importlib/_envs.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/metadata/importlib/_envs.py --strict
```

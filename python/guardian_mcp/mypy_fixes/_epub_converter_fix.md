# 🧠 Mypy Fix Guide: `_epub_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_epub_converter.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_epub_converter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_errors.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_errors.py --strict
```

# 🧠 Mypy Fix Guide: `_event_context_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_event_context_manager.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_event_context_manager.py --strict
```

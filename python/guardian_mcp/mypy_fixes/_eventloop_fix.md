...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_eventloop.py`
**Lines:** `166`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_eventloop.py --strict
```

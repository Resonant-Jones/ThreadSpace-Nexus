...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/streaming/responses/_events.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/streaming/responses/_events.py --strict
```

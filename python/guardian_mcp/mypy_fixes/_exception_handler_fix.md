# 🧠 Mypy Fix Guide: `_exception_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/starlette/_exception_handler.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/_exception_handler.py --strict
```

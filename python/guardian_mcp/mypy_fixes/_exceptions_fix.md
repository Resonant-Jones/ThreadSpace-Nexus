...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_exceptions.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_exceptions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_exiftool.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_exiftool.py --strict
```

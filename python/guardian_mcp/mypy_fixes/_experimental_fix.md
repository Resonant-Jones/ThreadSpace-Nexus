# 🧠 Mypy Fix Guide: `_experimental.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_experimental.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_experimental.py --strict
```

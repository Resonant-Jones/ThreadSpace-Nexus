# 🧠 Mypy Fix Guide: `_expired_attrs_2_0.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_expired_attrs_2_0.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_expired_attrs_2_0.py --strict
```

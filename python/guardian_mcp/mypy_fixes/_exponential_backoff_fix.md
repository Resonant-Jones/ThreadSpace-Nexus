# 🧠 Mypy Fix Guide: `_exponential_backoff.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_exponential_backoff.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_exponential_backoff.py --strict
```

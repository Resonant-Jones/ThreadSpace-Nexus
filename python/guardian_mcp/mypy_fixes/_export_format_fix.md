# 🧠 Mypy Fix Guide: `_export_format.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_export_format.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_export_format.py --strict
```

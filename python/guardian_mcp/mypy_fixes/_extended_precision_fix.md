# 🧠 Mypy Fix Guide: `_extended_precision.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_extended_precision.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_extended_precision.py --strict
```

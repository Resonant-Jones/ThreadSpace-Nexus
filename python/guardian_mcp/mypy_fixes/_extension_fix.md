...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_extension.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_extension.py --strict
```

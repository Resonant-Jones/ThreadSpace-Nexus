...
**File:** `.venv/lib/python3.13/site-packages/dateutil/tz/_factories.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/dateutil/tz/_factories.py --strict
```

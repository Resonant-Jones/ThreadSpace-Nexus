...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_fake_net.py`
**Lines:** `590`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_fake_net.py --strict
```

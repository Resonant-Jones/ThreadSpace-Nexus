...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_fetch.py`
**Lines:** `546`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_fetch.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_fields.py`
**Lines:** `463`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_fields.py --strict
```

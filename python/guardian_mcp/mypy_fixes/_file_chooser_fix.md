# 🧠 Mypy Fix Guide: `_file_chooser.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_file_chooser.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_file_chooser.py --strict
```

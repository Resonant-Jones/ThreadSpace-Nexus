...
**File:** `.venv/lib/python3.13/site-packages/proto/_file_info.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/_file_info.py --strict
```

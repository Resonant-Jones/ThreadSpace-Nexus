...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_fileio.py`
**Lines:** `742`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_fileio.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_fileno.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_fileno.py --strict
```

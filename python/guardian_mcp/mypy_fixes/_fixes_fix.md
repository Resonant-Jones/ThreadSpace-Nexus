...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_fixes.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_fixes.py --strict
```

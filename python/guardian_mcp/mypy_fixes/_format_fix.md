...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/_format.py`
**Lines:** `521`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/_format.py --strict
```

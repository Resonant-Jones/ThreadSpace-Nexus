# 🧠 Mypy Fix Guide: `_format_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_format_impl.py`
**Lines:** `1036`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_format_impl.py --strict
```

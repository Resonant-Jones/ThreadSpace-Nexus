# 🧠 Mypy Fix Guide: `_forward_ref.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_forward_ref.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_forward_ref.py --strict
```

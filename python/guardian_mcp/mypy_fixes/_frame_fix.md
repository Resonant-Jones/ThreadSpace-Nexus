...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_frame.py`
**Lines:** `807`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_frame.py --strict
```

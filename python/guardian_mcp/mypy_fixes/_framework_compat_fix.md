# 🧠 Mypy Fix Guide: `_framework_compat.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/_framework_compat.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/_framework_compat.py --strict
```

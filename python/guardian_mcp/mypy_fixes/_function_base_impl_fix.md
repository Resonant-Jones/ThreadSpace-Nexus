# 🧠 Mypy Fix Guide: `_function_base_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_function_base_impl.py`
**Lines:** `5842`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_function_base_impl.py --strict
```

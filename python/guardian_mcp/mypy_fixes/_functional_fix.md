...
**File:** `.venv/lib/python3.13/site-packages/importlib_resources/_functional.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/importlib_resources/_functional.py --strict
```

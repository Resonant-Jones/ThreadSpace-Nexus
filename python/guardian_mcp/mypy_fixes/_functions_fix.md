...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_functions.py`
**Lines:** `308`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_functions.py --strict
```

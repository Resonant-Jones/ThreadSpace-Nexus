...
**File:** `.venv/lib/python3.13/site-packages/playwright/sync_api/_generated.py`
**Lines:** `21019`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/sync_api/_generated.py --strict
```

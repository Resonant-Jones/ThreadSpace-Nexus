# 🧠 Mypy Fix Guide: `_generated_instrumentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_generated_instrumentation.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_generated_instrumentation.py --strict
```

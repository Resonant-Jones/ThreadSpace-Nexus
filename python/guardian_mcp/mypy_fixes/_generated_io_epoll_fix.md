# 🧠 Mypy Fix Guide: `_generated_io_epoll.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_generated_io_epoll.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_generated_io_epoll.py --strict
```

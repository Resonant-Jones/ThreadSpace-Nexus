# 🧠 Mypy Fix Guide: `_generated_io_kqueue.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_generated_io_kqueue.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_generated_io_kqueue.py --strict
```

# 🧠 Mypy Fix Guide: `_generated_io_windows.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_generated_io_windows.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_generated_io_windows.py --strict
```

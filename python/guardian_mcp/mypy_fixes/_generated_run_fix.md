# 🧠 Mypy Fix Guide: `_generated_run.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_generated_run.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_generated_run.py --strict
```

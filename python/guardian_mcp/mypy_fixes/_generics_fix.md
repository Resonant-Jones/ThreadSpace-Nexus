...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_generics.py`
**Lines:** `547`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_generics.py --strict
```

# 🧠 Mypy Fix Guide: `_git_credential.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_git_credential.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_git_credential.py --strict
```

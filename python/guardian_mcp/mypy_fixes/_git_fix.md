...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_git.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_git.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_glob.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_glob.py --strict
```

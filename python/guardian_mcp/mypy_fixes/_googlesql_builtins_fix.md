# 🧠 Mypy Fix Guide: `_googlesql_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_googlesql_builtins.py`
**Lines:** `918`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_googlesql_builtins.py --strict
```

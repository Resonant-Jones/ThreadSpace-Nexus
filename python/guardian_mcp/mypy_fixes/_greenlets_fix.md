...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_greenlets.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_greenlets.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/websocket/_handshake.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/websocket/_handshake.py --strict
```

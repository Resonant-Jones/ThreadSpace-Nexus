...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_har_router.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_har_router.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/_has_cy.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/_has_cy.py --strict
```

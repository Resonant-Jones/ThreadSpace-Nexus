# 🧠 Mypy Fix Guide: `_header_properties.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/properties/_header_properties.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/properties/_header_properties.py --strict
```

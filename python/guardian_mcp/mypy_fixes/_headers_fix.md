...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_headers.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_headers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_helper.py`
**Lines:** `523`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_helper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/auth/aio/_helpers.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/aio/_helpers.py --strict
```

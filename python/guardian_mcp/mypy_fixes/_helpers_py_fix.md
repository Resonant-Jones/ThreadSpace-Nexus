...
**File:** `.venv/lib/python3.13/site-packages/propcache/_helpers_py.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/propcache/_helpers_py.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_hf_folder.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_hf_folder.py --strict
```

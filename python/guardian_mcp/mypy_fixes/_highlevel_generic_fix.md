# 🧠 Mypy Fix Guide: `_highlevel_generic.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_generic.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_generic.py --strict
```

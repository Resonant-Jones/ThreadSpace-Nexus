# 🧠 Mypy Fix Guide: `_highlevel_open_tcp_listeners.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_open_tcp_listeners.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_open_tcp_listeners.py --strict
```

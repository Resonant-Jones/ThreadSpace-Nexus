# 🧠 Mypy Fix Guide: `_highlevel_open_tcp_stream.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_open_tcp_stream.py`
**Lines:** `405`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_open_tcp_stream.py --strict
```

# 🧠 Mypy Fix Guide: `_highlevel_open_unix_stream.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_open_unix_stream.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_open_unix_stream.py --strict
```

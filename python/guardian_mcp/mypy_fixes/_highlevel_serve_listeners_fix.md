# 🧠 Mypy Fix Guide: `_highlevel_serve_listeners.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_serve_listeners.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_serve_listeners.py --strict
```

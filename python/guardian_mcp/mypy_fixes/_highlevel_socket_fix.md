# 🧠 Mypy Fix Guide: `_highlevel_socket.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_socket.py`
**Lines:** `414`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_socket.py --strict
```

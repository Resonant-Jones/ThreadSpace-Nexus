# 🧠 Mypy Fix Guide: `_highlevel_ssl_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_highlevel_ssl_helpers.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_highlevel_ssl_helpers.py --strict
```

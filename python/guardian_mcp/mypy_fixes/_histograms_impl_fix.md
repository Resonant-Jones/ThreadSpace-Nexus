# 🧠 Mypy Fix Guide: `_histograms_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_histograms_impl.py`
**Lines:** `1085`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_histograms_impl.py --strict
```

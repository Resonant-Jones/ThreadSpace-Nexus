# 🧠 Mypy Fix Guide: `_html5builder.py`
...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/_html5builder.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/_html5builder.py --strict
```

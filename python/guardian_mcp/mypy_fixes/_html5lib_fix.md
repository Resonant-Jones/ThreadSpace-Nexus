...
**File:** `.venv/lib/python3.13/site-packages/bs4/builder/_html5lib.py`
**Lines:** `594`
...
```bash
mypy .venv/lib/python3.13/site-packages/bs4/builder/_html5lib.py --strict
```

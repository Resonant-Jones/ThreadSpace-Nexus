# 🧠 Mypy Fix Guide: `_html_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_html_converter.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_html_converter.py --strict
```

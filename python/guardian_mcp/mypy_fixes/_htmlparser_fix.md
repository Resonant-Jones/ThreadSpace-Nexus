...
**File:** `.venv/lib/python3.13/site-packages/bs4/builder/_htmlparser.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/bs4/builder/_htmlparser.py --strict
```

# 🧠 Mypy Fix Guide: `_http_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/_http_client.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/_http_client.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_http.py`
**Lines:** `637`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_http.py --strict
```

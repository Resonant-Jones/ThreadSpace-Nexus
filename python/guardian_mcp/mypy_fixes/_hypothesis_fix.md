...
**File:** `.venv/lib/python3.13/site-packages/pandas/_testing/_hypothesis.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_testing/_hypothesis.py --strict
```

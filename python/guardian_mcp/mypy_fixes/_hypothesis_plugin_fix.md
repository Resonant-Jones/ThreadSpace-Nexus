# 🧠 Mypy Fix Guide: `_hypothesis_plugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/_hypothesis_plugin.py`
**Lines:** `391`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/_hypothesis_plugin.py --strict
```

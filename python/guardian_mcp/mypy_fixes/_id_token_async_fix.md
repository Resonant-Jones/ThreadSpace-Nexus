# 🧠 Mypy Fix Guide: `_id_token_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/_id_token_async.py`
**Lines:** `285`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/_id_token_async.py --strict
```

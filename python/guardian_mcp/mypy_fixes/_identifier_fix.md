...
**File:** `.venv/lib/python3.13/site-packages/jinja2/_identifier.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/jinja2/_identifier.py --strict
```

# 🧠 Mypy Fix Guide: `_image_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_image_converter.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_image_converter.py --strict
```

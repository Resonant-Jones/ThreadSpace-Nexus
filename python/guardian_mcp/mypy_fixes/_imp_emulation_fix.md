# 🧠 Mypy Fix Guide: `_imp_emulation.py`
...
**File:** `.venv/lib/python3.13/site-packages/cffi/_imp_emulation.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/_imp_emulation.py --strict
```

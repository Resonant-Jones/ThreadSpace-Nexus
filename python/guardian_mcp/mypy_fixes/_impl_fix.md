...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pyproject_hooks/_impl.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pyproject_hooks/_impl.py --strict
```

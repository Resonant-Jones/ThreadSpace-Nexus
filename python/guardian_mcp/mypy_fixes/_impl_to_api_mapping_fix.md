# 🧠 Mypy Fix Guide: `_impl_to_api_mapping.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_impl_to_api_mapping.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_impl_to_api_mapping.py --strict
```

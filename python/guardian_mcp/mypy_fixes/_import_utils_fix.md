# 🧠 Mypy Fix Guide: `_import_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_import_utils.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_import_utils.py --strict
```

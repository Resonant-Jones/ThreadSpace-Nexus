...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_importhook.py`
**Lines:** `213`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_importhook.py --strict
```

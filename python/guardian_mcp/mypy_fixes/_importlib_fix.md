...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_importlib.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_importlib.py --strict
```

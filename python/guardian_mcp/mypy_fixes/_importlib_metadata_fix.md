# 🧠 Mypy Fix Guide: `_importlib_metadata.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/util/_importlib_metadata.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/util/_importlib_metadata.py --strict
```

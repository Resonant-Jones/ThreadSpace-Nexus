# 🧠 Mypy Fix Guide: `_index_tricks_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_index_tricks_impl.py`
**Lines:** `1067`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_index_tricks_impl.py --strict
```

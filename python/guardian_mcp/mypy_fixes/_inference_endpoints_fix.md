# 🧠 Mypy Fix Guide: `_inference_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_inference_endpoints.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_inference_endpoints.py --strict
```

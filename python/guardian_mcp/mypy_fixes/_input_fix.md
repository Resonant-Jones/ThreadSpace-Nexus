...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_input.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_input.py --strict
```

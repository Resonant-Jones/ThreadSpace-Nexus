...
**File:** `.venv/lib/python3.13/site-packages/numpy/_utils/_inspect.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_utils/_inspect.py --strict
```

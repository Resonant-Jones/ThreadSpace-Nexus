# 🧠 Mypy Fix Guide: `_instrumentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_instrumentation.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_instrumentation.py --strict
```

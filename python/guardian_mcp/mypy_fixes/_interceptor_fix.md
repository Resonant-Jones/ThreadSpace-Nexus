# 🧠 Mypy Fix Guide: `_interceptor.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/aio/_interceptor.py`
**Lines:** `1178`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/aio/_interceptor.py --strict
```

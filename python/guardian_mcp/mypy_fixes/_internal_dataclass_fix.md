# 🧠 Mypy Fix Guide: `_internal_dataclass.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_internal_dataclass.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_internal_dataclass.py --strict
```

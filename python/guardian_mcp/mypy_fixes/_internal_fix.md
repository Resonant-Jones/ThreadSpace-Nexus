...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_internal.py`
**Lines:** `958`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_internal.py --strict
```

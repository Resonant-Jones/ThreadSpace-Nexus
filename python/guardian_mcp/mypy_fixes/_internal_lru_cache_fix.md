# 🧠 Mypy Fix Guide: `_internal_lru_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/_internal_lru_cache.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/_internal_lru_cache.py --strict
```

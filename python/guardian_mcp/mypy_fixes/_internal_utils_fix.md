# 🧠 Mypy Fix Guide: `_internal_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/requests/_internal_utils.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/requests/_internal_utils.py --strict
```

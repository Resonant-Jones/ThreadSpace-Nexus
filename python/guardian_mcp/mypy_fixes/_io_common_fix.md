...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_io_common.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_io_common.py --strict
```

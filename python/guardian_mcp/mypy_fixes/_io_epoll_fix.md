...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_io_epoll.py`
**Lines:** `387`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_io_epoll.py --strict
```

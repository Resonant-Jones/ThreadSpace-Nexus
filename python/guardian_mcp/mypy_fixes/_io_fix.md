...
**File:** `.venv/lib/python3.13/site-packages/pandas/_testing/_io.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_testing/_io.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_io_kqueue.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_io_kqueue.py --strict
```

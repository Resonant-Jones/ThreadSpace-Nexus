...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_io_windows.py`
**Lines:** `1042`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_io_windows.py --strict
```

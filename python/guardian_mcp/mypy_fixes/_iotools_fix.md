...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_iotools.py`
**Lines:** `900`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_iotools.py --strict
```

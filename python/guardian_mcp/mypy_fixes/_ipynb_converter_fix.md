# 🧠 Mypy Fix Guide: `_ipynb_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_ipynb_converter.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_ipynb_converter.py --strict
```

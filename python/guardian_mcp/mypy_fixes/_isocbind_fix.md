...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/_isocbind.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/_isocbind.py --strict
```

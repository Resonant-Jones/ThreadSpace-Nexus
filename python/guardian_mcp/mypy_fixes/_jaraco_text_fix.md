# 🧠 Mypy Fix Guide: `_jaraco_text.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/_jaraco_text.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/_jaraco_text.py --strict
```

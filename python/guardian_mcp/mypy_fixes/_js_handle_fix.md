...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_js_handle.py`
**Lines:** `323`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_js_handle.py --strict
```

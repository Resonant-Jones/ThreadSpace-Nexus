...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/metadata/_json.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/metadata/_json.py --strict
```

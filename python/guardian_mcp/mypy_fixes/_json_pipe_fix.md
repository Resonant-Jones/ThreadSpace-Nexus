...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_json_pipe.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_json_pipe.py --strict
```

# 🧠 Mypy Fix Guide: `_julia_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_julia_builtins.py`
**Lines:** `411`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_julia_builtins.py --strict
```

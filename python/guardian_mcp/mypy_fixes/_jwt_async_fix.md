...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_jwt_async.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_jwt_async.py --strict
```

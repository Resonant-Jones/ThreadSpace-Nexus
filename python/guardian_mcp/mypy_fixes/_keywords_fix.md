...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/_keywords.py`
**Lines:** `449`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/_keywords.py --strict
```

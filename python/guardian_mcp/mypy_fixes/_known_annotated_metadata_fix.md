# 🧠 Mypy Fix Guide: `_known_annotated_metadata.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_known_annotated_metadata.py`
**Lines:** `393`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_known_annotated_metadata.py --strict
```

# 🧠 Mypy Fix Guide: `_lasso_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_lasso_builtins.py`
**Lines:** `5326`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_lasso_builtins.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/_ld_preload.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/_ld_preload.py --strict
```

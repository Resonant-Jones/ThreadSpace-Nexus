# 🧠 Mypy Fix Guide: `_legacy_keywords.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/_legacy_keywords.py`
**Lines:** `449`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/_legacy_keywords.py --strict
```

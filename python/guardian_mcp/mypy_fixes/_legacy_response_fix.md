# 🧠 Mypy Fix Guide: `_legacy_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/_legacy_response.py`
**Lines:** `488`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_legacy_response.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_lfs.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_lfs.py --strict
```

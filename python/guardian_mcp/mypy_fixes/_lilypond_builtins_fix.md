# 🧠 Mypy Fix Guide: `_lilypond_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_lilypond_builtins.py`
**Lines:** `4932`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_lilypond_builtins.py --strict
```

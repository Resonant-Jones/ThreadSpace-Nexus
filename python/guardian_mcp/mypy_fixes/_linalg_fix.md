...
**File:** `.venv/lib/python3.13/site-packages/numpy/linalg/_linalg.py`
**Lines:** `3681`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/linalg/_linalg.py --strict
```

# 🧠 Mypy Fix Guide: `_lint_dependency_groups.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/dependency_groups/_lint_dependency_groups.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/dependency_groups/_lint_dependency_groups.py --strict
```

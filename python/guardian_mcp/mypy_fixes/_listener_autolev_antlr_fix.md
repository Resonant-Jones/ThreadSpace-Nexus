# 🧠 Mypy Fix Guide: `_listener_autolev_antlr.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/_listener_autolev_antlr.py`
**Lines:** `2083`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/_listener_autolev_antlr.py --strict
```

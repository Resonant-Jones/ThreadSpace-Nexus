# 🧠 Mypy Fix Guide: `_llm_caption.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_llm_caption.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_llm_caption.py --strict
```

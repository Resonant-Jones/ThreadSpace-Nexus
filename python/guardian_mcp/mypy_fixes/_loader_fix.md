...
**File:** `.venv/lib/python3.13/site-packages/pydantic/plugin/_loader.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/plugin/_loader.py --strict
```

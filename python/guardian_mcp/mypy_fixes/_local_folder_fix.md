# 🧠 Mypy Fix Guide: `_local_folder.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_local_folder.py`
**Lines:** `441`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_local_folder.py --strict
```

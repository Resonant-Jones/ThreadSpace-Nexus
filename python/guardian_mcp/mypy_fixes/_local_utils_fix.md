# 🧠 Mypy Fix Guide: `_local_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_local_utils.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_local_utils.py --strict
```

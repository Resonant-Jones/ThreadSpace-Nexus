...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_locator.py`
**Lines:** `936`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_locator.py --strict
```

# 🧠 Mypy Fix Guide: `_log_encoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/exporter/otlp/proto/common/_log_encoder.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/exporter/otlp/proto/common/_log_encoder.py --strict
```

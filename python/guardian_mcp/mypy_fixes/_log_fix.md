...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/_log.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/_log.py --strict
```

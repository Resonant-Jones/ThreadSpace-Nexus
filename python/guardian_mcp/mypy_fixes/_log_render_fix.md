...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_log_render.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_log_render.py --strict
```

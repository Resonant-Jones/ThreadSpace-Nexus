...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_login.py`
**Lines:** `520`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_login.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/_utils/_logs.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_utils/_logs.py --strict
```

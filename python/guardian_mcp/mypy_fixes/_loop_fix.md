...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_loop.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_loop.py --strict
```

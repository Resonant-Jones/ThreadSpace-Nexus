# 🧠 Mypy Fix Guide: `_lua_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_lua_builtins.py`
**Lines:** `285`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_lua_builtins.py --strict
```

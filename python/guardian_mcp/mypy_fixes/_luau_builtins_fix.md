# 🧠 Mypy Fix Guide: `_luau_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_luau_builtins.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_luau_builtins.py --strict
```

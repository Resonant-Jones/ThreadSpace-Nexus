...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_machar.py`
**Lines:** `355`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_machar.py --strict
```

# 🧠 Mypy Fix Guide: `_macos_compat.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/_macos_compat.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/_macos_compat.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/truststore/_macos.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/truststore/_macos.py --strict
```

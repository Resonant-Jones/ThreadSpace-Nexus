...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/_manylinux.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/_manylinux.py --strict
```

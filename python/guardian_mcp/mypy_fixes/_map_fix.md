...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_map.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_map.py --strict
```

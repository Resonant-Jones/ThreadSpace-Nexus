...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/_mapping.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/_mapping.py --strict
```

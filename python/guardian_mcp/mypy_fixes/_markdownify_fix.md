# 🧠 Mypy Fix Guide: `_markdownify.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_markdownify.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_markdownify.py --strict
```

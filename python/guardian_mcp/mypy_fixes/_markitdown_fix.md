...
**File:** `.venv/lib/python3.13/site-packages/markitdown/_markitdown.py`
**Lines:** `771`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/_markitdown.py --strict
```

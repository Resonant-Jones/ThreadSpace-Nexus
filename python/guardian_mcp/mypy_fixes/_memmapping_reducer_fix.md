# 🧠 Mypy Fix Guide: `_memmapping_reducer.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/_memmapping_reducer.py`
**Lines:** `715`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/_memmapping_reducer.py --strict
```

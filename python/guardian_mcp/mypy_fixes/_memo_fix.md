...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_memo.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_memo.py --strict
```

# 🧠 Mypy Fix Guide: `_memory_streams.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_memory_streams.py`
**Lines:** `637`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_memory_streams.py --strict
```

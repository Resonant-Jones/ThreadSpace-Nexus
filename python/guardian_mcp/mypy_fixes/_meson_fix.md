...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/_backends/_meson.py`
**Lines:** `231`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/_backends/_meson.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/importlib_metadata/_meta.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/importlib_metadata/_meta.py --strict
```

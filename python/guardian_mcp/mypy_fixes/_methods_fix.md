...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_methods.py`
**Lines:** `255`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_methods.py --strict
```

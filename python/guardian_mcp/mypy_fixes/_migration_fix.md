...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_migration.py`
**Lines:** `308`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_migration.py --strict
```

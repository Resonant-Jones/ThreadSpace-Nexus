...
**File:** `.venv/lib/python3.13/site-packages/pandas/plotting/_misc.py`
**Lines:** `688`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/plotting/_misc.py --strict
```

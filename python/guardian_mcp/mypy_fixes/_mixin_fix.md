...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/biomechanics/_mixin.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/biomechanics/_mixin.py --strict
```

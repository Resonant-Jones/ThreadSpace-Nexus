...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/_mixins.py`
**Lines:** `544`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/_mixins.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_mock_clock.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_mock_clock.py --strict
```

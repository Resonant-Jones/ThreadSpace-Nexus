...
**File:** `.venv/lib/python3.13/site-packages/openai/cli/_models.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/cli/_models.py --strict
```

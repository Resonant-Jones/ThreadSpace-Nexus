...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/_modified.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/_modified.py --strict
```

# 🧠 Mypy Fix Guide: `_mql_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_mql_builtins.py`
**Lines:** `1171`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_mql_builtins.py --strict
```

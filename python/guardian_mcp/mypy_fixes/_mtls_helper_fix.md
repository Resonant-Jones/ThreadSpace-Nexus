# 🧠 Mypy Fix Guide: `_mtls_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/_mtls_helper.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/_mtls_helper.py --strict
```

# 🧠 Mypy Fix Guide: `_multiarray_umath.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/core/_multiarray_umath.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/core/_multiarray_umath.py --strict
```

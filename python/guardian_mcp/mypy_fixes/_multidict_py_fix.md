# 🧠 Mypy Fix Guide: `_multidict_py.py`
...
**File:** `.venv/lib/python3.13/site-packages/multidict/_multidict_py.py`
**Lines:** `947`
...
```bash
mypy .venv/lib/python3.13/site-packages/multidict/_multidict_py.py --strict
```

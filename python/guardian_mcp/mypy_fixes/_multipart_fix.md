...
**File:** `.venv/lib/python3.13/site-packages/httpx/_multipart.py`
**Lines:** `300`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpx/_multipart.py --strict
```

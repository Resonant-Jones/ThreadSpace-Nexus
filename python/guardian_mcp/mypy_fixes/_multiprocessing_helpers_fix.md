# 🧠 Mypy Fix Guide: `_multiprocessing_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/_multiprocessing_helpers.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/_multiprocessing_helpers.py --strict
```

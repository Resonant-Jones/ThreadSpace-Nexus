...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/_musllinux.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/_musllinux.py --strict
```

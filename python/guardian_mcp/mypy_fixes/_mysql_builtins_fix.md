# 🧠 Mypy Fix Guide: `_mysql_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_mysql_builtins.py`
**Lines:** `1335`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_mysql_builtins.py --strict
```

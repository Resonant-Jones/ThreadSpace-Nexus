# 🧠 Mypy Fix Guide: `_nanfunctions_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_nanfunctions_impl.py`
**Lines:** `2024`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_nanfunctions_impl.py --strict
```

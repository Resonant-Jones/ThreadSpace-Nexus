...
**File:** `.venv/lib/python3.13/site-packages/markupsafe/_native.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/markupsafe/_native.py --strict
```

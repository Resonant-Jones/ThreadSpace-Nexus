# 🧠 Mypy Fix Guide: `_navigator_properties.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/properties/_navigator_properties.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/properties/_navigator_properties.py --strict
```

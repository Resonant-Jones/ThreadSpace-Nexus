...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_nbit_base.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_nbit_base.py --strict
```

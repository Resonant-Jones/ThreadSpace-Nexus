...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_nbit.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_nbit.py --strict
```

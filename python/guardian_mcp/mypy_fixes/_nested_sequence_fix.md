# 🧠 Mypy Fix Guide: `_nested_sequence.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_nested_sequence.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_nested_sequence.py --strict
```

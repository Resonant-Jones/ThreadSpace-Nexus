...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_network.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_network.py --strict
```

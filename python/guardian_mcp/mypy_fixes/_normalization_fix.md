# 🧠 Mypy Fix Guide: `_normalization.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_normalization.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_normalization.py --strict
```

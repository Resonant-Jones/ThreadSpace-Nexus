...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/json/_normalize.py`
**Lines:** `544`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/json/_normalize.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_null_file.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_null_file.py --strict
```

# 🧠 Mypy Fix Guide: `_oauth2client.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_oauth2client.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_oauth2client.py --strict
```

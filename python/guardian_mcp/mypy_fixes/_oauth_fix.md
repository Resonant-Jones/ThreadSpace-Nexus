...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_oauth.py`
**Lines:** `464`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_oauth.py --strict
```

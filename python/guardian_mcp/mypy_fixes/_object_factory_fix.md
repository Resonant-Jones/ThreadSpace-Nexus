# 🧠 Mypy Fix Guide: `_object_factory.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_object_factory.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_object_factory.py --strict
```

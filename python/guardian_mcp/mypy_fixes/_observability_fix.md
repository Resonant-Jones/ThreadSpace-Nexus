# 🧠 Mypy Fix Guide: `_observability.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/_observability.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/_observability.py --strict
```

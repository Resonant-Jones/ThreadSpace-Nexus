...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_odfreader.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_odfreader.py --strict
```

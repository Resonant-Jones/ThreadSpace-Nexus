...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_odswriter.py`
**Lines:** `357`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_odswriter.py --strict
```

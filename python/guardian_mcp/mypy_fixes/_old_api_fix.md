...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/_old_api.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/_old_api.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/util/_once.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/util/_once.py --strict
```

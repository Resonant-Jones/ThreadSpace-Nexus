# 🧠 Mypy Fix Guide: `_openedge_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_openedge_builtins.py`
**Lines:** `2600`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_openedge_builtins.py --strict
```

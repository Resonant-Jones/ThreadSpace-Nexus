...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_openpyxl.py`
**Lines:** `639`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_openpyxl.py --strict
```

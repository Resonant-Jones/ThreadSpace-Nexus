...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/truststore/_openssl.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/truststore/_openssl.py --strict
```

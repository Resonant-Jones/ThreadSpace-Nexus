...
**File:** `.venv/lib/python3.13/site-packages/pandas/compat/_optional.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/compat/_optional.py --strict
```

# 🧠 Mypy Fix Guide: `_orm_constructors.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/_orm_constructors.py`
**Lines:** `2590`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/_orm_constructors.py --strict
```

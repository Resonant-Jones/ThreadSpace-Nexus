...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/_orm_types.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/_orm_types.py --strict
```

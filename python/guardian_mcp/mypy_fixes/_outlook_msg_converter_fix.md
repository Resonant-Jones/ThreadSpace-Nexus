# 🧠 Mypy Fix Guide: `_outlook_msg_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_outlook_msg_converter.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_outlook_msg_converter.py --strict
```

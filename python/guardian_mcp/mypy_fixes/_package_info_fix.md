# 🧠 Mypy Fix Guide: `_package_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/proto/_package_info.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/_package_info.py --strict
```

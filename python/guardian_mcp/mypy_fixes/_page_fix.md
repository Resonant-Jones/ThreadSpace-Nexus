...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_page.py`
**Lines:** `1492`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_page.py --strict
```

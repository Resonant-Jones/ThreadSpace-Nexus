...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_pagination.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_pagination.py --strict
```

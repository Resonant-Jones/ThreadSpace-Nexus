...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_palettes.py`
**Lines:** `309`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_palettes.py --strict
```

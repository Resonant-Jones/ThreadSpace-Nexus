# 🧠 Mypy Fix Guide: `_parameterized.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/_parameterized.py`
**Lines:** `420`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/_parameterized.py --strict
```

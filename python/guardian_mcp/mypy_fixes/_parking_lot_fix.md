# 🧠 Mypy Fix Guide: `_parking_lot.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_parking_lot.py`
**Lines:** `317`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_parking_lot.py --strict
```

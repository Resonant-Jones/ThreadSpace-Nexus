# 🧠 Mypy Fix Guide: `_parse_autolev_antlr.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/_parse_autolev_antlr.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/_parse_autolev_antlr.py --strict
```

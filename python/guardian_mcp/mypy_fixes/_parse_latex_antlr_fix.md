# 🧠 Mypy Fix Guide: `_parse_latex_antlr.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/_parse_latex_antlr.py`
**Lines:** `607`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/_parse_latex_antlr.py --strict
```

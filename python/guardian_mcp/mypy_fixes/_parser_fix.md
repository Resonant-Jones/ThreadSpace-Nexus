...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/_parser.py`
**Lines:** `356`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/_parser.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_path_utils.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_path_utils.py --strict
```

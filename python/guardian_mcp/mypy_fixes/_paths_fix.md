...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_paths.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_paths.py --strict
```

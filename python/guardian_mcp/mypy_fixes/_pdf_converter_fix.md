# 🧠 Mypy Fix Guide: `_pdf_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_pdf_converter.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_pdf_converter.py --strict
```

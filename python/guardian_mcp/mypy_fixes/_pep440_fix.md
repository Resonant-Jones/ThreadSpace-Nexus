...
**File:** `.venv/lib/python3.13/site-packages/numpy/_utils/_pep440.py`
**Lines:** `486`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_utils/_pep440.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/util/path/_permission.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/util/path/_permission.py --strict
```

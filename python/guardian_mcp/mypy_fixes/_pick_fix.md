...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_pick.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_pick.py --strict
```

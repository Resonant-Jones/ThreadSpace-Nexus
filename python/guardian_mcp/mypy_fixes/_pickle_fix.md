...
**File:** `.venv/lib/python3.13/site-packages/numpy/random/_pickle.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/random/_pickle.py --strict
```

# 🧠 Mypy Fix Guide: `_pip_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/dependency_groups/_pip_wrapper.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/dependency_groups/_pip_wrapper.py --strict
```

# 🧠 Mypy Fix Guide: `_plain_text_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_plain_text_converter.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_plain_text_converter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_playwright.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_playwright.py --strict
```

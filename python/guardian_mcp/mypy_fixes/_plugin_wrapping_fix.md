# 🧠 Mypy Fix Guide: `_plugin_wrapping.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/_plugin_wrapping.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/_plugin_wrapping.py --strict
```

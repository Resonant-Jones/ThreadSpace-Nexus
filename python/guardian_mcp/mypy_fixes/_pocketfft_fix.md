...
**File:** `.venv/lib/python3.13/site-packages/numpy/fft/_pocketfft.py`
**Lines:** `1693`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/fft/_pocketfft.py --strict
```

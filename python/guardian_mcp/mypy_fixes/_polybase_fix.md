...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/_polybase.py`
**Lines:** `1191`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/_polybase.py --strict
```

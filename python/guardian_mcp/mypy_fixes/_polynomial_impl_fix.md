# 🧠 Mypy Fix Guide: `_polynomial_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_polynomial_impl.py`
**Lines:** `1465`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_polynomial_impl.py --strict
```

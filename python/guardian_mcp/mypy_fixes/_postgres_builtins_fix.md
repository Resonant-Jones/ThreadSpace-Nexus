# 🧠 Mypy Fix Guide: `_postgres_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_postgres_builtins.py`
**Lines:** `739`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_postgres_builtins.py --strict
```

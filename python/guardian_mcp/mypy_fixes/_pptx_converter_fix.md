# 🧠 Mypy Fix Guide: `_pptx_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_pptx_converter.py`
**Lines:** `252`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_pptx_converter.py --strict
```

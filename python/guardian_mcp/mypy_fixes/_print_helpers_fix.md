# 🧠 Mypy Fix Guide: `_print_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/_print_helpers.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/_print_helpers.py --strict
```

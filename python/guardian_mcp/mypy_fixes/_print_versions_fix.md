# 🧠 Mypy Fix Guide: `_print_versions.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/util/_print_versions.py`
**Lines:** `158`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/util/_print_versions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/cli/_progress.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/cli/_progress.py --strict
```

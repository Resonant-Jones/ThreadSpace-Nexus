...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/properties/_properties.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/properties/_properties.py --strict
```

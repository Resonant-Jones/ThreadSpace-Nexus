...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/util/_providers.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/util/_providers.py --strict
```

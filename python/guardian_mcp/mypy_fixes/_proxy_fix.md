...
**File:** `.venv/lib/python3.13/site-packages/openai/_utils/_proxy.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_utils/_proxy.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/psutil/_pswindows.py`
**Lines:** `1103`
...
```bash
mypy .venv/lib/python3.13/site-packages/psutil/_pswindows.py --strict
```

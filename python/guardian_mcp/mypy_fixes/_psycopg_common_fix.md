# 🧠 Mypy Fix Guide: `_psycopg_common.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/_psycopg_common.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/_psycopg_common.py --strict
```

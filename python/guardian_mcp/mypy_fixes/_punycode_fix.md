...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/_punycode.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/_punycode.py --strict
```

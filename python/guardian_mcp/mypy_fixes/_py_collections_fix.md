# 🧠 Mypy Fix Guide: `_py_collections.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/_py_collections.py`
**Lines:** `541`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/_py_collections.py --strict
```

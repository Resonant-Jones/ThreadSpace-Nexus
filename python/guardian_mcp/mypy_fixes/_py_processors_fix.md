# 🧠 Mypy Fix Guide: `_py_processors.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/engine/_py_processors.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/engine/_py_processors.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/engine/_py_row.py`
**Lines:** `128`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/engine/_py_row.py --strict
```

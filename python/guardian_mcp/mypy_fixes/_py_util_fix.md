...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/_py_util.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/_py_util.py --strict
```

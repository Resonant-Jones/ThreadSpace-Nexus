# 🧠 Mypy Fix Guide: `_pybind_state.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/_pybind_state.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/_pybind_state.py --strict
```

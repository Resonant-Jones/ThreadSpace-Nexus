...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/_pydantic.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/_pydantic.py --strict
```

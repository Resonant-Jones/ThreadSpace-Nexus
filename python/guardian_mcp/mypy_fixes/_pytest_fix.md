...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/meta/_pytest.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/meta/_pytest.py --strict
```

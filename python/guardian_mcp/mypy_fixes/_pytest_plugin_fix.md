# 🧠 Mypy Fix Guide: `_pytest_plugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_pytest_plugin.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_pytest_plugin.py --strict
```

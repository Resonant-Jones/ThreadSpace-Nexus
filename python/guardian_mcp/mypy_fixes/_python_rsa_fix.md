...
**File:** `.venv/lib/python3.13/site-packages/google/auth/crypt/_python_rsa.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/crypt/_python_rsa.py --strict
```

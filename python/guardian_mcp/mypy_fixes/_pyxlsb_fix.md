...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_pyxlsb.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_pyxlsb.py --strict
```

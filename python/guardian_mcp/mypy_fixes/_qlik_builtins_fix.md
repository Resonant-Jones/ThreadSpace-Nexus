# 🧠 Mypy Fix Guide: `_qlik_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_qlik_builtins.py`
**Lines:** `666`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_qlik_builtins.py --strict
```

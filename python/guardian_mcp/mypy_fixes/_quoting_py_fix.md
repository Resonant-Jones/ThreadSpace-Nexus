...
**File:** `.venv/lib/python3.13/site-packages/yarl/_quoting_py.py`
**Lines:** `213`
...
```bash
mypy .venv/lib/python3.13/site-packages/yarl/_quoting_py.py --strict
```

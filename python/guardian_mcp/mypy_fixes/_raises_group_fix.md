# 🧠 Mypy Fix Guide: `_raises_group.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_raises_group.py`
**Lines:** `1021`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_raises_group.py --strict
```

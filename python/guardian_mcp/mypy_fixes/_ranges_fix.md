...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/_ranges.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/_ranges.py --strict
```

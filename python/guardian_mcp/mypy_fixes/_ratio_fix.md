...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_ratio.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_ratio.py --strict
```

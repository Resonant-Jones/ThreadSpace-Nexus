...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/tomli/_re.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/tomli/_re.py --strict
```

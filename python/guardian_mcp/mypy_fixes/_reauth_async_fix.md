# 🧠 Mypy Fix Guide: `_reauth_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/_reauth_async.py`
**Lines:** `328`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/_reauth_async.py --strict
```

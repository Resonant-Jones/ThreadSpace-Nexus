# 🧠 Mypy Fix Guide: `_receivebuffer.py`
...
**File:** `.venv/lib/python3.13/site-packages/h11/_receivebuffer.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/h11/_receivebuffer.py --strict
```

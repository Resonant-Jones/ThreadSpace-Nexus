...
**File:** `.venv/lib/python3.13/site-packages/openai/_utils/_reflection.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_utils/_reflection.py --strict
```

# 🧠 Mypy Fix Guide: `_refresh_worker.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_refresh_worker.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_refresh_worker.py --strict
```

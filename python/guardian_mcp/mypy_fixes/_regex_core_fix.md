...
**File:** `.venv/lib/python3.13/site-packages/regex/_regex_core.py`
**Lines:** `4495`
...
```bash
mypy .venv/lib/python3.13/site-packages/regex/_regex_core.py --strict
```

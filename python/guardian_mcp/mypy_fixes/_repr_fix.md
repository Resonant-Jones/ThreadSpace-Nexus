...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_repr.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_repr.py --strict
```

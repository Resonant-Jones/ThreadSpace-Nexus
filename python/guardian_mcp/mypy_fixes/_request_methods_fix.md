# 🧠 Mypy Fix Guide: `_request_methods.py`
...
**File:** `.venv/lib/python3.13/site-packages/urllib3/_request_methods.py`
**Lines:** `278`
...
```bash
mypy .venv/lib/python3.13/site-packages/urllib3/_request_methods.py --strict
```

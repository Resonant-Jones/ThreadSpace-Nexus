...
**File:** `.venv/lib/python3.13/site-packages/openai/_resource.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_resource.py --strict
```

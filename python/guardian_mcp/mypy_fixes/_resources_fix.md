...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_resources.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_resources.py --strict
```

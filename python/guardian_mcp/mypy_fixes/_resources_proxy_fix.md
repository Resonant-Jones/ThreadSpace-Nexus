# 🧠 Mypy Fix Guide: `_resources_proxy.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/_utils/_resources_proxy.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_utils/_resources_proxy.py --strict
```

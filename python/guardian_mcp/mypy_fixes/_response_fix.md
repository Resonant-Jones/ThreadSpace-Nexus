...
**File:** `.venv/lib/python3.13/site-packages/openai/_response.py`
**Lines:** `848`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_response.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/lib/streaming/responses/_responses.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/lib/streaming/responses/_responses.py --strict
```

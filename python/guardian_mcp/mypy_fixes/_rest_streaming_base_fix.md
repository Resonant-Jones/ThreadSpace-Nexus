# 🧠 Mypy Fix Guide: `_rest_streaming_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/_rest_streaming_base.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/_rest_streaming_base.py --strict
```

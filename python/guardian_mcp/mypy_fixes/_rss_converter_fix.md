# 🧠 Mypy Fix Guide: `_rss_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_rss_converter.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_rss_converter.py --strict
```

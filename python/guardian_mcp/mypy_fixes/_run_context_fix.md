# 🧠 Mypy Fix Guide: `_run_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_run_context.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_run_context.py --strict
```

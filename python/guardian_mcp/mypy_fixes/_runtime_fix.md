...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_runtime.py`
**Lines:** `394`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_runtime.py --strict
```

# 🧠 Mypy Fix Guide: `_runtime_protos.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/_runtime_protos.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/_runtime_protos.py --strict
```

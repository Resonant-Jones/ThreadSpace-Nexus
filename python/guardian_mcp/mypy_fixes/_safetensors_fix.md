# 🧠 Mypy Fix Guide: `_safetensors.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_safetensors.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_safetensors.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_scalars.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_scalars.py --strict
```

# 🧠 Mypy Fix Guide: `_schema_gather.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_schema_gather.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_schema_gather.py --strict
```

# 🧠 Mypy Fix Guide: `_schema_generation_shared.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_schema_generation_shared.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_schema_generation_shared.py --strict
```

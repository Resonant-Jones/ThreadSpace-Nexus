# 🧠 Mypy Fix Guide: `_schema_validator.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/plugin/_schema_validator.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/plugin/_schema_validator.py --strict
```

# 🧠 Mypy Fix Guide: `_scheme_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_scheme_builtins.py`
**Lines:** `1609`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_scheme_builtins.py --strict
```

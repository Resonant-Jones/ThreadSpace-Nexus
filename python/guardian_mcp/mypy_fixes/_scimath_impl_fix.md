# 🧠 Mypy Fix Guide: `_scimath_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_scimath_impl.py`
**Lines:** `642`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_scimath_impl.py --strict
```

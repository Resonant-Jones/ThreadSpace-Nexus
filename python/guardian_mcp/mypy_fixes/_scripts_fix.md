...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_scripts.py`
**Lines:** `361`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_scripts.py --strict
```

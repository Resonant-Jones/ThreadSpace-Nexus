# 🧠 Mypy Fix Guide: `_selectable_constructors.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/_selectable_constructors.py`
**Lines:** `715`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/_selectable_constructors.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/_semconv.py`
**Lines:** `473`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/_semconv.py --strict
```

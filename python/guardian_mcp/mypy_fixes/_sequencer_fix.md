...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_sequencer.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_sequencer.py --strict
```

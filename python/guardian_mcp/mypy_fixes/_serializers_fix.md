# 🧠 Mypy Fix Guide: `_serializers.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_serializers.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_serializers.py --strict
```

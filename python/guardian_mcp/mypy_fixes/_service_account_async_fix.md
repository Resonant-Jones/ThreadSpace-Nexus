# 🧠 Mypy Fix Guide: `_service_account_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/_service_account_async.py`
**Lines:** `132`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/_service_account_async.py --strict
```

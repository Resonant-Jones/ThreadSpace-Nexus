# 🧠 Mypy Fix Guide: `_service_account_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/_service_account_info.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/_service_account_info.py --strict
```

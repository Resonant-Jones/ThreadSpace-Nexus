# 🧠 Mypy Fix Guide: `_service_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/_service_logger.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/_service_logger.py --strict
```

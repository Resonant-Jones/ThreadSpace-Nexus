# 🧠 Mypy Fix Guide: `_set_input_files_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_set_input_files_helpers.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_set_input_files_helpers.py --strict
```

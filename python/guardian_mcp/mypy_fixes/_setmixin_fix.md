...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/_setmixin.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/_setmixin.py --strict
```

# 🧠 Mypy Fix Guide: `_shape_base_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_shape_base_impl.py`
**Lines:** `1301`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_shape_base_impl.py --strict
```

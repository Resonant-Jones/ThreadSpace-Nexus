...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/_shape.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/_shape.py --strict
```

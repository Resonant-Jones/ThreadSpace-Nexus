# 🧠 Mypy Fix Guide: `_shimmed_dist_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/cffi/_shimmed_dist_utils.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/_shimmed_dist_utils.py --strict
```

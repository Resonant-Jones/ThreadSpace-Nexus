...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_shutil.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_shutil.py --strict
```

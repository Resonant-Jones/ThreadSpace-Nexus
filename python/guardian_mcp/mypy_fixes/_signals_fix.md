...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_signals.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_signals.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_signature.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_signature.py --strict
```

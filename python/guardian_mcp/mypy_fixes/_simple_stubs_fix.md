# 🧠 Mypy Fix Guide: `_simple_stubs.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/_simple_stubs.py`
**Lines:** `588`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/_simple_stubs.py --strict
```

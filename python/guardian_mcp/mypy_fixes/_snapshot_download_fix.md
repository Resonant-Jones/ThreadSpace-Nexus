# 🧠 Mypy Fix Guide: `_snapshot_download.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_snapshot_download.py`
**Lines:** `338`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_snapshot_download.py --strict
```

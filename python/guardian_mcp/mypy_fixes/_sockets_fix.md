...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_sockets.py`
**Lines:** `792`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_sockets.py --strict
```

# 🧠 Mypy Fix Guide: `_sourcemod_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_sourcemod_builtins.py`
**Lines:** `1151`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_sourcemod_builtins.py --strict
```

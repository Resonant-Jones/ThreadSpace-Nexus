...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_space_api.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_space_api.py --strict
```

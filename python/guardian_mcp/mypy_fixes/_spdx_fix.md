...
**File:** `.venv/lib/python3.13/site-packages/packaging/licenses/_spdx.py`
**Lines:** `759`
...
```bash
mypy .venv/lib/python3.13/site-packages/packaging/licenses/_spdx.py --strict
```

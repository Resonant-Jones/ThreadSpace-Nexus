...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_spinners.py`
**Lines:** `482`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_spinners.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/_src_pyf.py`
**Lines:** `247`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/_src_pyf.py --strict
```

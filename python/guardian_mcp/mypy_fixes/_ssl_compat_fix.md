...
**File:** `.venv/lib/python3.13/site-packages/websocket/_ssl_compat.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/websocket/_ssl_compat.py --strict
```

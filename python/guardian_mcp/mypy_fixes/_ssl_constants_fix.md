# 🧠 Mypy Fix Guide: `_ssl_constants.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/truststore/_ssl_constants.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/truststore/_ssl_constants.py --strict
```

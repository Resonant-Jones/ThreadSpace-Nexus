...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_stack.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_stack.py --strict
```

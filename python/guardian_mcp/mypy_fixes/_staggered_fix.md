...
**File:** `.venv/lib/python3.13/site-packages/aiohappyeyeballs/_staggered.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohappyeyeballs/_staggered.py --strict
```

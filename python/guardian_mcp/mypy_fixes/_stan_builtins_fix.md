# 🧠 Mypy Fix Guide: `_stan_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_stan_builtins.py`
**Lines:** `648`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_stan_builtins.py --strict
```

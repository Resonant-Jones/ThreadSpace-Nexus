...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_static.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_static.py --strict
```

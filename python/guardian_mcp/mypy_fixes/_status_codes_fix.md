# 🧠 Mypy Fix Guide: `_status_codes.py`
...
**File:** `.venv/lib/python3.13/site-packages/httpx/_status_codes.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpx/_status_codes.py --strict
```

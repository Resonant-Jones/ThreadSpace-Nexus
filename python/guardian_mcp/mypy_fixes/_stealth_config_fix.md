# 🧠 Mypy Fix Guide: `_stealth_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/core/_stealth_config.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/core/_stealth_config.py --strict
```

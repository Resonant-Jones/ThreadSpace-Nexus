...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_str_utils.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_str_utils.py --strict
```

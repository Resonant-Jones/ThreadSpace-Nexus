...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_stream.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_stream.py --strict
```

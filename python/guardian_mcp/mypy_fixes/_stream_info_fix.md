# 🧠 Mypy Fix Guide: `_stream_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/_stream_info.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/_stream_info.py --strict
```

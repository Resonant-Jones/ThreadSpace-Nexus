...
**File:** `.venv/lib/python3.13/site-packages/openai/_streaming.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_streaming.py --strict
```

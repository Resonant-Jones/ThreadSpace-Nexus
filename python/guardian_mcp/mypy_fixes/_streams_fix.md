...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_streams.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_streams.py --strict
```

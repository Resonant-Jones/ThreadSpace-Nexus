# 🧠 Mypy Fix Guide: `_stride_tricks_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_stride_tricks_impl.py`
**Lines:** `549`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_stride_tricks_impl.py --strict
```

# 🧠 Mypy Fix Guide: `_string_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_string_helpers.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_string_helpers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/_structures.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/_structures.py --strict
```

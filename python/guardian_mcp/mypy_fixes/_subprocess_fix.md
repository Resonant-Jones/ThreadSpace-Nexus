...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_subprocess.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_subprocess.py --strict
```

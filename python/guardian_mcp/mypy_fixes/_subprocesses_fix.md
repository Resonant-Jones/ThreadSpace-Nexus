# 🧠 Mypy Fix Guide: `_subprocesses.py`
...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_subprocesses.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_subprocesses.py --strict
```

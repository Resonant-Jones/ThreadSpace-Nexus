# 🧠 Mypy Fix Guide: `_suppression.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_suppression.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/typeguard/_suppression.py --strict
```

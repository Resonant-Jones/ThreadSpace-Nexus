...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_sync_base.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_sync_base.py --strict
```

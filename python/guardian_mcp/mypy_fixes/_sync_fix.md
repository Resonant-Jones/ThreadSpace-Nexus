...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/util/path/_sync.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/util/path/_sync.py --strict
```

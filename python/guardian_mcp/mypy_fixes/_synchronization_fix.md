# 🧠 Mypy Fix Guide: `_synchronization.py`
...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_synchronization.py`
**Lines:** `732`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_synchronization.py --strict
```

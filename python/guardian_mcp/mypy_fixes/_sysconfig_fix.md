...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/locations/_sysconfig.py`
**Lines:** `214`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/locations/_sysconfig.py --strict
```

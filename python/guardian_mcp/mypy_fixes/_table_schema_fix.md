# 🧠 Mypy Fix Guide: `_table_schema.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/json/_table_schema.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/json/_table_schema.py --strict
```

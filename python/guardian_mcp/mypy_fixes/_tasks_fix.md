...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_tasks.py`
**Lines:** `158`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_tasks.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_telemetry.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_telemetry.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_tempfile.py`
**Lines:** `616`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_tempfile.py --strict
```

# 🧠 Mypy Fix Guide: `_tensorboard_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_tensorboard_logger.py`
**Lines:** `194`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_tensorboard_logger.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/serialization/_tensorflow.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/serialization/_tensorflow.py --strict
```

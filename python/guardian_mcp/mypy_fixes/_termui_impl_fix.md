# 🧠 Mypy Fix Guide: `_termui_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/click/_termui_impl.py`
**Lines:** `839`
...
```bash
mypy .venv/lib/python3.13/site-packages/click/_termui_impl.py --strict
```

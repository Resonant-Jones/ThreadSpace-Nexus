# 🧠 Mypy Fix Guide: `_test_decorators.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/util/_test_decorators.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/util/_test_decorators.py --strict
```

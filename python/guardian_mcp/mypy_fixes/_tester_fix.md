...
**File:** `.venv/lib/python3.13/site-packages/pandas/util/_tester.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/util/_tester.py --strict
```

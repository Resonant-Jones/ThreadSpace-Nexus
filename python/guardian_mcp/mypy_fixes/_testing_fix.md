...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_testing.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_testing.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/importlib_metadata/_text.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/importlib_metadata/_text.py --strict
```

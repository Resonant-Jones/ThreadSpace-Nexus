# 🧠 Mypy Fix Guide: `_thread_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_thread_cache.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_thread_cache.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_timer.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_timer.py --strict
```

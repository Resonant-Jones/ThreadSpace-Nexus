# 🧠 Mypy Fix Guide: `_tkinter_finder.py`
...
**File:** `.venv/lib/python3.13/site-packages/PIL/_tkinter_finder.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/PIL/_tkinter_finder.py --strict
```

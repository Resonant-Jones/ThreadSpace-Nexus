...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/_tokenizer.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/_tokenizer.py --strict
```

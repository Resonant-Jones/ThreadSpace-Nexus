# 🧠 Mypy Fix Guide: `_toml_compat.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/dependency_groups/_toml_compat.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/dependency_groups/_toml_compat.py --strict
```

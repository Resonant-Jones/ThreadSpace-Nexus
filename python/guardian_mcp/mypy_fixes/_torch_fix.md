...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/serialization/_torch.py`
**Lines:** `1033`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/serialization/_torch.py --strict
```

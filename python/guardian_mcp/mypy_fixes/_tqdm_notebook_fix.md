# 🧠 Mypy Fix Guide: `_tqdm_notebook.py`
...
**File:** `.venv/lib/python3.13/site-packages/tqdm/_tqdm_notebook.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/_tqdm_notebook.py --strict
```

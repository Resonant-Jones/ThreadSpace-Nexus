# 🧠 Mypy Fix Guide: `_tqdm_pandas.py`
...
**File:** `.venv/lib/python3.13/site-packages/tqdm/_tqdm_pandas.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/_tqdm_pandas.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_tracing.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_tracing.py --strict
```

# 🧠 Mypy Fix Guide: `_transcribe_audio.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_transcribe_audio.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_transcribe_audio.py --strict
```

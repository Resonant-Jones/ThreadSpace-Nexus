...
**File:** `.venv/lib/python3.13/site-packages/openai/_utils/_transform.py`
**Lines:** `447`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_utils/_transform.py --strict
```

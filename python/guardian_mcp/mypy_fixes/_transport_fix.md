...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_transport.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_transport.py --strict
```

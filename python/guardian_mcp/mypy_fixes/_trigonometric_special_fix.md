# 🧠 Mypy Fix Guide: `_trigonometric_special.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/_trigonometric_special.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/_trigonometric_special.py --strict
```

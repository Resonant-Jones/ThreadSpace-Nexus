...
**File:** `.venv/lib/python3.13/site-packages/anyio/_backends/_trio.py`
**Lines:** `1334`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_backends/_trio.py --strict
```

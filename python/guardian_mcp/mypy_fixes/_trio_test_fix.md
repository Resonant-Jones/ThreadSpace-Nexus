...
**File:** `.venv/lib/python3.13/site-packages/trio/testing/_trio_test.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/testing/_trio_test.py --strict
```

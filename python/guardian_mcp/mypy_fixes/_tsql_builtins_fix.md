# 🧠 Mypy Fix Guide: `_tsql_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_tsql_builtins.py`
**Lines:** `1003`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_tsql_builtins.py --strict
```

# 🧠 Mypy Fix Guide: `_twodim_base_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_twodim_base_impl.py`
**Lines:** `1201`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_twodim_base_impl.py --strict
```

# 🧠 Mypy Fix Guide: `_type_aliases.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_type_aliases.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_type_aliases.py --strict
```

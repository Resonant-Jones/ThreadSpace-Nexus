# 🧠 Mypy Fix Guide: `_type_check_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_type_check_impl.py`
**Lines:** `699`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_type_check_impl.py --strict
```

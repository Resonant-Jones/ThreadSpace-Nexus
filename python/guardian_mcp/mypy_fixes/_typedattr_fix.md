...
**File:** `.venv/lib/python3.13/site-packages/anyio/_core/_typedattr.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/_core/_typedattr.py --strict
```

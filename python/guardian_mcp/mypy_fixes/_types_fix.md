...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/tomli/_types.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/tomli/_types.py --strict
```

# 🧠 Mypy Fix Guide: `_typing_extra.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_typing_extra.py`
**Lines:** `714`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_typing_extra.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/html2text/_typing.py`
**Lines:** `3`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/html2text/_typing.py --strict
```

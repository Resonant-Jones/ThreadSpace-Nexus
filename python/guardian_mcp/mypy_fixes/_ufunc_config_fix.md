# 🧠 Mypy Fix Guide: `_ufunc_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/_ufunc_config.py`
**Lines:** `489`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/_ufunc_config.py --strict
```

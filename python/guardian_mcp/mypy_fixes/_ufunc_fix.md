...
**File:** `.venv/lib/python3.13/site-packages/numpy/_typing/_ufunc.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_typing/_ufunc.py --strict
```

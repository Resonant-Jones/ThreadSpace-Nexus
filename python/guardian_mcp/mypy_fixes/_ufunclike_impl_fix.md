# 🧠 Mypy Fix Guide: `_ufunclike_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_ufunclike_impl.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_ufunclike_impl.py --strict
```

# 🧠 Mypy Fix Guide: `_unbounded_queue.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_unbounded_queue.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_unbounded_queue.py --strict
```

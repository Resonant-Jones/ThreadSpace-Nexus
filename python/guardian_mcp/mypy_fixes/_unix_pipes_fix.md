...
**File:** `.venv/lib/python3.13/site-packages/trio/_unix_pipes.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_unix_pipes.py --strict
```

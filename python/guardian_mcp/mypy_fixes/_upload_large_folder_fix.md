# 🧠 Mypy Fix Guide: `_upload_large_folder.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_upload_large_folder.py`
**Lines:** `625`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_upload_large_folder.py --strict
```

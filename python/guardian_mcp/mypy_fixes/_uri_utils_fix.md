...
**File:** `.venv/lib/python3.13/site-packages/markitdown/_uri_utils.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/_uri_utils.py --strict
```

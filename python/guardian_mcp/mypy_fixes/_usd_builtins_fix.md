# 🧠 Mypy Fix Guide: `_usd_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_usd_builtins.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_usd_builtins.py --strict
```

# 🧠 Mypy Fix Guide: `_user_array_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_user_array_impl.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_user_array_impl.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_util.py`
**Lines:** `334`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_util.py --strict
```

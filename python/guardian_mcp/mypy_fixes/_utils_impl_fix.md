...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_utils_impl.py`
**Lines:** `779`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_utils_impl.py --strict
```

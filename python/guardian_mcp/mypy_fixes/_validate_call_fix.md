# 🧠 Mypy Fix Guide: `_validate_call.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/_internal/_validate_call.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/_internal/_validate_call.py --strict
```

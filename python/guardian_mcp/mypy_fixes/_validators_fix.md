...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_validators.py`
**Lines:** `226`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_validators.py --strict
```

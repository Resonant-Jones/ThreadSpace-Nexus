# 🧠 Mypy Fix Guide: `_vbscript_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_vbscript_builtins.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_vbscript_builtins.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/_version.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/_version.py --strict
```

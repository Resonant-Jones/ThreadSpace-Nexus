# 🧠 Mypy Fix Guide: `_version_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/attr/_version_info.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/attr/_version_info.py --strict
```

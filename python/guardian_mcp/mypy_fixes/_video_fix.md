...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_video.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_video.py --strict
```

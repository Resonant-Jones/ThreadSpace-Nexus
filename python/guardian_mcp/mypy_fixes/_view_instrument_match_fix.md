# 🧠 Mypy Fix Guide: `_view_instrument_match.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/_view_instrument_match.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/_view_instrument_match.py --strict
```

# 🧠 Mypy Fix Guide: `_viewport_properties.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/properties/_viewport_properties.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/properties/_viewport_properties.py --strict
```

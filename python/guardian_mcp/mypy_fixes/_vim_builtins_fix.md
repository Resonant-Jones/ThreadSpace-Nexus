# 🧠 Mypy Fix Guide: `_vim_builtins.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/_vim_builtins.py`
**Lines:** `1938`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/_vim_builtins.py --strict
```

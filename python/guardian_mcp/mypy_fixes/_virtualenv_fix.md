...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/_virtualenv.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/_virtualenv.py --strict
```

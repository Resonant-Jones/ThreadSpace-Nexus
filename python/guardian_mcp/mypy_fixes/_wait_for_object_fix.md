# 🧠 Mypy Fix Guide: `_wait_for_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_wait_for_object.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_wait_for_object.py --strict
```

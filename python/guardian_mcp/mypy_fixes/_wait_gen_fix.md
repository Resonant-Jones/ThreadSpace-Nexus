...
**File:** `.venv/lib/python3.13/site-packages/backoff/_wait_gen.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/backoff/_wait_gen.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/playwright/_impl/_waiter.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright/_impl/_waiter.py --strict
```

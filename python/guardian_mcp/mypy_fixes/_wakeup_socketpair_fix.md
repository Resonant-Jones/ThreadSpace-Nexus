# 🧠 Mypy Fix Guide: `_wakeup_socketpair.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_wakeup_socketpair.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_wakeup_socketpair.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/_testing/_warnings.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_testing/_warnings.py --strict
```

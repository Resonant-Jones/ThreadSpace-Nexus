# 🧠 Mypy Fix Guide: `_webgl_properties.py`
...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/properties/_webgl_properties.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/properties/_webgl_properties.py --strict
```

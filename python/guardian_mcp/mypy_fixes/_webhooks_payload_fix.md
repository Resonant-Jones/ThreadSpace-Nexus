# 🧠 Mypy Fix Guide: `_webhooks_payload.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_webhooks_payload.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_webhooks_payload.py --strict
```

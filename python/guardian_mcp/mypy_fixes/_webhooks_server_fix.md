# 🧠 Mypy Fix Guide: `_webhooks_server.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/_webhooks_server.py`
**Lines:** `388`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/_webhooks_server.py --strict
```

# 🧠 Mypy Fix Guide: `_width_table.py`
...
**File:** `.venv/lib/python3.13/site-packages/black/_width_table.py`
**Lines:** `478`
...
```bash
mypy .venv/lib/python3.13/site-packages/black/_width_table.py --strict
```

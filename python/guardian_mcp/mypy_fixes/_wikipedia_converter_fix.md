# 🧠 Mypy Fix Guide: `_wikipedia_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_wikipedia_converter.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_wikipedia_converter.py --strict
```

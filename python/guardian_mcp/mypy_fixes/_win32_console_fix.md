# 🧠 Mypy Fix Guide: `_win32_console.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_win32_console.py`
**Lines:** `661`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_win32_console.py --strict
```

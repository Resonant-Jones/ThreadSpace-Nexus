...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/util/path/_win.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/util/path/_win.py --strict
```

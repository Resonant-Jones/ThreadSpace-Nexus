# 🧠 Mypy Fix Guide: `_win_reduction.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/_win_reduction.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/_win_reduction.py --strict
```

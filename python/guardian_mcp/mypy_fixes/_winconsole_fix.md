...
**File:** `.venv/lib/python3.13/site-packages/click/_winconsole.py`
**Lines:** `296`
...
```bash
mypy .venv/lib/python3.13/site-packages/click/_winconsole.py --strict
```

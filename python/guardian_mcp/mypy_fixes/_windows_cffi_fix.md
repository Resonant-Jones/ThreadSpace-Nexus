# 🧠 Mypy Fix Guide: `_windows_cffi.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_windows_cffi.py`
**Lines:** `520`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_windows_cffi.py --strict
```

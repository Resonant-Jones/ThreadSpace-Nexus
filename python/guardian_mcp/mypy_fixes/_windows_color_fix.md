# 🧠 Mypy Fix Guide: `_windows_color.py`
...
**File:** `.venv/lib/python3.13/site-packages/flake8/formatting/_windows_color.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/formatting/_windows_color.py --strict
```

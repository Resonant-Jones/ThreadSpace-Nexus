...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_windows.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_windows.py --strict
```

# 🧠 Mypy Fix Guide: `_windows_pipes.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_windows_pipes.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_windows_pipes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/_wrap.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/_wrap.py --strict
```

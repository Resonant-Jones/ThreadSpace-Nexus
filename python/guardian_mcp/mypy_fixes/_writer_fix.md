...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/tomli_w/_writer.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/tomli_w/_writer.py --strict
```

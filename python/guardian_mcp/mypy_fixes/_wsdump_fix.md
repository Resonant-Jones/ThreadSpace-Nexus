...
**File:** `.venv/lib/python3.13/site-packages/websocket/_wsdump.py`
**Lines:** `244`
...
```bash
mypy .venv/lib/python3.13/site-packages/websocket/_wsdump.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/_xet.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/_xet.py --strict
```

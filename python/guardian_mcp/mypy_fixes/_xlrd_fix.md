...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_xlrd.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_xlrd.py --strict
```

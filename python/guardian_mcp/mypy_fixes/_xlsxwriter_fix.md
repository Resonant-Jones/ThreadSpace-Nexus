...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/excel/_xlsxwriter.py`
**Lines:** `284`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/excel/_xlsxwriter.py --strict
```

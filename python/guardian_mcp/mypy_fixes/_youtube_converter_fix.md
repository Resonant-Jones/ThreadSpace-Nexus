# 🧠 Mypy Fix Guide: `_youtube_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_youtube_converter.py`
**Lines:** `238`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_youtube_converter.py --strict
```

# 🧠 Mypy Fix Guide: `_zip_converter.py`
...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converters/_zip_converter.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converters/_zip_converter.py --strict
```

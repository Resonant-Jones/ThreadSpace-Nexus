...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/foundation/abandonment.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/foundation/abandonment.py --strict
```

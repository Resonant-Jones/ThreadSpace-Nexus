...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/abap.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/abap.py --strict
```

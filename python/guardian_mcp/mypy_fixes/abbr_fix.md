...
**File:** `.venv/lib/python3.13/site-packages/mistune/plugins/abbr.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/plugins/abbr.py --strict
```

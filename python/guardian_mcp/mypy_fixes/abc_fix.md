...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/abc.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/abc.py --strict
```

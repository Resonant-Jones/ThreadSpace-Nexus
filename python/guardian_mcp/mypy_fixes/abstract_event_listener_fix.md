# 🧠 Mypy Fix Guide: `abstract_event_listener.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/abstract_event_listener.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/abstract_event_listener.py --strict
```

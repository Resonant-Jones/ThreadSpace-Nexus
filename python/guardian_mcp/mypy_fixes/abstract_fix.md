...
**File:** `.venv/lib/python3.13/site-packages/chromadb/execution/executor/abstract.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/execution/executor/abstract.py --strict
```

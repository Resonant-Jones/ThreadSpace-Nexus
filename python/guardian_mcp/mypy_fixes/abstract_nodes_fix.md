# 🧠 Mypy Fix Guide: `abstract_nodes.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/abstract_nodes.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/abstract_nodes.py --strict
```

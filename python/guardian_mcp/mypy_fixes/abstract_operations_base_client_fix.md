# 🧠 Mypy Fix Guide: `abstract_operations_base_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/abstract_operations_base_client.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/abstract_operations_base_client.py --strict
```

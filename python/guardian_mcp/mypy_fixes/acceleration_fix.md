# 🧠 Mypy Fix Guide: `acceleration.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/acceleration.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/acceleration.py --strict
```

# 🧠 Mypy Fix Guide: `access_token.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/endpoints/access_token.py`
**Lines:** `215`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/endpoints/access_token.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/sparse/accessor.py`
**Lines:** `414`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/sparse/accessor.py --strict
```

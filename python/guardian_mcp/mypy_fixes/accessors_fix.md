...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/arrow/accessors.py`
**Lines:** `473`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/arrow/accessors.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/fedcm/account.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/fedcm/account.py --strict
```

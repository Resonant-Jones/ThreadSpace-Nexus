...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/wheels/acquire.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/wheels/acquire.py --strict
```

# 🧠 Mypy Fix Guide: `action_builder.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/action_builder.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/action_builder.py --strict
```

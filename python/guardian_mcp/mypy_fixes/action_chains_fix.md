# 🧠 Mypy Fix Guide: `action_chains.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/action_chains.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/action_chains.py --strict
```

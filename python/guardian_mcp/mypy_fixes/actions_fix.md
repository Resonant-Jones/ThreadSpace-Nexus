...
**File:** `.venv/lib/python3.13/site-packages/pyparsing/actions.py`
**Lines:** `219`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyparsing/actions.py --strict
```

# 🧠 Mypy Fix Guide: `actionscript.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/actionscript.py`
**Lines:** `243`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/actionscript.py --strict
```

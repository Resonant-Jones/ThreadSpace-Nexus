...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/biomechanics/activation.py`
**Lines:** `869`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/biomechanics/activation.py --strict
```

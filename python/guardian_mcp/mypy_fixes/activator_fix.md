...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/activation/activator.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/activation/activator.py --strict
```

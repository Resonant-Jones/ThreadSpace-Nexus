...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/run/plugin/activators.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/run/plugin/activators.py --strict
```

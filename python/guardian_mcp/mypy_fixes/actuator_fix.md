...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/actuator.py`
**Lines:** `1147`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/actuator.py --strict
```

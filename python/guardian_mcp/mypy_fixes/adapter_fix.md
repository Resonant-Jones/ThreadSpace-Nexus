...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/adapter.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/adapter.py --strict
```

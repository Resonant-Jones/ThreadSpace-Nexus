...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/requests/adapters.py`
**Lines:** `719`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/requests/adapters.py --strict
```

# 🧠 Mypy Fix Guide: `add_retry_fallback_headers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/add_retry_fallback_headers.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/add_retry_fallback_headers.py --strict
```

# 🧠 Mypy Fix Guide: `additional_logging_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/additional_logging_utils.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/additional_logging_utils.py --strict
```

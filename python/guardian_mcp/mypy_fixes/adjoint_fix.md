...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/adjoint.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/adjoint.py --strict
```

# 🧠 Mypy Fix Guide: `admin_ui_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/admin_ui_utils.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/admin_ui_utils.py --strict
```

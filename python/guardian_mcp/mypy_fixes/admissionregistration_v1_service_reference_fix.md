# 🧠 Mypy Fix Guide: `admissionregistration_v1_service_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/admissionregistration_v1_service_reference.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/admissionregistration_v1_service_reference.py --strict
```

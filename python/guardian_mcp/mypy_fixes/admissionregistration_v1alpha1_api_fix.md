# 🧠 Mypy Fix Guide: `admissionregistration_v1alpha1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/admissionregistration_v1alpha1_api.py`
**Lines:** `2216`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/admissionregistration_v1alpha1_api.py --strict
```

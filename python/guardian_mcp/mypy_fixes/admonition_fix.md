...
**File:** `.venv/lib/python3.13/site-packages/mistune/directives/admonition.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/directives/admonition.py --strict
```

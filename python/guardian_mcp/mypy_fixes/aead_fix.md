...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/ciphers/aead.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/ciphers/aead.py --strict
```

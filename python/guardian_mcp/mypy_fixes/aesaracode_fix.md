...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/aesaracode.py`
**Lines:** `563`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/aesaracode.py --strict
```

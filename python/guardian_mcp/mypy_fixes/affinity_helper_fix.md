# 🧠 Mypy Fix Guide: `affinity_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/affinity_helper.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/affinity_helper.py --strict
```

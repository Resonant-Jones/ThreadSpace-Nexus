...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/agent.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/agent.py --strict
```

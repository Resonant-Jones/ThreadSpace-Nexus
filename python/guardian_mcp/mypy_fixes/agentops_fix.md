...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/agentops/agentops.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/agentops/agentops.py --strict
```

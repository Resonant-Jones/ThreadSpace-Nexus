...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/aggregation.py`
**Lines:** `1474`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/aggregation.py --strict
```

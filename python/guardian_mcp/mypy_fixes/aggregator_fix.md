...
**File:** `.venv/lib/python3.13/site-packages/flake8/options/aggregator.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/options/aggregator.py --strict
```

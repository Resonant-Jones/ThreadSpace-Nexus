...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/agile.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/agile.py --strict
```

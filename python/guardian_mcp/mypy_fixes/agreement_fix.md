...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/agreement.py`
**Lines:** `467`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/agreement.py --strict
```

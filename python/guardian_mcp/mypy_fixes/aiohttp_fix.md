...
**File:** `.venv/lib/python3.13/site-packages/google/auth/aio/transport/aiohttp.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/aio/transport/aiohttp.py --strict
```

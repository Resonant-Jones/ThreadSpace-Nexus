# 🧠 Mypy Fix Guide: `aiohttp_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/custom_httpx/aiohttp_handler.py`
**Lines:** `600`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/custom_httpx/aiohttp_handler.py --strict
```

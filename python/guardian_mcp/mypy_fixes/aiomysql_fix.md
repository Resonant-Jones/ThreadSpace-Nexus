...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/aiomysql.py`
**Lines:** `335`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/aiomysql.py --strict
```

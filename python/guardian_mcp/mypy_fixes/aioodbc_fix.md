...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/aioodbc.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/aioodbc.py --strict
```

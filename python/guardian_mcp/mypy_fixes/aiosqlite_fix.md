...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/sqlite/aiosqlite.py`
**Lines:** `398`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/sqlite/aiosqlite.py --strict
```

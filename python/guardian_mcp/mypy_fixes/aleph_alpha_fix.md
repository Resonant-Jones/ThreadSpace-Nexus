...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/deprecated_providers/aleph_alpha.py`
**Lines:** `307`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/deprecated_providers/aleph_alpha.py --strict
```

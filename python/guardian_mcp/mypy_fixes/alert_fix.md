...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/alert.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/alert.py --strict
```

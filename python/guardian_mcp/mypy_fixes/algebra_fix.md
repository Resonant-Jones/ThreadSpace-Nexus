...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/algebra.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/algebra.py --strict
```

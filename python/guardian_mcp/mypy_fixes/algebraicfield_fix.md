# 🧠 Mypy Fix Guide: `algebraicfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/algebraicfield.py`
**Lines:** `638`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/algebraicfield.py --strict
```

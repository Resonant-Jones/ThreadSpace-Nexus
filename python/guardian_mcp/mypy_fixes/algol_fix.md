...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/algol.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/algol.py --strict
```

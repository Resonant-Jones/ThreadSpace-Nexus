...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/algol_nu.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/algol_nu.py --strict
```

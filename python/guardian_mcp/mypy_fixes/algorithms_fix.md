...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/algorithms.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/algorithms.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/alias.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/alias.py --strict
```

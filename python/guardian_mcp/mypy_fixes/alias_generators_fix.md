# 🧠 Mypy Fix Guide: `alias_generators.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/alias_generators.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/alias_generators.py --strict
```

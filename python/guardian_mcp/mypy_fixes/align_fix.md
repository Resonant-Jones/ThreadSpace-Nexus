...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/align.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/align.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/aligned.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/aligned.py --strict
```

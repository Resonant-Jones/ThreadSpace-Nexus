...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/aline.py`
**Lines:** `1359`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/aline.py --strict
```

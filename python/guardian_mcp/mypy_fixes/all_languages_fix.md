# 🧠 Mypy Fix Guide: `all_languages.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/all_languages.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/all_languages.py --strict
```

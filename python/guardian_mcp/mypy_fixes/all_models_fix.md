...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared/all_models.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared/all_models.py --strict
```

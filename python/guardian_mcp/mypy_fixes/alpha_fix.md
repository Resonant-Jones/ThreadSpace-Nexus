...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/fine_tuning/alpha/alpha.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/fine_tuning/alpha/alpha.py --strict
```

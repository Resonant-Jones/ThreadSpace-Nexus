...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/alphabets.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/alphabets.py --strict
```

# 🧠 Mypy Fix Guide: `amazon_ai21_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_ai21_transformation.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_ai21_transformation.py --strict
```

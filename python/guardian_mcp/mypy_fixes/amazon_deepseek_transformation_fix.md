# 🧠 Mypy Fix Guide: `amazon_deepseek_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_deepseek_transformation.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_deepseek_transformation.py --strict
```

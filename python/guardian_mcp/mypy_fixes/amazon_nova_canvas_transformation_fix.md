# 🧠 Mypy Fix Guide: `amazon_nova_canvas_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/amazon_nova_canvas_transformation.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/amazon_nova_canvas_transformation.py --strict
```

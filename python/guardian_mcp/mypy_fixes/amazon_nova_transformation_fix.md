# 🧠 Mypy Fix Guide: `amazon_nova_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_nova_transformation.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_nova_transformation.py --strict
```

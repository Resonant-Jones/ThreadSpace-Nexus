# 🧠 Mypy Fix Guide: `amazon_stability1_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/amazon_stability1_transformation.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/amazon_stability1_transformation.py --strict
```

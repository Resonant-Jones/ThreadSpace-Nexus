# 🧠 Mypy Fix Guide: `amazon_stability3_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/amazon_stability3_transformation.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/amazon_stability3_transformation.py --strict
```

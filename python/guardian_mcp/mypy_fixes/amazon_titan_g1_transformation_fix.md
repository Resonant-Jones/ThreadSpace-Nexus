# 🧠 Mypy Fix Guide: `amazon_titan_g1_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/embed/amazon_titan_g1_transformation.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/embed/amazon_titan_g1_transformation.py --strict
```

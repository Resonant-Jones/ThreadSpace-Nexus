# 🧠 Mypy Fix Guide: `amazon_titan_multimodal_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/embed/amazon_titan_multimodal_transformation.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/embed/amazon_titan_multimodal_transformation.py --strict
```

# 🧠 Mypy Fix Guide: `amazon_titan_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_titan_transformation.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/amazon_titan_transformation.py --strict
```

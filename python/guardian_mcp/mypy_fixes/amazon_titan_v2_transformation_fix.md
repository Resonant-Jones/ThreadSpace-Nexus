# 🧠 Mypy Fix Guide: `amazon_titan_v2_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/embed/amazon_titan_v2_transformation.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/embed/amazon_titan_v2_transformation.py --strict
```

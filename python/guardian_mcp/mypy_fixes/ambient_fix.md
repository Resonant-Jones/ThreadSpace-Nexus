...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ambient.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ambient.py --strict
```

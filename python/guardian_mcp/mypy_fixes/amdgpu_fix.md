...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/amdgpu.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/amdgpu.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/among.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/among.py --strict
```

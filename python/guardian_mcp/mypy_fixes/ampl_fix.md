...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ampl.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ampl.py --strict
```

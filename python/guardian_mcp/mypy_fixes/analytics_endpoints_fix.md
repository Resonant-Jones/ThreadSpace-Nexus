# 🧠 Mypy Fix Guide: `analytics_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/analytics_endpoints/analytics_endpoints.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/analytics_endpoints/analytics_endpoints.py --strict
```

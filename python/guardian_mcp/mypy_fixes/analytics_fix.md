...
**File:** `.venv/lib/python3.13/site-packages/pypika/analytics.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/analytics.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/platformdirs/android.py`
**Lines:** `249`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/platformdirs/android.py --strict
```

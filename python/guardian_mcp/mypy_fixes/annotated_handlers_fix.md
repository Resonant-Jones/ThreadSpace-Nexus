# 🧠 Mypy Fix Guide: `annotated_handlers.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/annotated_handlers.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/annotated_handlers.py --strict
```

# 🧠 Mypy Fix Guide: `annotated_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/annotated_types.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/annotated_types.py --strict
```

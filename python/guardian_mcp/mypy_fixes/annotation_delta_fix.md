# 🧠 Mypy Fix Guide: `annotation_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/annotation_delta.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/annotation_delta.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/annotation.py`
**Lines:** `585`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/annotation.py --strict
```

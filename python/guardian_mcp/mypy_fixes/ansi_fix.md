...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/ansi.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/ansi.py --strict
```

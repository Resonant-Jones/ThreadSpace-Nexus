...
**File:** `.venv/lib/python3.13/site-packages/colorama/ansitowin32.py`
**Lines:** `277`
...
```bash
mypy .venv/lib/python3.13/site-packages/colorama/ansitowin32.py --strict
```

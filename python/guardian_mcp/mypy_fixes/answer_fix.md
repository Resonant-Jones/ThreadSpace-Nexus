...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/answer.py`
**Lines:** `363`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/answer.py --strict
```

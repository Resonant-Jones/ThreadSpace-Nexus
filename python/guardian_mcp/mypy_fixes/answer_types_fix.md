# 🧠 Mypy Fix Guide: `answer_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/answer_types.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/answer_types.py --strict
```

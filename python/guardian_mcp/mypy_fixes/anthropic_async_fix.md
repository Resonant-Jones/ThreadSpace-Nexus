# 🧠 Mypy Fix Guide: `anthropic_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/ai/anthropic/anthropic_async.py`
**Lines:** `217`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/ai/anthropic/anthropic_async.py --strict
```

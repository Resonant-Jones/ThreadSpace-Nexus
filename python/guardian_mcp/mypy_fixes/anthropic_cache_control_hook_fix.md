# 🧠 Mypy Fix Guide: `anthropic_cache_control_hook.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/anthropic_cache_control_hook.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/anthropic_cache_control_hook.py --strict
```

# 🧠 Mypy Fix Guide: `anthropic_claude2_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/anthropic_claude2_transformation.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_transformations/anthropic_claude2_transformation.py --strict
```

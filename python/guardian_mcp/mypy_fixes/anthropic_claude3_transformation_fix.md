# 🧠 Mypy Fix Guide: `anthropic_claude3_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/messages/invoke_transformations/anthropic_claude3_transformation.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/messages/invoke_transformations/anthropic_claude3_transformation.py --strict
```

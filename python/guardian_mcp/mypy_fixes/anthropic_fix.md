...
**File:** `.venv/lib/python3.13/site-packages/posthog/ai/anthropic/anthropic.py`
**Lines:** `217`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/ai/anthropic/anthropic.py --strict
```

# 🧠 Mypy Fix Guide: `anthropic_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/anthropic_messages/anthropic_response.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/anthropic_messages/anthropic_response.py --strict
```

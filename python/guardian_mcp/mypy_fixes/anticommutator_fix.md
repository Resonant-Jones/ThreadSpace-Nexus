# 🧠 Mypy Fix Guide: `anticommutator.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/anticommutator.py`
**Lines:** `166`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/anticommutator.py --strict
```

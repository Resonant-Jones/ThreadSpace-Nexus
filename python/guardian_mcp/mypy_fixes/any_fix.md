...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/any.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/any.py --strict
```

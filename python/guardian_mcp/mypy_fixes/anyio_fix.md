...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_backends/anyio.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_backends/anyio.py --strict
```

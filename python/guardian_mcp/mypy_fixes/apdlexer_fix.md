...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/apdlexer.py`
**Lines:** `593`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/apdlexer.py --strict
```

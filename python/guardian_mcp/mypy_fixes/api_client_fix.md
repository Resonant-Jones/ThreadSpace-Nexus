...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api_client.py`
**Lines:** `647`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api_client.py --strict
```

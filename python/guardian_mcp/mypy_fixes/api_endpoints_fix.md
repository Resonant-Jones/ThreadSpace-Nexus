# 🧠 Mypy Fix Guide: `api_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/notion_client/api_endpoints.py`
**Lines:** `309`
...
```bash
mypy .venv/lib/python3.13/site-packages/notion_client/api_endpoints.py --strict
```

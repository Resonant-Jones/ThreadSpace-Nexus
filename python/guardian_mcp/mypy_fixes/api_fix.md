...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/api.py`
**Lines:** `517`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/api.py --strict
```

# 🧠 Mypy Fix Guide: `api_implementation.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/api_implementation.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/api_implementation.py --strict
```

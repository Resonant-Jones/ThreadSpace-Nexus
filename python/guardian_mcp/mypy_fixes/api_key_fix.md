...
**File:** `.venv/lib/python3.13/site-packages/google/auth/api_key.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/api_key.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/api_pb2.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/api_pb2.py --strict
```

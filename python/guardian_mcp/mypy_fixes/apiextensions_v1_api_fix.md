# 🧠 Mypy Fix Guide: `apiextensions_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/apiextensions_v1_api.py`
**Lines:** `1593`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/apiextensions_v1_api.py --strict
```

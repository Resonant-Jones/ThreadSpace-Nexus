# 🧠 Mypy Fix Guide: `apiextensions_v1_service_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/apiextensions_v1_service_reference.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/apiextensions_v1_service_reference.py --strict
```

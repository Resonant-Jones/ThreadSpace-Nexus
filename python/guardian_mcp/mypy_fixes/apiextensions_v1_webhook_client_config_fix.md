# 🧠 Mypy Fix Guide: `apiextensions_v1_webhook_client_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/apiextensions_v1_webhook_client_config.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/apiextensions_v1_webhook_client_config.py --strict
```

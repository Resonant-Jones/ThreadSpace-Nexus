# 🧠 Mypy Fix Guide: `apiregistration_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/apiregistration_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/apiregistration_api.py --strict
```

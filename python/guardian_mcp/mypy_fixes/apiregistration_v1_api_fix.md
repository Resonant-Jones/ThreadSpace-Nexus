# 🧠 Mypy Fix Guide: `apiregistration_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/apiregistration_v1_api.py`
**Lines:** `1593`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/apiregistration_v1_api.py --strict
```

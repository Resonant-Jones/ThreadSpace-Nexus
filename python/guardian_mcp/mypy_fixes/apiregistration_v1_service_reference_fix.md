# 🧠 Mypy Fix Guide: `apiregistration_v1_service_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/apiregistration_v1_service_reference.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/apiregistration_v1_service_reference.py --strict
```

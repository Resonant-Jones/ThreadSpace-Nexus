...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/aporia_ai.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/aporia_ai.py --strict
```

# 🧠 Mypy Fix Guide: `app_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/app_attributes.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/app_attributes.py --strict
```

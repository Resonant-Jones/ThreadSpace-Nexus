...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/appdirs.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/appdirs.py --strict
```

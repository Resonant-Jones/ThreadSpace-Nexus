...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/appellseqs.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/appellseqs.py --strict
```

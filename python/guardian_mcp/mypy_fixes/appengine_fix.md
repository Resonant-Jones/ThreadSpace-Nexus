...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/appengine.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/appengine.py --strict
```

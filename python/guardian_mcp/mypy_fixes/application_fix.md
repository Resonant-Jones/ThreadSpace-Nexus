...
**File:** `.venv/lib/python3.13/site-packages/flake8/main/application.py`
**Lines:** `215`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/main/application.py --strict
```

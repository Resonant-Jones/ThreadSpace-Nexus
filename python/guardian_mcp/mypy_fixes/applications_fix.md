# 🧠 Mypy Fix Guide: `applications.py`
...
**File:** `.venv/lib/python3.13/site-packages/fastapi/applications.py`
**Lines:** `4585`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/applications.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/apply.py`
**Lines:** `324`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/apply.py --strict
```

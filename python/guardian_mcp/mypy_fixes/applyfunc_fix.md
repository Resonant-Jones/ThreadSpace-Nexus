...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/applyfunc.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/applyfunc.py --strict
```

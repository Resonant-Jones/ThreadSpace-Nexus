# 🧠 Mypy Fix Guide: `approximants.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/approximants.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/approximants.py --strict
```

# 🧠 Mypy Fix Guide: `approximation.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/calculus/approximation.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/calculus/approximation.py --strict
```

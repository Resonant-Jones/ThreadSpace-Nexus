# 🧠 Mypy Fix Guide: `approximations.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/approximations.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/approximations.py --strict
```

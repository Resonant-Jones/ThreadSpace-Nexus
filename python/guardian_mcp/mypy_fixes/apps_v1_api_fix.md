...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/apps_v1_api.py`
**Lines:** `9529`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/apps_v1_api.py --strict
```

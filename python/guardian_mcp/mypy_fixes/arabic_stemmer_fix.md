# 🧠 Mypy Fix Guide: `arabic_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/arabic_stemmer.py`
**Lines:** `1199`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/arabic_stemmer.py --strict
```

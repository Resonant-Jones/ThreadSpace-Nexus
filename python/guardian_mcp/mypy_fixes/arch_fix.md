...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/continuum_mechanics/arch.py`
**Lines:** `1025`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/continuum_mechanics/arch.py --strict
```

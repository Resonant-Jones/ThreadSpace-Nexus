...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/archetype.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/archetype.py --strict
```

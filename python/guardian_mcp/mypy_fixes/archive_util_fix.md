# 🧠 Mypy Fix Guide: `archive_util.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/archive_util.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/archive_util.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/arduino.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/arduino.py --strict
```

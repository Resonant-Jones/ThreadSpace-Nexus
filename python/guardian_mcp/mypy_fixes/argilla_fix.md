...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/argilla.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/argilla.py --strict
```

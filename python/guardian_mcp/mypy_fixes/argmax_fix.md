...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/argmax.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/argmax.py --strict
```

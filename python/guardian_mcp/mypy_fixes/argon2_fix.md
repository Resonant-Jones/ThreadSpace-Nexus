...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/argon2.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/argon2.py --strict
```

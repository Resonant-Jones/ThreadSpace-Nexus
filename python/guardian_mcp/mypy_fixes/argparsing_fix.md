...
**File:** `.venv/lib/python3.13/site-packages/_pytest/config/argparsing.py`
**Lines:** `533`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/config/argparsing.py --strict
```

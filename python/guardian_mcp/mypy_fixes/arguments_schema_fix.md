# 🧠 Mypy Fix Guide: `arguments_schema.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/experimental/arguments_schema.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/experimental/arguments_schema.py --strict
```

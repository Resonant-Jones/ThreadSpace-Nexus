...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/arize.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/arize.py --strict
```

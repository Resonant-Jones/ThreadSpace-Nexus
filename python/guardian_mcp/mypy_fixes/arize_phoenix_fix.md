# 🧠 Mypy Fix Guide: `arize_phoenix.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/arize_phoenix.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/arize_phoenix.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/stem/arlstem2.py`
**Lines:** `457`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/stem/arlstem2.py --strict
```

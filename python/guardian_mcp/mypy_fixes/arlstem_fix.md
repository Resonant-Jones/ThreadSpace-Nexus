...
**File:** `.venv/lib/python3.13/site-packages/nltk/stem/arlstem.py`
**Lines:** `361`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/stem/arlstem.py --strict
```

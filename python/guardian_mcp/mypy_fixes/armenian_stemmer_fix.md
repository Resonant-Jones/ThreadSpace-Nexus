# 🧠 Mypy Fix Guide: `armenian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/armenian_stemmer.py`
**Lines:** `316`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/armenian_stemmer.py --strict
```

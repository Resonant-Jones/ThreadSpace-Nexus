# 🧠 Mypy Fix Guide: `array_comprehension.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/array_comprehension.py`
**Lines:** `399`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/array_comprehension.py --strict
```

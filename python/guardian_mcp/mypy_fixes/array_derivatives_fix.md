# 🧠 Mypy Fix Guide: `array_derivatives.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/array_derivatives.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/array_derivatives.py --strict
```

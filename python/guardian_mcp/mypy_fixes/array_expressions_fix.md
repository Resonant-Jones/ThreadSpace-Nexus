# 🧠 Mypy Fix Guide: `array_expressions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/array_expressions.py`
**Lines:** `1969`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/array_expressions.py --strict
```

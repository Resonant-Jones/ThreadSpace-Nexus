...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/array.py`
**Lines:** `509`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/array.py --strict
```

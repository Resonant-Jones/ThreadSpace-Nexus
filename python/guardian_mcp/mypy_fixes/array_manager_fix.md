# 🧠 Mypy Fix Guide: `array_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/internals/array_manager.py`
**Lines:** `1340`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/internals/array_manager.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/ops/array_ops.py`
**Lines:** `604`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/ops/array_ops.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/array_utils.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/array_utils.py --strict
```

# 🧠 Mypy Fix Guide: `arrayexpr_derivatives.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/arrayexpr_derivatives.py`
**Lines:** `194`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/arrayexpr_derivatives.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arraylike.py`
**Lines:** `530`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arraylike.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/arrayop.py`
**Lines:** `528`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/arrayop.py --strict
```

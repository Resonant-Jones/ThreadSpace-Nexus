...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/arrayprint.py`
**Lines:** `1775`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/arrayprint.py --strict
```

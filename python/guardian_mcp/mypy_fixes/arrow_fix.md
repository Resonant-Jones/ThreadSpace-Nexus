...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/arrow.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/arrow.py --strict
```

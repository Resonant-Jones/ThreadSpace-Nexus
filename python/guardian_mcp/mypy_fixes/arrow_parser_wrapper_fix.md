# 🧠 Mypy Fix Guide: `arrow_parser_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/parsers/arrow_parser_wrapper.py`
**Lines:** `295`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/parsers/arrow_parser_wrapper.py --strict
```

# 🧠 Mypy Fix Guide: `artifact_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/artifact_attributes.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/artifact_attributes.py --strict
```

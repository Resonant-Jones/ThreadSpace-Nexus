...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/arturo.py`
**Lines:** `249`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/arturo.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/asc.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/asc.py --strict
```

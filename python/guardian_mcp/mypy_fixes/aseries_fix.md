...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/aseries.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/aseries.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/middleware/asgi2.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/middleware/asgi2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/httpx/_transports/asgi.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpx/_transports/asgi.py --strict
```

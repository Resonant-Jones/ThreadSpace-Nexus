...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/ask.py`
**Lines:** `651`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/ask.py --strict
```

# 🧠 Mypy Fix Guide: `ask_generated.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/ask_generated.py`
**Lines:** `352`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/ask_generated.py --strict
```

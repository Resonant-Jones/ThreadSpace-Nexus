...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/asm.py`
**Lines:** `1051`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/asm.py --strict
```

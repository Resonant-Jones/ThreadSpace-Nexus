...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/asn1.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/asn1.py --strict
```

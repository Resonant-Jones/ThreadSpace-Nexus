...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/passthrough_endpoints/assembly_ai.py`
**Lines:** `2`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/passthrough_endpoints/assembly_ai.py --strict
```

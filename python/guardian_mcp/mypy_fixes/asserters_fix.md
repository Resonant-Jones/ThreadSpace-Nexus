...
**File:** `.venv/lib/python3.13/site-packages/pandas/_testing/asserters.py`
**Lines:** `1459`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_testing/asserters.py --strict
```

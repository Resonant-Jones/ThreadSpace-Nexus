...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/assertions.py`
**Lines:** `989`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/assertions.py --strict
```

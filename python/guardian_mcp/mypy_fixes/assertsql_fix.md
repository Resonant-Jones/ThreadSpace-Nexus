...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/assertsql.py`
**Lines:** `516`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/assertsql.py --strict
```

# 🧠 Mypy Fix Guide: `assistant_deleted.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_deleted.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_deleted.py --strict
```

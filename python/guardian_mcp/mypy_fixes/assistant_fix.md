...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant.py --strict
```

# 🧠 Mypy Fix Guide: `assistant_response_format_option.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_response_format_option.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_response_format_option.py --strict
```

# 🧠 Mypy Fix Guide: `assistant_stream_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_stream_event.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_stream_event.py --strict
```

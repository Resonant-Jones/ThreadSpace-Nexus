# 🧠 Mypy Fix Guide: `assistant_tool_choice_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_tool_choice_function.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_tool_choice_function.py --strict
```

# 🧠 Mypy Fix Guide: `assistant_tool_choice_function_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_tool_choice_function_param.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_tool_choice_function_param.py --strict
```

# 🧠 Mypy Fix Guide: `assistant_tool_choice_option.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_tool_choice_option.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_tool_choice_option.py --strict
```

# 🧠 Mypy Fix Guide: `assistant_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/assistant_update_params.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/assistant_update_params.py --strict
```

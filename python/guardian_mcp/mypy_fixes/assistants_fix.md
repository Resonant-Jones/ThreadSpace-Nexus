...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/azure/assistants.py`
**Lines:** `1025`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/azure/assistants.py --strict
```

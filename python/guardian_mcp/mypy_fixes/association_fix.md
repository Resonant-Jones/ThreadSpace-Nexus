...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/association.py`
**Lines:** `476`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/association.py --strict
```

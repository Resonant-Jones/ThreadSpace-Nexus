# 🧠 Mypy Fix Guide: `associationproxy.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/associationproxy.py`
**Lines:** `2013`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/associationproxy.py --strict
```

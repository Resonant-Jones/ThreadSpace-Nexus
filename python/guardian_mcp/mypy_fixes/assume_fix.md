...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/assume.py`
**Lines:** `485`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/assume.py --strict
```

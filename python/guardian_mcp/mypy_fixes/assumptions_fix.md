...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/assumptions.py`
**Lines:** `692`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/assumptions.py --strict
```

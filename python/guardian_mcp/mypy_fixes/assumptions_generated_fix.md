# 🧠 Mypy Fix Guide: `assumptions_generated.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/assumptions_generated.py`
**Lines:** `1615`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/assumptions_generated.py --strict
```

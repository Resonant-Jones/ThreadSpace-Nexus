...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/ast_helpers.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/ast_helpers.py --strict
```

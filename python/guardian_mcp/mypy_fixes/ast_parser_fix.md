...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/ast_parser.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/ast_parser.py --strict
```

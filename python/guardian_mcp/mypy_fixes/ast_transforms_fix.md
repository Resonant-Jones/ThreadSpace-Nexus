# 🧠 Mypy Fix Guide: `ast_transforms.py`
...
**File:** `.venv/lib/python3.13/site-packages/pycparser/ast_transforms.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/ast_transforms.py --strict
```

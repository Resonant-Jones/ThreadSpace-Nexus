...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/astmerge.py`
**Lines:** `564`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/astmerge.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/aststrip.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/aststrip.py --strict
```

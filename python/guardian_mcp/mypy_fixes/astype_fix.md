...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/dtypes/astype.py`
**Lines:** `301`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/dtypes/astype.py --strict
```

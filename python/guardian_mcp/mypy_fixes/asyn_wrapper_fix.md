# 🧠 Mypy Fix Guide: `asyn_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/asyn_wrapper.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/asyn_wrapper.py --strict
```

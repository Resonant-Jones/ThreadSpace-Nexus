...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/async_api.py`
**Lines:** `753`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/async_api.py --strict
```

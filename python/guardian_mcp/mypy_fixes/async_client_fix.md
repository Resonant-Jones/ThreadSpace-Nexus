# 🧠 Mypy Fix Guide: `async_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/async_client.py`
**Lines:** `521`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/async_client.py --strict
```

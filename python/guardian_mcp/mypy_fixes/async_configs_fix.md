# 🧠 Mypy Fix Guide: `async_configs.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/async_configs.py`
**Lines:** `1410`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/async_configs.py --strict
```

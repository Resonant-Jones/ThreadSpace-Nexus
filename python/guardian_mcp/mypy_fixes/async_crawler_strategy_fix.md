# 🧠 Mypy Fix Guide: `async_crawler_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/async_crawler_strategy.py`
**Lines:** `2172`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/async_crawler_strategy.py --strict
```

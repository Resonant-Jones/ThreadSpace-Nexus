# 🧠 Mypy Fix Guide: `async_database.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/async_database.py`
**Lines:** `564`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/async_database.py --strict
```

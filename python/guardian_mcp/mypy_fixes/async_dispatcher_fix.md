# 🧠 Mypy Fix Guide: `async_dispatcher.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/async_dispatcher.py`
**Lines:** `646`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/async_dispatcher.py --strict
```

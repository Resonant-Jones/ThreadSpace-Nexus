# 🧠 Mypy Fix Guide: `async_fastapi.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/async_fastapi.py`
**Lines:** `681`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/async_fastapi.py --strict
```

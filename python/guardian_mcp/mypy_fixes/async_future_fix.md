# 🧠 Mypy Fix Guide: `async_future.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/future/async_future.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/future/async_future.py --strict
```

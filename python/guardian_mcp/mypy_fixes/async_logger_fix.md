# 🧠 Mypy Fix Guide: `async_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/async_logger.py`
**Lines:** `373`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/async_logger.py --strict
```

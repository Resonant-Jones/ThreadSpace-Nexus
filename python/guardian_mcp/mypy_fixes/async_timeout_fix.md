# 🧠 Mypy Fix Guide: `async_timeout.py`
...
**File:** `.venv/lib/python3.13/site-packages/websockets/asyncio/async_timeout.py`
**Lines:** `282`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/asyncio/async_timeout.py --strict
```

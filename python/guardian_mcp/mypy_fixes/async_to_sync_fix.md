# 🧠 Mypy Fix Guide: `async_to_sync.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/async_to_sync.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/async_to_sync.py --strict
```

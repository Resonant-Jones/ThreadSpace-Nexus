# 🧠 Mypy Fix Guide: `async_webcrawler.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/async_webcrawler.py`
**Lines:** `746`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/async_webcrawler.py --strict
```

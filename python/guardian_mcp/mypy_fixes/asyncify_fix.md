...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/asyncify.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/asyncify.py --strict
```

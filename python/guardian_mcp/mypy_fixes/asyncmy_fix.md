...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/asyncmy.py`
**Lines:** `339`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/asyncmy.py --strict
```

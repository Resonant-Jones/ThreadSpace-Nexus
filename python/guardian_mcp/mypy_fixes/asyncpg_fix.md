...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/asyncpg.py`
**Lines:** `1287`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/asyncpg.py --strict
```

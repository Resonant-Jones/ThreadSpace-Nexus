...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/athina.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/athina.py --strict
```

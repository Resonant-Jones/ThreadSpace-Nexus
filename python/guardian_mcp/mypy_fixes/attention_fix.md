...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/attention.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/attention.py --strict
```

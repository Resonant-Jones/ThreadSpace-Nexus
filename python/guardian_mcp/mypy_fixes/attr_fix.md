...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/event/attr.py`
**Lines:** `655`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/event/attr.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/analysis/attrdefined.py`
**Lines:** `436`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/analysis/attrdefined.py --strict
```

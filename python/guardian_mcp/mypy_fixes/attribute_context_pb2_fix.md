# 🧠 Mypy Fix Guide: `attribute_context_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/rpc/context/attribute_context_pb2.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/rpc/context/attribute_context_pb2.py --strict
```

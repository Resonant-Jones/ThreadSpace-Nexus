...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/attributes.py`
**Lines:** `2835`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/attributes.py --strict
```

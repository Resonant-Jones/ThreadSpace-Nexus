# 🧠 Mypy Fix Guide: `audio_classification.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/audio_classification.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/audio_classification.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/audio/audio.py`
**Lines:** `166`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/audio/audio.py --strict
```

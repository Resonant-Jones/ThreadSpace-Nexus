...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio_model.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio_model.py --strict
```

# 🧠 Mypy Fix Guide: `audio_response_format.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio_response_format.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio_response_format.py --strict
```

# 🧠 Mypy Fix Guide: `audio_to_audio.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/audio_to_audio.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/audio_to_audio.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_helpers/audit_logs.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_helpers/audit_logs.py --strict
```

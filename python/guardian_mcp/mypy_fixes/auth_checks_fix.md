...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_checks.py`
**Lines:** `1688`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_checks.py --strict
```

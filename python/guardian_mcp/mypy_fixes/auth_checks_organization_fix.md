# 🧠 Mypy Fix Guide: `auth_checks_organization.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_checks_organization.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_checks_organization.py --strict
```

# 🧠 Mypy Fix Guide: `auth_exception_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_exception_handler.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_exception_handler.py --strict
```

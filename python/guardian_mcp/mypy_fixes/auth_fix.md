...
**File:** `.venv/lib/python3.13/site-packages/websockets/legacy/auth.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/legacy/auth.py --strict
```

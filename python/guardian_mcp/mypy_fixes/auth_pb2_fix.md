...
**File:** `.venv/lib/python3.13/site-packages/google/api/auth_pb2.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/auth_pb2.py --strict
```

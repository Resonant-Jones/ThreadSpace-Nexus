...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_utils.py`
**Lines:** `566`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/auth_utils.py --strict
```

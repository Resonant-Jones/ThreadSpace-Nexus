# 🧠 Mypy Fix Guide: `authentication_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/authentication_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/authentication_api.py --strict
```

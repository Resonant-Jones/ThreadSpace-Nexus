# 🧠 Mypy Fix Guide: `authentication.py`
...
**File:** `.venv/lib/python3.13/site-packages/starlette/middleware/authentication.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/middleware/authentication.py --strict
```

# 🧠 Mypy Fix Guide: `authentication_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/authentication_v1_api.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/authentication_v1_api.py --strict
```

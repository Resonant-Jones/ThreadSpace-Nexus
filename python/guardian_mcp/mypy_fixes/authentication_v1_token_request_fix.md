# 🧠 Mypy Fix Guide: `authentication_v1_token_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/authentication_v1_token_request.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/authentication_v1_token_request.py --strict
```

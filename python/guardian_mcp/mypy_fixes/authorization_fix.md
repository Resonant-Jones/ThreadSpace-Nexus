# 🧠 Mypy Fix Guide: `authorization.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/authorization.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/authorization.py --strict
```

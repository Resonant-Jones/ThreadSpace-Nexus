# 🧠 Mypy Fix Guide: `authorization_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/authorization_v1_api.py`
**Lines:** `687`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/authorization_v1_api.py --strict
```

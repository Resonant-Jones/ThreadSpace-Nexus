# 🧠 Mypy Fix Guide: `auto_file_chunking_strategy_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/auto_file_chunking_strategy_param.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/auto_file_chunking_strategy_param.py --strict
```

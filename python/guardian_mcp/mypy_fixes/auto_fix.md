...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_backends/auto.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_backends/auto.py --strict
```

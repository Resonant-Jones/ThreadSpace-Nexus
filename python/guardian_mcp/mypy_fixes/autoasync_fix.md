...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/autoasync.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/autoasync.py --strict
```

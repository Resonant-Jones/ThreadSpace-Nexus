...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/autocommand.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/autocommand.py --strict
```

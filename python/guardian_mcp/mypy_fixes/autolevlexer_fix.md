# 🧠 Mypy Fix Guide: `autolevlexer.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/_antlr/autolevlexer.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/_antlr/autolevlexer.py --strict
```

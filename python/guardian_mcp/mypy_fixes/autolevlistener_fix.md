# 🧠 Mypy Fix Guide: `autolevlistener.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/_antlr/autolevlistener.py`
**Lines:** `421`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/_antlr/autolevlistener.py --strict
```

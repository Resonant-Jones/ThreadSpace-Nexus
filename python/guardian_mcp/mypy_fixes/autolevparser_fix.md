# 🧠 Mypy Fix Guide: `autolevparser.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/_antlr/autolevparser.py`
**Lines:** `3063`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/_antlr/autolevparser.py --strict
```

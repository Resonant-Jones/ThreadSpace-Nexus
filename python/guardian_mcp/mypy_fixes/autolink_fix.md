...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/autolink.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/autolink.py --strict
```

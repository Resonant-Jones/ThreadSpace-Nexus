...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/automain.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/automain.py --strict
```

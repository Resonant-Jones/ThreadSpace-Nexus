...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/automap.py`
**Lines:** `1701`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/automap.py --strict
```

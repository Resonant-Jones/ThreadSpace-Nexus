# 🧠 Mypy Fix Guide: `automatic_speech_recognition.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/automatic_speech_recognition.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/automatic_speech_recognition.py --strict
```

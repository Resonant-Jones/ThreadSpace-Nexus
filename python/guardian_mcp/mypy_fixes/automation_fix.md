...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/automation.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/automation.py --strict
```

# 🧠 Mypy Fix Guide: `autonotebook.py`
...
**File:** `.venv/lib/python3.13/site-packages/tqdm/autonotebook.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/autonotebook.py --strict
```

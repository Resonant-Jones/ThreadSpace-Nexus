...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/autoparse.py`
**Lines:** `333`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/autocommand/autoparse.py --strict
```

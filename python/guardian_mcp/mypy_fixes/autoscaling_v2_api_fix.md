# 🧠 Mypy Fix Guide: `autoscaling_v2_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/autoscaling_v2_api.py`
**Lines:** `1843`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/autoscaling_v2_api.py --strict
```

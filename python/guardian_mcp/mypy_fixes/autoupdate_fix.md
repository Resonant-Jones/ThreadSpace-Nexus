...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/autoupdate.py`
**Lines:** `215`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/autoupdate.py --strict
```

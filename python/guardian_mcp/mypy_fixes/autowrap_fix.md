...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/autowrap.py`
**Lines:** `1178`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/autowrap.py --strict
```

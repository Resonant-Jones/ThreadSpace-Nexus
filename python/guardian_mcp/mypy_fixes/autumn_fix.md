...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/autumn.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/autumn.py --strict
```

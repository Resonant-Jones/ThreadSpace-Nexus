...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/auxfuncs.py`
**Lines:** `1004`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/auxfuncs.py --strict
```

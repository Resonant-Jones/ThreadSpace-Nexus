# 🧠 Mypy Fix Guide: `availability.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/_compilation/availability.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/_compilation/availability.py --strict
```

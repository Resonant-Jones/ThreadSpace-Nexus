# 🧠 Mypy Fix Guide: `aws_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/aws_attributes.py`
**Lines:** `345`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/aws_attributes.py --strict
```

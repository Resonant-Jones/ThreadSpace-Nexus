# 🧠 Mypy Fix Guide: `aws_secret_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/secret_managers/aws_secret_manager.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/secret_managers/aws_secret_manager.py --strict
```

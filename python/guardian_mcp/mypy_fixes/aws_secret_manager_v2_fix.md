# 🧠 Mypy Fix Guide: `aws_secret_manager_v2.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/secret_managers/aws_secret_manager_v2.py`
**Lines:** `360`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/secret_managers/aws_secret_manager_v2.py --strict
```

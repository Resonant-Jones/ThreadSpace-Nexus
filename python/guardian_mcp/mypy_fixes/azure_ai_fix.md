...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/azure_ai.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/azure_ai.py --strict
```

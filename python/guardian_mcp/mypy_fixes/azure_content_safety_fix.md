# 🧠 Mypy Fix Guide: `azure_content_safety.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/azure_content_safety.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/azure_content_safety.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/azure.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/azure.py --strict
```

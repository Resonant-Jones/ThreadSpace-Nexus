# 🧠 Mypy Fix Guide: `azure_storage.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/azure_storage/azure_storage.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/azure_storage/azure_storage.py --strict
```

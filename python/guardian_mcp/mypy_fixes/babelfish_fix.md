...
**File:** `.venv/lib/python3.13/site-packages/nltk/misc/babelfish.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/misc/babelfish.py --strict
```

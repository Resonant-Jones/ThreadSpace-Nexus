# 🧠 Mypy Fix Guide: `backend_application.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/backend_application.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/backend_application.py --strict
```

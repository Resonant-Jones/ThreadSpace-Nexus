# 🧠 Mypy Fix Guide: `backend_ctypes.py`
...
**File:** `.venv/lib/python3.13/site-packages/cffi/backend_ctypes.py`
**Lines:** `1121`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/backend_ctypes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/backend.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/backend.py --strict
```

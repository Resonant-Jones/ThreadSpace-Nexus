...
**File:** `.venv/lib/python3.13/site-packages/google/api/backend_pb2.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/backend_pb2.py --strict
```

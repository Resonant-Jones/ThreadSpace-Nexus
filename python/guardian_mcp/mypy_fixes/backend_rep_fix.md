...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/backend/backend_rep.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/backend/backend_rep.py --strict
```

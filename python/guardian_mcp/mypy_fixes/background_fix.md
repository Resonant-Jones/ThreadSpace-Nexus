...
**File:** `.venv/lib/python3.13/site-packages/fastapi/background.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/background.py --strict
```

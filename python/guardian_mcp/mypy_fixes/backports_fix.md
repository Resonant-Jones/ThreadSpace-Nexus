...
**File:** `.venv/lib/python3.13/site-packages/joblib/backports.py`
**Lines:** `195`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/backports.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/backticks.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/backticks.py --strict
```

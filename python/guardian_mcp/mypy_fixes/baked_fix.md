...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/baked.py`
**Lines:** `570`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/baked.py --strict
```

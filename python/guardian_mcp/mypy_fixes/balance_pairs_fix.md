# 🧠 Mypy Fix Guide: `balance_pairs.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/balance_pairs.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/balance_pairs.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/bar.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/bar.py --strict
```

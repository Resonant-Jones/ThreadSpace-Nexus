...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/bare.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/bare.py --strict
```

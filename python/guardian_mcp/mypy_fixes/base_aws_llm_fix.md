# 🧠 Mypy Fix Guide: `base_aws_llm.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/base_aws_llm.py`
**Lines:** `755`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/base_aws_llm.py --strict
```

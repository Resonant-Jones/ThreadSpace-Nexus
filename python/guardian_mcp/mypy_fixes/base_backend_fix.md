# 🧠 Mypy Fix Guide: `base_backend.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/backends/base_backend.py`
**Lines:** `419`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/backends/base_backend.py --strict
```

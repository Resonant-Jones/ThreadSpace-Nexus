...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/base_cache.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/base_cache.py --strict
```

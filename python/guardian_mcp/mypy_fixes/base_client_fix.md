...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/base_client.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/base_client.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/embed/base_embed.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/embed/base_embed.py --strict
```

# 🧠 Mypy Fix Guide: `base_health_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/base_health_check.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/base_health_check.py --strict
```

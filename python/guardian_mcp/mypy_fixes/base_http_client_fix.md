# 🧠 Mypy Fix Guide: `base_http_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/base_http_client.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/base_http_client.py --strict
```

# 🧠 Mypy Fix Guide: `base_model_iterator.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/base_llm/base_model_iterator.py`
**Lines:** `212`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/base_llm/base_model_iterator.py --strict
```

# 🧠 Mypy Fix Guide: `base_operator.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/base_operator.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/base_operator.py --strict
```

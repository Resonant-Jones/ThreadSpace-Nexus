...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/parsers/base_parser.py`
**Lines:** `1462`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/parsers/base_parser.py --strict
```

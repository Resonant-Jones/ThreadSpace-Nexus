# 🧠 Mypy Fix Guide: `base_protocol.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/base_protocol.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/base_protocol.py --strict
```

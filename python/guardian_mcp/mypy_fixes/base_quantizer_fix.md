# 🧠 Mypy Fix Guide: `base_quantizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/base_quantizer.py`
**Lines:** `564`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/base_quantizer.py --strict
```

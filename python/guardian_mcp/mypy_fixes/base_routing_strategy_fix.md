# 🧠 Mypy Fix Guide: `base_routing_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/base_routing_strategy.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/base_routing_strategy.py --strict
```

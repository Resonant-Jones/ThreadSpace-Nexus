# 🧠 Mypy Fix Guide: `base_secret_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/secret_managers/base_secret_manager.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/secret_managers/base_secret_manager.py --strict
```

# 🧠 Mypy Fix Guide: `base_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/base_strategy.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/base_strategy.py --strict
```

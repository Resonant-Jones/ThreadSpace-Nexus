# 🧠 Mypy Fix Guide: `base_tokenizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/implementations/base_tokenizer.py`
**Lines:** `418`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/implementations/base_tokenizer.py --strict
```

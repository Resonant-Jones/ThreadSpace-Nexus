...
**File:** `.venv/lib/python3.13/site-packages/chromadb/base_types.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/base_types.py --strict
```

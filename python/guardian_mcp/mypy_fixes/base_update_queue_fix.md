# 🧠 Mypy Fix Guide: `base_update_queue.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/base_update_queue.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/base_update_queue.py --strict
```

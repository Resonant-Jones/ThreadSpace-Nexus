...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/base_llm/base_utils.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/base_llm/base_utils.py --strict
```

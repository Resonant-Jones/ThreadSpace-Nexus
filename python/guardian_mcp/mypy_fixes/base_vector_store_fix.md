# 🧠 Mypy Fix Guide: `base_vector_store.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/vector_stores/base_vector_store.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/vector_stores/base_vector_store.py --strict
```

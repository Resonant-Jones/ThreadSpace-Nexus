...
**File:** `.venv/lib/python3.13/site-packages/sympy/categories/baseclasses.py`
**Lines:** `978`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/categories/baseclasses.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/supervisors/basereload.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/supervisors/basereload.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/basestemmer.py`
**Lines:** `323`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/basestemmer.py --strict
```

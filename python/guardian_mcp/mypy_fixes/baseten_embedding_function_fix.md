# 🧠 Mypy Fix Guide: `baseten_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/baseten_embedding_function.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/baseten_embedding_function.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/baseten.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/baseten.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/basis.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/basis.py --strict
```

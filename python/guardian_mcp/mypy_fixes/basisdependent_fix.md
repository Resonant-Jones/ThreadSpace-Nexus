# 🧠 Mypy Fix Guide: `basisdependent.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/basisdependent.py`
**Lines:** `374`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/basisdependent.py --strict
```

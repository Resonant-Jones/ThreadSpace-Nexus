# 🧠 Mypy Fix Guide: `basque_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/basque_stemmer.py`
**Lines:** `683`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/basque_stemmer.py --strict
```

# 🧠 Mypy Fix Guide: `batch_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/batch_create_params.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/batch_create_params.py --strict
```

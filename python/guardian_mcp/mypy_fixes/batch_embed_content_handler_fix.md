# 🧠 Mypy Fix Guide: `batch_embed_content_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/gemini_embeddings/batch_embed_content_handler.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/gemini_embeddings/batch_embed_content_handler.py --strict
```

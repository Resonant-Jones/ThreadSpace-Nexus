# 🧠 Mypy Fix Guide: `batch_embed_content_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/gemini_embeddings/batch_embed_content_transformation.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/gemini_embeddings/batch_embed_content_transformation.py --strict
```

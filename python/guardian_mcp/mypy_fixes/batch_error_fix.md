...
**File:** `.venv/lib/python3.13/site-packages/openai/types/batch_error.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/batch_error.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/batch.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/batch.py --strict
```

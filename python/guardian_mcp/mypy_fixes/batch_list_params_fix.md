# 🧠 Mypy Fix Guide: `batch_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/batch_list_params.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/batch_list_params.py --strict
```

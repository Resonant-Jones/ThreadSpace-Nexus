# 🧠 Mypy Fix Guide: `batch_redis_get.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/batch_redis_get.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/batch_redis_get.py --strict
```

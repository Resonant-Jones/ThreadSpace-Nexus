...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/batch_utils.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/batch_utils.py --strict
```

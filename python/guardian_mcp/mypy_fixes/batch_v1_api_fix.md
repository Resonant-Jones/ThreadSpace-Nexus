# 🧠 Mypy Fix Guide: `batch_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/batch_v1_api.py`
**Lines:** `3544`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/batch_v1_api.py --strict
```

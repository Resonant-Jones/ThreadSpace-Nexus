...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/batches.py`
**Lines:** `514`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/batches.py --strict
```

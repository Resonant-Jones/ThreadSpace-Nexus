...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/vcs/bazaar.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/vcs/bazaar.py --strict
```

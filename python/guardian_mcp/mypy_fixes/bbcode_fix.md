...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/bbcode.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/bbcode.py --strict
```

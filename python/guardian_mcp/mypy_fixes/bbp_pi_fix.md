...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/bbp_pi.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/bbp_pi.py --strict
```

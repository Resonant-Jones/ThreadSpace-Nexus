...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/bcp47.py`
**Lines:** `218`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/bcp47.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/bdist_dumb.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/bdist_dumb.py --strict
```

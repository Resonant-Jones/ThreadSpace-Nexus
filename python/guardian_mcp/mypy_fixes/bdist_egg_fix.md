...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/bdist_egg.py`
**Lines:** `477`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/bdist_egg.py --strict
```

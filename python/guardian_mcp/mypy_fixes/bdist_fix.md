...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/bdist.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/bdist.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/bdist_rpm.py`
**Lines:** `598`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/bdist_rpm.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/wheel/bdist_wheel.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/wheel/bdist_wheel.py --strict
```

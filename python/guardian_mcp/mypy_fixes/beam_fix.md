...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/continuum_mechanics/beam.py`
**Lines:** `3903`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/continuum_mechanics/beam.py --strict
```

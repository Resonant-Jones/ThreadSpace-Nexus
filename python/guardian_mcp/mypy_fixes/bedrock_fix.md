...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/bedrock.py`
**Lines:** `550`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/bedrock.py --strict
```

# 🧠 Mypy Fix Guide: `bedrock_guardrails.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/guardrails/guardrail_hooks/bedrock_guardrails.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/guardrails/guardrail_hooks/bedrock_guardrails.py --strict
```

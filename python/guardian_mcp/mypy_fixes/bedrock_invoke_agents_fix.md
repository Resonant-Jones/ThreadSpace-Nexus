# 🧠 Mypy Fix Guide: `bedrock_invoke_agents.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/bedrock_invoke_agents.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/bedrock_invoke_agents.py --strict
```

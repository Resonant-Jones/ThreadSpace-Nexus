# 🧠 Mypy Fix Guide: `bedrock_knowledgebase.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/rag/bedrock_knowledgebase.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/rag/bedrock_knowledgebase.py --strict
```

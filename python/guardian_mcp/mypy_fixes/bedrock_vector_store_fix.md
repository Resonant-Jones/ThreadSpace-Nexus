# 🧠 Mypy Fix Guide: `bedrock_vector_store.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/vector_stores/bedrock_vector_store.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/vector_stores/bedrock_vector_store.py --strict
```

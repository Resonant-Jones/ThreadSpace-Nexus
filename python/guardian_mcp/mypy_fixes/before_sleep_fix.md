# 🧠 Mypy Fix Guide: `before_sleep.py`
...
**File:** `.venv/lib/python3.13/site-packages/tenacity/before_sleep.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/tenacity/before_sleep.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/tqdm/contrib/bells.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/contrib/bells.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_arit.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_arit.py --strict
```

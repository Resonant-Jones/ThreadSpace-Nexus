# 🧠 Mypy Fix Guide: `bench_assumptions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_assumptions.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_assumptions.py --strict
```

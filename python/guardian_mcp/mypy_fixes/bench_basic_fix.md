...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_basic.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_basic.py --strict
```

# 🧠 Mypy Fix Guide: `bench_discrete_log.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/benchmarks/bench_discrete_log.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/benchmarks/bench_discrete_log.py --strict
```

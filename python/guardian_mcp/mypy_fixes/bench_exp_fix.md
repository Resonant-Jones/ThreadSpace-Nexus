...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/benchmarks/bench_exp.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/benchmarks/bench_exp.py --strict
```

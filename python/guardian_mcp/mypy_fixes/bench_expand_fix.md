# 🧠 Mypy Fix Guide: `bench_expand.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_expand.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_expand.py --strict
```

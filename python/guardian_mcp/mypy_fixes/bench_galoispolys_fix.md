# 🧠 Mypy Fix Guide: `bench_galoispolys.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/benchmarks/bench_galoispolys.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/benchmarks/bench_galoispolys.py --strict
```

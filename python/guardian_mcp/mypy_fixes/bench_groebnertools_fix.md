# 🧠 Mypy Fix Guide: `bench_groebnertools.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/benchmarks/bench_groebnertools.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/benchmarks/bench_groebnertools.py --strict
```

# 🧠 Mypy Fix Guide: `bench_integrate.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/benchmarks/bench_integrate.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/benchmarks/bench_integrate.py --strict
```

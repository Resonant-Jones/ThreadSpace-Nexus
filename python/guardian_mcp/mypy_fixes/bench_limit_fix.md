...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/benchmarks/bench_limit.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/benchmarks/bench_limit.py --strict
```

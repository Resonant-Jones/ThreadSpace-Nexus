# 🧠 Mypy Fix Guide: `bench_matrix.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/benchmarks/bench_matrix.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/benchmarks/bench_matrix.py --strict
```

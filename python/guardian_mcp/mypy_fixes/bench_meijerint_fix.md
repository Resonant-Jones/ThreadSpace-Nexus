# 🧠 Mypy Fix Guide: `bench_meijerint.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/benchmarks/bench_meijerint.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/benchmarks/bench_meijerint.py --strict
```

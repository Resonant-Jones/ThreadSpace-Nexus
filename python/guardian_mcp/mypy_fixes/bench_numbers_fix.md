# 🧠 Mypy Fix Guide: `bench_numbers.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_numbers.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_numbers.py --strict
```

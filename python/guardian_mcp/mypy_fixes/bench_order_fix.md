...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/benchmarks/bench_order.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/benchmarks/bench_order.py --strict
```

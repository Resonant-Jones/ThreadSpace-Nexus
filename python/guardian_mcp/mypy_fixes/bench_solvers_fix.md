# 🧠 Mypy Fix Guide: `bench_solvers.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/benchmarks/bench_solvers.py`
**Lines:** `543`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/benchmarks/bench_solvers.py --strict
```

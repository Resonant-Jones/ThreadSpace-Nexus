# 🧠 Mypy Fix Guide: `bench_special.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/benchmarks/bench_special.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/benchmarks/bench_special.py --strict
```

# 🧠 Mypy Fix Guide: `bench_symbench.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/benchmarks/bench_symbench.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/benchmarks/bench_symbench.py --strict
```

# 🧠 Mypy Fix Guide: `bench_sympify.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_sympify.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/benchmarks/bench_sympify.py --strict
```

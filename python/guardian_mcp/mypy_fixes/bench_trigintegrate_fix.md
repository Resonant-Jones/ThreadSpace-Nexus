# 🧠 Mypy Fix Guide: `bench_trigintegrate.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/benchmarks/bench_trigintegrate.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/benchmarks/bench_trigintegrate.py --strict
```

# 🧠 Mypy Fix Guide: `benchmark_all.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/benchmark_all.py`
**Lines:** `526`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/benchmark_all.py --strict
```

# 🧠 Mypy Fix Guide: `benchmark_e2e.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/benchmark_e2e.py`
**Lines:** `608`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/benchmark_e2e.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/benchmark.py`
**Lines:** `610`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/benchmark.py --strict
```

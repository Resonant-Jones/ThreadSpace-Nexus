# 🧠 Mypy Fix Guide: `benchmark_gpt2.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/benchmark_gpt2.py`
**Lines:** `413`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/benchmark_gpt2.py --strict
```

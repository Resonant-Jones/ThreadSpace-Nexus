# 🧠 Mypy Fix Guide: `benchmark_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/benchmark_helper.py`
**Lines:** `647`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/benchmark_helper.py --strict
```

# 🧠 Mypy Fix Guide: `benchmark_longformer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/longformer/benchmark_longformer.py`
**Lines:** `821`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/longformer/benchmark_longformer.py --strict
```

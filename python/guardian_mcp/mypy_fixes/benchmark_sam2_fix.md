# 🧠 Mypy Fix Guide: `benchmark_sam2.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/benchmark_sam2.py`
**Lines:** `638`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/benchmark_sam2.py --strict
```

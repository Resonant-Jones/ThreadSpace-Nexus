...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/berry.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/berry.py --strict
```

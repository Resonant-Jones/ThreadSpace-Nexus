# 🧠 Mypy Fix Guide: `bert_perf_test.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/bert_perf_test.py`
**Lines:** `633`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/bert_perf_test.py --strict
```

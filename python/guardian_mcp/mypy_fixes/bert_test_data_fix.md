# 🧠 Mypy Fix Guide: `bert_test_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/bert_test_data.py`
**Lines:** `641`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/bert_test_data.py --strict
```

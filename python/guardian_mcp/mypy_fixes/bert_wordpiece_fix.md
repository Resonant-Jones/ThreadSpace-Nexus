# 🧠 Mypy Fix Guide: `bert_wordpiece.py`
...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/implementations/bert_wordpiece.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/implementations/bert_wordpiece.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/bessel.py`
**Lines:** `2208`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/bessel.py --strict
```

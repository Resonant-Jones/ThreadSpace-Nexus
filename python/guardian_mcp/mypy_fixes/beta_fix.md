...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/beta/beta.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/beta/beta.py --strict
```

# 🧠 Mypy Fix Guide: `beta_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/beta_functions.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/beta_functions.py --strict
```

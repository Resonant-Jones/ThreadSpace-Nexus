# 🧠 Mypy Fix Guide: `bff_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/bff_strategy.py`
**Lines:** `257`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/bff_strategy.py --strict
```

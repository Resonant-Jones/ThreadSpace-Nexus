# 🧠 Mypy Fix Guide: `bfs_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/bfs_strategy.py`
**Lines:** `245`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/bfs_strategy.py --strict
```

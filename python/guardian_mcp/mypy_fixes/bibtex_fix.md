...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/bibtex.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/bibtex.py --strict
```

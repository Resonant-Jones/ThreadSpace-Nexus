# 🧠 Mypy Fix Guide: `bidi_connection.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/bidi_connection.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/bidi_connection.py --strict
```

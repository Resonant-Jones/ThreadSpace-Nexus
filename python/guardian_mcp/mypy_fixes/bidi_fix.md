...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/bidi.py`
**Lines:** `747`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/bidi.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chardet/big5prober.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/big5prober.py --strict
```

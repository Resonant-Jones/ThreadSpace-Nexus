...
**File:** `.venv/lib/python3.13/site-packages/aiofiles/threadpool/binary.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiofiles/threadpool/binary.py --strict
```

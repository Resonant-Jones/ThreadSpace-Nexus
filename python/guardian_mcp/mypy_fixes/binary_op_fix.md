...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/binary_op.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/binary_op.py --strict
```

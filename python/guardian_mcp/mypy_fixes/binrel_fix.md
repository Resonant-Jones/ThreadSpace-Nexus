...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/relation/binrel.py`
**Lines:** `212`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/relation/binrel.py --strict
```

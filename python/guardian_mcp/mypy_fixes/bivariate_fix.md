...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/bivariate.py`
**Lines:** `509`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/bivariate.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/bleu_score.py`
**Lines:** `714`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/bleu_score.py --strict
```

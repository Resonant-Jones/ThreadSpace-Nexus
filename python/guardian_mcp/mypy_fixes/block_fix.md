...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_core/block.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_core/block.py --strict
```

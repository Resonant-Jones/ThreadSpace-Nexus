# 🧠 Mypy Fix Guide: `block_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/mistune/block_parser.py`
**Lines:** `361`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/block_parser.py --strict
```

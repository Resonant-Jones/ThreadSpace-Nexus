...
**File:** `.venv/lib/python3.13/site-packages/mypyc/analysis/blockfreq.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/analysis/blockfreq.py --strict
```

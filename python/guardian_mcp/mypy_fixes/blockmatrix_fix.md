...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/blockmatrix.py`
**Lines:** `975`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/blockmatrix.py --strict
```

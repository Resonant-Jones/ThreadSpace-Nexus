...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/blockquote.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/blockquote.py --strict
```

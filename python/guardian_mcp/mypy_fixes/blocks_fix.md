...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/internals/blocks.py`
**Lines:** `2923`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/internals/blocks.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/blueprint.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/blueprint.py --strict
```

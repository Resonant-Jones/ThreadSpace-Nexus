...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/bnc.py`
**Lines:** `265`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/bnc.py --strict
```

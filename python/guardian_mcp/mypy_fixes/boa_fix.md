...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/boa.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/boa.py --strict
```

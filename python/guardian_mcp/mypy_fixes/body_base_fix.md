...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/body_base.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/body_base.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/body.py`
**Lines:** `710`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/body.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/boolalg.py`
**Lines:** `3587`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/boolalg.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/boolean.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/boolean.py --strict
```

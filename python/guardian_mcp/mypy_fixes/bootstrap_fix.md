...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/bootstrap.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/bootstrap.py --strict
```

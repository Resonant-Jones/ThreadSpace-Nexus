# 🧠 Mypy Fix Guide: `bootstrap_gen.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/bootstrap_gen.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/bootstrap_gen.py --strict
```

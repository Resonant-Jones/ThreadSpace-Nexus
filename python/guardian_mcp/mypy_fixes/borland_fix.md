...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/borland.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/borland.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/boson.py`
**Lines:** `243`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/boson.py --strict
```

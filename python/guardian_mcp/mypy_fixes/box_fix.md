...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/box.py`
**Lines:** `480`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/box.py --strict
```

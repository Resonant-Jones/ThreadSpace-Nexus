...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/bqn.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/bqn.py --strict
```

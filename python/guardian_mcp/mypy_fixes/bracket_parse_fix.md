# 🧠 Mypy Fix Guide: `bracket_parse.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/bracket_parse.py`
**Lines:** `237`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/bracket_parse.py --strict
```

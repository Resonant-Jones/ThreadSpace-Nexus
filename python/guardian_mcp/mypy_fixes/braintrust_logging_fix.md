# 🧠 Mypy Fix Guide: `braintrust_logging.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/braintrust_logging.py`
**Lines:** `450`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/braintrust_logging.py --strict
```

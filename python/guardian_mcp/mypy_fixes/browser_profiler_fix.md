# 🧠 Mypy Fix Guide: `browser_profiler.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/browser_profiler.py`
**Lines:** `1011`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/browser_profiler.py --strict
```

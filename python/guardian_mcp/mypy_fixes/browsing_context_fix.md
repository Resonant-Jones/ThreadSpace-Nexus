# 🧠 Mypy Fix Guide: `browsing_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/browsing_context.py`
**Lines:** `732`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/browsing_context.py --strict
```

# 🧠 Mypy Fix Guide: `brute_force_index.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/brute_force_index.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/brute_force_index.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/bsplines.py`
**Lines:** `348`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/bsplines.py --strict
```

# 🧠 Mypy Fix Guide: `budget_alert_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/SlackAlerting/budget_alert_types.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/SlackAlerting/budget_alert_types.py --strict
```

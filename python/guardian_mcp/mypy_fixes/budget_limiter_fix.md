# 🧠 Mypy Fix Guide: `budget_limiter.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/budget_limiter.py`
**Lines:** `821`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/budget_limiter.py --strict
```

# 🧠 Mypy Fix Guide: `budget_management_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/budget_management_endpoints.py`
**Lines:** `297`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/budget_management_endpoints.py --strict
```

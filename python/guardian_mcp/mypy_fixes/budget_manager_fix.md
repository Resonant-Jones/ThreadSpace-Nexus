# 🧠 Mypy Fix Guide: `budget_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/budget_manager.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/budget_manager.py --strict
```

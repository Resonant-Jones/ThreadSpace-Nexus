...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/interchange/buffer.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/interchange/buffer.py --strict
```

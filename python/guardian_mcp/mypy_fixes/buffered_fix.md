...
**File:** `.venv/lib/python3.13/site-packages/anyio/streams/buffered.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/streams/buffered.py --strict
```

# 🧠 Mypy Fix Guide: `build_and_package_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/build_and_package_info.py`
**Lines:** `2`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/build_and_package_info.py --strict
```

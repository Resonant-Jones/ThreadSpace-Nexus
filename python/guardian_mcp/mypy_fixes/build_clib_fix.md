...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_clib.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_clib.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/build_env.py`
**Lines:** `325`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/build_env.py --strict
```

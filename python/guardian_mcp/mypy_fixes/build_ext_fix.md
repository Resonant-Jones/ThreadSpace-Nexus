...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_ext.py`
**Lines:** `812`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_ext.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/build.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/build.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/build_meta.py`
**Lines:** `548`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/build_meta.py --strict
```

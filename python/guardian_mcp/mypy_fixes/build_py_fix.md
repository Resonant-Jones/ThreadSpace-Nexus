...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_py.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_py.py --strict
```

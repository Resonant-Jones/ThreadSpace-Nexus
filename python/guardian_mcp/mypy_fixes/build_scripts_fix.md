# 🧠 Mypy Fix Guide: `build_scripts.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_scripts.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/build_scripts.py --strict
```

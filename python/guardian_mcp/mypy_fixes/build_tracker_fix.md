# 🧠 Mypy Fix Guide: `build_tracker.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/operations/build/build_tracker.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/operations/build/build_tracker.py --strict
```

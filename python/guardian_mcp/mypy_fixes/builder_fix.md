...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/builder.py`
**Lines:** `1526`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/builder.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/discovery/builtin.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/discovery/builtin.py --strict
```

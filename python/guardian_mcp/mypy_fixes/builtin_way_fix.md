...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/builtin_way.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/builtin_way.py --strict
```

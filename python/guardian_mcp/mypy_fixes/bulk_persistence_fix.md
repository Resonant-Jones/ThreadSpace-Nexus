# 🧠 Mypy Fix Guide: `bulk_persistence.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/bulk_persistence.py`
**Lines:** `2123`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/bulk_persistence.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/wheels/bundle.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/wheels/bundle.py --strict
```

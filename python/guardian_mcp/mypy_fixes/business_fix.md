...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/business.py`
**Lines:** `625`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/business.py --strict
```

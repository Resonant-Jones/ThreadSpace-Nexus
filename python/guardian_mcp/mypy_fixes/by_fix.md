...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/by.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/by.py --strict
```

# 🧠 Mypy Fix Guide: `byte_level_bpe.py`
...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/implementations/byte_level_bpe.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/implementations/byte_level_bpe.py --strict
```

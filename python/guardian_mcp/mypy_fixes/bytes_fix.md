...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/bytes.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/bytes.py --strict
```

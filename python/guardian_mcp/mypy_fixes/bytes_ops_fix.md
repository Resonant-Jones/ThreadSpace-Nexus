...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/bytes_ops.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/bytes_ops.py --strict
```

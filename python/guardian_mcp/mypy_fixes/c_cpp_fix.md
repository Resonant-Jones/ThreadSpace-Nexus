...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/c_cpp.py`
**Lines:** `414`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/c_cpp.py --strict
```

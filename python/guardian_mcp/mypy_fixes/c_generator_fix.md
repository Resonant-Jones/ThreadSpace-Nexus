...
**File:** `.venv/lib/python3.13/site-packages/pycparser/c_generator.py`
**Lines:** `502`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/c_generator.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pycparser/c_lexer.py`
**Lines:** `555`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/c_lexer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/c_like.py`
**Lines:** `738`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/c_like.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/c/c_parser.py`
**Lines:** `1059`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/c/c_parser.py --strict
```

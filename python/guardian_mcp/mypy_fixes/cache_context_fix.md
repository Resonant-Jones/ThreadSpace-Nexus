# 🧠 Mypy Fix Guide: `cache_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/cache_context.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/cache_context.py --strict
```

# 🧠 Mypy Fix Guide: `cache_control_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/cache_control_check.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/cache_control_check.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/cache_key.py`
**Lines:** `1057`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/cache_key.py --strict
```

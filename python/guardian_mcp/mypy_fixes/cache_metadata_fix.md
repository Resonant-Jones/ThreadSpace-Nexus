# 🧠 Mypy Fix Guide: `cache_metadata.py`
...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/cache_metadata.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/cache_metadata.py --strict
```

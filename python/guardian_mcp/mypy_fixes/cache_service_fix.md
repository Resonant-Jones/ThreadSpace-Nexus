# 🧠 Mypy Fix Guide: `cache_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/cache_service.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/cache_service.py --strict
```

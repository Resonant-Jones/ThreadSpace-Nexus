# 🧠 Mypy Fix Guide: `cache_storage.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/cache_storage.py`
**Lines:** `309`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/cache_storage.py --strict
```

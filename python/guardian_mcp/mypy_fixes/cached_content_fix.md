# 🧠 Mypy Fix Guide: `cached_content.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/cached_content.py`
**Lines:** `182`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/cached_content.py --strict
```

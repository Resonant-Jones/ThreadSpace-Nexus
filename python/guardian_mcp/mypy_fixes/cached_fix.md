...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/cached.py`
**Lines:** `953`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/cached.py --strict
```

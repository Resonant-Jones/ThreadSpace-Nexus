# 🧠 Mypy Fix Guide: `cached_py_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/discovery/cached_py_info.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/discovery/cached_py_info.py --strict
```

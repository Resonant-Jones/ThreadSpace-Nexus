...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/caching.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/caching.py --strict
```

# 🧠 Mypy Fix Guide: `caching_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/caching_handler.py`
**Lines:** `952`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/caching_handler.py --strict
```

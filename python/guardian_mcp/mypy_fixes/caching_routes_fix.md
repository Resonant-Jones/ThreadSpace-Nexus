# 🧠 Mypy Fix Guide: `caching_routes.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/caching_routes.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/caching_routes.py --strict
```

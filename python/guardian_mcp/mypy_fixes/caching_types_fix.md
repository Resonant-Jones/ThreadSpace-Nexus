# 🧠 Mypy Fix Guide: `caching_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/caching_types.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/caching_types.py --strict
```

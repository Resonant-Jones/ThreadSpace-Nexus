...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/handlers/calculus.py`
**Lines:** `273`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/handlers/calculus.py --strict
```

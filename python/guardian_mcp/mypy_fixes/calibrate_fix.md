...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/calibrate.py`
**Lines:** `1252`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/calibrate.py --strict
```

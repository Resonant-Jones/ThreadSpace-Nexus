# 🧠 Mypy Fix Guide: `callable_class.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/callable_class.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/callable_class.py --strict
```

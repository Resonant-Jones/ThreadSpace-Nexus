# 🧠 Mypy Fix Guide: `callable_util.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/foundation/callable_util.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/foundation/callable_util.py --strict
```

# 🧠 Mypy Fix Guide: `callback_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/callback_utils.py`
**Lines:** `354`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/callback_utils.py --strict
```

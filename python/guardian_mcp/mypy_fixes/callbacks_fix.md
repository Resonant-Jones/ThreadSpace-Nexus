...
**File:** `.venv/lib/python3.13/site-packages/posthog/ai/langchain/callbacks.py`
**Lines:** `788`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/ai/langchain/callbacks.py --strict
```

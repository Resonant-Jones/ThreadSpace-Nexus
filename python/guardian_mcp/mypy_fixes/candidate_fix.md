...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/candidate.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/candidate.py --strict
```

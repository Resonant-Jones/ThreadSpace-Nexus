...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/resolution/resolvelib/candidates.py`
**Lines:** `579`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/resolution/resolvelib/candidates.py --strict
```

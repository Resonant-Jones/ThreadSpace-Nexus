...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/capi_maps.py`
**Lines:** `811`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/capi_maps.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/capnproto.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/capnproto.py --strict
```

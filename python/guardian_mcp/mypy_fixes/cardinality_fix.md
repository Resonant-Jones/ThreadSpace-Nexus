...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/common/cardinality.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/common/cardinality.py --strict
```

# 🧠 Mypy Fix Guide: `cartan_matrix.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/cartan_matrix.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/cartan_matrix.py --strict
```

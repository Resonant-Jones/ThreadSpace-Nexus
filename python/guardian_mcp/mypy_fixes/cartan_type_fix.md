...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/cartan_type.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/cartan_type.py --strict
```

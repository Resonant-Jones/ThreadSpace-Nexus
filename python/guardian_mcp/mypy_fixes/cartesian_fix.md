...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/cartesian.py`
**Lines:** `341`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/cartesian.py --strict
```

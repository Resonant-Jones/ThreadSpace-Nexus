# 🧠 Mypy Fix Guide: `cassandra_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cassandra_attributes.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cassandra_attributes.py --strict
```

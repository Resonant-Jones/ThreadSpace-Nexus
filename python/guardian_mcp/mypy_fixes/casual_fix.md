...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/casual.py`
**Lines:** `458`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/casual.py --strict
```

# 🧠 Mypy Fix Guide: `catalan_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/catalan_stemmer.py`
**Lines:** `784`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/catalan_stemmer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/categorical.py`
**Lines:** `3103`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/categorical.py --strict
```

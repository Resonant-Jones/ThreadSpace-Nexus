# 🧠 Mypy Fix Guide: `categorized_sents.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/categorized_sents.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/categorized_sents.py --strict
```

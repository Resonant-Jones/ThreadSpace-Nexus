...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/category.py`
**Lines:** `513`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/category.py --strict
```

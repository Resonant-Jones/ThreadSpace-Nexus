...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/cb_rules.py`
**Lines:** `665`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/cb_rules.py --strict
```

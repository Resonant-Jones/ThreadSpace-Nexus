...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/ccompiler.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/ccompiler.py --strict
```

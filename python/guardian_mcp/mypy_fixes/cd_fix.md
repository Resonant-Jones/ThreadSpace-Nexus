...
**File:** `.venv/lib/python3.13/site-packages/charset_normalizer/cd.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/charset_normalizer/cd.py --strict
```

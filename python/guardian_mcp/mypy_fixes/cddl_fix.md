...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/cddl.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/cddl.py --strict
```

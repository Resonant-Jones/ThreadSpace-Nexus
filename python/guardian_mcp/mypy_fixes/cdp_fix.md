...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/cdp.py`
**Lines:** `514`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/cdp.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/cells.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/cells.py --strict
```

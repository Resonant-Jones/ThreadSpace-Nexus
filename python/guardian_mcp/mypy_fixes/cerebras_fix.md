...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/cerebras.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/cerebras.py --strict
```

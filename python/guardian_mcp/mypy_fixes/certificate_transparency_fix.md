# 🧠 Mypy Fix Guide: `certificate_transparency.py`
...
**File:** `.venv/lib/python3.13/site-packages/cryptography/x509/certificate_transparency.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/x509/certificate_transparency.py --strict
```

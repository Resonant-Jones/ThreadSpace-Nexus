# 🧠 Mypy Fix Guide: `certificates_v1alpha1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/certificates_v1alpha1_api.py`
**Lines:** `1179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/certificates_v1alpha1_api.py --strict
```

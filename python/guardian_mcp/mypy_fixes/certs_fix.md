...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/requests/certs.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/requests/certs.py --strict
```

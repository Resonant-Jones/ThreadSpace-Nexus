...
**File:** `.venv/lib/python3.13/site-packages/cffi/cffi_opcode.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/cffi_opcode.py --strict
```

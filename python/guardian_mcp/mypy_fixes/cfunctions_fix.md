...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/cfunctions.py`
**Lines:** `558`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/cfunctions.py --strict
```

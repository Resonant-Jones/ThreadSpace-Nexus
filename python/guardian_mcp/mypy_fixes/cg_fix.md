...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/cg.py`
**Lines:** `754`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/cg.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/systems/cgs.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/systems/cgs.py --strict
```

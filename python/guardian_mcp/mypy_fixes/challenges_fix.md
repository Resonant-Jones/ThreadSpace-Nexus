...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/challenges.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/challenges.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/googleapiclient/channel.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/googleapiclient/channel.py --strict
```

# 🧠 Mypy Fix Guide: `chaos_pendulum.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/chaos_pendulum.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/chaos_pendulum.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/chapel.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/chapel.py --strict
```

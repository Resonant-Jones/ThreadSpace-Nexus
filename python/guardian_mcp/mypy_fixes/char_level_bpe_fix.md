# 🧠 Mypy Fix Guide: `char_level_bpe.py`
...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/implementations/char_level_bpe.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/implementations/char_level_bpe.py --strict
```

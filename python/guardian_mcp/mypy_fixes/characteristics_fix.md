# 🧠 Mypy Fix Guide: `characteristics.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/engine/characteristics.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/engine/characteristics.py --strict
```

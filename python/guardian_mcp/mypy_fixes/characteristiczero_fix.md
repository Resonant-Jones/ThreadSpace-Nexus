# 🧠 Mypy Fix Guide: `characteristiczero.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/characteristiczero.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/characteristiczero.py --strict
```

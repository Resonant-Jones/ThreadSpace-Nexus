...
**File:** `.venv/lib/python3.13/site-packages/chardet/cli/chardetect.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/cli/chardetect.py --strict
```

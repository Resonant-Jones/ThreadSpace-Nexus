# 🧠 Mypy Fix Guide: `chardistribution.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/chardistribution.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/chardistribution.py --strict
```

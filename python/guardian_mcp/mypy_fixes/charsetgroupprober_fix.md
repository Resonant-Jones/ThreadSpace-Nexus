# 🧠 Mypy Fix Guide: `charsetgroupprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/charsetgroupprober.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/charsetgroupprober.py --strict
```

# 🧠 Mypy Fix Guide: `charsetprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/charsetprober.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/charsetprober.py --strict
```

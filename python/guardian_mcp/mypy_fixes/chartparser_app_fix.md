# 🧠 Mypy Fix Guide: `chartparser_app.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/app/chartparser_app.py`
**Lines:** `2569`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/app/chartparser_app.py --strict
```

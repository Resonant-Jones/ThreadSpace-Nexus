...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/chasen.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/chasen.py --strict
```

# 🧠 Mypy Fix Guide: `chat_completion_audio.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_audio.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_audio.py --strict
```

# 🧠 Mypy Fix Guide: `chat_completion_audio_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_audio_param.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_audio_param.py --strict
```

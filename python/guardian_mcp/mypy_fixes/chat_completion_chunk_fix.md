# 🧠 Mypy Fix Guide: `chat_completion_chunk.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_chunk.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_chunk.py --strict
```

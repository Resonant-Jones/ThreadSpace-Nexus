# 🧠 Mypy Fix Guide: `chat_completion_content_part_image_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_content_part_image_param.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_content_part_image_param.py --strict
```

# 🧠 Mypy Fix Guide: `chat_completion_deleted.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_deleted.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_deleted.py --strict
```

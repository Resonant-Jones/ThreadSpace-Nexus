# 🧠 Mypy Fix Guide: `chat_completion_function_call_option_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_function_call_option_param.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_function_call_option_param.py --strict
```

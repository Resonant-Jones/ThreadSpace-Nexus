# 🧠 Mypy Fix Guide: `chat_completion_message.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_message.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_message.py --strict
```

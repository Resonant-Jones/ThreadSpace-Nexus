# 🧠 Mypy Fix Guide: `chat_completion_modality.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_modality.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_modality.py --strict
```

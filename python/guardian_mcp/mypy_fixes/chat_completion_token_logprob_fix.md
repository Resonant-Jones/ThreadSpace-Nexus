# 🧠 Mypy Fix Guide: `chat_completion_token_logprob.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_token_logprob.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_token_logprob.py --strict
```

# 🧠 Mypy Fix Guide: `chat_completion_tool_choice_option_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_tool_choice_option_param.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_tool_choice_option_param.py --strict
```

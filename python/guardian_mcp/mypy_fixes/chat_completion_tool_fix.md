# 🧠 Mypy Fix Guide: `chat_completion_tool.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_tool.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_tool.py --strict
```

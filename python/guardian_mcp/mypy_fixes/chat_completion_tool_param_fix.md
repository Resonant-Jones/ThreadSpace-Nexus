# 🧠 Mypy Fix Guide: `chat_completion_tool_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_tool_param.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/chat_completion_tool_param.py --strict
```

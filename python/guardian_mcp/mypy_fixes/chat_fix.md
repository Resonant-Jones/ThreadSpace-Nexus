...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/client/cli/commands/chat.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/client/cli/commands/chat.py --strict
```

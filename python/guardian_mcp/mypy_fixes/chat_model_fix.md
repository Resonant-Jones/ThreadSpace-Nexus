...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/chat_model.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/chat_model.py --strict
```

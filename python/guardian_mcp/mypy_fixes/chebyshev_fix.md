...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/chebyshev.py`
**Lines:** `2003`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/chebyshev.py --strict
```

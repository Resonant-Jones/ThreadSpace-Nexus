...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/check.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/check.py --strict
```

# 🧠 Mypy Fix Guide: `check_hooks_apply.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/meta_hooks/check_hooks_apply.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/meta_hooks/check_hooks_apply.py --strict
```

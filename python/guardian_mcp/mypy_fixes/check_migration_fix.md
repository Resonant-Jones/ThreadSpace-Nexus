# 🧠 Mypy Fix Guide: `check_migration.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/check_migration.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/check_migration.py --strict
```

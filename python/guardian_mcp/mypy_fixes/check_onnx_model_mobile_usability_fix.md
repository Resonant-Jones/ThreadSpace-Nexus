# 🧠 Mypy Fix Guide: `check_onnx_model_mobile_usability.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/check_onnx_model_mobile_usability.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/check_onnx_model_mobile_usability.py --strict
```

# 🧠 Mypy Fix Guide: `check_type_completeness.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/check_type_completeness.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/check_type_completeness.py --strict
```

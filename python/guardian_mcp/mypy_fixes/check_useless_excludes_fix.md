# 🧠 Mypy Fix Guide: `check_useless_excludes.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/meta_hooks/check_useless_excludes.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/meta_hooks/check_useless_excludes.py --strict
```

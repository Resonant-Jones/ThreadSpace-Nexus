...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/type_tests/check_wraps.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/type_tests/check_wraps.py --strict
```

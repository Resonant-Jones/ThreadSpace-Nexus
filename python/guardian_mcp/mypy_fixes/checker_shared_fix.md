# 🧠 Mypy Fix Guide: `checker_shared.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/checker_shared.py`
**Lines:** `349`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/checker_shared.py --strict
```

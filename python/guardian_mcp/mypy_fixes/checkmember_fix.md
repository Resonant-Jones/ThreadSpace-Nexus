...
**File:** `.venv/lib/python3.13/site-packages/mypy/checkmember.py`
**Lines:** `1504`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/checkmember.py --strict
```

# 🧠 Mypy Fix Guide: `checkpattern.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/checkpattern.py`
**Lines:** `817`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/checkpattern.py --strict
```

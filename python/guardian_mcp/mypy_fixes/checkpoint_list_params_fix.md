# 🧠 Mypy Fix Guide: `checkpoint_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/jobs/checkpoint_list_params.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/jobs/checkpoint_list_params.py --strict
```

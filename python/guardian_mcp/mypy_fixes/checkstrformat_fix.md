# 🧠 Mypy Fix Guide: `checkstrformat.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/checkstrformat.py`
**Lines:** `1099`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/checkstrformat.py --strict
```

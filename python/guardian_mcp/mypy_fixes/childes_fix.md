...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/childes.py`
**Lines:** `630`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/childes.py --strict
```

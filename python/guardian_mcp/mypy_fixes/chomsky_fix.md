...
**File:** `.venv/lib/python3.13/site-packages/nltk/misc/chomsky.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/misc/chomsky.py --strict
```

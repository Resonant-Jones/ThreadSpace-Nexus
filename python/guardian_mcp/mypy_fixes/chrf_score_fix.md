...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/chrf_score.py`
**Lines:** `221`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/chrf_score.py --strict
```

# 🧠 Mypy Fix Guide: `chunking_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/chunking_strategy.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/chunking_strategy.py --strict
```

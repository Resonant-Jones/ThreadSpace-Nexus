# 🧠 Mypy Fix Guide: `cicd_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cicd_attributes.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cicd_attributes.py --strict
```

# 🧠 Mypy Fix Guide: `cicd_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/cicd_metrics.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/cicd_metrics.py --strict
```

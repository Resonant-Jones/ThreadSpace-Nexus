...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/circuitplot.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/circuitplot.py --strict
```

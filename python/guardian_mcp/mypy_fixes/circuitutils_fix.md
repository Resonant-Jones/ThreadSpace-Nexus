# 🧠 Mypy Fix Guide: `circuitutils.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/circuitutils.py`
**Lines:** `488`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/circuitutils.py --strict
```

# 🧠 Mypy Fix Guide: `citation_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/citation_types.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/citation_types.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/ir/class_ir.py`
**Lines:** `515`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/ir/class_ir.py --strict
```

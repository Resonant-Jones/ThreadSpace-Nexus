# 🧠 Mypy Fix Guide: `class_validators.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/deprecated/class_validators.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/deprecated/class_validators.py --strict
```

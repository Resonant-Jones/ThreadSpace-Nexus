...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/classdef.py`
**Lines:** `901`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/classdef.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/clean.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/clean.py --strict
```

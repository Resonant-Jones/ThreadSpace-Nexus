...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/cli.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/cli.py --strict
```

# 🧠 Mypy Fix Guide: `client_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/client_attributes.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/client_attributes.py --strict
```

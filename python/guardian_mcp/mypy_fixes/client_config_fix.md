# 🧠 Mypy Fix Guide: `client_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/client_config.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/client_config.py --strict
```

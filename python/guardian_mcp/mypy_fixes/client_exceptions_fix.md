# 🧠 Mypy Fix Guide: `client_exceptions.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/client_exceptions.py`
**Lines:** `421`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/client_exceptions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/db/impl/grpc/client.py`
**Lines:** `555`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/db/impl/grpc/client.py --strict
```

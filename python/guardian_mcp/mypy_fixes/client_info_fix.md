...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/gapic_v1/client_info.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/gapic_v1/client_info.py --strict
```

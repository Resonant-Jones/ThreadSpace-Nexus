# 🧠 Mypy Fix Guide: `client_initalization_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/client_initalization_utils.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/client_initalization_utils.py --strict
```

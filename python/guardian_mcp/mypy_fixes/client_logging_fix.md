# 🧠 Mypy Fix Guide: `client_logging.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/client_logging.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/client_logging.py --strict
```

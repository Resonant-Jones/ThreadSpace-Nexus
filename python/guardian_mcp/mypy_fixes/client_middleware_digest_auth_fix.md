# 🧠 Mypy Fix Guide: `client_middleware_digest_auth.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/client_middleware_digest_auth.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/client_middleware_digest_auth.py --strict
```

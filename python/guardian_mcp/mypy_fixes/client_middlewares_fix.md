# 🧠 Mypy Fix Guide: `client_middlewares.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/client_middlewares.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/client_middlewares.py --strict
```

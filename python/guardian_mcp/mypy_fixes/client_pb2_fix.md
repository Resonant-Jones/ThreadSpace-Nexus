...
**File:** `.venv/lib/python3.13/site-packages/google/api/client_pb2.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/client_pb2.py --strict
```

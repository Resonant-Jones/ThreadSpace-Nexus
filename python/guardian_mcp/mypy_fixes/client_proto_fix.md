# 🧠 Mypy Fix Guide: `client_proto.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/client_proto.py`
**Lines:** `359`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/client_proto.py --strict
```

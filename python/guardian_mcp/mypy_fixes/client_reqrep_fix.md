# 🧠 Mypy Fix Guide: `client_reqrep.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/client_reqrep.py`
**Lines:** `1533`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/client_reqrep.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/client_ws.py`
**Lines:** `428`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/client_ws.py --strict
```

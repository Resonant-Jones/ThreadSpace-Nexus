...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/clientlib.py`
**Lines:** `500`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/clientlib.py --strict
```

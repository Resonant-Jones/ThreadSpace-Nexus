# 🧠 Mypy Fix Guide: `clientside_credential_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/clientside_credential_handler.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/clientside_credential_handler.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/clipboards.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/clipboards.py --strict
```

# 🧠 Mypy Fix Guide: `cloudflare_workers_ai_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/cloudflare_workers_ai_embedding_function.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/cloudflare_workers_ai_embedding_function.py --strict
```

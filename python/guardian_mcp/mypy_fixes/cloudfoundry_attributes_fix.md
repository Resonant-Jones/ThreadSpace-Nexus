# 🧠 Mypy Fix Guide: `cloudfoundry_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cloudfoundry_attributes.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cloudfoundry_attributes.py --strict
```

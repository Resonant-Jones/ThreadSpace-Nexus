...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/cloudpickle/cloudpickle.py`
**Lines:** `1545`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/cloudpickle/cloudpickle.py --strict
```

# 🧠 Mypy Fix Guide: `cloudpickle_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/cloudpickle_wrapper.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/cloudpickle_wrapper.py --strict
```

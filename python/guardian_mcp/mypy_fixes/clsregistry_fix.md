...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/clsregistry.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/clsregistry.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/cmac.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/cmac.py --strict
```

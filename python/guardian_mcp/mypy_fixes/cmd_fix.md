...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/cmd.py`
**Lines:** `554`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/cmd.py --strict
```

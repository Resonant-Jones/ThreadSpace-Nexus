...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/cmdoptions.py`
**Lines:** `1133`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/cmdoptions.py --strict
```

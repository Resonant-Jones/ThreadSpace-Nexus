...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/cmudict.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/cmudict.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/cnf.py`
**Lines:** `445`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/cnf.py --strict
```

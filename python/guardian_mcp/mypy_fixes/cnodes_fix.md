...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/cnodes.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/cnodes.py --strict
```

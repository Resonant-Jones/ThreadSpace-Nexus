# 🧠 Mypy Fix Guide: `code_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/code_attributes.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/code_attributes.py --strict
```

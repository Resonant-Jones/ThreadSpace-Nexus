...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/code.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/code.py --strict
```

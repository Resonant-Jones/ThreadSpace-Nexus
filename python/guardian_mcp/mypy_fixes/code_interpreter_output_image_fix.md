# 🧠 Mypy Fix Guide: `code_interpreter_output_image.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/code_interpreter_output_image.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/code_interpreter_output_image.py --strict
```

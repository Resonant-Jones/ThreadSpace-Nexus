# 🧠 Mypy Fix Guide: `code_interpreter_tool_call_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/code_interpreter_tool_call_delta.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/code_interpreter_tool_call_delta.py --strict
```

# 🧠 Mypy Fix Guide: `code_interpreter_tool_call.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/code_interpreter_tool_call.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/code_interpreter_tool_call.py --strict
```

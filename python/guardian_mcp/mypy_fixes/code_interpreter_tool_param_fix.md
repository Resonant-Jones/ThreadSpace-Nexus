# 🧠 Mypy Fix Guide: `code_interpreter_tool_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/code_interpreter_tool_param.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/code_interpreter_tool_param.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/idna/codec.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/idna/codec.py --strict
```

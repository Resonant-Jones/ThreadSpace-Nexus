...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/codegen.py`
**Lines:** `2237`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/codegen.py --strict
```

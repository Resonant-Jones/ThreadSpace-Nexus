...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/codeprinter.py`
**Lines:** `1039`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/codeprinter.py --strict
```

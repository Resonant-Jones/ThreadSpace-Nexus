...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/codeql.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/codeql.py --strict
```

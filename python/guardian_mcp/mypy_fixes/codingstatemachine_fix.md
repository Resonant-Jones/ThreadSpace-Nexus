# 🧠 Mypy Fix Guide: `codingstatemachine.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/codingstatemachine.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/codingstatemachine.py --strict
```

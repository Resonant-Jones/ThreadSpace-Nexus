# 🧠 Mypy Fix Guide: `codingstatemachinedict.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/codingstatemachinedict.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/codingstatemachinedict.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/coercions.py`
**Lines:** `1403`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/coercions.py --strict
```

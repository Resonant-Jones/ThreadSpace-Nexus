...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/coffee.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/coffee.py --strict
```

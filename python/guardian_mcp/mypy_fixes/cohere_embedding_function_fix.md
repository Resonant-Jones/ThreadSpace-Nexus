# 🧠 Mypy Fix Guide: `cohere_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/cohere_embedding_function.py`
**Lines:** `184`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/cohere_embedding_function.py --strict
```

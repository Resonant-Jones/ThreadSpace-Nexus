# 🧠 Mypy Fix Guide: `cohere_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/azure_ai/embed/cohere_transformation.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/azure_ai/embed/cohere_transformation.py --strict
```

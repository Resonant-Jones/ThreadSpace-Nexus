# 🧠 Mypy Fix Guide: `collection_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/collection_configuration.py`
**Lines:** `769`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/collection_configuration.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/collections.py`
**Lines:** `1627`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/collections.py --strict
```

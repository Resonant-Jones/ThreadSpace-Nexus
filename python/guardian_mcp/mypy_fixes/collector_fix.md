...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/index/collector.py`
**Lines:** `494`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/index/collector.py --strict
```

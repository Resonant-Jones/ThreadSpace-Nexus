# 🧠 Mypy Fix Guide: `collocations_app.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/app/collocations_app.py`
**Lines:** `438`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/app/collocations_app.py --strict
```

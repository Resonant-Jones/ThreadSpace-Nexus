# 🧠 Mypy Fix Guide: `collocations.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/collocations.py`
**Lines:** `412`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/collocations.py --strict
```

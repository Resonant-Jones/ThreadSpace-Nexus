...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/color.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/color.py --strict
```

# 🧠 Mypy Fix Guide: `color_scheme.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/color_scheme.py`
**Lines:** `336`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/color_scheme.py --strict
```

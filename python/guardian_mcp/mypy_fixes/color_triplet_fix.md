# 🧠 Mypy Fix Guide: `color_triplet.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/color_triplet.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/color_triplet.py --strict
```

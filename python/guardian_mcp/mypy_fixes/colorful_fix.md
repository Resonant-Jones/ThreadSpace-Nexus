...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/colorful.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/colorful.py --strict
```

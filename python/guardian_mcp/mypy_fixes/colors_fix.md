...
**File:** `.venv/lib/python3.13/site-packages/coloredlogs/converter/colors.py`
**Lines:** `310`
...
```bash
mypy .venv/lib/python3.13/site-packages/coloredlogs/converter/colors.py --strict
```

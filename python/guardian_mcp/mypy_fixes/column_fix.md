...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/interchange/column.py`
**Lines:** `461`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/interchange/column.py --strict
```

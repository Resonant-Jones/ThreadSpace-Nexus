...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/columns.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/columns.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/comal.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/comal.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/ccg/combinator.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/ccg/combinator.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/combsimp.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/combsimp.py --strict
```

# 🧠 Mypy Fix Guide: `command_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/command_context.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/command_context.py --strict
```

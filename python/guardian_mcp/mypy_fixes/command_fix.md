...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/command.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/command.py --strict
```

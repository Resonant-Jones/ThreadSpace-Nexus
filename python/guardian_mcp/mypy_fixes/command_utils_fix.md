# 🧠 Mypy Fix Guide: `command_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/command_utils.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/command_utils.py --strict
```

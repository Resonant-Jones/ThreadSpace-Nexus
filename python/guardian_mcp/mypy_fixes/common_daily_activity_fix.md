# 🧠 Mypy Fix Guide: `common_daily_activity.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/common_daily_activity.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/common_daily_activity.py --strict
```

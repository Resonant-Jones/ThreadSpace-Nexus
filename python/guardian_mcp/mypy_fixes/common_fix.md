...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/common.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/common.py --strict
```

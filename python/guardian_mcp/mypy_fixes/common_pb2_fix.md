...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/common/v1/common_pb2.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/common/v1/common_pb2.py --strict
```

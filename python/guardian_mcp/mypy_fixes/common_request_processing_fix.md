# 🧠 Mypy Fix Guide: `common_request_processing.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_request_processing.py`
**Lines:** `547`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_request_processing.py --strict
```

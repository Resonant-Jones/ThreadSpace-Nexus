# 🧠 Mypy Fix Guide: `common_rules.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/common_rules.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/common_rules.py --strict
```

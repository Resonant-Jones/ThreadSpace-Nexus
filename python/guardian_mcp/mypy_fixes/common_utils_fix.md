# 🧠 Mypy Fix Guide: `common_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/common_utils.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/common_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/presets/commonmark.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/presets/commonmark.py --strict
```

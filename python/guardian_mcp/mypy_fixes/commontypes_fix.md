...
**File:** `.venv/lib/python3.13/site-packages/cffi/commontypes.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/commontypes.py --strict
```

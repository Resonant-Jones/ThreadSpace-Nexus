...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/commutator.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/commutator.py --strict
```

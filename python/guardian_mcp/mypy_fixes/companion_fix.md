...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/companion.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/companion.py --strict
```

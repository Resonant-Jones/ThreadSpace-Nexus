# 🧠 Mypy Fix Guide: `comparative_sents.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/comparative_sents.py`
**Lines:** `309`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/comparative_sents.py --strict
```

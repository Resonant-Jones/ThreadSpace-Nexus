# 🧠 Mypy Fix Guide: `compare_bert_results.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/compare_bert_results.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/compare_bert_results.py --strict
```

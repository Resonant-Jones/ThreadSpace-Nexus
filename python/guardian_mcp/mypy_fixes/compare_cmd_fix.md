...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/compare_cmd.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/compare_cmd.py --strict
```

# 🧠 Mypy Fix Guide: `comparison_filter.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/comparison_filter.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/comparison_filter.py --strict
```

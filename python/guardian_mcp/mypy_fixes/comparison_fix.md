...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/comparison.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/comparison.py --strict
```

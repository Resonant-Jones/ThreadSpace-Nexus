...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/compat.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/compat.py --strict
```

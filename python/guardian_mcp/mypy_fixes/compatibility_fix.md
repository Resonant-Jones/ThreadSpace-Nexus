# 🧠 Mypy Fix Guide: `compatibility.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/compatibility.py`
**Lines:** `1152`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/compatibility.py --strict
```

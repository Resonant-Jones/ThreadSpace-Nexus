# 🧠 Mypy Fix Guide: `compatibility_tags.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/compatibility_tags.py`
**Lines:** `200`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/compatibility_tags.py --strict
```

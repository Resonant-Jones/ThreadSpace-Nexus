...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/_compilation/compilation.py`
**Lines:** `657`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/_compilation/compilation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/compile_cmd.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/compile_cmd.py --strict
```

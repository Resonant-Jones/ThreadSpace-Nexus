...
**File:** `.venv/lib/python3.13/site-packages/piptools/scripts/compile.py`
**Lines:** `537`
...
```bash
mypy .venv/lib/python3.13/site-packages/piptools/scripts/compile.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/compiled.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/compiled.py --strict
```

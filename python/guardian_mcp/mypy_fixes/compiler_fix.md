...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/compiler.py`
**Lines:** `7946`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/compiler.py --strict
```

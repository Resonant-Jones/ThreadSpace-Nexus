# 🧠 Mypy Fix Guide: `completion_choice.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/completion_choice.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/completion_choice.py --strict
```

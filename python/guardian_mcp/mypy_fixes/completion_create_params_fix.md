# 🧠 Mypy Fix Guide: `completion_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/completion_create_params.py`
**Lines:** `409`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/completion_create_params.py --strict
```

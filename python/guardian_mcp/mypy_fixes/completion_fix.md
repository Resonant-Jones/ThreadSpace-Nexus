...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/completion.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/completion.py --strict
```

# 🧠 Mypy Fix Guide: `completion_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/completion_list_params.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/completion_list_params.py --strict
```

# 🧠 Mypy Fix Guide: `completion_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/completion_update_params.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/completion_update_params.py --strict
```

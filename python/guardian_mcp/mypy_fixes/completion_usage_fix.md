# 🧠 Mypy Fix Guide: `completion_usage.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/completion_usage.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/completion_usage.py --strict
```

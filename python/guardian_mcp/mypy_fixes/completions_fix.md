...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/beta/chat/completions.py`
**Lines:** `634`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/beta/chat/completions.py --strict
```

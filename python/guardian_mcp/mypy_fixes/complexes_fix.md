...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/complexes.py`
**Lines:** `1492`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/complexes.py --strict
```

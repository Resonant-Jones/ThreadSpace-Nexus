# 🧠 Mypy Fix Guide: `complexfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/complexfield.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/complexfield.py --strict
```

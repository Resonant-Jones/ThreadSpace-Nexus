...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/propagators/composite.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/propagators/composite.py --strict
```

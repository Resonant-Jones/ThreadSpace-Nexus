# 🧠 Mypy Fix Guide: `compound_filter.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/compound_filter.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/compound_filter.py --strict
```

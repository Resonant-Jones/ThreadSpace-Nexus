...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/compound_rv.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/compound_rv.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/compression.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/compression.py --strict
```

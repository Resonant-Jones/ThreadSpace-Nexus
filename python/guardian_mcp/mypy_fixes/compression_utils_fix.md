# 🧠 Mypy Fix Guide: `compression_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/compression_utils.py`
**Lines:** `278`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/compression_utils.py --strict
```

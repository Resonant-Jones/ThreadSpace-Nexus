...
**File:** `.venv/lib/python3.13/site-packages/joblib/compressor.py`
**Lines:** `572`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/compressor.py --strict
```

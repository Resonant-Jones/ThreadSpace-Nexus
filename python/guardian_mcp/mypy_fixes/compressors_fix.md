...
**File:** `.venv/lib/python3.13/site-packages/pandas/compat/compressors.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/compat/compressors.py --strict
```

# 🧠 Mypy Fix Guide: `computer_tool.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/computer_tool.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/computer_tool.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/concat.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/concat.py --strict
```

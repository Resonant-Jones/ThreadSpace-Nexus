# 🧠 Mypy Fix Guide: `concordance_app.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/app/concordance_app.py`
**Lines:** `709`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/app/concordance_app.py --strict
```

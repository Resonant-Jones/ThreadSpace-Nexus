...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/concurrency.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/concurrency.py --strict
```

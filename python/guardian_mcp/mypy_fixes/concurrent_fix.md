...
**File:** `.venv/lib/python3.13/site-packages/tqdm/contrib/concurrent.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/contrib/concurrent.py --strict
```

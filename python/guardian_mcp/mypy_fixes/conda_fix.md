...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/conda.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/conda.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pypika/clickhouse/condition.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/clickhouse/condition.py --strict
```

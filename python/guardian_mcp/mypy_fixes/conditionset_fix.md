# 🧠 Mypy Fix Guide: `conditionset.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/conditionset.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/conditionset.py --strict
```

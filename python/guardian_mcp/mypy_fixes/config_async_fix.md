# 🧠 Mypy Fix Guide: `config_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/gapic_v1/config_async.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/gapic_v1/config_async.py --strict
```

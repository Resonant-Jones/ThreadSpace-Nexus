# 🧠 Mypy Fix Guide: `config_exception.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/config_exception.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/config_exception.py --strict
```

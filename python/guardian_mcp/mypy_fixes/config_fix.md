...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/html2text/config.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/html2text/config.py --strict
```

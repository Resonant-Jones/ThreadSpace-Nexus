...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/config_init.py`
**Lines:** `941`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/config_init.py --strict
```

# 🧠 Mypy Fix Guide: `configmaplock.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/leaderelection/resourcelock/configmaplock.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/leaderelection/resourcelock/configmaplock.py --strict
```

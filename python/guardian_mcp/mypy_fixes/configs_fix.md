...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/configs.py`
**Lines:** `1433`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/configs.py --strict
```

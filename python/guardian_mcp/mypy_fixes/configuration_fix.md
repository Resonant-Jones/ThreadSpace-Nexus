# 🧠 Mypy Fix Guide: `configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/configuration.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/configuration.py --strict
```

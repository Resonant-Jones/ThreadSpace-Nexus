...
**File:** `.venv/lib/python3.13/site-packages/sympy/multipledispatch/conflict.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/multipledispatch/conflict.py --strict
```

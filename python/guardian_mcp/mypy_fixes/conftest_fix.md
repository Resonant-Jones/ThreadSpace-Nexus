...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/conftest.py`
**Lines:** `1078`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/conftest.py --strict
```

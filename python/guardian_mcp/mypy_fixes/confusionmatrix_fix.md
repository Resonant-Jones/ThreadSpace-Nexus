# 🧠 Mypy Fix Guide: `confusionmatrix.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/confusionmatrix.py`
**Lines:** `351`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/confusionmatrix.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/conll.py`
**Lines:** `579`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/conll.py --strict
```

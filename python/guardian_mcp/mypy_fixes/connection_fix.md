...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/connection.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/connection.py --strict
```

# 🧠 Mypy Fix Guide: `connection_pool.py`
...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/connection_pool.py`
**Lines:** `420`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/connection_pool.py --strict
```

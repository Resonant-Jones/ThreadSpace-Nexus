# 🧠 Mypy Fix Guide: `connectionpool.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/connectionpool.py`
**Lines:** `1140`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/connectionpool.py --strict
```

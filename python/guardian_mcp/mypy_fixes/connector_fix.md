...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/connector.py`
**Lines:** `1814`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/connector.py --strict
```

# 🧠 Mypy Fix Guide: `const_vs_enum.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/const_vs_enum.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/const_vs_enum.py --strict
```

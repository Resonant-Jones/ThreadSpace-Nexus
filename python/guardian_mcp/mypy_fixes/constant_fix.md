...
**File:** `.venv/lib/python3.13/site-packages/charset_normalizer/constant.py`
**Lines:** `2015`
...
```bash
mypy .venv/lib/python3.13/site-packages/charset_normalizer/constant.py --strict
```

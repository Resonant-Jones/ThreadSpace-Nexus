# 🧠 Mypy Fix Guide: `constant_fold.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/constant_fold.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/constant_fold.py --strict
```

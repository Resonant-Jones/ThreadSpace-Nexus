# 🧠 Mypy Fix Guide: `constant_time.py`
...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/constant_time.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/constant_time.py --strict
```

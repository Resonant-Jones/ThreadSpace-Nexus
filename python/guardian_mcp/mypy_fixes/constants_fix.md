...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/constants.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/constants.py --strict
```

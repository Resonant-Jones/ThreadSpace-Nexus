...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/constrain.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/constrain.py --strict
```

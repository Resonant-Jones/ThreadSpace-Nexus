...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/type/constraint.py`
**Lines:** `751`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/type/constraint.py --strict
```

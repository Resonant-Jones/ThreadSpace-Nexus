...
**File:** `.venv/lib/python3.13/site-packages/mypy/constraints.py`
**Lines:** `1705`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/constraints.py --strict
```

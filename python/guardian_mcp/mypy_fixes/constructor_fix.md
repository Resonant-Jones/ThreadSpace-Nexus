...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/constructor.py`
**Lines:** `387`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/constructor.py --strict
```

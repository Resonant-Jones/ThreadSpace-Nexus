# 🧠 Mypy Fix Guide: `container_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/container_create_params.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/container_create_params.py --strict
```

# 🧠 Mypy Fix Guide: `container_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/container_create_response.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/container_create_response.py --strict
```

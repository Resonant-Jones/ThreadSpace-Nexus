# 🧠 Mypy Fix Guide: `container_list_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/container_list_response.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/container_list_response.py --strict
```

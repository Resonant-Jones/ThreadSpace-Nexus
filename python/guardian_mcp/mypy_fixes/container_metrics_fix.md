# 🧠 Mypy Fix Guide: `container_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/container_metrics.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/container_metrics.py --strict
```

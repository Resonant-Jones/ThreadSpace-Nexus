# 🧠 Mypy Fix Guide: `container_retrieve_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/container_retrieve_response.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/container_retrieve_response.py --strict
```

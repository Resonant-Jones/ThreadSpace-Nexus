...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/containers.py`
**Lines:** `415`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/containers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/contains.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/contains.py --strict
```

# 🧠 Mypy Fix Guide: `content_filter_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/content_filter_strategy.py`
**Lines:** `1070`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/content_filter_strategy.py --strict
```

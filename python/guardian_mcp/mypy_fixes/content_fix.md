...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/content.py`
**Lines:** `819`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/content.py --strict
```

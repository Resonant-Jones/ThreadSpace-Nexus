# 🧠 Mypy Fix Guide: `content_scraping_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/content_scraping_strategy.py`
**Lines:** `1673`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/content_scraping_strategy.py --strict
```

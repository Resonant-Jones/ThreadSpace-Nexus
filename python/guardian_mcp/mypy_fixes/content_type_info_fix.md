# 🧠 Mypy Fix Guide: `content_type_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/content_type_info.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/content_type_info.py --strict
```

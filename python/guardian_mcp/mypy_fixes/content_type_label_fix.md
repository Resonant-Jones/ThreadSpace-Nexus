# 🧠 Mypy Fix Guide: `content_type_label.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/content_type_label.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/content_type_label.py --strict
```

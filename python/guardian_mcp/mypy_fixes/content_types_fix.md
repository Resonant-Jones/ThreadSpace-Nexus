# 🧠 Mypy Fix Guide: `content_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/content_types.py`
**Lines:** `999`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/content_types.py --strict
```

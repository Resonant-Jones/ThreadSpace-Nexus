...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/context.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/context.py --strict
```

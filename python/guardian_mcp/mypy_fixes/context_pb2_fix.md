...
**File:** `.venv/lib/python3.13/site-packages/google/api/context_pb2.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/context_pb2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/_testing/contexts.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_testing/contexts.py --strict
```

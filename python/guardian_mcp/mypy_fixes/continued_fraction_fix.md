# 🧠 Mypy Fix Guide: `continued_fraction.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/continued_fraction.py`
**Lines:** `369`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/continued_fraction.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/control.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/control.py --strict
```

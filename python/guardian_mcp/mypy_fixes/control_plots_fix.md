# 🧠 Mypy Fix Guide: `control_plots.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/control/control_plots.py`
**Lines:** `1135`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/control/control_plots.py --strict
```

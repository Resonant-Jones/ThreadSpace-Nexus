...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/controller.py`
**Lines:** `511`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/controller.py --strict
```

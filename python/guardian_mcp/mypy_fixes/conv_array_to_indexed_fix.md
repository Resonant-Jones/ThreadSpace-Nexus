# 🧠 Mypy Fix Guide: `conv_array_to_indexed.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/conv_array_to_indexed.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/conv_array_to_indexed.py --strict
```

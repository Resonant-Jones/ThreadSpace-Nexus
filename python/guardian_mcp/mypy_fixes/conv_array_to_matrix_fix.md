# 🧠 Mypy Fix Guide: `conv_array_to_matrix.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/conv_array_to_matrix.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/conv_array_to_matrix.py --strict
```

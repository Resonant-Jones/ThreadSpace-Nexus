...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/conv.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/conv.py --strict
```

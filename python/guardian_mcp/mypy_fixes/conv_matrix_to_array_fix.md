# 🧠 Mypy Fix Guide: `conv_matrix_to_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/conv_matrix_to_array.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/conv_matrix_to_array.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/conventions.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/conventions.py --strict
```

# 🧠 Mypy Fix Guide: `converse_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/converse_handler.py`
**Lines:** `466`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/converse_handler.py --strict
```

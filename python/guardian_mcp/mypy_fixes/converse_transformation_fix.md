# 🧠 Mypy Fix Guide: `converse_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/converse_transformation.py`
**Lines:** `1027`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/converse_transformation.py --strict
```

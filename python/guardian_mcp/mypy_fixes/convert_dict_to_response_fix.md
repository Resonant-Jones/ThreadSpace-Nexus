# 🧠 Mypy Fix Guide: `convert_dict_to_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/convert_dict_to_response.py`
**Lines:** `717`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/convert_dict_to_response.py --strict
```

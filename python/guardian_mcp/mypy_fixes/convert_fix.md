...
**File:** `.venv/lib/python3.13/site-packages/chromadb/proto/convert.py`
**Lines:** `688`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/proto/convert.py --strict
```

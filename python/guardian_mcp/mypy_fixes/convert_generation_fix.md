# 🧠 Mypy Fix Guide: `convert_generation.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/convert_generation.py`
**Lines:** `3547`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/convert_generation.py --strict
```

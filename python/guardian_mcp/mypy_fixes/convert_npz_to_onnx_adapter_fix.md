# 🧠 Mypy Fix Guide: `convert_npz_to_onnx_adapter.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/convert_npz_to_onnx_adapter.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/convert_npz_to_onnx_adapter.py --strict
```

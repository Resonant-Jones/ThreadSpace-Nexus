# 🧠 Mypy Fix Guide: `convert_onnx_models_to_ort.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/convert_onnx_models_to_ort.py`
**Lines:** `377`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/convert_onnx_models_to_ort.py --strict
```

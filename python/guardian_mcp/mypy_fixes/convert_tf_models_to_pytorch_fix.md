# 🧠 Mypy Fix Guide: `convert_tf_models_to_pytorch.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/convert_tf_models_to_pytorch.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/convert_tf_models_to_pytorch.py --strict
```

# 🧠 Mypy Fix Guide: `convert_to_onnx.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/convert_to_onnx.py`
**Lines:** `543`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/convert_to_onnx.py --strict
```

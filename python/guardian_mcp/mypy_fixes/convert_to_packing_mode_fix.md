# 🧠 Mypy Fix Guide: `convert_to_packing_mode.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/convert_to_packing_mode.py`
**Lines:** `386`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/convert_to_packing_mode.py --strict
```

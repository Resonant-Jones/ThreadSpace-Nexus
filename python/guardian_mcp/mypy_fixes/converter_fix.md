...
**File:** `.venv/lib/python3.13/site-packages/pandas/plotting/_matplotlib/converter.py`
**Lines:** `1139`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/plotting/_matplotlib/converter.py --strict
```

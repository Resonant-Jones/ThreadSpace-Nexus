...
**File:** `.venv/lib/python3.13/site-packages/starlette/convertors.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/convertors.py --strict
```

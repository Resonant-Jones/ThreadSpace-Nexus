# 🧠 Mypy Fix Guide: `convolutions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/discrete/convolutions.py`
**Lines:** `597`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/discrete/convolutions.py --strict
```

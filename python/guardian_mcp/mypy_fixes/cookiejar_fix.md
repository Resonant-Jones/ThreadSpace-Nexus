...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/cookiejar.py`
**Lines:** `522`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/cookiejar.py --strict
```

# 🧠 Mypy Fix Guide: `cooldown_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/cooldown_cache.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/cooldown_cache.py --strict
```

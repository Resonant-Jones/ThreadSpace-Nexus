# 🧠 Mypy Fix Guide: `cooldown_callbacks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/cooldown_callbacks.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/cooldown_callbacks.py --strict
```

# 🧠 Mypy Fix Guide: `cooldown_handlers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/cooldown_handlers.py`
**Lines:** `438`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/cooldown_handlers.py --strict
```

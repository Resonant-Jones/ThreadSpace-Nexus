# 🧠 Mypy Fix Guide: `cooper_storage.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/sem/cooper_storage.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/sem/cooper_storage.py --strict
```

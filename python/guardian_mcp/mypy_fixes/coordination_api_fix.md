# 🧠 Mypy Fix Guide: `coordination_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/coordination_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/coordination_api.py --strict
```

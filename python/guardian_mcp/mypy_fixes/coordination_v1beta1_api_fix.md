# 🧠 Mypy Fix Guide: `coordination_v1beta1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/coordination_v1beta1_api.py`
**Lines:** `1402`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/coordination_v1beta1_api.py --strict
```

# 🧠 Mypy Fix Guide: `coordsysrect.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/coordsysrect.py`
**Lines:** `1031`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/coordsysrect.py --strict
```

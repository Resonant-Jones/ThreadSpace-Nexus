...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/embed/via_app_data/pip_install/copy.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/embed/via_app_data/pip_install/copy.py --strict
```

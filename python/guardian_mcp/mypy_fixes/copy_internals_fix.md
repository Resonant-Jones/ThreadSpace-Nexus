# 🧠 Mypy Fix Guide: `copy_internals.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/deprecated/copy_internals.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/deprecated/copy_internals.py --strict
```

# 🧠 Mypy Fix Guide: `copy_propagation.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/transform/copy_propagation.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/transform/copy_propagation.py --strict
```

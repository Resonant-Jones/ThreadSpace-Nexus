...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/core_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/core_api.py --strict
```

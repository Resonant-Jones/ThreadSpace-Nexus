...
**File:** `.venv/lib/python3.13/site-packages/sympy/strategies/branch/core.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/strategies/branch/core.py --strict
```

# 🧠 Mypy Fix Guide: `core_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/core_helpers.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/core_helpers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pydantic_core/core_schema.py`
**Lines:** `4325`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic_core/core_schema.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/core_v1_api.py`
**Lines:** `30454`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/core_v1_api.py --strict
```

# 🧠 Mypy Fix Guide: `core_v1_endpoint_port.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/core_v1_endpoint_port.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/core_v1_endpoint_port.py --strict
```

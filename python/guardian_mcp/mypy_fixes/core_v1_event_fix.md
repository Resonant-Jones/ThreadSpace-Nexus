# 🧠 Mypy Fix Guide: `core_v1_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/core_v1_event.py`
**Lines:** `562`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/core_v1_event.py --strict
```

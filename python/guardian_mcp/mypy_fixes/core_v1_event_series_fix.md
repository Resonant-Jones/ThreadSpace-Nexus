# 🧠 Mypy Fix Guide: `core_v1_event_series.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/core_v1_event_series.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/core_v1_event_series.py --strict
```

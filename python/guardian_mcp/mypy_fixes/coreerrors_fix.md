...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/coreerrors.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/coreerrors.py --strict
```

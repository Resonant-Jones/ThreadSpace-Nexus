...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/corenlp.py`
**Lines:** `796`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/corenlp.py --strict
```

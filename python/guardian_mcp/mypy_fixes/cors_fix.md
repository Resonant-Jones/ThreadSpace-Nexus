...
**File:** `.venv/lib/python3.13/site-packages/starlette/middleware/cors.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/middleware/cors.py --strict
```

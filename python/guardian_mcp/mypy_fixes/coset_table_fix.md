...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/coset_table.py`
**Lines:** `1259`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/coset_table.py --strict
```

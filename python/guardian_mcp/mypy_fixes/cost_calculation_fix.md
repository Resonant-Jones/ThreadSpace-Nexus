# 🧠 Mypy Fix Guide: `cost_calculation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/openai/cost_calculation.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/openai/cost_calculation.py --strict
```

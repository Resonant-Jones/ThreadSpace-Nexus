# 🧠 Mypy Fix Guide: `cost_calculator.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/image_generation/cost_calculator.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/image_generation/cost_calculator.py --strict
```

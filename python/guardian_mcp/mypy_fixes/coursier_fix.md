...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/coursier.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/coursier.py --strict
```

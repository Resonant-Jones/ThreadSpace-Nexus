...
**File:** `.venv/lib/python3.13/site-packages/chardet/cp949prober.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/cp949prober.py --strict
```

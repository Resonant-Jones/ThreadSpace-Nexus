...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/cplint.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/cplint.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/pyext/cpp_message.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/pyext/cpp_message.py --strict
```

# 🧠 Mypy Fix Guide: `cpu_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cpu_attributes.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/cpu_attributes.py --strict
```

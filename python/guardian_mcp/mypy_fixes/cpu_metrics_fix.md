...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/cpu_metrics.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/cpu_metrics.py --strict
```

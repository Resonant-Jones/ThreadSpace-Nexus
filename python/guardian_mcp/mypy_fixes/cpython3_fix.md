...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/cpython/cpython3.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/cpython/cpython3.py --strict
```

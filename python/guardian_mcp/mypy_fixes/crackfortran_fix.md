# 🧠 Mypy Fix Guide: `crackfortran.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/crackfortran.py`
**Lines:** `3725`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/crackfortran.py --strict
```

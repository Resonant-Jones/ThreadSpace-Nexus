...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/crawlers/google_search/crawler.py`
**Lines:** `131`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/crawlers/google_search/crawler.py --strict
```

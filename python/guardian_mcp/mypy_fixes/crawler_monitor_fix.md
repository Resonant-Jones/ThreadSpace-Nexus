# 🧠 Mypy Fix Guide: `crawler_monitor.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/components/crawler_monitor.py`
**Lines:** `837`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/components/crawler_monitor.py --strict
```

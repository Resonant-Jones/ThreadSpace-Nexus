# 🧠 Mypy Fix Guide: `crawler_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/crawler_strategy.py`
**Lines:** `394`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/crawler_strategy.py --strict
```

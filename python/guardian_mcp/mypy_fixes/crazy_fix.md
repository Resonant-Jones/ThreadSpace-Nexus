...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/crazy.py`
**Lines:** `432`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/crazy.py --strict
```

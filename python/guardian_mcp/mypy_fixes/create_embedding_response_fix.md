# 🧠 Mypy Fix Guide: `create_embedding_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/create_embedding_response.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/create_embedding_response.py --strict
```

# 🧠 Mypy Fix Guide: `create_eval_completions_run_data_source_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/create_eval_completions_run_data_source_param.py`
**Lines:** `194`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/create_eval_completions_run_data_source_param.py --strict
```

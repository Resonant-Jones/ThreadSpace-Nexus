# 🧠 Mypy Fix Guide: `create_eval_jsonl_run_data_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/create_eval_jsonl_run_data_source.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/create_eval_jsonl_run_data_source.py --strict
```

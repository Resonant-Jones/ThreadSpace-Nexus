# 🧠 Mypy Fix Guide: `create_from_yaml.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/utils/create_from_yaml.py`
**Lines:** `324`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/utils/create_from_yaml.py --strict
```

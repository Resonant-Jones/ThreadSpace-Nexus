# 🧠 Mypy Fix Guide: `create_http_client_with_basic_auth.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/client/create_http_client_with_basic_auth.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/client/create_http_client_with_basic_auth.py --strict
```

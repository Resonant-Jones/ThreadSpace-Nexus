# 🧠 Mypy Fix Guide: `create_numpy_pickle.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/data/create_numpy_pickle.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/data/create_numpy_pickle.py --strict
```

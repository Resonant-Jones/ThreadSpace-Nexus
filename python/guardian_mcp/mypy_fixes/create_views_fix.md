# 🧠 Mypy Fix Guide: `create_views.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/create_views.py`
**Lines:** `227`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/create_views.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/creator.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/creator.py --strict
```

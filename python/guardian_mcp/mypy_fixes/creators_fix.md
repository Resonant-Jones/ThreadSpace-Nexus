...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/run/plugin/creators.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/run/plugin/creators.py --strict
```

# 🧠 Mypy Fix Guide: `credential_accessor.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/credential_accessor.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/credential_accessor.py --strict
```

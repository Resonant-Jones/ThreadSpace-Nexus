...
**File:** `.venv/lib/python3.13/site-packages/google/auth/compute_engine/credentials.py`
**Lines:** `497`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/compute_engine/credentials.py --strict
```

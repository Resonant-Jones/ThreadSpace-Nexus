# 🧠 Mypy Fix Guide: `cross_version.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/utils/cross_version.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/utils/cross_version.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/crubadan.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/crubadan.py --strict
```

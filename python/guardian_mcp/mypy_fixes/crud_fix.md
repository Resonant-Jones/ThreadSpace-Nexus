...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/crud.py`
**Lines:** `1678`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/crud.py --strict
```

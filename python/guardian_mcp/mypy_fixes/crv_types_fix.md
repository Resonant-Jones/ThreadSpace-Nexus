...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/crv_types.py`
**Lines:** `4732`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/crv_types.py --strict
```

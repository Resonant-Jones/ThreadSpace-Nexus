...
**File:** `.venv/lib/python3.13/site-packages/sympy/crypto/crypto.py`
**Lines:** `3368`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/crypto/crypto.py --strict
```

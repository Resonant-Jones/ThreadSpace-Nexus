...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/crystal.py`
**Lines:** `364`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/crystal.py --strict
```

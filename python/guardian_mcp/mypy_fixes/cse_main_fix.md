...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/cse_main.py`
**Lines:** `945`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/cse_main.py --strict
```

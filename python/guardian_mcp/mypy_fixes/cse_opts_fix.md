...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/cse_opts.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/cse_opts.py --strict
```

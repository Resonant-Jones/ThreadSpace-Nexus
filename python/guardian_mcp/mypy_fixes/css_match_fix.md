...
**File:** `.venv/lib/python3.13/site-packages/soupsieve/css_match.py`
**Lines:** `1645`
...
```bash
mypy .venv/lib/python3.13/site-packages/soupsieve/css_match.py --strict
```

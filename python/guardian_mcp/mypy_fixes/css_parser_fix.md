...
**File:** `.venv/lib/python3.13/site-packages/soupsieve/css_parser.py`
**Lines:** `1318`
...
```bash
mypy .venv/lib/python3.13/site-packages/soupsieve/css_parser.py --strict
```

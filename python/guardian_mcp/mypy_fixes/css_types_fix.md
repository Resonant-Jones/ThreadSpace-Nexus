...
**File:** `.venv/lib/python3.13/site-packages/soupsieve/css_types.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/soupsieve/css_types.py --strict
```

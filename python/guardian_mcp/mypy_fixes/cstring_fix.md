...
**File:** `.venv/lib/python3.13/site-packages/mypyc/codegen/cstring.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/codegen/cstring.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/formats/csvs.py`
**Lines:** `330`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/formats/csvs.py --strict
```

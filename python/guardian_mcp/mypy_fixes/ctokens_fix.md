...
**File:** `.venv/lib/python3.13/site-packages/pycparser/ply/ctokens.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/ply/ctokens.py --strict
```

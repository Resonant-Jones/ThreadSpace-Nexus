# 🧠 Mypy Fix Guide: `ctx_mp_python.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/ctx_mp_python.py`
**Lines:** `1149`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/ctx_mp_python.py --strict
```

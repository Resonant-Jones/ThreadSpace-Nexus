...
**File:** `.venv/lib/python3.13/site-packages/mypy/plugins/ctypes.py`
**Lines:** `245`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/plugins/ctypes.py --strict
```

# 🧠 Mypy Fix Guide: `current_thread_executor.py`
...
**File:** `.venv/lib/python3.13/site-packages/asgiref/current_thread_executor.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/asgiref/current_thread_executor.py --strict
```

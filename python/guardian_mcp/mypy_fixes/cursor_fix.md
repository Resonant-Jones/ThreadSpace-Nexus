...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/engine/cursor.py`
**Lines:** `2181`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/engine/cursor.py --strict
```

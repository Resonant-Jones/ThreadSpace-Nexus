...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/biomechanics/curve.py`
**Lines:** `1763`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/biomechanics/curve.py --strict
```

# 🧠 Mypy Fix Guide: `custom_auth_auto.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/custom_auth_auto.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/custom_auth_auto.py --strict
```

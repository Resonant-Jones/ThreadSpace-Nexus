# 🧠 Mypy Fix Guide: `custom_auth_basic.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_auth_basic.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_auth_basic.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_auth.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_auth.py --strict
```

# 🧠 Mypy Fix Guide: `custom_batch_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/custom_batch_logger.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/custom_batch_logger.py --strict
```

# 🧠 Mypy Fix Guide: `custom_callbacks1.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_callbacks1.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_callbacks1.py --strict
```

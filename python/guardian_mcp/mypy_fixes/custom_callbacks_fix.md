# 🧠 Mypy Fix Guide: `custom_callbacks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_callbacks.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_callbacks.py --strict
```

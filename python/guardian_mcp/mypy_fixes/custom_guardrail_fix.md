# 🧠 Mypy Fix Guide: `custom_guardrail.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/custom_guardrail.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/custom_guardrail.py --strict
```

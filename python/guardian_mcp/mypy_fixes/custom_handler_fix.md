# 🧠 Mypy Fix Guide: `custom_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_handler.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/example_config_yaml/custom_handler.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/custom_http.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/custom_http.py --strict
```

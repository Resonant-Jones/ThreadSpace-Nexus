...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/custom_llm.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/custom_llm.py --strict
```

# 🧠 Mypy Fix Guide: `custom_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/custom_logger.py`
**Lines:** `409`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/custom_logger.py --strict
```

# 🧠 Mypy Fix Guide: `custom_objects_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/custom_objects_api.py`
**Lines:** `4696`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/custom_objects_api.py --strict
```

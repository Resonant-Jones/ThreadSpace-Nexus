# 🧠 Mypy Fix Guide: `custom_prompt_management.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/custom_prompt_management.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/custom_prompt_management.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/custom_sso.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/custom_sso.py --strict
```

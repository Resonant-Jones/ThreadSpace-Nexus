# 🧠 Mypy Fix Guide: `custom_validate.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/custom_validate.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/custom_validate.py --strict
```

# 🧠 Mypy Fix Guide: `customer_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/customer_endpoints.py`
**Lines:** `682`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/customer_endpoints.py --strict
```

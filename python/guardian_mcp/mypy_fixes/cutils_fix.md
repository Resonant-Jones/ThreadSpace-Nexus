...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/cutils.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/cutils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/cversions.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/cversions.py --strict
```

# 🧠 Mypy Fix Guide: `cvt_pyparsing_pep8_names.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyparsing/tools/cvt_pyparsing_pep8_names.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyparsing/tools/cvt_pyparsing_pep8_names.py --strict
```

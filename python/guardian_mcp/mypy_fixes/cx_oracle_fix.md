...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/oracle/cx_oracle.py`
**Lines:** `1552`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/oracle/cx_oracle.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/cxxnodes.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/cxxnodes.py --strict
```

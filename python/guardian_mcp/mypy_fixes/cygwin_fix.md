...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/compilers/C/cygwin.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/compilers/C/cygwin.py --strict
```

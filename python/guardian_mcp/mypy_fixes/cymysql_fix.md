...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/cymysql.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/cymysql.py --strict
```

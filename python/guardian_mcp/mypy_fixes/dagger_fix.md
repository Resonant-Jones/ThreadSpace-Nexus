...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/dagger.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/dagger.py --strict
```

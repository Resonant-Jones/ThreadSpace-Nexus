# 🧠 Mypy Fix Guide: `daily_spend_update_queue.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/daily_spend_update_queue.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/daily_spend_update_queue.py --strict
```

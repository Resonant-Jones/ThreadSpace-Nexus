# 🧠 Mypy Fix Guide: `dall_e_2_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/azure/image_generation/dall_e_2_transformation.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/azure/image_generation/dall_e_2_transformation.py --strict
```

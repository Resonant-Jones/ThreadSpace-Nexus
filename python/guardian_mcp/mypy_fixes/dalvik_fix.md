...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/dalvik.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/dalvik.py --strict
```

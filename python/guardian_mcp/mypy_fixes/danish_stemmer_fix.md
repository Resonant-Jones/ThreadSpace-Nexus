# 🧠 Mypy Fix Guide: `danish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/danish_stemmer.py`
**Lines:** `221`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/danish_stemmer.py --strict
```

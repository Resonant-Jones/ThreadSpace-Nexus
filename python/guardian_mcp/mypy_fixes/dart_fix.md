...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/dart.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/dart.py --strict
```

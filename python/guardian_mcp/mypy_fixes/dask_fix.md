...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/dask.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/dask.py --strict
```

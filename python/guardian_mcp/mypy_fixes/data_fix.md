...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/data.py`
**Lines:** `763`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/data.py --strict
```

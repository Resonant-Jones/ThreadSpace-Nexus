...
**File:** `.venv/lib/python3.13/site-packages/fake_http_header/data_import.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/fake_http_header/data_import.py --strict
```

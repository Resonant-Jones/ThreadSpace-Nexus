# 🧠 Mypy Fix Guide: `data_loaders.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/data_loaders.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/data_loaders.py --strict
```

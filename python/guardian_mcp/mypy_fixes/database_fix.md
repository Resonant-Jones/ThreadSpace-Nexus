...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/database.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/database.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/databricks.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/databricks.py --strict
```

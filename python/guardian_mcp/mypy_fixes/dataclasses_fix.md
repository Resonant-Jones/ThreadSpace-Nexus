...
**File:** `.venv/lib/python3.13/site-packages/mypy/plugins/dataclasses.py`
**Lines:** `1137`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/plugins/dataclasses.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/datadog.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/datadog.py --strict
```

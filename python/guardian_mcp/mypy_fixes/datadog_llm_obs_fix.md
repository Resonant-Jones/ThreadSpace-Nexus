# 🧠 Mypy Fix Guide: `datadog_llm_obs.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/datadog_llm_obs.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/datadog_llm_obs.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/analysis/dataflow.py`
**Lines:** `617`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/analysis/dataflow.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/interchange/dataframe.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/interchange/dataframe.py --strict
```

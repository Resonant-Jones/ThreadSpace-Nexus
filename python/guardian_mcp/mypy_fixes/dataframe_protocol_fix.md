# 🧠 Mypy Fix Guide: `dataframe_protocol.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/interchange/dataframe_protocol.py`
**Lines:** `465`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/interchange/dataframe_protocol.py --strict
```

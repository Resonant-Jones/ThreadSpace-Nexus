# 🧠 Mypy Fix Guide: `datastructures.py`
...
**File:** `.venv/lib/python3.13/site-packages/fastapi/datastructures.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/datastructures.py --strict
```

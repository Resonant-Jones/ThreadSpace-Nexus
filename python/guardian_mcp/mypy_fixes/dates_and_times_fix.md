# 🧠 Mypy Fix Guide: `dates_and_times.py`
...
**File:** `.venv/lib/python3.13/site-packages/pypika/clickhouse/dates_and_times.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/clickhouse/dates_and_times.py --strict
```

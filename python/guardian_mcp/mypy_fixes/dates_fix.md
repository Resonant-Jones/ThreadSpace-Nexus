...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/dates.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/dates.py --strict
```

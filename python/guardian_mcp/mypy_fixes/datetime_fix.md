...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/datetime.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/datetime.py --strict
```

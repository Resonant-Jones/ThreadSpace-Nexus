# 🧠 Mypy Fix Guide: `datetime_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/datetime_helpers.py`
**Lines:** `298`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/datetime_helpers.py --strict
```

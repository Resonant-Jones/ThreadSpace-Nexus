# 🧠 Mypy Fix Guide: `datetime_parse.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/datetime_parse.py`
**Lines:** `248`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/datetime_parse.py --strict
```

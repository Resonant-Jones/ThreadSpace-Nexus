# 🧠 Mypy Fix Guide: `datetime_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/type/datetime_pb2.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/type/datetime_pb2.py --strict
```

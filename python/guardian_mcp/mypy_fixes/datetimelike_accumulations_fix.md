# 🧠 Mypy Fix Guide: `datetimelike_accumulations.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/datetimelike_accumulations.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/datetimelike_accumulations.py --strict
```

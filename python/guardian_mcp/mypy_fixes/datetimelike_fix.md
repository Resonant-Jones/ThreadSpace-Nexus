# 🧠 Mypy Fix Guide: `datetimelike.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/datetimelike.py`
**Lines:** `843`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/datetimelike.py --strict
```

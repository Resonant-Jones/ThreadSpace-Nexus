...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/datetimes.py`
**Lines:** `1127`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/datetimes.py --strict
```

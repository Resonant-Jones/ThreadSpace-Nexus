...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/dateutil.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/dateutil.py --strict
```

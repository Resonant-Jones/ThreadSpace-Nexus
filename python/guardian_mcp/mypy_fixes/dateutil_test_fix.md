# 🧠 Mypy Fix Guide: `dateutil_test.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/dateutil_test.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/dateutil_test.py --strict
```

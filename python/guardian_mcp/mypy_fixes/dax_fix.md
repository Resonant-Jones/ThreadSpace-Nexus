...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/dax.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/dax.py --strict
```

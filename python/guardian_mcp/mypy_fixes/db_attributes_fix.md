# 🧠 Mypy Fix Guide: `db_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/db_attributes.py`
**Lines:** `591`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/db_attributes.py --strict
```

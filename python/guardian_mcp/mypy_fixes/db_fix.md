...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/_experimental/mcp_server/db.py`
**Lines:** `247`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/_experimental/mcp_server/db.py --strict
```

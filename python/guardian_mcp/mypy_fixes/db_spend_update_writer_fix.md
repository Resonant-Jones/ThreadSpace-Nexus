# 🧠 Mypy Fix Guide: `db_spend_update_writer.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_spend_update_writer.py`
**Lines:** `1206`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_spend_update_writer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/dbfs.py`
**Lines:** `468`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/dbfs.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/dd_tracing.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/dd_tracing.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/ddm.py`
**Lines:** `1176`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/ddm.py --strict
```

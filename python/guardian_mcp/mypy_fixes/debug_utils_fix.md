...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/debug_utils.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/debug_utils.py --strict
```

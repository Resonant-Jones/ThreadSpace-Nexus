...
**File:** `.venv/lib/python3.13/site-packages/_pytest/debugging.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/debugging.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/type/decimal_pb2.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/type/decimal_pb2.py --strict
```

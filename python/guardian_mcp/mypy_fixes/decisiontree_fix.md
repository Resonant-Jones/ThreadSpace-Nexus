# 🧠 Mypy Fix Guide: `decisiontree.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/decisiontree.py`
**Lines:** `349`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/decisiontree.py --strict
```

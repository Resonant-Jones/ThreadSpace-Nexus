...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/decl_api.py`
**Lines:** `1917`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/decl_api.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/decl_base.py`
**Lines:** `2186`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/decl_base.py --strict
```

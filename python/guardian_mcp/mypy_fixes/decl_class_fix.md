...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/decl_class.py`
**Lines:** `515`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/decl_class.py --strict
```

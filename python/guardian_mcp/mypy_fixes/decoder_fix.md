...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/codec/ber/decoder.py`
**Lines:** `2189`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/codec/ber/decoder.py --strict
```

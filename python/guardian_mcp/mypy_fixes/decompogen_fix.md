...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/decompogen.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/decompogen.py --strict
```

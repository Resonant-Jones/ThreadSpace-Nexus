# 🧠 Mypy Fix Guide: `decompositions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/decompositions.py`
**Lines:** `1621`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/decompositions.py --strict
```

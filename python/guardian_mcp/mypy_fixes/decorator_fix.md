...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/decorator.py`
**Lines:** `339`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/decorator.py --strict
```

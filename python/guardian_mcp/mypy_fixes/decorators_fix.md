...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/decorators.py`
**Lines:** `250`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/decorators.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/deepeval/deepeval.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/deepeval/deepeval.py --strict
```

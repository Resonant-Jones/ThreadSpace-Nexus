...
**File:** `.venv/lib/python3.13/site-packages/mistune/plugins/def_list.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/plugins/def_list.py --strict
```

# 🧠 Mypy Fix Guide: `default_comparator.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/default_comparator.py`
**Lines:** `552`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/default_comparator.py --strict
```

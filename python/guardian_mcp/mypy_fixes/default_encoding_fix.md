# 🧠 Mypy Fix Guide: `default_encoding.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/default_encoding.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/default_encoding.py --strict
```

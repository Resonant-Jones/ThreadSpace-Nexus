...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/default.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/default.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/defaults.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/defaults.py --strict
```

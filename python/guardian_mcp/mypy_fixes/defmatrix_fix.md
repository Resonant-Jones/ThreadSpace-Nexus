...
**File:** `.venv/lib/python3.13/site-packages/numpy/matrixlib/defmatrix.py`
**Lines:** `1119`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/matrixlib/defmatrix.py --strict
```

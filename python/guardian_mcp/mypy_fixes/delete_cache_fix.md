# 🧠 Mypy Fix Guide: `delete_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/delete_cache.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/delete_cache.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/delete_file.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/delete_file.py --strict
```

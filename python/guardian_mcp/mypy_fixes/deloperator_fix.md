...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/deloperator.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/deloperator.py --strict
```

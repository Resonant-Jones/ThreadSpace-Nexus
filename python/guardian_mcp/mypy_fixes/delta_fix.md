...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/delta.py`
**Lines:** `327`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/delta.py --strict
```

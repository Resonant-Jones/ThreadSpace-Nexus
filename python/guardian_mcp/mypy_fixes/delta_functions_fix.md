# 🧠 Mypy Fix Guide: `delta_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/delta_functions.py`
**Lines:** `664`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/delta_functions.py --strict
```

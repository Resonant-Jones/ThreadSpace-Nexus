# 🧠 Mypy Fix Guide: `deltafunctions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/deltafunctions.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/deltafunctions.py --strict
```

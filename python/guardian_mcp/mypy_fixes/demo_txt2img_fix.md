# 🧠 Mypy Fix Guide: `demo_txt2img.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/demo_txt2img.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/demo_txt2img.py --strict
```

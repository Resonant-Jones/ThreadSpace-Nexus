# 🧠 Mypy Fix Guide: `demo_txt2img_xl.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/demo_txt2img_xl.py`
**Lines:** `268`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/demo_txt2img_xl.py --strict
```

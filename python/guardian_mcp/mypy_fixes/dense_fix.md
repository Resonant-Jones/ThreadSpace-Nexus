...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/dense.py`
**Lines:** `824`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/dense.py --strict
```

# 🧠 Mypy Fix Guide: `dense_ndim_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/dense_ndim_array.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/dense_ndim_array.py --strict
```

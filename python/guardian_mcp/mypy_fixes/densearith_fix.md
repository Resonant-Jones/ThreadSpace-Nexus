...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/densearith.py`
**Lines:** `1875`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/densearith.py --strict
```

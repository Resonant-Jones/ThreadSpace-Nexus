...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/densebasic.py`
**Lines:** `1887`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/densebasic.py --strict
```

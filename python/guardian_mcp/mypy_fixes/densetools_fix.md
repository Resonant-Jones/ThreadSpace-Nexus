...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/densetools.py`
**Lines:** `1438`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/densetools.py --strict
```

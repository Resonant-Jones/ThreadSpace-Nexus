...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/density.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/density.py --strict
```

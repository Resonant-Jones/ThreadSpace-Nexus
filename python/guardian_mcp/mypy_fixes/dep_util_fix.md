...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/dep_util.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/dep_util.py --strict
```

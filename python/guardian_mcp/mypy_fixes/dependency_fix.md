...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/dependency.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/dependency.py --strict
```

# 🧠 Mypy Fix Guide: `dependencygraph.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/dependencygraph.py`
**Lines:** `799`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/dependencygraph.py --strict
```

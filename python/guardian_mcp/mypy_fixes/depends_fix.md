...
**File:** `.venv/lib/python3.13/site-packages/setuptools/depends.py`
**Lines:** `185`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/depends.py --strict
```

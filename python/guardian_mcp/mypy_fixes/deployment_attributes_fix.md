# 🧠 Mypy Fix Guide: `deployment_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/deployment_attributes.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/deployment_attributes.py --strict
```

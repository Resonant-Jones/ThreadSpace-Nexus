...
**File:** `.venv/lib/python3.13/site-packages/_pytest/deprecated.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/deprecated.py --strict
```

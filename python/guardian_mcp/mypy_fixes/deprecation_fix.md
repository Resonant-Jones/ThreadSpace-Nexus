...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/deprecation.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/deprecation.py --strict
```

# 🧠 Mypy Fix Guide: `deprecations.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/deprecations.py`
**Lines:** `401`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/deprecations.py --strict
```

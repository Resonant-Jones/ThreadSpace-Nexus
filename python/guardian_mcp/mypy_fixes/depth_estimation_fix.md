# 🧠 Mypy Fix Guide: `depth_estimation.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/depth_estimation.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/depth_estimation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/describe.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/describe.py --strict
```

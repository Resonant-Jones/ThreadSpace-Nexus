# 🧠 Mypy Fix Guide: `descriptor_database.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/descriptor_database.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/descriptor_database.py --strict
```

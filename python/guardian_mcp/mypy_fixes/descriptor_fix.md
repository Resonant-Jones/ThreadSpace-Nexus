...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/descriptor.py`
**Lines:** `1511`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/descriptor.py --strict
```

# 🧠 Mypy Fix Guide: `descriptor_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/descriptor_pb2.py`
**Lines:** `3169`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/descriptor_pb2.py --strict
```

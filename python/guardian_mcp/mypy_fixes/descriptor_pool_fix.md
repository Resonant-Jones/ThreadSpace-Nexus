# 🧠 Mypy Fix Guide: `descriptor_pool.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/descriptor_pool.py`
**Lines:** `1355`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/descriptor_pool.py --strict
```

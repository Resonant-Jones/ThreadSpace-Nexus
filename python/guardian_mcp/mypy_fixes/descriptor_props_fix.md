# 🧠 Mypy Fix Guide: `descriptor_props.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/descriptor_props.py`
**Lines:** `1077`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/descriptor_props.py --strict
```

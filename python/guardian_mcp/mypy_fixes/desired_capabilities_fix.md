# 🧠 Mypy Fix Guide: `desired_capabilities.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/desired_capabilities.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/desired_capabilities.py --strict
```

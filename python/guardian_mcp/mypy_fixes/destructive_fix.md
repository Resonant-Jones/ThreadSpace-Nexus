...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/destructive.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/destructive.py --strict
```

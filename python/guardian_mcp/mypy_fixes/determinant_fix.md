...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/determinant.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/determinant.py --strict
```

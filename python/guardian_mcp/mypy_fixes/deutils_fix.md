...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/deutils.py`
**Lines:** `273`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/deutils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/develop.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/develop.py --strict
```

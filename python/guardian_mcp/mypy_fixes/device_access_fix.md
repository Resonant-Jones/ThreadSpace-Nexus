# 🧠 Mypy Fix Guide: `device_access.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/device_access.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/device_access.py --strict
```

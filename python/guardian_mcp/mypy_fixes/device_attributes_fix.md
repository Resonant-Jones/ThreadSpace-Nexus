# 🧠 Mypy Fix Guide: `device_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/device_attributes.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/device_attributes.py --strict
```

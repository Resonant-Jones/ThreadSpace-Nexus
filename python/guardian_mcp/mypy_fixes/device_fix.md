...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc8628/clients/device.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc8628/clients/device.py --strict
```

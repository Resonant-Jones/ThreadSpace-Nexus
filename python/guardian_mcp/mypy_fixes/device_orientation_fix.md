# 🧠 Mypy Fix Guide: `device_orientation.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/device_orientation.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/device_orientation.py --strict
```

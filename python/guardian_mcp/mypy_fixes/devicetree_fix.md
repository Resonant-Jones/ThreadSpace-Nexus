...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/devicetree.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/devicetree.py --strict
```

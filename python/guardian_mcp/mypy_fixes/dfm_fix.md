...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/dfm.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/dfm.py --strict
```

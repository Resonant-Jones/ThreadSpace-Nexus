# 🧠 Mypy Fix Guide: `dfs_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/dfs_strategy.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/dfs_strategy.py --strict
```

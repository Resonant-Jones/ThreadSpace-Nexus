...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/diagnose.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/diagnose.py --strict
```

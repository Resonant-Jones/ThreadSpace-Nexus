...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/diagonal.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/diagonal.py --strict
```

# 🧠 Mypy Fix Guide: `diagram_drawing.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/categories/diagram_drawing.py`
**Lines:** `2580`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/categories/diagram_drawing.py --strict
```

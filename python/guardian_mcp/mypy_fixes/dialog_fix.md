...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/fedcm/dialog.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/fedcm/dialog.py --strict
```

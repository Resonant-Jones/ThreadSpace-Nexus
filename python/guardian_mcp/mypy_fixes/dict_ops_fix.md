...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/dict_ops.py`
**Lines:** `325`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/dict_ops.py --strict
```

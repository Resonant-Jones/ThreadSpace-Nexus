...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/oracle/dictionary.py`
**Lines:** `507`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/oracle/dictionary.py --strict
```

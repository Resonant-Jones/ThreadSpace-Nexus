...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/diff.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/diff.py --strict
```

# 🧠 Mypy Fix Guide: `differentiation.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/calculus/differentiation.py`
**Lines:** `647`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/calculus/differentiation.py --strict
```

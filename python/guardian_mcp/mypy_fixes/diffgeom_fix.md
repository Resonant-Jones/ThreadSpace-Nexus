...
**File:** `.venv/lib/python3.13/site-packages/sympy/diffgeom/diffgeom.py`
**Lines:** `2270`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/diffgeom/diffgeom.py --strict
```

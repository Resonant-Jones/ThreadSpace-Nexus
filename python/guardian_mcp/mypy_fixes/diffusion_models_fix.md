# 🧠 Mypy Fix Guide: `diffusion_models.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/diffusion_models.py`
**Lines:** `1318`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/diffusion_models.py --strict
```

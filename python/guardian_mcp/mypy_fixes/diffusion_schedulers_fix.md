# 🧠 Mypy Fix Guide: `diffusion_schedulers.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/diffusion_schedulers.py`
**Lines:** `1179`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/diffusion_schedulers.py --strict
```

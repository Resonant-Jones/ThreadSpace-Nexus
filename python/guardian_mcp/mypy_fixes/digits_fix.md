...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/digits.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/digits.py --strict
```

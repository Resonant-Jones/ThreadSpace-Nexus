# 🧠 Mypy Fix Guide: `dimension_definitions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/definitions/dimension_definitions.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/definitions/dimension_definitions.py --strict
```

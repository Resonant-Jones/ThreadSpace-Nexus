...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/dimensions.py`
**Lines:** `590`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/dimensions.py --strict
```

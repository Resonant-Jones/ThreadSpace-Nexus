...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/diophantine/diophantine.py`
**Lines:** `3980`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/diophantine/diophantine.py --strict
```

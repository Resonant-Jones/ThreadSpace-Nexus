...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/dir_util.py`
**Lines:** `244`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/dir_util.py --strict
```

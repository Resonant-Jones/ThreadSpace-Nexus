...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/direct_q8.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/direct_q8.py --strict
```

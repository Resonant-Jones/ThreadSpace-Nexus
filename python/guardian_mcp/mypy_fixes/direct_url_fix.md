...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/direct_url.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/direct_url.py --strict
```

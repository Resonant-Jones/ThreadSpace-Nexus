# 🧠 Mypy Fix Guide: `direct_url_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/direct_url_helpers.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/direct_url_helpers.py --strict
```

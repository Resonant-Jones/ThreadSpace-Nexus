...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/directory.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/directory.py --strict
```

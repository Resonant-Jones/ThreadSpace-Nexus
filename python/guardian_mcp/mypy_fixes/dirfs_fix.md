...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/dirfs.py`
**Lines:** `388`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/dirfs.py --strict
```

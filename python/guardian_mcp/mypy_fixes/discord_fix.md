...
**File:** `.venv/lib/python3.13/site-packages/tqdm/contrib/discord.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/contrib/discord.py --strict
```

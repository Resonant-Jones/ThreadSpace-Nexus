...
**File:** `.venv/lib/python3.13/site-packages/nltk/inference/discourse.py`
**Lines:** `651`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/inference/discourse.py --strict
```

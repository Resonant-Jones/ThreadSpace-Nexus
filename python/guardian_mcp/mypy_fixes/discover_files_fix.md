# 🧠 Mypy Fix Guide: `discover_files.py`
...
**File:** `.venv/lib/python3.13/site-packages/flake8/discover_files.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/discover_files.py --strict
```

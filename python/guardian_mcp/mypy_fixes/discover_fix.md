...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/discovery/discover.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/discovery/discover.py --strict
```

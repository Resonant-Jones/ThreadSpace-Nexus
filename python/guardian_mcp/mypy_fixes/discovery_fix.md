...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/dynamic/discovery.py`
**Lines:** `433`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/dynamic/discovery.py --strict
```

# 🧠 Mypy Fix Guide: `discovery_v1_endpoint_port.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/discovery_v1_endpoint_port.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/discovery_v1_endpoint_port.py --strict
```

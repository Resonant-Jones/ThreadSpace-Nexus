# 🧠 Mypy Fix Guide: `disk_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/disk_attributes.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/disk_attributes.py --strict
```

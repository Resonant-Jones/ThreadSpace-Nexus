...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/disk_cache.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/disk_cache.py --strict
```

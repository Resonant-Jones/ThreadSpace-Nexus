...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/ops/dispatch.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/ops/dispatch.py --strict
```

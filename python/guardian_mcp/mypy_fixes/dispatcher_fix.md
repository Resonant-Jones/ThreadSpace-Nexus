...
**File:** `.venv/lib/python3.13/site-packages/sympy/multipledispatch/dispatcher.py`
**Lines:** `413`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/multipledispatch/dispatcher.py --strict
```

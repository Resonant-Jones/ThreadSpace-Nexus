...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/dispersion.py`
**Lines:** `212`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/dispersion.py --strict
```

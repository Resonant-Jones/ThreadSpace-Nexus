...
**File:** `.venv/lib/python3.13/site-packages/pandas/_config/display.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_config/display.py --strict
```

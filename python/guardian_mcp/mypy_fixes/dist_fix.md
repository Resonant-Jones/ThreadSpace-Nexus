...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/dist.py`
**Lines:** `1386`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/dist.py --strict
```

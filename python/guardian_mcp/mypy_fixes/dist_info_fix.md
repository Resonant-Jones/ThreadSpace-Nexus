...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/dist_info.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/dist_info.py --strict
```

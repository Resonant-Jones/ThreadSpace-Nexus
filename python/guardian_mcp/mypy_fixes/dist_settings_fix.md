# 🧠 Mypy Fix Guide: `dist_settings.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/dist_settings.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/dist_settings.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/distance.py`
**Lines:** `508`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/distance.py --strict
```

# 🧠 Mypy Fix Guide: `distance_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/utils/distance_functions.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/utils/distance_functions.py --strict
```

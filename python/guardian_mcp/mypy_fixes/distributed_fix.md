...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/manager/distributed.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/manager/distributed.py --strict
```

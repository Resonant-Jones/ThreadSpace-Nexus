# 🧠 Mypy Fix Guide: `distributedmodules.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/distributedmodules.py`
**Lines:** `739`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/distributedmodules.py --strict
```

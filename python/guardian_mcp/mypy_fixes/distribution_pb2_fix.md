# 🧠 Mypy Fix Guide: `distribution_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/distribution_pb2.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/distribution_pb2.py --strict
```

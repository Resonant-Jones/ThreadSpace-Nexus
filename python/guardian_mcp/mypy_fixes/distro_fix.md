...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/distro.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/distro.py --strict
```

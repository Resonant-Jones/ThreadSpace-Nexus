...
**File:** `.venv/lib/python3.13/site-packages/posthog/sentry/django.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/sentry/django.py --strict
```

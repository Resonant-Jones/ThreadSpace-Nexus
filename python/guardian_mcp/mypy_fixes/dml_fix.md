...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/dml.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/dml.py --strict
```

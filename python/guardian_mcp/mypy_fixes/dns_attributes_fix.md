# 🧠 Mypy Fix Guide: `dns_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/dns_attributes.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/dns_attributes.py --strict
```

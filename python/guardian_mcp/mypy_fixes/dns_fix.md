...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/dns.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/dns.py --strict
```

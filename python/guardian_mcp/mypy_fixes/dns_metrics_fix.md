...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/dns_metrics.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/dns_metrics.py --strict
```

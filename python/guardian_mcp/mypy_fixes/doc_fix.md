...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/window/doc.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/window/doc.py --strict
```

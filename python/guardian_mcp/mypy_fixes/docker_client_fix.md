# 🧠 Mypy Fix Guide: `docker_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/docker_client.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/docker_client.py --strict
```

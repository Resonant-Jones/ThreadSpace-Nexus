...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/docker.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/docker.py --strict
```

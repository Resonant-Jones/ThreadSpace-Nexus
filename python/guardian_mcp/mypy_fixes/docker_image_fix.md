# 🧠 Mypy Fix Guide: `docker_image.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/docker_image.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/docker_image.py --strict
```

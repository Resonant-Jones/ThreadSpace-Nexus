...
**File:** `.venv/lib/python3.13/site-packages/fastapi/openapi/docs.py`
**Lines:** `344`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/openapi/docs.py --strict
```

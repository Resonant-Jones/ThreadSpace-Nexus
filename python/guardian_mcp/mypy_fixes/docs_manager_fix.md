# 🧠 Mypy Fix Guide: `docs_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/docs_manager.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/docs_manager.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/ops/docstrings.py`
**Lines:** `772`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/ops/docstrings.py --strict
```

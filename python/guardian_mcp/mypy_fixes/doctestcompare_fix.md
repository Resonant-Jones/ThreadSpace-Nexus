# 🧠 Mypy Fix Guide: `doctestcompare.py`
...
**File:** `.venv/lib/python3.13/site-packages/lxml/doctestcompare.py`
**Lines:** `488`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/doctestcompare.py --strict
```

# 🧠 Mypy Fix Guide: `documentation_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/documentation_pb2.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/documentation_pb2.py --strict
```

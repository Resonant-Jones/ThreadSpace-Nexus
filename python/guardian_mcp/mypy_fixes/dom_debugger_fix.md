# 🧠 Mypy Fix Guide: `dom_debugger.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/dom_debugger.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/dom_debugger.py --strict
```

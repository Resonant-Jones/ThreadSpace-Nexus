# 🧠 Mypy Fix Guide: `dom_snapshot.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/dom_snapshot.py`
**Lines:** `870`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/dom_snapshot.py --strict
```

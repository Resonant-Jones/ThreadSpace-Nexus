...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/domain.py`
**Lines:** `1382`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/domain.py --strict
```

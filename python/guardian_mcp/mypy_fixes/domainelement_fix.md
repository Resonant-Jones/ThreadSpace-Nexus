# 🧠 Mypy Fix Guide: `domainelement.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/domainelement.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/domainelement.py --strict
```

# 🧠 Mypy Fix Guide: `domainscalar.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/domainscalar.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/domainscalar.py --strict
```

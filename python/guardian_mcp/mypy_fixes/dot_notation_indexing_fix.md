# 🧠 Mypy Fix Guide: `dot_notation_indexing.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/dot_notation_indexing.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/dot_notation_indexing.py --strict
```

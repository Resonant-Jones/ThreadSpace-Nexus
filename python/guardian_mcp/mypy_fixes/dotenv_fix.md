...
**File:** `.venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/dotenv.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/dotenv.py --strict
```

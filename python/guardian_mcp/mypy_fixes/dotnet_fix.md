...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/dotnet.py`
**Lines:** `873`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/dotnet.py --strict
```

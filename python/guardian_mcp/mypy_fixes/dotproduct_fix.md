...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/dotproduct.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/dotproduct.py --strict
```

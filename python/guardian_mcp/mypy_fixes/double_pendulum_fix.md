# 🧠 Mypy Fix Guide: `double_pendulum.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/double_pendulum.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/double_pendulum.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/download.py`
**Lines:** `200`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/download.py --strict
```

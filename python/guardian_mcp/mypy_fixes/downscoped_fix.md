...
**File:** `.venv/lib/python3.13/site-packages/google/auth/downscoped.py`
**Lines:** `512`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/downscoped.py --strict
```

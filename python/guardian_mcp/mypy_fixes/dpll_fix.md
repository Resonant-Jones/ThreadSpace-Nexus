...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/algorithms/dpll.py`
**Lines:** `308`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/algorithms/dpll.py --strict
```

# 🧠 Mypy Fix Guide: `dpo_hyperparameters.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/dpo_hyperparameters.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/dpo_hyperparameters.py --strict
```

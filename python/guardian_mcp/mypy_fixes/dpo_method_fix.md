...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/dpo_method.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/dpo_method.py --strict
```

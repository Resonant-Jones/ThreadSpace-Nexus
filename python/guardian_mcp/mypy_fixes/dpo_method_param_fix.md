# 🧠 Mypy Fix Guide: `dpo_method_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/dpo_method_param.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/dpo_method_param.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/dracula.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/dracula.py --strict
```

# 🧠 Mypy Fix Guide: `driver_finder.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/driver_finder.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/driver_finder.py --strict
```

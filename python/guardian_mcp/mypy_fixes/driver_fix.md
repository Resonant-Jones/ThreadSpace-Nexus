...
**File:** `.venv/lib/python3.13/site-packages/blib2to3/pgen2/driver.py`
**Lines:** `319`
...
```bash
mypy .venv/lib/python3.13/site-packages/blib2to3/pgen2/driver.py --strict
```

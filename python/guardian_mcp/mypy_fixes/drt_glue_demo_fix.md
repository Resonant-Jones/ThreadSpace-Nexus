# 🧠 Mypy Fix Guide: `drt_glue_demo.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/sem/drt_glue_demo.py`
**Lines:** `553`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/sem/drt_glue_demo.py --strict
```

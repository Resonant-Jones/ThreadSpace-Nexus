...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/drv_types.py`
**Lines:** `849`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/drv_types.py --strict
```

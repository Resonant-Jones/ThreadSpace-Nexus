...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/dsls.py`
**Lines:** `970`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/dsls.py --strict
```

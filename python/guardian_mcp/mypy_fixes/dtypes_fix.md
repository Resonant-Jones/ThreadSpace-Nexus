...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/dtypes/dtypes.py`
**Lines:** `2348`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/dtypes/dtypes.py --strict
```

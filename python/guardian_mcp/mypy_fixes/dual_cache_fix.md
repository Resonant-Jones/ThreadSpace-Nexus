...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/dual_cache.py`
**Lines:** `462`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/dual_cache.py --strict
```

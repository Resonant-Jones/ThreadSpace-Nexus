...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/duration.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/duration.py --strict
```

# 🧠 Mypy Fix Guide: `duration_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/duration_parser.py`
**Lines:** `384`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/duration_parser.py --strict
```

# 🧠 Mypy Fix Guide: `dutch_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/dutch_stemmer.py`
**Lines:** `468`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/dutch_stemmer.py --strict
```

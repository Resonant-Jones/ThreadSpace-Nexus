...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/vector/dyadic.py`
**Lines:** `545`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/vector/dyadic.py --strict
```

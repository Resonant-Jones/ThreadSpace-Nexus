...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/dylan.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/dylan.py --strict
```

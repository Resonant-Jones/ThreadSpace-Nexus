...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/dynamic.py`
**Lines:** `300`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/dynamic.py --strict
```

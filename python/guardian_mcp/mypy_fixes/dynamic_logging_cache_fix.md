# 🧠 Mypy Fix Guide: `dynamic_logging_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/specialty_caches/dynamic_logging_cache.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/specialty_caches/dynamic_logging_cache.py --strict
```

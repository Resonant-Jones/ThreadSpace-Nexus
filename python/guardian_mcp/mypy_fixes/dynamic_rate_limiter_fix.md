# 🧠 Mypy Fix Guide: `dynamic_rate_limiter.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/dynamic_rate_limiter.py`
**Lines:** `306`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/dynamic_rate_limiter.py --strict
```

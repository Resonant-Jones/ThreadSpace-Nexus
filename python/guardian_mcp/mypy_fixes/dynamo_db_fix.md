...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/dynamo_db.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/dynamo_db.py --strict
```

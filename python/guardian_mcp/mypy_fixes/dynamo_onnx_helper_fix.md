# 🧠 Mypy Fix Guide: `dynamo_onnx_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/dynamo_onnx_helper.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/dynamo_onnx_helper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/dynamodb.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/dynamodb.py --strict
```

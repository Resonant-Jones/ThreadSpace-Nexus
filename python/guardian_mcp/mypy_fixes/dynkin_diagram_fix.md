# 🧠 Mypy Fix Guide: `dynkin_diagram.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/dynkin_diagram.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/dynkin_diagram.py --strict
```

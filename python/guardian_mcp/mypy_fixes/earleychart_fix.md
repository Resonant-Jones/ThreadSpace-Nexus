...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/earleychart.py`
**Lines:** `552`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/earleychart.py --strict
```

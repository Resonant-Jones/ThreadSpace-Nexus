# 🧠 Mypy Fix Guide: `easy_input_message.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/easy_input_message.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/easy_input_message.py --strict
```

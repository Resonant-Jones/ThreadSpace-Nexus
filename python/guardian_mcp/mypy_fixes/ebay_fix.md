...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/compliance_fixes/ebay.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/compliance_fixes/ebay.py --strict
```

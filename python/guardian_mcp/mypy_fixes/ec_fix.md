...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/asymmetric/ec.py`
**Lines:** `447`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/asymmetric/ec.py --strict
```

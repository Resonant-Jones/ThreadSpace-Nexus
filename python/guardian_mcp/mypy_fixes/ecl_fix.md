...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ecl.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ecl.py --strict
```

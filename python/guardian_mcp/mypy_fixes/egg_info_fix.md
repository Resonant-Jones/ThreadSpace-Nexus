...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/egg_info.py`
**Lines:** `718`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/egg_info.py --strict
```

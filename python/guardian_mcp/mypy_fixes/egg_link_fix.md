...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/egg_link.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/egg_link.py --strict
```

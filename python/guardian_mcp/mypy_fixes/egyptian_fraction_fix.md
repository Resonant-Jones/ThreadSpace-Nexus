# 🧠 Mypy Fix Guide: `egyptian_fraction.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/egyptian_fraction.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/egyptian_fraction.py --strict
```

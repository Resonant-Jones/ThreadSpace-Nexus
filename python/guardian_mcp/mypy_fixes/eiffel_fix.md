...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/eiffel.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/eiffel.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/eigen.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/eigen.py --strict
```

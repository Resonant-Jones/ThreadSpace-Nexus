# 🧠 Mypy Fix Guide: `eigen_symmetric.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/matrices/eigen_symmetric.py`
**Lines:** `1807`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/matrices/eigen_symmetric.py --strict
```

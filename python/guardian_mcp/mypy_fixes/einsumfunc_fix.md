...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/einsumfunc.py`
**Lines:** `1498`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/einsumfunc.py --strict
```

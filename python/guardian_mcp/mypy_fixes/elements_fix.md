...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/html2text/elements.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/html2text/elements.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/geometry/ellipse.py`
**Lines:** `1768`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/geometry/ellipse.py --strict
```

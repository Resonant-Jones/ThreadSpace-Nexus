# 🧠 Mypy Fix Guide: `elliptic_curve.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/elliptic_curve.py`
**Lines:** `397`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/elliptic_curve.py --strict
```

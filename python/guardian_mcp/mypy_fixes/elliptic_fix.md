...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/elliptic.py`
**Lines:** `1431`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/elliptic.py --strict
```

# 🧠 Mypy Fix Guide: `elliptic_integrals.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/elliptic_integrals.py`
**Lines:** `445`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/elliptic_integrals.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/elm.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/elm.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/elpi.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/elpi.py --strict
```

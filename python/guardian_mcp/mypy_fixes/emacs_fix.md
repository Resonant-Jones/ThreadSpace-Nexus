...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/emacs.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/emacs.py --strict
```

# 🧠 Mypy Fix Guide: `email_alerting.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/email_alerting.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/email_alerting.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/email.py`
**Lines:** `132`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/email.py --strict
```

# 🧠 Mypy Fix Guide: `email_footer.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/email_templates/email_footer.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/email_templates/email_footer.py --strict
```

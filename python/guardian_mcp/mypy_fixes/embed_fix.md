...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/together_ai/embed.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/together_ai/embed.py --strict
```

# 🧠 Mypy Fix Guide: `embed_layernorm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/embed_layernorm.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/embed_layernorm.py --strict
```

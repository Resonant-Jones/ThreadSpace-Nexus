# 🧠 Mypy Fix Guide: `embedding_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/embedding_create_params.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/embedding_create_params.py --strict
```

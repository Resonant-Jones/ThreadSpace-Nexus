...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/embedding.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/embedding.py --strict
```

# 🧠 Mypy Fix Guide: `embedding_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/vertex_embeddings/embedding_handler.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/vertex_embeddings/embedding_handler.py --strict
```

# 🧠 Mypy Fix Guide: `embedding_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/embedding_model.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/embedding_model.py --strict
```

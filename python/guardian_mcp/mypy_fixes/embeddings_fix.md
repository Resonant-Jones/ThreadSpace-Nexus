...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/embeddings.py`
**Lines:** `292`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/embeddings.py --strict
```

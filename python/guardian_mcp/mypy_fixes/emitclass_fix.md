...
**File:** `.venv/lib/python3.13/site-packages/mypyc/codegen/emitclass.py`
**Lines:** `1101`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/codegen/emitclass.py --strict
```

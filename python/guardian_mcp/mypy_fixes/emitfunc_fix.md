...
**File:** `.venv/lib/python3.13/site-packages/mypyc/codegen/emitfunc.py`
**Lines:** `885`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/codegen/emitfunc.py --strict
```

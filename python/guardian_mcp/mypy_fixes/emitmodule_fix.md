...
**File:** `.venv/lib/python3.13/site-packages/mypyc/codegen/emitmodule.py`
**Lines:** `1143`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/codegen/emitmodule.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/codegen/emitwrapper.py`
**Lines:** `978`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/codegen/emitwrapper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/emoji.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/emoji.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/emphasis.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/emphasis.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/empty_pb2.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/empty_pb2.py --strict
```

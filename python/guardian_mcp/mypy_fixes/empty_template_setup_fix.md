# 🧠 Mypy Fix Guide: `empty_template_setup.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/resources/empty_template_setup.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/resources/empty_template_setup.py --strict
```

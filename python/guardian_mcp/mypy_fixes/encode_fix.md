...
**File:** `.venv/lib/python3.13/site-packages/flatbuffers/encode.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/flatbuffers/encode.py --strict
```

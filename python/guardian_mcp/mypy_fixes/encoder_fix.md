...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/codec/ber/encoder.py`
**Lines:** `954`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/codec/ber/encoder.py --strict
```

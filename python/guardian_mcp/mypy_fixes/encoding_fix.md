...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/reshape/encoding.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/reshape/encoding.py --strict
```

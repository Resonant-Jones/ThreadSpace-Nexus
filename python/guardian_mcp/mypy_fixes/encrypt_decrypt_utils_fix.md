# 🧠 Mypy Fix Guide: `encrypt_decrypt_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/encrypt_decrypt_utils.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/encrypt_decrypt_utils.py --strict
```

# 🧠 Mypy Fix Guide: `endpoint_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/endpoint_helpers.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/endpoint_helpers.py --strict
```

# 🧠 Mypy Fix Guide: `endpoint_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/endpoint_pb2.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/endpoint_pb2.py --strict
```

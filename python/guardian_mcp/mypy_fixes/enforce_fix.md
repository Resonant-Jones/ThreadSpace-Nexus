...
**File:** `.venv/lib/python3.13/site-packages/overrides/enforce.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/overrides/enforce.py --strict
```

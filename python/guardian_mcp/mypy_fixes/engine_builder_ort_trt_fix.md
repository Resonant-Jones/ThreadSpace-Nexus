# 🧠 Mypy Fix Guide: `engine_builder_ort_trt.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/engine_builder_ort_trt.py`
**Lines:** `288`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/engine_builder_ort_trt.py --strict
```

# 🧠 Mypy Fix Guide: `engine_builder_tensorrt.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/engine_builder_tensorrt.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/engine_builder_tensorrt.py --strict
```

# 🧠 Mypy Fix Guide: `engine_builder_torch.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/engine_builder_torch.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/engine_builder_torch.py --strict
```

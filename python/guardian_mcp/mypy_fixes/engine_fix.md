...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/engine.py`
**Lines:** `1469`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/engine.py --strict
```

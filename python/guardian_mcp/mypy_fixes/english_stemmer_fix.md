# 🧠 Mypy Fix Guide: `english_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/english_stemmer.py`
**Lines:** `731`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/english_stemmer.py --strict
```

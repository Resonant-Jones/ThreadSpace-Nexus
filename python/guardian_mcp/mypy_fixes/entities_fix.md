...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/common/entities.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/common/entities.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/geometry/entity.py`
**Lines:** `641`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/geometry/entity.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/entrypoints.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/entrypoints.py --strict
```

# 🧠 Mypy Fix Guide: `enum_type_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/enum_type_wrapper.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/enum_type_wrapper.py --strict
```

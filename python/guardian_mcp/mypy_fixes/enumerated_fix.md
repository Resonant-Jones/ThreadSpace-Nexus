...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/enumerated.py`
**Lines:** `243`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/enumerated.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/enumerative.py`
**Lines:** `1155`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/enumerative.py --strict
```

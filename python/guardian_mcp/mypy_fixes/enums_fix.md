...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/enums.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/enums.py --strict
```

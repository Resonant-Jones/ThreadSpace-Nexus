...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/env_class.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/env_class.py --strict
```

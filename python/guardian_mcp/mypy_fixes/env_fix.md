...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/env.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/env.py --strict
```

# 🧠 Mypy Fix Guide: `env_settings.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/env_settings.py`
**Lines:** `350`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/env_settings.py --strict
```

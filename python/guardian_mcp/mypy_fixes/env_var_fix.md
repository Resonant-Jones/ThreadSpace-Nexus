...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/config/env_var.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/config/env_var.py --strict
```

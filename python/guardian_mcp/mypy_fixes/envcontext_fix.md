...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/envcontext.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/envcontext.py --strict
```

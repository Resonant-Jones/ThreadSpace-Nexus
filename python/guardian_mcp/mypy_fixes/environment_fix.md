...
**File:** `.venv/lib/python3.13/site-packages/jinja2/environment.py`
**Lines:** `1672`
...
```bash
mypy .venv/lib/python3.13/site-packages/jinja2/environment.py --strict
```

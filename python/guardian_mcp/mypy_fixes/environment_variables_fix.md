# 🧠 Mypy Fix Guide: `environment_variables.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/environment_variables.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/environment_variables.py --strict
```

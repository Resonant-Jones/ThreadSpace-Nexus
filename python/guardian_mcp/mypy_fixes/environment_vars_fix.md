# 🧠 Mypy Fix Guide: `environment_vars.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/environment_vars.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/environment_vars.py --strict
```

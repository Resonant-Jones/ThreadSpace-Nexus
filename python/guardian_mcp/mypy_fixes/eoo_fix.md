...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/codec/ber/eoo.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/codec/ber/eoo.py --strict
```

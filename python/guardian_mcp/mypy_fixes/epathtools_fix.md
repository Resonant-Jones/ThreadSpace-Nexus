...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/epathtools.py`
**Lines:** `352`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/epathtools.py --strict
```

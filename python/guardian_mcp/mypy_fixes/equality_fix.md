...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/relation/equality.py`
**Lines:** `302`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/relation/equality.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/erlang.py`
**Lines:** `526`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/erlang.py --strict
```

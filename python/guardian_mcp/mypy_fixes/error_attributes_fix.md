# 🧠 Mypy Fix Guide: `error_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/error_attributes.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/error_attributes.py --strict
```

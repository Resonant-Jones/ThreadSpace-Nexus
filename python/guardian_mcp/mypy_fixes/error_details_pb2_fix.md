# 🧠 Mypy Fix Guide: `error_details_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/rpc/error_details_pb2.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/rpc/error_details_pb2.py --strict
```

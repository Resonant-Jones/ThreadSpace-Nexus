...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/error_event.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/error_event.py --strict
```

# 🧠 Mypy Fix Guide: `error_formatter.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/error_formatter.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/error_formatter.py --strict
```

# 🧠 Mypy Fix Guide: `error_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/error_functions.py`
**Lines:** `2801`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/error_functions.py --strict
```

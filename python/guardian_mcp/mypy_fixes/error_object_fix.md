# 🧠 Mypy Fix Guide: `error_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared/error_object.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared/error_object.py --strict
```

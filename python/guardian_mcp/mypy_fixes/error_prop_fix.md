...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/error_prop.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/error_prop.py --strict
```

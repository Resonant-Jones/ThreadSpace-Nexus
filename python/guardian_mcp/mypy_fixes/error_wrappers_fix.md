# 🧠 Mypy Fix Guide: `error_wrappers.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/error_wrappers.py`
**Lines:** `161`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/error_wrappers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/errors.py`
**Lines:** `2`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/errors.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/auth/crypt/es256.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/crypt/es256.py --strict
```

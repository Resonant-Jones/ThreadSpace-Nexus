...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/escape.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/escape.py --strict
```

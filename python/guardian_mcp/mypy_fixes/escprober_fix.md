...
**File:** `.venv/lib/python3.13/site-packages/chardet/escprober.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/escprober.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/esoteric.py`
**Lines:** `300`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/esoteric.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chardet/euckrfreq.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/euckrfreq.py --strict
```

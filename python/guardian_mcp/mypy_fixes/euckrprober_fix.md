...
**File:** `.venv/lib/python3.13/site-packages/chardet/euckrprober.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/euckrprober.py --strict
```

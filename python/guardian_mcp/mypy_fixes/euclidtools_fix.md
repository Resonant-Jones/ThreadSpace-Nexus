...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/euclidtools.py`
**Lines:** `1912`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/euclidtools.py --strict
```

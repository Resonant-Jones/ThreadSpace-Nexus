...
**File:** `.venv/lib/python3.13/site-packages/chardet/euctwfreq.py`
**Lines:** `388`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/euctwfreq.py --strict
```

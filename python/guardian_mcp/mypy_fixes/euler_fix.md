...
**File:** `.venv/lib/python3.13/site-packages/sympy/calculus/euler.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/calculus/euler.py --strict
```

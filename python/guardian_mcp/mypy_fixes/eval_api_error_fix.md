# 🧠 Mypy Fix Guide: `eval_api_error.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/eval_api_error.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/eval_api_error.py --strict
```

# 🧠 Mypy Fix Guide: `eval_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_create_params.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_create_params.py --strict
```

# 🧠 Mypy Fix Guide: `eval_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_create_response.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_create_response.py --strict
```

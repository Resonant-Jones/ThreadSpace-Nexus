# 🧠 Mypy Fix Guide: `eval_custom_data_source_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_custom_data_source_config.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_custom_data_source_config.py --strict
```

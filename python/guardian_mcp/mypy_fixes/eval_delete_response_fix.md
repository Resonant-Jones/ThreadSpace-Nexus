# 🧠 Mypy Fix Guide: `eval_delete_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_delete_response.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_delete_response.py --strict
```

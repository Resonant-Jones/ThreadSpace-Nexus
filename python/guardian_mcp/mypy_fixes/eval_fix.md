...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/computation/eval.py`
**Lines:** `421`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/computation/eval.py --strict
```

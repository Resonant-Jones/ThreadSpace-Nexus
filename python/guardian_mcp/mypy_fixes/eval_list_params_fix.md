# 🧠 Mypy Fix Guide: `eval_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_list_params.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_list_params.py --strict
```

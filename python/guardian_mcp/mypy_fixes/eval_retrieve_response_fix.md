# 🧠 Mypy Fix Guide: `eval_retrieve_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_retrieve_response.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_retrieve_response.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/bert/eval_squad.py`
**Lines:** `329`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/bert/eval_squad.py --strict
```

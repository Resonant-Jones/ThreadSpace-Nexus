# 🧠 Mypy Fix Guide: `eval_stored_completions_data_source_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_stored_completions_data_source_config.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_stored_completions_data_source_config.py --strict
```

# 🧠 Mypy Fix Guide: `eval_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_update_params.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_update_params.py --strict
```

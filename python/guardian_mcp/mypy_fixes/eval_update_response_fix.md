# 🧠 Mypy Fix Guide: `eval_update_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/eval_update_response.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/eval_update_response.py --strict
```

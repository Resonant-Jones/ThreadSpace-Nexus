...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/evals/evals.py`
**Lines:** `662`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/evals/evals.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/evaluate.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/evaluate.py --strict
```

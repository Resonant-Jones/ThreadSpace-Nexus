...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/evaluator.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/evaluator.py --strict
```

# 🧠 Mypy Fix Guide: `event_firing_webdriver.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/event_firing_webdriver.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/event_firing_webdriver.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/events.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/events.py --strict
```

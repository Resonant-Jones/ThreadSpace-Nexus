# 🧠 Mypy Fix Guide: `events_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/events_v1_api.py`
**Lines:** `1402`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/events_v1_api.py --strict
```

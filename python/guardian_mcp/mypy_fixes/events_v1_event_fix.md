# 🧠 Mypy Fix Guide: `events_v1_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/events_v1_event.py`
**Lines:** `561`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/events_v1_event.py --strict
```

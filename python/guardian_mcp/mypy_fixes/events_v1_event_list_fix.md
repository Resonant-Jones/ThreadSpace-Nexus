# 🧠 Mypy Fix Guide: `events_v1_event_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/events_v1_event_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/events_v1_event_list.py --strict
```

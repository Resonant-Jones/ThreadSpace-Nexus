# 🧠 Mypy Fix Guide: `events_v1_event_series.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/events_v1_event_series.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/events_v1_event_series.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/window/ewm.py`
**Lines:** `1095`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/window/ewm.py --strict
```

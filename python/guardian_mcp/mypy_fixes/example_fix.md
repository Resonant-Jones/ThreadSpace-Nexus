...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/leaderelection/example.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/leaderelection/example.py --strict
```

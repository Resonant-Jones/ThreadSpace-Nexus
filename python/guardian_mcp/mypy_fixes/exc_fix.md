...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/exc.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/exc.py --strict
```

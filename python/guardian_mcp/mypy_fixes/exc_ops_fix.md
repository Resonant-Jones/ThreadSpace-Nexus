...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/exc_ops.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/exc_ops.py --strict
```

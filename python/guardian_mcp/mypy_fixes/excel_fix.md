...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/formats/excel.py`
**Lines:** `962`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/formats/excel.py --strict
```

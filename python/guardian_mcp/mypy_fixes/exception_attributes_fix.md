# 🧠 Mypy Fix Guide: `exception_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/exception_attributes.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/exception_attributes.py --strict
```

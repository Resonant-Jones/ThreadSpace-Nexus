# 🧠 Mypy Fix Guide: `exception_capture.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/exception_capture.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/exception_capture.py --strict
```

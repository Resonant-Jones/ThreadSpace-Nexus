# 🧠 Mypy Fix Guide: `exception_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/exception_handler.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/exception_handler.py --strict
```

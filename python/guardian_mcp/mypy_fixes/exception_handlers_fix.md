# 🧠 Mypy Fix Guide: `exception_handlers.py`
...
**File:** `.venv/lib/python3.13/site-packages/fastapi/exception_handlers.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/exception_handlers.py --strict
```

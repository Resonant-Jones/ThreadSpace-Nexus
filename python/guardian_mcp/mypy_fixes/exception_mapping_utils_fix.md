# 🧠 Mypy Fix Guide: `exception_mapping_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/exception_mapping_utils.py`
**Lines:** `2338`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/exception_mapping_utils.py --strict
```

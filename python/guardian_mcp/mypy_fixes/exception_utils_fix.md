# 🧠 Mypy Fix Guide: `exception_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/exception_utils.py`
**Lines:** `926`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/exception_utils.py --strict
```

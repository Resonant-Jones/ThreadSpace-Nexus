...
**File:** `.venv/lib/python3.13/site-packages/selenium/common/exceptions.py`
**Lines:** `290`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/common/exceptions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/exclusions.py`
**Lines:** `435`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/exclusions.py --strict
```

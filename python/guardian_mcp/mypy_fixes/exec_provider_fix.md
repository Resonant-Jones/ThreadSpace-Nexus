# 🧠 Mypy Fix Guide: `exec_provider.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/exec_provider.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/exec_provider.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/_numba/executor.py`
**Lines:** `239`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/_numba/executor.py --strict
```

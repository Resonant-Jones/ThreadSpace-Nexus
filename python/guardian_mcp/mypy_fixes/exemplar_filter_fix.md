# 🧠 Mypy Fix Guide: `exemplar_filter.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/exemplar/exemplar_filter.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/exemplar/exemplar_filter.py --strict
```

# 🧠 Mypy Fix Guide: `exemplar_reservoir.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/exemplar/exemplar_reservoir.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/exemplar/exemplar_reservoir.py --strict
```

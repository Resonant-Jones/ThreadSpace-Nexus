...
**File:** `.venv/lib/python3.13/site-packages/setuptools/config/expand.py`
**Lines:** `452`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/config/expand.py --strict
```

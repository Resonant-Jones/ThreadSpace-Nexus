...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/window/expanding.py`
**Lines:** `964`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/window/expanding.py --strict
```

# 🧠 Mypy Fix Guide: `expatbuilder.py`
...
**File:** `.venv/lib/python3.13/site-packages/defusedxml/expatbuilder.py`
**Lines:** `107`
...
```bash
mypy .venv/lib/python3.13/site-packages/defusedxml/expatbuilder.py --strict
```

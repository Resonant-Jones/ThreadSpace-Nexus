...
**File:** `.venv/lib/python3.13/site-packages/defusedxml/expatreader.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/defusedxml/expatreader.py --strict
```

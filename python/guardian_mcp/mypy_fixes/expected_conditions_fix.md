# 🧠 Mypy Fix Guide: `expected_conditions.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/expected_conditions.py`
**Lines:** `1017`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/expected_conditions.py --strict
```

# 🧠 Mypy Fix Guide: `experimental_lambdify.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/experimental_lambdify.py`
**Lines:** `641`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/experimental_lambdify.py --strict
```

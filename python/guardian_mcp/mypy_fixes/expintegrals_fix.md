# 🧠 Mypy Fix Guide: `expintegrals.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/expintegrals.py`
**Lines:** `425`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/expintegrals.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/exponential.py`
**Lines:** `1286`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/exponential.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/bart/export.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/bart/export.py --strict
```

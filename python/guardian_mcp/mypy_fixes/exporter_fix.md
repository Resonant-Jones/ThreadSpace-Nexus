...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/exporter/otlp/proto/grpc/exporter.py`
**Lines:** `375`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/exporter/otlp/proto/grpc/exporter.py --strict
```

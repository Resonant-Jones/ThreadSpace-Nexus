# 🧠 Mypy Fix Guide: `expr_with_intlimits.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/expr_with_intlimits.py`
**Lines:** `354`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/expr_with_intlimits.py --strict
```

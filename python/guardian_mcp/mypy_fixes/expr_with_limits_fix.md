# 🧠 Mypy Fix Guide: `expr_with_limits.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/expr_with_limits.py`
**Lines:** `603`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/expr_with_limits.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/expression.py`
**Lines:** `1079`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/expression.py --strict
```

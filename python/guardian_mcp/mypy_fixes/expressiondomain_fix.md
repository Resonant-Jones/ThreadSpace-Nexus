# 🧠 Mypy Fix Guide: `expressiondomain.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/expressiondomain.py`
**Lines:** `278`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/expressiondomain.py --strict
```

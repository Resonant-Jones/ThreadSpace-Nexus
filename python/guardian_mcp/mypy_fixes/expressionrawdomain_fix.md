# 🧠 Mypy Fix Guide: `expressionrawdomain.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/expressionrawdomain.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/expressionrawdomain.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/computation/expressions.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/computation/expressions.py --strict
```

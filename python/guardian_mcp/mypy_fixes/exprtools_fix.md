...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/exprtools.py`
**Lines:** `1573`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/exprtools.py --strict
```

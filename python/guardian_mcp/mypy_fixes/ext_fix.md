...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/ext.py`
**Lines:** `536`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/ext.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/testing/_private/extbuild.py`
**Lines:** `250`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/testing/_private/extbuild.py --strict
```

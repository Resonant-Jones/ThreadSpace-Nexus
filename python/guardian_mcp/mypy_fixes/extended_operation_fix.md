# 🧠 Mypy Fix Guide: `extended_operation.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/extended_operation.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/extended_operation.py --strict
```

# 🧠 Mypy Fix Guide: `extending_distributions.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/random/_examples/numba/extending_distributions.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/random/_examples/numba/extending_distributions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/random/_examples/numba/extending.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/random/_examples/numba/extending.py --strict
```

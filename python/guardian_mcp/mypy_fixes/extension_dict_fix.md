# 🧠 Mypy Fix Guide: `extension_dict.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/extension_dict.py`
**Lines:** `194`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/extension_dict.py --strict
```

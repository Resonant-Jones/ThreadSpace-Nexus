...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/extension.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/extension.py --strict
```

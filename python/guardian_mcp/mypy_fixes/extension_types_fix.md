# 🧠 Mypy Fix Guide: `extension_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/arrow/extension_types.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/arrow/extension_types.py --strict
```

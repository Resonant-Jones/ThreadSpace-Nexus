# 🧠 Mypy Fix Guide: `external_account_authorized_user.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/external_account_authorized_user.py`
**Lines:** `380`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/external_account_authorized_user.py --strict
```

# 🧠 Mypy Fix Guide: `external_account.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/external_account.py`
**Lines:** `628`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/external_account.py --strict
```

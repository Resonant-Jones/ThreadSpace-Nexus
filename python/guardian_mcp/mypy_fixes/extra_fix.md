...
**File:** `.venv/lib/python3.13/site-packages/mistune/plugins/extra.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/plugins/extra.py --strict
```

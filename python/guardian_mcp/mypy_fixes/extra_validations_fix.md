# 🧠 Mypy Fix Guide: `extra_validations.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/config/_validate_pyproject/extra_validations.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/config/_validate_pyproject/extra_validations.py --strict
```

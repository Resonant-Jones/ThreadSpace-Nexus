# 🧠 Mypy Fix Guide: `extraction_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/extraction_strategy.py`
**Lines:** `1971`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/extraction_strategy.py --strict
```

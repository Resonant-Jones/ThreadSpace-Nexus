# 🧠 Mypy Fix Guide: `extrapolation.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/calculus/extrapolation.py`
**Lines:** `2115`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/calculus/extrapolation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ezhil.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ezhil.py --strict
```

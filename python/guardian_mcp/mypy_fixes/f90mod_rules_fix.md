# 🧠 Mypy Fix Guide: `f90mod_rules.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/f90mod_rules.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/f90mod_rules.py --strict
```

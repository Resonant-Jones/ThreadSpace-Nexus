# 🧠 Mypy Fix Guide: `faas_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/faas_attributes.py`
**Lines:** `161`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/faas_attributes.py --strict
```

# 🧠 Mypy Fix Guide: `faas_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/faas_metrics.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/faas_metrics.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/interfaces/face/face.py`
**Lines:** `1084`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/interfaces/face/face.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/factor_.py`
**Lines:** `2841`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/factor_.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/factor.py`
**Lines:** `363`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/factor.py --strict
```

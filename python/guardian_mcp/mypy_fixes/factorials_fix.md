...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/combinatorial/factorials.py`
**Lines:** `1133`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/combinatorial/factorials.py --strict
```

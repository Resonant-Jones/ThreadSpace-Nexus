# 🧠 Mypy Fix Guide: `factorizations.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/factorizations.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/factorizations.py --strict
```

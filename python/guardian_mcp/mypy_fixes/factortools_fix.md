...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/factortools.py`
**Lines:** `1648`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/factortools.py --strict
```

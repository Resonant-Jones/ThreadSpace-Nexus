...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/resolution/resolvelib/factory.py`
**Lines:** `823`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/resolution/resolvelib/factory.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/facts.py`
**Lines:** `270`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/facts.py --strict
```

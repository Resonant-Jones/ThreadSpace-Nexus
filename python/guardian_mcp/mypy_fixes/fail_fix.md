...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/fail.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/fail.py --strict
```

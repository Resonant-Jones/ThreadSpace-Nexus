...
**File:** `.venv/lib/python3.13/site-packages/fake_useragent/fake.py`
**Lines:** `402`
...
```bash
mypy .venv/lib/python3.13/site-packages/fake_useragent/fake.py --strict
```

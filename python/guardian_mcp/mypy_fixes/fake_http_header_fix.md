# 🧠 Mypy Fix Guide: `fake_http_header.py`
...
**File:** `.venv/lib/python3.13/site-packages/fake_http_header/fake_http_header.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/fake_http_header/fake_http_header.py --strict
```

# 🧠 Mypy Fix Guide: `fallback_event_handlers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/fallback_event_handlers.py`
**Lines:** `303`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/fallback_event_handlers.py --strict
```

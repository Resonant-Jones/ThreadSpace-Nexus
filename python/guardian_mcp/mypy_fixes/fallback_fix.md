...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/msgpack/fallback.py`
**Lines:** `929`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/msgpack/fallback.py --strict
```

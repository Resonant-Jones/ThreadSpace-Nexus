# 🧠 Mypy Fix Guide: `fallback_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/fallback_utils.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/fallback_utils.py --strict
```

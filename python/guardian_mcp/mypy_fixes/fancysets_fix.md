...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/fancysets.py`
**Lines:** `1523`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/fancysets.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/fantom.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/fantom.py --strict
```

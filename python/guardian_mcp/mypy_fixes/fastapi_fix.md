...
**File:** `.venv/lib/python3.13/site-packages/chromadb/telemetry/opentelemetry/fastapi.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/telemetry/opentelemetry/fastapi.py --strict
```

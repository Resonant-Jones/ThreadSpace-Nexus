# 🧠 Mypy Fix Guide: `fastjsonschema_validations.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/config/_validate_pyproject/fastjsonschema_validations.py`
**Lines:** `1412`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/config/_validate_pyproject/fastjsonschema_validations.py --strict
```

# 🧠 Mypy Fix Guide: `faulthandler.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/faulthandler.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/faulthandler.py --strict
```

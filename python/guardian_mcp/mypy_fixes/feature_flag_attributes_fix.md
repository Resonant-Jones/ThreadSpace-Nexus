# 🧠 Mypy Fix Guide: `feature_flag_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/feature_flag_attributes.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/feature_flag_attributes.py --strict
```

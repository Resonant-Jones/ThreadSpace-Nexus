# 🧠 Mypy Fix Guide: `feature_flags.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/feature_flags.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/feature_flags.py --strict
```

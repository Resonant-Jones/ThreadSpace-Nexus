...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/fedcm.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/fedcm.py --strict
```

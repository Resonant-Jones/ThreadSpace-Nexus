...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/felix.py`
**Lines:** `275`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/felix.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/fence.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/fence.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/fermion.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/fermion.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/fernet.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/fernet.py --strict
```

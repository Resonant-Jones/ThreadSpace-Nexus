...
**File:** `.venv/lib/python3.13/site-packages/cffi/ffiplatform.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/ffiplatform.py --strict
```

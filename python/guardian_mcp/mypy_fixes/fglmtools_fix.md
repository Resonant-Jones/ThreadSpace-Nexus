...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/fglmtools.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/fglmtools.py --strict
```

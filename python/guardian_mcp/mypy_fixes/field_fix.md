...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/field.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/field.py --strict
```

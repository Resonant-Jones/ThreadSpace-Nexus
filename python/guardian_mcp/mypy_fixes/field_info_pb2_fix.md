# 🧠 Mypy Fix Guide: `field_info_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/field_info_pb2.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/field_info_pb2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/field_mask.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/field_mask.py --strict
```

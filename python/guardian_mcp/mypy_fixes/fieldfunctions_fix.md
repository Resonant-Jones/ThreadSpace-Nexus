# 🧠 Mypy Fix Guide: `fieldfunctions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/vector/fieldfunctions.py`
**Lines:** `313`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/vector/fieldfunctions.py --strict
```

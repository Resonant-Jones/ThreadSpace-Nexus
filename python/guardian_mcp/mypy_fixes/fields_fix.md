...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/fields.py`
**Lines:** `639`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/fields.py --strict
```

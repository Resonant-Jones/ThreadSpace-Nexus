# 🧠 Mypy Fix Guide: `file_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/file_attributes.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/file_attributes.py --strict
```

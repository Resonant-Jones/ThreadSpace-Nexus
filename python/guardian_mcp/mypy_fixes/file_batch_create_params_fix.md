# 🧠 Mypy Fix Guide: `file_batch_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_stores/file_batch_create_params.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_stores/file_batch_create_params.py --strict
```

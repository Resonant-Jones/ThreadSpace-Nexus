# 🧠 Mypy Fix Guide: `file_batch_list_files_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_stores/file_batch_list_files_params.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_stores/file_batch_list_files_params.py --strict
```

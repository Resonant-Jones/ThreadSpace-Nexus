# 🧠 Mypy Fix Guide: `file_batches.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/vector_stores/file_batches.py`
**Lines:** `797`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/vector_stores/file_batches.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/googleapiclient/discovery_cache/file_cache.py`
**Lines:** `145`
...
```bash
mypy .venv/lib/python3.13/site-packages/googleapiclient/discovery_cache/file_cache.py --strict
```

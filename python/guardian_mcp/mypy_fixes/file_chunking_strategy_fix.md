# 🧠 Mypy Fix Guide: `file_chunking_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/file_chunking_strategy.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/file_chunking_strategy.py --strict
```

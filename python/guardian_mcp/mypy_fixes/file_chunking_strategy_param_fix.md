# 🧠 Mypy Fix Guide: `file_chunking_strategy_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/file_chunking_strategy_param.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/file_chunking_strategy_param.py --strict
```

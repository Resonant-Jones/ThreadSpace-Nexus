# 🧠 Mypy Fix Guide: `file_citation_annotation.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/file_citation_annotation.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/file_citation_annotation.py --strict
```

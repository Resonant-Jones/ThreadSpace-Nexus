# 🧠 Mypy Fix Guide: `file_citation_delta_annotation.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/file_citation_delta_annotation.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/file_citation_delta_annotation.py --strict
```

# 🧠 Mypy Fix Guide: `file_content.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/file_content.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/file_content.py --strict
```

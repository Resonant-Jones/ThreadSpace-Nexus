# 🧠 Mypy Fix Guide: `file_content_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_stores/file_content_response.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_stores/file_content_response.py --strict
```

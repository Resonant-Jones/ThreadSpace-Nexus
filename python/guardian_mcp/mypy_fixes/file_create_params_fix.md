# 🧠 Mypy Fix Guide: `file_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/containers/file_create_params.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/containers/file_create_params.py --strict
```

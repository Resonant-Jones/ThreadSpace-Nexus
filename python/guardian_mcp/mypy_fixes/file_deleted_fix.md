# 🧠 Mypy Fix Guide: `file_deleted.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/file_deleted.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/file_deleted.py --strict
```

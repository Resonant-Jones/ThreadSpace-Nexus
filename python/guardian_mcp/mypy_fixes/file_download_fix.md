# 🧠 Mypy Fix Guide: `file_download.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/file_download.py`
**Lines:** `1803`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/file_download.py --strict
```

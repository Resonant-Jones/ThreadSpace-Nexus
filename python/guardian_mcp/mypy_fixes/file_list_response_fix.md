# 🧠 Mypy Fix Guide: `file_list_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/containers/file_list_response.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/containers/file_list_response.py --strict
```

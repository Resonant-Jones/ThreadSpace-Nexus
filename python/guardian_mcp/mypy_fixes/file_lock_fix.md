...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/file_lock.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/file_lock.py --strict
```

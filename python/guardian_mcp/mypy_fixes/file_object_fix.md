...
**File:** `.venv/lib/python3.13/site-packages/openai/types/file_object.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/file_object.py --strict
```

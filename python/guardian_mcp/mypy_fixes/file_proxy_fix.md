...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/file_proxy.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/file_proxy.py --strict
```

# 🧠 Mypy Fix Guide: `file_purpose.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/file_purpose.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/file_purpose.py --strict
```

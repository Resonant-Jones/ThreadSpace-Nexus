# 🧠 Mypy Fix Guide: `file_retrieve_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/containers/file_retrieve_response.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/containers/file_retrieve_response.py --strict
```

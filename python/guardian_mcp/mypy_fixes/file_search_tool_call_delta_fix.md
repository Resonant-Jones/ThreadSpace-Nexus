# 🧠 Mypy Fix Guide: `file_search_tool_call_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/file_search_tool_call_delta.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/file_search_tool_call_delta.py --strict
```

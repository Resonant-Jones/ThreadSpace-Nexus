# 🧠 Mypy Fix Guide: `file_search_tool_call.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/file_search_tool_call.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/file_search_tool_call.py --strict
```

# 🧠 Mypy Fix Guide: `file_search_tool.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/file_search_tool.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/file_search_tool.py --strict
```

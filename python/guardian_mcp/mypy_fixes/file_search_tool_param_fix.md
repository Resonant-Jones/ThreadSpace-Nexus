# 🧠 Mypy Fix Guide: `file_search_tool_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/file_search_tool_param.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/file_search_tool_param.py --strict
```

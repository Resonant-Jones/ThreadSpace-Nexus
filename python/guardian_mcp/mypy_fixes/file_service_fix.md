# 🧠 Mypy Fix Guide: `file_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/file_service.py`
**Lines:** `145`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/file_service.py --strict
```

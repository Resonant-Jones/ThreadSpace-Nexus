...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/file_types.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/file_types.py --strict
```

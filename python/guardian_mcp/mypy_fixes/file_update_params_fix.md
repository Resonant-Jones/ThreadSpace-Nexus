# 🧠 Mypy Fix Guide: `file_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_stores/file_update_params.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_stores/file_update_params.py --strict
```

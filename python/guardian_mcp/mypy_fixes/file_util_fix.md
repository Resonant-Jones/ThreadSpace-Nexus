...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/file_util.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/file_util.py --strict
```

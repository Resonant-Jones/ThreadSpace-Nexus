...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/file_utils.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/file_utils.py --strict
```

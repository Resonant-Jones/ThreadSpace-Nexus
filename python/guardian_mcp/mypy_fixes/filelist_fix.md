...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/filelist.py`
**Lines:** `431`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/filelist.py --strict
```

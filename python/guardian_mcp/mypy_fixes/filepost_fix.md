...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/filepost.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/filepost.py --strict
```

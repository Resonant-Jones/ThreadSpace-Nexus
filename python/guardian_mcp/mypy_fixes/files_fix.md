...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/files.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/files.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/filesize.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/filesize.py --strict
```

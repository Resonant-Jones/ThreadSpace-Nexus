...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/filesystem.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/filesystem.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/filetypes.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/filetypes.py --strict
```

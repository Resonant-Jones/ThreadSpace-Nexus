...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/filewrapper.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/filewrapper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/filters.py`
**Lines:** `666`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/filters.py --strict
```

# 🧠 Mypy Fix Guide: `find_sources.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/find_sources.py`
**Lines:** `254`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/find_sources.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/flake8/plugins/finder.py`
**Lines:** `365`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/plugins/finder.py --strict
```

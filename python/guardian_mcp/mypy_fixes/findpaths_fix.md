...
**File:** `.venv/lib/python3.13/site-packages/_pytest/config/findpaths.py`
**Lines:** `239`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/config/findpaths.py --strict
```

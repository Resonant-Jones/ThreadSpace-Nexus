...
**File:** `.venv/lib/python3.13/site-packages/openai/cli/_tools/fine_tunes.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/cli/_tools/fine_tunes.py --strict
```

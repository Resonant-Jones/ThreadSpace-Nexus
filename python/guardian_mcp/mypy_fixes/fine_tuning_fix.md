...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/fine_tuning.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/fine_tuning.py --strict
```

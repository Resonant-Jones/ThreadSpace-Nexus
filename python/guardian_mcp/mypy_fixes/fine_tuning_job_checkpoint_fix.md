# 🧠 Mypy Fix Guide: `fine_tuning_job_checkpoint.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/jobs/fine_tuning_job_checkpoint.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/jobs/fine_tuning_job_checkpoint.py --strict
```

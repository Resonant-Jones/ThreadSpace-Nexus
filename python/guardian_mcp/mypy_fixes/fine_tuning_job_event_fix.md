# 🧠 Mypy Fix Guide: `fine_tuning_job_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job_event.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job_event.py --strict
```

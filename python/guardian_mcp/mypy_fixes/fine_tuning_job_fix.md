# 🧠 Mypy Fix Guide: `fine_tuning_job.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job.py`
**Lines:** `161`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job.py --strict
```

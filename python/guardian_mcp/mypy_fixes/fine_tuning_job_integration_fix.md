# 🧠 Mypy Fix Guide: `fine_tuning_job_integration.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job_integration.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job_integration.py --strict
```

# 🧠 Mypy Fix Guide: `fine_tuning_job_wandb_integration_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job_wandb_integration_object.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/fine_tuning_job_wandb_integration_object.py --strict
```

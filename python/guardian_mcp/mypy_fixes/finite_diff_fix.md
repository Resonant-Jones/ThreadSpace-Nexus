...
**File:** `.venv/lib/python3.13/site-packages/sympy/calculus/finite_diff.py`
**Lines:** `476`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/calculus/finite_diff.py --strict
```

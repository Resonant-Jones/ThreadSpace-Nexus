...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/finitefield.py`
**Lines:** `368`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/finitefield.py --strict
```

# 🧠 Mypy Fix Guide: `finnish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/finnish_stemmer.py`
**Lines:** `548`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/finnish_stemmer.py --strict
```

# 🧠 Mypy Fix Guide: `firefox_binary.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/firefox/firefox_binary.py`
**Lines:** `226`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/firefox/firefox_binary.py --strict
```

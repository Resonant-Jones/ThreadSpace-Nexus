# 🧠 Mypy Fix Guide: `firefox_profile.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/firefox/firefox_profile.py`
**Lines:** `330`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/firefox/firefox_profile.py --strict
```

# 🧠 Mypy Fix Guide: `fireworks_ai.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/fireworks_ai.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/fireworks_ai.py --strict
```

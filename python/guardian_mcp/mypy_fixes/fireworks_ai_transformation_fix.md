# 🧠 Mypy Fix Guide: `fireworks_ai_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/fireworks_ai/embed/fireworks_ai_transformation.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/fireworks_ai/embed/fireworks_ai_transformation.py --strict
```

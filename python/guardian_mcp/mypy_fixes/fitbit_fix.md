...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/compliance_fixes/fitbit.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/compliance_fixes/fitbit.py --strict
```

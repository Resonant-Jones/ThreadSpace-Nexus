...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/flag_def.py`
**Lines:** `503`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/flag_def.py --strict
```

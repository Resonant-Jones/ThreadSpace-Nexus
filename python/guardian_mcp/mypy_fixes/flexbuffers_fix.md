...
**File:** `.venv/lib/python3.13/site-packages/flatbuffers/flexbuffers.py`
**Lines:** `1536`
...
```bash
mypy .venv/lib/python3.13/site-packages/flatbuffers/flexbuffers.py --strict
```

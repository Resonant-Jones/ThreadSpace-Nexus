...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/float16.py`
**Lines:** `501`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/float16.py --strict
```

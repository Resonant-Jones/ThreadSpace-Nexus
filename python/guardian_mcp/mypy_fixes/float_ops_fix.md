...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/float_ops.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/float_ops.py --strict
```

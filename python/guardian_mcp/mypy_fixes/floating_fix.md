...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/floating.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/floating.py --strict
```

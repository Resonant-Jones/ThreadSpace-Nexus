# 🧠 Mypy Fix Guide: `flow_control.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/protocols/http/flow_control.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/protocols/http/flow_control.py --strict
```

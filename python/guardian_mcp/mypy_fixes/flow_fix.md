...
**File:** `.venv/lib/python3.13/site-packages/google_auth_oauthlib/flow.py`
**Lines:** `507`
...
```bash
mypy .venv/lib/python3.13/site-packages/google_auth_oauthlib/flow.py --strict
```

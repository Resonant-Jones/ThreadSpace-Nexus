# 🧠 Mypy Fix Guide: `flowcontrol_apiserver_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/flowcontrol_apiserver_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/flowcontrol_apiserver_api.py --strict
```

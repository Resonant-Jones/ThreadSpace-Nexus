# 🧠 Mypy Fix Guide: `flowcontrol_apiserver_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/flowcontrol_apiserver_v1_api.py`
**Lines:** `3044`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/flowcontrol_apiserver_v1_api.py --strict
```

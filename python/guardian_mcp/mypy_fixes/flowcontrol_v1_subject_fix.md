# 🧠 Mypy Fix Guide: `flowcontrol_v1_subject.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/flowcontrol_v1_subject.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/flowcontrol_v1_subject.py --strict
```

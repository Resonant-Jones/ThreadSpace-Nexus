...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/fnodes.py`
**Lines:** `658`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/fnodes.py --strict
```

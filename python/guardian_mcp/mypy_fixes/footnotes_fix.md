...
**File:** `.venv/lib/python3.13/site-packages/mistune/plugins/footnotes.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/plugins/footnotes.py --strict
```

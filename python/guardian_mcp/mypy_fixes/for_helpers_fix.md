...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/for_helpers.py`
**Lines:** `1076`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/for_helpers.py --strict
```

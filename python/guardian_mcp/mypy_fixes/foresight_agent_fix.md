# 🧠 Mypy Fix Guide: `foresight_agent.py`
...
**File:** `guardian/core/orchestrator/agents/foresight_agent.py`
**Lines:** `39`
...
```bash
mypy guardian/core/orchestrator/agents/foresight_agent.py --strict
```

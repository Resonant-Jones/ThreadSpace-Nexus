...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/fork_exec.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/fork_exec.py --strict
```

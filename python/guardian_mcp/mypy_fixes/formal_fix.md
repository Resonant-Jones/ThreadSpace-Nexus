...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/formal.py`
**Lines:** `1863`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/formal.py --strict
```

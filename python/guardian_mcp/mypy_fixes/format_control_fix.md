# 🧠 Mypy Fix Guide: `format_control.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/format_control.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/format_control.py --strict
```

# 🧠 Mypy Fix Guide: `format_str_tokenizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/format_str_tokenizer.py`
**Lines:** `250`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/format_str_tokenizer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/formatter.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/formatter.py --strict
```

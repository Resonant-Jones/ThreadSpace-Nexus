...
**File:** `.venv/lib/python3.13/site-packages/click/formatting.py`
**Lines:** `301`
...
```bash
mypy .venv/lib/python3.13/site-packages/click/formatting.py --strict
```

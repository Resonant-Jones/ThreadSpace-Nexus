...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/formfill.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/formfill.py --strict
```

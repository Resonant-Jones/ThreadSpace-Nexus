...
**File:** `.venv/lib/python3.13/site-packages/starlette/formparsers.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/formparsers.py --strict
```

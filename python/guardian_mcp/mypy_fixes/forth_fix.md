...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/forth.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/forth.py --strict
```

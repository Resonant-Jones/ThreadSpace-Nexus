...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/fortran.py`
**Lines:** `779`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/fortran.py --strict
```

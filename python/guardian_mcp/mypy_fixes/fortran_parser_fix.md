# 🧠 Mypy Fix Guide: `fortran_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/fortran/fortran_parser.py`
**Lines:** `347`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/fortran/fortran_parser.py --strict
```

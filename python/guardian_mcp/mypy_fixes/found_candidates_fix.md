# 🧠 Mypy Fix Guide: `found_candidates.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/resolution/resolvelib/found_candidates.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/resolution/resolvelib/found_candidates.py --strict
```

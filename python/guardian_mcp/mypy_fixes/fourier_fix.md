...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/fourier.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/fourier.py --strict
```

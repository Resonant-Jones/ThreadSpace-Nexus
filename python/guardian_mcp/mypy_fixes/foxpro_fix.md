...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/foxpro.py`
**Lines:** `427`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/foxpro.py --strict
```

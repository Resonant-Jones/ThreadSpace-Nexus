...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/fp_groups.py`
**Lines:** `1352`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/fp_groups.py --strict
```

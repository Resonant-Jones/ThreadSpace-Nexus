# 🧠 Mypy Fix Guide: `fractionfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/fractionfield.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/fractionfield.py --strict
```

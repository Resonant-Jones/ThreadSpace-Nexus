# 🧠 Mypy Fix Guide: `fragments_join.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/fragments_join.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/fragments_join.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/vector/frame.py`
**Lines:** `1575`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/vector/frame.py --strict
```

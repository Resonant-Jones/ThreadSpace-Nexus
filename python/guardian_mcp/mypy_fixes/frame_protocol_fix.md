# 🧠 Mypy Fix Guide: `frame_protocol.py`
...
**File:** `.venv/lib/python3.13/site-packages/wsproto/frame_protocol.py`
**Lines:** `673`
...
```bash
mypy .venv/lib/python3.13/site-packages/wsproto/frame_protocol.py --strict
```

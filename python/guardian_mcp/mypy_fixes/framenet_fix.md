...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/framenet.py`
**Lines:** `3428`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/framenet.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/websockets/legacy/framing.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/legacy/framing.py --strict
```

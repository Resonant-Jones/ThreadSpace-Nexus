...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/free_groups.py`
**Lines:** `1360`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/free_groups.py --strict
```

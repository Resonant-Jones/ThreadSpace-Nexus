...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/freefem.py`
**Lines:** `893`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/freefem.py --strict
```

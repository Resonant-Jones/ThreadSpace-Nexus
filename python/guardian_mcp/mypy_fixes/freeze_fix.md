...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/freeze.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/freeze.py --strict
```

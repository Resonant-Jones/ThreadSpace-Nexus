# 🧠 Mypy Fix Guide: `freeze_support.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/freeze_support.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/freeze_support.py --strict
```

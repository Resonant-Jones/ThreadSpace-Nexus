# 🧠 Mypy Fix Guide: `french_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/french_stemmer.py`
**Lines:** `967`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/french_stemmer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/tseries/frequencies.py`
**Lines:** `602`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/tseries/frequencies.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/friendly.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/friendly.py --strict
```

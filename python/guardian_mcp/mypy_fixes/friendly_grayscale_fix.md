# 🧠 Mypy Fix Guide: `friendly_grayscale.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/friendly_grayscale.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/friendly_grayscale.py --strict
```

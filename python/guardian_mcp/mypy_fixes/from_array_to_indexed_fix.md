# 🧠 Mypy Fix Guide: `from_array_to_indexed.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_array_to_indexed.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_array_to_indexed.py --strict
```

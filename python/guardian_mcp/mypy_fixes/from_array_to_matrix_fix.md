# 🧠 Mypy Fix Guide: `from_array_to_matrix.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_array_to_matrix.py`
**Lines:** `1004`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_array_to_matrix.py --strict
```

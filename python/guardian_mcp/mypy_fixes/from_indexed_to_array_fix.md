# 🧠 Mypy Fix Guide: `from_indexed_to_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_indexed_to_array.py`
**Lines:** `257`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_indexed_to_array.py --strict
```

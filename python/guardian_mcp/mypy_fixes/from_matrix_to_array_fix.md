# 🧠 Mypy Fix Guide: `from_matrix_to_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_matrix_to_array.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/expressions/from_matrix_to_array.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/anyio/from_thread.py`
**Lines:** `527`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/from_thread.py --strict
```

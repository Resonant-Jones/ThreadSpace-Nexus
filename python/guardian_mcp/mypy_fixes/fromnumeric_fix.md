...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/fromnumeric.py`
**Lines:** `4268`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/fromnumeric.py --strict
```

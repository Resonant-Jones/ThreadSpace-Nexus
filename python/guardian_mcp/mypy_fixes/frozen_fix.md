...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/frozen.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/frozen.py --strict
```

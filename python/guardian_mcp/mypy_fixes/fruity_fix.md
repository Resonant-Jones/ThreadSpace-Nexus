...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/fruity.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/fruity.py --strict
```

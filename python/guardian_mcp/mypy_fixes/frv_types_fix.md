...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/frv_types.py`
**Lines:** `873`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/frv_types.py --strict
```

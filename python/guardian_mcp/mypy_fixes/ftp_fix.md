...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/ftp.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/ftp.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/func2subr.py`
**Lines:** `329`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/func2subr.py --strict
```

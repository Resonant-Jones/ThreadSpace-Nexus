...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/func.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/func.py --strict
```

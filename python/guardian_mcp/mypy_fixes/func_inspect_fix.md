# 🧠 Mypy Fix Guide: `func_inspect.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/func_inspect.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/func_inspect.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/funcmatrix.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/funcmatrix.py --strict
```

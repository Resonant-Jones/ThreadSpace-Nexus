# 🧠 Mypy Fix Guide: `function_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/function_base.py`
**Lines:** `545`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/function_base.py --strict
```

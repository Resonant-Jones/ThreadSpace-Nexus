# 🧠 Mypy Fix Guide: `function_definition.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/function_definition.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/function_definition.py --strict
```

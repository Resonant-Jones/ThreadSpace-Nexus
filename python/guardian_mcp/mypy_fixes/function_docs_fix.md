# 🧠 Mypy Fix Guide: `function_docs.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/function_docs.py`
**Lines:** `10201`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/function_docs.py --strict
```

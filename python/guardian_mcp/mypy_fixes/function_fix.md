...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/function.py`
**Lines:** `1045`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/function.py --strict
```

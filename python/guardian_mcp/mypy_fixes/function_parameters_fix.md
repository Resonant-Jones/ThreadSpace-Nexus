# 🧠 Mypy Fix Guide: `function_parameters.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/function_parameters.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/function_parameters.py --strict
```

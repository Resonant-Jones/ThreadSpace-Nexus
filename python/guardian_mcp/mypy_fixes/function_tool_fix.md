# 🧠 Mypy Fix Guide: `function_tool.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/function_tool.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/function_tool.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/functional.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/functional.py --strict
```

# 🧠 Mypy Fix Guide: `functional_serializers.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/functional_serializers.py`
**Lines:** `450`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/functional_serializers.py --strict
```

# 🧠 Mypy Fix Guide: `functional_validators.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/functional_validators.py`
**Lines:** `828`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/functional_validators.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/functions.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/functions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/plugins/functools.py`
**Lines:** `390`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/plugins/functools.py --strict
```

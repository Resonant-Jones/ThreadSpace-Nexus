# 🧠 Mypy Fix Guide: `fusion_attention_clip.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_clip.py`
**Lines:** `335`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_clip.py --strict
```

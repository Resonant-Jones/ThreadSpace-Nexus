# 🧠 Mypy Fix Guide: `fusion_attention.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention.py`
**Lines:** `1189`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention.py --strict
```

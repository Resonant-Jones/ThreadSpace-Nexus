# 🧠 Mypy Fix Guide: `fusion_attention_sam2.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_sam2.py`
**Lines:** `533`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_sam2.py --strict
```

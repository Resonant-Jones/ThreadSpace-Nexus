# 🧠 Mypy Fix Guide: `fusion_attention_unet.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_unet.py`
**Lines:** `1307`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_unet.py --strict
```

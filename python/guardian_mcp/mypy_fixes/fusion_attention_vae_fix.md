# 🧠 Mypy Fix Guide: `fusion_attention_vae.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_vae.py`
**Lines:** `300`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_attention_vae.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_bart_attention.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_bart_attention.py`
**Lines:** `644`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_bart_attention.py --strict
```

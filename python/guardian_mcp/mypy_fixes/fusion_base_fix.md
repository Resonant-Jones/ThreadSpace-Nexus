...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_base.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_base.py --strict
```

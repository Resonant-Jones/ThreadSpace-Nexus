# 🧠 Mypy Fix Guide: `fusion_bias_add.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_bias_add.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_bias_add.py --strict
```

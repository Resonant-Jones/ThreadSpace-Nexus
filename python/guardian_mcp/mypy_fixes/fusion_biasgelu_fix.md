# 🧠 Mypy Fix Guide: `fusion_biasgelu.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_biasgelu.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_biasgelu.py --strict
```

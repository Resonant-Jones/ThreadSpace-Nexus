# 🧠 Mypy Fix Guide: `fusion_biassplitgelu.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_biassplitgelu.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_biassplitgelu.py --strict
```

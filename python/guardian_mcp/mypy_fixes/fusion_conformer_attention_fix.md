# 🧠 Mypy Fix Guide: `fusion_conformer_attention.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_conformer_attention.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_conformer_attention.py --strict
```

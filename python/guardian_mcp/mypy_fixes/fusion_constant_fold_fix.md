# 🧠 Mypy Fix Guide: `fusion_constant_fold.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_constant_fold.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_constant_fold.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_embedlayer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_embedlayer.py`
**Lines:** `810`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_embedlayer.py --strict
```

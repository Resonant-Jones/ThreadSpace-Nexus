# 🧠 Mypy Fix Guide: `fusion_fastgelu.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_fastgelu.py`
**Lines:** `492`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_fastgelu.py --strict
```

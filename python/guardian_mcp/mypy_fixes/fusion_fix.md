...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/fusions/fusion.py`
**Lines:** `311`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/fusions/fusion.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_gelu_approximation.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gelu_approximation.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gelu_approximation.py --strict
```

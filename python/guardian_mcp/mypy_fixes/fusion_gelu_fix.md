...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/fusions/fusion_gelu.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/fusions/fusion_gelu.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_gemmfastgelu.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gemmfastgelu.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gemmfastgelu.py --strict
```

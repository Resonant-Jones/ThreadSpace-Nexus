# 🧠 Mypy Fix Guide: `fusion_gpt_attention.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gpt_attention.py`
**Lines:** `546`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gpt_attention.py --strict
```

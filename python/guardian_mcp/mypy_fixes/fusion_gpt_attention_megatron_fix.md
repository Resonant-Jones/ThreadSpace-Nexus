# 🧠 Mypy Fix Guide: `fusion_gpt_attention_megatron.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gpt_attention_megatron.py`
**Lines:** `355`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gpt_attention_megatron.py --strict
```

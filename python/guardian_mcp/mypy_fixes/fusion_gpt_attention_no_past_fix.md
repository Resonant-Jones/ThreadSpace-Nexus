# 🧠 Mypy Fix Guide: `fusion_gpt_attention_no_past.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gpt_attention_no_past.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_gpt_attention_no_past.py --strict
```

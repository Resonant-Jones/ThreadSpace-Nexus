# 🧠 Mypy Fix Guide: `fusion_group_norm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_group_norm.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_group_norm.py --strict
```

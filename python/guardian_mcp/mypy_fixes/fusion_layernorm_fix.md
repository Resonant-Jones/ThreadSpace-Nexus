# 🧠 Mypy Fix Guide: `fusion_layernorm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/fusions/fusion_layernorm.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/fusions/fusion_layernorm.py --strict
```

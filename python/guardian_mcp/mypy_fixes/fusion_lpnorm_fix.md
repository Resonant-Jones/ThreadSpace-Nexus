# 🧠 Mypy Fix Guide: `fusion_lpnorm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/fusion_lpnorm.py`
**Lines:** `132`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/fusion_lpnorm.py --strict
```

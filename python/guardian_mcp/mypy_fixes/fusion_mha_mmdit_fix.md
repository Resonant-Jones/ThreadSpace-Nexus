# 🧠 Mypy Fix Guide: `fusion_mha_mmdit.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_mha_mmdit.py`
**Lines:** `667`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_mha_mmdit.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_nhwc_conv.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_nhwc_conv.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_nhwc_conv.py --strict
```

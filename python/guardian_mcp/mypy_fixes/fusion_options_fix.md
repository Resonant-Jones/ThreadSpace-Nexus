# 🧠 Mypy Fix Guide: `fusion_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_options.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_options.py --strict
```

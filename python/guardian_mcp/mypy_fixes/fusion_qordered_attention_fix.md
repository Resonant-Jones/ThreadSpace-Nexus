# 🧠 Mypy Fix Guide: `fusion_qordered_attention.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_attention.py`
**Lines:** `420`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_attention.py --strict
```

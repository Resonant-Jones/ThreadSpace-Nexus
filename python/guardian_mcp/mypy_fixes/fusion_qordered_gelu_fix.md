# 🧠 Mypy Fix Guide: `fusion_qordered_gelu.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_gelu.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_gelu.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_qordered_layernorm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_layernorm.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_layernorm.py --strict
```

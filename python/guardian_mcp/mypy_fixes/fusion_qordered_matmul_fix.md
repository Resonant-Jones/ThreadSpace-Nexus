# 🧠 Mypy Fix Guide: `fusion_qordered_matmul.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_matmul.py`
**Lines:** `216`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_qordered_matmul.py --strict
```

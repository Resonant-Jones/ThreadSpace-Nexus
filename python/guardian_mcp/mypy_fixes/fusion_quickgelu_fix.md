# 🧠 Mypy Fix Guide: `fusion_quickgelu.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_quickgelu.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_quickgelu.py --strict
```

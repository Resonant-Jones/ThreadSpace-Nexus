# 🧠 Mypy Fix Guide: `fusion_reshape.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_reshape.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_reshape.py --strict
```

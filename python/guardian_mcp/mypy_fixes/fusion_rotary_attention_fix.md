# 🧠 Mypy Fix Guide: `fusion_rotary_attention.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_rotary_attention.py`
**Lines:** `1591`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_rotary_attention.py --strict
```

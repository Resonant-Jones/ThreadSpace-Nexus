# 🧠 Mypy Fix Guide: `fusion_shape.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_shape.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_shape.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_simplified_layernorm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_simplified_layernorm.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_simplified_layernorm.py --strict
```

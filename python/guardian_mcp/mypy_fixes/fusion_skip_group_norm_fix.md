# 🧠 Mypy Fix Guide: `fusion_skip_group_norm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_skip_group_norm.py`
**Lines:** `254`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_skip_group_norm.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_skiplayernorm.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_skiplayernorm.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_skiplayernorm.py --strict
```

# 🧠 Mypy Fix Guide: `fusion_transpose.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_transpose.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_transpose.py --strict
```

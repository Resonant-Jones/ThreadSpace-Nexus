# 🧠 Mypy Fix Guide: `fusion_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_utils.py`
**Lines:** `317`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/fusion_utils.py --strict
```

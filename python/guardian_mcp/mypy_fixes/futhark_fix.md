...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/futhark.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/futhark.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/futils.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/futils.py --strict
```

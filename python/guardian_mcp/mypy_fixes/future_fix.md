...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/foundation/future.py`
**Lines:** `219`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/foundation/future.py --strict
```

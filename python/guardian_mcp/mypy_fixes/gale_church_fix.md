...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/gale_church.py`
**Lines:** `263`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/gale_church.py --strict
```

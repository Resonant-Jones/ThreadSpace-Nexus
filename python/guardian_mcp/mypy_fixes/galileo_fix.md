...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/galileo.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/galileo.py --strict
```

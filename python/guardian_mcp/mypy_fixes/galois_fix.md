...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/galois.py`
**Lines:** `611`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/galois.py --strict
```

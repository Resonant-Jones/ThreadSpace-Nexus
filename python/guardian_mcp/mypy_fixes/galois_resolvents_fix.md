# 🧠 Mypy Fix Guide: `galois_resolvents.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/galois_resolvents.py`
**Lines:** `676`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/galois_resolvents.py --strict
```

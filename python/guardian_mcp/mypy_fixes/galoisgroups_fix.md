# 🧠 Mypy Fix Guide: `galoisgroups.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/galoisgroups.py`
**Lines:** `623`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/galoisgroups.py --strict
```

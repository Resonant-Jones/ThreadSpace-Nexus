...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/galoistools.py`
**Lines:** `2532`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/galoistools.py --strict
```

# 🧠 Mypy Fix Guide: `gamma_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/gamma_functions.py`
**Lines:** `1344`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/gamma_functions.py --strict
```

# 🧠 Mypy Fix Guide: `gamma_matrices.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/hep/gamma_matrices.py`
**Lines:** `716`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/hep/gamma_matrices.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/gammasimp.py`
**Lines:** `493`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/gammasimp.py --strict
```

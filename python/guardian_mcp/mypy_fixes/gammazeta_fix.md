...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/gammazeta.py`
**Lines:** `2167`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/gammazeta.py --strict
```

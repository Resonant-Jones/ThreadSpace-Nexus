# 🧠 Mypy Fix Guide: `gapic_metadata_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/gapic/metadata/gapic_metadata_pb2.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/gapic/metadata/gapic_metadata_pb2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/gate.py`
**Lines:** `1309`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/gate.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/gather.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/gather.py --strict
```

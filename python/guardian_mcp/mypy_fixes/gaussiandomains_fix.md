# 🧠 Mypy Fix Guide: `gaussiandomains.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/gaussiandomains.py`
**Lines:** `706`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/gaussiandomains.py --strict
```

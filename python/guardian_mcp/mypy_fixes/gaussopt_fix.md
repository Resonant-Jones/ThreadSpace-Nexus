...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/optics/gaussopt.py`
**Lines:** `923`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/optics/gaussopt.py --strict
```

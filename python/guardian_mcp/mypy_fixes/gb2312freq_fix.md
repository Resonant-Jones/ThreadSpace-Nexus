...
**File:** `.venv/lib/python3.13/site-packages/chardet/gb2312freq.py`
**Lines:** `284`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/gb2312freq.py --strict
```

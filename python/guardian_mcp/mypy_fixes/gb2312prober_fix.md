# 🧠 Mypy Fix Guide: `gb2312prober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/gb2312prober.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/gb2312prober.py --strict
```

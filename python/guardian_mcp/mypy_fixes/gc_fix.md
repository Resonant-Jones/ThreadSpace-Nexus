...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/gc.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/gc.py --strict
```

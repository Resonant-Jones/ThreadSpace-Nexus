# 🧠 Mypy Fix Guide: `gcp_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/gcp_attributes.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/gcp_attributes.py --strict
```

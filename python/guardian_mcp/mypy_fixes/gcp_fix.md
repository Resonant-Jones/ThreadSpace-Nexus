...
**File:** `.venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/gcp.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/gcp.py --strict
```

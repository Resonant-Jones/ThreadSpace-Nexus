# 🧠 Mypy Fix Guide: `gcs_bucket_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/gcs_bucket/gcs_bucket_base.py`
**Lines:** `334`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/gcs_bucket/gcs_bucket_base.py --strict
```

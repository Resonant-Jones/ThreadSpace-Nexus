...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/gcs_bucket.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/gcs_bucket.py --strict
```

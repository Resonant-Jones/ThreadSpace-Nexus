# 🧠 Mypy Fix Guide: `gdch_credentials.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/gdch_credentials.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/gdch_credentials.py --strict
```

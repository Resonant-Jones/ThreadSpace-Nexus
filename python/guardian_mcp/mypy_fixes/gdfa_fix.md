...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/gdfa.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/gdfa.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/gdscript.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/gdscript.py --strict
```

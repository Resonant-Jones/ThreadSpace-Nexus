...
**File:** `.venv/lib/python3.13/site-packages/posthog/ai/gemini/gemini.py`
**Lines:** `366`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/ai/gemini/gemini.py --strict
```

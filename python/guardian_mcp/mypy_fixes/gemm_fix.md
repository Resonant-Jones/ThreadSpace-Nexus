...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/gemm.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/gemm.py --strict
```

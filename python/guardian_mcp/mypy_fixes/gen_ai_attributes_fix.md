# 🧠 Mypy Fix Guide: `gen_ai_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/gen_ai_attributes.py`
**Lines:** `331`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/gen_ai_attributes.py --strict
```

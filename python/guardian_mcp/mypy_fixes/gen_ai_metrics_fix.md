# 🧠 Mypy Fix Guide: `gen_ai_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/gen_ai_metrics.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/gen_ai_metrics.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_tools/gen_exports.py`
**Lines:** `403`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tools/gen_exports.py --strict
```

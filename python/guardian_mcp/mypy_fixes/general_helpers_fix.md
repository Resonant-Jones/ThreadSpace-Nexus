# 🧠 Mypy Fix Guide: `general_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/general_helpers.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/general_helpers.py --strict
```

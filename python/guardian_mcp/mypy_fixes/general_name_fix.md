# 🧠 Mypy Fix Guide: `general_name.py`
...
**File:** `.venv/lib/python3.13/site-packages/cryptography/x509/general_name.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/x509/general_name.py --strict
```

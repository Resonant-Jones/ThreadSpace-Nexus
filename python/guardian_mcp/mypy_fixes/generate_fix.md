...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/generate.py`
**Lines:** `1157`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/generate.py --strict
```

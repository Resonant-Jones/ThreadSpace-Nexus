# 🧠 Mypy Fix Guide: `generate_test_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/longformer/generate_test_data.py`
**Lines:** `347`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/longformer/generate_test_data.py --strict
```

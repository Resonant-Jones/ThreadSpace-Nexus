# 🧠 Mypy Fix Guide: `generation_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/generation_types.py`
**Lines:** `759`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/generation_types.py --strict
```

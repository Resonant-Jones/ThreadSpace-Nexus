# 🧠 Mypy Fix Guide: `generative_models.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/generative_models.py`
**Lines:** `875`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/generative_models.py --strict
```

# 🧠 Mypy Fix Guide: `generative_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/generative_service.py`
**Lines:** `1751`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/generative_service.py --strict
```

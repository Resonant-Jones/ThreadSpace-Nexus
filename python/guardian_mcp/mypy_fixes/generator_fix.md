...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/generator.py`
**Lines:** `409`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/generator.py --strict
```

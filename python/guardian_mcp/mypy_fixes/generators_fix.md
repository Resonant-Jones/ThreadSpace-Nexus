...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/generators.py`
**Lines:** `301`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/generators.py --strict
```

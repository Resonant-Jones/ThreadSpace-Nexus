...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/groupby/generic.py`
**Lines:** `2852`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/groupby/generic.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/generic_ops.py`
**Lines:** `384`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/generic_ops.py --strict
```

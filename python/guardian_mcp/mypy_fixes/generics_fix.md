...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/generics.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/generics.py --strict
```

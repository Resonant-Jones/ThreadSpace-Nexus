...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/gensim_fixt.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/gensim_fixt.py --strict
```

# 🧠 Mypy Fix Guide: `german_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/german_stemmer.py`
**Lines:** `415`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/german_stemmer.py --strict
```

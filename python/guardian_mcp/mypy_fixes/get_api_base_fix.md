# 🧠 Mypy Fix Guide: `get_api_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/get_api_base.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/get_api_base.py --strict
```

# 🧠 Mypy Fix Guide: `get_azure_ad_token_provider.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/secret_managers/get_azure_ad_token_provider.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/secret_managers/get_azure_ad_token_provider.py --strict
```

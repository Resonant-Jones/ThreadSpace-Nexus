# 🧠 Mypy Fix Guide: `get_formatted_prompt.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/get_formatted_prompt.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/get_formatted_prompt.py --strict
```

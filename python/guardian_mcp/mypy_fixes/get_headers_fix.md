...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/get_headers.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/get_headers.py --strict
```

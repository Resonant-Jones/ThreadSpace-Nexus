# 🧠 Mypy Fix Guide: `get_litellm_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/get_litellm_params.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/get_litellm_params.py --strict
```

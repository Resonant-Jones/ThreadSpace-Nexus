# 🧠 Mypy Fix Guide: `get_model_cost_map.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/get_model_cost_map.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/get_model_cost_map.py --strict
```

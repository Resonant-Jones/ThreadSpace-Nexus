# 🧠 Mypy Fix Guide: `get_retry_from_policy.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/get_retry_from_policy.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/get_retry_from_policy.py --strict
```

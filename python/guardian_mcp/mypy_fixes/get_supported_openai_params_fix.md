# 🧠 Mypy Fix Guide: `get_supported_openai_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/get_supported_openai_params.py`
**Lines:** `267`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/get_supported_openai_params.py --strict
```

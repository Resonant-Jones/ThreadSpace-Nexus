...
**File:** `.venv/lib/python3.13/site-packages/fake_useragent/get_version.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/fake_useragent/get_version.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/grpc/experimental/gevent.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/experimental/gevent.py --strict
```

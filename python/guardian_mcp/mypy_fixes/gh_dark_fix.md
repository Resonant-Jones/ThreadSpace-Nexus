...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/gh_dark.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/gh_dark.py --strict
```

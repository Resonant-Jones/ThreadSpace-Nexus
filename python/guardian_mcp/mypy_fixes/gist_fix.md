...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/gist.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/gist.py --strict
```

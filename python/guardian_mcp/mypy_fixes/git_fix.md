...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/git.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/git.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/github.py`
**Lines:** `333`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/github.py --strict
```

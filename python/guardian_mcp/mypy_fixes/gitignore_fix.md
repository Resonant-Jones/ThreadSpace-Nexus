...
**File:** `.venv/lib/python3.13/site-packages/pathspec/gitignore.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/pathspec/gitignore.py --strict
```

# 🧠 Mypy Fix Guide: `gitwildmatch.py`
...
**File:** `.venv/lib/python3.13/site-packages/pathspec/patterns/gitwildmatch.py`
**Lines:** `421`
...
```bash
mypy .venv/lib/python3.13/site-packages/pathspec/patterns/gitwildmatch.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/gleu_score.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/gleu_score.py --strict
```

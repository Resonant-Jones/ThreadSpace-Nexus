...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/glibc.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/glibc.py --strict
```

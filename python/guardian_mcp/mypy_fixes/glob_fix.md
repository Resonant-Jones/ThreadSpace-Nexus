...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/zipp/glob.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/zipp/glob.py --strict
```

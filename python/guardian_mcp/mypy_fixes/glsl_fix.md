...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/glsl.py`
**Lines:** `548`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/glsl.py --strict
```

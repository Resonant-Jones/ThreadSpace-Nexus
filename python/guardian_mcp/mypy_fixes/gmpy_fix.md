...
**File:** `.venv/lib/python3.13/site-packages/sympy/external/gmpy.py`
**Lines:** `342`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/external/gmpy.py --strict
```

# 🧠 Mypy Fix Guide: `gmpyfinitefield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/gmpyfinitefield.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/gmpyfinitefield.py --strict
```

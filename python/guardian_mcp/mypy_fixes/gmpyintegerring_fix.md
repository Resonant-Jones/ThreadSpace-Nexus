# 🧠 Mypy Fix Guide: `gmpyintegerring.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/gmpyintegerring.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/gmpyintegerring.py --strict
```

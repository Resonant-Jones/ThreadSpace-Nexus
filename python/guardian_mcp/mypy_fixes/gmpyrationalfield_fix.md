# 🧠 Mypy Fix Guide: `gmpyrationalfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/gmpyrationalfield.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/gmpyrationalfield.py --strict
```

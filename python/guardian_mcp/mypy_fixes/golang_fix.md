...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/golang.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/golang.py --strict
```

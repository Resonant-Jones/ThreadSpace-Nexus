# 🧠 Mypy Fix Guide: `google_auth_httplib2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google_auth_httplib2.py`
**Lines:** `307`
...
```bash
mypy .venv/lib/python3.13/site-packages/google_auth_httplib2.py --strict
```

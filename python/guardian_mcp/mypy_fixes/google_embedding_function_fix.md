# 🧠 Mypy Fix Guide: `google_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/google_embedding_function.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/google_embedding_function.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/secret_managers/google_kms.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/secret_managers/google_kms.py --strict
```

# 🧠 Mypy Fix Guide: `google_secret_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/secret_managers/google_secret_manager.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/secret_managers/google_secret_manager.py --strict
```

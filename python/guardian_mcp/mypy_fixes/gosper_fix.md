...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/gosper.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/gosper.py --strict
```

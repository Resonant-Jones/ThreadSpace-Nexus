...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/gpt2_parity.py`
**Lines:** `513`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/gpt2_parity.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/gpt2_tester.py`
**Lines:** `501`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/gpt2_tester.py --strict
```

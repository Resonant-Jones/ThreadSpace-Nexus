# 🧠 Mypy Fix Guide: `gpt_audio_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/openai/chat/gpt_audio_transformation.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/openai/chat/gpt_audio_transformation.py --strict
```

# 🧠 Mypy Fix Guide: `gpt_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/azure/image_generation/gpt_transformation.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/azure/image_generation/gpt_transformation.py --strict
```

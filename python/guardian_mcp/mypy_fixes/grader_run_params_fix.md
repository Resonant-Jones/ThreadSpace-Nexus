# 🧠 Mypy Fix Guide: `grader_run_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_run_params.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_run_params.py --strict
```

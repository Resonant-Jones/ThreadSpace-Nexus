# 🧠 Mypy Fix Guide: `grader_run_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_run_response.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_run_response.py --strict
```

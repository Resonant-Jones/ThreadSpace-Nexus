# 🧠 Mypy Fix Guide: `grader_validate_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_validate_params.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_validate_params.py --strict
```

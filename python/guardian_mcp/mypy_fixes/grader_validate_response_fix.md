# 🧠 Mypy Fix Guide: `grader_validate_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_validate_response.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/alpha/grader_validate_response.py --strict
```

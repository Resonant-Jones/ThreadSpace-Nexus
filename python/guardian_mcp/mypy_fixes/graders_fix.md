...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/fine_tuning/alpha/graders.py`
**Lines:** `282`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/fine_tuning/alpha/graders.py --strict
```

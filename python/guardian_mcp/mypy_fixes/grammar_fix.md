...
**File:** `.venv/lib/python3.13/site-packages/blib2to3/pgen2/grammar.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/blib2to3/pgen2/grammar.py --strict
```

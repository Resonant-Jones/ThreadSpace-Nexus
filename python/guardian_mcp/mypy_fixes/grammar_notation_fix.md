# 🧠 Mypy Fix Guide: `grammar_notation.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/grammar_notation.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/grammar_notation.py --strict
```

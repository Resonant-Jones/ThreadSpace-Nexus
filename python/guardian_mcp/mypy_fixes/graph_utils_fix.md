...
**File:** `.venv/lib/python3.13/site-packages/mypy/graph_utils.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/graph_utils.py --strict
```

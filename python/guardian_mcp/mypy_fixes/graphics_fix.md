...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/graphics.py`
**Lines:** `794`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/graphics.py --strict
```

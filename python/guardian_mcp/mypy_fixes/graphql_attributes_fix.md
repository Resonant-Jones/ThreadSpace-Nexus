# 🧠 Mypy Fix Guide: `graphql_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/graphql_attributes.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/graphql_attributes.py --strict
```

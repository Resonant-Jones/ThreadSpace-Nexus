...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/graphql.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/graphql.py --strict
```

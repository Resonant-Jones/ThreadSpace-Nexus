...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/graphviz.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/graphviz.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/graycode.py`
**Lines:** `430`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/graycode.py --strict
```

# 🧠 Mypy Fix Guide: `greek_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/greek_stemmer.py`
**Lines:** `2271`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/greek_stemmer.py --strict
```

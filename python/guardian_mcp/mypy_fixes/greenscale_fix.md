...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/greenscale.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/greenscale.py --strict
```

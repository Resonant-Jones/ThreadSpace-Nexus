# 🧠 Mypy Fix Guide: `groebnertools.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/groebnertools.py`
**Lines:** `862`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/groebnertools.py --strict
```

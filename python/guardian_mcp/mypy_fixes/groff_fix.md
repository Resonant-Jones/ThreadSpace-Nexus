...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/groff.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/groff.py --strict
```

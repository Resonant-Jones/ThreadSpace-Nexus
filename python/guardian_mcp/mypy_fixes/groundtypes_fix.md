...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/groundtypes.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/groundtypes.py --strict
```

# 🧠 Mypy Fix Guide: `group_constructs.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/group_constructs.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/group_constructs.py --strict
```

# 🧠 Mypy Fix Guide: `group_numbers.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/group_numbers.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/group_numbers.py --strict
```

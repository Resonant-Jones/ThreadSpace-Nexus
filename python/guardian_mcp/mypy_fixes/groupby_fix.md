...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/groupby/groupby.py`
**Lines:** `5997`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/groupby/groupby.py --strict
```

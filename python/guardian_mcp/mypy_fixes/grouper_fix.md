...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/groupby/grouper.py`
**Lines:** `1102`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/groupby/grouper.py --strict
```

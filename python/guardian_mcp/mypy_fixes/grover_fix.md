...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/grover.py`
**Lines:** `345`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/grover.py --strict
```

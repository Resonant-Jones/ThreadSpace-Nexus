...
**File:** `.venv/lib/python3.13/site-packages/chromadb/telemetry/opentelemetry/grpc.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/telemetry/opentelemetry/grpc.py --strict
```

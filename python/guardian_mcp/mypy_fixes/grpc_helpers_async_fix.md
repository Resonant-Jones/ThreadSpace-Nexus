# 🧠 Mypy Fix Guide: `grpc_helpers_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/grpc_helpers_async.py`
**Lines:** `343`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/grpc_helpers_async.py --strict
```

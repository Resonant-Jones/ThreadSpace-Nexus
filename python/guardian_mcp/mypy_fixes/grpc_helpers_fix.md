# 🧠 Mypy Fix Guide: `grpc_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/grpc_helpers.py`
**Lines:** `646`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/grpc_helpers.py --strict
```

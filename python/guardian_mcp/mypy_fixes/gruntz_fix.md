...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/gruntz.py`
**Lines:** `701`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/gruntz.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/gruvbox.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/gruvbox.py --strict
```

# 🧠 Mypy Fix Guide: `gspread_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/gspread_client.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/gspread_client.py --strict
```

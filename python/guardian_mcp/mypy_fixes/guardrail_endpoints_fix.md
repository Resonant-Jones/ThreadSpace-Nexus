# 🧠 Mypy Fix Guide: `guardrail_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_endpoints.py`
**Lines:** `778`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_endpoints.py --strict
```

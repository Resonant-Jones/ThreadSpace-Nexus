# 🧠 Mypy Fix Guide: `guardrail_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_helpers.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_helpers.py --strict
```

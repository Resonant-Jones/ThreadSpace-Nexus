# 🧠 Mypy Fix Guide: `guardrail_initializers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_initializers.py`
**Lines:** `210`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_initializers.py --strict
```

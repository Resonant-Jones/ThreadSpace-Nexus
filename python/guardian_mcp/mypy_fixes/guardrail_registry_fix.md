# 🧠 Mypy Fix Guide: `guardrail_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_registry.py`
**Lines:** `401`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_registry.py --strict
```

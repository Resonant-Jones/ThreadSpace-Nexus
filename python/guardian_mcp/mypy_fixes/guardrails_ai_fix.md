# 🧠 Mypy Fix Guide: `guardrails_ai.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/guardrails_ai.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/guardrails_ai.py --strict
```

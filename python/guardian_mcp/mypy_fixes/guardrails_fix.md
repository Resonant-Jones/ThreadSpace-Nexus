...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/guardrails.py`
**Lines:** `488`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/guardrails.py --strict
```

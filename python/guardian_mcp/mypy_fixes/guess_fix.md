...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/guess.py`
**Lines:** `473`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/guess.py --strict
```

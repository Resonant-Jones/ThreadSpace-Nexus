...
**File:** `.venv/lib/python3.13/site-packages/starlette/middleware/gzip.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/middleware/gzip.py --strict
```

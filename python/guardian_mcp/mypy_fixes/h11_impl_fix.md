...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/protocols/http/h11_impl.py`
**Lines:** `543`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/protocols/http/h11_impl.py --strict
```

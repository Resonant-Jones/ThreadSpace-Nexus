...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/hadamard.py`
**Lines:** `464`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/hadamard.py --strict
```

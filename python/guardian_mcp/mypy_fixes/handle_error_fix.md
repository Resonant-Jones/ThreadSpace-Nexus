# 🧠 Mypy Fix Guide: `handle_error.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/handle_error.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/handle_error.py --strict
```

# 🧠 Mypy Fix Guide: `handle_ipynb_magics.py`
...
**File:** `.venv/lib/python3.13/site-packages/black/handle_ipynb_magics.py`
**Lines:** `508`
...
```bash
mypy .venv/lib/python3.13/site-packages/black/handle_ipynb_magics.py --strict
```

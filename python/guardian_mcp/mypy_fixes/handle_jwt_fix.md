...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/handle_jwt.py`
**Lines:** `1046`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/handle_jwt.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/websockets/legacy/handshake.py`
**Lines:** `158`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/legacy/handshake.py --strict
```

# 🧠 Mypy Fix Guide: `hanging_request_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/SlackAlerting/hanging_request_check.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/SlackAlerting/hanging_request_check.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/hare.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/hare.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/harness.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/harness.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/hash.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/hash.py --strict
```

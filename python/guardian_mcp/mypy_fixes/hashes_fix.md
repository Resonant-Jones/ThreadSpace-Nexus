...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/hashes.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/hashes.py --strict
```

# 🧠 Mypy Fix Guide: `hashicorp_secret_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/secret_managers/hashicorp_secret_manager.py`
**Lines:** `325`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/secret_managers/hashicorp_secret_manager.py --strict
```

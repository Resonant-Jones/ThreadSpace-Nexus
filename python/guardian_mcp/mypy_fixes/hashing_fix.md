...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/util/hashing.py`
**Lines:** `339`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/util/hashing.py --strict
```

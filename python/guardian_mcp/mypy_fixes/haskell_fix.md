...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/haskell.py`
**Lines:** `866`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/haskell.py --strict
```

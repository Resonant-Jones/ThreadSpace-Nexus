...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/haxe.py`
**Lines:** `935`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/haxe.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/hdl.py`
**Lines:** `466`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/hdl.py --strict
```

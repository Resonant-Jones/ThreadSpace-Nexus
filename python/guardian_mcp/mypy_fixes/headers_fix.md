...
**File:** `.venv/lib/python3.13/site-packages/websockets/headers.py`
**Lines:** `586`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/headers.py --strict
```

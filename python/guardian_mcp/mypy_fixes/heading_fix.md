...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/heading.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/heading.py --strict
```

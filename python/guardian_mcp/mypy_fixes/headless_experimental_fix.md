# 🧠 Mypy Fix Guide: `headless_experimental.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/headless_experimental.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/headless_experimental.py --strict
```

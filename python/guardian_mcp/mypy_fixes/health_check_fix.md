# 🧠 Mypy Fix Guide: `health_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/health_check.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/health_check.py --strict
```

# 🧠 Mypy Fix Guide: `health_check_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/health_check_utils.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/health_check_utils.py --strict
```

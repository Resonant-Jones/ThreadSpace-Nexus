...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/client/health.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/client/health.py --strict
```

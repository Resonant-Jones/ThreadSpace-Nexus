# 🧠 Mypy Fix Guide: `heap_profiler.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/heap_profiler.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/heap_profiler.py --strict
```

# 🧠 Mypy Fix Guide: `hebrewprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/hebrewprober.py`
**Lines:** `316`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/hebrewprober.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/helicone.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/helicone.py --strict
```

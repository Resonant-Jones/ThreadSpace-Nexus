...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/help.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/help.py --strict
```

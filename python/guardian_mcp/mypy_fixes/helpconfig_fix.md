...
**File:** `.venv/lib/python3.13/site-packages/_pytest/helpconfig.py`
**Lines:** `283`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/helpconfig.py --strict
```

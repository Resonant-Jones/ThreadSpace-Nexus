# 🧠 Mypy Fix Guide: `helper_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/helper_types.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/helper_types.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_websocket/helpers.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_websocket/helpers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/hermite_e.py`
**Lines:** `1642`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/hermite_e.py --strict
```

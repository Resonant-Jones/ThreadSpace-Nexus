...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/hermite.py`
**Lines:** `1740`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/hermite.py --strict
```

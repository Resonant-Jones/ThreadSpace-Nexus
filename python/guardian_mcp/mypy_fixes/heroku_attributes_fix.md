# 🧠 Mypy Fix Guide: `heroku_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/heroku_attributes.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/heroku_attributes.py --strict
```

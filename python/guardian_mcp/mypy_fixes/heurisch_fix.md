...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/heurisch.py`
**Lines:** `781`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/heurisch.py --strict
```

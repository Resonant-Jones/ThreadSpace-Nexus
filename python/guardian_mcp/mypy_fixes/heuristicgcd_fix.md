# 🧠 Mypy Fix Guide: `heuristicgcd.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/heuristicgcd.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/heuristicgcd.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/heuristics.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/heuristics.py --strict
```

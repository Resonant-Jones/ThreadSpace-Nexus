...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/hexdump.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/hexdump.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/hf_api.py`
**Lines:** `10069`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/hf_api.py --strict
```

# 🧠 Mypy Fix Guide: `hf_file_system.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/hf_file_system.py`
**Lines:** `1142`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/hf_file_system.py --strict
```

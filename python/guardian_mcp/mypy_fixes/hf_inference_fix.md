# 🧠 Mypy Fix Guide: `hf_inference.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/hf_inference.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/hf_inference.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/highlighter.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/highlighter.py --strict
```

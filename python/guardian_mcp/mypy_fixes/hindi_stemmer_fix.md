# 🧠 Mypy Fix Guide: `hindi_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/hindi_stemmer.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/hindi_stemmer.py --strict
```

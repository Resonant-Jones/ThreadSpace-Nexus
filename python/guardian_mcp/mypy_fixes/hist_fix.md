...
**File:** `.venv/lib/python3.13/site-packages/pandas/plotting/_matplotlib/hist.py`
**Lines:** `581`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/plotting/_matplotlib/hist.py --strict
```

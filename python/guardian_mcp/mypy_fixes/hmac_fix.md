...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/hmac.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/hmac.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/hnsw_params.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/hnsw_params.py --strict
```

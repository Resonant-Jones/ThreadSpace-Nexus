...
**File:** `.venv/lib/python3.13/site-packages/pandas/tseries/holiday.py`
**Lines:** `634`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/tseries/holiday.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/holonomic/holonomic.py`
**Lines:** `2765`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/holonomic/holonomic.py --strict
```

# 🧠 Mypy Fix Guide: `holonomicerrors.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/holonomic/holonomicerrors.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/holonomic/holonomicerrors.py --strict
```

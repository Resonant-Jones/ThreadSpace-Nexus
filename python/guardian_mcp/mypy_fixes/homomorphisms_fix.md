# 🧠 Mypy Fix Guide: `homomorphisms.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/agca/homomorphisms.py`
**Lines:** `691`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/agca/homomorphisms.py --strict
```

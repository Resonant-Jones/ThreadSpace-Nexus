...
**File:** `.venv/lib/python3.13/site-packages/numpy/_pyinstaller/hook-numpy.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_pyinstaller/hook-numpy.py --strict
```

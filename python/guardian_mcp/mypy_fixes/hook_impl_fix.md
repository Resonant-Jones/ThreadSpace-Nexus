...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/hook_impl.py`
**Lines:** `271`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/hook_impl.py --strict
```

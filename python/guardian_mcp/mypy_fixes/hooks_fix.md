...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/requests/hooks.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/requests/hooks.py --strict
```

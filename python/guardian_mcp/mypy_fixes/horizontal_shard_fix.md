# 🧠 Mypy Fix Guide: `horizontal_shard.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/horizontal_shard.py`
**Lines:** `478`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/horizontal_shard.py --strict
```

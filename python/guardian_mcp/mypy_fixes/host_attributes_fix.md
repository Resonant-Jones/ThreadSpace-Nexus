# 🧠 Mypy Fix Guide: `host_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/host_attributes.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/host_attributes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/twofactor/hotp.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/twofactor/hotp.py --strict
```

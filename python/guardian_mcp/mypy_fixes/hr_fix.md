...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/hr.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/hr.py --strict
```

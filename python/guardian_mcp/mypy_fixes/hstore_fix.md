...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/hstore.py`
**Lines:** `406`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/hstore.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/html5parser.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/html5parser.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/html_block.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/html_block.py --strict
```

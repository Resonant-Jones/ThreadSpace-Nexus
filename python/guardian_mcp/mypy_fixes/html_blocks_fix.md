...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/common/html_blocks.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/common/html_blocks.py --strict
```

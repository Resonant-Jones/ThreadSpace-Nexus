...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/html.py`
**Lines:** `995`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/html.py --strict
```

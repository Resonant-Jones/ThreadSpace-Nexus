...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/html_inline.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/html_inline.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/common/html_re.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/common/html_re.py --strict
```

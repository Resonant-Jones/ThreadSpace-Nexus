...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/html_utils.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/html_utils.py --strict
```

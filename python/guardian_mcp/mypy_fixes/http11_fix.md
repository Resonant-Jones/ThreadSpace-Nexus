...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/http11.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/http11.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/http2.py`
**Lines:** `592`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/http2.py --strict
```

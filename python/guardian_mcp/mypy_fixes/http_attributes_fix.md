# 🧠 Mypy Fix Guide: `http_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/http_attributes.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/http_attributes.py --strict
```

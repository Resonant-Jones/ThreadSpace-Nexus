...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/client/http_client.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/client/http_client.py --strict
```

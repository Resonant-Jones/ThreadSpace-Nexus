# 🧠 Mypy Fix Guide: `http_exceptions.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/http_exceptions.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/http_exceptions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/http.py`
**Lines:** `880`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/http.py --strict
```

# 🧠 Mypy Fix Guide: `http_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/http_metrics.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/http_metrics.py --strict
```

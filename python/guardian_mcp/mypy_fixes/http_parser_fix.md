...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/http_parser.py`
**Lines:** `1046`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/http_parser.py --strict
```

# 🧠 Mypy Fix Guide: `http_parsing_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/http_parsing_utils.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/http_parsing_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/rpc/http_pb2.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/rpc/http_pb2.py --strict
```

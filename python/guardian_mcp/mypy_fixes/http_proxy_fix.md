...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/http_proxy.py`
**Lines:** `367`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/http_proxy.py --strict
```

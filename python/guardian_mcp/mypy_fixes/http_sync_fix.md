...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/http_sync.py`
**Lines:** `931`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/http_sync.py --strict
```

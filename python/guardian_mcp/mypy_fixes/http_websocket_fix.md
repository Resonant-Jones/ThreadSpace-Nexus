# 🧠 Mypy Fix Guide: `http_websocket.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/http_websocket.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/http_websocket.py --strict
```

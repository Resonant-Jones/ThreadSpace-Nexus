...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/http_writer.py`
**Lines:** `378`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/http_writer.py --strict
```

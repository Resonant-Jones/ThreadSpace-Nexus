...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/util/http/httplib.py`
**Lines:** `195`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/util/http/httplib.py --strict
```

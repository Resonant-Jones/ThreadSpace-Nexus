# 🧠 Mypy Fix Guide: `httpsredirect.py`
...
**File:** `.venv/lib/python3.13/site-packages/starlette/middleware/httpsredirect.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/middleware/httpsredirect.py --strict
```

# 🧠 Mypy Fix Guide: `httptools_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/protocols/http/httptools_impl.py`
**Lines:** `570`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/protocols/http/httptools_impl.py --strict
```

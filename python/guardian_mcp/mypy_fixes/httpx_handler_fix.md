# 🧠 Mypy Fix Guide: `httpx_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/custom_httpx/httpx_handler.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/custom_httpx/httpx_handler.py --strict
```

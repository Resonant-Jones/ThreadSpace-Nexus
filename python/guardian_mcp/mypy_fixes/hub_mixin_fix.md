...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/hub_mixin.py`
**Lines:** `851`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/hub_mixin.py --strict
```

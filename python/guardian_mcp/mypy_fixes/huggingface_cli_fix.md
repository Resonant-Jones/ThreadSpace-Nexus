# 🧠 Mypy Fix Guide: `huggingface_cli.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/huggingface_cli.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/huggingface_cli.py --strict
```

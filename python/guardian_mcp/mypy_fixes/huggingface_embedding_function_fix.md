# 🧠 Mypy Fix Guide: `huggingface_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/huggingface_embedding_function.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/huggingface_embedding_function.py --strict
```

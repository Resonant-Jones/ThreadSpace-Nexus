# 🧠 Mypy Fix Guide: `huggingface_models.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/huggingface_models.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/huggingface_models.py --strict
```

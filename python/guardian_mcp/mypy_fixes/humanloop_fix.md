...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/humanloop.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/humanloop.py --strict
```

# 🧠 Mypy Fix Guide: `hungarian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/hungarian_stemmer.py`
**Lines:** `520`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/hungarian_stemmer.py --strict
```

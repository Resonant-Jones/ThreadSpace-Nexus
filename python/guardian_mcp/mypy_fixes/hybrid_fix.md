...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/openid/connect/core/grant_types/hybrid.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/openid/connect/core/grant_types/hybrid.py --strict
```

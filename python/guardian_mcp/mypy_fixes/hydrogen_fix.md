...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/hydrogen.py`
**Lines:** `265`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/hydrogen.py --strict
```

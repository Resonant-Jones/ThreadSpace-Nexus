...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/hyper.py`
**Lines:** `1185`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/hyper.py --strict
```

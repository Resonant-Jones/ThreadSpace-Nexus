...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/hyperbolic.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/hyperbolic.py --strict
```

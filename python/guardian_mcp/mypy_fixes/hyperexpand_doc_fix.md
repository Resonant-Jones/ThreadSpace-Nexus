# 🧠 Mypy Fix Guide: `hyperexpand_doc.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/hyperexpand_doc.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/hyperexpand_doc.py --strict
```

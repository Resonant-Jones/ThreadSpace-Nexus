...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/hyperexpand.py`
**Lines:** `2494`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/hyperexpand.py --strict
```

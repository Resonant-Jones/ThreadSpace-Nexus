# 🧠 Mypy Fix Guide: `hypergeometric.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/hypergeometric.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/hypergeometric.py --strict
```

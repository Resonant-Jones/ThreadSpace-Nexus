...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/iam.py`
**Lines:** `427`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/iam.py --strict
```

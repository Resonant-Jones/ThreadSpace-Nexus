...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/ibm1.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/ibm1.py --strict
```

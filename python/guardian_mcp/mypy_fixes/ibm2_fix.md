...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/ibm2.py`
**Lines:** `319`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/ibm2.py --strict
```

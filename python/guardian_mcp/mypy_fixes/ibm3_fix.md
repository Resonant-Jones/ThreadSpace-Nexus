...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/ibm3.py`
**Lines:** `346`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/ibm3.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/ibm4.py`
**Lines:** `490`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/ibm4.py --strict
```

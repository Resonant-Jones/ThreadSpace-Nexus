...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/ibm5.py`
**Lines:** `661`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/ibm5.py --strict
```

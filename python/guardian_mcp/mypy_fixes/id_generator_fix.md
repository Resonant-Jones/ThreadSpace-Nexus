# 🧠 Mypy Fix Guide: `id_generator.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/trace/id_generator.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/trace/id_generator.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/id_token.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/id_token.py --strict
```

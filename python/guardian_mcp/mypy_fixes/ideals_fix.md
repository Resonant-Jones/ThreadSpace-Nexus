...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/agca/ideals.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/agca/ideals.py --strict
```

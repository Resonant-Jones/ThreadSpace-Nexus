...
**File:** `.venv/lib/python3.13/site-packages/identify/identify.py`
**Lines:** `278`
...
```bash
mypy .venv/lib/python3.13/site-packages/identify/identify.py --strict
```

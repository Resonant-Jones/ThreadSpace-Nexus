...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/meta_hooks/identity.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/meta_hooks/identity.py --strict
```

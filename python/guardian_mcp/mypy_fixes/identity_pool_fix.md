# 🧠 Mypy Fix Guide: `identity_pool.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/identity_pool.py`
**Lines:** `528`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/identity_pool.py --strict
```

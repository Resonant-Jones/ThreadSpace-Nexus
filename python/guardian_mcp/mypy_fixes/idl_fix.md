...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/idl.py`
**Lines:** `284`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/idl.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/idna/idnadata.py`
**Lines:** `4243`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/idna/idnadata.py --strict
```

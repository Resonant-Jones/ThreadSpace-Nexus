...
**File:** `.venv/lib/python3.13/site-packages/jinja2/idtracking.py`
**Lines:** `318`
...
```bash
mypy .venv/lib/python3.13/site-packages/jinja2/idtracking.py --strict
```

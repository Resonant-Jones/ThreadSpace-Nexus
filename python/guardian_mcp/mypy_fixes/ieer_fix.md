...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/ieer.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/ieer.py --strict
```

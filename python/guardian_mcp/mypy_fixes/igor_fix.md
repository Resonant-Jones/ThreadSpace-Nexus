...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/igor.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/igor.py --strict
```

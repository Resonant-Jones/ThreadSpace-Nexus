# 🧠 Mypy Fix Guide: `image_classification.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_classification.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_classification.py --strict
```

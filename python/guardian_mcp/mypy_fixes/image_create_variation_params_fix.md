# 🧠 Mypy Fix Guide: `image_create_variation_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/image_create_variation_params.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/image_create_variation_params.py --strict
```

# 🧠 Mypy Fix Guide: `image_decoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/image_decoder.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/image_decoder.py --strict
```

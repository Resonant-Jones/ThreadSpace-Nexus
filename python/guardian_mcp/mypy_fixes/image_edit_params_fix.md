# 🧠 Mypy Fix Guide: `image_edit_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/image_edit_params.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/image_edit_params.py --strict
```

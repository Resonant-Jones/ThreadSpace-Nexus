# 🧠 Mypy Fix Guide: `image_encoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/image_encoder.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/image_encoder.py --strict
```

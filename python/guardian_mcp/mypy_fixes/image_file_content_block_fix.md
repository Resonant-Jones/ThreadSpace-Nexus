# 🧠 Mypy Fix Guide: `image_file_content_block.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/image_file_content_block.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/image_file_content_block.py --strict
```

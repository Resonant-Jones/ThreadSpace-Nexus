# 🧠 Mypy Fix Guide: `image_file_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/image_file_delta.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/image_file_delta.py --strict
```

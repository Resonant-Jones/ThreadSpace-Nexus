# 🧠 Mypy Fix Guide: `image_generate_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/image_generate_params.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/image_generate_params.py --strict
```

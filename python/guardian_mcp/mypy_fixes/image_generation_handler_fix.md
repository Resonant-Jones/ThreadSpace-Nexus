# 🧠 Mypy Fix Guide: `image_generation_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/image_generation/image_generation_handler.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/image_generation/image_generation_handler.py --strict
```

# 🧠 Mypy Fix Guide: `image_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/image_handler.py`
**Lines:** `321`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/image/image_handler.py --strict
```

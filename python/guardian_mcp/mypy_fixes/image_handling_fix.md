# 🧠 Mypy Fix Guide: `image_handling.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/prompt_templates/image_handling.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/prompt_templates/image_handling.py --strict
```

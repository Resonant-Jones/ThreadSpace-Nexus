# 🧠 Mypy Fix Guide: `image_segmentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_segmentation.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_segmentation.py --strict
```

# 🧠 Mypy Fix Guide: `image_to_image.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_to_image.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_to_image.py --strict
```

# 🧠 Mypy Fix Guide: `image_to_text.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_to_text.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/image_to_text.py --strict
```

# 🧠 Mypy Fix Guide: `image_url_content_block_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/image_url_content_block_param.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/image_url_content_block_param.py --strict
```

# 🧠 Mypy Fix Guide: `image_url_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/image_url_delta.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/image_url_delta.py --strict
```

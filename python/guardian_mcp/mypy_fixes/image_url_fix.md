...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/image_url.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/image_url.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/images.py`
**Lines:** `729`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/images.py --strict
```

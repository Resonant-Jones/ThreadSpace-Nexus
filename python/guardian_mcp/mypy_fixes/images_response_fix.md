# 🧠 Mypy Fix Guide: `images_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/images_response.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/images_response.py --strict
```

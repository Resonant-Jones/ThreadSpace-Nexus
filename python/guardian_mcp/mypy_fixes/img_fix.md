...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/img.py`
**Lines:** `686`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/img.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/immutable.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/immutable.py --strict
```

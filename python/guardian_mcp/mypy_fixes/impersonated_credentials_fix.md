# 🧠 Mypy Fix Guide: `impersonated_credentials.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/auth/impersonated_credentials.py`
**Lines:** `654`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/impersonated_credentials.py --strict
```

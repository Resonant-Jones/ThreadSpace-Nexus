...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/pool/impl.py`
**Lines:** `581`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/pool/impl.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/grant_types/implicit.py`
**Lines:** `376`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/grant_types/implicit.py --strict
```

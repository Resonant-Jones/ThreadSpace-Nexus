# 🧠 Mypy Fix Guide: `import_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/import_utils.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/import_utils.py --strict
```

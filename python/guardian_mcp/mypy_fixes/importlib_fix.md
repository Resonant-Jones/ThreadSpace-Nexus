...
**File:** `.venv/lib/python3.13/site-packages/build/_compat/importlib.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/build/_compat/importlib.py --strict
```

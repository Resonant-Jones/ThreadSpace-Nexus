...
**File:** `.venv/lib/python3.13/site-packages/websockets/imports.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/imports.py --strict
```

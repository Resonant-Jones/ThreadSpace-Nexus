...
**File:** `.venv/lib/python3.13/site-packages/sympy/external/importtools.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/external/importtools.py --strict
```

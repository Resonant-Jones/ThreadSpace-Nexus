# 🧠 Mypy Fix Guide: `in_memory_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/in_memory_cache.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/in_memory_cache.py --strict
```

# 🧠 Mypy Fix Guide: `in_memory_log_exporter.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/_logs/_internal/export/in_memory_log_exporter.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/_logs/_internal/export/in_memory_log_exporter.py --strict
```

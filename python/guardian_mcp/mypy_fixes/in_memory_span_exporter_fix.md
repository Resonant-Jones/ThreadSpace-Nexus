# 🧠 Mypy Fix Guide: `in_memory_span_exporter.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/trace/export/in_memory_span_exporter.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/trace/export/in_memory_span_exporter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mistune/directives/include.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/directives/include.py --strict
```

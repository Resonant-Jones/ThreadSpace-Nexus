# 🧠 Mypy Fix Guide: `incluster_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/incluster_config.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/incluster_config.py --strict
```

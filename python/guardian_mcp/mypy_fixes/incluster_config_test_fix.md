# 🧠 Mypy Fix Guide: `incluster_config_test.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/incluster_config_test.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/incluster_config_test.py --strict
```

# 🧠 Mypy Fix Guide: `index_command.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/index_command.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/index_command.py --strict
```

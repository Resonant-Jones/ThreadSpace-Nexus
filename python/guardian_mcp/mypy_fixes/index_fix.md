...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/index.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/index.py --strict
```

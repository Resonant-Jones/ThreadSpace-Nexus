# 🧠 Mypy Fix Guide: `index_methods.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/index_methods.py`
**Lines:** `469`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/index_methods.py --strict
```

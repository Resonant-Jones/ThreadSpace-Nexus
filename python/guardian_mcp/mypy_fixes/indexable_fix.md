...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/indexable.py`
**Lines:** `345`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/indexable.py --strict
```

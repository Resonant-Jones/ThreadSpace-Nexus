...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/indexed.py`
**Lines:** `793`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/indexed.py --strict
```

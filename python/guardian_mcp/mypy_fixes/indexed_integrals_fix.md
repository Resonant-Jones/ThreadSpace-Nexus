# 🧠 Mypy Fix Guide: `indexed_integrals.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/sandbox/indexed_integrals.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sandbox/indexed_integrals.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/groupby/indexing.py`
**Lines:** `304`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/groupby/indexing.py --strict
```

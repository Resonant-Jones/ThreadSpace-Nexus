...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/indian.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/indian.py --strict
```

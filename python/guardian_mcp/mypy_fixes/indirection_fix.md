...
**File:** `.venv/lib/python3.13/site-packages/mypy/indirection.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/indirection.py --strict
```

# 🧠 Mypy Fix Guide: `indonesian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/indonesian_stemmer.py`
**Lines:** `319`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/indonesian_stemmer.py --strict
```

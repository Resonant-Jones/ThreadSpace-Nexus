# 🧠 Mypy Fix Guide: `inequalities.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/inequalities.py`
**Lines:** `986`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/inequalities.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/inertia.py`
**Lines:** `199`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/inertia.py --strict
```

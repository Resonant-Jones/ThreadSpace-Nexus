...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/infer.py`
**Lines:** `590`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/infer.py --strict
```

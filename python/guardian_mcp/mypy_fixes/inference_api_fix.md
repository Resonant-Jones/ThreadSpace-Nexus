# 🧠 Mypy Fix Guide: `inference_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference_api.py`
**Lines:** `217`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference_api.py --strict
```

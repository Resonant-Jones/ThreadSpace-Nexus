# 🧠 Mypy Fix Guide: `inference_example.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/phi2/inference_example.py`
**Lines:** `414`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/phi2/inference_example.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/inference.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/inference.py --strict
```

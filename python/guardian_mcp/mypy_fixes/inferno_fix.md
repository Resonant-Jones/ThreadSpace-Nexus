...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/inferno.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/inferno.py --strict
```

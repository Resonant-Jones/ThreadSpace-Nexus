...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/formats/info.py`
**Lines:** `1101`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/formats/info.py --strict
```

# 🧠 Mypy Fix Guide: `information_schema.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/information_schema.py`
**Lines:** `254`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/information_schema.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/config/ini.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/config/ini.py --strict
```

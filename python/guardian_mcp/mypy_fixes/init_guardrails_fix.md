# 🧠 Mypy Fix Guide: `init_guardrails.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/init_guardrails.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/init_guardrails.py --strict
```

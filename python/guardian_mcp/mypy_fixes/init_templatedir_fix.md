# 🧠 Mypy Fix Guide: `init_templatedir.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/init_templatedir.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/init_templatedir.py --strict
```

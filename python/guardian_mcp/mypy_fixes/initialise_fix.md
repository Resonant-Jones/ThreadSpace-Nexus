...
**File:** `.venv/lib/python3.13/site-packages/colorama/initialise.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/colorama/initialise.py --strict
```

# 🧠 Mypy Fix Guide: `initialize_dynamic_callback_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/initialize_dynamic_callback_params.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/initialize_dynamic_callback_params.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/inkpot.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/inkpot.py --strict
```

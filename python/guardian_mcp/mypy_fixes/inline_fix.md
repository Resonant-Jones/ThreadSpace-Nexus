...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_core/inline.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_core/inline.py --strict
```

# 🧠 Mypy Fix Guide: `inline_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/mistune/inline_parser.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/inline_parser.py --strict
```

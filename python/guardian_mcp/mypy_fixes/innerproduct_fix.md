# 🧠 Mypy Fix Guide: `innerproduct.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/innerproduct.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/innerproduct.py --strict
```

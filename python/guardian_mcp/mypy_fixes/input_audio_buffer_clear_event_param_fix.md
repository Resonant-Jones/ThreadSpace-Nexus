# 🧠 Mypy Fix Guide: `input_audio_buffer_clear_event_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/input_audio_buffer_clear_event_param.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/input_audio_buffer_clear_event_param.py --strict
```

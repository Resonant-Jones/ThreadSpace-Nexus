# 🧠 Mypy Fix Guide: `input_audio_buffer_commit_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/input_audio_buffer_commit_event.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/input_audio_buffer_commit_event.py --strict
```

# 🧠 Mypy Fix Guide: `input_device.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/input_device.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/input_device.py --strict
```

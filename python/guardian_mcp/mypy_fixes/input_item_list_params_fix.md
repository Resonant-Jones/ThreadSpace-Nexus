# 🧠 Mypy Fix Guide: `input_item_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/input_item_list_params.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/input_item_list_params.py --strict
```

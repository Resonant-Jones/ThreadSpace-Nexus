...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/responses/input_items.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/responses/input_items.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/input_utils.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/input_utils.py --strict
```

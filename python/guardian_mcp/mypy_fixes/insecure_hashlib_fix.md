# 🧠 Mypy Fix Guide: `insecure_hashlib.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/insecure_hashlib.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/insecure_hashlib.py --strict
```

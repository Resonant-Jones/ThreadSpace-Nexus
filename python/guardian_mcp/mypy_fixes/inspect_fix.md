...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/inspect.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/inspect.py --strict
```

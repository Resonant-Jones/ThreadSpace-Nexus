...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/inspection.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/inspection.py --strict
```

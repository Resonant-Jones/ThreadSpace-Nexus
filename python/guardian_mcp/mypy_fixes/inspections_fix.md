...
**File:** `.venv/lib/python3.13/site-packages/mypy/inspections.py`
**Lines:** `626`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/inspections.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/inspector.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/inspector.py --strict
```

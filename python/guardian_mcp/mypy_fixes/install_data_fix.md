# 🧠 Mypy Fix Guide: `install_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/install_data.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/install_data.py --strict
```

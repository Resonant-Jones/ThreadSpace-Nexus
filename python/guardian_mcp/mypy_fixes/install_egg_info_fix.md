# 🧠 Mypy Fix Guide: `install_egg_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/install_egg_info.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/install_egg_info.py --strict
```

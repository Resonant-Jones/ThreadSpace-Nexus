...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/install.py`
**Lines:** `793`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/install.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/command/install_lib.py`
**Lines:** `238`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/command/install_lib.py --strict
```

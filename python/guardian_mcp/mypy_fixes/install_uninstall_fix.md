# 🧠 Mypy Fix Guide: `install_uninstall.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/install_uninstall.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/install_uninstall.py --strict
```

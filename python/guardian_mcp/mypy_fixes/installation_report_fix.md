# 🧠 Mypy Fix Guide: `installation_report.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/installation_report.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/installation_report.py --strict
```

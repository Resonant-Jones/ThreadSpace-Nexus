...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/distributions/installed.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/distributions/installed.py --strict
```

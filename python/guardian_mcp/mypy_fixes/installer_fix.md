...
**File:** `.venv/lib/python3.13/site-packages/setuptools/installer.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/installer.py --strict
```

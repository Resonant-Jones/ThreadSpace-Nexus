...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/installers.py`
**Lines:** `352`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/installers.py --strict
```

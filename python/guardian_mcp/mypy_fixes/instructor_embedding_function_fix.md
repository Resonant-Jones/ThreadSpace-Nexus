# 🧠 Mypy Fix Guide: `instructor_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/instructor_embedding_function.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/instructor_embedding_function.py --strict
```

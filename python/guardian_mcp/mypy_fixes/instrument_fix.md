...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/metrics/_internal/instrument.py`
**Lines:** `530`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/metrics/_internal/instrument.py --strict
```

# 🧠 Mypy Fix Guide: `instrumentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/util/instrumentation.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/util/instrumentation.py --strict
```

# 🧠 Mypy Fix Guide: `instrumentor.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/instrumentor.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/instrumentor.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/int_fiction.py`
**Lines:** `1370`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/int_fiction.py --strict
```

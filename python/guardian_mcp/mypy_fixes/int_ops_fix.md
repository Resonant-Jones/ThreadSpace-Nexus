...
**File:** `.venv/lib/python3.13/site-packages/mypyc/lower/int_ops.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/lower/int_ops.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/compat/integer.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/compat/integer.py --strict
```

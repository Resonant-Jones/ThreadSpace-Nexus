...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/integerring.py`
**Lines:** `276`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/integerring.py --strict
```

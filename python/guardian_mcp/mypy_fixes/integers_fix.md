...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/integers.py`
**Lines:** `710`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/integers.py --strict
```

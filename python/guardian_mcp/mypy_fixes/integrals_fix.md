...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/integrals.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/integrals.py --strict
```

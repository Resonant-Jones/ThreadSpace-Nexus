...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/interaction.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/interaction.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google_auth_oauthlib/interactive.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/google_auth_oauthlib/interactive.py --strict
```

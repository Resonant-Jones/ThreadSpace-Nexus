...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/interfaces.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/interfaces.py --strict
```

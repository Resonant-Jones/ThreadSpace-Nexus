# 🧠 Mypy Fix Guide: `internal_apiserver_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/internal_apiserver_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/internal_apiserver_api.py --strict
```

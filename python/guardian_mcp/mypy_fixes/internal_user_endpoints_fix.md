# 🧠 Mypy Fix Guide: `internal_user_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/internal_user_endpoints.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/internal_user_endpoints.py --strict
```

# 🧠 Mypy Fix Guide: `intersection.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/intersection.py`
**Lines:** `533`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/intersection.py --strict
```

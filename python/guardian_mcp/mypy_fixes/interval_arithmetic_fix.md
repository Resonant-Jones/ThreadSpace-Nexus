# 🧠 Mypy Fix Guide: `interval_arithmetic.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/intervalmath/interval_arithmetic.py`
**Lines:** `413`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/intervalmath/interval_arithmetic.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/interval.py`
**Lines:** `1137`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/interval.py --strict
```

# 🧠 Mypy Fix Guide: `interval_membership.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/intervalmath/interval_membership.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/intervalmath/interval_membership.py --strict
```

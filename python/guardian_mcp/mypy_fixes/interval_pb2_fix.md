# 🧠 Mypy Fix Guide: `interval_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/type/interval_pb2.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/type/interval_pb2.py --strict
```

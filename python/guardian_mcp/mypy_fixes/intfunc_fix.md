...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/intfunc.py`
**Lines:** `530`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/intfunc.py --strict
```

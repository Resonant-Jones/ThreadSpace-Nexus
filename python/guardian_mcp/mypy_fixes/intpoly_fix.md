...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/intpoly.py`
**Lines:** `1302`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/intpoly.py --strict
```

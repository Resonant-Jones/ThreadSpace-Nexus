...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/idna/intranges.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/idna/intranges.py --strict
```

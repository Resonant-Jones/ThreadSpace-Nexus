...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/introspect.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/introspect.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/ops/invalid.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/ops/invalid.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/invariants.py`
**Lines:** `584`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/invariants.py --strict
```

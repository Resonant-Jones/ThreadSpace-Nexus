...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/inverse.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/inverse.py --strict
```

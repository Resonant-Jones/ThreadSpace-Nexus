# 🧠 Mypy Fix Guide: `invoke_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_handler.py`
**Lines:** `1684`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/bedrock/chat/invoke_handler.py --strict
```

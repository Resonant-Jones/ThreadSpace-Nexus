# 🧠 Mypy Fix Guide: `io_binding_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/io_binding_helper.py`
**Lines:** `447`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/io_binding_helper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/iolang.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/iolang.py --strict
```

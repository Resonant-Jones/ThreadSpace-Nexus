...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/ipipan.py`
**Lines:** `354`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/ipipan.py --strict
```

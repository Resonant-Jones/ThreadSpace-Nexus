...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/ipython_env.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/ipython_env.py --strict
```

# 🧠 Mypy Fix Guide: `ir_transform.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/transform/ir_transform.py`
**Lines:** `371`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/transform/ir_transform.py --strict
```

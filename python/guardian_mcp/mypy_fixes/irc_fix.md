...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/irc.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/irc.py --strict
```

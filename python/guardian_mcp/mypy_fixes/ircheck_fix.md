...
**File:** `.venv/lib/python3.13/site-packages/mypyc/analysis/ircheck.py`
**Lines:** `433`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/analysis/ircheck.py --strict
```

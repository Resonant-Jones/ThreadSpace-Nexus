# 🧠 Mypy Fix Guide: `irish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/irish_stemmer.py`
**Lines:** `276`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/irish_stemmer.py --strict
```

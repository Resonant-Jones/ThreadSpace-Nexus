...
**File:** `.venv/lib/python3.13/site-packages/dateutil/parser/isoparser.py`
**Lines:** `416`
...
```bash
mypy .venv/lib/python3.13/site-packages/dateutil/parser/isoparser.py --strict
```

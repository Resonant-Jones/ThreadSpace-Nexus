...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/issubset.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/issubset.py --strict
```

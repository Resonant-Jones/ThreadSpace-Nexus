...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/issue232.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/issue232.py --strict
```

# 🧠 Mypy Fix Guide: `italian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/italian_stemmer.py`
**Lines:** `715`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/italian_stemmer.py --strict
```

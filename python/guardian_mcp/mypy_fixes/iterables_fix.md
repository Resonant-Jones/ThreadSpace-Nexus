...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/iterables.py`
**Lines:** `3179`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/iterables.py --strict
```

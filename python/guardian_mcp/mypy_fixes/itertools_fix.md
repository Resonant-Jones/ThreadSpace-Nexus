...
**File:** `.venv/lib/python3.13/site-packages/tqdm/contrib/itertools.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/contrib/itertools.py --strict
```

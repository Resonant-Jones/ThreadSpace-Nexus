...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/javascript.py`
**Lines:** `1591`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/javascript.py --strict
```

# 🧠 Mypy Fix Guide: `jina_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/jina_embedding_function.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/jina_embedding_function.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/jmespath.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/jmespath.py --strict
```

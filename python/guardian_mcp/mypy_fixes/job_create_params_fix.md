# 🧠 Mypy Fix Guide: `job_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/job_create_params.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/job_create_params.py --strict
```

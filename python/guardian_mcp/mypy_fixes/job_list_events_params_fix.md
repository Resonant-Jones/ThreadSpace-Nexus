# 🧠 Mypy Fix Guide: `job_list_events_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/job_list_events_params.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/job_list_events_params.py --strict
```

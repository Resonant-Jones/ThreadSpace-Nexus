# 🧠 Mypy Fix Guide: `job_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/job_list_params.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/job_list_params.py --strict
```

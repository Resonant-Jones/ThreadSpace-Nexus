...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/fine_tuning/jobs/jobs.py`
**Lines:** `914`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/fine_tuning/jobs/jobs.py --strict
```

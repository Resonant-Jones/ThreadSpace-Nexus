...
**File:** `.venv/lib/python3.13/site-packages/chardet/johabfreq.py`
**Lines:** `2382`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/johabfreq.py --strict
```

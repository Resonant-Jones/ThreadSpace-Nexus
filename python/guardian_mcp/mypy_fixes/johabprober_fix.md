...
**File:** `.venv/lib/python3.13/site-packages/chardet/johabprober.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/johabprober.py --strict
```

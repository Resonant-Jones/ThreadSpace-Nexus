...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/joint.py`
**Lines:** `2188`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/joint.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/joint_rv.py`
**Lines:** `426`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/joint_rv.py --strict
```

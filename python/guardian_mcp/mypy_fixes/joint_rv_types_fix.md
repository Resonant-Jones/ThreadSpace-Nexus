# 🧠 Mypy Fix Guide: `joint_rv_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/joint_rv_types.py`
**Lines:** `945`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/joint_rv_types.py --strict
```

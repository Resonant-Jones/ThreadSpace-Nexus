# 🧠 Mypy Fix Guide: `jointsmethod.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/jointsmethod.py`
**Lines:** `318`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/jointsmethod.py --strict
```

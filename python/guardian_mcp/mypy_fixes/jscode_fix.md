...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/jscode.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/jscode.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/jslt.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/jslt.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/json5.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/json5.py --strict
```

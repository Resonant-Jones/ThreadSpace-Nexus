...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/json.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/json.py --strict
```

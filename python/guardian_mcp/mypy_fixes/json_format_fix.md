...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/json_format.py`
**Lines:** `1069`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/json_format.py --strict
```

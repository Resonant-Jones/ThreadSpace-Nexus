# 🧠 Mypy Fix Guide: `json_schema_test_suite.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/json_schema_test_suite.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/json_schema_test_suite.py --strict
```

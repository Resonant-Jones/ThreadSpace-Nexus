# 🧠 Mypy Fix Guide: `json_validation_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/json_validation_rule.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/json_validation_rule.py --strict
```

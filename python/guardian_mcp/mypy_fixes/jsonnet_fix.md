...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/jsonnet.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/jsonnet.py --strict
```

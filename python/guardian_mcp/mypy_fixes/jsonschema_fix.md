...
**File:** `.venv/lib/python3.13/site-packages/referencing/jsonschema.py`
**Lines:** `642`
...
```bash
mypy .venv/lib/python3.13/site-packages/referencing/jsonschema.py --strict
```

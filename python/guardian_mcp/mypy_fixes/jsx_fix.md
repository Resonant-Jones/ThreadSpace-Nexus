...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/jsx.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/jsx.py --strict
```

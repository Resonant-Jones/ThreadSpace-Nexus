...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/julia.py`
**Lines:** `652`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/julia.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/jvm.py`
**Lines:** `1802`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/jvm.py --strict
```

# 🧠 Mypy Fix Guide: `jwt_display_template.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/html_forms/jwt_display_template.py`
**Lines:** `284`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/html_forms/jwt_display_template.py --strict
```

# 🧠 Mypy Fix Guide: `k8s_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/k8s_attributes.py`
**Lines:** `366`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/k8s_attributes.py --strict
```

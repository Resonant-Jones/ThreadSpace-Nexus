...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/kane.py`
**Lines:** `859`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/kane.py --strict
```

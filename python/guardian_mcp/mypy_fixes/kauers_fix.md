...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/kauers.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/kauers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/kbkdf.py`
**Lines:** `305`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/kbkdf.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/keras_mixin.py`
**Lines:** `500`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/keras_mixin.py --strict
```

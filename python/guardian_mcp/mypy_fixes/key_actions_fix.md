...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/key_actions.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/key_actions.py --strict
```

# 🧠 Mypy Fix Guide: `key_created_email.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/email_templates/key_created_email.py`
**Lines:** `212`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/email_templates/key_created_email.py --strict
```

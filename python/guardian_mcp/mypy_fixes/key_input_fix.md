...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/key_input.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/key_input.py --strict
```

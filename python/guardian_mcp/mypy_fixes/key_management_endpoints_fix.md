# 🧠 Mypy Fix Guide: `key_management_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/key_management_endpoints.py`
**Lines:** `2931`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/key_management_endpoints.py --strict
```

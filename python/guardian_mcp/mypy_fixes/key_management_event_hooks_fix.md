# 🧠 Mypy Fix Guide: `key_management_event_hooks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/key_management_event_hooks.py`
**Lines:** `377`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/key_management_event_hooks.py --strict
```

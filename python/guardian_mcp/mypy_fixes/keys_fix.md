...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/keys.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/keys.py --strict
```

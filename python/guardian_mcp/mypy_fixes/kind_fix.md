...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/kind.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/kind.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/cluster/kmeans.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/cluster/kmeans.py --strict
```

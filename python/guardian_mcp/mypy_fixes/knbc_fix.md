...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/knbc.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/knbc.py --strict
```

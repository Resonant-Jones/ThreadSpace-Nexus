...
**File:** `.venv/lib/python3.13/site-packages/trio/_subprocess_platform/kqueue.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_subprocess_platform/kqueue.py --strict
```

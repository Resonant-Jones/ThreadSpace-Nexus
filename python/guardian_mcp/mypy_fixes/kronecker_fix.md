...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/kronecker.py`
**Lines:** `434`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/kronecker.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/config/kube_config.py`
**Lines:** `901`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/config/kube_config.py --strict
```

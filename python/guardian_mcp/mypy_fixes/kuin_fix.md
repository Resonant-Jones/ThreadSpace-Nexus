...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/kuin.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/kuin.py --strict
```

# 🧠 Mypy Fix Guide: `label_model_grader_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/label_model_grader_param.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/label_model_grader_param.py --strict
```

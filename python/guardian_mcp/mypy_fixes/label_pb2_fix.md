...
**File:** `.venv/lib/python3.13/site-packages/google/api/label_pb2.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/label_pb2.py --strict
```

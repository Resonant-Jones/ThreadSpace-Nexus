...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/lago.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/lago.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/lagrange.py`
**Lines:** `512`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/lagrange.py --strict
```

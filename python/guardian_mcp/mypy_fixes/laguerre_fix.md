...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/laguerre.py`
**Lines:** `1675`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/laguerre.py --strict
```

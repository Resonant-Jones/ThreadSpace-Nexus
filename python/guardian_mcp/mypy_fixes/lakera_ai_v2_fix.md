# 🧠 Mypy Fix Guide: `lakera_ai_v2.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/guardrails/guardrail_hooks/lakera_ai_v2.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/guardrails/guardrail_hooks/lakera_ai_v2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/lambda.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/lambda.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/lambdarepr.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/lambdarepr.py --strict
```

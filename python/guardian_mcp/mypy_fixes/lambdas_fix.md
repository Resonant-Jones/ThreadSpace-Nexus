...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/lambdas.py`
**Lines:** `1440`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/lambdas.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/lambdify.py`
**Lines:** `1592`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/lambdify.py --strict
```

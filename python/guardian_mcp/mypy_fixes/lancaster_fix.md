...
**File:** `.venv/lib/python3.13/site-packages/nltk/stem/lancaster.py`
**Lines:** `342`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/stem/lancaster.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/lang_base.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/lang_base.py --strict
```

# 🧠 Mypy Fix Guide: `langbulgarianmodel.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/langbulgarianmodel.py`
**Lines:** `4649`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/langbulgarianmodel.py --strict
```

# 🧠 Mypy Fix Guide: `langfuse_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/vertex_ai_endpoints/langfuse_endpoints.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/vertex_ai_endpoints/langfuse_endpoints.py --strict
```

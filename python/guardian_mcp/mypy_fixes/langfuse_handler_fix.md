# 🧠 Mypy Fix Guide: `langfuse_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/langfuse/langfuse_handler.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/langfuse/langfuse_handler.py --strict
```

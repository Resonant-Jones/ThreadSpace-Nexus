# 🧠 Mypy Fix Guide: `langfuse_prompt_management.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/langfuse/langfuse_prompt_management.py`
**Lines:** `295`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/langfuse/langfuse_prompt_management.py --strict
```

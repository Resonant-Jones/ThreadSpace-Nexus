# 🧠 Mypy Fix Guide: `langgreekmodel.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/langgreekmodel.py`
**Lines:** `4397`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/langgreekmodel.py --strict
```

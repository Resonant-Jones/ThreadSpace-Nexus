# 🧠 Mypy Fix Guide: `langhebrewmodel.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/langhebrewmodel.py`
**Lines:** `4380`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/langhebrewmodel.py --strict
```

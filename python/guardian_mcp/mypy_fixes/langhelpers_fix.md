...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/langhelpers.py`
**Lines:** `2303`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/langhelpers.py --strict
```

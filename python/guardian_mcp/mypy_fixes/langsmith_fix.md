...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/langsmith.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/langsmith.py --strict
```

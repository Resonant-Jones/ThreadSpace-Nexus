# 🧠 Mypy Fix Guide: `langthaimodel.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/langthaimodel.py`
**Lines:** `4380`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/langthaimodel.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/langtrace.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/langtrace.py --strict
```

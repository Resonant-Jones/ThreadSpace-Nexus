# 🧠 Mypy Fix Guide: `langturkishmodel.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/langturkishmodel.py`
**Lines:** `4380`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/langturkishmodel.py --strict
```

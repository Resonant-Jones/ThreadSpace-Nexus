...
**File:** `.venv/lib/python3.13/site-packages/chardet/metadata/languages.py`
**Lines:** `352`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/metadata/languages.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/laplace.py`
**Lines:** `2377`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/laplace.py --strict
```

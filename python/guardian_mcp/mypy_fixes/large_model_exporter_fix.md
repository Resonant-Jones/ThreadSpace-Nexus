# 🧠 Mypy Fix Guide: `large_model_exporter.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/large_model_exporter.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/large_model_exporter.py --strict
```

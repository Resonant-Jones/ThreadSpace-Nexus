...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/lasso.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/lasso.py --strict
```

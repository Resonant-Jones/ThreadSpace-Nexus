...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converter_utils/docx/math/latex_dict.py`
**Lines:** `273`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converter_utils/docx/math/latex_dict.py --strict
```

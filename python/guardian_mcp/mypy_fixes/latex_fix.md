...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/latex.py`
**Lines:** `3318`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/latex.py --strict
```

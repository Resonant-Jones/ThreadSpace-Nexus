# 🧠 Mypy Fix Guide: `latex_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/lark/latex_parser.py`
**Lines:** `145`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/lark/latex_parser.py --strict
```

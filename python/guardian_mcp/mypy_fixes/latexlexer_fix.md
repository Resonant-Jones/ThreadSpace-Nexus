...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/_antlr/latexlexer.py`
**Lines:** `512`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/_antlr/latexlexer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/_antlr/latexparser.py`
**Lines:** `3652`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/_antlr/latexparser.py --strict
```

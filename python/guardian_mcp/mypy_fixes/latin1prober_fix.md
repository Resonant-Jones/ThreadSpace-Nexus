# 🧠 Mypy Fix Guide: `latin1prober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/latin1prober.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/latin1prober.py --strict
```

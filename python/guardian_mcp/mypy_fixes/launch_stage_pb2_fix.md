# 🧠 Mypy Fix Guide: `launch_stage_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/launch_stage_pb2.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/launch_stage_pb2.py --strict
```

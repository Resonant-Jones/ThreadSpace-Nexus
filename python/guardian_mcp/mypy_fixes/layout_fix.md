...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/layout.py`
**Lines:** `442`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/layout.py --strict
```

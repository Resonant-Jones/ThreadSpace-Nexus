...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/layouts.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/layouts.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/network/lazy_wheel.py`
**Lines:** `210`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/network/lazy_wheel.py --strict
```

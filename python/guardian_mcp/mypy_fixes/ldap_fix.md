...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ldap.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ldap.py --strict
```

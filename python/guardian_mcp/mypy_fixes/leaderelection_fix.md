# 🧠 Mypy Fix Guide: `leaderelection.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/leaderelection/leaderelection.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/leaderelection/leaderelection.py --strict
```

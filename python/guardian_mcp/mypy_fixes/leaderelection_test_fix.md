# 🧠 Mypy Fix Guide: `leaderelection_test.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/leaderelection/leaderelection_test.py`
**Lines:** `270`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/leaderelection/leaderelection_test.py --strict
```

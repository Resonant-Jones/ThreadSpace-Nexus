# 🧠 Mypy Fix Guide: `leaderelectionrecord.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/leaderelection/leaderelectionrecord.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/leaderelection/leaderelectionrecord.py --strict
```

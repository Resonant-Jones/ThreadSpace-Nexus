...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/lean.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/lean.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/least_busy.py`
**Lines:** `252`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/least_busy.py --strict
```

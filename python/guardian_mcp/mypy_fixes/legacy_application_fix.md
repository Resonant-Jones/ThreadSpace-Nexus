# 🧠 Mypy Fix Guide: `legacy_application.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/legacy_application.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/legacy_application.py --strict
```

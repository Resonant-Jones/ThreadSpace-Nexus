...
**File:** `.venv/lib/python3.13/site-packages/_pytest/legacypath.py`
**Lines:** `468`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/legacypath.py --strict
```

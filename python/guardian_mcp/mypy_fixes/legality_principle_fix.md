# 🧠 Mypy Fix Guide: `legality_principle.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/legality_principle.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/legality_principle.py --strict
```

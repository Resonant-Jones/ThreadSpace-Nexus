...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/legendre.py`
**Lines:** `1605`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/legendre.py --strict
```

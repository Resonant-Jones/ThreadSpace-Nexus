# 🧠 Mypy Fix Guide: `length_weight_time.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/systems/length_weight_time.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/systems/length_weight_time.py --strict
```

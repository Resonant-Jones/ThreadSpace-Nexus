...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/lexer.py`
**Lines:** `963`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/lexer.py --strict
```

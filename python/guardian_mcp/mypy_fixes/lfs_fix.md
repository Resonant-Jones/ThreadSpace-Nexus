...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/lfs.py`
**Lines:** `200`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/lfs.py --strict
```

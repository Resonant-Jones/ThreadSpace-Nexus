...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/lheading.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/lheading.py --strict
```

# 🧠 Mypy Fix Guide: `lib_interval.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/intervalmath/lib_interval.py`
**Lines:** `452`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/intervalmath/lib_interval.py --strict
```

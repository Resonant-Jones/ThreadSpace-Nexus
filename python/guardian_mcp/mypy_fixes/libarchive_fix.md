...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/libarchive.py`
**Lines:** `213`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/libarchive.py --strict
```

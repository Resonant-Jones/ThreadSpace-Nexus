...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/libelefun.py`
**Lines:** `1428`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/libelefun.py --strict
```

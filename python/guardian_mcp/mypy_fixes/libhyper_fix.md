...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/libhyper.py`
**Lines:** `1150`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/libhyper.py --strict
```

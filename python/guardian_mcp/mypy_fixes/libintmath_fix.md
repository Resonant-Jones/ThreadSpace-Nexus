...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/libintmath.py`
**Lines:** `584`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/libintmath.py --strict
```

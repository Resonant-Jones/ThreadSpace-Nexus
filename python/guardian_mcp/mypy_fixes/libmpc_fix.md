...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/libmpc.py`
**Lines:** `835`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/libmpc.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/libmpf.py`
**Lines:** `1414`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/libmpf.py --strict
```

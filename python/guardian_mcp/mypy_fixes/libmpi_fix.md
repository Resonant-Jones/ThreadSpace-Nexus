...
**File:** `.venv/lib/python3.13/site-packages/mpmath/libmp/libmpi.py`
**Lines:** `935`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/libmp/libmpi.py --strict
```

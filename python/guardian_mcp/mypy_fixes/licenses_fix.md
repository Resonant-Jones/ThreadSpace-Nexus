...
**File:** `.venv/lib/python3.13/site-packages/identify/vendor/licenses.py`
**Lines:** `6747`
...
```bash
mypy .venv/lib/python3.13/site-packages/identify/vendor/licenses.py --strict
```

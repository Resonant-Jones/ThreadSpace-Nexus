...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/lie_group.py`
**Lines:** `1096`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/lie_group.py --strict
```

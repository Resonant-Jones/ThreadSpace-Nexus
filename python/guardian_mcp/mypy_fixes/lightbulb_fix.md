...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/lightbulb.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/lightbulb.py --strict
```

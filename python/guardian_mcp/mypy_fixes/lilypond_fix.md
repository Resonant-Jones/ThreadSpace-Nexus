...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/lilypond.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/lilypond.py --strict
```

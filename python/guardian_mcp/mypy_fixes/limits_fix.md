...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/limits.py`
**Lines:** `394`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/limits.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/limitseq.py`
**Lines:** `257`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/limitseq.py --strict
```

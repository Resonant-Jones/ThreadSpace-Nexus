...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/lin.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/lin.py --strict
```

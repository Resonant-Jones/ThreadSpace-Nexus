...
**File:** `.venv/lib/python3.13/site-packages/mpmath/matrices/linalg.py`
**Lines:** `790`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/matrices/linalg.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/geometry/line.py`
**Lines:** `2877`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/geometry/line.py --strict
```

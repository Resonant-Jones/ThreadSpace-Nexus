...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/linearize.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/linearize.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/sem/linearlogic.py`
**Lines:** `481`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/sem/linearlogic.py --strict
```

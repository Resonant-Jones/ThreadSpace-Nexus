...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/link.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/link.py --strict
```

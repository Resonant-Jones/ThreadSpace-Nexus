...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/linkify.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/linkify.py --strict
```

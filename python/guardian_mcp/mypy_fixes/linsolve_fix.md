...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/linsolve.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/linsolve.py --strict
```

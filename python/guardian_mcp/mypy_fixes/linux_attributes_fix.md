# 🧠 Mypy Fix Guide: `linux_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/linux_attributes.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/linux_attributes.py --strict
```

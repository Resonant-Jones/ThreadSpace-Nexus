...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/lisp.py`
**Lines:** `3146`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/lisp.py --strict
```

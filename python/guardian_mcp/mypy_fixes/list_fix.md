...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/list.py`
**Lines:** `345`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/list.py --strict
```

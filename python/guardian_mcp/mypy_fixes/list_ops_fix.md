...
**File:** `.venv/lib/python3.13/site-packages/mypyc/lower/list_ops.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/lower/list_ops.py --strict
```

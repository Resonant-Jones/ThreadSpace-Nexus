# 🧠 Mypy Fix Guide: `litellm_logging.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/litellm_logging.py`
**Lines:** `4113`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/litellm_logging.py --strict
```

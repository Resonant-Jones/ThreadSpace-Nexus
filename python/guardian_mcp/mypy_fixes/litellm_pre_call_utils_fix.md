# 🧠 Mypy Fix Guide: `litellm_pre_call_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/litellm_pre_call_utils.py`
**Lines:** `966`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/litellm_pre_call_utils.py --strict
```

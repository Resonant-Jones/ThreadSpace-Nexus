...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/literal_ai.py`
**Lines:** `317`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/literal_ai.py --strict
```

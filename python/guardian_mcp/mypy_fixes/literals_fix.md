...
**File:** `.venv/lib/python3.13/site-packages/mypyc/codegen/literals.py`
**Lines:** `302`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/codegen/literals.py --strict
```

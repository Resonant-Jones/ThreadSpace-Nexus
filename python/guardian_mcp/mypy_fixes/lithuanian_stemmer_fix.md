# 🧠 Mypy Fix Guide: `lithuanian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/lithuanian_stemmer.py`
**Lines:** `469`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/lithuanian_stemmer.py --strict
```

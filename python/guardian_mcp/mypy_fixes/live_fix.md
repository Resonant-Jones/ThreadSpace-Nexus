...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/live.py`
**Lines:** `375`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/live.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/live_render.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/live_render.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/ll_builder.py`
**Lines:** `2438`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/ll_builder.py --strict
```

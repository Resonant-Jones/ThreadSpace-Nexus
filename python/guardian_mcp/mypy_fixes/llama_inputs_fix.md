# 🧠 Mypy Fix Guide: `llama_inputs.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/llama_inputs.py`
**Lines:** `504`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/llama_inputs.py --strict
```

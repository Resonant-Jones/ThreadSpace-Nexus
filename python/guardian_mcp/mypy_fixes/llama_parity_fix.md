# 🧠 Mypy Fix Guide: `llama_parity.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/llama_parity.py`
**Lines:** `342`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/llama_parity.py --strict
```

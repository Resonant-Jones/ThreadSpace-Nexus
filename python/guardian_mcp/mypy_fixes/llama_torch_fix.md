...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/llama_torch.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/llama_torch.py --strict
```

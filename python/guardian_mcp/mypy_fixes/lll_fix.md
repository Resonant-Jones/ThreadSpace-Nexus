...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/lll.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/lll.py --strict
```

# 🧠 Mypy Fix Guide: `llm_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llm_function.py`
**Lines:** `468`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llm_function.py --strict
```

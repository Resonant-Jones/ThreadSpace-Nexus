# 🧠 Mypy Fix Guide: `llm_passthrough_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/llm_passthrough_endpoints.py`
**Lines:** `1052`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/llm_passthrough_endpoints.py --strict
```

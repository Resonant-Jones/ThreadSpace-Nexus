# 🧠 Mypy Fix Guide: `llm_request_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_request_utils.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_request_utils.py --strict
```

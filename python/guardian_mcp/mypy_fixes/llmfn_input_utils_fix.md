# 🧠 Mypy Fix Guide: `llmfn_input_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_input_utils.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_input_utils.py --strict
```

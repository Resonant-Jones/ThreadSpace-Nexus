# 🧠 Mypy Fix Guide: `llmfn_inputs_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_inputs_source.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_inputs_source.py --strict
```

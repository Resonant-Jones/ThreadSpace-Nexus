# 🧠 Mypy Fix Guide: `llmfn_output_row.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_output_row.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_output_row.py --strict
```

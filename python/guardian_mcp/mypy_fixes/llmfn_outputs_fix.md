# 🧠 Mypy Fix Guide: `llmfn_outputs.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_outputs.py`
**Lines:** `250`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_outputs.py --strict
```

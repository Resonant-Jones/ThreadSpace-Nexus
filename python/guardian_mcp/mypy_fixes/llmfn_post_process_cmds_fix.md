# 🧠 Mypy Fix Guide: `llmfn_post_process_cmds.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_post_process_cmds.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_post_process_cmds.py --strict
```

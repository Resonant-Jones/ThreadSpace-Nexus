# 🧠 Mypy Fix Guide: `llmfn_post_process.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_post_process.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/llmfn_post_process.py --strict
```

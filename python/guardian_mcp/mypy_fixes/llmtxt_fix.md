...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/llmtxt.py`
**Lines:** `546`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/llmtxt.py --strict
```

# 🧠 Mypy Fix Guide: `load_config_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/load_config_utils.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/load_config_utils.py --strict
```

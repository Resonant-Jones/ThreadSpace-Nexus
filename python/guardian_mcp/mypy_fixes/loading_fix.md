...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/loading.py`
**Lines:** `1682`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/loading.py --strict
```

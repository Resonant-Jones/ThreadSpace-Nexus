...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/loads.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/loads.py --strict
```

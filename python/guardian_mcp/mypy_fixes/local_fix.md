...
**File:** `.venv/lib/python3.13/site-packages/piptools/repositories/local.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/piptools/repositories/local.py --strict
```

# 🧠 Mypy Fix Guide: `local_persistent_hnsw.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/local_persistent_hnsw.py`
**Lines:** `543`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/vector/local_persistent_hnsw.py --strict
```

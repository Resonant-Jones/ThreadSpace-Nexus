# 🧠 Mypy Fix Guide: `localization.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/_config/localization.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/_config/localization.py --strict
```

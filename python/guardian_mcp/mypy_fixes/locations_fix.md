...
**File:** `.venv/lib/python3.13/site-packages/piptools/locations.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/piptools/locations.py --strict
```

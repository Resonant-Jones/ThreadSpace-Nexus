# 🧠 Mypy Fix Guide: `locations_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/cloud/location/locations_pb2.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/cloud/location/locations_pb2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/distlib/locators.py`
**Lines:** `1295`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/distlib/locators.py --strict
```

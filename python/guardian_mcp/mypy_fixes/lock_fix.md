...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/lock.py`
**Lines:** `171`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/lock.py --strict
```

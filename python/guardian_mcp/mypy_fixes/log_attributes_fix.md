# 🧠 Mypy Fix Guide: `log_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/log_attributes.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/log_attributes.py --strict
```

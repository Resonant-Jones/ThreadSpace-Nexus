# 🧠 Mypy Fix Guide: `log_db_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/log_db_metrics.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/log_db_metrics.py --strict
```

# 🧠 Mypy Fix Guide: `log_severity_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/logging/type/log_severity_pb2.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/logging/type/log_severity_pb2.py --strict
```

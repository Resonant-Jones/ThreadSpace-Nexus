# 🧠 Mypy Fix Guide: `logfire_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/logfire_logger.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/logfire_logger.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/logger.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/logger.py --strict
```

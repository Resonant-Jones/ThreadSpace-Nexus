# 🧠 Mypy Fix Guide: `logging_callback_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/logging_callback_manager.py`
**Lines:** `277`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/logging_callback_manager.py --strict
```

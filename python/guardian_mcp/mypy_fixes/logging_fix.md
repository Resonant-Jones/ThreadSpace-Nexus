...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/logging.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/logging.py --strict
```

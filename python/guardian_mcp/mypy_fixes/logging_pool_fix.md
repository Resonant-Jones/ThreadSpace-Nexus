# 🧠 Mypy Fix Guide: `logging_pool.py`
...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/foundation/logging_pool.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/foundation/logging_pool.py --strict
```

# 🧠 Mypy Fix Guide: `logging_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/logging_utils.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/logging_utils.py --strict
```

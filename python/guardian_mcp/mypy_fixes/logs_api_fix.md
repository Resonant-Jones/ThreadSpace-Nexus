...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/logs_api.py`
**Lines:** `244`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/logs_api.py --strict
```

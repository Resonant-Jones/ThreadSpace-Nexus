...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/logs/v1/logs_pb2.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/logs/v1/logs_pb2.py --strict
```

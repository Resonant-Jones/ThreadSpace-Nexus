# 🧠 Mypy Fix Guide: `logs_service_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/collector/logs/v1/logs_service_pb2.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/collector/logs/v1/logs_service_pb2.py --strict
```

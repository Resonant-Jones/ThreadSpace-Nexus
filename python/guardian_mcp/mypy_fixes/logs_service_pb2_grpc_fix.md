# 🧠 Mypy Fix Guide: `logs_service_pb2_grpc.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/collector/logs/v1/logs_service_pb2_grpc.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/collector/logs/v1/logs_service_pb2_grpc.py --strict
```

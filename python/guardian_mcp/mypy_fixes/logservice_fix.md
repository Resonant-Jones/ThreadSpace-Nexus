...
**File:** `.venv/lib/python3.13/site-packages/chromadb/logservice/logservice.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/logservice/logservice.py --strict
```

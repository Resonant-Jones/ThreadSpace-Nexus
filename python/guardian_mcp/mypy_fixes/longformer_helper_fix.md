# 🧠 Mypy Fix Guide: `longformer_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/longformer/longformer_helper.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/longformer/longformer_helper.py --strict
```

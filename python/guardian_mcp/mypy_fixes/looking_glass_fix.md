# 🧠 Mypy Fix Guide: `looking_glass.py`
...
**File:** `guardian/core/research/Modules/agent/looking_glass.py`
**Lines:** `200`
...
```bash
mypy guardian/core/research/Modules/agent/looking_glass.py --strict
```

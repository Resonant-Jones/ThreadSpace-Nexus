...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/lovelace.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/lovelace.py --strict
```

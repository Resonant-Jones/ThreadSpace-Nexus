...
**File:** `.venv/lib/python3.13/site-packages/mypyc/transform/lower.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/transform/lower.py --strict
```

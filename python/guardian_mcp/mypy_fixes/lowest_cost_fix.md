...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_cost.py`
**Lines:** `333`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_cost.py --strict
```

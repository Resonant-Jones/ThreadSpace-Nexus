# 🧠 Mypy Fix Guide: `lowest_latency.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_latency.py`
**Lines:** `590`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_latency.py --strict
```

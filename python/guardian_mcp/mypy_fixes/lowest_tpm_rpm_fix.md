# 🧠 Mypy Fix Guide: `lowest_tpm_rpm.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_tpm_rpm.py`
**Lines:** `247`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_tpm_rpm.py --strict
```

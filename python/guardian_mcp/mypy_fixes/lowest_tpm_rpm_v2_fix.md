# 🧠 Mypy Fix Guide: `lowest_tpm_rpm_v2.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_tpm_rpm_v2.py`
**Lines:** `670`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/lowest_tpm_rpm_v2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/lra_satask.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/lra_satask.py --strict
```

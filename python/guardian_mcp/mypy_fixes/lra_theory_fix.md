...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/algorithms/lra_theory.py`
**Lines:** `912`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/algorithms/lra_theory.py --strict
```

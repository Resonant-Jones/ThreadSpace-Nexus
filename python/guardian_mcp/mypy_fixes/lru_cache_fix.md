...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/lru_cache.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/lru_cache.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/lstm.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/lstm.py --strict
```

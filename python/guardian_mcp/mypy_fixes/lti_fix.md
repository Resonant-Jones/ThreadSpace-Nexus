...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/control/lti.py`
**Lines:** `5001`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/control/lti.py --strict
```

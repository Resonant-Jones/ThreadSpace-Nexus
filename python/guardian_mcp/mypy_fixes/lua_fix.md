...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/lua.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/lua.py --strict
```

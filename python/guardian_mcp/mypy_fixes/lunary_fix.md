...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/lunary.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/lunary.py --strict
```

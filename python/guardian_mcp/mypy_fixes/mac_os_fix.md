...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/cpython/mac_os.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/cpython/mac_os.py --strict
```

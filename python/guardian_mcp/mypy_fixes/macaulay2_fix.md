...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/macaulay2.py`
**Lines:** `1814`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/macaulay2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/inference/mace.py`
**Lines:** `383`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/inference/mace.py --strict
```

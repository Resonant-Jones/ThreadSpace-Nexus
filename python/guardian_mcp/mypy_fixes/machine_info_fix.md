# 🧠 Mypy Fix Guide: `machine_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/machine_info.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/machine_info.py --strict
```

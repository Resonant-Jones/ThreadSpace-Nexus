...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/platformdirs/macos.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/platformdirs/macos.py --strict
```

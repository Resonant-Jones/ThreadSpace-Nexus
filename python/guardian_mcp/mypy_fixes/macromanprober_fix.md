# 🧠 Mypy Fix Guide: `macromanprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/macromanprober.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/macromanprober.py --strict
```

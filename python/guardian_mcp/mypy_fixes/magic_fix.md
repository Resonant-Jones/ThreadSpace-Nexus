...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/magic.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/magic.py --strict
```

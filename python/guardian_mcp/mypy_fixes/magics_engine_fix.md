# 🧠 Mypy Fix Guide: `magics_engine.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/magics_engine.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/magics_engine.py --strict
```

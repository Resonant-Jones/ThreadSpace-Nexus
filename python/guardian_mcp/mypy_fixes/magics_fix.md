...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/magics.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/magics.py --strict
```

# 🧠 Mypy Fix Guide: `magika_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/cli/magika_client.py`
**Lines:** `344`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/cli/magika_client.py --strict
```

# 🧠 Mypy Fix Guide: `magika_error.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/magika_error.py`
**Lines:** `2`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/magika_error.py --strict
```

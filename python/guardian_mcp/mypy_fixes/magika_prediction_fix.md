# 🧠 Mypy Fix Guide: `magika_prediction.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/magika_prediction.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/magika_prediction.py --strict
```

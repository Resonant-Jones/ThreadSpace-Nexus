# 🧠 Mypy Fix Guide: `magika_result.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/magika_result.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/magika_result.py --strict
```

# 🧠 Mypy Fix Guide: `magika_rust_client_not_found_warning.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/cli/magika_rust_client_not_found_warning.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/cli/magika_rust_client_not_found_warning.py --strict
```

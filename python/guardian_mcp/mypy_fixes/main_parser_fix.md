...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/main_parser.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/main_parser.py --strict
```

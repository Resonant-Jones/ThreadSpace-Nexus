# 🧠 Mypy Fix Guide: `make_dynamic_shape_fixed.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/make_dynamic_shape_fixed.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/make_dynamic_shape_fixed.py --strict
```

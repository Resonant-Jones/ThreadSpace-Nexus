...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/make.py`
**Lines:** `212`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/make.py --strict
```

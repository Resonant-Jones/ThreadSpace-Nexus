...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/packages/backports/makefile.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/packages/backports/makefile.py --strict
```

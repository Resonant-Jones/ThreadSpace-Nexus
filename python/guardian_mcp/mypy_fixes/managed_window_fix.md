# 🧠 Mypy Fix Guide: `managed_window.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/managed_window.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/managed_window.py --strict
```

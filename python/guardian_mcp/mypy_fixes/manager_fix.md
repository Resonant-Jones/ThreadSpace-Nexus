...
**File:** `.venv/lib/python3.13/site-packages/flake8/options/manager.py`
**Lines:** `320`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/options/manager.py --strict
```

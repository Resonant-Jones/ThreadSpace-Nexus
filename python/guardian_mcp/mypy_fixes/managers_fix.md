...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/internals/managers.py`
**Lines:** `2375`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/internals/managers.py --strict
```

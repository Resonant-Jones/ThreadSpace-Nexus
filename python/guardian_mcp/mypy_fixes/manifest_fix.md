...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/distlib/manifest.py`
**Lines:** `384`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/distlib/manifest.py --strict
```

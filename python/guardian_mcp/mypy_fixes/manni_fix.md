...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/manni.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/manni.py --strict
```

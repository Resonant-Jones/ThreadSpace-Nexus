# 🧠 Mypy Fix Guide: `manualintegrate.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/manualintegrate.py`
**Lines:** `2174`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/manualintegrate.py --strict
```

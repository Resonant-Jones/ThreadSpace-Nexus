...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/maple.py`
**Lines:** `311`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/maple.py --strict
```

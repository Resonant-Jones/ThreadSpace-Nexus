# 🧠 Mypy Fix Guide: `mapped_collection.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/mapped_collection.py`
**Lines:** `557`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/mapped_collection.py --strict
```

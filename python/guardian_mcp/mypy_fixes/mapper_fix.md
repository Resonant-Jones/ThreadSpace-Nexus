...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/mapper.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/mapper.py --strict
```

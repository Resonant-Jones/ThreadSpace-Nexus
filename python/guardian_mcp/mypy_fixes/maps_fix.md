...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/collections/maps.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/collections/maps.py --strict
```

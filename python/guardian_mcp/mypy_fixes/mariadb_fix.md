...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mariadb.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mariadb.py --strict
```

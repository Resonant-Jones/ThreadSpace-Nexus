# 🧠 Mypy Fix Guide: `mariadbconnector.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mariadbconnector.py`
**Lines:** `277`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mariadbconnector.py --strict
```

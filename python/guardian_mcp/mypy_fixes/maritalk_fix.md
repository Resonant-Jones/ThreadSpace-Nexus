...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/maritalk.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/maritalk.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/markdown.py`
**Lines:** `344`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/markdown.py --strict
```

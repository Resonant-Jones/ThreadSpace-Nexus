# 🧠 Mypy Fix Guide: `markdown_generation_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/markdown_generation_strategy.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/markdown_generation_strategy.py --strict
```

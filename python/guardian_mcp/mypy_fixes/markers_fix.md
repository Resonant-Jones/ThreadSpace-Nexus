...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/markers.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/markers.py --strict
```

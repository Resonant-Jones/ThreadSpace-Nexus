...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/markup.py`
**Lines:** `1654`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/markup.py --strict
```

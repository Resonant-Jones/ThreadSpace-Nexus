...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/marshal.py`
**Lines:** `297`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/marshal.py --strict
```

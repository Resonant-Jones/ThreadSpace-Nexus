# 🧠 Mypy Fix Guide: `mask_decoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/mask_decoder.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/mask_decoder.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/ops/mask_ops.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/ops/mask_ops.py --strict
```

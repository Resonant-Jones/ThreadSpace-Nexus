# 🧠 Mypy Fix Guide: `masked_accumulations.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/masked_accumulations.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/masked_accumulations.py --strict
```

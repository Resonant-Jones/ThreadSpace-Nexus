...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/masked.py`
**Lines:** `1669`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/masked.py --strict
```

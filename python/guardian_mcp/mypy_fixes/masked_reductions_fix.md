# 🧠 Mypy Fix Guide: `masked_reductions.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/masked_reductions.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/masked_reductions.py --strict
```

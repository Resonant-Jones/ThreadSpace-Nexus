# 🧠 Mypy Fix Guide: `mass_spring_damper.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/mass_spring_damper.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/mass_spring_damper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/matadd.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/matadd.py --strict
```

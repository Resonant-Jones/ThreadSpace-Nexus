...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/match.py`
**Lines:** `362`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/match.py --strict
```

# 🧠 Mypy Fix Guide: `matchpy_connector.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/matchpy_connector.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/matchpy_connector.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/material.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/material.py --strict
```

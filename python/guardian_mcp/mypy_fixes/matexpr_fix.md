...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/matexpr.py`
**Lines:** `888`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/matexpr.py --strict
```

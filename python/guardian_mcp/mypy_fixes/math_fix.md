...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/math.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/math.py --strict
```

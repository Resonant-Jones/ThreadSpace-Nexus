...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/mathematica.py`
**Lines:** `1085`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/mathematica.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/mathml.py`
**Lines:** `2157`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/mathml.py --strict
```

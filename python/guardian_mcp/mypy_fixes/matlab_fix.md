...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/matlab.py`
**Lines:** `3307`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/matlab.py --strict
```

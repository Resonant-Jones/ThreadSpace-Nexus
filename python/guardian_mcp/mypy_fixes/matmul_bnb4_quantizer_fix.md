# 🧠 Mypy Fix Guide: `matmul_bnb4_quantizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/matmul_bnb4_quantizer.py`
**Lines:** `239`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/matmul_bnb4_quantizer.py --strict
```

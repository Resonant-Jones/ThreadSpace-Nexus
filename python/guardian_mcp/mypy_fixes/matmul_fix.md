...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/matmul.py`
**Lines:** `496`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/matmul.py --strict
```

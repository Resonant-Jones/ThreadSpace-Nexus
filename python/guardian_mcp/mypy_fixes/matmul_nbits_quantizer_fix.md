# 🧠 Mypy Fix Guide: `matmul_nbits_quantizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/matmul_nbits_quantizer.py`
**Lines:** `1536`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/matmul_nbits_quantizer.py --strict
```

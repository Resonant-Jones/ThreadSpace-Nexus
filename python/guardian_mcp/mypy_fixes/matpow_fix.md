...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/matpow.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/matpow.py --strict
```

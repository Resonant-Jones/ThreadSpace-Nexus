...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/handlers/matrices.py`
**Lines:** `716`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/handlers/matrices.py --strict
```

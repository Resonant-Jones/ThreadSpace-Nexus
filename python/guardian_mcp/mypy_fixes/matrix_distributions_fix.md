# 🧠 Mypy Fix Guide: `matrix_distributions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/matrix_distributions.py`
**Lines:** `610`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/matrix_distributions.py --strict
```

# 🧠 Mypy Fix Guide: `matrix_nodes.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/matrix_nodes.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/matrix_nodes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/matrixbase.py`
**Lines:** `5428`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/matrixbase.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/matrixcache.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/matrixcache.py --strict
```

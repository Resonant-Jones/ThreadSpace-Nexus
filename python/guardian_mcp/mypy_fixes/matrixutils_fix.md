...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/matrixutils.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/matrixutils.py --strict
```

# 🧠 Mypy Fix Guide: `max_budget_limiter.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/max_budget_limiter.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/max_budget_limiter.py --strict
```

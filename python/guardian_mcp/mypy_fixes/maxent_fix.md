...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/maxent.py`
**Lines:** `1631`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/maxent.py --strict
```

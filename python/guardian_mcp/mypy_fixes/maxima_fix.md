...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/maxima.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/maxima.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/maxpool.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/maxpool.py --strict
```

# 🧠 Mypy Fix Guide: `mbcharsetprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/mbcharsetprober.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/mbcharsetprober.py --strict
```

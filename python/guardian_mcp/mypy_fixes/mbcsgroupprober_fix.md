# 🧠 Mypy Fix Guide: `mbcsgroupprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/mbcsgroupprober.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/mbcsgroupprober.py --strict
```

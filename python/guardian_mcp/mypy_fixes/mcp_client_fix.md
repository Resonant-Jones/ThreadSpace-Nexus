...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/mcp_client.py`
**Lines:** `336`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/mcp_client.py --strict
```

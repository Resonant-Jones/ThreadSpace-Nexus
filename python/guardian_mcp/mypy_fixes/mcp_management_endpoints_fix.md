# 🧠 Mypy Fix Guide: `mcp_management_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/mcp_management_endpoints.py`
**Lines:** `351`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/mcp_management_endpoints.py --strict
```

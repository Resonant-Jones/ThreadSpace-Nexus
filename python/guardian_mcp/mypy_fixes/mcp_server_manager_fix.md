# 🧠 Mypy Fix Guide: `mcp_server_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/mcp_server/mcp_server_manager.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/mcp_server/mcp_server_manager.py --strict
```

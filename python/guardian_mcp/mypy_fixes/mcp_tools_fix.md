...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/mcp_tools.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/mcp_tools.py --strict
```

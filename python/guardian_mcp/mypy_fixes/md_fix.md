...
**File:** `.venv/lib/python3.13/site-packages/charset_normalizer/md.py`
**Lines:** `635`
...
```bash
mypy .venv/lib/python3.13/site-packages/charset_normalizer/md.py --strict
```

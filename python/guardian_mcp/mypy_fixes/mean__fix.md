...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/mean_.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/mean_.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/measure.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/measure.py --strict
```

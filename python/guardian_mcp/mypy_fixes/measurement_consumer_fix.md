# 🧠 Mypy Fix Guide: `measurement_consumer.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/measurement_consumer.py`
**Lines:** `145`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/measurement_consumer.py --strict
```

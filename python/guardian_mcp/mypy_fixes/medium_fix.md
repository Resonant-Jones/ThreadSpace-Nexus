...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/optics/medium.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/optics/medium.py --strict
```

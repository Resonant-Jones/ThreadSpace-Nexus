...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/megam.py`
**Lines:** `184`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/megam.py --strict
```

# 🧠 Mypy Fix Guide: `meijerint_doc.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/meijerint_doc.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/meijerint_doc.py --strict
```

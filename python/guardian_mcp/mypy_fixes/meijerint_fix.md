...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/meijerint.py`
**Lines:** `2191`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/meijerint.py --strict
```

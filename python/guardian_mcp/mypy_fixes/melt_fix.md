...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/reshape/melt.py`
**Lines:** `512`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/reshape/melt.py --strict
```

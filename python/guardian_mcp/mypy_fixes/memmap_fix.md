...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/memmap.py`
**Lines:** `363`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/memmap.py --strict
```

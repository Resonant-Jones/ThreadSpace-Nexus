...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/memoization.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/memoization.py --strict
```

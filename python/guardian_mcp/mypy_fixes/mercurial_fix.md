...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/vcs/mercurial.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/vcs/mercurial.py --strict
```

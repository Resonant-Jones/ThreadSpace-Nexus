...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/reshape/merge.py`
**Lines:** `2761`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/reshape/merge.py --strict
```

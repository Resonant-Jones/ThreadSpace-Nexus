...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/mergecheck.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/mergecheck.py --strict
```

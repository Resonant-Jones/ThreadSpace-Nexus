...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/meson.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/meson.py --strict
```

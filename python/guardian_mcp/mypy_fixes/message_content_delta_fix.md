# 🧠 Mypy Fix Guide: `message_content_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_content_delta.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_content_delta.py --strict
```

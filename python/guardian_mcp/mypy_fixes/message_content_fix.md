# 🧠 Mypy Fix Guide: `message_content.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_content.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_content.py --strict
```

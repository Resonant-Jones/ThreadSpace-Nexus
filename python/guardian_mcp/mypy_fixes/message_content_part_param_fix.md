# 🧠 Mypy Fix Guide: `message_content_part_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_content_part_param.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_content_part_param.py --strict
```

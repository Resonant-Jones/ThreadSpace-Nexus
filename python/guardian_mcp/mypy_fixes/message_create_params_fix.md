# 🧠 Mypy Fix Guide: `message_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_create_params.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_create_params.py --strict
```

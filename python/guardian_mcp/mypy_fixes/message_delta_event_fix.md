# 🧠 Mypy Fix Guide: `message_delta_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_delta_event.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_delta_event.py --strict
```

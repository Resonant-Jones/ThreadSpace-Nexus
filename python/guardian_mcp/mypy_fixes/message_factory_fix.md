# 🧠 Mypy Fix Guide: `message_factory.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/message_factory.py`
**Lines:** `237`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/message_factory.py --strict
```

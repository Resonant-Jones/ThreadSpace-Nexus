...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/message.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/message.py --strict
```

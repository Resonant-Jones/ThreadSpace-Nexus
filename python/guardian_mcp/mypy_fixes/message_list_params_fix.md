# 🧠 Mypy Fix Guide: `message_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_list_params.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_list_params.py --strict
```

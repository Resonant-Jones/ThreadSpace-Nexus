# 🧠 Mypy Fix Guide: `message_listener.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/message_listener.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/message_listener.py --strict
```

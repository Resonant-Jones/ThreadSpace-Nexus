# 🧠 Mypy Fix Guide: `message_logger.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/middleware/message_logger.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/middleware/message_logger.py --strict
```

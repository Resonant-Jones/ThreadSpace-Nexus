# 🧠 Mypy Fix Guide: `message_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/message_registry.py`
**Lines:** `367`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/message_registry.py --strict
```

# 🧠 Mypy Fix Guide: `message_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/message_update_params.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/message_update_params.py --strict
```

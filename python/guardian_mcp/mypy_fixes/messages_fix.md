...
**File:** `.venv/lib/python3.13/site-packages/websockets/asyncio/messages.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/asyncio/messages.py --strict
```

# 🧠 Mypy Fix Guide: `messaging_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/messaging_attributes.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/messaging_attributes.py --strict
```

# 🧠 Mypy Fix Guide: `messaging_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/messaging_metrics.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/messaging_metrics.py --strict
```

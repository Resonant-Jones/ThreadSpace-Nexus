# 🧠 Mypy Fix Guide: `meteor_score.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/meteor_score.py`
**Lines:** `409`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/meteor_score.py --strict
```

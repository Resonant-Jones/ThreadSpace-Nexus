# 🧠 Mypy Fix Guide: `method_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/gapic_v1/method_async.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/gapic_v1/method_async.py --strict
```

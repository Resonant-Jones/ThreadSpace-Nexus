...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/method.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/method.py --strict
```

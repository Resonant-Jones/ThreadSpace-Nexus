...
**File:** `.venv/lib/python3.13/site-packages/google/api/metric_pb2.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/metric_pb2.py --strict
```

# 🧠 Mypy Fix Guide: `metric_reader_storage.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/metric_reader_storage.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/metric_reader_storage.py --strict
```

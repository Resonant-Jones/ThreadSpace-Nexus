...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/metrics.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/metrics.py --strict
```

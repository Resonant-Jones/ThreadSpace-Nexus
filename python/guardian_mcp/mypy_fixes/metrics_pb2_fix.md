...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/metrics/v1/metrics_pb2.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/metrics/v1/metrics_pb2.py --strict
```

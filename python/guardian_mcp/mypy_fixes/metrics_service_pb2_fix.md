# 🧠 Mypy Fix Guide: `metrics_service_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/collector/metrics/v1/metrics_service_pb2.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/collector/metrics/v1/metrics_service_pb2.py --strict
```

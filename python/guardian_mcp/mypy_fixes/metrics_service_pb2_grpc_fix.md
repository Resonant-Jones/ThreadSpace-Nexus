# 🧠 Mypy Fix Guide: `metrics_service_pb2_grpc.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/collector/metrics/v1/metrics_service_pb2_grpc.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/collector/metrics/v1/metrics_service_pb2_grpc.py --strict
```

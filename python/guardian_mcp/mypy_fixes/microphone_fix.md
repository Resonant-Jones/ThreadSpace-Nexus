...
**File:** `.venv/lib/python3.13/site-packages/openai/helpers/microphone.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/helpers/microphone.py --strict
```

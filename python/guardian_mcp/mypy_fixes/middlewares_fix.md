...
**File:** `.venv/lib/python3.13/site-packages/blackd/middlewares.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/blackd/middlewares.py --strict
```

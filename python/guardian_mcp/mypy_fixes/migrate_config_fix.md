# 🧠 Mypy Fix Guide: `migrate_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/migrate_config.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/migrate_config.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/cli/_tools/migrate.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/cli/_tools/migrate.py --strict
```

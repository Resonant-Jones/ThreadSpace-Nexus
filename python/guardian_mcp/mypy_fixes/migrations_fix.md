...
**File:** `.venv/lib/python3.13/site-packages/chromadb/db/migrations.py`
**Lines:** `276`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/db/migrations.py --strict
```

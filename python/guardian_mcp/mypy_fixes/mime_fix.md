...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/mime.py`
**Lines:** `210`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/mime.py --strict
```

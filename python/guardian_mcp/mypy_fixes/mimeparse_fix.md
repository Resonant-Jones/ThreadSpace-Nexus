...
**File:** `.venv/lib/python3.13/site-packages/googleapiclient/mimeparse.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/googleapiclient/mimeparse.py --strict
```

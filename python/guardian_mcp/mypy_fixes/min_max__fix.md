...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/min_max_.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/min_max_.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/minecraft.py`
**Lines:** `391`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/minecraft.py --strict
```

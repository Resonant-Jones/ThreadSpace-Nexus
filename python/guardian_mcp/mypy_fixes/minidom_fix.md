...
**File:** `.venv/lib/python3.13/site-packages/defusedxml/minidom.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/defusedxml/minidom.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/misc/minimalset.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/misc/minimalset.py --strict
```

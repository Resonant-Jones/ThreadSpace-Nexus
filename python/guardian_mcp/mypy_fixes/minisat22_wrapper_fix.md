# 🧠 Mypy Fix Guide: `minisat22_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/algorithms/minisat22_wrapper.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/algorithms/minisat22_wrapper.py --strict
```

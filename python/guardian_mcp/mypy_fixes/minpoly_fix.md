...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/minpoly.py`
**Lines:** `882`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/minpoly.py --strict
```

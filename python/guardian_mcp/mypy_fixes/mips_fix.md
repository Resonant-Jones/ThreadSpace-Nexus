...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/mips.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/mips.py --strict
```

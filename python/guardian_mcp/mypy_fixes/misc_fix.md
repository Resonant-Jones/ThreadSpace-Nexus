...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/misc.py`
**Lines:** `564`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/misc.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/lower/misc_ops.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/lower/misc_ops.py --strict
```

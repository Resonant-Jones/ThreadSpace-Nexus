# 🧠 Mypy Fix Guide: `miscellaneous.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/miscellaneous.py`
**Lines:** `915`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/miscellaneous.py --strict
```

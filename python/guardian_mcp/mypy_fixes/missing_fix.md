...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/ops/missing.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/ops/missing.py --strict
```

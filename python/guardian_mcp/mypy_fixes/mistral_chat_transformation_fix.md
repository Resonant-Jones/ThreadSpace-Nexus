# 🧠 Mypy Fix Guide: `mistral_chat_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/mistral/mistral_chat_transformation.py`
**Lines:** `238`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/mistral/mistral_chat_transformation.py --strict
```

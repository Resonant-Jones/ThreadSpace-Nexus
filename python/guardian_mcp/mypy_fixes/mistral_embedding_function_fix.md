# 🧠 Mypy Fix Guide: `mistral_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/mistral_embedding_function.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/mistral_embedding_function.py --strict
```

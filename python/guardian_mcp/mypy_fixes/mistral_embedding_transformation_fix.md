# 🧠 Mypy Fix Guide: `mistral_embedding_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/mistral/mistral_embedding_transformation.py`
**Lines:** `0`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/mistral/mistral_embedding_transformation.py --strict
```

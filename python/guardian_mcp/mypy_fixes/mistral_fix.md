...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/mistral.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/mistral.py --strict
```

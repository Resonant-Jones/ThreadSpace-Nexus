# 🧠 Mypy Fix Guide: `mixed_precision_overrides_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/mixed_precision_overrides_utils.py`
**Lines:** `413`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/mixed_precision_overrides_utils.py --strict
```

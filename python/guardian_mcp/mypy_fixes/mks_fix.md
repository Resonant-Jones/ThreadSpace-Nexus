...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/systems/mks.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/systems/mks.py --strict
```

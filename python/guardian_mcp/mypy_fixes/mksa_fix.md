...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/systems/mksa.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/systems/mksa.py --strict
```

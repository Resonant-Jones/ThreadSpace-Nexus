# 🧠 Mypy Fix Guide: `mobile_application.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/mobile_application.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/mobile_application.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/mobile.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/mobile.py --strict
```

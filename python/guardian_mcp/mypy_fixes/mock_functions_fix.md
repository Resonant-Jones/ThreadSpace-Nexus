# 🧠 Mypy Fix Guide: `mock_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/mock_functions.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/mock_functions.py --strict
```

# 🧠 Mypy Fix Guide: `model_checks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/model_checks.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/model_checks.py --strict
```

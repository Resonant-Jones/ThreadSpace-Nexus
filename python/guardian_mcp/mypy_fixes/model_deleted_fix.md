# 🧠 Mypy Fix Guide: `model_deleted.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/model_deleted.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/model_deleted.py --strict
```

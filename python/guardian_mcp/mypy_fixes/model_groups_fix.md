# 🧠 Mypy Fix Guide: `model_groups.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/client/model_groups.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/client/model_groups.py --strict
```

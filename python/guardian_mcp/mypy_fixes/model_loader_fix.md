# 🧠 Mypy Fix Guide: `model_loader.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/model_loader.py`
**Lines:** `296`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/model_loader.py --strict
```

# 🧠 Mypy Fix Guide: `model_management_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/model_management_endpoints.py`
**Lines:** `975`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/model_management_endpoints.py --strict
```

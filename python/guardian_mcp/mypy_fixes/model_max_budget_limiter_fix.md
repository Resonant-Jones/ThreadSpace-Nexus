# 🧠 Mypy Fix Guide: `model_max_budget_limiter.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/model_max_budget_limiter.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/model_max_budget_limiter.py --strict
```

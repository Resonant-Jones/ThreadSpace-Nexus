# 🧠 Mypy Fix Guide: `model_param_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/model_param_helper.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/model_param_helper.py --strict
```

# 🧠 Mypy Fix Guide: `model_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/model_registry.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/model_registry.py --strict
```

# 🧠 Mypy Fix Guide: `model_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/model_service.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/model_service.py --strict
```

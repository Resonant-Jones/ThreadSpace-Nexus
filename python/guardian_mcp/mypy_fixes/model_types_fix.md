...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/model_types.py`
**Lines:** `393`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/model_types.py --strict
```

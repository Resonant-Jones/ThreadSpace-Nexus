...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/modeline.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/modeline.py --strict
```

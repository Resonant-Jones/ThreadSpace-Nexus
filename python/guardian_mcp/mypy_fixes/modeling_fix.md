...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/modeling.py`
**Lines:** `366`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/modeling.py --strict
```

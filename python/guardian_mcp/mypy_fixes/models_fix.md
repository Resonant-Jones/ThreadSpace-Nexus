...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_websocket/models.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_websocket/models.py --strict
```

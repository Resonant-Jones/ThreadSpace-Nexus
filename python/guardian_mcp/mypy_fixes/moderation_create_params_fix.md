# 🧠 Mypy Fix Guide: `moderation_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation_create_params.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation_create_params.py --strict
```

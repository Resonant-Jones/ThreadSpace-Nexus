# 🧠 Mypy Fix Guide: `moderation_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation_create_response.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation_create_response.py --strict
```

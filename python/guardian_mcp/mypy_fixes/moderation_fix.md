...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation.py --strict
```

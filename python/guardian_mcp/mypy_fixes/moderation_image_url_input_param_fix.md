# 🧠 Mypy Fix Guide: `moderation_image_url_input_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation_image_url_input_param.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation_image_url_input_param.py --strict
```

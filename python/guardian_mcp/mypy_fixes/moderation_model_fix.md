# 🧠 Mypy Fix Guide: `moderation_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation_model.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation_model.py --strict
```

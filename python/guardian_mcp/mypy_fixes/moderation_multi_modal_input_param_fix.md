# 🧠 Mypy Fix Guide: `moderation_multi_modal_input_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation_multi_modal_input_param.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation_multi_modal_input_param.py --strict
```

# 🧠 Mypy Fix Guide: `moderation_text_input_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/moderation_text_input_param.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/moderation_text_input_param.py --strict
```

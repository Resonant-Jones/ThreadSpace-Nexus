...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/moderations.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/moderations.py --strict
```

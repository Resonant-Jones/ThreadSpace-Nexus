...
**File:** `.venv/lib/python3.13/site-packages/setuptools/modified.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/modified.py --strict
```

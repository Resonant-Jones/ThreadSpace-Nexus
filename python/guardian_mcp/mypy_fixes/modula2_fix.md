...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/modula2.py`
**Lines:** `1579`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/modula2.py --strict
```

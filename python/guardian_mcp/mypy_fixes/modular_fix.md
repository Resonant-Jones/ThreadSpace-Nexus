...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/modular.py`
**Lines:** `291`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/modular.py --strict
```

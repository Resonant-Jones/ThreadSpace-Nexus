...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/modulargcd.py`
**Lines:** `2278`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/modulargcd.py --strict
```

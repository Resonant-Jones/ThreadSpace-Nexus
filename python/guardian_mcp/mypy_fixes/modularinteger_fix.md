# 🧠 Mypy Fix Guide: `modularinteger.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/modularinteger.py`
**Lines:** `237`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/modularinteger.py --strict
```

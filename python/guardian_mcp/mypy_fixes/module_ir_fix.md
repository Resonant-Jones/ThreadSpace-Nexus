...
**File:** `.venv/lib/python3.13/site-packages/mypyc/ir/module_ir.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/ir/module_ir.py --strict
```

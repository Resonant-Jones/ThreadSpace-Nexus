# 🧠 Mypy Fix Guide: `module_with_deprecations.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/module_with_deprecations.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/module_with_deprecations.py --strict
```

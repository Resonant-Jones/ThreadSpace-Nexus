# 🧠 Mypy Fix Guide: `modulefinder.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/modulefinder.py`
**Lines:** `984`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/modulefinder.py --strict
```

# 🧠 Mypy Fix Guide: `moduleinspect.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/moduleinspect.py`
**Lines:** `184`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/moduleinspect.py --strict
```

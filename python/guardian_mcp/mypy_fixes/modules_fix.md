...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/agca/modules.py`
**Lines:** `1488`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/agca/modules.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/mojo.py`
**Lines:** `707`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/mojo.py --strict
```

# 🧠 Mypy Fix Guide: `monitored_resource_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/monitored_resource_pb2.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/monitored_resource_pb2.py --strict
```

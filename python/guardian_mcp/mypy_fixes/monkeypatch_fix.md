...
**File:** `.venv/lib/python3.13/site-packages/_pytest/monkeypatch.py`
**Lines:** `415`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/monkeypatch.py --strict
```

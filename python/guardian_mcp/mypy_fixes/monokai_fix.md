...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/monokai.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/monokai.py --strict
```

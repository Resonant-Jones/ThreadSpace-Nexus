...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/monomials.py`
**Lines:** `628`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/monomials.py --strict
```

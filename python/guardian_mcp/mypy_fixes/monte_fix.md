...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/monte.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/monte.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/more_itertools/more.py`
**Lines:** `4806`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/more_itertools/more.py --strict
```

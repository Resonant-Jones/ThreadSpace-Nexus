...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/mosel.py`
**Lines:** `447`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/mosel.py --strict
```

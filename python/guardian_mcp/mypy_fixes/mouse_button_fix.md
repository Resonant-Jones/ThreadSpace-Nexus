# 🧠 Mypy Fix Guide: `mouse_button.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/mouse_button.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/mouse_button.py --strict
```

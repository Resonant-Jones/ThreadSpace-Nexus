...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/mpelements.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/mpelements.py --strict
```

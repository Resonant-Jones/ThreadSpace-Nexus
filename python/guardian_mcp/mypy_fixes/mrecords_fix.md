...
**File:** `.venv/lib/python3.13/site-packages/numpy/ma/mrecords.py`
**Lines:** `773`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/ma/mrecords.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/compilers/C/msvc.py`
**Lines:** `614`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/compilers/C/msvc.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/mtls.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/mtls.py --strict
```

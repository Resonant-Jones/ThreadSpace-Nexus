...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/mul.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/mul.py --strict
```

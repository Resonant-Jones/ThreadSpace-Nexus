...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/multi.py`
**Lines:** `4176`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/multi.py --strict
```

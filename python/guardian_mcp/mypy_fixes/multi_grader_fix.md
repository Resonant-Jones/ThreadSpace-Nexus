# 🧠 Mypy Fix Guide: `multi_grader.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/multi_grader.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/multi_grader.py --strict
```

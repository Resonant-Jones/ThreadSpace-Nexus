# 🧠 Mypy Fix Guide: `multi_grader_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/multi_grader_param.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/multi_grader_param.py --strict
```

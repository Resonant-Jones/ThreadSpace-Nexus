...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/multiarray.py`
**Lines:** `1762`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/multiarray.py --strict
```

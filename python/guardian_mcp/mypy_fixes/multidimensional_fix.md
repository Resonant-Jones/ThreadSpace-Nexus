# 🧠 Mypy Fix Guide: `multidimensional.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/multidimensional.py`
**Lines:** `131`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/multidimensional.py --strict
```

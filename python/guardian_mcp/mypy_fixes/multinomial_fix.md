...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/multinomial.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/multinomial.py --strict
```

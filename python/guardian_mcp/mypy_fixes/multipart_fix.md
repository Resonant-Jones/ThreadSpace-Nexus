...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/multipart.py`
**Lines:** `1140`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/multipart.py --strict
```

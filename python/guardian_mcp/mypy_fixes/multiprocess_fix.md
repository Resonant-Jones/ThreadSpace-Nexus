# 🧠 Mypy Fix Guide: `multiprocess.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/supervisors/multiprocess.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/supervisors/multiprocess.py --strict
```

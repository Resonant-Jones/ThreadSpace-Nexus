# 🧠 Mypy Fix Guide: `multivariate_resultants.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/multivariate_resultants.py`
**Lines:** `473`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/multivariate_resultants.py --strict
```

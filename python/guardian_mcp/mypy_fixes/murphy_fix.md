...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/murphy.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/murphy.py --strict
```

# 🧠 Mypy Fix Guide: `musculotendon.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/biomechanics/musculotendon.py`
**Lines:** `1424`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/biomechanics/musculotendon.py --strict
```

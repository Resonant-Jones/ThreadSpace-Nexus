...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/mutable.py`
**Lines:** `1095`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/mutable.py --strict
```

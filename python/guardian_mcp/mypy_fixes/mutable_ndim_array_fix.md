# 🧠 Mypy Fix Guide: `mutable_ndim_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/mutable_ndim_array.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/mutable_ndim_array.py --strict
```

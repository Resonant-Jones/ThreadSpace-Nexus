# 🧠 Mypy Fix Guide: `mypy_annotate.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tools/mypy_annotate.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tools/mypy_annotate.py --strict
```

# 🧠 Mypy Fix Guide: `mysqlconnector.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mysqlconnector.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mysqlconnector.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mysqldb.py`
**Lines:** `305`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/mysqldb.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/app_data/na.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/app_data/na.py --strict
```

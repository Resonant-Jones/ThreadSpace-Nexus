...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/naivebayes.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/naivebayes.py --strict
```

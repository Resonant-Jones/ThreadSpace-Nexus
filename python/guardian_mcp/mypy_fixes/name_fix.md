...
**File:** `.venv/lib/python3.13/site-packages/cryptography/x509/name.py`
**Lines:** `477`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/x509/name.py --strict
```

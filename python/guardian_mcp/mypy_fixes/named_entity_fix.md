# 🧠 Mypy Fix Guide: `named_entity.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/chunk/named_entity.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/chunk/named_entity.py --strict
```

# 🧠 Mypy Fix Guide: `named_groups.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/named_groups.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/named_groups.py --strict
```

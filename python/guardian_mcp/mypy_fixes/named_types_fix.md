...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/named_types.py`
**Lines:** `538`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/named_types.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/type/namedtype.py`
**Lines:** `550`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/type/namedtype.py --strict
```

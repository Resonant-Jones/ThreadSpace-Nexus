...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/type/namedval.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/type/namedval.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/names.py`
**Lines:** `335`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/names.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/namespaces.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/namespaces.py --strict
```

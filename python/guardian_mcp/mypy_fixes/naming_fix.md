...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/naming.py`
**Lines:** `212`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/naming.py --strict
```

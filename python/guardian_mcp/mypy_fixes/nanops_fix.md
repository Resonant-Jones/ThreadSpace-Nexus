...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/nanops.py`
**Lines:** `1748`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/nanops.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/native.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/native.py --strict
```

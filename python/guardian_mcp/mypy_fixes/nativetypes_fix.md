...
**File:** `.venv/lib/python3.13/site-packages/jinja2/nativetypes.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/jinja2/nativetypes.py --strict
```

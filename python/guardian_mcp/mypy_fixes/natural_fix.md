...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/systems/natural.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/systems/natural.py --strict
```

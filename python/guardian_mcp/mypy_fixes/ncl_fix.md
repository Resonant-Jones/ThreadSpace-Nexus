...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ncl.py`
**Lines:** `894`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ncl.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/ndim_array.py`
**Lines:** `601`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/ndim_array.py --strict
```

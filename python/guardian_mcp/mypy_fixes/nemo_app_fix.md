...
**File:** `.venv/lib/python3.13/site-packages/nltk/app/nemo_app.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/app/nemo_app.py --strict
```

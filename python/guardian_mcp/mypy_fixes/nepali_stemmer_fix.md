# 🧠 Mypy Fix Guide: `nepali_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/nepali_stemmer.py`
**Lines:** `274`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/nepali_stemmer.py --strict
```

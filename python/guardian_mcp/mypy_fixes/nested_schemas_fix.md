# 🧠 Mypy Fix Guide: `nested_schemas.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/nested_schemas.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/nested_schemas.py --strict
```

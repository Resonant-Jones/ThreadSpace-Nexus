# 🧠 Mypy Fix Guide: `net_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/net_attributes.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/net_attributes.py --strict
```

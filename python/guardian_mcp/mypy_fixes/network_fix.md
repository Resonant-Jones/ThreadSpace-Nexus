...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/network.py`
**Lines:** `4284`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/network.py --strict
```

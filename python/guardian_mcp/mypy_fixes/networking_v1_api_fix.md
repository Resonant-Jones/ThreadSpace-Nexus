# 🧠 Mypy Fix Guide: `networking_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/networking_v1_api.py`
**Lines:** `6628`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/networking_v1_api.py --strict
```

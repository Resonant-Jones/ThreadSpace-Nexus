...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/networks.py`
**Lines:** `747`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/networks.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/nimrod.py`
**Lines:** `199`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/nimrod.py --strict
```

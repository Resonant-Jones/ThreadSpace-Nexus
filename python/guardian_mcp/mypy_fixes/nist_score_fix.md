...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/nist_score.py`
**Lines:** `195`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/nist_score.py --strict
```

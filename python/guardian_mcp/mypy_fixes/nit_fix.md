...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/nit.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/nit.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/nkjp.py`
**Lines:** `486`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/nkjp.py --strict
```

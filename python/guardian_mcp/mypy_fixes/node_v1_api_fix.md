...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/node_v1_api.py`
**Lines:** `1179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/node_v1_api.py --strict
```

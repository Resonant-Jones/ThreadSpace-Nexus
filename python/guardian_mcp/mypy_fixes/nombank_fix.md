...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/nombank.py`
**Lines:** `465`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/nombank.py --strict
```

# 🧠 Mypy Fix Guide: `non_min_pendulum.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/non_min_pendulum.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/pydy-example-repo/non_min_pendulum.py --strict
```

# 🧠 Mypy Fix Guide: `nonhomogeneous.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/nonhomogeneous.py`
**Lines:** `484`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/nonhomogeneous.py --strict
```

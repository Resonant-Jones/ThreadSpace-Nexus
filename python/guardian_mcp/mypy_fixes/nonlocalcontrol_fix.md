# 🧠 Mypy Fix Guide: `nonlocalcontrol.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/nonlocalcontrol.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/nonlocalcontrol.py --strict
```

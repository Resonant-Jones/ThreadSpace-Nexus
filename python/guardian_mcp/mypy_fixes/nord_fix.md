...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/nord.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/nord.py --strict
```

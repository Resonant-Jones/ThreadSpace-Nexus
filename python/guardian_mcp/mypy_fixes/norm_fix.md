...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/norm.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/norm.py --strict
```

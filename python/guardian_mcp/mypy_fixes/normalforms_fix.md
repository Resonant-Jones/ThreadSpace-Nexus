...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/normalforms.py`
**Lines:** `540`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/normalforms.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_core/normalize.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_core/normalize.py --strict
```

# 🧠 Mypy Fix Guide: `normalize_url.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/common/normalize_url.py`
**Lines:** `81`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/common/normalize_url.py --strict
```

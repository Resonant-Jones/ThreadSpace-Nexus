# 🧠 Mypy Fix Guide: `norwegian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/norwegian_stemmer.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/norwegian_stemmer.py --strict
```

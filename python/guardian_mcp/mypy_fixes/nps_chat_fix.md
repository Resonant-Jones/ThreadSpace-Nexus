...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/nps_chat.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/nps_chat.py --strict
```

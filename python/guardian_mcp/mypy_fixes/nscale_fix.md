...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/nscale.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_providers/nscale.py --strict
```

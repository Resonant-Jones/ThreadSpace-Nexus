...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/handlers/ntheory.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/handlers/ntheory.py --strict
```

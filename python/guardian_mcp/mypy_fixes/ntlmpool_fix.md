...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/ntlmpool.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/ntlmpool.py --strict
```

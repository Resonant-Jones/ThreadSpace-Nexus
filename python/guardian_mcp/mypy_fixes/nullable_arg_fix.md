# 🧠 Mypy Fix Guide: `nullable_arg.py`
...
**File:** `.venv/lib/python3.13/site-packages/pypika/clickhouse/nullable_arg.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/clickhouse/nullable_arg.py --strict
```

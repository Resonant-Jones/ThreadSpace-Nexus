...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/window/numba_.py`
**Lines:** `351`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/window/numba_.py --strict
```

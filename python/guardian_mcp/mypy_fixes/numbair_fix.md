...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/numbair.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/numbair.py --strict
```

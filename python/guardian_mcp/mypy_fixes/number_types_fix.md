# 🧠 Mypy Fix Guide: `number_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/flatbuffers/number_types.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/flatbuffers/number_types.py --strict
```

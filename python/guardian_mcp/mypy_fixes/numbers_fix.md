...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/combinatorial/numbers.py`
**Lines:** `3196`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/combinatorial/numbers.py --strict
```

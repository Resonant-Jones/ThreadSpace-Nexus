...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/numeric.py`
**Lines:** `2760`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/numeric.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/holonomic/numerical.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/holonomic/numerical.py --strict
```

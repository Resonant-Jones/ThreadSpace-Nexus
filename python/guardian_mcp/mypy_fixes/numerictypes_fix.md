# 🧠 Mypy Fix Guide: `numerictypes.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/numerictypes.py`
**Lines:** `633`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/numerictypes.py --strict
```

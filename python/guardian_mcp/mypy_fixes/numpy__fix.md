...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/numpy_.py`
**Lines:** `574`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/numpy_.py --strict
```

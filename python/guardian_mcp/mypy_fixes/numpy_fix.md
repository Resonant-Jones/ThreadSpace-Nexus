...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/numpy.py`
**Lines:** `541`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/numpy.py --strict
```

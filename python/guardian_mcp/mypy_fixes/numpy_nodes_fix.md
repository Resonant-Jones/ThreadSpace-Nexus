...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/numpy_nodes.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/numpy_nodes.py --strict
```

# 🧠 Mypy Fix Guide: `numpy_pickle_compat.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/numpy_pickle_compat.py`
**Lines:** `250`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/numpy_pickle_compat.py --strict
```

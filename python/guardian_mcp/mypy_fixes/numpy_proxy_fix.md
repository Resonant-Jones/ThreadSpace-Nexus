...
**File:** `.venv/lib/python3.13/site-packages/openai/_extras/numpy_proxy.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_extras/numpy_proxy.py --strict
```

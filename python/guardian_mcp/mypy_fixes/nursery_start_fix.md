# 🧠 Mypy Fix Guide: `nursery_start.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/type_tests/nursery_start.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/type_tests/nursery_start.py --strict
```

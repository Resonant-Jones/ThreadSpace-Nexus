# 🧠 Mypy Fix Guide: `o_series_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/azure/chat/o_series_handler.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/azure/chat/o_series_handler.py --strict
```

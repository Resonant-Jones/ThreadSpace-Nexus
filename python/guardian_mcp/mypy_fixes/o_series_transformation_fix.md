# 🧠 Mypy Fix Guide: `o_series_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/azure/chat/o_series_transformation.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/azure/chat/o_series_transformation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/oauth1_auth.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/oauth1_auth.py --strict
```

# 🧠 Mypy Fix Guide: `oauth1_session.py`
...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/oauth1_session.py`
**Lines:** `395`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/oauth1_session.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/oauth2_auth.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/oauth2_auth.py --strict
```

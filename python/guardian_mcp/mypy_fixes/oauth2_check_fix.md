# 🧠 Mypy Fix Guide: `oauth2_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/oauth2_check.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/oauth2_check.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fastapi/security/oauth2.py`
**Lines:** `638`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/security/oauth2.py --strict
```

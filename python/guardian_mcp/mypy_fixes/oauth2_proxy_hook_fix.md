# 🧠 Mypy Fix Guide: `oauth2_proxy_hook.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/oauth2_proxy_hook.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/oauth2_proxy_hook.py --strict
```

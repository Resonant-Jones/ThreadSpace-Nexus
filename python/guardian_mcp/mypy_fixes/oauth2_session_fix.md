# 🧠 Mypy Fix Guide: `oauth2_session.py`
...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/oauth2_session.py`
**Lines:** `587`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/oauth2_session.py --strict
```

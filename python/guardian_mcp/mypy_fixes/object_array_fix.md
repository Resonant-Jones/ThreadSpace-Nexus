# 🧠 Mypy Fix Guide: `object_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/strings/object_array.py`
**Lines:** `534`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/strings/object_array.py --strict
```

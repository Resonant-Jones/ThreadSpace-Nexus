# 🧠 Mypy Fix Guide: `object_detection.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/object_detection.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/object_detection.py --strict
```

# 🧠 Mypy Fix Guide: `object_permission_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_helpers/object_permission_utils.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_helpers/object_permission_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/objective.py`
**Lines:** `513`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/objective.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexers/objects.py`
**Lines:** `453`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexers/objects.py --strict
```

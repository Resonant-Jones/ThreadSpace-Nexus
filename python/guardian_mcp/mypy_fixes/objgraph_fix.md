...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/objgraph.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/objgraph.py --strict
```

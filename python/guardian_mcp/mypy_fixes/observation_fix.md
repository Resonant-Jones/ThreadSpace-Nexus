...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/metrics/_internal/observation.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/metrics/_internal/observation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/x509/ocsp.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/x509/ocsp.py --strict
```

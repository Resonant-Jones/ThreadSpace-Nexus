...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/octave.py`
**Lines:** `711`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/octave.py --strict
```

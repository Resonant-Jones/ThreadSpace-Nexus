...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/ode.py`
**Lines:** `3572`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/ode.py --strict
```

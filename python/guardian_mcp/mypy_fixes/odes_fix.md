...
**File:** `.venv/lib/python3.13/site-packages/mpmath/calculus/odes.py`
**Lines:** `288`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/calculus/odes.py --strict
```

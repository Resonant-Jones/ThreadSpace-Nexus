...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/lifespan/off.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/lifespan/off.py --strict
```

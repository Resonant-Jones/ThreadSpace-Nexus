# 🧠 Mypy Fix Guide: `offline_tuning.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/offline_tuning.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/offline_tuning.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/tseries/offsets.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/tseries/offsets.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/x509/oid.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/x509/oid.py --strict
```

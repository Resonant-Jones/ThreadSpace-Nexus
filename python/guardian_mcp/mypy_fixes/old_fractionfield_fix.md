# 🧠 Mypy Fix Guide: `old_fractionfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/old_fractionfield.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/old_fractionfield.py --strict
```

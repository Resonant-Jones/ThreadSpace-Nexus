# 🧠 Mypy Fix Guide: `old_polynomialring.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/old_polynomialring.py`
**Lines:** `490`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/old_polynomialring.py --strict
```

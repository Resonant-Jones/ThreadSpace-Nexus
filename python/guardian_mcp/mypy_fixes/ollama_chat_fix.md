...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/ollama_chat.py`
**Lines:** `439`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/ollama_chat.py --strict
```

# 🧠 Mypy Fix Guide: `ollama_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/ollama_embedding_function.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/ollama_embedding_function.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/ollama.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/ollama.py --strict
```

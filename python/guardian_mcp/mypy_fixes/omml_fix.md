...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converter_utils/docx/math/omml.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converter_utils/docx/math/omml.py --strict
```

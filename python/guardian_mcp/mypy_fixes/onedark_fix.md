...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/onedark.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/onedark.py --strict
```

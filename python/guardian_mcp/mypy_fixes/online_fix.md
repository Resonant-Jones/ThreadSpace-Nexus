...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/window/online.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/window/online.py --strict
```

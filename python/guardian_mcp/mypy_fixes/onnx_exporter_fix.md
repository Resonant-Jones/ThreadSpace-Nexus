# 🧠 Mypy Fix Guide: `onnx_exporter.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_exporter.py`
**Lines:** `719`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_exporter.py --strict
```

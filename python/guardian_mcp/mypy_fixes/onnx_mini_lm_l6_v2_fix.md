# 🧠 Mypy Fix Guide: `onnx_mini_lm_l6_v2.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/onnx_mini_lm_l6_v2.py`
**Lines:** `357`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/onnx_mini_lm_l6_v2.py --strict
```

# 🧠 Mypy Fix Guide: `onnx_model_bart.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_bart.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_bart.py --strict
```

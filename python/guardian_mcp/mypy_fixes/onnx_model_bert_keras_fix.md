# 🧠 Mypy Fix Guide: `onnx_model_bert_keras.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_bert_keras.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_bert_keras.py --strict
```

# 🧠 Mypy Fix Guide: `onnx_model_bert_tf.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_bert_tf.py`
**Lines:** `588`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_bert_tf.py --strict
```

# 🧠 Mypy Fix Guide: `onnx_model_clip.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_clip.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_clip.py --strict
```

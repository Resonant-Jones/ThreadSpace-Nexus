# 🧠 Mypy Fix Guide: `onnx_model_conformer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_conformer.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_conformer.py --strict
```

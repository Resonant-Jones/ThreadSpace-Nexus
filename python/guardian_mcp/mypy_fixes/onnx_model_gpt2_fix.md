# 🧠 Mypy Fix Guide: `onnx_model_gpt2.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_gpt2.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_gpt2.py --strict
```

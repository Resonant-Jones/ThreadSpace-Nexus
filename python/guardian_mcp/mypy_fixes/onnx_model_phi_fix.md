# 🧠 Mypy Fix Guide: `onnx_model_phi.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_phi.py`
**Lines:** `929`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_phi.py --strict
```

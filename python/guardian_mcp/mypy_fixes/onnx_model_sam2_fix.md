# 🧠 Mypy Fix Guide: `onnx_model_sam2.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_sam2.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_sam2.py --strict
```

# 🧠 Mypy Fix Guide: `onnx_model_tnlr.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_tnlr.py`
**Lines:** `226`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_model_tnlr.py --strict
```

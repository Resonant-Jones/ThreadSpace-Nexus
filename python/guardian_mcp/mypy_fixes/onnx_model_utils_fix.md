# 🧠 Mypy Fix Guide: `onnx_model_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/onnx_model_utils.py`
**Lines:** `413`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/onnx_model_utils.py --strict
```

# 🧠 Mypy Fix Guide: `onnx_quantizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/onnx_quantizer.py`
**Lines:** `1008`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/onnx_quantizer.py --strict
```

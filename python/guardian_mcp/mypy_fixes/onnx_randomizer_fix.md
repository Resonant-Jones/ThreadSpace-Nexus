# 🧠 Mypy Fix Guide: `onnx_randomizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/onnx_randomizer.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/onnx_randomizer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_utils.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/onnx_utils.py --strict
```

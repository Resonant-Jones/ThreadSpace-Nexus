# 🧠 Mypy Fix Guide: `onnxruntime_collect_build_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/onnxruntime_collect_build_info.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/onnxruntime_collect_build_info.py --strict
```

# 🧠 Mypy Fix Guide: `onnxruntime_inference_collection.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/onnxruntime_inference_collection.py`
**Lines:** `1154`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/onnxruntime_inference_collection.py --strict
```

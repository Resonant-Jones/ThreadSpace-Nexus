# 🧠 Mypy Fix Guide: `onnxruntime_test.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/onnxruntime_test.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/onnxruntime_test.py --strict
```

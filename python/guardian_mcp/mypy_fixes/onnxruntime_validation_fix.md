# 🧠 Mypy Fix Guide: `onnxruntime_validation.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/capi/onnxruntime_validation.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/capi/onnxruntime_validation.py --strict
```

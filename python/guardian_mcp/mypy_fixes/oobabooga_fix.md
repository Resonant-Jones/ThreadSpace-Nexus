...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/oobabooga/chat/oobabooga.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/oobabooga/chat/oobabooga.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ooc.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ooc.py --strict
```

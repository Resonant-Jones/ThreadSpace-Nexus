# 🧠 Mypy Fix Guide: `open_clip_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/open_clip_embedding_function.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/open_clip_embedding_function.py --strict
```

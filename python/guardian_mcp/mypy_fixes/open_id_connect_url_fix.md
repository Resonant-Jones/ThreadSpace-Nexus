# 🧠 Mypy Fix Guide: `open_id_connect_url.py`
...
**File:** `.venv/lib/python3.13/site-packages/fastapi/security/open_id_connect_url.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/security/open_id_connect_url.py --strict
```

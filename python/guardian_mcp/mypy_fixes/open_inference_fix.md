# 🧠 Mypy Fix Guide: `open_inference.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/_types/open_inference.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/_types/open_inference.py --strict
```

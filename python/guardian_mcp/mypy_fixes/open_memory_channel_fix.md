# 🧠 Mypy Fix Guide: `open_memory_channel.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/type_tests/open_memory_channel.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/type_tests/open_memory_channel.py --strict
```

# 🧠 Mypy Fix Guide: `openai_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/ai/openai/openai_async.py`
**Lines:** `639`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/ai/openai/openai_async.py --strict
```

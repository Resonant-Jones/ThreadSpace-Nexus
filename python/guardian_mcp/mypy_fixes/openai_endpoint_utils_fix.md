# 🧠 Mypy Fix Guide: `openai_endpoint_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/openai_endpoint_utils.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/openai_endpoint_utils.py --strict
```

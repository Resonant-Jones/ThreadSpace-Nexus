# 🧠 Mypy Fix Guide: `openai_providers.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/ai/openai/openai_providers.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/ai/openai/openai_providers.py --strict
```

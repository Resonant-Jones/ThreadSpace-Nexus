# 🧠 Mypy Fix Guide: `openai_public.py`
...
**File:** `.venv/lib/python3.13/site-packages/tiktoken_ext/openai_public.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/tiktoken_ext/openai_public.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/openmeter.py`
**Lines:** `132`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/openmeter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/openrouter.py`
**Lines:** `9`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/openrouter.py --strict
```

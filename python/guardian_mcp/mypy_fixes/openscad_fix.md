...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/openscad.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/openscad.py --strict
```

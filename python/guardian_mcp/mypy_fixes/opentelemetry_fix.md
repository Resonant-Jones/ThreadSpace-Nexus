# 🧠 Mypy Fix Guide: `opentelemetry.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/opentelemetry.py`
**Lines:** `1105`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/opentelemetry.py --strict
```

# 🧠 Mypy Fix Guide: `opentracing_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/opentracing_attributes.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/opentracing_attributes.py --strict
```

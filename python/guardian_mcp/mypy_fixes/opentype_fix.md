...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/type/opentype.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/type/opentype.py --strict
```

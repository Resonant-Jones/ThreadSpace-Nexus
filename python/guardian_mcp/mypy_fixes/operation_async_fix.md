# 🧠 Mypy Fix Guide: `operation_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operation_async.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operation_async.py --strict
```

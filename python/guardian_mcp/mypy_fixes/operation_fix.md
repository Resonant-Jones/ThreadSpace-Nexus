...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operation.py`
**Lines:** `365`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operation.py --strict
```

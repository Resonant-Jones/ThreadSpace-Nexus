# 🧠 Mypy Fix Guide: `operations_client_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/operations_client_config.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/operations_client_config.py --strict
```

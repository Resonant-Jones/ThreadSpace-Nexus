# 🧠 Mypy Fix Guide: `operations_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/operations_client.py`
**Lines:** `378`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/operations_client.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/operations.py`
**Lines:** `741`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/operations.py --strict
```

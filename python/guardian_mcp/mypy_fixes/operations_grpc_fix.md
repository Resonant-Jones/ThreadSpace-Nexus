# 🧠 Mypy Fix Guide: `operations_grpc.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/longrunning/operations_grpc.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/longrunning/operations_grpc.py --strict
```

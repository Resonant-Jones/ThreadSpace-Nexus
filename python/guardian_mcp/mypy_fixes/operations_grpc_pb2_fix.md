# 🧠 Mypy Fix Guide: `operations_grpc_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/longrunning/operations_grpc_pb2.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/longrunning/operations_grpc_pb2.py --strict
```

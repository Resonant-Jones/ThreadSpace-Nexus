# 🧠 Mypy Fix Guide: `operations_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/longrunning/operations_pb2.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/longrunning/operations_pb2.py --strict
```

# 🧠 Mypy Fix Guide: `operations_pb2_grpc.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/longrunning/operations_pb2_grpc.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/longrunning/operations_pb2_grpc.py --strict
```

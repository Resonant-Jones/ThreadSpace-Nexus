# 🧠 Mypy Fix Guide: `operations_proto.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/longrunning/operations_proto.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/longrunning/operations_proto.py --strict
```

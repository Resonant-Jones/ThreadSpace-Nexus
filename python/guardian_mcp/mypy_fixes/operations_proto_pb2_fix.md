# 🧠 Mypy Fix Guide: `operations_proto_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/longrunning/operations_proto_pb2.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/longrunning/operations_proto_pb2.py --strict
```

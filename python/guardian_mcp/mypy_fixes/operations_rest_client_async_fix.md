# 🧠 Mypy Fix Guide: `operations_rest_client_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/operations_rest_client_async.py`
**Lines:** `345`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/operations_rest_client_async.py --strict
```

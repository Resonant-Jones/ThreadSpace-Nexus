...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/operator.py`
**Lines:** `653`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/operator.py --strict
```

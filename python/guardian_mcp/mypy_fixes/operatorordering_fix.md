# 🧠 Mypy Fix Guide: `operatorordering.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/operatorordering.py`
**Lines:** `290`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/operatorordering.py --strict
```

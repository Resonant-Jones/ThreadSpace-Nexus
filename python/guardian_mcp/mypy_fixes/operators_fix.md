...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/operators.py`
**Lines:** `335`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/operators.py --strict
```

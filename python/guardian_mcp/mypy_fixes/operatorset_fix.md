...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/operatorset.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/operatorset.py --strict
```

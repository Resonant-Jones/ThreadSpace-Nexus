...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/opik/opik.py`
**Lines:** `325`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/opik/opik.py --strict
```

# 🧠 Mypy Fix Guide: `opinion_lexicon.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/opinion_lexicon.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/opinion_lexicon.py --strict
```

# 🧠 Mypy Fix Guide: `optimization.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/calculus/optimization.py`
**Lines:** `1102`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/calculus/optimization.py --strict
```

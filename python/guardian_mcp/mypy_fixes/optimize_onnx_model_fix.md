# 🧠 Mypy Fix Guide: `optimize_onnx_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/optimize_onnx_model.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/optimize_onnx_model.py --strict
```

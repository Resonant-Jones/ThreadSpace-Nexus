# 🧠 Mypy Fix Guide: `optimize_qdq_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/qdq_helpers/optimize_qdq_model.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/qdq_helpers/optimize_qdq_model.py --strict
```

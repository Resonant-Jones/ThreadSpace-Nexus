...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/optimizer.py`
**Lines:** `623`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/optimizer.py --strict
```

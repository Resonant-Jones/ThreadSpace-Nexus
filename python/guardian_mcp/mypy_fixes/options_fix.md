...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/ie/options.py`
**Lines:** `405`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/ie/options.py --strict
```

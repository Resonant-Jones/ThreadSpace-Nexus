...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/oracle/oracledb.py`
**Lines:** `947`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/oracle/oracledb.py --strict
```

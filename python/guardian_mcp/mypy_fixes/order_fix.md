...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/handlers/order.py`
**Lines:** `440`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/handlers/order.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/uritemplate/orderedset.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/uritemplate/orderedset.py --strict
```

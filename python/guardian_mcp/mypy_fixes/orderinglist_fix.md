# 🧠 Mypy Fix Guide: `orderinglist.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/orderinglist.py`
**Lines:** `427`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/orderinglist.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/orderings.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/orderings.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/ordinals.py`
**Lines:** `282`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/ordinals.py --strict
```

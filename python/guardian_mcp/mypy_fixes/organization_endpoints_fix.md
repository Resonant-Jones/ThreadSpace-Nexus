# 🧠 Mypy Fix Guide: `organization_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/organization_endpoints.py`
**Lines:** `924`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/organization_endpoints.py --strict
```

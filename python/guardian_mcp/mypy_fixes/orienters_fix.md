...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/orienters.py`
**Lines:** `398`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/orienters.py --strict
```

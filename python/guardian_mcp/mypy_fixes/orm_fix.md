...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/fixtures/orm.py`
**Lines:** `227`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/fixtures/orm.py --strict
```

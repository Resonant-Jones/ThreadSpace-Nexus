# 🧠 Mypy Fix Guide: `ort_model_processor.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/ort_format_model/ort_model_processor.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/ort_format_model/ort_model_processor.py --strict
```

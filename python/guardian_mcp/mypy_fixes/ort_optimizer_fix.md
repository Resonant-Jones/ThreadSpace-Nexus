# 🧠 Mypy Fix Guide: `ort_optimizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/ort_optimizer.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/stable_diffusion/ort_optimizer.py --strict
```

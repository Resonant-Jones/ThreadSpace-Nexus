...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/orthogonal.py`
**Lines:** `493`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/orthogonal.py --strict
```

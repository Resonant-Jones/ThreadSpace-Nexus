...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/orthopolys.py`
**Lines:** `343`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/orthopolys.py --strict
```

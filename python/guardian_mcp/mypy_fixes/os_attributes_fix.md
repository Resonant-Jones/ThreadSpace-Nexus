# 🧠 Mypy Fix Guide: `os_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/os_attributes.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/os_attributes.py --strict
```

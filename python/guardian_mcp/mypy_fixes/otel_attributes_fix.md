# 🧠 Mypy Fix Guide: `otel_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/otel_attributes.py`
**Lines:** `128`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/otel_attributes.py --strict
```

# 🧠 Mypy Fix Guide: `otel_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/otel_metrics.py`
**Lines:** `447`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/otel_metrics.py --strict
```

# 🧠 Mypy Fix Guide: `other_file_chunking_strategy_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/other_file_chunking_strategy_object.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/other_file_chunking_strategy_object.py --strict
```

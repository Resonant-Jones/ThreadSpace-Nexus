...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/other.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/other.py --strict
```

# 🧠 Mypy Fix Guide: `output_item_retrieve_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/runs/output_item_retrieve_response.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/runs/output_item_retrieve_response.py --strict
```

# 🧠 Mypy Fix Guide: `output_items.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/evals/runs/output_items.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/evals/runs/output_items.py --strict
```

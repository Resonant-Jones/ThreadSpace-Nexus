# 🧠 Mypy Fix Guide: `output_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/output_utils.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/output_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/_distutils_hack/override.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/_distutils_hack/override.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/testing/overrides.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/testing/overrides.py --strict
```

# 🧠 Mypy Fix Guide: `overwrite_reason.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/overwrite_reason.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/overwrite_reason.py --strict
```

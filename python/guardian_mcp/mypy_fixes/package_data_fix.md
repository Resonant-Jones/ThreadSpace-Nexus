# 🧠 Mypy Fix Guide: `package_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/idna/package_data.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/idna/package_data.py --strict
```

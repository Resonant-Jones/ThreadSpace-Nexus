# 🧠 Mypy Fix Guide: `package_finder.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/index/package_finder.py`
**Lines:** `1050`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/index/package_finder.py --strict
```

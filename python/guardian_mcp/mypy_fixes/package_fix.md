...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/fastapi/package.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/fastapi/package.py --strict
```

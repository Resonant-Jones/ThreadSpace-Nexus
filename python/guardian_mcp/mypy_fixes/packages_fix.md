...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/requests/packages.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/requests/packages.py --strict
```

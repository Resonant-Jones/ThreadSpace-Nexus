...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/packaging.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/packaging.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/flatbuffers/packer.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/flatbuffers/packer.py --strict
```

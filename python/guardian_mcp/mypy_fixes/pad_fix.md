...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/pad.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/pad.py --strict
```

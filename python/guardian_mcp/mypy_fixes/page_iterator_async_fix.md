# 🧠 Mypy Fix Guide: `page_iterator_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/page_iterator_async.py`
**Lines:** `285`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/page_iterator_async.py --strict
```

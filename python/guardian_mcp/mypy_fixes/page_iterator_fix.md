# 🧠 Mypy Fix Guide: `page_iterator.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/page_iterator.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/page_iterator.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/pager.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/pager.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/pagerduty.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/pagerduty.py --strict
```

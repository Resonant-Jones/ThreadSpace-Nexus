# 🧠 Mypy Fix Guide: `pagers_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/pagers_async.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/pagers_async.py --strict
```

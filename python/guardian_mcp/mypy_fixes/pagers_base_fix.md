...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/pagers_base.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/pagers_base.py --strict
```

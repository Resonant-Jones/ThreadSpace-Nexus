...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/services/file_service/pagers.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/services/file_service/pagers.py --strict
```

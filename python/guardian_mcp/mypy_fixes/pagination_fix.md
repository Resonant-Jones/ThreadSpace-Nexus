...
**File:** `.venv/lib/python3.13/site-packages/openai/pagination.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/pagination.py --strict
```

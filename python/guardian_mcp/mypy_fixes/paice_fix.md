...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/paice.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/paice.py --strict
```

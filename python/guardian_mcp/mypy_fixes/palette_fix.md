...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/palette.py`
**Lines:** `100`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/palette.py --strict
```

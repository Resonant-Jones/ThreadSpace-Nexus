...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/deprecated_providers/palm.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/deprecated_providers/palm.py --strict
```

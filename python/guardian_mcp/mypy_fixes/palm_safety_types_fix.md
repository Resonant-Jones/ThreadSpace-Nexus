# 🧠 Mypy Fix Guide: `palm_safety_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/palm_safety_types.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/palm_safety_types.py --strict
```

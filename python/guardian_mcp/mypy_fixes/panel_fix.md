...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/panel.py`
**Lines:** `318`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/panel.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/pangea.py`
**Lines:** `399`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/guardrails/guardrail_hooks/pangea.py --strict
```

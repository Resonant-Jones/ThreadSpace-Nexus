...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/pangomarkup.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/pangomarkup.py --strict
```

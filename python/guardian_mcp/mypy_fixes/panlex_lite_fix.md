...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/panlex_lite.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/panlex_lite.py --strict
```

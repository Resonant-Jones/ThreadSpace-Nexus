# 🧠 Mypy Fix Guide: `panlex_swadesh.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/panlex_swadesh.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/panlex_swadesh.py --strict
```

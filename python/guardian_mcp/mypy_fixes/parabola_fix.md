...
**File:** `.venv/lib/python3.13/site-packages/sympy/geometry/parabola.py`
**Lines:** `422`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/geometry/parabola.py --strict
```

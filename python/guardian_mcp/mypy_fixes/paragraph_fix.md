...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/paragraph.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/paragraph.py --strict
```

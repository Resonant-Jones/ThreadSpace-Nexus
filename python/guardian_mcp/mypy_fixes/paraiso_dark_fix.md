# 🧠 Mypy Fix Guide: `paraiso_dark.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/paraiso_dark.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/paraiso_dark.py --strict
```

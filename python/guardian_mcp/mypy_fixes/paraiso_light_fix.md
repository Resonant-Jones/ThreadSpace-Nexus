# 🧠 Mypy Fix Guide: `paraiso_light.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/paraiso_light.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/paraiso_light.py --strict
```

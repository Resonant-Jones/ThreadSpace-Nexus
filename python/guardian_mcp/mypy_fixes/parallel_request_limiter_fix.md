# 🧠 Mypy Fix Guide: `parallel_request_limiter.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/parallel_request_limiter.py`
**Lines:** `868`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/parallel_request_limiter.py --strict
```

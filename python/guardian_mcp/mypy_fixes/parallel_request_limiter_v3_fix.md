# 🧠 Mypy Fix Guide: `parallel_request_limiter_v3.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/parallel_request_limiter_v3.py`
**Lines:** `642`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/parallel_request_limiter_v3.py --strict
```

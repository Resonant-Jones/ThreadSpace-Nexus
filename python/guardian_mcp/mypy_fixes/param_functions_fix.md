# 🧠 Mypy Fix Guide: `param_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/fastapi/param_functions.py`
**Lines:** `2360`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/param_functions.py --strict
```

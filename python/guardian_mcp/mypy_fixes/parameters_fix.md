...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/parameters.py`
**Lines:** `161`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/parameters.py --strict
```

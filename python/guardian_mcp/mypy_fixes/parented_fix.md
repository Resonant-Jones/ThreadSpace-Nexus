...
**File:** `.venv/lib/python3.13/site-packages/nltk/tree/parented.py`
**Lines:** `590`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tree/parented.py --strict
```

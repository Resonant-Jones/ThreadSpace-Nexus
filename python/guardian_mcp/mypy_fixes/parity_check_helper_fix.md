# 🧠 Mypy Fix Guide: `parity_check_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/parity_check_helper.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/gpt2/parity_check_helper.py --strict
```

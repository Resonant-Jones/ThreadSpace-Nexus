...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/parquet.py`
**Lines:** `678`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/parquet.py --strict
```

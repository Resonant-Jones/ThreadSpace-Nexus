...
**File:** `.venv/lib/python3.13/site-packages/flake8/options/parse_args.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/options/parse_args.py --strict
```

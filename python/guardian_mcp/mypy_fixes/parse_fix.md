...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/cli/parse.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/cli/parse.py --strict
```

# 🧠 Mypy Fix Guide: `parse_link_destination.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/helpers/parse_link_destination.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/helpers/parse_link_destination.py --strict
```

# 🧠 Mypy Fix Guide: `parse_link_title.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/helpers/parse_link_title.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/helpers/parse_link_title.py --strict
```

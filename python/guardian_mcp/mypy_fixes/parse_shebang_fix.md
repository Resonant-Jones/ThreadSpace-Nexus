# 🧠 Mypy Fix Guide: `parse_shebang.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/parse_shebang.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/parse_shebang.py --strict
```

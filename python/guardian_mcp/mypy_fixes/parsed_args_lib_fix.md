# 🧠 Mypy Fix Guide: `parsed_args_lib.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/parsed_args_lib.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/parsed_args_lib.py --strict
```

# 🧠 Mypy Fix Guide: `parsed_chat_completion.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/parsed_chat_completion.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/parsed_chat_completion.py --strict
```

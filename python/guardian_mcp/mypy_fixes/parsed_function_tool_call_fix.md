# 🧠 Mypy Fix Guide: `parsed_function_tool_call.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/chat/parsed_function_tool_call.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/chat/parsed_function_tool_call.py --strict
```

# 🧠 Mypy Fix Guide: `parsed_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/parsed_response.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/parsed_response.py --strict
```

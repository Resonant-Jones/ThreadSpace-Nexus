# 🧠 Mypy Fix Guide: `parser_block.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/parser_block.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/parser_block.py --strict
```

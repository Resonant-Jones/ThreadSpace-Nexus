...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/parser_core.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/parser_core.py --strict
```

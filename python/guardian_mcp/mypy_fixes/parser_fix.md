...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/parser.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/parser.py --strict
```

# 🧠 Mypy Fix Guide: `parser_inline.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/parser_inline.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/parser_inline.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/tree/parsing.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tree/parsing.py --strict
```

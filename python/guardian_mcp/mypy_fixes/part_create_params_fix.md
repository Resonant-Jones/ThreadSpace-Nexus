# 🧠 Mypy Fix Guide: `part_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/uploads/part_create_params.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/uploads/part_create_params.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/partfrac.py`
**Lines:** `496`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/partfrac.py --strict
```

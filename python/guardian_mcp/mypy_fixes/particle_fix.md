...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/particle.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/particle.py --strict
```

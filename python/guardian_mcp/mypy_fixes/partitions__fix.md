...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/partitions_.py`
**Lines:** `277`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/partitions_.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/partitions.py`
**Lines:** `745`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/partitions.py --strict
```

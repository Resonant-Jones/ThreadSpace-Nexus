...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/uploads/parts.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/uploads/parts.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/pascal.py`
**Lines:** `644`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/pascal.py --strict
```

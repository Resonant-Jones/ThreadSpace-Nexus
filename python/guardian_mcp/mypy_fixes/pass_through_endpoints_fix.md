# 🧠 Mypy Fix Guide: `pass_through_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/passthrough_endpoints/pass_through_endpoints.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/passthrough_endpoints/pass_through_endpoints.py --strict
```

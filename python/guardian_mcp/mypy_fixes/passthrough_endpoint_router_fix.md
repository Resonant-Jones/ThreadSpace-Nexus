# 🧠 Mypy Fix Guide: `passthrough_endpoint_router.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/passthrough_endpoint_router.py`
**Lines:** `193`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/passthrough_endpoint_router.py --strict
```

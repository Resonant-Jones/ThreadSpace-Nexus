...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/past_helper.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/past_helper.py --strict
```

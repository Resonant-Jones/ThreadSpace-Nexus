...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/pastie.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/pastie.py --strict
```

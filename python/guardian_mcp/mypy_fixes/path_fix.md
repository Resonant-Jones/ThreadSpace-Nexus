...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/type_tests/path.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/type_tests/path.py --strict
```

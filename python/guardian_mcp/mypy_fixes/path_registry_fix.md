# 🧠 Mypy Fix Guide: `path_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/path_registry.py`
**Lines:** `811`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/path_registry.py --strict
```

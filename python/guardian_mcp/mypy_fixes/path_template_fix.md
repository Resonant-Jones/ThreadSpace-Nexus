# 🧠 Mypy Fix Guide: `path_template.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/path_template.py`
**Lines:** `346`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/path_template.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pathspec/pathspec.py`
**Lines:** `394`
...
```bash
mypy .venv/lib/python3.13/site-packages/pathspec/pathspec.py --strict
```

# 🧠 Mypy Fix Guide: `pattern_match_deployments.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/pattern_match_deployments.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/pattern_match_deployments.py --strict
```

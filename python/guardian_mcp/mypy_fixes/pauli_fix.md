...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/pauli.py`
**Lines:** `675`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/pauli.py --strict
```

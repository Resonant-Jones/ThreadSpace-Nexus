...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/pawn.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/pawn.py --strict
```

# 🧠 Mypy Fix Guide: `payload_streamer.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/payload_streamer.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/payload_streamer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/pc_groups.py`
**Lines:** `710`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/pc_groups.py --strict
```

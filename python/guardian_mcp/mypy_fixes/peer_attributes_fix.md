# 🧠 Mypy Fix Guide: `peer_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/peer_attributes.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/peer_attributes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/discovery/windows/pep514.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/discovery/windows/pep514.py --strict
```

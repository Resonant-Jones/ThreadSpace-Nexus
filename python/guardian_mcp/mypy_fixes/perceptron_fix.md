...
**File:** `.venv/lib/python3.13/site-packages/nltk/tag/perceptron.py`
**Lines:** `399`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tag/perceptron.py --strict
```

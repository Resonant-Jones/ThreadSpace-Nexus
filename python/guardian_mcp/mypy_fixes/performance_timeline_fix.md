# 🧠 Mypy Fix Guide: `performance_timeline.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/performance_timeline.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/performance_timeline.py --strict
```

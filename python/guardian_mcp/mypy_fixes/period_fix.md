...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/period.py`
**Lines:** `614`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/period.py --strict
```

# 🧠 Mypy Fix Guide: `periodic_update.py`
...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/wheels/periodic_update.py`
**Lines:** `428`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/wheels/periodic_update.py --strict
```

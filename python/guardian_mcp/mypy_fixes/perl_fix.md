...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/perl.py`
**Lines:** `733`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/perl.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/perldoc.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/perldoc.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/perm_groups.py`
**Lines:** `5459`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/perm_groups.py --strict
```

# 🧠 Mypy Fix Guide: `permessage_deflate.py`
...
**File:** `.venv/lib/python3.13/site-packages/websockets/extensions/permessage_deflate.py`
**Lines:** `697`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/extensions/permessage_deflate.py --strict
```

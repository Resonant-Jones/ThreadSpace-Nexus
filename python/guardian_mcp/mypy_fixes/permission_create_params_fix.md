# 🧠 Mypy Fix Guide: `permission_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_create_params.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_create_params.py --strict
```

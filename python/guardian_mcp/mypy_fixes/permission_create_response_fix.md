# 🧠 Mypy Fix Guide: `permission_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_create_response.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_create_response.py --strict
```

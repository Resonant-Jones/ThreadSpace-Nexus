# 🧠 Mypy Fix Guide: `permission_delete_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_delete_response.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_delete_response.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/permission.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/permission.py --strict
```

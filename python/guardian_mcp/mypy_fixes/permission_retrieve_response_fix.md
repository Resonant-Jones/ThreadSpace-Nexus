# 🧠 Mypy Fix Guide: `permission_retrieve_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_retrieve_response.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/checkpoints/permission_retrieve_response.py --strict
```

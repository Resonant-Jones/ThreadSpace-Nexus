# 🧠 Mypy Fix Guide: `permission_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/permission_service.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/permission_service.py --strict
```

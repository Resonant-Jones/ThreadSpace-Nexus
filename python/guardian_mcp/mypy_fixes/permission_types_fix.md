# 🧠 Mypy Fix Guide: `permission_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/permission_types.py`
**Lines:** `479`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/permission_types.py --strict
```

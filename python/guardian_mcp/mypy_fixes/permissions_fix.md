...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/safari/permissions.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/safari/permissions.py --strict
```

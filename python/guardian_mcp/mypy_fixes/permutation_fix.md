...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/permutation.py`
**Lines:** `303`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/permutation.py --strict
```

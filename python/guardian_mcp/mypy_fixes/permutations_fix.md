# 🧠 Mypy Fix Guide: `permutations.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/permutations.py`
**Lines:** `3114`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/permutations.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/persistence.py`
**Lines:** `1782`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/persistence.py --strict
```

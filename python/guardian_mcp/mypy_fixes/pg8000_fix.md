...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/pg8000.py`
**Lines:** `666`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/pg8000.py --strict
```

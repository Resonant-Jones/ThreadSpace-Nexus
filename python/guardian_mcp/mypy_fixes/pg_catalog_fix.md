...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/pg_catalog.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/pg_catalog.py --strict
```

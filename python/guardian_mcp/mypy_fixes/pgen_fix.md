...
**File:** `.venv/lib/python3.13/site-packages/blib2to3/pgen2/pgen.py`
**Lines:** `420`
...
```bash
mypy .venv/lib/python3.13/site-packages/blib2to3/pgen2/pgen.py --strict
```

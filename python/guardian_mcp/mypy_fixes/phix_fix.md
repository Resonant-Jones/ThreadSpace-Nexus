...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/phix.py`
**Lines:** `363`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/phix.py --strict
```

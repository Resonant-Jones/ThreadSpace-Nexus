# 🧠 Mypy Fix Guide: `phone_number_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/type/phone_number_pb2.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/type/phone_number_pb2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/php.py`
**Lines:** `334`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/php.py --strict
```

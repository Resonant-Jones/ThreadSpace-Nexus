# 🧠 Mypy Fix Guide: `phrase_based.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/phrase_based.py`
**Lines:** `193`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/phrase_based.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/piab.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/piab.py --strict
```

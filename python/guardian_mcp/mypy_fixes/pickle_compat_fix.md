# 🧠 Mypy Fix Guide: `pickle_compat.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/compat/pickle_compat.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/compat/pickle_compat.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/pickleable.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/pickleable.py --strict
```

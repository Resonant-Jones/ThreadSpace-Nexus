...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/piecewise.py`
**Lines:** `1517`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/piecewise.py --strict
```

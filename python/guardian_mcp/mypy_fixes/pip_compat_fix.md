...
**File:** `.venv/lib/python3.13/site-packages/piptools/_compat/pip_compat.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/piptools/_compat/pip_compat.py --strict
```

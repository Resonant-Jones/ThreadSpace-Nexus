...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/embed/pip_invoke.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/embed/pip_invoke.py --strict
```

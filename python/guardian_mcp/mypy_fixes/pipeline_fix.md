...
**File:** `.venv/lib/python3.13/site-packages/pydantic/experimental/pipeline.py`
**Lines:** `667`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/experimental/pipeline.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/reshape/pivot.py`
**Lines:** `899`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/reshape/pivot.py --strict
```

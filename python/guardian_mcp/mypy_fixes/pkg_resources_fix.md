# 🧠 Mypy Fix Guide: `pkg_resources.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/metadata/pkg_resources.py`
**Lines:** `301`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/metadata/pkg_resources.py --strict
```

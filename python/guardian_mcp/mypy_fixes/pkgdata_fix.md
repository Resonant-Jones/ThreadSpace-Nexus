...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/pkgdata.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/pkgdata.py --strict
```

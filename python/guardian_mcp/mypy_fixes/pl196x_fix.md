...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/pl196x.py`
**Lines:** `373`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/pl196x.py --strict
```

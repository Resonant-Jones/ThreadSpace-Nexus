...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/plaintext.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/plaintext.py --strict
```

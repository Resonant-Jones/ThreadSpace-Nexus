...
**File:** `.venv/lib/python3.13/site-packages/chromadb/execution/expression/plan.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/execution/expression/plan.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/geometry/plane.py`
**Lines:** `878`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/geometry/plane.py --strict
```

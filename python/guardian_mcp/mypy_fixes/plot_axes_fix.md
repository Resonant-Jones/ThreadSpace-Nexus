...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_axes.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_axes.py --strict
```

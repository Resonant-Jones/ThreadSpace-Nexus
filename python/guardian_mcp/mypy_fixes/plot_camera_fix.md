...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_camera.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_camera.py --strict
```

# 🧠 Mypy Fix Guide: `plot_controller.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_controller.py`
**Lines:** `218`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_controller.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_curve.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_curve.py --strict
```

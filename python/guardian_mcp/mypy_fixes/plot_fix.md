...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot.py`
**Lines:** `464`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot.py --strict
```

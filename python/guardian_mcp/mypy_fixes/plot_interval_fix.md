# 🧠 Mypy Fix Guide: `plot_interval.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_interval.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_interval.py --strict
```

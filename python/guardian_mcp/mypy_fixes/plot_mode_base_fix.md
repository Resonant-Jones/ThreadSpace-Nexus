# 🧠 Mypy Fix Guide: `plot_mode_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_mode_base.py`
**Lines:** `378`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_mode_base.py --strict
```

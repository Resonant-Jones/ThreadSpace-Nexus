...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_mode.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_mode.py --strict
```

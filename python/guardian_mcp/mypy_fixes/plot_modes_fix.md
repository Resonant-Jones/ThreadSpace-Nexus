...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_modes.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_modes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_object.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_object.py --strict
```

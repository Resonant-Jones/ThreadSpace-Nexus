# 🧠 Mypy Fix Guide: `plot_rotation.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_rotation.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_rotation.py --strict
```

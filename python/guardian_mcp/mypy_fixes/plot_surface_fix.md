# 🧠 Mypy Fix Guide: `plot_surface.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_surface.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_surface.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_window.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/pygletplot/plot_window.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/plotgrid.py`
**Lines:** `188`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/plotgrid.py --strict
```

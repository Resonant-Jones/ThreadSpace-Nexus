...
**File:** `.venv/lib/python3.13/site-packages/google/auth/pluggable.py`
**Lines:** `429`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/pluggable.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/plugin/plugin_base.py`
**Lines:** `779`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/plugin/plugin_base.py --strict
```

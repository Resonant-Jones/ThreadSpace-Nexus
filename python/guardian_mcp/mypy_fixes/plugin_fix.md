...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/plugin.py`
**Lines:** `303`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/mypy/plugin.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/compiler/plugin_pb2.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/compiler/plugin_pb2.py --strict
```

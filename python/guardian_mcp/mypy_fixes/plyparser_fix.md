...
**File:** `.venv/lib/python3.13/site-packages/pycparser/plyparser.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/plyparser.py --strict
```

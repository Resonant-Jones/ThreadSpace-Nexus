# 🧠 Mypy Fix Guide: `pod_lock_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/pod_lock_manager.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/pod_lock_manager.py --strict
```

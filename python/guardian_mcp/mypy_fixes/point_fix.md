...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/vector/point.py`
**Lines:** `635`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/vector/point.py --strict
```

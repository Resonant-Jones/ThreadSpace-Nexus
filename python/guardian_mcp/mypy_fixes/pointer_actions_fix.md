# 🧠 Mypy Fix Guide: `pointer_actions.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/pointer_actions.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/pointer_actions.py --strict
```

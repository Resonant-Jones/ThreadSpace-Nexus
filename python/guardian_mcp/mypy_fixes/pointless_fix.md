...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/pointless.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/pointless.py --strict
```

# 🧠 Mypy Fix Guide: `polarization.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/optics/polarization.py`
**Lines:** `732`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/optics/polarization.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/policy_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/policy_api.py --strict
```

# 🧠 Mypy Fix Guide: `policy_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/policy_v1_api.py`
**Lines:** `1843`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/policy_v1_api.py --strict
```

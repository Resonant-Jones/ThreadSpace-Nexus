...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/future/polling.py`
**Lines:** `323`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/future/polling.py --strict
```

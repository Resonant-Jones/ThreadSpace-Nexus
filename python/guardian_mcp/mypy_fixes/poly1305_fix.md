...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/poly1305.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/poly1305.py --strict
```

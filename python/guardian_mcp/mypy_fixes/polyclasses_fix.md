...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyclasses.py`
**Lines:** `3186`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyclasses.py --strict
```

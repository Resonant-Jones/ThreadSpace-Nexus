...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyconfig.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyconfig.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyerrors.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyerrors.py --strict
```

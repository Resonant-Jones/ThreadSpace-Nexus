...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyfuncs.py`
**Lines:** `321`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyfuncs.py --strict
```

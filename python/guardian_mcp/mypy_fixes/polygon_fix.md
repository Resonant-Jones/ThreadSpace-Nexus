...
**File:** `.venv/lib/python3.13/site-packages/sympy/geometry/polygon.py`
**Lines:** `2891`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/geometry/polygon.py --strict
```

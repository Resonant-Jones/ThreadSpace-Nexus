...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/polyhedron.py`
**Lines:** `1019`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/polyhedron.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polymatrix.py`
**Lines:** `292`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polymatrix.py --strict
```

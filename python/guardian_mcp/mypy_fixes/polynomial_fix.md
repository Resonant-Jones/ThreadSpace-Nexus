...
**File:** `.venv/lib/python3.13/site-packages/numpy/polynomial/polynomial.py`
**Lines:** `1616`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/polynomial/polynomial.py --strict
```

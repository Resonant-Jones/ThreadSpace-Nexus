# 🧠 Mypy Fix Guide: `polynomialring.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/polynomialring.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/polynomialring.py --strict
```

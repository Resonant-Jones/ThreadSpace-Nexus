...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/polynomials.py`
**Lines:** `1447`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/polynomials.py --strict
```

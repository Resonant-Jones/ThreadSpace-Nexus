...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyoptions.py`
**Lines:** `791`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyoptions.py --strict
```

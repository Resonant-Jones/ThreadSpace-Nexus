# 🧠 Mypy Fix Guide: `polyquinticconst.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyquinticconst.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyquinticconst.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyroots.py`
**Lines:** `1227`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyroots.py --strict
```

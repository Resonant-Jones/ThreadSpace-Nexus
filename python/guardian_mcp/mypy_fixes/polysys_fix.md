...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/polysys.py`
**Lines:** `872`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/polysys.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polytools.py`
**Lines:** `7960`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polytools.py --strict
```

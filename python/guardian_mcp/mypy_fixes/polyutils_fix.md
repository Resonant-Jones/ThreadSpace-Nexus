...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/polyutils.py`
**Lines:** `584`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/polyutils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/pony.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/pony.py --strict
```

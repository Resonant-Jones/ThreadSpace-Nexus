...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/pooling.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/pooling.py --strict
```

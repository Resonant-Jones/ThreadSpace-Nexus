...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/poolmanager.py`
**Lines:** `540`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/poolmanager.py --strict
```

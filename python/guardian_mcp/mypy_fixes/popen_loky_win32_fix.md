# 🧠 Mypy Fix Guide: `popen_loky_win32.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/popen_loky_win32.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/popen_loky_win32.py --strict
```

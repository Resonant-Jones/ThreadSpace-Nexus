# 🧠 Mypy Fix Guide: `porter_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/porter_stemmer.py`
**Lines:** `506`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/porter_stemmer.py --strict
```

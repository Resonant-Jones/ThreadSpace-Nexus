# 🧠 Mypy Fix Guide: `portuguese_en_fixt.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/portuguese_en_fixt.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/portuguese_en_fixt.py --strict
```

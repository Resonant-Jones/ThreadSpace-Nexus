# 🧠 Mypy Fix Guide: `portuguese_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/portuguese_stemmer.py`
**Lines:** `659`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/portuguese_stemmer.py --strict
```

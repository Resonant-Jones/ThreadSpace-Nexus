# 🧠 Mypy Fix Guide: `positivenaivebayes.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/positivenaivebayes.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/positivenaivebayes.py --strict
```

# 🧠 Mypy Fix Guide: `post_call_rules.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/_experimental/post_call_rules.py`
**Lines:** `4`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/_experimental/post_call_rules.py --strict
```

# 🧠 Mypy Fix Guide: `post_process_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/post_process_utils.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/post_process_utils.py --strict
```

# 🧠 Mypy Fix Guide: `post_process_utils_test_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/post_process_utils_test_helper.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/post_process_utils_test_helper.py --strict
```

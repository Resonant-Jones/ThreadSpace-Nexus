# 🧠 Mypy Fix Guide: `postal_address_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/type/postal_address_pb2.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/type/postal_address_pb2.py --strict
```

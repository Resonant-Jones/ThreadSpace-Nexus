...
**File:** `.venv/lib/python3.13/site-packages/chromadb/telemetry/product/posthog.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/telemetry/product/posthog.py --strict
```

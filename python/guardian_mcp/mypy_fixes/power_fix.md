...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/power.py`
**Lines:** `107`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/power.py --strict
```

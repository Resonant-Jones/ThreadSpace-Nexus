...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/powerset.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/powerset.py --strict
```

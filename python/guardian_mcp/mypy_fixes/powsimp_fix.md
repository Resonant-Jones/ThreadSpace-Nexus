...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/powsimp.py`
**Lines:** `718`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/powsimp.py --strict
```

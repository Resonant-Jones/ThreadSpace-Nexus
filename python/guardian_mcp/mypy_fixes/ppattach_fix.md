...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/ppattach.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/ppattach.py --strict
```

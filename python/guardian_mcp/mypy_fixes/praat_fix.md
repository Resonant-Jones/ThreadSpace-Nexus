...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/praat.py`
**Lines:** `303`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/praat.py --strict
```

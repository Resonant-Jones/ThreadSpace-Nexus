...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/prde.py`
**Lines:** `1333`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/prde.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markitdown/converter_utils/docx/pre_process.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/markitdown/converter_utils/docx/pre_process.py --strict
```

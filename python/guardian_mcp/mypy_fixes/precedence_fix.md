...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/precedence.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/precedence.py --strict
```

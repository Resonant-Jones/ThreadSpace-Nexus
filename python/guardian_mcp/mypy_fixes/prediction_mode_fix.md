# 🧠 Mypy Fix Guide: `prediction_mode.py`
...
**File:** `.venv/lib/python3.13/site-packages/magika/types/prediction_mode.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/prediction_mode.py --strict
```

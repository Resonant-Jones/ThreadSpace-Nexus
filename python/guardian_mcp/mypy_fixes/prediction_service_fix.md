# 🧠 Mypy Fix Guide: `prediction_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/prediction_service.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/prediction_service.py --strict
```

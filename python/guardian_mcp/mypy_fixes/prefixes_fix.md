...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/prefixes.py`
**Lines:** `219`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/prefixes.py --strict
```

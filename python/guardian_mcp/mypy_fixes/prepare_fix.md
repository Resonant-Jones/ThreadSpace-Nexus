...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/prepare.py`
**Lines:** `650`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/prepare.py --strict
```

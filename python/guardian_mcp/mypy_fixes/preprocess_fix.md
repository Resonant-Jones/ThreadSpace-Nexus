...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/preprocess.py`
**Lines:** `307`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/preprocess.py --strict
```

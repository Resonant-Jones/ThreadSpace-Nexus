...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/guardrails/guardrail_hooks/presidio.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/guardrails/guardrail_hooks/presidio.py --strict
```

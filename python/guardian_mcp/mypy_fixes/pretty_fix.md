...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/pretty/pretty.py`
**Lines:** `2937`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/pretty/pretty.py --strict
```

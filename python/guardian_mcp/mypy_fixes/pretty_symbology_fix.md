# 🧠 Mypy Fix Guide: `pretty_symbology.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/pretty/pretty_symbology.py`
**Lines:** `731`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/pretty/pretty_symbology.py --strict
```

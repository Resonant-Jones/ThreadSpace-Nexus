# 🧠 Mypy Fix Guide: `prettyprinter.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/tree/prettyprinter.py`
**Lines:** `627`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tree/prettyprinter.py --strict
```

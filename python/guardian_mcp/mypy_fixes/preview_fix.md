...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/preview.py`
**Lines:** `390`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/preview.py --strict
```

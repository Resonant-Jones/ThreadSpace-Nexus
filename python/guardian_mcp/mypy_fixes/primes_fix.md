...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/primes.py`
**Lines:** `784`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/primes.py --strict
```

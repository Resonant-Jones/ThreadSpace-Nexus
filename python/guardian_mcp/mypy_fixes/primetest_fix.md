...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/primetest.py`
**Lines:** `830`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/primetest.py --strict
```

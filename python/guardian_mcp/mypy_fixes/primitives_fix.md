...
**File:** `.venv/lib/python3.13/site-packages/proto/primitives.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/primitives.py --strict
```

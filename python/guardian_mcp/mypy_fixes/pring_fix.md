...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/pring.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/pring.py --strict
```

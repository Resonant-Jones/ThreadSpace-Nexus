# 🧠 Mypy Fix Guide: `print_coercion_tables.py`
...
**File:** `.venv/lib/python3.13/site-packages/numpy/testing/print_coercion_tables.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/testing/print_coercion_tables.py --strict
```

# 🧠 Mypy Fix Guide: `print_page_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/print_page_options.py`
**Lines:** `443`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/print_page_options.py --strict
```

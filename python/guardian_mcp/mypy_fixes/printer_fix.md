...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/printer.py`
**Lines:** `432`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/printer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/vector/printing.py`
**Lines:** `371`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/vector/printing.py --strict
```

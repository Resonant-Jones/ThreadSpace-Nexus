# 🧠 Mypy Fix Guide: `prisma_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/prisma_client.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/prisma_client.py --strict
```

# 🧠 Mypy Fix Guide: `prisma_migration.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/prisma_migration.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/prisma_migration.py --strict
```

# 🧠 Mypy Fix Guide: `probabilistic.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/tree/probabilistic.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tree/probabilistic.py --strict
```

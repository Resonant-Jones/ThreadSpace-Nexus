...
**File:** `.venv/lib/python3.13/site-packages/nltk/probability.py`
**Lines:** `2578`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/probability.py --strict
```

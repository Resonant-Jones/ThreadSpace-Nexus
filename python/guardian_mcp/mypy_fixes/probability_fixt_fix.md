# 🧠 Mypy Fix Guide: `probability_fixt.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/probability_fixt.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/probability_fixt.py --strict
```

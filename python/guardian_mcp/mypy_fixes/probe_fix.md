...
**File:** `.venv/lib/python3.13/site-packages/urllib3/http2/probe.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/urllib3/http2/probe.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/shellingham/posix/proc.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/shellingham/posix/proc.py --strict
```

# 🧠 Mypy Fix Guide: `process_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/process_attributes.py`
**Lines:** `240`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/process_attributes.py --strict
```

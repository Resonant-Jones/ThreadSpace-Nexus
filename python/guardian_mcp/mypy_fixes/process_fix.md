...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/process.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/process.py --strict
```

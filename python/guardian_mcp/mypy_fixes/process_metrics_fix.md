# 🧠 Mypy Fix Guide: `process_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/process_metrics.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/process_metrics.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/processors/pdf/processor.py`
**Lines:** `487`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/processors/pdf/processor.py --strict
```

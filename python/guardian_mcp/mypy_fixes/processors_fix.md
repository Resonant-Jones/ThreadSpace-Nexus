...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/engine/processors.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/engine/processors.py --strict
```

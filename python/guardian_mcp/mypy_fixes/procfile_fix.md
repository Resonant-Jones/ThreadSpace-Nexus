...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/procfile.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/procfile.py --strict
```

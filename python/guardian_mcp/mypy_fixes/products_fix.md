...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/products.py`
**Lines:** `605`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/products.py --strict
```

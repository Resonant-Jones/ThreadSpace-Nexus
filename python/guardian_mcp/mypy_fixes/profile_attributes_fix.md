# 🧠 Mypy Fix Guide: `profile_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/profile_attributes.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/profile_attributes.py --strict
```

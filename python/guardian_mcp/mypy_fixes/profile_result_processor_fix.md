# 🧠 Mypy Fix Guide: `profile_result_processor.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/profile_result_processor.py`
**Lines:** `358`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/profile_result_processor.py --strict
```

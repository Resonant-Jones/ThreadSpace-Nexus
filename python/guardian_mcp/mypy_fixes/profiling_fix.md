...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/profiling.py`
**Lines:** `324`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/profiling.py --strict
```

# 🧠 Mypy Fix Guide: `progress_bar.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/progress_bar.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/progress_bar.py --strict
```

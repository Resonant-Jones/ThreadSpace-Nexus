# 🧠 Mypy Fix Guide: `progress_bars.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/progress_bars.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/progress_bars.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/progress.py`
**Lines:** `1715`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/progress.py --strict
```

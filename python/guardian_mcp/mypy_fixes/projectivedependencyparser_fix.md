# 🧠 Mypy Fix Guide: `projectivedependencyparser.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/projectivedependencyparser.py`
**Lines:** `716`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/projectivedependencyparser.py --strict
```

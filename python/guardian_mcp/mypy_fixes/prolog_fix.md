...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/prolog.py`
**Lines:** `318`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/prolog.py --strict
```

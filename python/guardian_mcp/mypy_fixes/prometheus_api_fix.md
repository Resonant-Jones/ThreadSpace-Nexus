# 🧠 Mypy Fix Guide: `prometheus_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/prometheus_helpers/prometheus_api.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/prometheus_helpers/prometheus_api.py --strict
```

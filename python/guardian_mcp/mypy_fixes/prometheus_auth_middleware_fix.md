# 🧠 Mypy Fix Guide: `prometheus_auth_middleware.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/middleware/prometheus_auth_middleware.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/middleware/prometheus_auth_middleware.py --strict
```

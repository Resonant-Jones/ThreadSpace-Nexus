...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/prometheus.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/prometheus.py --strict
```

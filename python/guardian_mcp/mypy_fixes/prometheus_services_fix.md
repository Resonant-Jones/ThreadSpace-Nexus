# 🧠 Mypy Fix Guide: `prometheus_services.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/prometheus_services.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/prometheus_services.py --strict
```

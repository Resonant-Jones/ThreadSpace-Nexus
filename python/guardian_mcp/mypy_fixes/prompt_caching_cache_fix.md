# 🧠 Mypy Fix Guide: `prompt_caching_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/prompt_caching_cache.py`
**Lines:** `171`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/prompt_caching_cache.py --strict
```

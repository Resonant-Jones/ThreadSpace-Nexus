# 🧠 Mypy Fix Guide: `prompt_caching_deployment_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/pre_call_checks/prompt_caching_deployment_check.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/pre_call_checks/prompt_caching_deployment_check.py --strict
```

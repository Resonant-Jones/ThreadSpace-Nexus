# 🧠 Mypy Fix Guide: `prompt_encoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/prompt_encoder.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/prompt_encoder.py --strict
```

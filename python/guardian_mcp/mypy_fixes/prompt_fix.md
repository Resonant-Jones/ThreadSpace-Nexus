...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/prompt.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/prompt.py --strict
```

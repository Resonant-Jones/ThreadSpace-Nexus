# 🧠 Mypy Fix Guide: `prompt_injection_detection.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/prompt_injection_detection.py`
**Lines:** `282`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/prompt_injection_detection.py --strict
```

# 🧠 Mypy Fix Guide: `prompt_layer.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/prompt_layer.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/prompt_layer.py --strict
```

# 🧠 Mypy Fix Guide: `prompt_management_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/prompt_management_base.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/prompt_management_base.py --strict
```

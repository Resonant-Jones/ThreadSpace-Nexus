# 🧠 Mypy Fix Guide: `prompt_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/prompt_utils.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/prompt_utils.py --strict
```

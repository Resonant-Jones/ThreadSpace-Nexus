...
**File:** `.venv/lib/python3.13/site-packages/humanfriendly/prompts.py`
**Lines:** `376`
...
```bash
mypy .venv/lib/python3.13/site-packages/humanfriendly/prompts.py --strict
```

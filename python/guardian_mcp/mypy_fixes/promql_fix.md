...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/promql.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/promql.py --strict
```

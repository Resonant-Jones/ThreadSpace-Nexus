...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/propagators.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/propagators.py --strict
```

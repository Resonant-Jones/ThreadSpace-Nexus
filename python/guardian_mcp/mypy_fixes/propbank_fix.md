...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/propbank.py`
**Lines:** `519`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/propbank.py --strict
```

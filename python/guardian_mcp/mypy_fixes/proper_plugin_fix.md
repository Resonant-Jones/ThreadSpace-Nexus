# 🧠 Mypy Fix Guide: `proper_plugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/plugins/proper_plugin.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/plugins/proper_plugin.py --strict
```

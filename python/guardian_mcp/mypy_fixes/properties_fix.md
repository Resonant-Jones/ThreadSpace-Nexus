...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/properties.py`
**Lines:** `884`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/properties.py --strict
```

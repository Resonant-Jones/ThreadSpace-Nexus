...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/pros_cons.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/pros_cons.py --strict
```

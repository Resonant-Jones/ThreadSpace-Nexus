# 🧠 Mypy Fix Guide: `proto_builder.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/proto_builder.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/proto_builder.py --strict
```

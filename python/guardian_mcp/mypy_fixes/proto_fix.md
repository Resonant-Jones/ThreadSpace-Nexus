...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/proto.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/proto.py --strict
```

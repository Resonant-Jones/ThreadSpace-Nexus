...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/proto_json.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/proto_json.py --strict
```

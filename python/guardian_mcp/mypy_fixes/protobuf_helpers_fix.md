# 🧠 Mypy Fix Guide: `protobuf_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/protobuf_helpers.py`
**Lines:** `371`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/protobuf_helpers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/websockets/legacy/protocol.py`
**Lines:** `1641`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/legacy/protocol.py --strict
```

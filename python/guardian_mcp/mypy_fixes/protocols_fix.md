...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/protocols.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/protocols.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/protos.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/protos.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/inference/prover9.py`
**Lines:** `507`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/inference/prover9.py --strict
```

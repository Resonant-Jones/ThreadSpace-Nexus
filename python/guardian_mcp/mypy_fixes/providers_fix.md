...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/resolvelib/providers.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/resolvelib/providers.py --strict
```

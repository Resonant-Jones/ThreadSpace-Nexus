...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/provision.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/provision.py --strict
```

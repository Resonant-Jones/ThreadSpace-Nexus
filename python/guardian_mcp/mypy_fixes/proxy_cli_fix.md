...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/proxy_cli.py`
**Lines:** `826`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/proxy_cli.py --strict
```

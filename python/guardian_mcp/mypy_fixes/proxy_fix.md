...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/proxy.py`
**Lines:** `307`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/proxy.py --strict
```

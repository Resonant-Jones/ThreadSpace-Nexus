# 🧠 Mypy Fix Guide: `proxy_headers.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/middleware/proxy_headers.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/middleware/proxy_headers.py --strict
```

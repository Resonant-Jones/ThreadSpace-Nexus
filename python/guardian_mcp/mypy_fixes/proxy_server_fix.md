# 🧠 Mypy Fix Guide: `proxy_server.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/proxy_server.py`
**Lines:** `8299`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/proxy_server.py --strict
```

# 🧠 Mypy Fix Guide: `proxy_setting_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/ui_crud_endpoints/proxy_setting_endpoints.py`
**Lines:** `436`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/ui_crud_endpoints/proxy_setting_endpoints.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/proxy_state.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/proxy_state.py --strict
```

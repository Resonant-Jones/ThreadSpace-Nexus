# 🧠 Mypy Fix Guide: `proxy_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/proxy_strategy.py`
**Lines:** `158`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/proxy_strategy.py --strict
```

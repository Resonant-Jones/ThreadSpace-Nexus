# 🧠 Mypy Fix Guide: `proxy_track_cost_callback.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/proxy_track_cost_callback.py`
**Lines:** `255`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/proxy_track_cost_callback.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/prql.py`
**Lines:** `251`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/prql.py --strict
```

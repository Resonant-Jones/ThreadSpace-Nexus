...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/prufer.py`
**Lines:** `435`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/prufer.py --strict
```

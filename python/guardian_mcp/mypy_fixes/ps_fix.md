...
**File:** `.venv/lib/python3.13/site-packages/shellingham/posix/ps.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/shellingham/posix/ps.py --strict
```

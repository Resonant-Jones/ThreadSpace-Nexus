# 🧠 Mypy Fix Guide: `pseudocolumns.py`
...
**File:** `.venv/lib/python3.13/site-packages/pypika/pseudocolumns.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/pseudocolumns.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/psycopg2.py`
**Lines:** `892`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/psycopg2.py --strict
```

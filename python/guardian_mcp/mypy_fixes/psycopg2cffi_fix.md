# 🧠 Mypy Fix Guide: `psycopg2cffi.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/psycopg2cffi.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/psycopg2cffi.py --strict
```

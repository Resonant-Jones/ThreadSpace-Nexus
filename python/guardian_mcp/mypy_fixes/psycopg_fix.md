...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/psycopg.py`
**Lines:** `783`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/psycopg.py --strict
```

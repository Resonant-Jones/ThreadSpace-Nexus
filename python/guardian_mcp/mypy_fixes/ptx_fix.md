...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ptx.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ptx.py --strict
```

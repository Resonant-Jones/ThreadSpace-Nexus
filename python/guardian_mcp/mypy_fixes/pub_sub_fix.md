...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/gcs_pubsub/pub_sub.py`
**Lines:** `214`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/gcs_pubsub/pub_sub.py --strict
```

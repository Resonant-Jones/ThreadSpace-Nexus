...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/puiseux.py`
**Lines:** `795`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/puiseux.py --strict
```

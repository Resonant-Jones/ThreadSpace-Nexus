...
**File:** `.venv/lib/python3.13/site-packages/defusedxml/pulldom.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/defusedxml/pulldom.py --strict
```

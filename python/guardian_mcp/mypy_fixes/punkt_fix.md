...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/punkt.py`
**Lines:** `1826`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/punkt.py --strict
```

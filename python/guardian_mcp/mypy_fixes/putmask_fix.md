...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/putmask.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/putmask.py --strict
```

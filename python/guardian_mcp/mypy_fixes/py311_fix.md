...
**File:** `.venv/lib/python3.13/site-packages/importlib_metadata/compat/py311.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/importlib_metadata/compat/py311.py --strict
```

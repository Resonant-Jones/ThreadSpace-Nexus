...
**File:** `.venv/lib/python3.13/site-packages/setuptools/compat/py312.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/compat/py312.py --strict
```

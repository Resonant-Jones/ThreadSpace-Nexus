...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/inflect/compat/py38.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/inflect/compat/py38.py --strict
```

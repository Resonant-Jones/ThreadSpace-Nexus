...
**File:** `.venv/lib/python3.13/site-packages/importlib_metadata/compat/py39.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/importlib_metadata/compat/py39.py --strict
```

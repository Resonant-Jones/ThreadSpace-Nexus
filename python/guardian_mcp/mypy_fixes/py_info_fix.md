...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/discovery/py_info.py`
**Lines:** `590`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/discovery/py_info.py --strict
```

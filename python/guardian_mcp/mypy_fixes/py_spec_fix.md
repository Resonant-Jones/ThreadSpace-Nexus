...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/discovery/py_spec.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/discovery/py_spec.py --strict
```

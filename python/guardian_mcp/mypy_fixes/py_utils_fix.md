...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/py_utils.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/py_utils.py --strict
```

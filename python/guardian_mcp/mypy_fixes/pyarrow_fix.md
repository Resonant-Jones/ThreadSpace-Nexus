...
**File:** `.venv/lib/python3.13/site-packages/pandas/compat/pyarrow.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/compat/pyarrow.py --strict
```

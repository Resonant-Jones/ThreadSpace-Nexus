# 🧠 Mypy Fix Guide: `pyclasslookup.py`
...
**File:** `.venv/lib/python3.13/site-packages/lxml/pyclasslookup.py`
**Lines:** `3`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/pyclasslookup.py --strict
```

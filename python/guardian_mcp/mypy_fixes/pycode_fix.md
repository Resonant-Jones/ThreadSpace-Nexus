...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/pycode.py`
**Lines:** `852`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/pycode.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/flake8/plugins/pycodestyle.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/plugins/pycodestyle.py --strict
```

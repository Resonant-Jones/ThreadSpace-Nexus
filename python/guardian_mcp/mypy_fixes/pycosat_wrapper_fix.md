# 🧠 Mypy Fix Guide: `pycosat_wrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/algorithms/pycosat_wrapper.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/algorithms/pycosat_wrapper.py --strict
```

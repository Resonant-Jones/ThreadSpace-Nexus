...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/pyenv_cfg.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/pyenv_cfg.py --strict
```

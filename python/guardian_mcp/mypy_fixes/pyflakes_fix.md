...
**File:** `.venv/lib/python3.13/site-packages/flake8/plugins/pyflakes.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/plugins/pyflakes.py --strict
```

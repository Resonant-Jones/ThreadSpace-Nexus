...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/pygrep.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/pygrep.py --strict
```

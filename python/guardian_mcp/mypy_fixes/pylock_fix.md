...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/pylock.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/pylock.py --strict
```

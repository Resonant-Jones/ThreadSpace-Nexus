...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/pymssql.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/pymssql.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/pymysql.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/pymysql.py --strict
```

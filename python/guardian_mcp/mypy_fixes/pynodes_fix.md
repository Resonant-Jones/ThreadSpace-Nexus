...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/pynodes.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/pynodes.py --strict
```

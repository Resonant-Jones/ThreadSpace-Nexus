...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/pyodbc.py`
**Lines:** `760`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mssql/pyodbc.py --strict
```

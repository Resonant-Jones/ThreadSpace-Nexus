...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/pyopenssl.py`
**Lines:** `518`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/pyopenssl.py --strict
```

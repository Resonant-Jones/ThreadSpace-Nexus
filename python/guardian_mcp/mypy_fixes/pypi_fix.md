...
**File:** `.venv/lib/python3.13/site-packages/piptools/repositories/pypi.py`
**Lines:** `502`
...
```bash
mypy .venv/lib/python3.13/site-packages/piptools/repositories/pypi.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/pyproject.py`
**Lines:** `185`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/pyproject.py --strict
```

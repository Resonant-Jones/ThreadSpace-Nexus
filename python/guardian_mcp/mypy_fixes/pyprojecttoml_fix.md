# 🧠 Mypy Fix Guide: `pyprojecttoml.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/config/pyprojecttoml.py`
**Lines:** `468`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/config/pyprojecttoml.py --strict
```

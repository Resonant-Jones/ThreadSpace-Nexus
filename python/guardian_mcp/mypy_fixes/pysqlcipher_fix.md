...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/sqlite/pysqlcipher.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/sqlite/pysqlcipher.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/sqlite/pysqlite.py`
**Lines:** `705`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/sqlite/pysqlite.py --strict
```

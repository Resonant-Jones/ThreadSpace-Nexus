...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/computation/pytables.py`
**Lines:** `666`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/computation/pytables.py --strict
```

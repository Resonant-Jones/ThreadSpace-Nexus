...
**File:** `.venv/lib/python3.13/site-packages/sympy/testing/pytest.py`
**Lines:** `392`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/testing/pytest.py --strict
```

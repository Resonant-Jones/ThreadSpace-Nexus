# 🧠 Mypy Fix Guide: `pytest_plugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/pytest_plugin.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/pytest_plugin.py --strict
```

# 🧠 Mypy Fix Guide: `pytester_assertions.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/pytester_assertions.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/pytester_assertions.py --strict
```

# 🧠 Mypy Fix Guide: `pytestplugin.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/plugin/pytestplugin.py`
**Lines:** `867`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/plugin/pytestplugin.py --strict
```

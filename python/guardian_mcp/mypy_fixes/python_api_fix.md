...
**File:** `.venv/lib/python3.13/site-packages/_pytest/python_api.py`
**Lines:** `793`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/python_api.py --strict
```

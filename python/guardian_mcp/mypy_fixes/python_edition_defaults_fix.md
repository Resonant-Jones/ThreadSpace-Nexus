# 🧠 Mypy Fix Guide: `python_edition_defaults.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/python_edition_defaults.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/python_edition_defaults.py --strict
```

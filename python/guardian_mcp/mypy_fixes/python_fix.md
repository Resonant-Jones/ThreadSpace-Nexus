...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/python.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/python.py --strict
```

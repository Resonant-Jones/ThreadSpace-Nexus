# 🧠 Mypy Fix Guide: `python_grader.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/python_grader.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/python_grader.py --strict
```

# 🧠 Mypy Fix Guide: `python_grader_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/python_grader_param.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/python_grader_param.py --strict
```

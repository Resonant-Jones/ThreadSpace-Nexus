# 🧠 Mypy Fix Guide: `pythonfinitefield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/pythonfinitefield.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/pythonfinitefield.py --strict
```

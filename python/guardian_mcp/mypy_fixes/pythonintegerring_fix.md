# 🧠 Mypy Fix Guide: `pythonintegerring.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/pythonintegerring.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/pythonintegerring.py --strict
```

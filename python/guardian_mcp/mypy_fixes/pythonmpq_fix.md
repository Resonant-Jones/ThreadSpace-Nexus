...
**File:** `.venv/lib/python3.13/site-packages/sympy/external/pythonmpq.py`
**Lines:** `341`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/external/pythonmpq.py --strict
```

# 🧠 Mypy Fix Guide: `pythonrational.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/pythonrational.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/pythonrational.py --strict
```

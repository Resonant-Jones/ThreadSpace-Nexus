# 🧠 Mypy Fix Guide: `pythonrationalfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/pythonrationalfield.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/pythonrationalfield.py --strict
```

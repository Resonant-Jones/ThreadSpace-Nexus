# 🧠 Mypy Fix Guide: `pytorch_export_contrib_ops.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/pytorch_export_contrib_ops.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/pytorch_export_contrib_ops.py --strict
```

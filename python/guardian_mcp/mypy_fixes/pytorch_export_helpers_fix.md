# 🧠 Mypy Fix Guide: `pytorch_export_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/pytorch_export_helpers.py`
**Lines:** `131`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/pytorch_export_helpers.py --strict
```

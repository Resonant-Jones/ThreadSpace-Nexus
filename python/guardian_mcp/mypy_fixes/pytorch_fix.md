...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/pytorch.py`
**Lines:** `297`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/pytorch.py --strict
```

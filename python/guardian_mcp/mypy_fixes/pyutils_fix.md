...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/pyutils.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/pyutils.py --strict
```

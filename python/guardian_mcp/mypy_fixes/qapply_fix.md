...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/qapply.py`
**Lines:** `263`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/qapply.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/qasm.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/qasm.py --strict
```

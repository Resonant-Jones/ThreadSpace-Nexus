# 🧠 Mypy Fix Guide: `qdq_base_operator.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/qdq_base_operator.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/qdq_base_operator.py --strict
```

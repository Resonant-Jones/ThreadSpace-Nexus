# 🧠 Mypy Fix Guide: `qdq_loss_debug.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/qdq_loss_debug.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/qdq_loss_debug.py --strict
```

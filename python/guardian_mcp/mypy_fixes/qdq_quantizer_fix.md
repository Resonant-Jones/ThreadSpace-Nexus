# 🧠 Mypy Fix Guide: `qdq_quantizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/qdq_quantizer.py`
**Lines:** `1478`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/qdq_quantizer.py --strict
```

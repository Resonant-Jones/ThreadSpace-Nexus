# 🧠 Mypy Fix Guide: `qdrant_semantic_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/qdrant_semantic_cache.py`
**Lines:** `442`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/qdrant_semantic_cache.py --strict
```

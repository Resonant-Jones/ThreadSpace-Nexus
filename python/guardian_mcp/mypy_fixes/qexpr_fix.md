...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/qexpr.py`
**Lines:** `409`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/qexpr.py --strict
```

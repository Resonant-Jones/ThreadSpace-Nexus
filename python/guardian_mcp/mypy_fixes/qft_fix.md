...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/qft.py`
**Lines:** `215`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/qft.py --strict
```

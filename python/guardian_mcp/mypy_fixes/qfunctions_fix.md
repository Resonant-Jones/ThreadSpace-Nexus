...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/qfunctions.py`
**Lines:** `280`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/qfunctions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/qho_1d.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/qho_1d.py --strict
```

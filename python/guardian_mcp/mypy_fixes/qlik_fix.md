...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/qlik.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/qlik.py --strict
```

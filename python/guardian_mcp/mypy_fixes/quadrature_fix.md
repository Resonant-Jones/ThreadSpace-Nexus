...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/quadrature.py`
**Lines:** `617`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/quadrature.py --strict
```

# 🧠 Mypy Fix Guide: `quality_unicode.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/testing/quality_unicode.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/testing/quality_unicode.py --strict
```

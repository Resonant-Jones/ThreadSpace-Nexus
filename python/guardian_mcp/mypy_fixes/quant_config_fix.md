# 🧠 Mypy Fix Guide: `quant_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/quant_config.py`
**Lines:** `406`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/execution_providers/qnn/quant_config.py --strict
```

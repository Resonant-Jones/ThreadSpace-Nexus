# 🧠 Mypy Fix Guide: `quant_kv_dataloader.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/quant_kv_dataloader.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/llama/quant_kv_dataloader.py --strict
```

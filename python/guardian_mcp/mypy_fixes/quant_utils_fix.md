...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/quant_utils.py`
**Lines:** `1021`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/quant_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/quantile.py`
**Lines:** `226`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/quantile.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/quantities.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/quantities.py --strict
```

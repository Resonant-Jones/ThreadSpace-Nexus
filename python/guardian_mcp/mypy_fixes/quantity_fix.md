...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/utils/quantity.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/utils/quantity.py --strict
```

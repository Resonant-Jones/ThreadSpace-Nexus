...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/quantize.py`
**Lines:** `943`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/quantize.py --strict
```

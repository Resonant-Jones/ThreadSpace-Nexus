# 🧠 Mypy Fix Guide: `quantize_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/quantize_helper.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/quantize_helper.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/algebras/quaternion.py`
**Lines:** `1666`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/algebras/quaternion.py --strict
```

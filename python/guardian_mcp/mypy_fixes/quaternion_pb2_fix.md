# 🧠 Mypy Fix Guide: `quaternion_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/type/quaternion_pb2.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/type/quaternion_pb2.py --strict
```

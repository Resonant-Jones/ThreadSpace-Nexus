...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/qubit.py`
**Lines:** `811`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/qubit.py --strict
```

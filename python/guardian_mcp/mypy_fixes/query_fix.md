...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/query.py`
**Lines:** `3453`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/query.py --strict
```

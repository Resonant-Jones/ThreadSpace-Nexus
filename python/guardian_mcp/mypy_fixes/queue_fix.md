...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/queue.py`
**Lines:** `322`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/queue.py --strict
```

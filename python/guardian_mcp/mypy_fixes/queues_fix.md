...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/queues.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/queues.py --strict
```

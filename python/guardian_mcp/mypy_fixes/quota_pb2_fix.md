...
**File:** `.venv/lib/python3.13/site-packages/google/api/quota_pb2.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/quota_pb2.py --strict
```

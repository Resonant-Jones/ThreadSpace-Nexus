# 🧠 Mypy Fix Guide: `quotientring.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/quotientring.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/quotientring.py --strict
```

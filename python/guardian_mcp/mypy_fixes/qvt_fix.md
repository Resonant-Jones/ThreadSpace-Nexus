...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/qvt.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/qvt.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/radsimp.py`
**Lines:** `1234`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/radsimp.py --strict
```

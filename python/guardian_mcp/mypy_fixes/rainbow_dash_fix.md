# 🧠 Mypy Fix Guide: `rainbow_dash.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/rainbow_dash.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/rainbow_dash.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/type_tests/raisesgroup.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/type_tests/raisesgroup.py --strict
```

# 🧠 Mypy Fix Guide: `random_matrix.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/random_matrix.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/random_matrix.py --strict
```

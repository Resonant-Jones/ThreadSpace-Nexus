# 🧠 Mypy Fix Guide: `random_matrix_models.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/random_matrix_models.py`
**Lines:** `457`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/random_matrix_models.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/testing/randtest.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/testing/randtest.py --strict
```

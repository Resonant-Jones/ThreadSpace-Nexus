...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/range.py`
**Lines:** `1187`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/range.py --strict
```

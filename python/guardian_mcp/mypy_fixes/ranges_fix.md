...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/ranges.py`
**Lines:** `1031`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/postgresql/ranges.py --strict
```

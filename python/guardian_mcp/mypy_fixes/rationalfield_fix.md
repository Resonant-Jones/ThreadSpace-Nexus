# 🧠 Mypy Fix Guide: `rationalfield.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/rationalfield.py`
**Lines:** `200`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/rationalfield.py --strict
```

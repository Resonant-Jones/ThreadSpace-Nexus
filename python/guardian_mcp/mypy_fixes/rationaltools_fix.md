# 🧠 Mypy Fix Guide: `rationaltools.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/rationaltools.py`
**Lines:** `445`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/rationaltools.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/ratsimp.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/ratsimp.py --strict
```

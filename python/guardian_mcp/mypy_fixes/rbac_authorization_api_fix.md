# 🧠 Mypy Fix Guide: `rbac_authorization_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/rbac_authorization_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/rbac_authorization_api.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/rcode.py`
**Lines:** `402`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/rcode.py --strict
```

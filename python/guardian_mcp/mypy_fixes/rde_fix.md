...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/rde.py`
**Lines:** `800`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/rde.py --strict
```

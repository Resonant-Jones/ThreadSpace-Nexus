...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/rdf.py`
**Lines:** `468`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/rdf.py --strict
```

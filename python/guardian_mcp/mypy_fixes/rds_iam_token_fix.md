# 🧠 Mypy Fix Guide: `rds_iam_token.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/rds_iam_token.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/rds_iam_token.py --strict
```

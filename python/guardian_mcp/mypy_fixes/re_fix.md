...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/util/re.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/util/re.py --strict
```

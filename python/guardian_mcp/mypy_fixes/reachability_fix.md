# 🧠 Mypy Fix Guide: `reachability.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/reachability.py`
**Lines:** `362`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/reachability.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/app_data/read_only.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/app_data/read_only.py --strict
```

# 🧠 Mypy Fix Guide: `read_write_lock.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/read_write_lock.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/read_write_lock.py --strict
```

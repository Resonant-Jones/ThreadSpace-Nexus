...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_websocket/reader_c.py`
**Lines:** `476`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_websocket/reader_c.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_websocket/reader.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_websocket/reader.py --strict
```

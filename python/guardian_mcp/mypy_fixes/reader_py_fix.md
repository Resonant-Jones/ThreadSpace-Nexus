...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_websocket/reader_py.py`
**Lines:** `476`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_websocket/reader_py.py --strict
```

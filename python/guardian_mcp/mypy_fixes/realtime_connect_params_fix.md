# 🧠 Mypy Fix Guide: `realtime_connect_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/realtime_connect_params.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/realtime_connect_params.py --strict
```

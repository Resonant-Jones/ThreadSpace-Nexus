...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/realtime.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/realtime.py --strict
```

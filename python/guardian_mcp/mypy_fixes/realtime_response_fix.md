# 🧠 Mypy Fix Guide: `realtime_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/realtime_response.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/realtime_response.py --strict
```

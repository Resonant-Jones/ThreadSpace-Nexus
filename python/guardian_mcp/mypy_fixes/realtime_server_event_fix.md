# 🧠 Mypy Fix Guide: `realtime_server_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/realtime_server_event.py`
**Lines:** `133`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/realtime_server_event.py --strict
```

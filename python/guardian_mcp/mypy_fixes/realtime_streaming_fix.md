# 🧠 Mypy Fix Guide: `realtime_streaming.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/realtime_streaming.py`
**Lines:** `218`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/realtime_streaming.py --strict
```

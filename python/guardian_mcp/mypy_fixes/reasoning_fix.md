...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/reasoning.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/reasoning.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/reauth.py`
**Lines:** `369`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/reauth.py --strict
```

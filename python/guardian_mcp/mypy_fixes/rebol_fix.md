...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/rebol.py`
**Lines:** `419`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/rebol.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/dateutil/zoneinfo/rebuild.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/dateutil/zoneinfo/rebuild.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/more_itertools/recipes.py`
**Lines:** `1046`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/more_itertools/recipes.py --strict
```

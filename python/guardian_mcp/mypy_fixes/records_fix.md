...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/records.py`
**Lines:** `1089`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/records.py --strict
```

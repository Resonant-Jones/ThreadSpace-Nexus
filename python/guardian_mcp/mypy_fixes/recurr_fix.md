...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/recurr.py`
**Lines:** `843`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/recurr.py --strict
```

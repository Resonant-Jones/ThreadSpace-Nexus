...
**File:** `.venv/lib/python3.13/site-packages/sympy/holonomic/recurrence.py`
**Lines:** `342`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/holonomic/recurrence.py --strict
```

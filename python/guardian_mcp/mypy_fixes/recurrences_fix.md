...
**File:** `.venv/lib/python3.13/site-packages/sympy/discrete/recurrences.py`
**Lines:** `166`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/discrete/recurrences.py --strict
```

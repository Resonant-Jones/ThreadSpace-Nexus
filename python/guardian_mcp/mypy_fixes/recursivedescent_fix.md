# 🧠 Mypy Fix Guide: `recursivedescent.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/recursivedescent.py`
**Lines:** `684`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/recursivedescent.py --strict
```

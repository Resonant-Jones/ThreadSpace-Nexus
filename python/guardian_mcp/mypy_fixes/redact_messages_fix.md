# 🧠 Mypy Fix Guide: `redact_messages.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/redact_messages.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/redact_messages.py --strict
```

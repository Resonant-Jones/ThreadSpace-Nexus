# 🧠 Mypy Fix Guide: `redis_cluster_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/redis_cluster_cache.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/redis_cluster_cache.py --strict
```

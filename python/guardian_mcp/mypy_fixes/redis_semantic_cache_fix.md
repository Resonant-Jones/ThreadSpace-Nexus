# 🧠 Mypy Fix Guide: `redis_semantic_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/redis_semantic_cache.py`
**Lines:** `450`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/redis_semantic_cache.py --strict
```

# 🧠 Mypy Fix Guide: `redis_update_buffer.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/redis_update_buffer.py`
**Lines:** `422`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/redis_update_buffer.py --strict
```

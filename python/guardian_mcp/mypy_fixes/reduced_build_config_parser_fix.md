# 🧠 Mypy Fix Guide: `reduced_build_config_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/reduced_build_config_parser.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/reduced_build_config_parser.py --strict
```

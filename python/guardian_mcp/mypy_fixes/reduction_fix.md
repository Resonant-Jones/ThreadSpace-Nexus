...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/reduction.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/reduction.py --strict
```

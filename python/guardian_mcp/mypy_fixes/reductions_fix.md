...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/reductions.py`
**Lines:** `387`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/reductions.py --strict
```

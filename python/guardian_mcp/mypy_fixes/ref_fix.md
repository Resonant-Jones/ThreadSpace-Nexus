...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/ref.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/ref.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/transform/refcount.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/transform/refcount.py --strict
```

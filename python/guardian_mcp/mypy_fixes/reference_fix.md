...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/reference.py`
**Lines:** `1305`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/reference.py --strict
```

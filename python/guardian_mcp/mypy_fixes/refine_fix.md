...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/refine.py`
**Lines:** `405`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/refine.py --strict
```

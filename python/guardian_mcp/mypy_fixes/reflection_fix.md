...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/reflection.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/reflection.py --strict
```

# 🧠 Mypy Fix Guide: `refresh_token.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/grant_types/refresh_token.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/grant_types/refresh_token.py --strict
```

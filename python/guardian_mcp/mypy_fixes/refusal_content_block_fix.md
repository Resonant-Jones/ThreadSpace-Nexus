# 🧠 Mypy Fix Guide: `refusal_content_block.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/refusal_content_block.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/refusal_content_block.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/regexopt.py`
**Lines:** `91`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/regexopt.py --strict
```

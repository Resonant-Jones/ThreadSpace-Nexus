...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/regexp.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/regexp.py --strict
```

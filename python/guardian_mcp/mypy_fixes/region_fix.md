...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/region.py`
**Lines:** `10`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/region.py --strict
```

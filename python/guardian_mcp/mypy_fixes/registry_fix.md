...
**File:** `.venv/lib/python3.13/site-packages/mypyc/lower/registry.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/lower/registry.py --strict
```

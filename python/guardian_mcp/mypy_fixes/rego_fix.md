...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/rego.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/rego.py --strict
```

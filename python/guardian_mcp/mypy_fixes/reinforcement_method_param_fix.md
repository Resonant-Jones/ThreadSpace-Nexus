# 🧠 Mypy Fix Guide: `reinforcement_method_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/reinforcement_method_param.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/reinforcement_method_param.py --strict
```

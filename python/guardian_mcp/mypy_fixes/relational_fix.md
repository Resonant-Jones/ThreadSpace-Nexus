...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/relational.py`
**Lines:** `1622`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/relational.py --strict
```

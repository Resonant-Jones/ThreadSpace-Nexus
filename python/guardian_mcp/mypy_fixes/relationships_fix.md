# 🧠 Mypy Fix Guide: `relationships.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/relationships.py`
**Lines:** `3509`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/relationships.py --strict
```

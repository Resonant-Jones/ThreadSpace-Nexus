# 🧠 Mypy Fix Guide: `relative_locator.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/relative_locator.py`
**Lines:** `368`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/relative_locator.py --strict
```

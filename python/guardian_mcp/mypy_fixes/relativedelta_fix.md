# 🧠 Mypy Fix Guide: `relativedelta.py`
...
**File:** `.venv/lib/python3.13/site-packages/dateutil/relativedelta.py`
**Lines:** `599`
...
```bash
mypy .venv/lib/python3.13/site-packages/dateutil/relativedelta.py --strict
```

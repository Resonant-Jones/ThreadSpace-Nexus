...
**File:** `.venv/lib/python3.13/site-packages/nltk/sem/relextract.py`
**Lines:** `539`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/sem/relextract.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/renderer.py`
**Lines:** `336`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/renderer.py --strict
```

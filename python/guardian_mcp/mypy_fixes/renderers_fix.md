...
**File:** `.venv/lib/python3.13/site-packages/mistune/renderers.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/renderers.py --strict
```

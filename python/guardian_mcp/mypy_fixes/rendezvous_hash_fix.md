# 🧠 Mypy Fix Guide: `rendezvous_hash.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/rendezvous_hash.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/rendezvous_hash.py --strict
```

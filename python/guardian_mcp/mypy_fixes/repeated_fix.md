...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/collections/repeated.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/collections/repeated.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/replace.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/replace.py --strict
```

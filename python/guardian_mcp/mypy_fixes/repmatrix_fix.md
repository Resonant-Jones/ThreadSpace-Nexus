...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/repmatrix.py`
**Lines:** `1034`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/repmatrix.py --strict
```

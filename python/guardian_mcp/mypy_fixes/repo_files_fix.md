...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/repo_files.py`
**Lines:** `128`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/repo_files.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/repo.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/repo.py --strict
```

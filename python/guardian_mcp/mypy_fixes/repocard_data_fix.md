# 🧠 Mypy Fix Guide: `repocard_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/repocard_data.py`
**Lines:** `770`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/repocard_data.py --strict
```

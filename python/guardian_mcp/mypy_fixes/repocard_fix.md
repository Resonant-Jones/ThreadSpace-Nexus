...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/repocard.py`
**Lines:** `830`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/repocard.py --strict
```

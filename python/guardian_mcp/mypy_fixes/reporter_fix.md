...
**File:** `.venv/lib/python3.13/site-packages/flake8/plugins/reporter.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/plugins/reporter.py --strict
```

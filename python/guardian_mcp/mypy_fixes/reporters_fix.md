...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/resolvelib/reporters.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/resolvelib/reporters.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/repository.py`
**Lines:** `237`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/repository.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/repr.py`
**Lines:** `339`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/repr.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/represent.py`
**Lines:** `574`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/represent.py --strict
```

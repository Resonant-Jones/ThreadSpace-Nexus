...
**File:** `.venv/lib/python3.13/site-packages/yaml/representer.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/yaml/representer.py --strict
```

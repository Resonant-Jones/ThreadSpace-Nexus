...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/req_command.py`
**Lines:** `347`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/req_command.py --strict
```

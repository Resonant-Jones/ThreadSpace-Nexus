# 🧠 Mypy Fix Guide: `req_dependency_group.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/req/req_dependency_group.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/req/req_dependency_group.py --strict
```

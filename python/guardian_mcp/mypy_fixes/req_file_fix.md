...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/req/req_file.py`
**Lines:** `623`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/req/req_file.py --strict
```

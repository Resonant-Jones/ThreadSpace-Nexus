...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/req/req_install.py`
**Lines:** `934`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/req/req_install.py --strict
```

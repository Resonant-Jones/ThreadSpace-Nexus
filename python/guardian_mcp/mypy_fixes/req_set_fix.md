...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/req/req_set.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/req/req_set.py --strict
```

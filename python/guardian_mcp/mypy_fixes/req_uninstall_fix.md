# 🧠 Mypy Fix Guide: `req_uninstall.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/req/req_uninstall.py`
**Lines:** `636`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/req/req_uninstall.py --strict
```

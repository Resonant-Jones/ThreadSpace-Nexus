...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/request.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/request.py --strict
```

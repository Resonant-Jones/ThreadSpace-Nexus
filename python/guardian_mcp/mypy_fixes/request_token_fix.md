# 🧠 Mypy Fix Guide: `request_token.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/endpoints/request_token.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/endpoints/request_token.py --strict
```

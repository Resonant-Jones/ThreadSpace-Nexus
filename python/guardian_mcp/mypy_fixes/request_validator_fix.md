# 🧠 Mypy Fix Guide: `request_validator.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/request_validator.py`
**Lines:** `680`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/request_validator.py --strict
```

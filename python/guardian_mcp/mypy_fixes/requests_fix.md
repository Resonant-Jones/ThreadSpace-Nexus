...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/requests.py`
**Lines:** `602`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/requests.py --strict
```

# 🧠 Mypy Fix Guide: `required_action_function_tool_call.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/required_action_function_tool_call.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/required_action_function_tool_call.py --strict
```

# 🧠 Mypy Fix Guide: `requirements.py`
...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/requirements.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/requirements.py --strict
```

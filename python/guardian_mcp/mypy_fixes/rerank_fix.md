...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/rerank.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/rerank.py --strict
```

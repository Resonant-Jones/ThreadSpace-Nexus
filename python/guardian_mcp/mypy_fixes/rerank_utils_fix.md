# 🧠 Mypy Fix Guide: `rerank_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/rerank_api/rerank_utils.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/rerank_api/rerank_utils.py --strict
```

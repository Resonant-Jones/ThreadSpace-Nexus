...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/resample.py`
**Lines:** `2920`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/resample.py --strict
```

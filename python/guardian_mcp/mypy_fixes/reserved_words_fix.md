# 🧠 Mypy Fix Guide: `reserved_words.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/reserved_words.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/dialects/mysql/reserved_words.py --strict
```

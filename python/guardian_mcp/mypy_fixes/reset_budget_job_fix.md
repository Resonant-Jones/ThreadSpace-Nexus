# 🧠 Mypy Fix Guide: `reset_budget_job.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/reset_budget_job.py`
**Lines:** `545`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/reset_budget_job.py --strict
```

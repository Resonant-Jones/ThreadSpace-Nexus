...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/reshape/reshape.py`
**Lines:** `989`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/reshape/reshape.py --strict
```

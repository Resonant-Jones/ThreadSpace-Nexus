# 🧠 Mypy Fix Guide: `residue_ntheory.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/ntheory/residue_ntheory.py`
**Lines:** `1963`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/ntheory/residue_ntheory.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/residues.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/residues.py --strict
```

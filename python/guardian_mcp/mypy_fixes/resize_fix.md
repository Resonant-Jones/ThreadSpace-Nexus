...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/resize.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/resize.py --strict
```

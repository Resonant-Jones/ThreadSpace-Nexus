...
**File:** `.venv/lib/python3.13/site-packages/nltk/inference/resolution.py`
**Lines:** `759`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/inference/resolution.py --strict
```

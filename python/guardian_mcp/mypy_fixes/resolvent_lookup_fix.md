# 🧠 Mypy Fix Guide: `resolvent_lookup.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/resolvent_lookup.py`
**Lines:** `456`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/resolvent_lookup.py --strict
```

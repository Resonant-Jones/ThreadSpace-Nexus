# 🧠 Mypy Fix Guide: `resource_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/resource_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/resource_api.py --strict
```

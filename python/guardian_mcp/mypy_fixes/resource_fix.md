...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/resource.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/resource.py --strict
```

# 🧠 Mypy Fix Guide: `resource_owner_password_credentials.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/grant_types/resource_owner_password_credentials.py`
**Lines:** `199`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/grant_types/resource_owner_password_credentials.py --strict
```

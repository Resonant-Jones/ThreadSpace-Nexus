# 🧠 Mypy Fix Guide: `resource_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/resource/v1/resource_pb2.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/resource/v1/resource_pb2.py --strict
```

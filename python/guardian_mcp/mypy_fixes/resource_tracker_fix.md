# 🧠 Mypy Fix Guide: `resource_tracker.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/resource_tracker.py`
**Lines:** `351`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/resource_tracker.py --strict
```

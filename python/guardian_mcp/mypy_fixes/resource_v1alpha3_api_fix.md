# 🧠 Mypy Fix Guide: `resource_v1alpha3_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/resource_v1alpha3_api.py`
**Lines:** `6214`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/resource_v1alpha3_api.py --strict
```

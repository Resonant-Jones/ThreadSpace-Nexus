# 🧠 Mypy Fix Guide: `resource_v1beta1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/resource_v1beta1_api.py`
**Lines:** `5177`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/resource_v1beta1_api.py --strict
```

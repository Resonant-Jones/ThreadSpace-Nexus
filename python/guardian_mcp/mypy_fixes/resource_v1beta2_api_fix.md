# 🧠 Mypy Fix Guide: `resource_v1beta2_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/resource_v1beta2_api.py`
**Lines:** `5177`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/resource_v1beta2_api.py --strict
```

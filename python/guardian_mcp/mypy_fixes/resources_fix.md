...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/distlib/resources.py`
**Lines:** `358`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/distlib/resources.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/responder.py`
**Lines:** `625`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/responder.py --strict
```

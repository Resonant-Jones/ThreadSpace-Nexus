# 🧠 Mypy Fix Guide: `response_code_interpreter_call_in_progress_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_code_interpreter_call_in_progress_event.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_code_interpreter_call_in_progress_event.py --strict
```

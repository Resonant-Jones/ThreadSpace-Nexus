# 🧠 Mypy Fix Guide: `response_completed_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_completed_event.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_completed_event.py --strict
```

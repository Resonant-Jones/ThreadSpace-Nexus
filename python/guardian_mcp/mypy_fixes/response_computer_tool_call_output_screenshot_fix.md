# 🧠 Mypy Fix Guide: `response_computer_tool_call_output_screenshot.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_computer_tool_call_output_screenshot.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_computer_tool_call_output_screenshot.py --strict
```

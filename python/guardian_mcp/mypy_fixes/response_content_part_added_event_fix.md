# 🧠 Mypy Fix Guide: `response_content_part_added_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/response_content_part_added_event.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/response_content_part_added_event.py --strict
```

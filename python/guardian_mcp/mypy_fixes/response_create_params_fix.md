# 🧠 Mypy Fix Guide: `response_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_create_params.py`
**Lines:** `239`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_create_params.py --strict
```

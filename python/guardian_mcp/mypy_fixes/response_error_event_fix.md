# 🧠 Mypy Fix Guide: `response_error_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_error_event.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_error_event.py --strict
```

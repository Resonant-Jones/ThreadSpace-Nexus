...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/response.py`
**Lines:** `107`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/response.py --strict
```

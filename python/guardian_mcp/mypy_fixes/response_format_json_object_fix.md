# 🧠 Mypy Fix Guide: `response_format_json_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/response_format_json_object.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/response_format_json_object.py --strict
```

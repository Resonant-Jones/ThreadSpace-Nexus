# 🧠 Mypy Fix Guide: `response_format_json_schema.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/response_format_json_schema.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/response_format_json_schema.py --strict
```

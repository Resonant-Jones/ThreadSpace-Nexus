# 🧠 Mypy Fix Guide: `response_function_call_arguments_done_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/response_function_call_arguments_done_event.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/response_function_call_arguments_done_event.py --strict
```

# 🧠 Mypy Fix Guide: `response_function_tool_call_output_item.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_function_tool_call_output_item.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_function_tool_call_output_item.py --strict
```

# 🧠 Mypy Fix Guide: `response_function_tool_call_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_function_tool_call_param.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_function_tool_call_param.py --strict
```

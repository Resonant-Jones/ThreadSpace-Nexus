# 🧠 Mypy Fix Guide: `response_function_web_search.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_function_web_search.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_function_web_search.py --strict
```

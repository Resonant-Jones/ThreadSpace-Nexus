# 🧠 Mypy Fix Guide: `response_header_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/response_header_helpers.py`
**Lines:** `0`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/response_header_helpers.py --strict
```

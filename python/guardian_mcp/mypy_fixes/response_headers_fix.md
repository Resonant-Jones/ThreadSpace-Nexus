# 🧠 Mypy Fix Guide: `response_headers.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/response_headers.py`
**Lines:** `0`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/response_headers.py --strict
```

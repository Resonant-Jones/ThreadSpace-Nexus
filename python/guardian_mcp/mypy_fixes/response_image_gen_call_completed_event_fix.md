# 🧠 Mypy Fix Guide: `response_image_gen_call_completed_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_image_gen_call_completed_event.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_image_gen_call_completed_event.py --strict
```

# 🧠 Mypy Fix Guide: `response_metadata.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/response_metadata.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_response_utils/response_metadata.py --strict
```

# 🧠 Mypy Fix Guide: `response_reasoning_done_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_reasoning_done_event.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_reasoning_done_event.py --strict
```

# 🧠 Mypy Fix Guide: `response_reasoning_summary_part_done_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/response_reasoning_summary_part_done_event.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/response_reasoning_summary_part_done_event.py --strict
```

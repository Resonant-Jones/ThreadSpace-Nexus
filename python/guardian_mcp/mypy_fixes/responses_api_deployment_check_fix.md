# 🧠 Mypy Fix Guide: `responses_api_deployment_check.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/pre_call_checks/responses_api_deployment_check.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/pre_call_checks/responses_api_deployment_check.py --strict
```

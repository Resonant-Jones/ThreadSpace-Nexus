...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/responses/responses.py`
**Lines:** `2599`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/responses/responses.py --strict
```

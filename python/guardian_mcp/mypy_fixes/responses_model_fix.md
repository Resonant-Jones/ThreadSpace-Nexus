# 🧠 Mypy Fix Guide: `responses_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/shared_params/responses_model.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/shared_params/responses_model.py --strict
```

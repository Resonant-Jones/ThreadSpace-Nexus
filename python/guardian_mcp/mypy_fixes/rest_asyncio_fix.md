# 🧠 Mypy Fix Guide: `rest_asyncio.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/operations_v1/transports/rest_asyncio.py`
**Lines:** `560`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/operations_v1/transports/rest_asyncio.py --strict
```

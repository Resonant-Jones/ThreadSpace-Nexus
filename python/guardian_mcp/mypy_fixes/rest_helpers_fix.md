# 🧠 Mypy Fix Guide: `rest_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/rest_helpers.py`
**Lines:** `109`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/rest_helpers.py --strict
```

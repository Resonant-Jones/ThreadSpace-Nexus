# 🧠 Mypy Fix Guide: `rest_streaming_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/rest_streaming_async.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/rest_streaming_async.py --strict
```

# 🧠 Mypy Fix Guide: `rest_streaming.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/rest_streaming.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/rest_streaming.py --strict
```

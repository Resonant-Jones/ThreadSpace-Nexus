...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/result.py`
**Lines:** `962`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/result.py --strict
```

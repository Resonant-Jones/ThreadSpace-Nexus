...
**File:** `.venv/lib/python3.13/site-packages/chardet/resultdict.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/resultdict.py --strict
```

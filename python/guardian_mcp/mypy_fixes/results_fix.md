...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/results.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/results.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/referencing/retrieval.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/referencing/retrieval.py --strict
```

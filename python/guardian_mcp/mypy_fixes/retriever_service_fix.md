# 🧠 Mypy Fix Guide: `retriever_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/retriever_service.py`
**Lines:** `793`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/retriever_service.py --strict
```

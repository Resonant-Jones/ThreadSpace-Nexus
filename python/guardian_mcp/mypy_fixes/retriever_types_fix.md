# 🧠 Mypy Fix Guide: `retriever_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/retriever_types.py`
**Lines:** `1698`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/retriever_types.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/retry_async.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/retry_async.py --strict
```

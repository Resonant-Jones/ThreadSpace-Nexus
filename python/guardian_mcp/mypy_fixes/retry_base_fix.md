...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/retry/retry_base.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/retry/retry_base.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/tenacity/asyncio/retry.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/tenacity/asyncio/retry.py --strict
```

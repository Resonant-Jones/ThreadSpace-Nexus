# 🧠 Mypy Fix Guide: `retry_streaming_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/retry/retry_streaming_async.py`
**Lines:** `328`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/retry/retry_streaming_async.py --strict
```

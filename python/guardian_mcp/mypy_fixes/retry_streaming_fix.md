# 🧠 Mypy Fix Guide: `retry_streaming.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/retry/retry_streaming.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/retry/retry_streaming.py --strict
```

# 🧠 Mypy Fix Guide: `retry_unary_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/retry/retry_unary_async.py`
**Lines:** `239`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/retry/retry_unary_async.py --strict
```

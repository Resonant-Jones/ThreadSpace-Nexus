...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/retry/retry_unary.py`
**Lines:** `302`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/retry/retry_unary.py --strict
```

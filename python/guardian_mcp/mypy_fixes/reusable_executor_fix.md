# 🧠 Mypy Fix Guide: `reusable_executor.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/reusable_executor.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/reusable_executor.py --strict
```

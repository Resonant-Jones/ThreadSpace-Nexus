...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/reviews.py`
**Lines:** `331`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/reviews.py --strict
```

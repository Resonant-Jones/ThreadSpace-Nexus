...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/revocation.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/endpoints/revocation.py --strict
```

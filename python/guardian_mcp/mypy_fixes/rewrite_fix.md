...
**File:** `.venv/lib/python3.13/site-packages/sympy/unify/rewrite.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/unify/rewrite.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/rewriting.py`
**Lines:** `357`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/rewriting.py --strict
```

# 🧠 Mypy Fix Guide: `rewritingsystem.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/rewritingsystem.py`
**Lines:** `453`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/rewritingsystem.py --strict
```

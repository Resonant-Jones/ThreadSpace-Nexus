# 🧠 Mypy Fix Guide: `rewritingsystem_fsm.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/rewritingsystem_fsm.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/rewritingsystem_fsm.py --strict
```

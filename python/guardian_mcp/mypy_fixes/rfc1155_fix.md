...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc1155.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc1155.py --strict
```

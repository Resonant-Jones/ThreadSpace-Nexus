...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc1157.py`
**Lines:** `126`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc1157.py --strict
```

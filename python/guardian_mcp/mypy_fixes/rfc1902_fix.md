...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc1902.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc1902.py --strict
```

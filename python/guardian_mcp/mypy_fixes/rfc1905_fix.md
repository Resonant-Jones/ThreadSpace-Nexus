...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc1905.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc1905.py --strict
```

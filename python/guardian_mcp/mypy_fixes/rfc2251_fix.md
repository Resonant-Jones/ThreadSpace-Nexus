...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2251.py`
**Lines:** `563`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2251.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2314.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2314.py --strict
```

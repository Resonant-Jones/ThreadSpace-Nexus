...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2315.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2315.py --strict
```

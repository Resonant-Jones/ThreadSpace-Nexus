...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2437.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2437.py --strict
```

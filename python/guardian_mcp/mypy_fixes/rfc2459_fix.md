...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2459.py`
**Lines:** `1339`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2459.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2560.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2560.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2631.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2631.py --strict
```

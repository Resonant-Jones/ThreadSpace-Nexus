...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2634.py`
**Lines:** `336`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2634.py --strict
```

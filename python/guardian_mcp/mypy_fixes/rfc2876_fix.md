...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2876.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2876.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2985.py`
**Lines:** `588`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2985.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc2986.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc2986.py --strict
```

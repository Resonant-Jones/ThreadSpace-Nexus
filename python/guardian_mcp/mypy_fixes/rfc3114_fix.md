...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3114.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3114.py --strict
```

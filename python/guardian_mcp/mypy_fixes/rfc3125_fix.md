...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3125.py`
**Lines:** `469`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3125.py --strict
```

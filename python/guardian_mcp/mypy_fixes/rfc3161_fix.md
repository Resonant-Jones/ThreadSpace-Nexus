...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3161.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3161.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3274.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3274.py --strict
```

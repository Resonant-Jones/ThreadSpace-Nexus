...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3279.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3279.py --strict
```

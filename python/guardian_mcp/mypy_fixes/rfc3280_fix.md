...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3280.py`
**Lines:** `1543`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3280.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3281.py`
**Lines:** `331`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3281.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3370.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3370.py --strict
```

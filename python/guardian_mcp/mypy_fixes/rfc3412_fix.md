...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3412.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3412.py --strict
```

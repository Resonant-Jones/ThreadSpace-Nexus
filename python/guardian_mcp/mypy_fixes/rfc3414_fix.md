...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3414.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3414.py --strict
```

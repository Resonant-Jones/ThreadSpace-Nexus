...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3537.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3537.py --strict
```

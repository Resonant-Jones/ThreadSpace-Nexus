...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3560.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3560.py --strict
```

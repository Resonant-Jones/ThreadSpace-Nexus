...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3565.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3565.py --strict
```

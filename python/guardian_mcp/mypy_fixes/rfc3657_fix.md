...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3657.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3657.py --strict
```

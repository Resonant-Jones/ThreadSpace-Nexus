...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3709.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3709.py --strict
```

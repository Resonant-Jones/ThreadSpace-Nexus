...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3739.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3739.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3779.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3779.py --strict
```

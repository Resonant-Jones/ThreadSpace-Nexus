...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3820.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3820.py --strict
```

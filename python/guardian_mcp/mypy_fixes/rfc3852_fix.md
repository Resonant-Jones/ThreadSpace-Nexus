...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc3852.py`
**Lines:** `706`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc3852.py --strict
```

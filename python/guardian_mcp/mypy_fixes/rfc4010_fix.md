...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4010.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4010.py --strict
```

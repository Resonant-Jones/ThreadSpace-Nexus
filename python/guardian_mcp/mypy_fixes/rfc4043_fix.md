...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4043.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4043.py --strict
```

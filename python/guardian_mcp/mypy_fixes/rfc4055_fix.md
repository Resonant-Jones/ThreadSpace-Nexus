...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4055.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4055.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4073.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4073.py --strict
```

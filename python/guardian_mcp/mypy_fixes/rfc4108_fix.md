...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4108.py`
**Lines:** `350`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4108.py --strict
```

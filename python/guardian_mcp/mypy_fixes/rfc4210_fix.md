...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4210.py`
**Lines:** `803`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4210.py --strict
```

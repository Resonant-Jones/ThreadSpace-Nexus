...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4211.py`
**Lines:** `396`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4211.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4334.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4334.py --strict
```

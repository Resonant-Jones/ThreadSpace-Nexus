...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4357.py`
**Lines:** `477`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4357.py --strict
```

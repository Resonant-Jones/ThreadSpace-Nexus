...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4387.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4387.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc4476.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc4476.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5035.py`
**Lines:** `199`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5035.py --strict
```

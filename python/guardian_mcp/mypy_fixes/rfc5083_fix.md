...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5083.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5083.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5084.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5084.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5126.py`
**Lines:** `577`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5126.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5275.py`
**Lines:** `404`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5275.py --strict
```

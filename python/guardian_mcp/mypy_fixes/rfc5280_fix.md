...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5280.py`
**Lines:** `1658`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5280.py --strict
```

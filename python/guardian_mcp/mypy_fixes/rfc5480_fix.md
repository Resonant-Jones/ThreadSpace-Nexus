...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5480.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5480.py --strict
```

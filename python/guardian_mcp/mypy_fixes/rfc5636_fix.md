...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5636.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5636.py --strict
```

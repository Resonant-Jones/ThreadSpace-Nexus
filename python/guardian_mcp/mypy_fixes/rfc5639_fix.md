...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5639.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5639.py --strict
```

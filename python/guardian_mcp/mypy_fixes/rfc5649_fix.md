...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5649.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5649.py --strict
```

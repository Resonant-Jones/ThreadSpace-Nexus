...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5652.py`
**Lines:** `761`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5652.py --strict
```

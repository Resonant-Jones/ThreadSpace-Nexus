...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5697.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5697.py --strict
```

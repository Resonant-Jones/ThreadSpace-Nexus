...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5751.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5751.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5752.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5752.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5753.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5753.py --strict
```

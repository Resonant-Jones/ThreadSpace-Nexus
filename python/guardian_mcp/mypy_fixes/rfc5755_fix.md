...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5755.py`
**Lines:** `398`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5755.py --strict
```

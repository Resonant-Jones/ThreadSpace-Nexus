...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5913.py`
**Lines:** `44`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5913.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5914.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5914.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5915.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5915.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5916.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5916.py --strict
```

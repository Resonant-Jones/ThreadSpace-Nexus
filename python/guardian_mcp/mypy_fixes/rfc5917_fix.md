...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5917.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5917.py --strict
```

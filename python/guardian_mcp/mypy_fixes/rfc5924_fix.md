...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5924.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5924.py --strict
```

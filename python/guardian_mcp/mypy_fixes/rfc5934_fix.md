...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5934.py`
**Lines:** `786`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5934.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5940.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5940.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5958.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5958.py --strict
```

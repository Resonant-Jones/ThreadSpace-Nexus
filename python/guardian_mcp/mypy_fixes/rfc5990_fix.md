...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc5990.py`
**Lines:** `237`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc5990.py --strict
```

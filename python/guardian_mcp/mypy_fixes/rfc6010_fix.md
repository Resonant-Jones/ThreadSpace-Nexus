...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6010.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6010.py --strict
```

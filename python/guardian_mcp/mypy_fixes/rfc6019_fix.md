...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6019.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6019.py --strict
```

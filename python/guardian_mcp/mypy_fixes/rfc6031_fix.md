...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6031.py`
**Lines:** `469`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6031.py --strict
```

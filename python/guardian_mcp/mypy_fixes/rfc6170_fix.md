...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6170.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6170.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6210.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6210.py --strict
```

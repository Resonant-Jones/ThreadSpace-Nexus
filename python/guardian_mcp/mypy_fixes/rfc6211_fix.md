...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6211.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6211.py --strict
```

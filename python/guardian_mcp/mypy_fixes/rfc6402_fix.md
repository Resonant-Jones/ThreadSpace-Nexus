...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6402.py`
**Lines:** `628`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6402.py --strict
```

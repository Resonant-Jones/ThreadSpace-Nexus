...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6482.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6482.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6486.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6486.py --strict
```

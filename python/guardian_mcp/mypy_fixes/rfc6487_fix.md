...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6487.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6487.py --strict
```

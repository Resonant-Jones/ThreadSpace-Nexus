...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6664.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6664.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6955.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6955.py --strict
```

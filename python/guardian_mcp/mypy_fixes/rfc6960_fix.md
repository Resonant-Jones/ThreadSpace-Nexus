...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc6960.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc6960.py --strict
```

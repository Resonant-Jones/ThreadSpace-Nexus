...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7030.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7030.py --strict
```

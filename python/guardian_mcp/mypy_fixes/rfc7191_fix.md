...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7191.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7191.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7229.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7229.py --strict
```

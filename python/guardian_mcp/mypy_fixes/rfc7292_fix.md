...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7292.py`
**Lines:** `357`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7292.py --strict
```

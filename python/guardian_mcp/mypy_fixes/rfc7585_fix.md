...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7585.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7585.py --strict
```

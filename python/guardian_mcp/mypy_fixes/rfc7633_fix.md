...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7633.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7633.py --strict
```

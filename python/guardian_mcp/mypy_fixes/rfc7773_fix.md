...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7773.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7773.py --strict
```

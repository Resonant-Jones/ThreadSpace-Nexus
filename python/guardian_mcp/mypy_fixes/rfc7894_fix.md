...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7894.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7894.py --strict
```

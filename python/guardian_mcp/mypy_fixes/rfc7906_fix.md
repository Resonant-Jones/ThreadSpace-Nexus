...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc7906.py`
**Lines:** `736`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc7906.py --strict
```

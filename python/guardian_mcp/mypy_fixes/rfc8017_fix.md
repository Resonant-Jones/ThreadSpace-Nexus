...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8017.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8017.py --strict
```

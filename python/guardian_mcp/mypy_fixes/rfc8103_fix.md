...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8103.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8103.py --strict
```

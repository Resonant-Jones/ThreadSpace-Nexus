...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8209.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8209.py --strict
```

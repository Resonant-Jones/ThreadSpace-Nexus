...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8226.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8226.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8358.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8358.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8410.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8410.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8418.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8418.py --strict
```

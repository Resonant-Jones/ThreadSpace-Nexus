...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8479.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8479.py --strict
```

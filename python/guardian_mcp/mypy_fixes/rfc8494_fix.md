...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8494.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8494.py --strict
```

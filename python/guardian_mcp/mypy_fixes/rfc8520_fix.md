...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8520.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8520.py --strict
```

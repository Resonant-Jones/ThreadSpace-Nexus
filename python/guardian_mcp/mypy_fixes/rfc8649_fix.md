...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8649.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8649.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8692.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8692.py --strict
```

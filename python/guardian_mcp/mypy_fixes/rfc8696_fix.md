...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8696.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8696.py --strict
```

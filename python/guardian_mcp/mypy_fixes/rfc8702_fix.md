...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8702.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8702.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8708.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8708.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1_modules/rfc8769.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1_modules/rfc8769.py --strict
```

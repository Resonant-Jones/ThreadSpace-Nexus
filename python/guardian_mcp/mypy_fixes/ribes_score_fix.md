...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/ribes_score.py`
**Lines:** `330`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/ribes_score.py --strict
```

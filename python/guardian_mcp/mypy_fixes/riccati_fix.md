...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/riccati.py`
**Lines:** `893`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/riccati.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/typer/rich_utils.py`
**Lines:** `741`
...
```bash
mypy .venv/lib/python3.13/site-packages/typer/rich_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ride.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ride.py --strict
```

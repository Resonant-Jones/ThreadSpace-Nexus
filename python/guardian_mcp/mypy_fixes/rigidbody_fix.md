...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/rigidbody.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/rigidbody.py --strict
```

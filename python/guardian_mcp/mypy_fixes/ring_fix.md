...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/ring.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/ring.py --strict
```

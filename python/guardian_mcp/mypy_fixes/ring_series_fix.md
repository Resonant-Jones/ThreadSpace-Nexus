...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/ring_series.py`
**Lines:** `2127`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/ring_series.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/risch.py`
**Lines:** `1851`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/risch.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/rita.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/rita.py --strict
```

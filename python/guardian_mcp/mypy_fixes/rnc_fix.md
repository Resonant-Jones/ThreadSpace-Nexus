...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/rnc.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/rnc.py --strict
```

# 🧠 Mypy Fix Guide: `roboflow_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/roboflow_embedding_function.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/roboflow_embedding_function.py --strict
```

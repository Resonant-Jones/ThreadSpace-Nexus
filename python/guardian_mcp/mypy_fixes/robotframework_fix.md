# 🧠 Mypy Fix Guide: `robotframework.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/robotframework.py`
**Lines:** `551`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/robotframework.py --strict
```

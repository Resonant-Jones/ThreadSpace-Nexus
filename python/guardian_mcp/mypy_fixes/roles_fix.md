...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/roles.py`
**Lines:** `323`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/roles.py --strict
```

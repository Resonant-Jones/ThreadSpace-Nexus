...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/window/rolling.py`
**Lines:** `2930`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/window/rolling.py --strict
```

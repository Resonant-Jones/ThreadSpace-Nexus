# 🧠 Mypy Fix Guide: `romanian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/romanian_stemmer.py`
**Lines:** `633`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/romanian_stemmer.py --strict
```

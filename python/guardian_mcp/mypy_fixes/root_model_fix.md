...
**File:** `.venv/lib/python3.13/site-packages/pydantic/root_model.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/root_model.py --strict
```

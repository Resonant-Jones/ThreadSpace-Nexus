...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/root_system.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/root_system.py --strict
```

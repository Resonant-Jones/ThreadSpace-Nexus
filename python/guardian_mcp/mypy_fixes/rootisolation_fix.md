# 🧠 Mypy Fix Guide: `rootisolation.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/rootisolation.py`
**Lines:** `2190`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/rootisolation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/rootoftools.py`
**Lines:** `1298`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/rootoftools.py --strict
```

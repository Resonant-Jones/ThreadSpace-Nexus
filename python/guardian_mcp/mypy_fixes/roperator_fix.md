...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/roperator.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/roperator.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/rotate.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/rotate.py --strict
```

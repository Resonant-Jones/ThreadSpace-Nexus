# 🧠 Mypy Fix Guide: `route_checks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/route_checks.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/route_checks.py --strict
```

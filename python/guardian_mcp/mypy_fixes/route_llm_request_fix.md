# 🧠 Mypy Fix Guide: `route_llm_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/route_llm_request.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/route_llm_request.py --strict
```

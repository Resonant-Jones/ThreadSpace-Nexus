...
**File:** `.venv/lib/python3.13/site-packages/websockets/asyncio/router.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/asyncio/router.py --strict
```

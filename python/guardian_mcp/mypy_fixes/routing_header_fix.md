# 🧠 Mypy Fix Guide: `routing_header.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/gapic_v1/routing_header.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/gapic_v1/routing_header.py --strict
```

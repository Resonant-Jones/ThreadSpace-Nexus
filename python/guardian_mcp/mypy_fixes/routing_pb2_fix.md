...
**File:** `.venv/lib/python3.13/site-packages/google/api/routing_pb2.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/routing_pb2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/engine/row.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/engine/row.py --strict
```

# 🧠 Mypy Fix Guide: `rpc_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/rpc_attributes.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/rpc_attributes.py --strict
```

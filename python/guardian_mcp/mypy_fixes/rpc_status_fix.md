...
**File:** `.venv/lib/python3.13/site-packages/grpc_status/rpc_status.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc_status/rpc_status.py --strict
```

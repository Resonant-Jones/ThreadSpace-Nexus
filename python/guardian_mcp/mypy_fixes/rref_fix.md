...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/rref.py`
**Lines:** `422`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/rref.py --strict
```

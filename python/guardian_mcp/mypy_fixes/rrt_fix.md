...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/rrt.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/rrt.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/rszeta.py`
**Lines:** `1403`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/rszeta.py --strict
```

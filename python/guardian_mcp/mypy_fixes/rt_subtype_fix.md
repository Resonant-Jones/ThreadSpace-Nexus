...
**File:** `.venv/lib/python3.13/site-packages/mypyc/rt_subtype.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/rt_subtype.py --strict
```

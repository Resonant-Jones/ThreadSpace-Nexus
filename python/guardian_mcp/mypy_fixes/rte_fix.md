...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/rte.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/rte.py --strict
```

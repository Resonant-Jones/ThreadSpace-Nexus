...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/rtf.py`
**Lines:** `349`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/rtf.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ruby.py`
**Lines:** `518`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ruby.py --strict
```

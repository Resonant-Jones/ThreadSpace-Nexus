...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest10.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest10.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest11.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest11.py --strict
```

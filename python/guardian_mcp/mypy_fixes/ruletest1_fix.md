...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest1.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest1.py --strict
```

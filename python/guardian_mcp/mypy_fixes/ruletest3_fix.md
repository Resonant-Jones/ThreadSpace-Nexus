...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest3.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest3.py --strict
```

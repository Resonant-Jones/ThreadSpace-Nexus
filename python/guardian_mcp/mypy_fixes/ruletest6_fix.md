...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest6.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/autolev/test-examples/ruletest6.py --strict
```

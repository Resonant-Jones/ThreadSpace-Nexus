# 🧠 Mypy Fix Guide: `run_cancel_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/run_cancel_response.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/run_cancel_response.py --strict
```

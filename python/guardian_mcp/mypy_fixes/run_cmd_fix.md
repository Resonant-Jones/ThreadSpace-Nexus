...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/run_cmd.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/run_cmd.py --strict
```

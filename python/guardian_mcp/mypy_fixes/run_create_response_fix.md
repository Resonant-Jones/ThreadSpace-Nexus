# 🧠 Mypy Fix Guide: `run_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/run_create_response.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/run_create_response.py --strict
```

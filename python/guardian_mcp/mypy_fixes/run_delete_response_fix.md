# 🧠 Mypy Fix Guide: `run_delete_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/run_delete_response.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/run_delete_response.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/type_tests/run.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/type_tests/run.py --strict
```

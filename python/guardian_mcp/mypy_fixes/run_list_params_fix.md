# 🧠 Mypy Fix Guide: `run_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/run_list_params.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/run_list_params.py --strict
```

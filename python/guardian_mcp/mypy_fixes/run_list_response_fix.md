# 🧠 Mypy Fix Guide: `run_list_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/run_list_response.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/run_list_response.py --strict
```

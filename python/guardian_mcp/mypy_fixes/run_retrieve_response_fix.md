# 🧠 Mypy Fix Guide: `run_retrieve_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/evals/run_retrieve_response.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/evals/run_retrieve_response.py --strict
```

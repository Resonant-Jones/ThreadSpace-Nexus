...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/run_status.py`
**Lines:** `17`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/run_status.py --strict
```

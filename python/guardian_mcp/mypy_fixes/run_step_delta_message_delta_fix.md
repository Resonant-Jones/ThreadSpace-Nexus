# 🧠 Mypy Fix Guide: `run_step_delta_message_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/run_step_delta_message_delta.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/run_step_delta_message_delta.py --strict
```

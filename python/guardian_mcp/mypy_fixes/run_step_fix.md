...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/run_step.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/run_step.py --strict
```

# 🧠 Mypy Fix Guide: `run_step_include.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/run_step_include.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/run_step_include.py --strict
```

# 🧠 Mypy Fix Guide: `run_submit_tool_outputs_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/run_submit_tool_outputs_params.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/run_submit_tool_outputs_params.py --strict
```

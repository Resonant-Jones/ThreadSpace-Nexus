# 🧠 Mypy Fix Guide: `run_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/run_update_params.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/run_update_params.py --strict
```

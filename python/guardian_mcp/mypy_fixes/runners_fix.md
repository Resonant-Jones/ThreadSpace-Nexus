...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/_compilation/runners.py`
**Lines:** `301`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/_compilation/runners.py --strict
```

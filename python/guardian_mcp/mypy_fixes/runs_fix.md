...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/beta/threads/runs/runs.py`
**Lines:** `3086`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/beta/threads/runs/runs.py --strict
```

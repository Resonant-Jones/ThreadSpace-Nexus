...
**File:** `.venv/lib/python3.13/site-packages/sympy/testing/runtests.py`
**Lines:** `2409`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/testing/runtests.py --strict
```

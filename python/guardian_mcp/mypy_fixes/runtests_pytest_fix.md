# 🧠 Mypy Fix Guide: `runtests_pytest.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/testing/runtests_pytest.py`
**Lines:** `461`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/testing/runtests_pytest.py --strict
```

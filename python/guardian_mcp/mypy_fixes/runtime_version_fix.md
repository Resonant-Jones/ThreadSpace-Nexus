# 🧠 Mypy Fix Guide: `runtime_version.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/runtime_version.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/runtime_version.py --strict
```

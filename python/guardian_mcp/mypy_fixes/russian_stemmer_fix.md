# 🧠 Mypy Fix Guide: `russian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/russian_stemmer.py`
**Lines:** `492`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/russian_stemmer.py --strict
```

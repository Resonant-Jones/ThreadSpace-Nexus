...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/rust.py`
**Lines:** `637`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/rust.py --strict
```

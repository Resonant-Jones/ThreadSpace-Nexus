# 🧠 Mypy Fix Guide: `rv_interface.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/rv_interface.py`
**Lines:** `519`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/rv_interface.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/caching/s3_cache.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/caching/s3_cache.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/s3.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/s3.py --strict
```

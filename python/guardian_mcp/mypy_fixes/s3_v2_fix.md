...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/integrations/s3_v2.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/integrations/s3_v2.py --strict
```

# 🧠 Mypy Fix Guide: `safe_json_dumps.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/safe_json_dumps.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/safe_json_dumps.py --strict
```

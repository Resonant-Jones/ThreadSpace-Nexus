# 🧠 Mypy Fix Guide: `safe_json_loads.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/safe_json_loads.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/safe_json_loads.py --strict
```

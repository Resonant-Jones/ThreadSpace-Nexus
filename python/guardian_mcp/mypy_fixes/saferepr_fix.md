...
**File:** `.venv/lib/python3.13/site-packages/_pytest/_io/saferepr.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/_io/saferepr.py --strict
```

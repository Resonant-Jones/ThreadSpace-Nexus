# 🧠 Mypy Fix Guide: `safety_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/safety_types.py`
**Lines:** `303`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/safety_types.py --strict
```

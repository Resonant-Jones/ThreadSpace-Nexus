...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/sam2_demo.py`
**Lines:** `321`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/sam2_demo.py --strict
```

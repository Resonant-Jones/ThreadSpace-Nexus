# 🧠 Mypy Fix Guide: `sam2_image_onnx_predictor.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/sam2_image_onnx_predictor.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/sam2/sam2_image_onnx_predictor.py --strict
```

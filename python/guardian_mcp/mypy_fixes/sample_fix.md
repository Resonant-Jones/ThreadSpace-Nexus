...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/sample.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/sample.py --strict
```

# 🧠 Mypy Fix Guide: `sample_numpy.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/sampling/sample_numpy.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/sampling/sample_numpy.py --strict
```

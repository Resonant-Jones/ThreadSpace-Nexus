...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/sampling/sample_pymc.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/sampling/sample_pymc.py --strict
```

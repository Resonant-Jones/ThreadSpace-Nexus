# 🧠 Mypy Fix Guide: `sample_scipy.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/sampling/sample_scipy.py`
**Lines:** `167`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/sampling/sample_scipy.py --strict
```

# 🧠 Mypy Fix Guide: `sample_tools.py`
...
**File:** `.venv/lib/python3.13/site-packages/googleapiclient/sample_tools.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/googleapiclient/sample_tools.py --strict
```

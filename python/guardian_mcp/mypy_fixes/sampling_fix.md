...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/trace/sampling.py`
**Lines:** `453`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/trace/sampling.py --strict
```

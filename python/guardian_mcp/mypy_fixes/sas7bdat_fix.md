...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/sas/sas7bdat.py`
**Lines:** `762`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/sas/sas7bdat.py --strict
```

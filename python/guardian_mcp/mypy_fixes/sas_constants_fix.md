# 🧠 Mypy Fix Guide: `sas_constants.py`
...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/sas/sas_constants.py`
**Lines:** `310`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/sas/sas_constants.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/sas.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/sas.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/sas/sas_xport.py`
**Lines:** `508`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/sas/sas_xport.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/sas/sasreader.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/sas/sasreader.py --strict
```

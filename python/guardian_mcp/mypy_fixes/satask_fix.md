...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/satask.py`
**Lines:** `369`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/satask.py --strict
```

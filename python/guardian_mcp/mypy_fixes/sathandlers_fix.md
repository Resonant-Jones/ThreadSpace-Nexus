...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/sathandlers.py`
**Lines:** `322`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/sathandlers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/savi.py`
**Lines:** `171`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/savi.py --strict
```

# 🧠 Mypy Fix Guide: `sbcharsetprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/sbcharsetprober.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/sbcharsetprober.py --strict
```

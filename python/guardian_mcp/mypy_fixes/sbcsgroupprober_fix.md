# 🧠 Mypy Fix Guide: `sbcsgroupprober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/sbcsgroupprober.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/sbcsgroupprober.py --strict
```

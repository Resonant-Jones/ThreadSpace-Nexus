...
**File:** `.venv/lib/python3.13/site-packages/sympy/vector/scalar.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/vector/scalar.py --strict
```

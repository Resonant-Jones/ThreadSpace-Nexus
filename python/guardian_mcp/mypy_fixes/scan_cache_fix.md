...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/scan_cache.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/scan_cache.py --strict
```

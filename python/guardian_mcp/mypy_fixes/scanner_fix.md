...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/scanner.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/scanner.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/scheduler.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/scheduler.py --strict
```

# 🧠 Mypy Fix Guide: `scheduling_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/scheduling_v1_api.py`
**Lines:** `1179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/scheduling_v1_api.py --strict
```

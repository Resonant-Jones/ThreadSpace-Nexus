# 🧠 Mypy Fix Guide: `schema_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/schemas/schema_utils.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/schemas/schema_utils.py --strict
```

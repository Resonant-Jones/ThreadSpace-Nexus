...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/schemas.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/schemas.py --strict
```

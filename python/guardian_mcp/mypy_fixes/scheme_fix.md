...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/scheme.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/scheme.py --strict
```

# 🧠 Mypy Fix Guide: `schur_number.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/schur_number.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/schur_number.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/scikitlearn.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/scikitlearn.py --strict
```

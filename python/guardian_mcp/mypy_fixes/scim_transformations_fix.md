# 🧠 Mypy Fix Guide: `scim_transformations.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/scim/scim_transformations.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/scim/scim_transformations.py --strict
```

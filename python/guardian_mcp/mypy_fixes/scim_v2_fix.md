...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/scim_v2.py`
**Lines:** `92`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/scim_v2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/scimath.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/scimath.py --strict
```

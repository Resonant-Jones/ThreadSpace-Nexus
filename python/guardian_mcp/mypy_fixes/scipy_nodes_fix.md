...
**File:** `.venv/lib/python3.13/site-packages/sympy/codegen/scipy_nodes.py`
**Lines:** `79`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/codegen/scipy_nodes.py --strict
```

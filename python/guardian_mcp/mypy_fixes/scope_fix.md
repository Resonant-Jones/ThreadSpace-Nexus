...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/scope.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/scope.py --strict
```

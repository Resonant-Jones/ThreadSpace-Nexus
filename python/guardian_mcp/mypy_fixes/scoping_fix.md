...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/scoping.py`
**Lines:** `1613`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/asyncio/scoping.py --strict
```

# 🧠 Mypy Fix Guide: `score_model_grader.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/score_model_grader.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/score_model_grader.py --strict
```

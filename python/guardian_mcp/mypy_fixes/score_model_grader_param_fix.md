# 🧠 Mypy Fix Guide: `score_model_grader_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/score_model_grader_param.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/score_model_grader_param.py --strict
```

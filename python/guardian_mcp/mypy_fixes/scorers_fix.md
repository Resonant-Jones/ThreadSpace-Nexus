...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/scorers.py`
**Lines:** `519`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/deep_crawling/scorers.py --strict
```

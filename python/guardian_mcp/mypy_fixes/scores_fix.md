...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/scores.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/scores.py --strict
```

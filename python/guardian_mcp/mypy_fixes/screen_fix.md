...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/screen.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/screen.py --strict
```

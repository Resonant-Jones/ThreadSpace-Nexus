...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/script.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/script.py --strict
```

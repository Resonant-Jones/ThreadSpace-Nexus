...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/script_key.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/script_key.py --strict
```

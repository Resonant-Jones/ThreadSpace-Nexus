...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/scripting.py`
**Lines:** `1614`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/scripting.py --strict
```

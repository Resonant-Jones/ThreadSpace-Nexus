...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/distlib/scripts.py`
**Lines:** `447`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/distlib/scripts.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/scrypt.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/scrypt.py --strict
```

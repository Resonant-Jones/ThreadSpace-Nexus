...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/distributions/sdist.py`
**Lines:** `158`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/distributions/sdist.py --strict
```

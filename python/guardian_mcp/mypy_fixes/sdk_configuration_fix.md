# 🧠 Mypy Fix Guide: `sdk_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/sdk_configuration.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/sdk/metrics/_internal/sdk_configuration.py --strict
```

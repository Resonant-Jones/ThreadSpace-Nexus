...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/matrices/sdm.py`
**Lines:** `2197`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/matrices/sdm.py --strict
```

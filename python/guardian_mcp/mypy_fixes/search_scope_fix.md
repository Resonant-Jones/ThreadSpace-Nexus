# 🧠 Mypy Fix Guide: `search_scope.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/search_scope.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/search_scope.py --strict
```

# 🧠 Mypy Fix Guide: `search_string.py`
...
**File:** `.venv/lib/python3.13/site-packages/pypika/clickhouse/search_string.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/clickhouse/search_string.py --strict
```

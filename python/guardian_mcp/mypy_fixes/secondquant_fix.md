...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/secondquant.py`
**Lines:** `3125`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/secondquant.py --strict
```

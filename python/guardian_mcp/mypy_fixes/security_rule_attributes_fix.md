# 🧠 Mypy Fix Guide: `security_rule_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/security_rule_attributes.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/security_rule_attributes.py --strict
```

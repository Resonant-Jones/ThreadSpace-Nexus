...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/seeder.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/seeder.py --strict
```

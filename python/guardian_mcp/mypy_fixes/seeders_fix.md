...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/run/plugin/seeders.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/run/plugin/seeders.py --strict
```

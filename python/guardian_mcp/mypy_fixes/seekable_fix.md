...
**File:** `.venv/lib/python3.13/site-packages/magika/types/seekable.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/seekable.py --strict
```

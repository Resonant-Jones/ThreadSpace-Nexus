# 🧠 Mypy Fix Guide: `segment_directory.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/distributed/segment_directory.py`
**Lines:** `337`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/distributed/segment_directory.py --strict
```

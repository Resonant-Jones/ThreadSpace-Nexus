...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/segment.py`
**Lines:** `999`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/segment.py --strict
```

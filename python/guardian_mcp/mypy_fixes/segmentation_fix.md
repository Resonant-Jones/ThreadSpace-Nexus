# 🧠 Mypy Fix Guide: `segmentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/segmentation.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/segmentation.py --strict
```

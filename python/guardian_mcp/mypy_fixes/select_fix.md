...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/select.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/select.py --strict
```

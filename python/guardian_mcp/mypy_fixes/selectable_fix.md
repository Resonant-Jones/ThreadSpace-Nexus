...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/selectable.py`
**Lines:** `7193`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/selectable.py --strict
```

# 🧠 Mypy Fix Guide: `selection_prefs.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/selection_prefs.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/selection_prefs.py --strict
```

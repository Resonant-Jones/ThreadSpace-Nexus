...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/methods/selectn.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/methods/selectn.py --strict
```

# 🧠 Mypy Fix Guide: `selenium_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/selenium_manager.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/selenium_manager.py --strict
```

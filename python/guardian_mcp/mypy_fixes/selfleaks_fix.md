...
**File:** `.venv/lib/python3.13/site-packages/mypyc/analysis/selfleaks.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/analysis/selfleaks.py --strict
```

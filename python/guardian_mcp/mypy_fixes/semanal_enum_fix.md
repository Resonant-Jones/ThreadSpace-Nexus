# 🧠 Mypy Fix Guide: `semanal_enum.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/semanal_enum.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/semanal_enum.py --strict
```

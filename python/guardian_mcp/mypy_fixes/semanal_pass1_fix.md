# 🧠 Mypy Fix Guide: `semanal_pass1.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/semanal_pass1.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/semanal_pass1.py --strict
```

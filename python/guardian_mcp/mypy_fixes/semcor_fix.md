...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/semcor.py`
**Lines:** `296`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/semcor.py --strict
```

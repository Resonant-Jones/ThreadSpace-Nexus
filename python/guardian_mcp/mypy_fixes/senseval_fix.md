...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/senseval.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/senseval.py --strict
```

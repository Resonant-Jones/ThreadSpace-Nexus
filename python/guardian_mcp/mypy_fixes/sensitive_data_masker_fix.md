# 🧠 Mypy Fix Guide: `sensitive_data_masker.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/sensitive_data_masker.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/sensitive_data_masker.py --strict
```

# 🧠 Mypy Fix Guide: `sentence_transformer_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/sentence_transformer_embedding_function.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/sentence_transformer_embedding_function.py --strict
```

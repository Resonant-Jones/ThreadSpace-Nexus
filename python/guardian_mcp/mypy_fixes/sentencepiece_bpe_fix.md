# 🧠 Mypy Fix Guide: `sentencepiece_bpe.py`
...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/implementations/sentencepiece_bpe.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/implementations/sentencepiece_bpe.py --strict
```

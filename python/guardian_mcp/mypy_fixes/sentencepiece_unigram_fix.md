# 🧠 Mypy Fix Guide: `sentencepiece_unigram.py`
...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/implementations/sentencepiece_unigram.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/implementations/sentencepiece_unigram.py --strict
```

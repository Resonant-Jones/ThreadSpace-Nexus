# 🧠 Mypy Fix Guide: `sentiwordnet.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/sentiwordnet.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/sentiwordnet.py --strict
```

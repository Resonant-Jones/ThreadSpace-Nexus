...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/sequences.py`
**Lines:** `1239`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/sequences.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/tag/sequential.py`
**Lines:** `754`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tag/sequential.py --strict
```

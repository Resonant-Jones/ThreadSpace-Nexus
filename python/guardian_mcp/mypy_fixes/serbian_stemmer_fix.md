# 🧠 Mypy Fix Guide: `serbian_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/serbian_stemmer.py`
**Lines:** `3497`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/serbian_stemmer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/serialize.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/cachecontrol/serialize.py --strict
```

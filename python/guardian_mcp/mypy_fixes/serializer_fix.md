...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/ext/serializer.py`
**Lines:** `185`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/ext/serializer.py --strict
```

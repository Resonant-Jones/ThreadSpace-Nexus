# 🧠 Mypy Fix Guide: `series_class.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/series/series_class.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/series/series_class.py --strict
```

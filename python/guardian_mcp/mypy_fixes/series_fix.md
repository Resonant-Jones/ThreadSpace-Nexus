...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/series.py`
**Lines:** `2591`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/series.py --strict
```

# 🧠 Mypy Fix Guide: `server_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/server_attributes.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/server_attributes.py --strict
```

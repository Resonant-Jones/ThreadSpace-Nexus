...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/server.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/server.py --strict
```

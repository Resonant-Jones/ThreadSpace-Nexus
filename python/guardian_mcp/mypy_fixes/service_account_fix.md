# 🧠 Mypy Fix Guide: `service_account.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/service_account.py`
**Lines:** `847`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/service_account.py --strict
```

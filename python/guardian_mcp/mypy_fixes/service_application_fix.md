# 🧠 Mypy Fix Guide: `service_application.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/service_application.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/service_application.py --strict
```

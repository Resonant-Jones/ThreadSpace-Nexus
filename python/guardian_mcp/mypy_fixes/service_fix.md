...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/ie/service.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/ie/service.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/api/service_pb2.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/service_pb2.py --strict
```

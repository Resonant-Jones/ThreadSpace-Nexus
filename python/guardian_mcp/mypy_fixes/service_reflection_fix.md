# 🧠 Mypy Fix Guide: `service_reflection.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/service_reflection.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/service_reflection.py --strict
```

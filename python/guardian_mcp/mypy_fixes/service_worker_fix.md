# 🧠 Mypy Fix Guide: `service_worker.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/service_worker.py`
**Lines:** `414`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/service_worker.py --strict
```

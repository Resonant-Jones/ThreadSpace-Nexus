...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/services.py`
**Lines:** `128`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/services.py --strict
```

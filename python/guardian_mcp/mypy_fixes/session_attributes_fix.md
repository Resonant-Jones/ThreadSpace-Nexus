# 🧠 Mypy Fix Guide: `session_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/session_attributes.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/session_attributes.py --strict
```

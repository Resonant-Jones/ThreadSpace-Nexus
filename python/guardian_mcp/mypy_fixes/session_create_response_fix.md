# 🧠 Mypy Fix Guide: `session_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/session_create_response.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/session_create_response.py --strict
```

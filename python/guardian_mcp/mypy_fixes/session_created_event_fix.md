# 🧠 Mypy Fix Guide: `session_created_event.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/session_created_event.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/session_created_event.py --strict
```

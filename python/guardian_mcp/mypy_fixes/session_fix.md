...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/session.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/session.py --strict
```

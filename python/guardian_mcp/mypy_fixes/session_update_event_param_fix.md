# 🧠 Mypy Fix Guide: `session_update_event_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/realtime/session_update_event_param.py`
**Lines:** `310`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/realtime/session_update_event_param.py --strict
```

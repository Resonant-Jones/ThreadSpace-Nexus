...
**File:** `.venv/lib/python3.13/site-packages/google/auth/aio/transport/sessions.py`
**Lines:** `268`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/aio/transport/sessions.py --strict
```

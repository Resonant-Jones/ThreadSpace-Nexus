...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/set_ops.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/set_ops.py --strict
```

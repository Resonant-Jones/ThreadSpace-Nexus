...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/setexpr.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/setexpr.py --strict
```

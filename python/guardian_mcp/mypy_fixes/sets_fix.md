...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/handlers/sets.py`
**Lines:** `816`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/handlers/sets.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/setup_fixt.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/setup_fixt.py --strict
```

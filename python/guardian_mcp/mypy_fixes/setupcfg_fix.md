...
**File:** `.venv/lib/python3.13/site-packages/setuptools/config/setupcfg.py`
**Lines:** `780`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/config/setupcfg.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/_pytest/setuponly.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/setuponly.py --strict
```

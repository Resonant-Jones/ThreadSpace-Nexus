...
**File:** `.venv/lib/python3.13/site-packages/_pytest/setupplan.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/setupplan.py --strict
```

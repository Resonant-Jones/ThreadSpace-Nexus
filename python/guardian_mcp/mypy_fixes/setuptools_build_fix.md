# 🧠 Mypy Fix Guide: `setuptools_build.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/setuptools_build.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/setuptools_build.py --strict
```

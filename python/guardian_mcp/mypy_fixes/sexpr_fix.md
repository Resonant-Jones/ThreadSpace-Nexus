...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/sexpr.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/sexpr.py --strict
```

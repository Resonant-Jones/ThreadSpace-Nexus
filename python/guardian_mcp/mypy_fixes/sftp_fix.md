...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/sftp.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/sftp.py --strict
```

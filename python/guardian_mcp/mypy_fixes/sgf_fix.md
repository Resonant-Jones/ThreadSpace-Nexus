...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/sgf.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/sgf.py --strict
```

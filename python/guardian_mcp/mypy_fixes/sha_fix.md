...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/sha.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/sha.py --strict
```

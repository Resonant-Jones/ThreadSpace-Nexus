...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/shadowroot.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/shadowroot.py --strict
```

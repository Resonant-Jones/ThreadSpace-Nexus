...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/shape_base.py`
**Lines:** `998`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/shape_base.py --strict
```

# 🧠 Mypy Fix Guide: `shape_infer_helper.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/shape_infer_helper.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/shape_infer_helper.py --strict
```

# 🧠 Mypy Fix Guide: `shape_inference.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/shape_inference.py`
**Lines:** `192`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/shape_inference.py --strict
```

# 🧠 Mypy Fix Guide: `shape_optimizer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/shape_optimizer.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/shape_optimizer.py --strict
```

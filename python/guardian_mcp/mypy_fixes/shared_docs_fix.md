...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/shared_docs.py`
**Lines:** `952`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/shared_docs.py --strict
```

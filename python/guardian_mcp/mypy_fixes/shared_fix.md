...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/shared.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/shared.py --strict
```

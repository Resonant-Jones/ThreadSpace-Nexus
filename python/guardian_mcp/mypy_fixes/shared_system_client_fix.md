# 🧠 Mypy Fix Guide: `shared_system_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/api/shared_system_client.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/api/shared_system_client.py --strict
```

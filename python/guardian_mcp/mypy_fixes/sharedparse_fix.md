...
**File:** `.venv/lib/python3.13/site-packages/mypy/sharedparse.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/sharedparse.py --strict
```

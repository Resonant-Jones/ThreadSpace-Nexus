...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/sheets_id.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/sheets_id.py --strict
```

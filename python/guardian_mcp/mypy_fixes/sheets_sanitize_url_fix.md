# 🧠 Mypy Fix Guide: `sheets_sanitize_url.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/sheets_sanitize_url.py`
**Lines:** `89`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/sheets_sanitize_url.py --strict
```

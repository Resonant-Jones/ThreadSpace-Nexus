# 🧠 Mypy Fix Guide: `sheets_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/sheets_utils.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/sheets_utils.py --strict
```

# 🧠 Mypy Fix Guide: `shell_completion.py`
...
**File:** `.venv/lib/python3.13/site-packages/click/shell_completion.py`
**Lines:** `644`
...
```bash
mypy .venv/lib/python3.13/site-packages/click/shell_completion.py --strict
```

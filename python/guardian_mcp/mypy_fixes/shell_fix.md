...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/shell.py`
**Lines:** `902`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/shell.py --strict
```

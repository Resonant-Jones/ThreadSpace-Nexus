...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/shiftreduce.py`
**Lines:** `478`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/shiftreduce.py --strict
```

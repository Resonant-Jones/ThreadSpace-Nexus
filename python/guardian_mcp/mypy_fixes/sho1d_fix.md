...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/sho1d.py`
**Lines:** `679`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/sho1d.py --strict
```

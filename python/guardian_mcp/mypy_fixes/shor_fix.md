...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/shor.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/shor.py --strict
```

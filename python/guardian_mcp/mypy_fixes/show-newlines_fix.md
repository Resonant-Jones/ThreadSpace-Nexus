# 🧠 Mypy Fix Guide: `show-newlines.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/show-newlines.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/show-newlines.py --strict
```

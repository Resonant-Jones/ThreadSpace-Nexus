...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/show.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/show.py --strict
```

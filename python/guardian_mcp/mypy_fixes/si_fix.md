...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/systems/si.py`
**Lines:** `377`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/systems/si.py --strict
```

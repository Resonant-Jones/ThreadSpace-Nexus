...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/signals.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/signals.py --strict
```

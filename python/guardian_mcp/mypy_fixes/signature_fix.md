...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/signature.py`
**Lines:** `852`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/signature.py --strict
```

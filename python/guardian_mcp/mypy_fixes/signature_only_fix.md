# 🧠 Mypy Fix Guide: `signature_only.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/endpoints/signature_only.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth1/rfc5849/endpoints/signature_only.py --strict
```

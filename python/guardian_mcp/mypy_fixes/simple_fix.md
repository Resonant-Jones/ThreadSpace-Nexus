...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/simple.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/simple.py --strict
```

# 🧠 Mypy Fix Guide: `simple_shuffle.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/simple_shuffle.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/simple_shuffle.py --strict
```

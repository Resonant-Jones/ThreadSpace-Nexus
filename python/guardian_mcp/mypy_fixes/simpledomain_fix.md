# 🧠 Mypy Fix Guide: `simpledomain.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/domains/simpledomain.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/domains/simpledomain.py --strict
```

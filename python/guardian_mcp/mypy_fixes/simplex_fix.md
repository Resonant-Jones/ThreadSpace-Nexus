...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/simplex.py`
**Lines:** `1104`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/simplex.py --strict
```

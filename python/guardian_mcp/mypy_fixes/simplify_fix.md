...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/simplify.py`
**Lines:** `2164`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/simplify.py --strict
```

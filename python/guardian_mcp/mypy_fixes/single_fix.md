...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/single.py`
**Lines:** `2977`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/single.py --strict
```

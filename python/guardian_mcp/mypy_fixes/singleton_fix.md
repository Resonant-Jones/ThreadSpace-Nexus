...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/singleton.py`
**Lines:** `199`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/singleton.py --strict
```

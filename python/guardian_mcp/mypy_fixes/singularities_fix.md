# 🧠 Mypy Fix Guide: `singularities.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/calculus/singularities.py`
**Lines:** `406`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/calculus/singularities.py --strict
```

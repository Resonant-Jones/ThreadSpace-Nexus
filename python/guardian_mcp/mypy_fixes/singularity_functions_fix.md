# 🧠 Mypy Fix Guide: `singularity_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/singularity_functions.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/singularity_functions.py --strict
```

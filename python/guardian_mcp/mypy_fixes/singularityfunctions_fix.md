# 🧠 Mypy Fix Guide: `singularityfunctions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/singularityfunctions.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/singularityfunctions.py --strict
```

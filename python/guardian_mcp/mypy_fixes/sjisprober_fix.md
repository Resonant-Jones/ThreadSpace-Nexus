...
**File:** `.venv/lib/python3.13/site-packages/chardet/sjisprober.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/sjisprober.py --strict
```

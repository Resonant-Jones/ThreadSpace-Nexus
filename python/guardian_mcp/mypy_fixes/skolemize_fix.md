...
**File:** `.venv/lib/python3.13/site-packages/nltk/sem/skolemize.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/sem/skolemize.py --strict
```

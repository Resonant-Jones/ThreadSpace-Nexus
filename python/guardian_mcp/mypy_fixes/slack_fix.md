...
**File:** `.venv/lib/python3.13/site-packages/requests_oauthlib/compliance_fixes/slack.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/requests_oauthlib/compliance_fixes/slack.py --strict
```

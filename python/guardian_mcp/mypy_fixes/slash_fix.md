...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/slash.py`
**Lines:** `183`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/slash.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/slice.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/slice.py --strict
```

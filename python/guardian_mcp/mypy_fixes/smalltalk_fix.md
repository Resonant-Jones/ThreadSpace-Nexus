...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/smalltalk.py`
**Lines:** `194`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/smalltalk.py --strict
```

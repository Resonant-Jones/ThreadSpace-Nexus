...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_core/smartquotes.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_core/smartquotes.py --strict
```

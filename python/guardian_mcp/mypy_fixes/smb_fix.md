...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/smb.py`
**Lines:** `416`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/smb.py --strict
```

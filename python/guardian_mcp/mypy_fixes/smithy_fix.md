...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/smithy.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/smithy.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/lm/smoothing.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/lm/smoothing.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/smtlib.py`
**Lines:** `583`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/smtlib.py --strict
```

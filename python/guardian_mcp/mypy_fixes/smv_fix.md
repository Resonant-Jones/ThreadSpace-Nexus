...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/smv.py`
**Lines:** `78`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/smv.py --strict
```

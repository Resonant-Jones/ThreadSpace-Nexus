...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/snobol.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/snobol.py --strict
```

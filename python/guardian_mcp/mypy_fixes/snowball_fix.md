...
**File:** `.venv/lib/python3.13/site-packages/nltk/stem/snowball.py`
**Lines:** `5921`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/stem/snowball.py --strict
```

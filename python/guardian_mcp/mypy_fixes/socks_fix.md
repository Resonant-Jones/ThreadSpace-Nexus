...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/socks.py`
**Lines:** `216`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/contrib/socks.py --strict
```

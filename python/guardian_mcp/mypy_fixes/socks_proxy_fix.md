...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_sync/socks_proxy.py`
**Lines:** `341`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_sync/socks_proxy.py --strict
```

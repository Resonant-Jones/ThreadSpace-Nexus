...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/softmax.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/softmax.py --strict
```

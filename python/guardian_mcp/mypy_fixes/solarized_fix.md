...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/solarized.py`
**Lines:** `144`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/solarized.py --strict
```

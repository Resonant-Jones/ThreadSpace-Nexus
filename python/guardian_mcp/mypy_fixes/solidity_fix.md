...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/solidity.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/solidity.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/solvers.py`
**Lines:** `942`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/solvers.py --strict
```

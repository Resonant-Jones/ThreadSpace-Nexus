...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/solveset.py`
**Lines:** `4131`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/solveset.py --strict
```

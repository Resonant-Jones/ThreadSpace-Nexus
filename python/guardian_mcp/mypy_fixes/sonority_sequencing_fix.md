# 🧠 Mypy Fix Guide: `sonority_sequencing.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/sonority_sequencing.py`
**Lines:** `194`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/sonority_sequencing.py --strict
```

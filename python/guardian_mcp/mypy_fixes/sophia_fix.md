...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/sophia.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/sophia.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sortedcontainers/sorteddict.py`
**Lines:** `812`
...
```bash
mypy .venv/lib/python3.13/site-packages/sortedcontainers/sorteddict.py --strict
```

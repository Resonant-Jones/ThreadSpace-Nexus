...
**File:** `.venv/lib/python3.13/site-packages/sortedcontainers/sortedlist.py`
**Lines:** `2646`
...
```bash
mypy .venv/lib/python3.13/site-packages/sortedcontainers/sortedlist.py --strict
```

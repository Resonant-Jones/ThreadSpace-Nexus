...
**File:** `.venv/lib/python3.13/site-packages/sortedcontainers/sortedset.py`
**Lines:** `733`
...
```bash
mypy .venv/lib/python3.13/site-packages/sortedcontainers/sortedset.py --strict
```

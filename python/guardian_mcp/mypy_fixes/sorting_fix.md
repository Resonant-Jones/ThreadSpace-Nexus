...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/sorting.py`
**Lines:** `312`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/sorting.py --strict
```

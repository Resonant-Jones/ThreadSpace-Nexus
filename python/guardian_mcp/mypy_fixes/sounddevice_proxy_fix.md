# 🧠 Mypy Fix Guide: `sounddevice_proxy.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/_extras/sounddevice_proxy.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/_extras/sounddevice_proxy.py --strict
```

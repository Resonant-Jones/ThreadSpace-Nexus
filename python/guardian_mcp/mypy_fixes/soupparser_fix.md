...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/soupparser.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/soupparser.py --strict
```

# 🧠 Mypy Fix Guide: `source_context_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/source_context_pb2.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/source_context_pb2.py --strict
```

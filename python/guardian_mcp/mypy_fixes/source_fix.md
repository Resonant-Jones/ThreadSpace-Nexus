...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/source.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/source.py --strict
```

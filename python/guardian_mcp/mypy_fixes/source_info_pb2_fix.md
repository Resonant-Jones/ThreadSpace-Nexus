# 🧠 Mypy Fix Guide: `source_info_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api/source_info_pb2.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api/source_info_pb2.py --strict
```

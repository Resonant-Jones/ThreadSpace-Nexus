...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/index/sources.py`
**Lines:** `284`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/index/sources.py --strict
```

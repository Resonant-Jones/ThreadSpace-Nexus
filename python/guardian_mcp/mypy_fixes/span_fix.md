...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/trace/span.py`
**Lines:** `608`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/trace/span.py --strict
```

# 🧠 Mypy Fix Guide: `spanish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/spanish_stemmer.py`
**Lines:** `708`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/spanish_stemmer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/sparse.py`
**Lines:** `473`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/sparse.py --strict
```

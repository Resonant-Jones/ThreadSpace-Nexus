# 🧠 Mypy Fix Guide: `sparse_ndim_array.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/array/sparse_ndim_array.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/array/sparse_ndim_array.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/sparsetools.py`
**Lines:** `300`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/sparsetools.py --strict
```

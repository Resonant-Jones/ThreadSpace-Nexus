...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/spawn.py`
**Lines:** `244`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/spawn.py --strict
```

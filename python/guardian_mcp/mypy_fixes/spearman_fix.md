...
**File:** `.venv/lib/python3.13/site-packages/nltk/metrics/spearman.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/metrics/spearman.py --strict
```

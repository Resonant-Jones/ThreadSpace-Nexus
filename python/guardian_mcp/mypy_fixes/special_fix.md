...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/special.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/special.py --strict
```

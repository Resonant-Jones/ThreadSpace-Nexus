...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/specialize.py`
**Lines:** `890`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/specialize.py --strict
```

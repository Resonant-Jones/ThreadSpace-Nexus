# 🧠 Mypy Fix Guide: `specialpolys.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/specialpolys.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/specialpolys.py --strict
```

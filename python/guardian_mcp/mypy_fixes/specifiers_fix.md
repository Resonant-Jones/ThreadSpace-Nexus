...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/specifiers.py`
**Lines:** `1011`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/specifiers.py --strict
```

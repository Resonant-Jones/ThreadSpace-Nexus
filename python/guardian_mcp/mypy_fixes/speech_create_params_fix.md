# 🧠 Mypy Fix Guide: `speech_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio/speech_create_params.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio/speech_create_params.py --strict
```

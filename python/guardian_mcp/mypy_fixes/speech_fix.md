...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/audio/speech.py`
**Lines:** `245`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/audio/speech.py --strict
```

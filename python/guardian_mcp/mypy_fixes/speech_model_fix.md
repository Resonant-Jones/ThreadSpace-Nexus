# 🧠 Mypy Fix Guide: `speech_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio/speech_model.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio/speech_model.py --strict
```

# 🧠 Mypy Fix Guide: `spend_log_cleanup.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/spend_log_cleanup.py`
**Lines:** `161`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/spend_log_cleanup.py --strict
```

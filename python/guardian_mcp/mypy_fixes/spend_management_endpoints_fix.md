# 🧠 Mypy Fix Guide: `spend_management_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/spend_tracking/spend_management_endpoints.py`
**Lines:** `2942`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/spend_tracking/spend_management_endpoints.py --strict
```

# 🧠 Mypy Fix Guide: `spend_tracking_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/spend_tracking/spend_tracking_utils.py`
**Lines:** `558`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/spend_tracking/spend_tracking_utils.py --strict
```

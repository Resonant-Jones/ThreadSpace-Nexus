# 🧠 Mypy Fix Guide: `spend_update_queue.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/spend_update_queue.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/db/db_transaction_queue/spend_update_queue.py --strict
```

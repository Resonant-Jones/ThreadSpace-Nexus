# 🧠 Mypy Fix Guide: `spherical_harmonics.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/spherical_harmonics.py`
**Lines:** `334`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/spherical_harmonics.py --strict
```

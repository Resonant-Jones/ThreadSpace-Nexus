...
**File:** `.venv/lib/python3.13/site-packages/humanfriendly/sphinx.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/humanfriendly/sphinx.py --strict
```

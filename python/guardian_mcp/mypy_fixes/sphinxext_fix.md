...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/sphinxext.py`
**Lines:** `247`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/sphinxext.py --strict
```

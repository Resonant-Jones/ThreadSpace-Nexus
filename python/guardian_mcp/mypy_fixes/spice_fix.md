...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/spice.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/spice.py --strict
```

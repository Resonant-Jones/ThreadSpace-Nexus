...
**File:** `.venv/lib/python3.13/site-packages/mypyc/transform/spill.py`
**Lines:** `107`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/transform/spill.py --strict
```

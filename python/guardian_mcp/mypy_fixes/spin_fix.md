...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/spin.py`
**Lines:** `2150`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/spin.py --strict
```

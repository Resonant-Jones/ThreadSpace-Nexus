...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/spinner.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/spinner.py --strict
```

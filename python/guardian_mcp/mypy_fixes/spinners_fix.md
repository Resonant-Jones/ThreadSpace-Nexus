...
**File:** `.venv/lib/python3.13/site-packages/humanfriendly/terminal/spinners.py`
**Lines:** `310`
...
```bash
mypy .venv/lib/python3.13/site-packages/humanfriendly/terminal/spinners.py --strict
```

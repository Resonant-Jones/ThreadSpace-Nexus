...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/split.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/split.py --strict
```

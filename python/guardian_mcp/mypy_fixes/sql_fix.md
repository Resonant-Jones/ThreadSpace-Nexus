...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/sql.py`
**Lines:** `1203`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/sql.py --strict
```

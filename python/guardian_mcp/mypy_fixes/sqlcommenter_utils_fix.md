# 🧠 Mypy Fix Guide: `sqlcommenter_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/instrumentation/sqlcommenter_utils.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/instrumentation/sqlcommenter_utils.py --strict
```

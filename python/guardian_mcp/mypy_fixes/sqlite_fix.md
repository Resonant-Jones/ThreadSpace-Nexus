...
**File:** `.venv/lib/python3.13/site-packages/chromadb/segment/impl/metadata/sqlite.py`
**Lines:** `723`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/segment/impl/metadata/sqlite.py --strict
```

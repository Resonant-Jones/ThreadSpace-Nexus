...
**File:** `.venv/lib/python3.13/site-packages/chromadb/db/impl/sqlite_pool.py`
**Lines:** `163`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/db/impl/sqlite_pool.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/sqltypes.py`
**Lines:** `3921`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/sqltypes.py --strict
```

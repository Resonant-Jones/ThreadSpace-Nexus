...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/sqrtdenest.py`
**Lines:** `678`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/sqrtdenest.py --strict
```

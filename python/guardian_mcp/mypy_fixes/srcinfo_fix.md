...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/srcinfo.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/srcinfo.py --strict
```

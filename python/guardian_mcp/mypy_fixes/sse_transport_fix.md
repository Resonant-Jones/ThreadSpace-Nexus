# 🧠 Mypy Fix Guide: `sse_transport.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/_experimental/mcp_server/sse_transport.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/_experimental/mcp_server/sse_transport.py --strict
```

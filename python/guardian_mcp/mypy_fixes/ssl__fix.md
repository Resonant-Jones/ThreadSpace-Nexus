...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/ssl_.py`
**Lines:** `504`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/ssl_.py --strict
```

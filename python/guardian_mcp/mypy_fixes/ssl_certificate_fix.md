# 🧠 Mypy Fix Guide: `ssl_certificate.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/ssl_certificate.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/ssl_certificate.py --strict
```

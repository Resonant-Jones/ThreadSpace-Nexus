# 🧠 Mypy Fix Guide: `ssl_match_hostname.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/ssl_match_hostname.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/util/ssl_match_hostname.py --strict
```

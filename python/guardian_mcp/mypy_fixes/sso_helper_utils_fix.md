# 🧠 Mypy Fix Guide: `sso_helper_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/sso_helper_utils.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/sso_helper_utils.py --strict
```

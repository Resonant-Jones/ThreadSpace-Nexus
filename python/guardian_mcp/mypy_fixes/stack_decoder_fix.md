# 🧠 Mypy Fix Guide: `stack_decoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/translate/stack_decoder.py`
**Lines:** `515`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/translate/stack_decoder.py --strict
```

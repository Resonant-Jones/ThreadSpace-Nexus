# 🧠 Mypy Fix Guide: `staged_files_only.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/staged_files_only.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/staged_files_only.py --strict
```

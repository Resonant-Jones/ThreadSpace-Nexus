...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/stanford.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/stanford.py --strict
```

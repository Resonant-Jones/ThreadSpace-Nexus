# 🧠 Mypy Fix Guide: `stanford_segmenter.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/stanford_segmenter.py`
**Lines:** `292`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/stanford_segmenter.py --strict
```

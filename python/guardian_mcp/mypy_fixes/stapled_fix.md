...
**File:** `.venv/lib/python3.13/site-packages/anyio/streams/stapled.py`
**Lines:** `141`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/streams/stapled.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/staroffice.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/staroffice.py --strict
```

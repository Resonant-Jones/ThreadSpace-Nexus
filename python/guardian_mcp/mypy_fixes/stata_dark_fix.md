...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/stata_dark.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/stata_dark.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/stata.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/stata.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/stata_light.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/stata_light.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_block/state_block.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_block/state_block.py --strict
```

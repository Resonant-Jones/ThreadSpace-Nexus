# 🧠 Mypy Fix Guide: `state_changes.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/state_changes.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/state_changes.py --strict
```

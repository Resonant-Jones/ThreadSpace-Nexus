...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_core/state_core.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_core/state_core.py --strict
```

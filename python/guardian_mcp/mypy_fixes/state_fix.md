...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/state.py`
**Lines:** `987`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/state.py --strict
```

# 🧠 Mypy Fix Guide: `state_inline.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/state_inline.py`
**Lines:** `166`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/state_inline.py --strict
```

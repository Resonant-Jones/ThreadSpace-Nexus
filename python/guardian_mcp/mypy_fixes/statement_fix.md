...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/statement.py`
**Lines:** `1053`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/statement.py --strict
```

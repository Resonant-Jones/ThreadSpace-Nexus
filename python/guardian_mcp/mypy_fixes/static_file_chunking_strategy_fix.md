# 🧠 Mypy Fix Guide: `static_file_chunking_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/static_file_chunking_strategy.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/static_file_chunking_strategy.py --strict
```

# 🧠 Mypy Fix Guide: `static_file_chunking_strategy_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/static_file_chunking_strategy_object.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/static_file_chunking_strategy_object.py --strict
```

# 🧠 Mypy Fix Guide: `static_file_chunking_strategy_object_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/static_file_chunking_strategy_object_param.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/static_file_chunking_strategy_object_param.py --strict
```

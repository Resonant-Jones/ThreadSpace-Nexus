# 🧠 Mypy Fix Guide: `static_quantize_runner.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/static_quantize_runner.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/static_quantize_runner.py --strict
```

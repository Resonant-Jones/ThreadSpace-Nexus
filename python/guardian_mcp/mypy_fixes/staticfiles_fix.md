...
**File:** `.venv/lib/python3.13/site-packages/fastapi/staticfiles.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/staticfiles.py --strict
```

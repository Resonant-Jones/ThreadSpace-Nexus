...
**File:** `.venv/lib/python3.13/site-packages/flake8/statistics.py`
**Lines:** `131`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/statistics.py --strict
```

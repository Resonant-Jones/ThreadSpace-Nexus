...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/supervisors/statreload.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/supervisors/statreload.py --strict
```

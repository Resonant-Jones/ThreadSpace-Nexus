# 🧠 Mypy Fix Guide: `status_codes.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/cli/status_codes.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/cli/status_codes.py --strict
```

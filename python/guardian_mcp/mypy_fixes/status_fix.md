...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/trace/status.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/trace/status.py --strict
```

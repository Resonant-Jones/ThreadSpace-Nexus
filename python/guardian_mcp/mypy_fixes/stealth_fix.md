...
**File:** `.venv/lib/python3.13/site-packages/playwright_stealth/stealth.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/playwright_stealth/stealth.py --strict
```

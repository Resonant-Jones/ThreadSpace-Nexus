# 🧠 Mypy Fix Guide: `step_list_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/step_list_params.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/step_list_params.py --strict
```

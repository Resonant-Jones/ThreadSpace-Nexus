# 🧠 Mypy Fix Guide: `step_retrieve_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/step_retrieve_params.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/step_retrieve_params.py --strict
```

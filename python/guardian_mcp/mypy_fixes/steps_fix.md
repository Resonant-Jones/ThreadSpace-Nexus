...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/beta/threads/runs/steps.py`
**Lines:** `399`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/beta/threads/runs/steps.py --strict
```

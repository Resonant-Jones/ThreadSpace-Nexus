# 🧠 Mypy Fix Guide: `stochastic_process.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/stochastic_process.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/stochastic_process.py --strict
```

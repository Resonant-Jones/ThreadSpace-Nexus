# 🧠 Mypy Fix Guide: `stochastic_process_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/stochastic_process_types.py`
**Lines:** `2383`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/stochastic_process_types.py --strict
```

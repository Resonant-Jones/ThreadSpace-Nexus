...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/storage_api.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/storage_api.py --strict
```

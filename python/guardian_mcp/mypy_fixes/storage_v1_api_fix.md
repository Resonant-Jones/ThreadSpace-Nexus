# 🧠 Mypy Fix Guide: `storage_v1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/storage_v1_api.py`
**Lines:** `5964`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/storage_v1_api.py --strict
```

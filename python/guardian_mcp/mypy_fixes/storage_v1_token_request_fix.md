# 🧠 Mypy Fix Guide: `storage_v1_token_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/storage_v1_token_request.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/storage_v1_token_request.py --strict
```

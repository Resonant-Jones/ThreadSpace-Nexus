# 🧠 Mypy Fix Guide: `storagemigration_v1alpha1_api.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/api/storagemigration_v1alpha1_api.py`
**Lines:** `1593`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/api/storagemigration_v1alpha1_api.py --strict
```

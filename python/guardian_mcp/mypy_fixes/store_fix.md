...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/store.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/store.py --strict
```

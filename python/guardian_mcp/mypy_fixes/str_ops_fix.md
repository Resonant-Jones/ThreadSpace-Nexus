...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/str_ops.py`
**Lines:** `402`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/str_ops.py --strict
```

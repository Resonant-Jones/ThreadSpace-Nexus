...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/strategies.py`
**Lines:** `698`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/strategies.py --strict
```

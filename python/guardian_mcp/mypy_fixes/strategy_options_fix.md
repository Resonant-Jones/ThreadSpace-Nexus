# 🧠 Mypy Fix Guide: `strategy_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/strategy_options.py`
**Lines:** `2549`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/strategy_options.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/foundation/stream.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/foundation/stream.py --strict
```

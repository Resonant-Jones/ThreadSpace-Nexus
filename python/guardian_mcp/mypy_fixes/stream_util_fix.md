...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/foundation/stream_util.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/foundation/stream_util.py --strict
```

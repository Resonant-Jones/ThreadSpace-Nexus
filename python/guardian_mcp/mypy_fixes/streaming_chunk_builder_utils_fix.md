# 🧠 Mypy Fix Guide: `streaming_chunk_builder_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/streaming_chunk_builder_utils.py`
**Lines:** `435`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/streaming_chunk_builder_utils.py --strict
```

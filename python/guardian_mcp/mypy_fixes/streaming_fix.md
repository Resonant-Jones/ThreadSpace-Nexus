...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/codec/streaming.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/codec/streaming.py --strict
```

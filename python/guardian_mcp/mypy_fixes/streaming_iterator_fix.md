# 🧠 Mypy Fix Guide: `streaming_iterator.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/responses/litellm_completion_transformation/streaming_iterator.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/responses/litellm_completion_transformation/streaming_iterator.py --strict
```

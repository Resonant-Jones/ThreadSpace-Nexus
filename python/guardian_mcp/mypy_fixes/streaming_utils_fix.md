# 🧠 Mypy Fix Guide: `streaming_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/databricks/streaming_utils.py`
**Lines:** `165`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/databricks/streaming_utils.py --strict
```

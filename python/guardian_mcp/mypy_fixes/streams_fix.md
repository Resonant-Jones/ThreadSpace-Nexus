...
**File:** `.venv/lib/python3.13/site-packages/websockets/streams.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/websockets/streams.py --strict
```

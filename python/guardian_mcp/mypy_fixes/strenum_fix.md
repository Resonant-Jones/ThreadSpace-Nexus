...
**File:** `.venv/lib/python3.13/site-packages/magika/types/strenum.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/magika/types/strenum.py --strict
```

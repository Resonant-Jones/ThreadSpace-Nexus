# 🧠 Mypy Fix Guide: `strikethrough.py`
...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_inline/strikethrough.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_inline/strikethrough.py --strict
```

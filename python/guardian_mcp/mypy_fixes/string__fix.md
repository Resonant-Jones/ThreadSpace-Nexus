...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/arrays/string_.py`
**Lines:** `1080`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/arrays/string_.py --strict
```

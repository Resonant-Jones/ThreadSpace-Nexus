# 🧠 Mypy Fix Guide: `string_category.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/string_category.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/string_category.py --strict
```

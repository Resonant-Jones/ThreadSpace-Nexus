# 🧠 Mypy Fix Guide: `string_check_grader.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/string_check_grader.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/string_check_grader.py --strict
```

# 🧠 Mypy Fix Guide: `string_check_grader_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/string_check_grader_param.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/string_check_grader_param.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/formats/string.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/formats/string.py --strict
```

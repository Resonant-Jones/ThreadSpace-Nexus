# 🧠 Mypy Fix Guide: `string_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/string_utils.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/string_utils.py --strict
```

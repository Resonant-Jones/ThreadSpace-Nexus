...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/pretty/stringpict.py`
**Lines:** `537`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/pretty/stringpict.py --strict
```

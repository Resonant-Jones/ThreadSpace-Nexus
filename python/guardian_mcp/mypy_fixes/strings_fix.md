...
**File:** `.venv/lib/python3.13/site-packages/numpy/_core/strings.py`
**Lines:** `1823`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/_core/strings.py --strict
```

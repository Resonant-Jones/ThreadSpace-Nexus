# 🧠 Mypy Fix Guide: `stringy_numbers.py`
...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/stringy_numbers.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/stringy_numbers.py --strict
```

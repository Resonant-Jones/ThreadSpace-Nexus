# 🧠 Mypy Fix Guide: `strip-prefix.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/strip-prefix.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/strip-prefix.py --strict
```

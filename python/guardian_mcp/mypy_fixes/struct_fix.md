...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/struct.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/struct.py --strict
```

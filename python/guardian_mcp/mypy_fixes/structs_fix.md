...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/resolvelib/structs.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/resolvelib/structs.py --strict
```

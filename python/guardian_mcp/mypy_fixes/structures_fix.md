...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/requests/structures.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/requests/structures.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/grpc/framework/common/style.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/grpc/framework/common/style.py --strict
```

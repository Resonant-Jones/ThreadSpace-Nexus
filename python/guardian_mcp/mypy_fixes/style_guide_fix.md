...
**File:** `.venv/lib/python3.13/site-packages/flake8/style_guide.py`
**Lines:** `425`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/style_guide.py --strict
```

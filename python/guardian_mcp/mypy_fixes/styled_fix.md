...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/styled.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/styled.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/subexpr.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/subexpr.py --strict
```

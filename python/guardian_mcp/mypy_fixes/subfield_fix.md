...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/subfield.py`
**Lines:** `516`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/subfield.py --strict
```

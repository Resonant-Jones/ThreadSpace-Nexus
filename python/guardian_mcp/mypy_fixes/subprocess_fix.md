...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/subprocess.py`
**Lines:** `245`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/subprocess.py --strict
```

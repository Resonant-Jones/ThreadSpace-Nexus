# 🧠 Mypy Fix Guide: `subprocess_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/piptools/subprocess_utils.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/piptools/subprocess_utils.py --strict
```

# 🧠 Mypy Fix Guide: `subprocesses.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/type_tests/subprocesses.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/type_tests/subprocesses.py --strict
```

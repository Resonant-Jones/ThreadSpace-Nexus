# 🧠 Mypy Fix Guide: `subresultants_qq_zz.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/subresultants_qq_zz.py`
**Lines:** `2558`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/subresultants_qq_zz.py --strict
```

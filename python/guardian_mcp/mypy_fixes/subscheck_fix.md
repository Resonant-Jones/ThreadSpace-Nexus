...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/subscheck.py`
**Lines:** `392`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/subscheck.py --strict
```

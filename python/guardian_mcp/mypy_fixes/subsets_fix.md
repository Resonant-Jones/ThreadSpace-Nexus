...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/subsets.py`
**Lines:** `619`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/subsets.py --strict
```

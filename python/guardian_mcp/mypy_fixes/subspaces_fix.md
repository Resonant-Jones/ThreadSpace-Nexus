...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/subspaces.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/subspaces.py --strict
```

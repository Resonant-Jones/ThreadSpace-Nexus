...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/vcs/subversion.py`
**Lines:** `324`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/vcs/subversion.py --strict
```

# 🧠 Mypy Fix Guide: `success_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/success_handler.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/success_handler.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/suggestions.py`
**Lines:** `1052`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/suggestions.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/sum_.py`
**Lines:** `244`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/sum_.py --strict
```

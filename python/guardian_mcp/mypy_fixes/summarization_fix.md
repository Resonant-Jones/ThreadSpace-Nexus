# 🧠 Mypy Fix Guide: `summarization.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/summarization.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/summarization.py --strict
```

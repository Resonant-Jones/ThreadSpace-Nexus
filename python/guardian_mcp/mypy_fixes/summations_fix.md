...
**File:** `.venv/lib/python3.13/site-packages/sympy/concrete/summations.py`
**Lines:** `1659`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/concrete/summations.py --strict
```

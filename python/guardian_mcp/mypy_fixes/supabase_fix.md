...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/supabase.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/supabase.py --strict
```

# 🧠 Mypy Fix Guide: `supercollider.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/supercollider.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/supercollider.py --strict
```

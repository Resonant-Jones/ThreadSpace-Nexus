# 🧠 Mypy Fix Guide: `supervised_hyperparameters.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/supervised_hyperparameters.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/supervised_hyperparameters.py --strict
```

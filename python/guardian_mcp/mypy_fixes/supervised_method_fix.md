# 🧠 Mypy Fix Guide: `supervised_method.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/supervised_method.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/supervised_method.py --strict
```

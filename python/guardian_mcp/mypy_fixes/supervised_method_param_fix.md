# 🧠 Mypy Fix Guide: `supervised_method_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/fine_tuning/supervised_method_param.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/fine_tuning/supervised_method_param.py --strict
```

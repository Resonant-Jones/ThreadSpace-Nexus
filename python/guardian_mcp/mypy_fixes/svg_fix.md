...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/svg.py`
**Lines:** `185`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/svg.py --strict
```

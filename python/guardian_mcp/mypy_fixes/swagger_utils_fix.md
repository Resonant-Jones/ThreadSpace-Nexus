# 🧠 Mypy Fix Guide: `swagger_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/swagger_utils.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/swagger_utils.py --strict
```

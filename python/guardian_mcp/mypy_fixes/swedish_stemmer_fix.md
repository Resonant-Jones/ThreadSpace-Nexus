# 🧠 Mypy Fix Guide: `swedish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/swedish_stemmer.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/swedish_stemmer.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/languages/swift.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/languages/swift.py --strict
```

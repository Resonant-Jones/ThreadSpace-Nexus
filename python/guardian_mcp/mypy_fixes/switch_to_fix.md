...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/switch_to.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/switch_to.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/switchboard.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/switchboard.py --strict
```

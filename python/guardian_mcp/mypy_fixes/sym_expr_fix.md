...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/sym_expr.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/sym_expr.py --strict
```

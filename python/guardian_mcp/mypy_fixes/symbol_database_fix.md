# 🧠 Mypy Fix Guide: `symbol_database.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/symbol_database.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/symbol_database.py --strict
```

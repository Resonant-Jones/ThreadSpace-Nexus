...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/symbolic.py`
**Lines:** `1516`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/symbolic.py --strict
```

# 🧠 Mypy Fix Guide: `symbolic_multivariate_probability.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/symbolic_multivariate_probability.py`
**Lines:** `308`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/symbolic_multivariate_probability.py --strict
```

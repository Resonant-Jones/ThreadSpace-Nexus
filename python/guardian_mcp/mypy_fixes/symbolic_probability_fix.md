# 🧠 Mypy Fix Guide: `symbolic_probability.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/stats/symbolic_probability.py`
**Lines:** `698`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/stats/symbolic_probability.py --strict
```

# 🧠 Mypy Fix Guide: `symbolic_shape_infer.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/symbolic_shape_infer.py`
**Lines:** `3093`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/symbolic_shape_infer.py --strict
```

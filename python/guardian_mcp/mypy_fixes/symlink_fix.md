...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/embed/via_app_data/pip_install/symlink.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/embed/via_app_data/pip_install/symlink.py --strict
```

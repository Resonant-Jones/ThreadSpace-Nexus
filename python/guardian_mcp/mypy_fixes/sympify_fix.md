...
**File:** `.venv/lib/python3.13/site-packages/sympy/core/sympify.py`
**Lines:** `646`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/core/sympify.py --strict
```

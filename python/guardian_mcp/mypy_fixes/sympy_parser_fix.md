# 🧠 Mypy Fix Guide: `sympy_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/sympy_parser.py`
**Lines:** `1270`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/sympy_parser.py --strict
```

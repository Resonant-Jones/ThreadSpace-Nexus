...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_backends/sync.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_backends/sync.py --strict
```

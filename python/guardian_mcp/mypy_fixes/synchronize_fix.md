...
**File:** `.venv/lib/python3.13/site-packages/joblib/externals/loky/backend/synchronize.py`
**Lines:** `409`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/externals/loky/backend/synchronize.py --strict
```

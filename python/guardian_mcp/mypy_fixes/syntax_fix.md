...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/syntax.py`
**Lines:** `966`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/syntax.py --strict
```

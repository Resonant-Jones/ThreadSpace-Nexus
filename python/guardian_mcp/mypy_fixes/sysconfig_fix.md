...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/sysconfig.py`
**Lines:** `598`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/sysconfig.py --strict
```

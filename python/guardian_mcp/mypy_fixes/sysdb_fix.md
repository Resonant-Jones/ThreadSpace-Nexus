...
**File:** `.venv/lib/python3.13/site-packages/chromadb/db/mixins/sysdb.py`
**Lines:** `977`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/db/mixins/sysdb.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/coloredlogs/syslog.py`
**Lines:** `292`
...
```bash
mypy .venv/lib/python3.13/site-packages/coloredlogs/syslog.py --strict
```

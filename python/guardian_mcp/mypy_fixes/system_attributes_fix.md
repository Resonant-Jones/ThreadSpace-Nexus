# 🧠 Mypy Fix Guide: `system_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/system_attributes.py`
**Lines:** `221`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/system_attributes.py --strict
```

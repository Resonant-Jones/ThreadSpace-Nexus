...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/mechanics/system.py`
**Lines:** `1553`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/mechanics/system.py --strict
```

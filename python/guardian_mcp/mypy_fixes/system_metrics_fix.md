# 🧠 Mypy Fix Guide: `system_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/system_metrics.py`
**Lines:** `611`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/metrics/system_metrics.py --strict
```

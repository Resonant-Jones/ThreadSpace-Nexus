...
**File:** `.venv/lib/python3.13/site-packages/sympy/solvers/ode/systems.py`
**Lines:** `2135`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/solvers/ode/systems.py --strict
```

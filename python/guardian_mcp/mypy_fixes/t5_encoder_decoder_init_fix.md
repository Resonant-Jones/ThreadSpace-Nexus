# 🧠 Mypy Fix Guide: `t5_encoder_decoder_init.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/t5/t5_encoder_decoder_init.py`
**Lines:** `361`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/t5/t5_encoder_decoder_init.py --strict
```

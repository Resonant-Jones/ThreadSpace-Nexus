...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/t5/t5_encoder.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/t5/t5_encoder.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/t5/t5_helper.py`
**Lines:** `302`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/t5/t5_helper.py --strict
```

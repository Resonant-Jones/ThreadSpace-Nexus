...
**File:** `.venv/lib/python3.13/site-packages/mistune/plugins/table.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/plugins/table.py --strict
```

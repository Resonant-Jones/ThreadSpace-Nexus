# 🧠 Mypy Fix Guide: `table_question_answering.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/table_question_answering.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/table_question_answering.py --strict
```

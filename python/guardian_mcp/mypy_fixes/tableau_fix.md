...
**File:** `.venv/lib/python3.13/site-packages/nltk/inference/tableau.py`
**Lines:** `712`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/inference/tableau.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/tableform.py`
**Lines:** `366`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/tableform.py --strict
```

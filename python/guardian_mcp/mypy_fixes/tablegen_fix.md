...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/tablegen.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/tablegen.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/humanfriendly/tables.py`
**Lines:** `341`
...
```bash
mypy .venv/lib/python3.13/site-packages/humanfriendly/tables.py --strict
```

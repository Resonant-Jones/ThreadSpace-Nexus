...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/tact.py`
**Lines:** `303`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/tact.py --strict
```

# 🧠 Mypy Fix Guide: `tag_based_routing.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_strategy/tag_based_routing.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_strategy/tag_based_routing.py --strict
```

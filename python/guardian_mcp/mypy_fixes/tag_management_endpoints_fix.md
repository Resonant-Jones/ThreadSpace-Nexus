# 🧠 Mypy Fix Guide: `tag_management_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/tag_management_endpoints.py`
**Lines:** `436`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/tag_management_endpoints.py --strict
```

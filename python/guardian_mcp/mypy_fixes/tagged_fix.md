...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/tagged.py`
**Lines:** `354`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/tagged.py --strict
```

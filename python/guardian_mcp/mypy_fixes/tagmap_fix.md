...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/type/tagmap.py`
**Lines:** `96`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/type/tagmap.py --strict
```

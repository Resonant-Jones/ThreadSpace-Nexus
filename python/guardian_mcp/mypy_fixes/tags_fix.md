...
**File:** `.venv/lib/python3.13/site-packages/wheel/vendored/packaging/tags.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/wheel/vendored/packaging/tags.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/array_algos/take.py`
**Lines:** `594`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/array_algos/take.py --strict
```

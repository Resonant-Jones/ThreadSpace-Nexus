...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/tal.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/tal.py --strict
```

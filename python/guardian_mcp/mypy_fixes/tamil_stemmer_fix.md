# 🧠 Mypy Fix Guide: `tamil_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/tamil_stemmer.py`
**Lines:** `1788`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/tamil_stemmer.py --strict
```

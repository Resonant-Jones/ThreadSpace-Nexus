...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/tango.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/tango.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/tar.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/tar.py --strict
```

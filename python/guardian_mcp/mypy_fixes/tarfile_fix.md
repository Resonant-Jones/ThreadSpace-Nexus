...
**File:** `.venv/lib/python3.13/site-packages/build/_compat/tarfile.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/build/_compat/tarfile.py --strict
```

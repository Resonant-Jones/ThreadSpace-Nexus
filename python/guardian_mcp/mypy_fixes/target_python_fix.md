# 🧠 Mypy Fix Guide: `target_python.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/models/target_python.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/models/target_python.py --strict
```

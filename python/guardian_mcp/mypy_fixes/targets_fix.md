...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/targets.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/targets.py --strict
```

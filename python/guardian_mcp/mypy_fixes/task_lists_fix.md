...
**File:** `.venv/lib/python3.13/site-packages/mistune/plugins/task_lists.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/plugins/task_lists.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/type_tests/task_status.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/type_tests/task_status.py --strict
```

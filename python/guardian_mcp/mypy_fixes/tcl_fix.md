...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/tcl.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/tcl.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/tcp_helpers.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/tcp_helpers.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/teal.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/teal.py --strict
```

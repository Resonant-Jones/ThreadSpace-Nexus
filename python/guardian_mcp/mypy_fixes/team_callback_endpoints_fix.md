# 🧠 Mypy Fix Guide: `team_callback_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/team_callback_endpoints.py`
**Lines:** `383`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_endpoints/team_callback_endpoints.py --strict
```

# 🧠 Mypy Fix Guide: `team_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/team_endpoints.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/team_endpoints.py --strict
```

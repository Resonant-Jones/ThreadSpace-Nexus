# 🧠 Mypy Fix Guide: `team_member_permission_checks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/management_helpers/team_member_permission_checks.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/management_helpers/team_member_permission_checks.py --strict
```

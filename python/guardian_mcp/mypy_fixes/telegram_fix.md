...
**File:** `.venv/lib/python3.13/site-packages/tqdm/contrib/telegram.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/contrib/telegram.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/temp_dir.py`
**Lines:** `296`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/temp_dir.py --strict
```

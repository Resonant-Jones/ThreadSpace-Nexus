...
**File:** `.venv/lib/python3.13/site-packages/nltk/tbl/template.py`
**Lines:** `325`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tbl/template.py --strict
```

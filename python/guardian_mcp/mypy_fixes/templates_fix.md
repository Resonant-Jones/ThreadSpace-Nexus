...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/templates.py`
**Lines:** `2355`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/templates.py --strict
```

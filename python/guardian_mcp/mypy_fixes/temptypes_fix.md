...
**File:** `.venv/lib/python3.13/site-packages/aiofiles/tempfile/temptypes.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiofiles/tempfile/temptypes.py --strict
```

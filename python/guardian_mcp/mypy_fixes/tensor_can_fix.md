...
**File:** `.venv/lib/python3.13/site-packages/sympy/combinatorics/tensor_can.py`
**Lines:** `1189`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/combinatorics/tensor_can.py --strict
```

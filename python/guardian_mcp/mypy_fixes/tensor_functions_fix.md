# 🧠 Mypy Fix Guide: `tensor_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/tensor_functions.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/tensor_functions.py --strict
```

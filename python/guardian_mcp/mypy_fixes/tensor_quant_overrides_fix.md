# 🧠 Mypy Fix Guide: `tensor_quant_overrides.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/tensor_quant_overrides.py`
**Lines:** `520`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/tensor_quant_overrides.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/tensorflow.py`
**Lines:** `224`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/tensorflow.py --strict
```

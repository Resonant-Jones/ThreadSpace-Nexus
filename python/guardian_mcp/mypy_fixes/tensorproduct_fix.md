# 🧠 Mypy Fix Guide: `tensorproduct.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/tensorproduct.py`
**Lines:** `363`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/tensorproduct.py --strict
```

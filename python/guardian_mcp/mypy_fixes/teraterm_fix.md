...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/teraterm.py`
**Lines:** `325`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/teraterm.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/terminal256.py`
**Lines:** `338`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/terminal256.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/formatters/terminal.py`
**Lines:** `127`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/formatters/terminal.py --strict
```

# 🧠 Mypy Fix Guide: `terminalwriter.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/_io/terminalwriter.py`
**Lines:** `254`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/_io/terminalwriter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_abc.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_abc.py --strict
```

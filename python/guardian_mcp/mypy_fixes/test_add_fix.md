...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_add.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_add.py --strict
```

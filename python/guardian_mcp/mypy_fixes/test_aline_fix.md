...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_aline.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_aline.py --strict
```

# 🧠 Mypy Fix Guide: `test_analysis.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_analysis.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_analysis.py --strict
```

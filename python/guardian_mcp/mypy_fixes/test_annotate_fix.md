# 🧠 Mypy Fix Guide: `test_annotate.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_annotate.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_annotate.py --strict
```

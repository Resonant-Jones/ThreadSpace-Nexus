...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/test_api.py`
**Lines:** `1793`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/test_api.py --strict
```

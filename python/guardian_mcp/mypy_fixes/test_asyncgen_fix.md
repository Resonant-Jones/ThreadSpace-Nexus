# 🧠 Mypy Fix Guide: `test_asyncgen.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_asyncgen.py`
**Lines:** `337`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_asyncgen.py --strict
```

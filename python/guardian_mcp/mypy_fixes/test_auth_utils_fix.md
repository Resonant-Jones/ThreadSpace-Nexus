# 🧠 Mypy Fix Guide: `test_auth_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/auth/test_auth_utils.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/auth/test_auth_utils.py --strict
```

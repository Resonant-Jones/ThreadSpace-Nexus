# 🧠 Mypy Fix Guide: `test_before_send.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_before_send.py`
**Lines:** `171`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_before_send.py --strict
```

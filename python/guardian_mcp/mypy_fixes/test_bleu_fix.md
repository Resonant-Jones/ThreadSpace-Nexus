...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_bleu.py`
**Lines:** `416`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_bleu.py --strict
```

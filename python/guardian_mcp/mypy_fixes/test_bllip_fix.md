...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_bllip.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_bllip.py --strict
```

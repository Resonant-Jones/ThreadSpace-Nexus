...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_brill.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_brill.py --strict
```

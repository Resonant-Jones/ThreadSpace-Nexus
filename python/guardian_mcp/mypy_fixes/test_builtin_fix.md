# 🧠 Mypy Fix Guide: `test_builtin.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_builtin.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_builtin.py --strict
```

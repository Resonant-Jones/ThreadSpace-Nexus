...
**File:** `.venv/lib/python3.13/site-packages/annotated_types/test_cases.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/annotated_types/test_cases.py --strict
```

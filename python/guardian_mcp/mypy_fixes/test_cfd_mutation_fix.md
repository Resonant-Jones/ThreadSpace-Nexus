# 🧠 Mypy Fix Guide: `test_cfd_mutation.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_cfd_mutation.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_cfd_mutation.py --strict
```

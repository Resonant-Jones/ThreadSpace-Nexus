# 🧠 Mypy Fix Guide: `test_cfg2chomsky.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_cfg2chomsky.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_cfg2chomsky.py --strict
```

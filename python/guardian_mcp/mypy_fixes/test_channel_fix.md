# 🧠 Mypy Fix Guide: `test_channel.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_channel.py`
**Lines:** `627`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_channel.py --strict
```

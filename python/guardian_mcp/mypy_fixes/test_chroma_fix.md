...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/test_chroma.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/test_chroma.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_chunk.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_chunk.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/test_cli.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/test_cli.py --strict
```

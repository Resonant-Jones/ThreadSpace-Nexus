...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/test_client.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/test_client.py --strict
```

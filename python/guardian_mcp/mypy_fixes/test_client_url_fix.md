# 🧠 Mypy Fix Guide: `test_client_url.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_client_url.py`
**Lines:** `134`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_client_url.py --strict
```

# 🧠 Mypy Fix Guide: `test_cloud_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/client/test_cloud_client.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/client/test_cloud_client.py --strict
```

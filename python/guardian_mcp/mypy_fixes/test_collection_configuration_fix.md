# 🧠 Mypy Fix Guide: `test_collection_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/configurations/test_collection_configuration.py`
**Lines:** `1268`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/configurations/test_collection_configuration.py --strict
```

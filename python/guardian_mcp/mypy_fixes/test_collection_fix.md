# 🧠 Mypy Fix Guide: `test_collection.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_collection.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_collection.py --strict
```

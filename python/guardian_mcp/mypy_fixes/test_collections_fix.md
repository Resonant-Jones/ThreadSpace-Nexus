# 🧠 Mypy Fix Guide: `test_collections.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_collections.py`
**Lines:** `338`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_collections.py --strict
```

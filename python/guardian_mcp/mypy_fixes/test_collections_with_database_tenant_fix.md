# 🧠 Mypy Fix Guide: `test_collections_with_database_tenant.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_collections_with_database_tenant.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_collections_with_database_tenant.py --strict
```

# 🧠 Mypy Fix Guide: `test_collections_with_database_tenant_overwrite.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_collections_with_database_tenant_overwrite.py`
**Lines:** `214`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_collections_with_database_tenant_overwrite.py --strict
```

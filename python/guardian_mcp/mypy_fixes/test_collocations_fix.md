# 🧠 Mypy Fix Guide: `test_collocations.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_collocations.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_collocations.py --strict
```

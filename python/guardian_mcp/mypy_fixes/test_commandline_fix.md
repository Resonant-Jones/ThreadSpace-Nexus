# 🧠 Mypy Fix Guide: `test_commandline.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_commandline.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_commandline.py --strict
```

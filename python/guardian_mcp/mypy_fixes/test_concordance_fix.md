# 🧠 Mypy Fix Guide: `test_concordance.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_concordance.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_concordance.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/test_config.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/test_config.py --strict
```

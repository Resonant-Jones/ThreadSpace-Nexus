# 🧠 Mypy Fix Guide: `test_config_parser.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/test_config_parser.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/test_config_parser.py --strict
```

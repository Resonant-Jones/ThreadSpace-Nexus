# 🧠 Mypy Fix Guide: `test_configurations.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/configurations/test_configurations.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/configurations/test_configurations.py --strict
```

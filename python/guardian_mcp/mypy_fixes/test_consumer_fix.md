# 🧠 Mypy Fix Guide: `test_consumer.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_consumer.py`
**Lines:** `196`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_consumer.py --strict
```

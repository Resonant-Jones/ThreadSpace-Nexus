# 🧠 Mypy Fix Guide: `test_contextvars.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_contextvars.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_contextvars.py --strict
```

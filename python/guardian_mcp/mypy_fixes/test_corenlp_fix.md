# 🧠 Mypy Fix Guide: `test_corenlp.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_corenlp.py`
**Lines:** `1436`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_corenlp.py --strict
```

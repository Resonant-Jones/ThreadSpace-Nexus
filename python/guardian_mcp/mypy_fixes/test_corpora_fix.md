# 🧠 Mypy Fix Guide: `test_corpora.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_corpora.py`
**Lines:** `275`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_corpora.py --strict
```

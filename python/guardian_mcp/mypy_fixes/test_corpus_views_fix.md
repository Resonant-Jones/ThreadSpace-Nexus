# 🧠 Mypy Fix Guide: `test_corpus_views.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_corpus_views.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_corpus_views.py --strict
```

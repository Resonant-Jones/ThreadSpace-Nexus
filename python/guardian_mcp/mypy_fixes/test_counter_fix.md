# 🧠 Mypy Fix Guide: `test_counter.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_counter.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_counter.py --strict
```

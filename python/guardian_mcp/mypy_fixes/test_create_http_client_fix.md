# 🧠 Mypy Fix Guide: `test_create_http_client.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/client/test_create_http_client.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/client/test_create_http_client.py --strict
```

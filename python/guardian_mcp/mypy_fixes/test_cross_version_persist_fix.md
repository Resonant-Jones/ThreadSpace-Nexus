# 🧠 Mypy Fix Guide: `test_cross_version_persist.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_cross_version_persist.py`
**Lines:** `350`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_cross_version_persist.py --strict
```

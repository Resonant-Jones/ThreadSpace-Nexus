...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_cte.py`
**Lines:** `211`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_cte.py --strict
```

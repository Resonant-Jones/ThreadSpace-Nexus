# 🧠 Mypy Fix Guide: `test_custom_ef.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_custom_ef.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_custom_ef.py --strict
```

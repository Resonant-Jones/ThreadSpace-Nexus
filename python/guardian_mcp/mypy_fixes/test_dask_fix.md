...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_dask.py`
**Lines:** `607`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_dask.py --strict
```

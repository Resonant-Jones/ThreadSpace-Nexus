...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_data.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_data.py --strict
```

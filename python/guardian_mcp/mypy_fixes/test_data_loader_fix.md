# 🧠 Mypy Fix Guide: `test_data_loader.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/data_loader/test_data_loader.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/data_loader/test_data_loader.py --strict
```

# 🧠 Mypy Fix Guide: `test_database_tenant_auth.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/client/test_database_tenant_auth.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/client/test_database_tenant_auth.py --strict
```

# 🧠 Mypy Fix Guide: `test_database_tenant.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/client/test_database_tenant.py`
**Lines:** `184`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/client/test_database_tenant.py --strict
```

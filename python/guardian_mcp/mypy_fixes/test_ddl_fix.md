...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_ddl.py`
**Lines:** `389`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_ddl.py --strict
```

# 🧠 Mypy Fix Guide: `test_default_ef.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_default_ef.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_default_ef.py --strict
```

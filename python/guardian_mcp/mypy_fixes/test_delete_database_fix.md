# 🧠 Mypy Fix Guide: `test_delete_database.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_delete_database.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_delete_database.py --strict
```

# 🧠 Mypy Fix Guide: `test_deprecate.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_deprecate.py`
**Lines:** `289`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_deprecate.py --strict
```

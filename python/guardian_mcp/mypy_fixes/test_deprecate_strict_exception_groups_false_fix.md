# 🧠 Mypy Fix Guide: `test_deprecate_strict_exception_groups_false.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_deprecate_strict_exception_groups_false.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_deprecate_strict_exception_groups_false.py --strict
```

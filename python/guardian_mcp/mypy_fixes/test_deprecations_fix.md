# 🧠 Mypy Fix Guide: `test_deprecations.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_deprecations.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_deprecations.py --strict
```

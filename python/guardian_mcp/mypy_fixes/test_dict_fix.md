...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_dict.py`
**Lines:** `193`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_dict.py --strict
```

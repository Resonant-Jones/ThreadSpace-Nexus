# 🧠 Mypy Fix Guide: `test_disagreement.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_disagreement.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_disagreement.py --strict
```

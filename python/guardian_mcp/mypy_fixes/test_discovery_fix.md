# 🧠 Mypy Fix Guide: `test_discovery.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/dynamic/test_discovery.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/dynamic/test_discovery.py --strict
```

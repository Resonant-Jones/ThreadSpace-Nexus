...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_disk.py`
**Lines:** `80`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_disk.py --strict
```

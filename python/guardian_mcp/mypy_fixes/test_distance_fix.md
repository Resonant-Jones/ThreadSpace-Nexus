# 🧠 Mypy Fix Guide: `test_distance.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_distance.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_distance.py --strict
```

# 🧠 Mypy Fix Guide: `test_doctests.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_doctests.py`
**Lines:** `444`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_doctests.py --strict
```

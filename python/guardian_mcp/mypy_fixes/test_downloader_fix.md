# 🧠 Mypy Fix Guide: `test_downloader.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_downloader.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_downloader.py --strict
```

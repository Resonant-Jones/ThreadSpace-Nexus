...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_dtls.py`
**Lines:** `902`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_dtls.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_ef.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_ef.py --strict
```

# 🧠 Mypy Fix Guide: `test_embedding_function_schemas.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/utils/test_embedding_function_schemas.py`
**Lines:** `131`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/utils/test_embedding_function_schemas.py --strict
```

# 🧠 Mypy Fix Guide: `test_embeddings.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_embeddings.py`
**Lines:** `1505`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_embeddings.py --strict
```

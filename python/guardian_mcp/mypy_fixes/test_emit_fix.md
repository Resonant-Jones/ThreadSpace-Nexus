...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_emit.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_emit.py --strict
```

# 🧠 Mypy Fix Guide: `test_emitclass.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_emitclass.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_emitclass.py --strict
```

# 🧠 Mypy Fix Guide: `test_emitfunc.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_emitfunc.py`
**Lines:** `954`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_emitfunc.py --strict
```

# 🧠 Mypy Fix Guide: `test_emitwrapper.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_emitwrapper.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_emitwrapper.py --strict
```

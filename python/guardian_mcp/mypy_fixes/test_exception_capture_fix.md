# 🧠 Mypy Fix Guide: `test_exception_capture.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_exception_capture.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_exception_capture.py --strict
```

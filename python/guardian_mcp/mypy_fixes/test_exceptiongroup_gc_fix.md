# 🧠 Mypy Fix Guide: `test_exceptiongroup_gc.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_exceptiongroup_gc.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_exceptiongroup_gc.py --strict
```

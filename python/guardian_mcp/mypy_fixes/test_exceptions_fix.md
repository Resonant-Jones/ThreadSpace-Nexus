# 🧠 Mypy Fix Guide: `test_exceptions.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_exceptions.py`
**Lines:** `56`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_exceptions.py --strict
```

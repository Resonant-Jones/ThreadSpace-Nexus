# 🧠 Mypy Fix Guide: `test_exports.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_exports.py`
**Lines:** `612`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_exports.py --strict
```

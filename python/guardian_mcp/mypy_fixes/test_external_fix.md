# 🧠 Mypy Fix Guide: `test_external.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_external.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_external.py --strict
```

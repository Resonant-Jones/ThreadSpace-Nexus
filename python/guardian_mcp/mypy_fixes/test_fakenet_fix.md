# 🧠 Mypy Fix Guide: `test_fakenet.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_fakenet.py`
**Lines:** `317`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_fakenet.py --strict
```

# 🧠 Mypy Fix Guide: `test_feature_flag.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_feature_flag.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_feature_flag.py --strict
```

# 🧠 Mypy Fix Guide: `test_feature_flags.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_feature_flags.py`
**Lines:** `5311`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_feature_flags.py --strict
```

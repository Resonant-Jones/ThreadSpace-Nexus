# 🧠 Mypy Fix Guide: `test_file_io.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_file_io.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_file_io.py --strict
```

# 🧠 Mypy Fix Guide: `test_filtering.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_filtering.py`
**Lines:** `599`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_filtering.py --strict
```

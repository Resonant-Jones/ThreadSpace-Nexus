# 🧠 Mypy Fix Guide: `test_find_sources.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/test_find_sources.py`
**Lines:** `376`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/test_find_sources.py --strict
```

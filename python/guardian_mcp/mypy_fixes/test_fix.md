...
**File:** `.venv/lib/python3.13/site-packages/setuptools/command/test.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/command/test.py --strict
```

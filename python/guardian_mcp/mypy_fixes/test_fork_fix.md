...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_fork.py`
**Lines:** `191`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_fork.py --strict
```

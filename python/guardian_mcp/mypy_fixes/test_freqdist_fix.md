# 🧠 Mypy Fix Guide: `test_freqdist.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_freqdist.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_freqdist.py --strict
```

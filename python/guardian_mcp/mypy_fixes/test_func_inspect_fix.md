# 🧠 Mypy Fix Guide: `test_func_inspect.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_func_inspect.py`
**Lines:** `338`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_func_inspect.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_gdfa.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_gdfa.py --strict
```

# 🧠 Mypy Fix Guide: `test_gen_exports.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/tools/test_gen_exports.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/tools/test_gen_exports.py --strict
```

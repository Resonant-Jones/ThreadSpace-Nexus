# 🧠 Mypy Fix Guide: `test_get_database.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_get_database.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_get_database.py --strict
```

# 🧠 Mypy Fix Guide: `test_guest_mode.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_guest_mode.py`
**Lines:** `756`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_guest_mode.py --strict
```

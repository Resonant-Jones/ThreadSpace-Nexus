# 🧠 Mypy Fix Guide: `test_hashing.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_hashing.py`
**Lines:** `520`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_hashing.py --strict
```

# 🧠 Mypy Fix Guide: `test_highlevel_generic.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_generic.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_generic.py --strict
```

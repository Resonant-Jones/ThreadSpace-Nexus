# 🧠 Mypy Fix Guide: `test_highlevel_open_tcp_listeners.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_open_tcp_listeners.py`
**Lines:** `419`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_open_tcp_listeners.py --strict
```

# 🧠 Mypy Fix Guide: `test_highlevel_open_tcp_stream.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_open_tcp_stream.py`
**Lines:** `694`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_open_tcp_stream.py --strict
```

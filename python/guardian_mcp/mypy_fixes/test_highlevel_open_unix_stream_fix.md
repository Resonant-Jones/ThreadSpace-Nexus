# 🧠 Mypy Fix Guide: `test_highlevel_open_unix_stream.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_open_unix_stream.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_open_unix_stream.py --strict
```

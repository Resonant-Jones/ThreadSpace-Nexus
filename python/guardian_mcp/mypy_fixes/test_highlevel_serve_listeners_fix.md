# 🧠 Mypy Fix Guide: `test_highlevel_serve_listeners.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_serve_listeners.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_serve_listeners.py --strict
```

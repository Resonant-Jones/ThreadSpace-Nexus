# 🧠 Mypy Fix Guide: `test_highlevel_socket.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_socket.py`
**Lines:** `336`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_socket.py --strict
```

# 🧠 Mypy Fix Guide: `test_highlevel_ssl_helpers.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_ssl_helpers.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_highlevel_ssl_helpers.py --strict
```

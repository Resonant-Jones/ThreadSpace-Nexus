...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_hmm.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_hmm.py --strict
```

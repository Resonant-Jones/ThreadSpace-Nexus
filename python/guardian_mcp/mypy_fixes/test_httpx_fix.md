...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/test_httpx.py`
**Lines:** `0`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/test_httpx.py --strict
```

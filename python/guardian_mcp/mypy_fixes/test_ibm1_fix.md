...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm1.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm1.py --strict
```

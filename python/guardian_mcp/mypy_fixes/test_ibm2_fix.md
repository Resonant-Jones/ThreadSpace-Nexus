...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm2.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm2.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm3.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm3.py --strict
```

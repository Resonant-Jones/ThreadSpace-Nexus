...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm4.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm4.py --strict
```

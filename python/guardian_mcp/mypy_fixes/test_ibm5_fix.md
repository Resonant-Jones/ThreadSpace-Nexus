...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm5.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm5.py --strict
```

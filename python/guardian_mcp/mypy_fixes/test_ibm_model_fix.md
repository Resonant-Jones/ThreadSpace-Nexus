# 🧠 Mypy Fix Guide: `test_ibm_model.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm_model.py`
**Lines:** `269`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_ibm_model.py --strict
```

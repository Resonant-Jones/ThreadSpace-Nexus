# 🧠 Mypy Fix Guide: `test_imports.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_imports.py`
**Lines:** `1207`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_imports.py --strict
```

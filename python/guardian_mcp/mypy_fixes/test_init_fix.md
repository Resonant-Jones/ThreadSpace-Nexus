...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_init.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_init.py --strict
```

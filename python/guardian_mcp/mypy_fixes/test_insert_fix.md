...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_insert.py`
**Lines:** `630`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_insert.py --strict
```

# 🧠 Mypy Fix Guide: `test_instrumentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_instrumentation.py`
**Lines:** `315`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_instrumentation.py --strict
```

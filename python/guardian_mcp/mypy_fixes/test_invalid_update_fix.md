# 🧠 Mypy Fix Guide: `test_invalid_update.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_invalid_update.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_invalid_update.py --strict
```

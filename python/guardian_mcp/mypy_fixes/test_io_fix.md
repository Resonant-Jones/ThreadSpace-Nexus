...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_io.py`
**Lines:** `522`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_io.py --strict
```

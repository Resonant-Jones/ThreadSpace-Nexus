# 🧠 Mypy Fix Guide: `test_irbuild.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_irbuild.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_irbuild.py --strict
```

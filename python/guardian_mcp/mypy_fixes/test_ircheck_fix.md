# 🧠 Mypy Fix Guide: `test_ircheck.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_ircheck.py`
**Lines:** `199`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_ircheck.py --strict
```

# 🧠 Mypy Fix Guide: `test_is_literal.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_is_literal.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_is_literal.py --strict
```

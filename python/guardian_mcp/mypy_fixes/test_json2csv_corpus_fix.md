# 🧠 Mypy Fix Guide: `test_json2csv_corpus.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_json2csv_corpus.py`
**Lines:** `210`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_json2csv_corpus.py --strict
```

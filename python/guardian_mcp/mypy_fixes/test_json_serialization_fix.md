# 🧠 Mypy Fix Guide: `test_json_serialization.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_json_serialization.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_json_serialization.py --strict
```

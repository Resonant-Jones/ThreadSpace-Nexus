...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_ki.py`
**Lines:** `705`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_ki.py --strict
```

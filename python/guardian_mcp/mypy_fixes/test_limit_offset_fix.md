# 🧠 Mypy Fix Guide: `test_limit_offset.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_limit_offset.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_limit_offset.py --strict
```

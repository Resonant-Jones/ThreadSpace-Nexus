# 🧠 Mypy Fix Guide: `test_list_databases.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_list_databases.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_list_databases.py --strict
```

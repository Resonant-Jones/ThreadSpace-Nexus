# 🧠 Mypy Fix Guide: `test_literals.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_literals.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_literals.py --strict
```

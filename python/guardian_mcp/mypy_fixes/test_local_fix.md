...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_local.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_local.py --strict
```

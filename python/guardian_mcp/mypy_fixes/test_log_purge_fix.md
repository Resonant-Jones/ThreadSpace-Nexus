# 🧠 Mypy Fix Guide: `test_log_purge.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/db/test_log_purge.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/db/test_log_purge.py --strict
```

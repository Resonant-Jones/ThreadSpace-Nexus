...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_logger.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_logger.py --strict
```

# 🧠 Mypy Fix Guide: `test_lowering.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_lowering.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_lowering.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_match.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_match.py --strict
```

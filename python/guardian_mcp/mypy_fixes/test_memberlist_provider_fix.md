# 🧠 Mypy Fix Guide: `test_memberlist_provider.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/segment/distributed/test_memberlist_provider.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/segment/distributed/test_memberlist_provider.py --strict
```

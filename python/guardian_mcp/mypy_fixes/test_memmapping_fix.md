# 🧠 Mypy Fix Guide: `test_memmapping.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_memmapping.py`
**Lines:** `1280`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_memmapping.py --strict
```

# 🧠 Mypy Fix Guide: `test_memory_async.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_memory_async.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_memory_async.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_memory.py`
**Lines:** `1577`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_memory.py --strict
```

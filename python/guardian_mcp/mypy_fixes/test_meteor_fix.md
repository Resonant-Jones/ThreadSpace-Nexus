...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_meteor.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_meteor.py --strict
```

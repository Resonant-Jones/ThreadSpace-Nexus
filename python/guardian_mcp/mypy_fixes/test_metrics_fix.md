# 🧠 Mypy Fix Guide: `test_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_metrics.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_metrics.py --strict
```

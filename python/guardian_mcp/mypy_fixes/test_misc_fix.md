...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_misc.py`
**Lines:** `20`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_misc.py --strict
```

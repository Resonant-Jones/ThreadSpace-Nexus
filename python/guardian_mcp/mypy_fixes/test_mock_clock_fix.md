# 🧠 Mypy Fix Guide: `test_mock_clock.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_mock_clock.py`
**Lines:** `193`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_mock_clock.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_models.py`
**Lines:** `611`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_models.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_module.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_module.py --strict
```

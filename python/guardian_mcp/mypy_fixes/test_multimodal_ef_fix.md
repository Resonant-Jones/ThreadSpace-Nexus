# 🧠 Mypy Fix Guide: `test_multimodal_ef.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_multimodal_ef.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_multimodal_ef.py --strict
```

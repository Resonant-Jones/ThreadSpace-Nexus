# 🧠 Mypy Fix Guide: `test_mypy_annotate.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/tools/test_mypy_annotate.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/tools/test_mypy_annotate.py --strict
```

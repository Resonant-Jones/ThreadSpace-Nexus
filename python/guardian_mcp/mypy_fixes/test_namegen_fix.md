# 🧠 Mypy Fix Guide: `test_namegen.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_namegen.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_namegen.py --strict
```

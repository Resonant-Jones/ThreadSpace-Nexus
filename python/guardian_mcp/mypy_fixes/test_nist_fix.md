...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_nist.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_nist.py --strict
```

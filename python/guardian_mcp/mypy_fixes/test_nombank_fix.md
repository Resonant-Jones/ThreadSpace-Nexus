# 🧠 Mypy Fix Guide: `test_nombank.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_nombank.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_nombank.py --strict
```

# 🧠 Mypy Fix Guide: `test_numpy_list_inputs.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_numpy_list_inputs.py`
**Lines:** `62`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_numpy_list_inputs.py --strict
```

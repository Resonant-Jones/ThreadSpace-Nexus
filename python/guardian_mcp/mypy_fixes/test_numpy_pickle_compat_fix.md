# 🧠 Mypy Fix Guide: `test_numpy_pickle_compat.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_numpy_pickle_compat.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_numpy_pickle_compat.py --strict
```

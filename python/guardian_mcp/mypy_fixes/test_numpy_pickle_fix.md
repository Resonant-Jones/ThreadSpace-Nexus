# 🧠 Mypy Fix Guide: `test_numpy_pickle.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_numpy_pickle.py`
**Lines:** `1225`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_numpy_pickle.py --strict
```

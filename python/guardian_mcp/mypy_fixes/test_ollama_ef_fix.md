# 🧠 Mypy Fix Guide: `test_ollama_ef.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_ollama_ef.py`
**Lines:** `50`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_ollama_ef.py --strict
```

# 🧠 Mypy Fix Guide: `test_onnx_mini_lm_l6_v2.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_onnx_mini_lm_l6_v2.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_onnx_mini_lm_l6_v2.py --strict
```

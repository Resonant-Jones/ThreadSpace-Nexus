# 🧠 Mypy Fix Guide: `test_openai_ef.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_openai_ef.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_openai_ef.py --strict
```

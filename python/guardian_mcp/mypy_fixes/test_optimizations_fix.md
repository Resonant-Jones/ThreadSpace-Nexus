# 🧠 Mypy Fix Guide: `test_optimizations.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_optimizations.py`
**Lines:** `68`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_optimizations.py --strict
```

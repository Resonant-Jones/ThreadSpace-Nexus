...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_other.py`
**Lines:** `2134`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_other.py --strict
```

# 🧠 Mypy Fix Guide: `test_parking_lot.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_parking_lot.py`
**Lines:** `390`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_parking_lot.py --strict
```

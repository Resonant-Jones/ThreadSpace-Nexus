# 🧠 Mypy Fix Guide: `test_parse_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/meta/test_parse_data.py`
**Lines:** `73`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/meta/test_parse_data.py --strict
```

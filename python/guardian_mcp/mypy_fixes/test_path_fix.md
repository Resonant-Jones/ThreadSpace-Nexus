...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_path.py`
**Lines:** `279`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_path.py --strict
```

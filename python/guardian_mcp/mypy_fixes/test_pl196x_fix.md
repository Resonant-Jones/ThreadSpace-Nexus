...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_pl196x.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_pl196x.py --strict
```

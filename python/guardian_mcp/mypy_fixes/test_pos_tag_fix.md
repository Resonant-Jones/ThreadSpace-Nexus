# 🧠 Mypy Fix Guide: `test_pos_tag.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_pos_tag.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_pos_tag.py --strict
```

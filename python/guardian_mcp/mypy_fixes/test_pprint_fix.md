...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_pprint.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_pprint.py --strict
```

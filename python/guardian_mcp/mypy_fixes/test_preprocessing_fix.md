# 🧠 Mypy Fix Guide: `test_preprocessing.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_preprocessing.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_preprocessing.py --strict
```

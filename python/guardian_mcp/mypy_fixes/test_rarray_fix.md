...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_rarray.py`
**Lines:** `48`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_rarray.py --strict
```

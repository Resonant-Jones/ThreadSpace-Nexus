# 🧠 Mypy Fix Guide: `test_ref_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/test_ref_info.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/test_ref_info.py --strict
```

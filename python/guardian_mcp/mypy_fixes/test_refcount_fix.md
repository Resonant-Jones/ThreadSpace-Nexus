# 🧠 Mypy Fix Guide: `test_refcount.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_refcount.py`
**Lines:** `59`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_refcount.py --strict
```

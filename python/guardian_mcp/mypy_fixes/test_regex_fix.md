...
**File:** `.venv/lib/python3.13/site-packages/regex/test_regex.py`
**Lines:** `4488`
...
```bash
mypy .venv/lib/python3.13/site-packages/regex/test_regex.py --strict
```

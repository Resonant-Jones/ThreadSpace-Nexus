# 🧠 Mypy Fix Guide: `test_rendezvous_hash.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/segment/distributed/test_rendezvous_hash.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/segment/distributed/test_rendezvous_hash.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_repl.py`
**Lines:** `241`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_repl.py --strict
```

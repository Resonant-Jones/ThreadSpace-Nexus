# 🧠 Mypy Fix Guide: `test_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_request.py`
**Lines:** `130`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_request.py --strict
```

# 🧠 Mypy Fix Guide: `test_restart_persist.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/property/test_restart_persist.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/property/test_restart_persist.py --strict
```

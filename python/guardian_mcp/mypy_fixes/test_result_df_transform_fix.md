# 🧠 Mypy Fix Guide: `test_result_df_transform.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/utils/test_result_df_transform.py`
**Lines:** `184`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/utils/test_result_df_transform.py --strict
```

# 🧠 Mypy Fix Guide: `test_results.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_results.py`
**Lines:** `504`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_results.py --strict
```

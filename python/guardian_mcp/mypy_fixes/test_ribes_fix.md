...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_ribes.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_ribes.py --strict
```

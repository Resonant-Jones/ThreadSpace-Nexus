# 🧠 Mypy Fix Guide: `test_rowcount.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_rowcount.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_rowcount.py --strict
```

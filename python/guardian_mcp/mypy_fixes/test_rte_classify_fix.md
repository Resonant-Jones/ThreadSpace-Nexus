# 🧠 Mypy Fix Guide: `test_rte_classify.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_rte_classify.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_rte_classify.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_run.py`
**Lines:** `476`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_run.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/distributed/test_sanity.py`
**Lines:** `102`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/distributed/test_sanity.py --strict
```

# 🧠 Mypy Fix Guide: `test_scheduler_determinism.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_scheduler_determinism.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_scheduler_determinism.py --strict
```

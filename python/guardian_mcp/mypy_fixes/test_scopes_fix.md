...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_scopes.py`
**Lines:** `138`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_scopes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_select.py`
**Lines:** `2008`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_select.py --strict
```

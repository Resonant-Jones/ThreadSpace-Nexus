...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_senna.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_senna.py --strict
```

# 🧠 Mypy Fix Guide: `test_sequence.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_sequence.py`
**Lines:** `317`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_sequence.py --strict
```

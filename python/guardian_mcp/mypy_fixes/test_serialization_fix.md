# 🧠 Mypy Fix Guide: `test_serialization.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_serialization.py`
**Lines:** `108`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_serialization.py --strict
```

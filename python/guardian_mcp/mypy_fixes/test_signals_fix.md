# 🧠 Mypy Fix Guide: `test_signals.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_signals.py`
**Lines:** `187`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_signals.py --strict
```

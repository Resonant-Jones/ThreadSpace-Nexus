# 🧠 Mypy Fix Guide: `test_size_limited_dict.py`
...
**File:** `.venv/lib/python3.13/site-packages/posthog/test/test_size_limited_dict.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/posthog/test/test_size_limited_dict.py --strict
```

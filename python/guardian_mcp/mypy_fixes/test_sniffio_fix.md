# 🧠 Mypy Fix Guide: `test_sniffio.py`
...
**File:** `.venv/lib/python3.13/site-packages/sniffio/_tests/test_sniffio.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/sniffio/_tests/test_sniffio.py --strict
```

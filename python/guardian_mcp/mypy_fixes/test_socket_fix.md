...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_socket.py`
**Lines:** `1253`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_socket.py --strict
```

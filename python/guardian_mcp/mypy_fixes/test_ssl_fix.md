...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_ssl.py`
**Lines:** `1378`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_ssl.py --strict
```

# 🧠 Mypy Fix Guide: `test_stack_decoder.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_stack_decoder.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/translate/test_stack_decoder.py --strict
```

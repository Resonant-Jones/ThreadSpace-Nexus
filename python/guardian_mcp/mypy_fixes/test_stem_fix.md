...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_stem.py`
**Lines:** `157`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_stem.py --strict
```

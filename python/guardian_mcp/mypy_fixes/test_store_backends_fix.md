# 🧠 Mypy Fix Guide: `test_store_backends.py`
...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_store_backends.py`
**Lines:** `94`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_store_backends.py --strict
```

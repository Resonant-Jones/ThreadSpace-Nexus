...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_struct.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_struct.py --strict
```

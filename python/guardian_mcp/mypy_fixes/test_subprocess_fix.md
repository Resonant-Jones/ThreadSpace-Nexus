# 🧠 Mypy Fix Guide: `test_subprocess.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_subprocess.py`
**Lines:** `767`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_subprocess.py --strict
```

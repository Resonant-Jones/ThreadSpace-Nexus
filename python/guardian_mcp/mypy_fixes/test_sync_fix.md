...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_sync.py`
**Lines:** `655`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_sync.py --strict
```

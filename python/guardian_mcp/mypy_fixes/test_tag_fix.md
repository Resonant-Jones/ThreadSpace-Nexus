...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_tag.py`
**Lines:** `23`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_tag.py --strict
```

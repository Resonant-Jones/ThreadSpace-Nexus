# 🧠 Mypy Fix Guide: `test_testing.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_testing.py`
**Lines:** `684`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_testing.py --strict
```

# 🧠 Mypy Fix Guide: `test_testing_raisesgroup.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_testing_raisesgroup.py`
**Lines:** `1118`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_testing_raisesgroup.py --strict
```

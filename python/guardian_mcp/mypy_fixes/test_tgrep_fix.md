...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_tgrep.py`
**Lines:** `779`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_tgrep.py --strict
```

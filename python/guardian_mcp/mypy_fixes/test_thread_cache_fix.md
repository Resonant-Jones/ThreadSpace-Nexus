# 🧠 Mypy Fix Guide: `test_thread_cache.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_thread_cache.py`
**Lines:** `242`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_thread_cache.py --strict
```

# 🧠 Mypy Fix Guide: `test_threads.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_threads.py`
**Lines:** `1143`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_threads.py --strict
```

# 🧠 Mypy Fix Guide: `test_timeouts.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_timeouts.py`
**Lines:** `281`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_timeouts.py --strict
```

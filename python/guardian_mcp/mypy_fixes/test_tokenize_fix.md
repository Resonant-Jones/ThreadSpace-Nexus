# 🧠 Mypy Fix Guide: `test_tokenize.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_tokenize.py`
**Lines:** `905`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_tokenize.py --strict
```

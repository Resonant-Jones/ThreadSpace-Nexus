# 🧠 Mypy Fix Guide: `test_tracing.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_tracing.py`
**Lines:** `71`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_tracing.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_trio.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_trio.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_tutil.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_tutil.py --strict
```

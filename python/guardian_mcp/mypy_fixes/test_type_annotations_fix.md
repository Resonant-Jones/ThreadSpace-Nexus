# 🧠 Mypy Fix Guide: `test_type_annotations.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_type_annotations.py`
**Lines:** `806`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_type_annotations.py --strict
```

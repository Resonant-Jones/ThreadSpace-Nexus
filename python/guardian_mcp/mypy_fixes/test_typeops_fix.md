# 🧠 Mypy Fix Guide: `test_typeops.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/test_typeops.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/test_typeops.py --strict
```

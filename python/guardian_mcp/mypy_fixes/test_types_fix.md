...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/api/test_types.py`
**Lines:** `105`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/api/test_types.py --strict
```

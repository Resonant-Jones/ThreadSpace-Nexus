# 🧠 Mypy Fix Guide: `test_unbounded_queue.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_unbounded_queue.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_unbounded_queue.py --strict
```

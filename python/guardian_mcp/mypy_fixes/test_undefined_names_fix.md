# 🧠 Mypy Fix Guide: `test_undefined_names.py`
...
**File:** `.venv/lib/python3.13/site-packages/pyflakes/test/test_undefined_names.py`
**Lines:** `819`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyflakes/test/test_undefined_names.py --strict
```

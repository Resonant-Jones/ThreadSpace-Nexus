# 🧠 Mypy Fix Guide: `test_unicode_ddl.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_unicode_ddl.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_unicode_ddl.py --strict
```

# 🧠 Mypy Fix Guide: `test_unix_pipes.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_unix_pipes.py`
**Lines:** `291`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_unix_pipes.py --strict
```

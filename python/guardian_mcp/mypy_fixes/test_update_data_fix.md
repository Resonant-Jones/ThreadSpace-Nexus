# 🧠 Mypy Fix Guide: `test_update_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/meta/test_update_data.py`
**Lines:** `135`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/meta/test_update_data.py --strict
```

# 🧠 Mypy Fix Guide: `test_update_delete.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_update_delete.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/suite/test_update_delete.py --strict
```

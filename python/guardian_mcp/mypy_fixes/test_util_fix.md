...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_util.py`
**Lines:** `355`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_util.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/joblib/test/test_utils.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/joblib/test/test_utils.py --strict
```

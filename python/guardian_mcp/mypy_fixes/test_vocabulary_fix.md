# 🧠 Mypy Fix Guide: `test_vocabulary.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_vocabulary.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/lm/test_vocabulary.py --strict
```

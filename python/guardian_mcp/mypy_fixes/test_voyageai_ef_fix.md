# 🧠 Mypy Fix Guide: `test_voyageai_ef.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/ef/test_voyageai_ef.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/ef/test_voyageai_ef.py --strict
```

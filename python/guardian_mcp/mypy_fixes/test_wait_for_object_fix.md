# 🧠 Mypy Fix Guide: `test_wait_for_object.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_wait_for_object.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_wait_for_object.py --strict
```

# 🧠 Mypy Fix Guide: `test_windows.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/test_windows.py`
**Lines:** `299`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/test_windows.py --strict
```

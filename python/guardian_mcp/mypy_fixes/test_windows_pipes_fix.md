# 🧠 Mypy Fix Guide: `test_windows_pipes.py`
...
**File:** `.venv/lib/python3.13/site-packages/trio/_tests/test_windows_pipes.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_tests/test_windows_pipes.py --strict
```

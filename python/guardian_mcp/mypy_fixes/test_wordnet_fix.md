# 🧠 Mypy Fix Guide: `test_wordnet.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/test/unit/test_wordnet.py`
**Lines:** `246`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/test/unit/test_wordnet.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testapi.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testapi.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testargs.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testargs.py --strict
```

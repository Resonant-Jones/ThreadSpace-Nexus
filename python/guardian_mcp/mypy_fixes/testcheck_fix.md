...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testcheck.py`
**Lines:** `322`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testcheck.py --strict
```

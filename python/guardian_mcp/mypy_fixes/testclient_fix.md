...
**File:** `.venv/lib/python3.13/site-packages/fastapi/testclient.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/testclient.py --strict
```

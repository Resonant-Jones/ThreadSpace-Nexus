...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testcmdline.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testcmdline.py --strict
```

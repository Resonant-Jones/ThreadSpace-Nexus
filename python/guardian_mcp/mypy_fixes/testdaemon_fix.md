...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testdaemon.py`
**Lines:** `132`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testdaemon.py --strict
```

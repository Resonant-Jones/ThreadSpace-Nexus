...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testdeps.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testdeps.py --strict
```

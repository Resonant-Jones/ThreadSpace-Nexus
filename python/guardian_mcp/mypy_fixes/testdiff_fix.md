...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testdiff.py`
**Lines:** `70`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testdiff.py --strict
```

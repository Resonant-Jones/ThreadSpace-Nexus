# 🧠 Mypy Fix Guide: `testformatter.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testformatter.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testformatter.py --strict
```

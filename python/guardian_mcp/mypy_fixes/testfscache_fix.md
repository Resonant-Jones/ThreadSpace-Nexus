...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testfscache.py`
**Lines:** `101`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testfscache.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testgraph.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testgraph.py --strict
```

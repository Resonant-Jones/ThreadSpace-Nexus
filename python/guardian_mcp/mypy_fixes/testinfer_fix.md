...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testinfer.py`
**Lines:** `373`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testinfer.py --strict
```

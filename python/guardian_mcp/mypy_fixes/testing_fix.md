...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/testing.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/testing.py --strict
```

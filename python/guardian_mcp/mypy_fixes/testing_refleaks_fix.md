# 🧠 Mypy Fix Guide: `testing_refleaks.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/testing_refleaks.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/testing_refleaks.py --strict
```

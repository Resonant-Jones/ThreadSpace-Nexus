...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testipc.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testipc.py --strict
```

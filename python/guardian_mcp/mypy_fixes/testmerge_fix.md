...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testmerge.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testmerge.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testmypyc.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testmypyc.py --strict
```

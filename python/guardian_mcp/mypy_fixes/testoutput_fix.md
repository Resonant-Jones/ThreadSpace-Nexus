...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testoutput.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testoutput.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testparse.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testparse.py --strict
```

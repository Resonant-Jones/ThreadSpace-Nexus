...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testpep561.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testpep561.py --strict
```

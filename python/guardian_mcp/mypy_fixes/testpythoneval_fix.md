# 🧠 Mypy Fix Guide: `testpythoneval.py`
...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testpythoneval.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testpythoneval.py --strict
```

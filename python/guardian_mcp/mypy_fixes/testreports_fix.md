...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testreports.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testreports.py --strict
```

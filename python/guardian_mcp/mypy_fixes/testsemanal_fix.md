...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testsemanal.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testsemanal.py --strict
```

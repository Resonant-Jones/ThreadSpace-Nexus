...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testsolve.py`
**Lines:** `285`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testsolve.py --strict
```

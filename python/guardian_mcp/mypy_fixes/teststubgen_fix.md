...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/teststubgen.py`
**Lines:** `1648`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/teststubgen.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testtypegen.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testtypegen.py --strict
```

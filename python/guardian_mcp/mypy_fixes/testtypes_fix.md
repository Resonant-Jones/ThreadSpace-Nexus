...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/testtypes.py`
**Lines:** `1595`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/testtypes.py --strict
```

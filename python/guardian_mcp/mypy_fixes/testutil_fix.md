...
**File:** `.venv/lib/python3.13/site-packages/mypyc/test/testutil.py`
**Lines:** `284`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/test/testutil.py --strict
```

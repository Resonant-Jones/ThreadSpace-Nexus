...
**File:** `.venv/lib/python3.13/site-packages/numpy/ma/testutils.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/ma/testutils.py --strict
```

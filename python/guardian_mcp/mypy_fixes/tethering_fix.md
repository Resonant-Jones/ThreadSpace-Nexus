...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/tethering.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/tethering.py --strict
```

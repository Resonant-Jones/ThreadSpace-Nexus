# 🧠 Mypy Fix Guide: `text2text_generation.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text2text_generation.py`
**Lines:** `42`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text2text_generation.py --strict
```

# 🧠 Mypy Fix Guide: `text2vec_embedding_function.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/text2vec_embedding_function.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/utils/embedding_functions/text2vec_embedding_function.py --strict
```

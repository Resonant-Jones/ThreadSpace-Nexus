# 🧠 Mypy Fix Guide: `text_classification.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text_classification.py`
**Lines:** `41`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text_classification.py --strict
```

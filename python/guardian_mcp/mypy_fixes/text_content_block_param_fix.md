# 🧠 Mypy Fix Guide: `text_content_block_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/text_content_block_param.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/text_content_block_param.py --strict
```

# 🧠 Mypy Fix Guide: `text_delta_block.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/text_delta_block.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/text_delta_block.py --strict
```

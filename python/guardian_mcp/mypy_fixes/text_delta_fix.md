...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/text_delta.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/text_delta.py --strict
```

# 🧠 Mypy Fix Guide: `text_encoding.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/text_encoding.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/text_encoding.py --strict
```

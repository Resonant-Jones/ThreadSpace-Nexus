...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/text_file.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/text_file.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/backends/textbackend/text.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/backends/textbackend/text.py --strict
```

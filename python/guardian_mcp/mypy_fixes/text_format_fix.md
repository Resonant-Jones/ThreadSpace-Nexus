...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/text_format.py`
**Lines:** `1864`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/text_format.py --strict
```

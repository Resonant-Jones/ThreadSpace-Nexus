# 🧠 Mypy Fix Guide: `text_generation.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text_generation.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text_generation.py --strict
```

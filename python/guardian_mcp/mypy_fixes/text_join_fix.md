...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/rules_core/text_join.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/rules_core/text_join.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/text_model.py`
**Lines:** `72`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/text_model.py --strict
```

# 🧠 Mypy Fix Guide: `text_service.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/text_service.py`
**Lines:** `441`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/ai/generativelanguage_v1beta/types/text_service.py --strict
```

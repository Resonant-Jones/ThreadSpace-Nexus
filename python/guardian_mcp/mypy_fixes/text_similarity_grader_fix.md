# 🧠 Mypy Fix Guide: `text_similarity_grader.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/text_similarity_grader.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/text_similarity_grader.py --strict
```

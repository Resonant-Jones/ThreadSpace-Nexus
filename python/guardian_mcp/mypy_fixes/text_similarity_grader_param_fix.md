# 🧠 Mypy Fix Guide: `text_similarity_grader_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/graders/text_similarity_grader_param.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/graders/text_similarity_grader_param.py --strict
```

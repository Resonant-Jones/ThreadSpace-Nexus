# 🧠 Mypy Fix Guide: `text_to_speech_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/text_to_speech/text_to_speech_handler.py`
**Lines:** `243`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/text_to_speech/text_to_speech_handler.py --strict
```

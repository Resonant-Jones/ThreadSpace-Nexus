# 🧠 Mypy Fix Guide: `text_to_video.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text_to_video.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_generated/types/text_to_video.py --strict
```

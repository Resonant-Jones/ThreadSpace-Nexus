...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/types/text_types.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/types/text_types.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/classify/textcat.py`
**Lines:** `193`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/classify/textcat.py --strict
```

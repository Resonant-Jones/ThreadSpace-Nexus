...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/textedit.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/textedit.py --strict
```

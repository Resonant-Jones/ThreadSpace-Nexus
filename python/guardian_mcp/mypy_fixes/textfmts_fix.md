...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/textfmts.py`
**Lines:** `436`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/textfmts.py --strict
```

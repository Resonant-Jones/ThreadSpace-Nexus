...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/propagators/textmap.py`
**Lines:** `197`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/propagators/textmap.py --strict
```

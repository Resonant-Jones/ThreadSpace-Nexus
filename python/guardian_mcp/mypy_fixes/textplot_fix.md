...
**File:** `.venv/lib/python3.13/site-packages/sympy/plotting/textplot.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/plotting/textplot.py --strict
```

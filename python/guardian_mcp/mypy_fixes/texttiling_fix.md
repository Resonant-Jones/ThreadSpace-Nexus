...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/texttiling.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/texttiling.py --strict
```

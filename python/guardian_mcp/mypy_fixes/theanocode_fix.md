...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/theanocode.py`
**Lines:** `571`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/theanocode.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/theme.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/theme.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/themes.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/themes.py --strict
```

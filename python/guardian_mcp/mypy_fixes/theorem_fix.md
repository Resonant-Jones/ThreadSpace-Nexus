...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/theorem.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/theorem.py --strict
```

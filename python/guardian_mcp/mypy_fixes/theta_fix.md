...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/theta.py`
**Lines:** `1049`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/theta.py --strict
```

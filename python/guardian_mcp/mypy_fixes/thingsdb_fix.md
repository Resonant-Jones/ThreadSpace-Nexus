...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/thingsdb.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/thingsdb.py --strict
```

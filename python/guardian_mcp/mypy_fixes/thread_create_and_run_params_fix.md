# 🧠 Mypy Fix Guide: `thread_create_and_run_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/thread_create_and_run_params.py`
**Lines:** `396`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/thread_create_and_run_params.py --strict
```

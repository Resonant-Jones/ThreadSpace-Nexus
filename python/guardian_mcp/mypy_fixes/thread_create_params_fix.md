# 🧠 Mypy Fix Guide: `thread_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/thread_create_params.py`
**Lines:** `185`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/thread_create_params.py --strict
```

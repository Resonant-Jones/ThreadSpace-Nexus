...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/thread.py`
**Lines:** `63`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/thread.py --strict
```

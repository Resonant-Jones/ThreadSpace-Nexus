# 🧠 Mypy Fix Guide: `thread_pool_executor.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/thread_pool_executor.py`
**Lines:** `5`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/thread_pool_executor.py --strict
```

# 🧠 Mypy Fix Guide: `thread_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/thread_update_params.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/thread_update_params.py --strict
```

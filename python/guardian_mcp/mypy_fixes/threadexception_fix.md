# 🧠 Mypy Fix Guide: `threadexception.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/threadexception.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/threadexception.py --strict
```

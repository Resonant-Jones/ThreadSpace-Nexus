...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/beta/threads/threads.py`
**Lines:** `1935`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/beta/threads/threads.py --strict
```

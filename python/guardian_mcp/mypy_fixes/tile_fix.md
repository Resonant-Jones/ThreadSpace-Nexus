...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/reshape/tile.py`
**Lines:** `638`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/reshape/tile.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/indexes/timedeltas.py`
**Lines:** `356`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/indexes/timedeltas.py --strict
```

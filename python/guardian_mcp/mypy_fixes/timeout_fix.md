...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/timeout.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/timeout.py --strict
```

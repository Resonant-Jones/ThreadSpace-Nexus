...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/timeouts.py`
**Lines:** `142`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/timeouts.py --strict
```

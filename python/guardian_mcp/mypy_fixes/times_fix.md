...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/tools/times.py`
**Lines:** `168`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/tools/times.py --strict
```

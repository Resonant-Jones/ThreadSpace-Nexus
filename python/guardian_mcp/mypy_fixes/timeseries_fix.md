...
**File:** `.venv/lib/python3.13/site-packages/pandas/plotting/_matplotlib/timeseries.py`
**Lines:** `370`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/plotting/_matplotlib/timeseries.py --strict
```

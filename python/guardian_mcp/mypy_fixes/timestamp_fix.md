...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/timestamp.py`
**Lines:** `112`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/timestamp.py --strict
```

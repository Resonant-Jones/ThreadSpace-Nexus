...
**File:** `.venv/lib/python3.13/site-packages/sympy/utilities/timeutils.py`
**Lines:** `75`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/utilities/timeutils.py --strict
```

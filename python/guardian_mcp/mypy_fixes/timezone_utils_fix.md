# 🧠 Mypy Fix Guide: `timezone_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/timezone_utils.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/timezone_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/timit.py`
**Lines:** `510`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/timit.py --strict
```

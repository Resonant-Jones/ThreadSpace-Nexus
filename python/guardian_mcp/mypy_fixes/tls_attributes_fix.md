# 🧠 Mypy Fix Guide: `tls_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/tls_attributes.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/tls_attributes.py --strict
```

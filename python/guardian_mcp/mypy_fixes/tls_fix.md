...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/tls.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/tls.py --strict
```

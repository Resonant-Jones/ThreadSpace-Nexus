...
**File:** `.venv/lib/python3.13/site-packages/sympy/testing/tmpfiles.py`
**Lines:** `46`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/testing/tmpfiles.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/tnt.py`
**Lines:** `270`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/tnt.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/to-qwerty.py`
**Lines:** `6`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/jaraco/text/to-qwerty.py --strict
```

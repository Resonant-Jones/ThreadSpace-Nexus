...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/methods/to_dict.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/methods/to_dict.py --strict
```

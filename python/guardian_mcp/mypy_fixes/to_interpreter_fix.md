# 🧠 Mypy Fix Guide: `to_interpreter.py`
...
**File:** `.venv/lib/python3.13/site-packages/anyio/to_interpreter.py`
**Lines:** `218`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/to_interpreter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/anyio/to_process.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/anyio/to_process.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mistune/directives/toc.py`
**Lines:** `215`
...
```bash
mypy .venv/lib/python3.13/site-packages/mistune/directives/toc.py --strict
```

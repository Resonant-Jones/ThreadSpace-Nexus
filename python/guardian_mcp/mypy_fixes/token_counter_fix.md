# 🧠 Mypy Fix Guide: `token_counter.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/token_counter.py`
**Lines:** `673`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/token_counter.py --strict
```

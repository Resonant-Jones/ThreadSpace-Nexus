...
**File:** `.venv/lib/python3.13/site-packages/blib2to3/pgen2/tokenize.py`
**Lines:** `1114`
...
```bash
mypy .venv/lib/python3.13/site-packages/blib2to3/pgen2/tokenize.py --strict
```

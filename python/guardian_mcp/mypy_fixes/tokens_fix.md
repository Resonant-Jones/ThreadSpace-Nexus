...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/tokens.py`
**Lines:** `356`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/tokens.py --strict
```

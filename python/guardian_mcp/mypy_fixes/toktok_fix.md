...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/toktok.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/toktok.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/toml.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/toml.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/build/_compat/tomllib.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/build/_compat/tomllib.py --strict
```

# 🧠 Mypy Fix Guide: `tool_call_cost_tracking.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_cost_calc/tool_call_cost_tracking.py`
**Lines:** `326`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/litellm_core_utils/llm_cost_calc/tool_call_cost_tracking.py --strict
```

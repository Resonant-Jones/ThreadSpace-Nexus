# 🧠 Mypy Fix Guide: `tool_call_delta.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/tool_call_delta.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/tool_call_delta.py --strict
```

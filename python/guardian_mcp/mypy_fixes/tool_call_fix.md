...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/tool_call.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/tool_call.py --strict
```

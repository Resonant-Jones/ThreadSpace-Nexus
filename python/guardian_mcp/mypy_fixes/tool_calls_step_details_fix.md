# 🧠 Mypy Fix Guide: `tool_calls_step_details.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/tool_calls_step_details.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/beta/threads/runs/tool_calls_step_details.py --strict
```

# 🧠 Mypy Fix Guide: `tool_choice_function_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_function_param.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_function_param.py --strict
```

# 🧠 Mypy Fix Guide: `tool_choice_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_options.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_options.py --strict
```

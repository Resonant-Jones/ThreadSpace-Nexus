# 🧠 Mypy Fix Guide: `tool_choice_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_types.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_types.py --strict
```

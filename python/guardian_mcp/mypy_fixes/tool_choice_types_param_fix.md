# 🧠 Mypy Fix Guide: `tool_choice_types_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_types_param.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/tool_choice_types_param.py --strict
```

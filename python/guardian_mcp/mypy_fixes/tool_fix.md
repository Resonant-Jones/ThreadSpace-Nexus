...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/tool.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/tool.py --strict
```

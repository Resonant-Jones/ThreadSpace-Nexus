...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/tool_param.py`
**Lines:** `182`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/tool_param.py --strict
```

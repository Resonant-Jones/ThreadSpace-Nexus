# 🧠 Mypy Fix Guide: `tool_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/mcp_server/tool_registry.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/mcp_server/tool_registry.py --strict
```

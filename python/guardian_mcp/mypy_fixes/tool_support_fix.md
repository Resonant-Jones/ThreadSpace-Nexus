# 🧠 Mypy Fix Guide: `tool_support.py`
...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/tool_support.py`
**Lines:** `201`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/tool_support.py --strict
```

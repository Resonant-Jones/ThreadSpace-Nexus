...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/toolbox.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/toolbox.py --strict
```

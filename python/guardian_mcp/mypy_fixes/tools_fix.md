...
**File:** `.venv/lib/python3.13/site-packages/sympy/strategies/branch/tools.py`
**Lines:** `12`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/strategies/branch/tools.py --strict
```

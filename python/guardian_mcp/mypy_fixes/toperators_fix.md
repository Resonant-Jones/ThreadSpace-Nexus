...
**File:** `.venv/lib/python3.13/site-packages/sympy/tensor/toperators.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/tensor/toperators.py --strict
```

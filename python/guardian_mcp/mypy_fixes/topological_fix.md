...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/topological.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/topological.py --strict
```

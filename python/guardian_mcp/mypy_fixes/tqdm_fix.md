...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/utils/tqdm.py`
**Lines:** `307`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/utils/tqdm.py --strict
```

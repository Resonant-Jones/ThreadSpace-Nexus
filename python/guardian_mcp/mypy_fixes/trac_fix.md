...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/trac.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/trac.py --strict
```

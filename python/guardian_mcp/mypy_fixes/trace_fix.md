...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/trace.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/trace.py --strict
```

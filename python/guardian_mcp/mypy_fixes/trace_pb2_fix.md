...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/trace/v1/trace_pb2.py`
**Lines:** `58`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/trace/v1/trace_pb2.py --strict
```

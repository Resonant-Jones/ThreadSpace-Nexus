# 🧠 Mypy Fix Guide: `trace_service_pb2.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/collector/trace/v1/trace_service_pb2.py`
**Lines:** `45`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/collector/trace/v1/trace_service_pb2.py --strict
```

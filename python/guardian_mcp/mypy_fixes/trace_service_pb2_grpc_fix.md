# 🧠 Mypy Fix Guide: `trace_service_pb2_grpc.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/proto/collector/trace/v1/trace_service_pb2_grpc.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/proto/collector/trace/v1/trace_service_pb2_grpc.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/rich/traceback.py`
**Lines:** `884`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/rich/traceback.py --strict
```

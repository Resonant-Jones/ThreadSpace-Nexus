# 🧠 Mypy Fix Guide: `tracecontext.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/trace/propagation/tracecontext.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/trace/propagation/tracecontext.py --strict
```

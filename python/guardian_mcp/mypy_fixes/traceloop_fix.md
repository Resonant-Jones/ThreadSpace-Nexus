...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/traceloop.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/traceloop.py --strict
```

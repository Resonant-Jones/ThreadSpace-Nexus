...
**File:** `.venv/lib/python3.13/site-packages/_pytest/tracemalloc.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/tracemalloc.py --strict
```

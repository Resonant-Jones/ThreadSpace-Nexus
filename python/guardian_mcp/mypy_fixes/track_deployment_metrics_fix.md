# 🧠 Mypy Fix Guide: `track_deployment_metrics.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/router_utils/router_callbacks/track_deployment_metrics.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/router_utils/router_callbacks/track_deployment_metrics.py --strict
```

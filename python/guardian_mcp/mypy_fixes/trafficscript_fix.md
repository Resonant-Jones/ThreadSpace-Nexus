# 🧠 Mypy Fix Guide: `trafficscript.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/trafficscript.py`
**Lines:** `51`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/trafficscript.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/transaction.py`
**Lines:** `90`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/transaction.py --strict
```

# 🧠 Mypy Fix Guide: `transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/responses/litellm_completion_transformation/transformation.py`
**Lines:** `721`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/responses/litellm_completion_transformation/transformation.py --strict
```

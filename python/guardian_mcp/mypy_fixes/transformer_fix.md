...
**File:** `.venv/lib/python3.13/site-packages/sympy/parsing/latex/lark/transformer.py`
**Lines:** `730`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/parsing/latex/lark/transformer.py --strict
```

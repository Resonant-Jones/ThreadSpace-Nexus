...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/quantum/transforms.py`
**Lines:** `291`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/quantum/transforms.py --strict
```

# 🧠 Mypy Fix Guide: `transitionparser.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/transitionparser.py`
**Lines:** `793`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/transitionparser.py --strict
```

# 🧠 Mypy Fix Guide: `translation_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio/translation_create_params.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio/translation_create_params.py --strict
```

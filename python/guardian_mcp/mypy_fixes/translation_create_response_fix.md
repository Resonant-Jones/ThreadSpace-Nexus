# 🧠 Mypy Fix Guide: `translation_create_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio/translation_create_response.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio/translation_create_response.py --strict
```

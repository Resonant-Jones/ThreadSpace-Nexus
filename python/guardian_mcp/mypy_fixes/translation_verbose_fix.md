# 🧠 Mypy Fix Guide: `translation_verbose.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/audio/translation_verbose.py`
**Lines:** `22`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/audio/translation_verbose.py --strict
```

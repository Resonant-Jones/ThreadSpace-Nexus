# 🧠 Mypy Fix Guide: `translations.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/audio/translations.py`
**Lines:** `367`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/audio/translations.py --strict
```

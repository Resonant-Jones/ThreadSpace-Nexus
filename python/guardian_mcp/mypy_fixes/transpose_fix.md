...
**File:** `.venv/lib/python3.13/site-packages/sympy/matrices/expressions/transpose.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/matrices/expressions/transpose.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/interactive/traversal.py`
**Lines:** `95`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/interactive/traversal.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/traversals.py`
**Lines:** `1024`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/traversals.py --strict
```

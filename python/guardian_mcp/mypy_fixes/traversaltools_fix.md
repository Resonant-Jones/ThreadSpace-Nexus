# 🧠 Mypy Fix Guide: `traversaltools.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/traversaltools.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/traversaltools.py --strict
```

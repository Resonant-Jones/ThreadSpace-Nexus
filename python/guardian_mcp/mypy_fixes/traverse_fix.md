...
**File:** `.venv/lib/python3.13/site-packages/sympy/strategies/branch/traverse.py`
**Lines:** `25`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/strategies/branch/traverse.py --strict
```

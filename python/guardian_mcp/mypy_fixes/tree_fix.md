...
**File:** `.venv/lib/python3.13/site-packages/sympy/printing/tree.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/printing/tree.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/tokenize/treebank.py`
**Lines:** `402`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/tokenize/treebank.py --strict
```

# 🧠 Mypy Fix Guide: `treeprettyprinter.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/treeprettyprinter.py`
**Lines:** `28`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/treeprettyprinter.py --strict
```

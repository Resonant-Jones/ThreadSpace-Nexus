...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/trigger.py`
**Lines:** `26`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/trigger.py --strict
```

# 🧠 Mypy Fix Guide: `trigonometric.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/elementary/trigonometric.py`
**Lines:** `3627`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/elementary/trigonometric.py --strict
```

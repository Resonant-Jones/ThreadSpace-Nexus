# 🧠 Mypy Fix Guide: `trigonometry.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/integrals/trigonometry.py`
**Lines:** `335`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/integrals/trigonometry.py --strict
```

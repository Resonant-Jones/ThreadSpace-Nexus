...
**File:** `.venv/lib/python3.13/site-packages/sympy/simplify/trigsimp.py`
**Lines:** `1252`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/simplify/trigsimp.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/httpcore/_backends/trio.py`
**Lines:** `159`
...
```bash
mypy .venv/lib/python3.13/site-packages/httpcore/_backends/trio.py --strict
```

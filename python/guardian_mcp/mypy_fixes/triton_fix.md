...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/triton.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/triton.py --strict
```

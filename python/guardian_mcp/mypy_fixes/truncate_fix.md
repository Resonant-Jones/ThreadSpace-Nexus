...
**File:** `.venv/lib/python3.13/site-packages/_pytest/assertion/truncate.py`
**Lines:** `137`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/assertion/truncate.py --strict
```

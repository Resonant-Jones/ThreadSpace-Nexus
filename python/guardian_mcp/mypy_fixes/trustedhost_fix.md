...
**File:** `.venv/lib/python3.13/site-packages/starlette/middleware/trustedhost.py`
**Lines:** `60`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/middleware/trustedhost.py --strict
```

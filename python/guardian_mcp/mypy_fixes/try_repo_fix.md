...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/try_repo.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/try_repo.py --strict
```

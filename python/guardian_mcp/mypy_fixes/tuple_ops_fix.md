...
**File:** `.venv/lib/python3.13/site-packages/mypyc/primitives/tuple_ops.py`
**Lines:** `110`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/primitives/tuple_ops.py --strict
```

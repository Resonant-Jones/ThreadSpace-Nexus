# 🧠 Mypy Fix Guide: `turkish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/turkish_stemmer.py`
**Lines:** `1803`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/turkish_stemmer.py --strict
```

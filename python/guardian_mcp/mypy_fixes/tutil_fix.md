...
**File:** `.venv/lib/python3.13/site-packages/trio/_core/_tests/tutil.py`
**Lines:** `117`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_core/_tests/tutil.py --strict
```

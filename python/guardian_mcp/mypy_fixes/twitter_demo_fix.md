# 🧠 Mypy Fix Guide: `twitter_demo.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/twitter/twitter_demo.py`
**Lines:** `306`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/twitter/twitter_demo.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/twitter.py`
**Lines:** `136`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/twitter.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_a.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_a.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/type_api.py`
**Lines:** `2362`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/type_api.py --strict
```

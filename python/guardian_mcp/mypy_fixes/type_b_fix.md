...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_b.py`
**Lines:** `170`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_b.py --strict
```

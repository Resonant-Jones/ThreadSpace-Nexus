...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_c.py`
**Lines:** `169`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_c.py --strict
```

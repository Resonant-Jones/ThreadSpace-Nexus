# 🧠 Mypy Fix Guide: `type_checkers.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/type_checkers.py`
**Lines:** `408`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/type_checkers.py --strict
```

# 🧠 Mypy Fix Guide: `type_conversion.py`
...
**File:** `.venv/lib/python3.13/site-packages/pypika/clickhouse/type_conversion.py`
**Lines:** `88`
...
```bash
mypy .venv/lib/python3.13/site-packages/pypika/clickhouse/type_conversion.py --strict
```

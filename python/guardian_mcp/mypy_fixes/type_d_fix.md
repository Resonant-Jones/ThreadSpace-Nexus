...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_d.py`
**Lines:** `173`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_d.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_e.py`
**Lines:** `275`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_e.py --strict
```

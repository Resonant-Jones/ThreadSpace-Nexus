...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_f.py`
**Lines:** `162`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_f.py --strict
```

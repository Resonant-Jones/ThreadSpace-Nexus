...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/type_g.py`
**Lines:** `111`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/type_g.py --strict
```

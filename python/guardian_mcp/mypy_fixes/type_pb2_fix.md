...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/type_pb2.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/type_pb2.py --strict
```

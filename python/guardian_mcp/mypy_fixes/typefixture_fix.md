...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/typefixture.py`
**Lines:** `417`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/typefixture.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/types.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/inference/_mcp/types.py --strict
```

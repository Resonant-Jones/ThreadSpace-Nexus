...
**File:** `.venv/lib/python3.13/site-packages/mypy/types_utils.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/types_utils.py --strict
```

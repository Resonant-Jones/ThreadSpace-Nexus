# 🧠 Mypy Fix Guide: `typing_extensions.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/typing_extensions.py`
**Lines:** `4584`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/typing_extensions.py --strict
```

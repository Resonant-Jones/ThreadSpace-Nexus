...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/util/typing.py`
**Lines:** `733`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/util/typing.py --strict
```

# 🧠 Mypy Fix Guide: `typing_utils.py`
...
**File:** `.venv/lib/python3.13/site-packages/overrides/typing_utils.py`
**Lines:** `471`
...
```bash
mypy .venv/lib/python3.13/site-packages/overrides/typing_utils.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/typoscript.py`
**Lines:** `216`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/typoscript.py --strict
```

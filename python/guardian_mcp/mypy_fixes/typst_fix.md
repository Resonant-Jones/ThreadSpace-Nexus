...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/typst.py`
**Lines:** `160`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/typst.py --strict
```

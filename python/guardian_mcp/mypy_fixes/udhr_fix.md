...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/udhr.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/udhr.py --strict
```

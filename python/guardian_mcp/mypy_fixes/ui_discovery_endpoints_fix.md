# 🧠 Mypy Fix Guide: `ui_discovery_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/discovery_endpoints/ui_discovery_endpoints.py`
**Lines:** `8`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/discovery_endpoints/ui_discovery_endpoints.py --strict
```

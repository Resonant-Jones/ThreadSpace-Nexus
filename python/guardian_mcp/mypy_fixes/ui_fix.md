...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/ui.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/ui.py --strict
```

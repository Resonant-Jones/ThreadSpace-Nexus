...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/common_utils/html_forms/ui_login.py`
**Lines:** `220`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/common_utils/html_forms/ui_login.py --strict
```

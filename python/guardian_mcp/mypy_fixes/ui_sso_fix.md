...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/ui_sso.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/proxy/management_endpoints/ui_sso.py --strict
```

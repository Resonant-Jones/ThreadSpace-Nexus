...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/ul4.py`
**Lines:** `309`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/ul4.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyparsing/unicode.py`
**Lines:** `356`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyparsing/unicode.py --strict
```

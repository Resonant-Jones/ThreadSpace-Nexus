...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/unicon.py`
**Lines:** `413`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/unicon.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/transform/uninit.py`
**Lines:** `195`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/transform/uninit.py --strict
```

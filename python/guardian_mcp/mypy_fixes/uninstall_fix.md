...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/commands/uninstall.py`
**Lines:** `114`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/commands/uninstall.py --strict
```

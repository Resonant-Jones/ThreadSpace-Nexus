...
**File:** `.venv/lib/python3.13/site-packages/sympy/sets/handlers/union.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/sets/handlers/union.py --strict
```

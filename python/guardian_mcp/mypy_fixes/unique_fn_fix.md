...
**File:** `.venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/unique_fn.py`
**Lines:** `47`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/generativeai/notebook/lib/unique_fn.py --strict
```

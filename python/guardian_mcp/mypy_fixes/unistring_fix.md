...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/pygments/unistring.py`
**Lines:** `153`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/pygments/unistring.py --strict
```

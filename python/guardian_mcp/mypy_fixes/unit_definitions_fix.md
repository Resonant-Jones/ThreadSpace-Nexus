# 🧠 Mypy Fix Guide: `unit_definitions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/definitions/unit_definitions.py`
**Lines:** `407`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/definitions/unit_definitions.py --strict
```

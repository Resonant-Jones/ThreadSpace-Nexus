...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/unitofwork.py`
**Lines:** `796`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/unitofwork.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/units/unitsystem.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/units/unitsystem.py --strict
```

# 🧠 Mypy Fix Guide: `universaldetector.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/universaldetector.py`
**Lines:** `362`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/universaldetector.py --strict
```

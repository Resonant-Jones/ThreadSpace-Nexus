...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/universe.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/universe.py --strict
```

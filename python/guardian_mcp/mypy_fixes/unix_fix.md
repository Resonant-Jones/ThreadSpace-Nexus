...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/platformdirs/unix.py`
**Lines:** `272`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/platformdirs/unix.py --strict
```

# 🧠 Mypy Fix Guide: `unknown_fields.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/unknown_fields.py`
**Lines:** `97`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/unknown_fields.py --strict
```

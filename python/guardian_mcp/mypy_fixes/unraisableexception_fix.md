# 🧠 Mypy Fix Guide: `unraisableexception.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/unraisableexception.py`
**Lines:** `158`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/unraisableexception.py --strict
```

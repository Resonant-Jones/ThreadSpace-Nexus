# 🧠 Mypy Fix Guide: `unused_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/unused_registry.py`
**Lines:** `35`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/unused_registry.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypy/test/update_data.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/test/update_data.py --strict
```

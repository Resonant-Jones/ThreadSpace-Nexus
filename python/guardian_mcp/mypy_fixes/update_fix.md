...
**File:** `.venv/lib/python3.13/site-packages/mypy/server/update.py`
**Lines:** `1339`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypy/server/update.py --strict
```

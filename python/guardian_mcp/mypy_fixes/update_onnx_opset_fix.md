# 🧠 Mypy Fix Guide: `update_onnx_opset.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/update_onnx_opset.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/update_onnx_opset.py --strict
```

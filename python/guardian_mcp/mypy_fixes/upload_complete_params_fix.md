# 🧠 Mypy Fix Guide: `upload_complete_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/upload_complete_params.py`
**Lines:** `19`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/upload_complete_params.py --strict
```

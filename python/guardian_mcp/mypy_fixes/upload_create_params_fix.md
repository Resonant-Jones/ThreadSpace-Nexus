# 🧠 Mypy Fix Guide: `upload_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/upload_create_params.py`
**Lines:** `31`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/upload_create_params.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/upload.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/upload.py --strict
```

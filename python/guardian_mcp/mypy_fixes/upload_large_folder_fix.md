# 🧠 Mypy Fix Guide: `upload_large_folder.py`
...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/upload_large_folder.py`
**Lines:** `129`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/upload_large_folder.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/openai/types/uploads/upload_part.py`
**Lines:** `21`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/uploads/upload_part.py --strict
```

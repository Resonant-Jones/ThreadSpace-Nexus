...
**File:** `.venv/lib/python3.13/site-packages/openai/resources/uploads/uploads.py`
**Lines:** `711`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/resources/uploads/uploads.py --strict
```

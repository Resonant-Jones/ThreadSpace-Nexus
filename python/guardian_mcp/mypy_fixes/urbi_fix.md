...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/urbi.py`
**Lines:** `145`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/urbi.py --strict
```

# 🧠 Mypy Fix Guide: `uri_validate.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/uri_validate.py`
**Lines:** `190`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/uri_validate.py --strict
```

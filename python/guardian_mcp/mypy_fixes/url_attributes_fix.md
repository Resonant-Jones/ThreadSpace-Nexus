# 🧠 Mypy Fix Guide: `url_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/url_attributes.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/url_attributes.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/google/auth/transport/urllib3.py`
**Lines:** `454`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/auth/transport/urllib3.py --strict
```

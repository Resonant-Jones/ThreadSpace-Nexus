...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/urls.py`
**Lines:** `55`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/urls.py --strict
```

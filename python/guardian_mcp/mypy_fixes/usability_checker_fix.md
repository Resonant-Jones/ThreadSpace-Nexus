# 🧠 Mypy Fix Guide: `usability_checker.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/tools/mobile_helpers/usability_checker.py`
**Lines:** `738`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/tools/mobile_helpers/usability_checker.py --strict
```

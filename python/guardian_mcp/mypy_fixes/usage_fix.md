...
**File:** `.venv/lib/python3.13/site-packages/humanfriendly/usage.py`
**Lines:** `351`
...
```bash
mypy .venv/lib/python3.13/site-packages/humanfriendly/usage.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/usd.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/usd.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/f2py/use_rules.py`
**Lines:** `99`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/f2py/use_rules.py --strict
```

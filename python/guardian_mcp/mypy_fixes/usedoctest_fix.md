...
**File:** `.venv/lib/python3.13/site-packages/lxml/html/usedoctest.py`
**Lines:** `13`
...
```bash
mypy .venv/lib/python3.13/site-packages/lxml/html/usedoctest.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pyasn1/type/useful.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/pyasn1/type/useful.py --strict
```

# 🧠 Mypy Fix Guide: `useless_applicator_schemas.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/useless_applicator_schemas.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/useless_applicator_schemas.py --strict
```

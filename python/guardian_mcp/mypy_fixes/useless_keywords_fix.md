# 🧠 Mypy Fix Guide: `useless_keywords.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/useless_keywords.py`
**Lines:** `32`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/useless_keywords.py --strict
```

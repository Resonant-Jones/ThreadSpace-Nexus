# 🧠 Mypy Fix Guide: `user_agent_generator.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/user_agent_generator.py`
**Lines:** `428`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/user_agent_generator.py --strict
```

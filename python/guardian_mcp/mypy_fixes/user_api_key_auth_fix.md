# 🧠 Mypy Fix Guide: `user_api_key_auth.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/auth/user_api_key_auth.py`
**Lines:** `1262`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/auth/user_api_key_auth.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/numpy/lib/user_array.py`
**Lines:** `1`
...
```bash
mypy .venv/lib/python3.13/site-packages/numpy/lib/user_array.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/user.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/user.py --strict
```

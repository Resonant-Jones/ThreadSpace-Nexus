# 🧠 Mypy Fix Guide: `user_invitation_email.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/email_templates/user_invitation_email.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/email_templates/user_invitation_email.py --strict
```

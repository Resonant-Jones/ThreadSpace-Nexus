# 🧠 Mypy Fix Guide: `user_management_event_hooks.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/hooks/user_management_event_hooks.py`
**Lines:** `209`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/hooks/user_management_event_hooks.py --strict
```

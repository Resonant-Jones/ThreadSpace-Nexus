...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/openid/connect/core/endpoints/userinfo.py`
**Lines:** `106`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/openid/connect/core/endpoints/userinfo.py --strict
```

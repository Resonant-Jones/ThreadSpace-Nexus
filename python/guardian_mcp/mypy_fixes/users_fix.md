...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/client/cli/commands/users.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/client/cli/commands/users.py --strict
```

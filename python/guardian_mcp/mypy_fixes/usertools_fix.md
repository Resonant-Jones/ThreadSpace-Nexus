...
**File:** `.venv/lib/python3.13/site-packages/mpmath/usertools.py`
**Lines:** `93`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/usertools.py --strict
```

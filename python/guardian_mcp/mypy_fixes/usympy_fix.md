...
**File:** `.venv/lib/python3.13/site-packages/sympy/unify/usympy.py`
**Lines:** `124`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/unify/usympy.py --strict
```

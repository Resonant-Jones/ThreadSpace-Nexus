# 🧠 Mypy Fix Guide: `utf1632prober.py`
...
**File:** `.venv/lib/python3.13/site-packages/chardet/utf1632prober.py`
**Lines:** `225`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/utf1632prober.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/chardet/utf8prober.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/chardet/utf8prober.py --strict
```

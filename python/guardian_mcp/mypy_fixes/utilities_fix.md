...
**File:** `.venv/lib/python3.13/site-packages/sympy/polys/numberfields/utilities.py`
**Lines:** `474`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/polys/numberfields/utilities.py --strict
```

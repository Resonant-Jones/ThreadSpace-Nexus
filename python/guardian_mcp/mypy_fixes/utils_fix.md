...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/utils.py`
**Lines:** `27`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/utils.py --strict
```

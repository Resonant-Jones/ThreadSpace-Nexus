# 🧠 Mypy Fix Guide: `utils_worker.py`
...
**File:** `.venv/lib/python3.13/site-packages/tqdm/contrib/utils_worker.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/tqdm/contrib/utils_worker.py --strict
```

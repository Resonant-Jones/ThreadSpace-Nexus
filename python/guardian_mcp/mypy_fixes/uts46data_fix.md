...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/idna/uts46data.py`
**Lines:** `8681`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/idna/uts46data.py --strict
```

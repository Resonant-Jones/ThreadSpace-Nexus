...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/loops/uvloop.py`
**Lines:** `7`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/loops/uvloop.py --strict
```

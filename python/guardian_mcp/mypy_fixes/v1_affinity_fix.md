...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_affinity.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_affinity.py --strict
```

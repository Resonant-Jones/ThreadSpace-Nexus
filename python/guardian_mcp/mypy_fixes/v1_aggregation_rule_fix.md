# 🧠 Mypy Fix Guide: `v1_aggregation_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_aggregation_rule.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_aggregation_rule.py --strict
```

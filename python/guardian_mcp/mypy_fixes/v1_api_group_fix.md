# 🧠 Mypy Fix Guide: `v1_api_group.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_group.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_group.py --strict
```

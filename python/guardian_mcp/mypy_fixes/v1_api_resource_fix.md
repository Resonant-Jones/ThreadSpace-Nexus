# 🧠 Mypy Fix Guide: `v1_api_resource.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_resource.py`
**Lines:** `379`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_resource.py --strict
```

# 🧠 Mypy Fix Guide: `v1_api_resource_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_resource_list.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_resource_list.py --strict
```

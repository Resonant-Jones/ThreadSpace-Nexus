# 🧠 Mypy Fix Guide: `v1_api_service_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_service_spec.py`
**Lines:** `293`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_service_spec.py --strict
```

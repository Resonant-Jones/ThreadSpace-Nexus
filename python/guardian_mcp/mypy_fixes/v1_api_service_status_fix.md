# 🧠 Mypy Fix Guide: `v1_api_service_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_service_status.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_api_service_status.py --strict
```

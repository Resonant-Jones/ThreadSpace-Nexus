# 🧠 Mypy Fix Guide: `v1_app_armor_profile.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_app_armor_profile.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_app_armor_profile.py --strict
```

# 🧠 Mypy Fix Guide: `v1_attached_volume.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_attached_volume.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_attached_volume.py --strict
```

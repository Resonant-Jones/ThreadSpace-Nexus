# 🧠 Mypy Fix Guide: `v1_audit_annotation.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_audit_annotation.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_audit_annotation.py --strict
```

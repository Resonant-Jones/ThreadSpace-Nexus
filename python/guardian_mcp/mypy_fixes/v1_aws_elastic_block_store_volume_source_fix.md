# 🧠 Mypy Fix Guide: `v1_aws_elastic_block_store_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_aws_elastic_block_store_volume_source.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_aws_elastic_block_store_volume_source.py --strict
```

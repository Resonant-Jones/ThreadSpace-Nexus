# 🧠 Mypy Fix Guide: `v1_azure_file_persistent_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_azure_file_persistent_volume_source.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_azure_file_persistent_volume_source.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_binding.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_binding.py --strict
```

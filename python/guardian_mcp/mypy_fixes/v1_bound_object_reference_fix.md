# 🧠 Mypy Fix Guide: `v1_bound_object_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_bound_object_reference.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_bound_object_reference.py --strict
```

# 🧠 Mypy Fix Guide: `v1_ceph_fs_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ceph_fs_volume_source.py`
**Lines:** `261`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ceph_fs_volume_source.py --strict
```

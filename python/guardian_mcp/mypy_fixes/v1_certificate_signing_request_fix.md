# 🧠 Mypy Fix Guide: `v1_certificate_signing_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_certificate_signing_request.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_certificate_signing_request.py --strict
```

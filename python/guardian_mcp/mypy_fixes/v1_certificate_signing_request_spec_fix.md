# 🧠 Mypy Fix Guide: `v1_certificate_signing_request_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_certificate_signing_request_spec.py`
**Lines:** `323`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_certificate_signing_request_spec.py --strict
```

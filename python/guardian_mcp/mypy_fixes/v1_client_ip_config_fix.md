# 🧠 Mypy Fix Guide: `v1_client_ip_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_client_ip_config.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_client_ip_config.py --strict
```

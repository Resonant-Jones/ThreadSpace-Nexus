# 🧠 Mypy Fix Guide: `v1_cluster_role_binding.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cluster_role_binding.py`
**Lines:** `231`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cluster_role_binding.py --strict
```

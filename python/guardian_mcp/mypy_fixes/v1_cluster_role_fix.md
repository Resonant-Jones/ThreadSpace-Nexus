# 🧠 Mypy Fix Guide: `v1_cluster_role.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cluster_role.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cluster_role.py --strict
```

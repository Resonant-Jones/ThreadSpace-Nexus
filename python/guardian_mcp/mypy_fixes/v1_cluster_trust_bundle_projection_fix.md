# 🧠 Mypy Fix Guide: `v1_cluster_trust_bundle_projection.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cluster_trust_bundle_projection.py`
**Lines:** `233`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cluster_trust_bundle_projection.py --strict
```

# 🧠 Mypy Fix Guide: `v1_config_map_node_config_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_config_map_node_config_source.py`
**Lines:** `237`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_config_map_node_config_source.py --strict
```

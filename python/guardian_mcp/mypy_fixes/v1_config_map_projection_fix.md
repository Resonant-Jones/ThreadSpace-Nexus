# 🧠 Mypy Fix Guide: `v1_config_map_projection.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_config_map_projection.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_config_map_projection.py --strict
```

# 🧠 Mypy Fix Guide: `v1_container_port.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_port.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_port.py --strict
```

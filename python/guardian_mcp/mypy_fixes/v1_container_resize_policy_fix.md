# 🧠 Mypy Fix Guide: `v1_container_resize_policy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_resize_policy.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_resize_policy.py --strict
```

# 🧠 Mypy Fix Guide: `v1_container_state.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state.py --strict
```

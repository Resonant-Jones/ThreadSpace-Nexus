# 🧠 Mypy Fix Guide: `v1_container_state_running.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state_running.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state_running.py --strict
```

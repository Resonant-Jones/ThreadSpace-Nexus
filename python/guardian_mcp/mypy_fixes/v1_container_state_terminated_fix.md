# 🧠 Mypy Fix Guide: `v1_container_state_terminated.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state_terminated.py`
**Lines:** `291`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state_terminated.py --strict
```

# 🧠 Mypy Fix Guide: `v1_container_state_waiting.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state_waiting.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_state_waiting.py --strict
```

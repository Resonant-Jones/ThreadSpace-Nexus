# 🧠 Mypy Fix Guide: `v1_container_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_status.py`
**Lines:** `511`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_container_status.py --strict
```

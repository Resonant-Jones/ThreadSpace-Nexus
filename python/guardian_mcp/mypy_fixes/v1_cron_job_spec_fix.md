# 🧠 Mypy Fix Guide: `v1_cron_job_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cron_job_spec.py`
**Lines:** `318`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cron_job_spec.py --strict
```

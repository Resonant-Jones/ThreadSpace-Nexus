# 🧠 Mypy Fix Guide: `v1_cron_job_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cron_job_status.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cron_job_status.py --strict
```

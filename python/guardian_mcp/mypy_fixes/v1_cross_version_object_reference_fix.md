# 🧠 Mypy Fix Guide: `v1_cross_version_object_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cross_version_object_reference.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_cross_version_object_reference.py --strict
```

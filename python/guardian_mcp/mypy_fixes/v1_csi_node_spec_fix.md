# 🧠 Mypy Fix Guide: `v1_csi_node_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_csi_node_spec.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_csi_node_spec.py --strict
```

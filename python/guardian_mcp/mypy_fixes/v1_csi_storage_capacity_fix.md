# 🧠 Mypy Fix Guide: `v1_csi_storage_capacity.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_csi_storage_capacity.py`
**Lines:** `287`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_csi_storage_capacity.py --strict
```

# 🧠 Mypy Fix Guide: `v1_csi_storage_capacity_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_csi_storage_capacity_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_csi_storage_capacity_list.py --strict
```

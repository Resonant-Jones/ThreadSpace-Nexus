# 🧠 Mypy Fix Guide: `v1_custom_resource_column_definition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_column_definition.py`
**Lines:** `265`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_column_definition.py --strict
```

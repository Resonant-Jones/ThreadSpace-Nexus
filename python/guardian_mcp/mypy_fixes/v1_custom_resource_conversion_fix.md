# 🧠 Mypy Fix Guide: `v1_custom_resource_conversion.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_conversion.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_conversion.py --strict
```

# 🧠 Mypy Fix Guide: `v1_custom_resource_definition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_definition.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_definition.py --strict
```

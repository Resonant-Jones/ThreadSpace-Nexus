# 🧠 Mypy Fix Guide: `v1_custom_resource_definition_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_definition_spec.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_definition_spec.py --strict
```

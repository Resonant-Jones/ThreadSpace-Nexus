# 🧠 Mypy Fix Guide: `v1_custom_resource_definition_version.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_definition_version.py`
**Lines:** `345`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_definition_version.py --strict
```

# 🧠 Mypy Fix Guide: `v1_custom_resource_subresource_scale.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_subresource_scale.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_subresource_scale.py --strict
```

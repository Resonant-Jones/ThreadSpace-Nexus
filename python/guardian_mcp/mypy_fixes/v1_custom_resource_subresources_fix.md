# 🧠 Mypy Fix Guide: `v1_custom_resource_subresources.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_subresources.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_custom_resource_subresources.py --strict
```

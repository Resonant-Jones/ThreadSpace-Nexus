# 🧠 Mypy Fix Guide: `v1_daemon_endpoint.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_endpoint.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_endpoint.py --strict
```

# 🧠 Mypy Fix Guide: `v1_daemon_set.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set.py --strict
```

# 🧠 Mypy Fix Guide: `v1_daemon_set_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set_spec.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set_spec.py --strict
```

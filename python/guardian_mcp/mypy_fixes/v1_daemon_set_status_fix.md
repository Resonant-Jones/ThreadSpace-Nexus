# 🧠 Mypy Fix Guide: `v1_daemon_set_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set_status.py`
**Lines:** `378`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set_status.py --strict
```

# 🧠 Mypy Fix Guide: `v1_daemon_set_update_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set_update_strategy.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_daemon_set_update_strategy.py --strict
```

# 🧠 Mypy Fix Guide: `v1_delete_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_delete_options.py`
**Lines:** `316`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_delete_options.py --strict
```

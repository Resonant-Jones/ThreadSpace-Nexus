# 🧠 Mypy Fix Guide: `v1_deployment_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_deployment_condition.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_deployment_condition.py --strict
```

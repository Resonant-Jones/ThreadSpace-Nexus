# 🧠 Mypy Fix Guide: `v1_deployment_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_deployment_spec.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_deployment_spec.py --strict
```

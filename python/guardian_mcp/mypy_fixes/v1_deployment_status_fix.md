# 🧠 Mypy Fix Guide: `v1_deployment_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_deployment_status.py`
**Lines:** `346`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_deployment_status.py --strict
```

# 🧠 Mypy Fix Guide: `v1_downward_api_projection.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_downward_api_projection.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_downward_api_projection.py --strict
```

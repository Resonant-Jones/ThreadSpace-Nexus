...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_endpoint.py`
**Lines:** `313`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_endpoint.py --strict
```

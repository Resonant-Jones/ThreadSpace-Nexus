# 🧠 Mypy Fix Guide: `v1_endpoint_hints.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_endpoint_hints.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_endpoint_hints.py --strict
```

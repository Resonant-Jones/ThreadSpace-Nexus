# 🧠 Mypy Fix Guide: `v1_env_from_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_env_from_source.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_env_from_source.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_env_var.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_env_var.py --strict
```

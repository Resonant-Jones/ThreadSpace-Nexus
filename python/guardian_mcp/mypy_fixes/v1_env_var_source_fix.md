# 🧠 Mypy Fix Guide: `v1_env_var_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_env_var_source.py`
**Lines:** `198`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_env_var_source.py --strict
```

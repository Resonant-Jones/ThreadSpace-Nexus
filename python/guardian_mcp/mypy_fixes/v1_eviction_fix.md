...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_eviction.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_eviction.py --strict
```

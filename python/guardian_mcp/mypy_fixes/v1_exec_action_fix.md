# 🧠 Mypy Fix Guide: `v1_exec_action.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_exec_action.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_exec_action.py --strict
```

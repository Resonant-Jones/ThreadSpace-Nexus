# 🧠 Mypy Fix Guide: `v1_exempt_priority_level_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_exempt_priority_level_configuration.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_exempt_priority_level_configuration.py --strict
```

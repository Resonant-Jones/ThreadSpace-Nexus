# 🧠 Mypy Fix Guide: `v1_external_documentation.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_external_documentation.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_external_documentation.py --strict
```

# 🧠 Mypy Fix Guide: `v1_flow_distinguisher_method.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_distinguisher_method.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_distinguisher_method.py --strict
```

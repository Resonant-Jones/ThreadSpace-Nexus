# 🧠 Mypy Fix Guide: `v1_flow_schema_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_schema_condition.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_schema_condition.py --strict
```

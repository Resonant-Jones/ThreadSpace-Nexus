# 🧠 Mypy Fix Guide: `v1_flow_schema.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_schema.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_schema.py --strict
```

# 🧠 Mypy Fix Guide: `v1_flow_schema_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_schema_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_flow_schema_list.py --strict
```

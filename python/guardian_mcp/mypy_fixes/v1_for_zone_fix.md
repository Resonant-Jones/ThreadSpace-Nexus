...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_for_zone.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_for_zone.py --strict
```

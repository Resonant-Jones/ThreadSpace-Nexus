# 🧠 Mypy Fix Guide: `v1_gce_persistent_disk_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_gce_persistent_disk_volume_source.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_gce_persistent_disk_volume_source.py --strict
```

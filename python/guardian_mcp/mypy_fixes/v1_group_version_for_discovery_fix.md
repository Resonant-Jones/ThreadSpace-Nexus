# 🧠 Mypy Fix Guide: `v1_group_version_for_discovery.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_group_version_for_discovery.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_group_version_for_discovery.py --strict
```

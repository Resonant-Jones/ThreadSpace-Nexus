# 🧠 Mypy Fix Guide: `v1_horizontal_pod_autoscaler_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_horizontal_pod_autoscaler_spec.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_horizontal_pod_autoscaler_spec.py --strict
```

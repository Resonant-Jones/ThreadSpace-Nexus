# 🧠 Mypy Fix Guide: `v1_horizontal_pod_autoscaler_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_horizontal_pod_autoscaler_status.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_horizontal_pod_autoscaler_status.py --strict
```

# 🧠 Mypy Fix Guide: `v1_host_alias.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_host_alias.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_host_alias.py --strict
```

# 🧠 Mypy Fix Guide: `v1_http_get_action.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_get_action.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_get_action.py --strict
```

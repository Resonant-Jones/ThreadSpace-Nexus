# 🧠 Mypy Fix Guide: `v1_http_header.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_header.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_header.py --strict
```

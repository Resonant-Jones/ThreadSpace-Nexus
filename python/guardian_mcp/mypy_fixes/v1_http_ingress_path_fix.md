# 🧠 Mypy Fix Guide: `v1_http_ingress_path.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_ingress_path.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_ingress_path.py --strict
```

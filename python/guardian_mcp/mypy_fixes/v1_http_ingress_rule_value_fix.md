# 🧠 Mypy Fix Guide: `v1_http_ingress_rule_value.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_ingress_rule_value.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_http_ingress_rule_value.py --strict
```

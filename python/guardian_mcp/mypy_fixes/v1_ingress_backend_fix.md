# 🧠 Mypy Fix Guide: `v1_ingress_backend.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_backend.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_backend.py --strict
```

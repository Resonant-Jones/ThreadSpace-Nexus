# 🧠 Mypy Fix Guide: `v1_ingress_class_parameters_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_class_parameters_reference.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_class_parameters_reference.py --strict
```

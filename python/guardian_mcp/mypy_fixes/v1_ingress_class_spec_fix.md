# 🧠 Mypy Fix Guide: `v1_ingress_class_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_class_spec.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_class_spec.py --strict
```

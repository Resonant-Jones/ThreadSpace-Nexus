# 🧠 Mypy Fix Guide: `v1_ingress_load_balancer_ingress.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_load_balancer_ingress.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_load_balancer_ingress.py --strict
```

# 🧠 Mypy Fix Guide: `v1_ingress_load_balancer_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_load_balancer_status.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_load_balancer_status.py --strict
```

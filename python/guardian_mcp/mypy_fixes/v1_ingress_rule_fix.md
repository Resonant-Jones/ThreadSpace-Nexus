# 🧠 Mypy Fix Guide: `v1_ingress_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_rule.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_rule.py --strict
```

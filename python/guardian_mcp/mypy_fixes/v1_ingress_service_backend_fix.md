# 🧠 Mypy Fix Guide: `v1_ingress_service_backend.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_service_backend.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_service_backend.py --strict
```

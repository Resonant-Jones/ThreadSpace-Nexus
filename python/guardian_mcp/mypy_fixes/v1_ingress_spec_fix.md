# 🧠 Mypy Fix Guide: `v1_ingress_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_spec.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_spec.py --strict
```

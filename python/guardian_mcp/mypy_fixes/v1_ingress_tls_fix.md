# 🧠 Mypy Fix Guide: `v1_ingress_tls.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_tls.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ingress_tls.py --strict
```

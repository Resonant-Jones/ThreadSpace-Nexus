...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ip_block.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_ip_block.py --strict
```

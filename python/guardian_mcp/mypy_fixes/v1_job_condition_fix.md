# 🧠 Mypy Fix Guide: `v1_job_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_condition.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_condition.py --strict
```

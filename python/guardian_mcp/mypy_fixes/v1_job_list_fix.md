...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_list.py --strict
```

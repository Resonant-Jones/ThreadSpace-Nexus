...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_spec.py`
**Lines:** `535`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_spec.py --strict
```

# 🧠 Mypy Fix Guide: `v1_job_template_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_template_spec.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_job_template_spec.py --strict
```

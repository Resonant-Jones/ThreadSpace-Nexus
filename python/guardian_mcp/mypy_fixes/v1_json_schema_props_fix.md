# 🧠 Mypy Fix Guide: `v1_json_schema_props.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_json_schema_props.py`
**Lines:** `1264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_json_schema_props.py --strict
```

# 🧠 Mypy Fix Guide: `v1_key_to_path.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_key_to_path.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_key_to_path.py --strict
```

# 🧠 Mypy Fix Guide: `v1_label_selector.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_label_selector.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_label_selector.py --strict
```

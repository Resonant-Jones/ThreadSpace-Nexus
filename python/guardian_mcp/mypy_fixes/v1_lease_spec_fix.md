# 🧠 Mypy Fix Guide: `v1_lease_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_lease_spec.py`
**Lines:** `290`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_lease_spec.py --strict
```

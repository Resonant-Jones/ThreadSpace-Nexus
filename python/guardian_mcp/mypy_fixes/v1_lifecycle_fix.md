# 🧠 Mypy Fix Guide: `v1_lifecycle.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_lifecycle.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_lifecycle.py --strict
```

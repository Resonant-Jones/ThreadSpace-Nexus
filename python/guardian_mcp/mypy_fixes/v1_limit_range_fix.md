# 🧠 Mypy Fix Guide: `v1_limit_range.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_limit_range.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_limit_range.py --strict
```

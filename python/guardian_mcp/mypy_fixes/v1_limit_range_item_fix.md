# 🧠 Mypy Fix Guide: `v1_limit_range_item.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_limit_range_item.py`
**Lines:** `263`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_limit_range_item.py --strict
```

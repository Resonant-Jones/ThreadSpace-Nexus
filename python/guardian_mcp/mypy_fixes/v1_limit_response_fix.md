# 🧠 Mypy Fix Guide: `v1_limit_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_limit_response.py`
**Lines:** `149`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_limit_response.py --strict
```

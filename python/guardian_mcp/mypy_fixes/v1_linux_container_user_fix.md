# 🧠 Mypy Fix Guide: `v1_linux_container_user.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_linux_container_user.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_linux_container_user.py --strict
```

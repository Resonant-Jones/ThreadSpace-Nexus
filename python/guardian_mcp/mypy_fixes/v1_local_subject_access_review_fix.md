# 🧠 Mypy Fix Guide: `v1_local_subject_access_review.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_local_subject_access_review.py`
**Lines:** `229`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_local_subject_access_review.py --strict
```

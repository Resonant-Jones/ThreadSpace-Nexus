# 🧠 Mypy Fix Guide: `v1_match_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_match_condition.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_match_condition.py --strict
```

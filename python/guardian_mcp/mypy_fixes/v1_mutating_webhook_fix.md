# 🧠 Mypy Fix Guide: `v1_mutating_webhook.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_mutating_webhook.py`
**Lines:** `428`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_mutating_webhook.py --strict
```

# 🧠 Mypy Fix Guide: `v1_namespace_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_namespace_spec.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_namespace_spec.py --strict
```

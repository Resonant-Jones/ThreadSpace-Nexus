# 🧠 Mypy Fix Guide: `v1_network_policy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy.py --strict
```

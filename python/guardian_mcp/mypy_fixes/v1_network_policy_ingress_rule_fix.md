# 🧠 Mypy Fix Guide: `v1_network_policy_ingress_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_ingress_rule.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_ingress_rule.py --strict
```

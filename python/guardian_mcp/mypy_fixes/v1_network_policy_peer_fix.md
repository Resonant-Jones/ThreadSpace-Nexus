# 🧠 Mypy Fix Guide: `v1_network_policy_peer.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_peer.py`
**Lines:** `172`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_peer.py --strict
```

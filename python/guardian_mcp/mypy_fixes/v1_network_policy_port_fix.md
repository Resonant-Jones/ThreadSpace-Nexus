# 🧠 Mypy Fix Guide: `v1_network_policy_port.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_port.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_port.py --strict
```

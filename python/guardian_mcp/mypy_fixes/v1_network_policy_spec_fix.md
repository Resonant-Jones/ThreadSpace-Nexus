# 🧠 Mypy Fix Guide: `v1_network_policy_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_spec.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_network_policy_spec.py --strict
```

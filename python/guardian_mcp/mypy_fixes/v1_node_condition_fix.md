# 🧠 Mypy Fix Guide: `v1_node_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_condition.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_condition.py --strict
```

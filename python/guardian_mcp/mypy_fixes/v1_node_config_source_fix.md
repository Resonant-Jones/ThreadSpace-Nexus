# 🧠 Mypy Fix Guide: `v1_node_config_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_config_source.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_config_source.py --strict
```

# 🧠 Mypy Fix Guide: `v1_node_config_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_config_status.py`
**Lines:** `200`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_config_status.py --strict
```

# 🧠 Mypy Fix Guide: `v1_node_daemon_endpoints.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_daemon_endpoints.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_daemon_endpoints.py --strict
```

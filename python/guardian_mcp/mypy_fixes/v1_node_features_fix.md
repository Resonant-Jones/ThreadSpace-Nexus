# 🧠 Mypy Fix Guide: `v1_node_features.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_features.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_features.py --strict
```

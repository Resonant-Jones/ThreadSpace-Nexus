...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node.py --strict
```

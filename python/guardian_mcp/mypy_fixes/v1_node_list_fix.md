# 🧠 Mypy Fix Guide: `v1_node_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_list.py --strict
```

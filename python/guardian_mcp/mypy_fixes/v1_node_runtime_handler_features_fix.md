# 🧠 Mypy Fix Guide: `v1_node_runtime_handler_features.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_runtime_handler_features.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_runtime_handler_features.py --strict
```

# 🧠 Mypy Fix Guide: `v1_node_runtime_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_runtime_handler.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_runtime_handler.py --strict
```

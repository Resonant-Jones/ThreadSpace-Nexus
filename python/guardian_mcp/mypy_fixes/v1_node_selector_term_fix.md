# 🧠 Mypy Fix Guide: `v1_node_selector_term.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_selector_term.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_selector_term.py --strict
```

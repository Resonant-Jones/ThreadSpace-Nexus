# 🧠 Mypy Fix Guide: `v1_node_system_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_system_info.py`
**Lines:** `410`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_node_system_info.py --strict
```

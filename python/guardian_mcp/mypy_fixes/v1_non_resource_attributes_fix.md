# 🧠 Mypy Fix Guide: `v1_non_resource_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_non_resource_attributes.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_non_resource_attributes.py --strict
```

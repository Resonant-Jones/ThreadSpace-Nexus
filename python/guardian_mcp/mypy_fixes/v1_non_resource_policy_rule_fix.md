# 🧠 Mypy Fix Guide: `v1_non_resource_policy_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_non_resource_policy_rule.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_non_resource_policy_rule.py --strict
```

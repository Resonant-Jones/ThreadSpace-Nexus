# 🧠 Mypy Fix Guide: `v1_object_meta.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_object_meta.py`
**Lines:** `514`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_object_meta.py --strict
```

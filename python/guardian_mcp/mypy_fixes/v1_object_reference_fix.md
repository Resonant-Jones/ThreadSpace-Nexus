# 🧠 Mypy Fix Guide: `v1_object_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_object_reference.py`
**Lines:** `290`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_object_reference.py --strict
```

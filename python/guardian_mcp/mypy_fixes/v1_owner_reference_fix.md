# 🧠 Mypy Fix Guide: `v1_owner_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_owner_reference.py`
**Lines:** `266`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_owner_reference.py --strict
```

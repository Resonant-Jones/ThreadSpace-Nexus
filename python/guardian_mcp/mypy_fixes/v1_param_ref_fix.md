# 🧠 Mypy Fix Guide: `v1_param_ref.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_param_ref.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_param_ref.py --strict
```

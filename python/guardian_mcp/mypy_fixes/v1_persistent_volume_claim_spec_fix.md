# 🧠 Mypy Fix Guide: `v1_persistent_volume_claim_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_persistent_volume_claim_spec.py`
**Lines:** `338`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_persistent_volume_claim_spec.py --strict
```

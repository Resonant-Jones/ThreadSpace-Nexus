# 🧠 Mypy Fix Guide: `v1_persistent_volume_claim_template.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_persistent_volume_claim_template.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_persistent_volume_claim_template.py --strict
```

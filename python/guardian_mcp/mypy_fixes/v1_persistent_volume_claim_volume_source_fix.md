# 🧠 Mypy Fix Guide: `v1_persistent_volume_claim_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_persistent_volume_claim_volume_source.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_persistent_volume_claim_volume_source.py --strict
```

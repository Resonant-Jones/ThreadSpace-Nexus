# 🧠 Mypy Fix Guide: `v1_pod_affinity_term.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_affinity_term.py`
**Lines:** `259`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_affinity_term.py --strict
```

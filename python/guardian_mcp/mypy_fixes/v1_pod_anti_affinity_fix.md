# 🧠 Mypy Fix Guide: `v1_pod_anti_affinity.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_anti_affinity.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_anti_affinity.py --strict
```

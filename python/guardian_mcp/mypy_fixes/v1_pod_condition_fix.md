# 🧠 Mypy Fix Guide: `v1_pod_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_condition.py`
**Lines:** `292`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_condition.py --strict
```

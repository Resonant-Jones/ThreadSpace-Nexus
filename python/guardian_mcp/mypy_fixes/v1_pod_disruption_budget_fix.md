# 🧠 Mypy Fix Guide: `v1_pod_disruption_budget.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_disruption_budget.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_disruption_budget.py --strict
```

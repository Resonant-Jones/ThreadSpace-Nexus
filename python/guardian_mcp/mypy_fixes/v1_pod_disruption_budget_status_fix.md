# 🧠 Mypy Fix Guide: `v1_pod_disruption_budget_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_disruption_budget_status.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_disruption_budget_status.py --strict
```

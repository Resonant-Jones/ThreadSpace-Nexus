# 🧠 Mypy Fix Guide: `v1_pod_dns_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_dns_config.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_dns_config.py --strict
```

# 🧠 Mypy Fix Guide: `v1_pod_failure_policy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy.py --strict
```

# 🧠 Mypy Fix Guide: `v1_pod_failure_policy_on_exit_codes_requirement.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy_on_exit_codes_requirement.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy_on_exit_codes_requirement.py --strict
```

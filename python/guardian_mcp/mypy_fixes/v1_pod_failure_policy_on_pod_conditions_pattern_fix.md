# 🧠 Mypy Fix Guide: `v1_pod_failure_policy_on_pod_conditions_pattern.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy_on_pod_conditions_pattern.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy_on_pod_conditions_pattern.py --strict
```

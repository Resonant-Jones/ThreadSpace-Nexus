# 🧠 Mypy Fix Guide: `v1_pod_failure_policy_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy_rule.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_failure_policy_rule.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_list.py --strict
```

# 🧠 Mypy Fix Guide: `v1_pod_resource_claim.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_resource_claim.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_resource_claim.py --strict
```

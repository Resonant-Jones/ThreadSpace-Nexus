# 🧠 Mypy Fix Guide: `v1_pod_scheduling_gate.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_scheduling_gate.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_scheduling_gate.py --strict
```

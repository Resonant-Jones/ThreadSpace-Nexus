# 🧠 Mypy Fix Guide: `v1_pod_security_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_security_context.py`
**Lines:** `450`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_security_context.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_spec.py`
**Lines:** `1205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_spec.py --strict
```

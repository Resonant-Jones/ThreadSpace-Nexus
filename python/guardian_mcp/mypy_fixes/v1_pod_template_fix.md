# 🧠 Mypy Fix Guide: `v1_pod_template.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_template.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_pod_template.py --strict
```

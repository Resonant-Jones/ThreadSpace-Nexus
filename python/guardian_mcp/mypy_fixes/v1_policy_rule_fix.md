# 🧠 Mypy Fix Guide: `v1_policy_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_policy_rule.py`
**Lines:** `235`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_policy_rule.py --strict
```

# 🧠 Mypy Fix Guide: `v1_policy_rules_with_subjects.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_policy_rules_with_subjects.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_policy_rules_with_subjects.py --strict
```

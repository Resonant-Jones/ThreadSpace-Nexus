# 🧠 Mypy Fix Guide: `v1_preferred_scheduling_term.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_preferred_scheduling_term.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_preferred_scheduling_term.py --strict
```

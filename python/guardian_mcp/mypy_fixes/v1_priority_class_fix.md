# 🧠 Mypy Fix Guide: `v1_priority_class.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_class.py`
**Lines:** `289`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_class.py --strict
```

# 🧠 Mypy Fix Guide: `v1_priority_level_configuration_reference.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_level_configuration_reference.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_level_configuration_reference.py --strict
```

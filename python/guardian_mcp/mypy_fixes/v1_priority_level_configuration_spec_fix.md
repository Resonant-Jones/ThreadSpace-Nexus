# 🧠 Mypy Fix Guide: `v1_priority_level_configuration_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_level_configuration_spec.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_level_configuration_spec.py --strict
```

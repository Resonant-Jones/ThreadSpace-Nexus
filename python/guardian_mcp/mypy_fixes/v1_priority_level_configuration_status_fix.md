# 🧠 Mypy Fix Guide: `v1_priority_level_configuration_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_level_configuration_status.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_priority_level_configuration_status.py --strict
```

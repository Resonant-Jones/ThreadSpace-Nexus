...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_probe.py`
**Lines:** `366`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_probe.py --strict
```

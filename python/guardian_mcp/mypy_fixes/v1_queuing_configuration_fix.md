# 🧠 Mypy Fix Guide: `v1_queuing_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_queuing_configuration.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_queuing_configuration.py --strict
```

# 🧠 Mypy Fix Guide: `v1_quobyte_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_quobyte_volume_source.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_quobyte_volume_source.py --strict
```

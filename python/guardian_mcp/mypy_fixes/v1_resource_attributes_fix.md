# 🧠 Mypy Fix Guide: `v1_resource_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_attributes.py`
**Lines:** `342`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_attributes.py --strict
```

# 🧠 Mypy Fix Guide: `v1_resource_field_selector.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_field_selector.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_field_selector.py --strict
```

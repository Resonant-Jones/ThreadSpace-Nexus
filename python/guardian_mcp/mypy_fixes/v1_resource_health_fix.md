# 🧠 Mypy Fix Guide: `v1_resource_health.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_health.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_health.py --strict
```

# 🧠 Mypy Fix Guide: `v1_resource_quota.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_quota.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_quota.py --strict
```

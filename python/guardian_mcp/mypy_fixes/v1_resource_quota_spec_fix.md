# 🧠 Mypy Fix Guide: `v1_resource_quota_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_quota_spec.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_quota_spec.py --strict
```

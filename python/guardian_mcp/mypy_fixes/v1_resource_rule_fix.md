# 🧠 Mypy Fix Guide: `v1_resource_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_rule.py`
**Lines:** `207`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_resource_rule.py --strict
```

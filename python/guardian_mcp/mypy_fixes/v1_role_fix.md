...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_role.py`
**Lines:** `204`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_role.py --strict
```

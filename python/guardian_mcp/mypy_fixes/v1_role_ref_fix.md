...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_role_ref.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_role_ref.py --strict
```

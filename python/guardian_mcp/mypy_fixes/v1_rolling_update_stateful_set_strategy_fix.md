# 🧠 Mypy Fix Guide: `v1_rolling_update_stateful_set_strategy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_rolling_update_stateful_set_strategy.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_rolling_update_stateful_set_strategy.py --strict
```

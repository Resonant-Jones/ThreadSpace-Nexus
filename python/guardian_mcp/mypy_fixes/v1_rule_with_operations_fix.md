# 🧠 Mypy Fix Guide: `v1_rule_with_operations.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_rule_with_operations.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_rule_with_operations.py --strict
```

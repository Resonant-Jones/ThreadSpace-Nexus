# 🧠 Mypy Fix Guide: `v1_runtime_class.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_runtime_class.py`
**Lines:** `257`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_runtime_class.py --strict
```

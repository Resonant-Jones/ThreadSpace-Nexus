# 🧠 Mypy Fix Guide: `v1_scale_io_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scale_io_volume_source.py`
**Lines:** `375`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scale_io_volume_source.py --strict
```

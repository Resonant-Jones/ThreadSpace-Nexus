# 🧠 Mypy Fix Guide: `v1_scale_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scale_status.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scale_status.py --strict
```

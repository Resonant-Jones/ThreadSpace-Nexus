# 🧠 Mypy Fix Guide: `v1_scheduling.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scheduling.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scheduling.py --strict
```

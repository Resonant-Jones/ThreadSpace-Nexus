# 🧠 Mypy Fix Guide: `v1_scope_selector.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scope_selector.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scope_selector.py --strict
```

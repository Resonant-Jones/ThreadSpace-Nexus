# 🧠 Mypy Fix Guide: `v1_scoped_resource_selector_requirement.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scoped_resource_selector_requirement.py`
**Lines:** `180`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_scoped_resource_selector_requirement.py --strict
```

# 🧠 Mypy Fix Guide: `v1_se_linux_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_se_linux_options.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_se_linux_options.py --strict
```

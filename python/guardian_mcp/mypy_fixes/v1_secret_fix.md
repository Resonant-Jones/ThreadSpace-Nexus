...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_secret.py`
**Lines:** `288`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_secret.py --strict
```

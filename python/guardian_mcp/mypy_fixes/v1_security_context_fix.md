# 🧠 Mypy Fix Guide: `v1_security_context.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_security_context.py`
**Lines:** `420`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_security_context.py --strict
```

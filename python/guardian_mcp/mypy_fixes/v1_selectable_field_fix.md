# 🧠 Mypy Fix Guide: `v1_selectable_field.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_selectable_field.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_selectable_field.py --strict
```

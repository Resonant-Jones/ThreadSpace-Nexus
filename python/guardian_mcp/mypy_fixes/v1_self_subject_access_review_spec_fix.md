# 🧠 Mypy Fix Guide: `v1_self_subject_access_review_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_self_subject_access_review_spec.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_self_subject_access_review_spec.py --strict
```

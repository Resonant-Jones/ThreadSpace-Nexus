# 🧠 Mypy Fix Guide: `v1_self_subject_review.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_self_subject_review.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_self_subject_review.py --strict
```

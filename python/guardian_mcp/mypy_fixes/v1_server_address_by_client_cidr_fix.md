# 🧠 Mypy Fix Guide: `v1_server_address_by_client_cidr.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_server_address_by_client_cidr.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_server_address_by_client_cidr.py --strict
```

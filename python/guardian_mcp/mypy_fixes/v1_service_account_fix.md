# 🧠 Mypy Fix Guide: `v1_service_account.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_account.py`
**Lines:** `260`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_account.py --strict
```

# 🧠 Mypy Fix Guide: `v1_service_account_subject.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_account_subject.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_account_subject.py --strict
```

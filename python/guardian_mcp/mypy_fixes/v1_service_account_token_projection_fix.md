# 🧠 Mypy Fix Guide: `v1_service_account_token_projection.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_account_token_projection.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_account_token_projection.py --strict
```

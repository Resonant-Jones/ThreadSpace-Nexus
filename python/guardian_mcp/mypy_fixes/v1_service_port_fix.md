# 🧠 Mypy Fix Guide: `v1_service_port.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_port.py`
**Lines:** `263`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_port.py --strict
```

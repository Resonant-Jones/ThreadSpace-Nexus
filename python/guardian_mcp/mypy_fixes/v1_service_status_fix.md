# 🧠 Mypy Fix Guide: `v1_service_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_status.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_service_status.py --strict
```

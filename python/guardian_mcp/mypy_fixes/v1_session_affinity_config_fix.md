# 🧠 Mypy Fix Guide: `v1_session_affinity_config.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_session_affinity_config.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_session_affinity_config.py --strict
```

# 🧠 Mypy Fix Guide: `v1_stateful_set_ordinals.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_stateful_set_ordinals.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_stateful_set_ordinals.py --strict
```

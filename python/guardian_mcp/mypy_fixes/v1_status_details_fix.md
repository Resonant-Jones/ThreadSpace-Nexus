# 🧠 Mypy Fix Guide: `v1_status_details.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_status_details.py`
**Lines:** `262`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_status_details.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_status.py`
**Lines:** `314`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_status.py --strict
```

# 🧠 Mypy Fix Guide: `v1_storage_class.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_storage_class.py`
**Lines:** `373`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_storage_class.py --strict
```

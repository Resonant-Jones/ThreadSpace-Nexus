# 🧠 Mypy Fix Guide: `v1_storage_os_persistent_volume_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_storage_os_persistent_volume_source.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_storage_os_persistent_volume_source.py --strict
```

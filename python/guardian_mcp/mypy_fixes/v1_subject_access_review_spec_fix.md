# 🧠 Mypy Fix Guide: `v1_subject_access_review_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_subject_access_review_spec.py`
**Lines:** `258`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_subject_access_review_spec.py --strict
```

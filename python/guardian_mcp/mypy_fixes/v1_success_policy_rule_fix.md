# 🧠 Mypy Fix Guide: `v1_success_policy_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_success_policy_rule.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_success_policy_rule.py --strict
```

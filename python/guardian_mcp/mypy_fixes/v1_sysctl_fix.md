...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_sysctl.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_sysctl.py --strict
```

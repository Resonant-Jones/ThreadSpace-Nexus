...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_taint.py`
**Lines:** `208`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_taint.py --strict
```

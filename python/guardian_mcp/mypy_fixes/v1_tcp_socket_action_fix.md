# 🧠 Mypy Fix Guide: `v1_tcp_socket_action.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_tcp_socket_action.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_tcp_socket_action.py --strict
```

# 🧠 Mypy Fix Guide: `v1_token_request_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_token_request_status.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_token_request_status.py --strict
```

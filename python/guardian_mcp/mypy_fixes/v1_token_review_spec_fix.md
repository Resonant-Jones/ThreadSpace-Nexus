# 🧠 Mypy Fix Guide: `v1_token_review_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_token_review_spec.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_token_review_spec.py --strict
```

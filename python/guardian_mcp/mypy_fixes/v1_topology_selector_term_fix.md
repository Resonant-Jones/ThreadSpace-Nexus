# 🧠 Mypy Fix Guide: `v1_topology_selector_term.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_topology_selector_term.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_topology_selector_term.py --strict
```

# 🧠 Mypy Fix Guide: `v1_topology_spread_constraint.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_topology_spread_constraint.py`
**Lines:** `319`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_topology_spread_constraint.py --strict
```

# 🧠 Mypy Fix Guide: `v1_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/cohere/embed/v1_transformation.py`
**Lines:** `143`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/cohere/embed/v1_transformation.py --strict
```

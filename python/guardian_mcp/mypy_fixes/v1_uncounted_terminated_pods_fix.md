# 🧠 Mypy Fix Guide: `v1_uncounted_terminated_pods.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_uncounted_terminated_pods.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_uncounted_terminated_pods.py --strict
```

# 🧠 Mypy Fix Guide: `v1_user_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_user_info.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_user_info.py --strict
```

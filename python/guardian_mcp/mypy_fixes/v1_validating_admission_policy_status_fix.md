# 🧠 Mypy Fix Guide: `v1_validating_admission_policy_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_validating_admission_policy_status.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_validating_admission_policy_status.py --strict
```

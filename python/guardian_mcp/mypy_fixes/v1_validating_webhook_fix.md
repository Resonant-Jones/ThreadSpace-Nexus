# 🧠 Mypy Fix Guide: `v1_validating_webhook.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_validating_webhook.py`
**Lines:** `400`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_validating_webhook.py --strict
```

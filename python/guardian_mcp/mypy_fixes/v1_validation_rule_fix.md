# 🧠 Mypy Fix Guide: `v1_validation_rule.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_validation_rule.py`
**Lines:** `263`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_validation_rule.py --strict
```

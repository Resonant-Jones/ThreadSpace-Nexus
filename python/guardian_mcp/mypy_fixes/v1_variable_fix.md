...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_variable.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_variable.py --strict
```

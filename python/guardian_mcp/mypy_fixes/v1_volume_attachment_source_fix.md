# 🧠 Mypy Fix Guide: `v1_volume_attachment_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_attachment_source.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_attachment_source.py --strict
```

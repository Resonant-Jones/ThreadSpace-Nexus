# 🧠 Mypy Fix Guide: `v1_volume_attachment_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_attachment_spec.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_attachment_spec.py --strict
```

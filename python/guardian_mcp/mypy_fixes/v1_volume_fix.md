...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume.py`
**Lines:** `903`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume.py --strict
```

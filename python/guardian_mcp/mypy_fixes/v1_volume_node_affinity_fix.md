# 🧠 Mypy Fix Guide: `v1_volume_node_affinity.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_node_affinity.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_node_affinity.py --strict
```

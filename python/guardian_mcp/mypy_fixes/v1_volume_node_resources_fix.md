# 🧠 Mypy Fix Guide: `v1_volume_node_resources.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_node_resources.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_node_resources.py --strict
```

# 🧠 Mypy Fix Guide: `v1_volume_resource_requirements.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_resource_requirements.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_volume_resource_requirements.py --strict
```

# 🧠 Mypy Fix Guide: `v1_weighted_pod_affinity_term.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1_weighted_pod_affinity_term.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1_weighted_pod_affinity_term.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha1_apply_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_apply_configuration.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_apply_configuration.py --strict
```

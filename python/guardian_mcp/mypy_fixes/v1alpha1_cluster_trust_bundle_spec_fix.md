# 🧠 Mypy Fix Guide: `v1alpha1_cluster_trust_bundle_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_cluster_trust_bundle_spec.py`
**Lines:** `151`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_cluster_trust_bundle_spec.py --strict
```

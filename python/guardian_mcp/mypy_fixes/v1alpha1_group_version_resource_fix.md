# 🧠 Mypy Fix Guide: `v1alpha1_group_version_resource.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_group_version_resource.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_group_version_resource.py --strict
```

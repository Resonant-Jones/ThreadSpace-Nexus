# 🧠 Mypy Fix Guide: `v1alpha1_json_patch.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_json_patch.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_json_patch.py --strict
```

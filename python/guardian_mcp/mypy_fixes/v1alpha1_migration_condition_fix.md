# 🧠 Mypy Fix Guide: `v1alpha1_migration_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_migration_condition.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_migration_condition.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha1_mutating_admission_policy_binding_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutating_admission_policy_binding_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutating_admission_policy_binding_list.py --strict
```

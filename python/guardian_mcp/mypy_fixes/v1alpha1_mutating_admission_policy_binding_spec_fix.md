# 🧠 Mypy Fix Guide: `v1alpha1_mutating_admission_policy_binding_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutating_admission_policy_binding_spec.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutating_admission_policy_binding_spec.py --strict
```

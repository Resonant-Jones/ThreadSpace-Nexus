# 🧠 Mypy Fix Guide: `v1alpha1_mutating_admission_policy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutating_admission_policy.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutating_admission_policy.py --strict
```

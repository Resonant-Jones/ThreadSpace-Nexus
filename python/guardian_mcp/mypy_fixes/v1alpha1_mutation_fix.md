# 🧠 Mypy Fix Guide: `v1alpha1_mutation.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutation.py`
**Lines:** `175`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha1_mutation.py --strict
```

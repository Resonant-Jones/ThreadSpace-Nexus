# 🧠 Mypy Fix Guide: `v1alpha2_lease_candidate.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha2_lease_candidate.py`
**Lines:** `202`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha2_lease_candidate.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha2_lease_candidate_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha2_lease_candidate_spec.py`
**Lines:** `265`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha2_lease_candidate_spec.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha3_device_allocation_result.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_allocation_result.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_allocation_result.py --strict
```

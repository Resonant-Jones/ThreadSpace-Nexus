# 🧠 Mypy Fix Guide: `v1alpha3_device_claim.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_claim.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_claim.py --strict
```

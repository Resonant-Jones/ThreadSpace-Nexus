# 🧠 Mypy Fix Guide: `v1alpha3_device_class.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_class.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_class.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha3_device_counter_consumption.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_counter_consumption.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_counter_consumption.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha3_device_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_request.py`
**Lines:** `319`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_request.py --strict
```

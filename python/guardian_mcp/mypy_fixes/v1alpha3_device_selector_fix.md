# 🧠 Mypy Fix Guide: `v1alpha3_device_selector.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_selector.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_selector.py --strict
```

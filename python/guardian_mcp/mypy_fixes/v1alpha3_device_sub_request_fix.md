# 🧠 Mypy Fix Guide: `v1alpha3_device_sub_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_sub_request.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_sub_request.py --strict
```

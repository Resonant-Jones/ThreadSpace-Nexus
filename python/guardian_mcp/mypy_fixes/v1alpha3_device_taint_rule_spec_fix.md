# 🧠 Mypy Fix Guide: `v1alpha3_device_taint_rule_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_taint_rule_spec.py`
**Lines:** `147`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_device_taint_rule_spec.py --strict
```

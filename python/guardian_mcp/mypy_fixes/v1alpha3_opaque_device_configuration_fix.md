# 🧠 Mypy Fix Guide: `v1alpha3_opaque_device_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_opaque_device_configuration.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_opaque_device_configuration.py --strict
```

# 🧠 Mypy Fix Guide: `v1alpha3_resource_claim_template_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_resource_claim_template_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_resource_claim_template_list.py --strict
```

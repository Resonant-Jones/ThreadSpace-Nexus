# 🧠 Mypy Fix Guide: `v1alpha3_resource_pool.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_resource_pool.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1alpha3_resource_pool.py --strict
```

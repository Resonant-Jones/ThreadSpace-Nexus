# 🧠 Mypy Fix Guide: `v1beta1_basic_device.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_basic_device.py`
**Lines:** `288`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_basic_device.py --strict
```

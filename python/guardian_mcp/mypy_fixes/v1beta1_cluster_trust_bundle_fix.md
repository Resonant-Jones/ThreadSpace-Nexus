# 🧠 Mypy Fix Guide: `v1beta1_cluster_trust_bundle.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_cluster_trust_bundle.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_cluster_trust_bundle.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta1_device_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_device_request.py`
**Lines:** `319`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_device_request.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta1_device_sub_request.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_device_sub_request.py`
**Lines:** `264`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_device_sub_request.py --strict
```

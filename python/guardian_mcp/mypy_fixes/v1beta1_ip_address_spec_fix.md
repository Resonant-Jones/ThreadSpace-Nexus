# 🧠 Mypy Fix Guide: `v1beta1_ip_address_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_ip_address_spec.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_ip_address_spec.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta1_lease_candidate_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_lease_candidate_spec.py`
**Lines:** `265`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_lease_candidate_spec.py --strict
```

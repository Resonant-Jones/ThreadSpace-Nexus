# 🧠 Mypy Fix Guide: `v1beta1_match_resources.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_match_resources.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_match_resources.py --strict
```

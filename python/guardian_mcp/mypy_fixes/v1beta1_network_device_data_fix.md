# 🧠 Mypy Fix Guide: `v1beta1_network_device_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_network_device_data.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_network_device_data.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta1_resource_claim_list.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_resource_claim_list.py`
**Lines:** `205`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_resource_claim_list.py --strict
```

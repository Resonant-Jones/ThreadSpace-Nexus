# 🧠 Mypy Fix Guide: `v1beta1_resource_slice_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_resource_slice_spec.py`
**Lines:** `316`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_resource_slice_spec.py --strict
```

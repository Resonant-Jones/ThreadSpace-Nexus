# 🧠 Mypy Fix Guide: `v1beta1_service_cidr.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_service_cidr.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_service_cidr.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta1_service_cidr_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_service_cidr_status.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_service_cidr_status.py --strict
```

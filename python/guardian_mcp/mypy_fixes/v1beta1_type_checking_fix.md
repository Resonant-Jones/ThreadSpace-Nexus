# 🧠 Mypy Fix Guide: `v1beta1_type_checking.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_type_checking.py`
**Lines:** `122`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_type_checking.py --strict
```

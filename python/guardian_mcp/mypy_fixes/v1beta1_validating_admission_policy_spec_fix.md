# 🧠 Mypy Fix Guide: `v1beta1_validating_admission_policy_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_validating_admission_policy_spec.py`
**Lines:** `286`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta1_validating_admission_policy_spec.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta2_allocated_device_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_allocated_device_status.py`
**Lines:** `263`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_allocated_device_status.py --strict
```

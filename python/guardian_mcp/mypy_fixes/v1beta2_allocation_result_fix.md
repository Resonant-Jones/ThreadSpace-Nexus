# 🧠 Mypy Fix Guide: `v1beta2_allocation_result.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_allocation_result.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_allocation_result.py --strict
```

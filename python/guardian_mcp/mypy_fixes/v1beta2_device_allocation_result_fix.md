# 🧠 Mypy Fix Guide: `v1beta2_device_allocation_result.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_allocation_result.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_allocation_result.py --strict
```

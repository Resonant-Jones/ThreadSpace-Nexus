# 🧠 Mypy Fix Guide: `v1beta2_device_capacity.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_capacity.py`
**Lines:** `123`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_capacity.py --strict
```

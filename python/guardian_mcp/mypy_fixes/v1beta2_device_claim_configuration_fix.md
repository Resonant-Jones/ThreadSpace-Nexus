# 🧠 Mypy Fix Guide: `v1beta2_device_claim_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_claim_configuration.py`
**Lines:** `148`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_claim_configuration.py --strict
```

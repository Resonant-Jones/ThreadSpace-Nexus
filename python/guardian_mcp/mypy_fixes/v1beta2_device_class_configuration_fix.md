# 🧠 Mypy Fix Guide: `v1beta2_device_class_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_class_configuration.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_class_configuration.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta2_device_toleration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_toleration.py`
**Lines:** `234`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_device_toleration.py --strict
```

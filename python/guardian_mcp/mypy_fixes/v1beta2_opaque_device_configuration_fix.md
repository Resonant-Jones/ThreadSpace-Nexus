# 🧠 Mypy Fix Guide: `v1beta2_opaque_device_configuration.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_opaque_device_configuration.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_opaque_device_configuration.py --strict
```

# 🧠 Mypy Fix Guide: `v1beta2_resource_claim_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_resource_claim_status.py`
**Lines:** `176`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_resource_claim_status.py --strict
```

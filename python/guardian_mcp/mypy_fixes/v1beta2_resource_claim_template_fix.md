# 🧠 Mypy Fix Guide: `v1beta2_resource_claim_template.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_resource_claim_template.py`
**Lines:** `203`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v1beta2_resource_claim_template.py --strict
```

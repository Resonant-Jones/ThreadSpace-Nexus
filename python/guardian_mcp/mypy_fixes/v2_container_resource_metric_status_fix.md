# 🧠 Mypy Fix Guide: `v2_container_resource_metric_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_container_resource_metric_status.py`
**Lines:** `179`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_container_resource_metric_status.py --strict
```

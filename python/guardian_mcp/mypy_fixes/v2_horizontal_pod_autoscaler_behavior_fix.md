# 🧠 Mypy Fix Guide: `v2_horizontal_pod_autoscaler_behavior.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler_behavior.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler_behavior.py --strict
```

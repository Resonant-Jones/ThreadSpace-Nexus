# 🧠 Mypy Fix Guide: `v2_horizontal_pod_autoscaler_condition.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler_condition.py`
**Lines:** `236`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler_condition.py --strict
```

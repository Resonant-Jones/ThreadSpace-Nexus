# 🧠 Mypy Fix Guide: `v2_horizontal_pod_autoscaler.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler.py`
**Lines:** `228`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler.py --strict
```

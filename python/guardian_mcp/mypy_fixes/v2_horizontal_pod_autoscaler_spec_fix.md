# 🧠 Mypy Fix Guide: `v2_horizontal_pod_autoscaler_spec.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler_spec.py`
**Lines:** `232`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_horizontal_pod_autoscaler_spec.py --strict
```

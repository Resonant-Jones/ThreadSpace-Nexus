# 🧠 Mypy Fix Guide: `v2_hpa_scaling_policy.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_hpa_scaling_policy.py`
**Lines:** `181`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_hpa_scaling_policy.py --strict
```

# 🧠 Mypy Fix Guide: `v2_hpa_scaling_rules.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_hpa_scaling_rules.py`
**Lines:** `206`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_hpa_scaling_rules.py --strict
```

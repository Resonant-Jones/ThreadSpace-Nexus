# 🧠 Mypy Fix Guide: `v2_metric_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_metric_status.py`
**Lines:** `253`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_metric_status.py --strict
```

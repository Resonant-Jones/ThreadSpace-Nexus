# 🧠 Mypy Fix Guide: `v2_metric_value_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_metric_value_status.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_metric_value_status.py --strict
```

# 🧠 Mypy Fix Guide: `v2_resource_metric_source.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_resource_metric_source.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_resource_metric_source.py --strict
```

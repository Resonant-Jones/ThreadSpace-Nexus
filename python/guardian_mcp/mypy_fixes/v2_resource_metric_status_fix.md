# 🧠 Mypy Fix Guide: `v2_resource_metric_status.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/v2_resource_metric_status.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/v2_resource_metric_status.py --strict
```

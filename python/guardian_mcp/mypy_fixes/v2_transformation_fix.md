# 🧠 Mypy Fix Guide: `v2_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/cohere/chat/v2_transformation.py`
**Lines:** `356`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/cohere/chat/v2_transformation.py --strict
```

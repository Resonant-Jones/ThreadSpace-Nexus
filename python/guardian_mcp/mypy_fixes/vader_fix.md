...
**File:** `.venv/lib/python3.13/site-packages/nltk/sentiment/vader.py`
**Lines:** `633`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/sentiment/vader.py --strict
```

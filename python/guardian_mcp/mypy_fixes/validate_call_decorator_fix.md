# 🧠 Mypy Fix Guide: `validate_call_decorator.py`
...
**File:** `.venv/lib/python3.13/site-packages/pydantic/validate_call_decorator.py`
**Lines:** `116`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/validate_call_decorator.py --strict
```

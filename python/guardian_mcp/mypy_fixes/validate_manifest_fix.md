# 🧠 Mypy Fix Guide: `validate_manifest.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/commands/validate_manifest.py`
**Lines:** `18`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/commands/validate_manifest.py --strict
```

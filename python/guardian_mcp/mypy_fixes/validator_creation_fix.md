# 🧠 Mypy Fix Guide: `validator_creation.py`
...
**File:** `.venv/lib/python3.13/site-packages/jsonschema/benchmarks/validator_creation.py`
**Lines:** `14`
...
```bash
mypy .venv/lib/python3.13/site-packages/jsonschema/benchmarks/validator_creation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pydantic/v1/validators.py`
**Lines:** `768`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic/v1/validators.py --strict
```

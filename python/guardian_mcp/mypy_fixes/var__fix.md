...
**File:** `.venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/var_.py`
**Lines:** `245`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/core/_numba/kernels/var_.py --strict
```

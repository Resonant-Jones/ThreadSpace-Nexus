...
**File:** `.venv/lib/python3.13/site-packages/uritemplate/variable.py`
**Lines:** `564`
...
```bash
mypy .venv/lib/python3.13/site-packages/uritemplate/variable.py --strict
```

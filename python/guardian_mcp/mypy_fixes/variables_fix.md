...
**File:** `.venv/lib/python3.13/site-packages/dotenv/variables.py`
**Lines:** `86`
...
```bash
mypy .venv/lib/python3.13/site-packages/dotenv/variables.py --strict
```

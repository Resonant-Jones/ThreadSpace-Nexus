...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/varnish.py`
**Lines:** `189`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/varnish.py --strict
```

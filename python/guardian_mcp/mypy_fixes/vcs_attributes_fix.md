# 🧠 Mypy Fix Guide: `vcs_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/vcs_attributes.py`
**Lines:** `231`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/vcs_attributes.py --strict
```

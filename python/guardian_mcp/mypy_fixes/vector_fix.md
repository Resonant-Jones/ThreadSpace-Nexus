...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/vector/vector.py`
**Lines:** `806`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/vector/vector.py --strict
```

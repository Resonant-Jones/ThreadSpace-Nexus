# 🧠 Mypy Fix Guide: `vector_store_create_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_store_create_params.py`
**Lines:** `54`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_store_create_params.py --strict
```

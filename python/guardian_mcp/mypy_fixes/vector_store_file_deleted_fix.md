# 🧠 Mypy Fix Guide: `vector_store_file_deleted.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_stores/vector_store_file_deleted.py`
**Lines:** `15`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_stores/vector_store_file_deleted.py --strict
```

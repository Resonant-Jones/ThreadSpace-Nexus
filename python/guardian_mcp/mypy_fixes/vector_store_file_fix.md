# 🧠 Mypy Fix Guide: `vector_store_file.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_stores/vector_store_file.py`
**Lines:** `67`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_stores/vector_store_file.py --strict
```

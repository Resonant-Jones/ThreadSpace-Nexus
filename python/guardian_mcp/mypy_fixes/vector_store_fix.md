# 🧠 Mypy Fix Guide: `vector_store.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_store.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_store.py --strict
```

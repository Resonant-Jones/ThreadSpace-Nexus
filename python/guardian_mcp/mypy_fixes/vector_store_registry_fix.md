# 🧠 Mypy Fix Guide: `vector_store_registry.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/vector_stores/vector_store_registry.py`
**Lines:** `267`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/vector_stores/vector_store_registry.py --strict
```

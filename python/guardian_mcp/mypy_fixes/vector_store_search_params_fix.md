# 🧠 Mypy Fix Guide: `vector_store_search_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_store_search_params.py`
**Lines:** `40`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_store_search_params.py --strict
```

# 🧠 Mypy Fix Guide: `vector_store_search_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_store_search_response.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_store_search_response.py --strict
```

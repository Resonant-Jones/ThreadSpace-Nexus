# 🧠 Mypy Fix Guide: `vector_store_update_params.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/vector_store_update_params.py`
**Lines:** `39`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/vector_store_update_params.py --strict
```

# 🧠 Mypy Fix Guide: `vector_stores.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/vector_stores.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/vector_stores.py --strict
```

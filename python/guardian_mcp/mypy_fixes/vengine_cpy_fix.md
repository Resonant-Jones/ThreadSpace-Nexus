...
**File:** `.venv/lib/python3.13/site-packages/cffi/vengine_cpy.py`
**Lines:** `1084`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/vengine_cpy.py --strict
```

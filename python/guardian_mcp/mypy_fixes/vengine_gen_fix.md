...
**File:** `.venv/lib/python3.13/site-packages/cffi/vengine_gen.py`
**Lines:** `679`
...
```bash
mypy .venv/lib/python3.13/site-packages/cffi/vengine_gen.py --strict
```

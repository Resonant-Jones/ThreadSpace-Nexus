...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/venv.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/venv.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/verbnet.py`
**Lines:** `629`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/verbnet.py --strict
```

# 🧠 Mypy Fix Guide: `verification.py`
...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/verification.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/verification.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/verifpal.py`
**Lines:** `65`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/verifpal.py --strict
```

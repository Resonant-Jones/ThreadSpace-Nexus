...
**File:** `.venv/lib/python3.13/site-packages/huggingface_hub/commands/version.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/huggingface_hub/commands/version.py --strict
```

# 🧠 Mypy Fix Guide: `version_header.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/api_core/version_header.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/api_core/version_header.py --strict
```

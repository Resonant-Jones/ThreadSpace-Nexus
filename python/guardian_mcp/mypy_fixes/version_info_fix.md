# 🧠 Mypy Fix Guide: `version_info.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/client/models/version_info.py`
**Lines:** `453`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/client/models/version_info.py --strict
```

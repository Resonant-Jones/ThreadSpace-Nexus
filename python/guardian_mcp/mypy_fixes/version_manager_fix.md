# 🧠 Mypy Fix Guide: `version_manager.py`
...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/version_manager.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/version_manager.py --strict
```

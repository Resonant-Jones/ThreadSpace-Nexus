# 🧠 Mypy Fix Guide: `vertex_ai_context_caching.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/context_caching/vertex_ai_context_caching.py`
**Lines:** `416`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/context_caching/vertex_ai_context_caching.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/vertex_ai.py`
**Lines:** `611`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/vertex_ai.py --strict
```

# 🧠 Mypy Fix Guide: `vertex_ai_non_gemini.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/vertex_ai_non_gemini.py`
**Lines:** `782`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/vertex_ai_non_gemini.py --strict
```

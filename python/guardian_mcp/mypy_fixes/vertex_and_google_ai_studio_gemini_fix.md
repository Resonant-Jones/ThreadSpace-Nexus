# 🧠 Mypy Fix Guide: `vertex_and_google_ai_studio_gemini.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/gemini/vertex_and_google_ai_studio_gemini.py`
**Lines:** `1996`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/gemini/vertex_and_google_ai_studio_gemini.py --strict
```

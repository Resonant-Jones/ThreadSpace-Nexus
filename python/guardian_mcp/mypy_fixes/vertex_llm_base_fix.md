# 🧠 Mypy Fix Guide: `vertex_llm_base.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/vertex_llm_base.py`
**Lines:** `479`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/vertex_ai/vertex_llm_base.py --strict
```

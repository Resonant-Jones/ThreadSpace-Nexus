# 🧠 Mypy Fix Guide: `vertex_passthrough_logging_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/llm_provider_handlers/vertex_passthrough_logging_handler.py`
**Lines:** `331`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/proxy/pass_through_endpoints/llm_provider_handlers/vertex_passthrough_logging_handler.py --strict
```

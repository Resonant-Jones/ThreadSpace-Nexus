# 🧠 Mypy Fix Guide: `via_app_data.py`
...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/seed/embed/via_app_data/via_app_data.py`
**Lines:** `146`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/seed/embed/via_app_data/via_app_data.py --strict
```

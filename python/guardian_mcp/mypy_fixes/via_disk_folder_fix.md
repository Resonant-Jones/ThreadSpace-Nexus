# 🧠 Mypy Fix Guide: `via_disk_folder.py`
...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/app_data/via_disk_folder.py`
**Lines:** `174`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/app_data/via_disk_folder.py --strict
```

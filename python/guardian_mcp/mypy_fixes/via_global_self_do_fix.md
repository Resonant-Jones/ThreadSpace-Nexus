# 🧠 Mypy Fix Guide: `via_global_self_do.py`
...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/via_global_self_do.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/create/via_global_ref/builtin/via_global_self_do.py --strict
```

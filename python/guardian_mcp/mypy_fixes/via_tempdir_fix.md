...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/app_data/via_tempdir.py`
**Lines:** `34`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/app_data/via_tempdir.py --strict
```

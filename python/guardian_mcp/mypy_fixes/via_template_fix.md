# 🧠 Mypy Fix Guide: `via_template.py`
...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/activation/via_template.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/activation/via_template.py --strict
```

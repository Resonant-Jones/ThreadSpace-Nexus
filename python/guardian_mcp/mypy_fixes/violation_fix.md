...
**File:** `.venv/lib/python3.13/site-packages/flake8/violation.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/flake8/violation.py --strict
```

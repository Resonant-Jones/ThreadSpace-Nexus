...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/vip.py`
**Lines:** `150`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/vip.py --strict
```

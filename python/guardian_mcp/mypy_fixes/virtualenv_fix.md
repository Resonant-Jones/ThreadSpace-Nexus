...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/utils/virtualenv.py`
**Lines:** `104`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/utils/virtualenv.py --strict
```

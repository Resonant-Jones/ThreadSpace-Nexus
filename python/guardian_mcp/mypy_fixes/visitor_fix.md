...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/visitor.py`
**Lines:** `406`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/visitor.py --strict
```

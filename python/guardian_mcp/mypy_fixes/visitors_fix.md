...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/sql/visitors.py`
**Lines:** `1167`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/sql/visitors.py --strict
```

# 🧠 Mypy Fix Guide: `visualization.py`
...
**File:** `.venv/lib/python3.13/site-packages/mpmath/visualization.py`
**Lines:** `313`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/visualization.py --strict
```

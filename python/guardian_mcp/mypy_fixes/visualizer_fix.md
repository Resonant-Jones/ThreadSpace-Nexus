...
**File:** `.venv/lib/python3.13/site-packages/tokenizers/tools/visualizer.py`
**Lines:** `403`
...
```bash
mypy .venv/lib/python3.13/site-packages/tokenizers/tools/visualizer.py --strict
```

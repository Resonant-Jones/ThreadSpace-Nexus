...
**File:** `.venv/lib/python3.13/site-packages/nltk/parse/viterbi.py`
**Lines:** `453`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/parse/viterbi.py --strict
```

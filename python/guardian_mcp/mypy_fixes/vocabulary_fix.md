...
**File:** `.venv/lib/python3.13/site-packages/nltk/lm/vocabulary.py`
**Lines:** `218`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/lm/vocabulary.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/volcengine.py`
**Lines:** `64`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/volcengine.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/mypyc/irbuild/vtable.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/mypyc/irbuild/vtable.py --strict
```

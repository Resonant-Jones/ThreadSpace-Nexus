...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/vyper.py`
**Lines:** `140`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/vyper.py --strict
```

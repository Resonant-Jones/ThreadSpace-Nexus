...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/support/wait.py`
**Lines:** `186`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/support/wait.py --strict
```

# 🧠 Mypy Fix Guide: `wait_for_version_increase.py`
...
**File:** `.venv/lib/python3.13/site-packages/chromadb/test/utils/wait_for_version_increase.py`
**Lines:** `29`
...
```bash
mypy .venv/lib/python3.13/site-packages/chromadb/test/utils/wait_for_version_increase.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_subprocess_platform/waitid.py`
**Lines:** `113`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_subprocess_platform/waitid.py --strict
```

# 🧠 Mypy Fix Guide: `warning_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/_pytest/warning_types.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/warning_types.py --strict
```

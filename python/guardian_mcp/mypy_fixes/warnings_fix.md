...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/testing/warnings.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/testing/warnings.py --strict
```

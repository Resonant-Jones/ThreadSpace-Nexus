...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/watch/watch.py`
**Lines:** `223`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/watch/watch.py --strict
```

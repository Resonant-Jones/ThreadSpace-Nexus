...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/watch/watch_test.py`
**Lines:** `580`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/watch/watch_test.py --strict
```

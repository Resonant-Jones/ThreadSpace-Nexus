# 🧠 Mypy Fix Guide: `watchfilesreload.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/supervisors/watchfilesreload.py`
**Lines:** `85`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/supervisors/watchfilesreload.py --strict
```

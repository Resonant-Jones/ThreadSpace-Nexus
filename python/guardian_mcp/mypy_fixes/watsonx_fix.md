...
**File:** `.venv/lib/python3.13/site-packages/litellm/types/llms/watsonx.py`
**Lines:** `33`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/types/llms/watsonx.py --strict
```

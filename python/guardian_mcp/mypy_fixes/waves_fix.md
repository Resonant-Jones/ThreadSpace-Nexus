...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/optics/waves.py`
**Lines:** `340`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/optics/waves.py --strict
```

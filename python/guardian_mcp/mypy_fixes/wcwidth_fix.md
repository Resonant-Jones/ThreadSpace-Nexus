...
**File:** `.venv/lib/python3.13/site-packages/_pytest/_io/wcwidth.py`
**Lines:** `57`
...
```bash
mypy .venv/lib/python3.13/site-packages/_pytest/_io/wcwidth.py --strict
```

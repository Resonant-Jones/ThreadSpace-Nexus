# 🧠 Mypy Fix Guide: `weakref_finalize.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_vendor/urllib3/packages/backports/weakref_finalize.py`
**Lines:** `155`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_vendor/urllib3/packages/backports/weakref_finalize.py --strict
```

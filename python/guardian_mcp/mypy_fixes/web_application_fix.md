# 🧠 Mypy Fix Guide: `web_application.py`
...
**File:** `.venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/web_application.py`
**Lines:** `222`
...
```bash
mypy .venv/lib/python3.13/site-packages/oauthlib/oauth2/rfc6749/clients/web_application.py --strict
```

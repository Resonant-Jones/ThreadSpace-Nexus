...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/web_authn.py`
**Lines:** `579`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/devtools/v137/web_authn.py --strict
```

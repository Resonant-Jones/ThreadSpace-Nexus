...
**File:** `.venv/lib/python3.13/site-packages/crawl4ai/legacy/web_crawler.py`
**Lines:** `294`
...
```bash
mypy .venv/lib/python3.13/site-packages/crawl4ai/legacy/web_crawler.py --strict
```

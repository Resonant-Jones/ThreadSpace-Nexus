# 🧠 Mypy Fix Guide: `web_exceptions.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_exceptions.py`
**Lines:** `452`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_exceptions.py --strict
```

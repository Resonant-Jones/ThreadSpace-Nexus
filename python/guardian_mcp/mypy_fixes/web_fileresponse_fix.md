# 🧠 Mypy Fix Guide: `web_fileresponse.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_fileresponse.py`
**Lines:** `418`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_fileresponse.py --strict
```

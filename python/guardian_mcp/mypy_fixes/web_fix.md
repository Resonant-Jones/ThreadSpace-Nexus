...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/web.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/web.py --strict
```

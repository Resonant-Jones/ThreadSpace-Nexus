# 🧠 Mypy Fix Guide: `web_middlewares.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_middlewares.py`
**Lines:** `121`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_middlewares.py --strict
```

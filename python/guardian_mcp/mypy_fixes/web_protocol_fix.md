# 🧠 Mypy Fix Guide: `web_protocol.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_protocol.py`
**Lines:** `792`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_protocol.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_request.py`
**Lines:** `916`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_request.py --strict
```

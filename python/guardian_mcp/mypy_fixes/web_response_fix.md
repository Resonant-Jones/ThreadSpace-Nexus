# 🧠 Mypy Fix Guide: `web_response.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_response.py`
**Lines:** `856`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_response.py --strict
```

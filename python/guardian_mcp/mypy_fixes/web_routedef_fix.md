# 🧠 Mypy Fix Guide: `web_routedef.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_routedef.py`
**Lines:** `214`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_routedef.py --strict
```

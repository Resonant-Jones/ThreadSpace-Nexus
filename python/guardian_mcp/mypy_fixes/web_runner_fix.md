...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_runner.py`
**Lines:** `399`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_runner.py --strict
```

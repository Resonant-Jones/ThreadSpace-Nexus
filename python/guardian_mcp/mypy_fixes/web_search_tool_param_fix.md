# 🧠 Mypy Fix Guide: `web_search_tool_param.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/responses/web_search_tool_param.py`
**Lines:** `49`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/responses/web_search_tool_param.py --strict
```

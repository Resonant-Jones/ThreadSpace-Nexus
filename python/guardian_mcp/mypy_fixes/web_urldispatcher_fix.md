# 🧠 Mypy Fix Guide: `web_urldispatcher.py`
...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/web_urldispatcher.py`
**Lines:** `1303`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/web_urldispatcher.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/webassembly.py`
**Lines:** `119`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/webassembly.py --strict
```

# 🧠 Mypy Fix Guide: `webauthn_handler_factory.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/webauthn_handler_factory.py`
**Lines:** `16`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/webauthn_handler_factory.py --strict
```

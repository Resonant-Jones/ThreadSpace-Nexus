# 🧠 Mypy Fix Guide: `webauthn_handler.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/webauthn_handler.py`
**Lines:** `82`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/webauthn_handler.py --strict
```

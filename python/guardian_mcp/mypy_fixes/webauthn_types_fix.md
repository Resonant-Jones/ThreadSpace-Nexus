# 🧠 Mypy Fix Guide: `webauthn_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/oauth2/webauthn_types.py`
**Lines:** `156`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/oauth2/webauthn_types.py --strict
```

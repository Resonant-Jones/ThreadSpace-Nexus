...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/webdriver.py`
**Lines:** `1636`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/webdriver.py --strict
```

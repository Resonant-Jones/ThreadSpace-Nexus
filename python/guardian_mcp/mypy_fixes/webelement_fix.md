...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/webelement.py`
**Lines:** `654`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/webelement.py --strict
```

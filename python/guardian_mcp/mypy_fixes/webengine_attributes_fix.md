# 🧠 Mypy Fix Guide: `webengine_attributes.py`
...
**File:** `.venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/webengine_attributes.py`
**Lines:** `30`
...
```bash
mypy .venv/lib/python3.13/site-packages/opentelemetry/semconv/_incubating/attributes/webengine_attributes.py --strict
```

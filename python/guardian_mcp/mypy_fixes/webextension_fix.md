# 🧠 Mypy Fix Guide: `webextension.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/webextension.py`
**Lines:** `74`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/bidi/webextension.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/webhdfs.py`
**Lines:** `485`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/webhdfs.py --strict
```

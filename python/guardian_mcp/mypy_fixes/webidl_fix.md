...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/webidl.py`
**Lines:** `298`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/webidl.py --strict
```

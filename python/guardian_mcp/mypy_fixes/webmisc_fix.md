...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/webmisc.py`
**Lines:** `1006`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/webmisc.py --strict
```

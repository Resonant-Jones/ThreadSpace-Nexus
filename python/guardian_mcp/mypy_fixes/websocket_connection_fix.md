# 🧠 Mypy Fix Guide: `websocket_connection.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/remote/websocket_connection.py`
**Lines:** `154`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/remote/websocket_connection.py --strict
```

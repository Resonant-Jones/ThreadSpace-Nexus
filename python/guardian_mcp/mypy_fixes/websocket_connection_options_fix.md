# 🧠 Mypy Fix Guide: `websocket_connection_options.py`
...
**File:** `.venv/lib/python3.13/site-packages/openai/types/websocket_connection_options.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/openai/types/websocket_connection_options.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fastapi/websockets.py`
**Lines:** `3`
...
```bash
mypy .venv/lib/python3.13/site-packages/fastapi/websockets.py --strict
```

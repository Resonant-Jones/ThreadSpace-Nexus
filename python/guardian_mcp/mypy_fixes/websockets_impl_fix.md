# 🧠 Mypy Fix Guide: `websockets_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/protocols/websockets/websockets_impl.py`
**Lines:** `387`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/protocols/websockets/websockets_impl.py --strict
```

# 🧠 Mypy Fix Guide: `weights_biases.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/integrations/weights_biases.py`
**Lines:** `217`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/integrations/weights_biases.py --strict
```

# 🧠 Mypy Fix Guide: `well_known_types.py`
...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/well_known_types.py`
**Lines:** `678`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/well_known_types.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/liealgebras/weyl_group.py`
**Lines:** `403`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/liealgebras/weyl_group.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/wgsl.py`
**Lines:** `406`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/wgsl.py --strict
```

# 🧠 Mypy Fix Guide: `wheel_actions.py`
...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/wheel_actions.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/wheel_actions.py --strict
```

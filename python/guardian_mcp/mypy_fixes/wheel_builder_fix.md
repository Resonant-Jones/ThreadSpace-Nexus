# 🧠 Mypy Fix Guide: `wheel_builder.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/wheel_builder.py`
**Lines:** `332`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/wheel_builder.py --strict
```

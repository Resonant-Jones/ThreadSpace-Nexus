...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/operations/build/wheel.py`
**Lines:** `37`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/operations/build/wheel.py --strict
```

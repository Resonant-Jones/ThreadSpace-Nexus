...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/wheel_input.py`
**Lines:** `77`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/actions/wheel_input.py --strict
```

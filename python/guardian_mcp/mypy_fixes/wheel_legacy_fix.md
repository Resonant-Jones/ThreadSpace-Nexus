# 🧠 Mypy Fix Guide: `wheel_legacy.py`
...
**File:** `.venv/lib/python3.13/site-packages/pip/_internal/operations/build/wheel_legacy.py`
**Lines:** `118`
...
```bash
mypy .venv/lib/python3.13/site-packages/pip/_internal/operations/build/wheel_legacy.py --strict
```

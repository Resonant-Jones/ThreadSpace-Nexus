...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_vendor/wheel/wheelfile.py`
**Lines:** `227`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_vendor/wheel/wheelfile.py --strict
```

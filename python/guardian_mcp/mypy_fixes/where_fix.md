...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/where.py`
**Lines:** `87`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/quantization/operators/where.py --strict
```

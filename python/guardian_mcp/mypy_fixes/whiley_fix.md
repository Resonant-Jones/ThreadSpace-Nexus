...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/whiley.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/whiley.py --strict
```

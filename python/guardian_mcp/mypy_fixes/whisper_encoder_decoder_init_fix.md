# 🧠 Mypy Fix Guide: `whisper_encoder_decoder_init.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/whisper_encoder_decoder_init.py`
**Lines:** `371`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/whisper_encoder_decoder_init.py --strict
```

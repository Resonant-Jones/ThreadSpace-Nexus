# 🧠 Mypy Fix Guide: `whisper_inputs.py`
...
**File:** `.venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/whisper_inputs.py`
**Lines:** `380`
...
```bash
mypy .venv/lib/python3.13/site-packages/onnxruntime/transformers/models/whisper/whisper_inputs.py --strict
```

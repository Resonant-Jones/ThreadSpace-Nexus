# 🧠 Mypy Fix Guide: `whisper_transformation.py`
...
**File:** `.venv/lib/python3.13/site-packages/litellm/llms/openai/transcriptions/whisper_transformation.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/litellm/llms/openai/transcriptions/whisper_transformation.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sympy/physics/wigner.py`
**Lines:** `1213`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/physics/wigner.py --strict
```

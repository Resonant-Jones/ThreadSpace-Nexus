...
**File:** `.venv/lib/python3.13/site-packages/selenium/webdriver/common/window.py`
**Lines:** `24`
...
```bash
mypy .venv/lib/python3.13/site-packages/selenium/webdriver/common/window.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/trio/_subprocess_platform/windows.py`
**Lines:** `11`
...
```bash
mypy .venv/lib/python3.13/site-packages/trio/_subprocess_platform/windows.py --strict
```

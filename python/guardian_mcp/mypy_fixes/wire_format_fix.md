...
**File:** `.venv/lib/python3.13/site-packages/google/protobuf/internal/wire_format.py`
**Lines:** `245`
...
```bash
mypy .venv/lib/python3.13/site-packages/google/protobuf/internal/wire_format.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/nltk/misc/wordfinder.py`
**Lines:** `139`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/misc/wordfinder.py --strict
```

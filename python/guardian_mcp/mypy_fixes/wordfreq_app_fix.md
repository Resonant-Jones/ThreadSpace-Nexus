# 🧠 Mypy Fix Guide: `wordfreq_app.py`
...
**File:** `.venv/lib/python3.13/site-packages/nltk/app/wordfreq_app.py`
**Lines:** `36`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/app/wordfreq_app.py --strict
```

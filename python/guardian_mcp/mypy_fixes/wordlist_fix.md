...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/wordlist.py`
**Lines:** `166`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/wordlist.py --strict
```

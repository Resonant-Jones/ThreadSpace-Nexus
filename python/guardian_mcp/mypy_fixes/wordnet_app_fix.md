...
**File:** `.venv/lib/python3.13/site-packages/nltk/app/wordnet_app.py`
**Lines:** `1006`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/app/wordnet_app.py --strict
```

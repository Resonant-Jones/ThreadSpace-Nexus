...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/wordnet.py`
**Lines:** `2488`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/wordnet.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/wowtoc.py`
**Lines:** `120`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/wowtoc.py --strict
```

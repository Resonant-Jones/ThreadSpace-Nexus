...
**File:** `.venv/lib/python3.13/site-packages/sympy/assumptions/wrapper.py`
**Lines:** `164`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/assumptions/wrapper.py --strict
```

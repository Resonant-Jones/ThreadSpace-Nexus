...
**File:** `.venv/lib/python3.13/site-packages/proto/marshal/rules/wrappers.py`
**Lines:** `84`
...
```bash
mypy .venv/lib/python3.13/site-packages/proto/marshal/rules/wrappers.py --strict
```

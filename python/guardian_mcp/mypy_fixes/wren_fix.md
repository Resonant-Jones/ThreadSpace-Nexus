...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/wren.py`
**Lines:** `98`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/wren.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/sqlalchemy/orm/writeonly.py`
**Lines:** `678`
...
```bash
mypy .venv/lib/python3.13/site-packages/sqlalchemy/orm/writeonly.py --strict
```

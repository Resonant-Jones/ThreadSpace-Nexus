...
**File:** `.venv/lib/python3.13/site-packages/aiohttp/_websocket/writer.py`
**Lines:** `178`
...
```bash
mypy .venv/lib/python3.13/site-packages/aiohttp/_websocket/writer.py --strict
```

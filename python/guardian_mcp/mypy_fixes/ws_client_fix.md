...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/stream/ws_client.py`
**Lines:** `576`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/stream/ws_client.py --strict
```

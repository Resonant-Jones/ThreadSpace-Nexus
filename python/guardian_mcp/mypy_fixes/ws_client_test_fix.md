# 🧠 Mypy Fix Guide: `ws_client_test.py`
...
**File:** `.venv/lib/python3.13/site-packages/kubernetes/stream/ws_client_test.py`
**Lines:** `76`
...
```bash
mypy .venv/lib/python3.13/site-packages/kubernetes/stream/ws_client_test.py --strict
```

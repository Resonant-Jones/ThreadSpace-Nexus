...
**File:** `.venv/lib/python3.13/site-packages/starlette/middleware/wsgi.py`
**Lines:** `152`
...
```bash
mypy .venv/lib/python3.13/site-packages/starlette/middleware/wsgi.py --strict
```

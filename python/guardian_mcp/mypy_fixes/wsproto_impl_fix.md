# 🧠 Mypy Fix Guide: `wsproto_impl.py`
...
**File:** `.venv/lib/python3.13/site-packages/uvicorn/protocols/websockets/wsproto_impl.py`
**Lines:** `377`
...
```bash
mypy .venv/lib/python3.13/site-packages/uvicorn/protocols/websockets/wsproto_impl.py --strict
```

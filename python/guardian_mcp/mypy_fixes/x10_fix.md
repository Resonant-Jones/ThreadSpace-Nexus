...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/x10.py`
**Lines:** `66`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/x10.py --strict
```

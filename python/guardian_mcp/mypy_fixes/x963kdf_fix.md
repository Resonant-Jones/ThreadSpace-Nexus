...
**File:** `.venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/x963kdf.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/cryptography/hazmat/primitives/kdf/x963kdf.py --strict
```

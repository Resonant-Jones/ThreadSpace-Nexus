...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/xcode.py`
**Lines:** `53`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/xcode.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pandas/io/formats/xml.py`
**Lines:** `560`
...
```bash
mypy .venv/lib/python3.13/site-packages/pandas/io/formats/xml.py --strict
```

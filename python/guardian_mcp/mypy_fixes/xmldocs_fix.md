...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/xmldocs.py`
**Lines:** `397`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/xmldocs.py --strict
```

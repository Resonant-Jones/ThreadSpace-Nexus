...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/xorg.py`
**Lines:** `38`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/xorg.py --strict
```

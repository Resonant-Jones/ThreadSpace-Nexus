...
**File:** `.venv/lib/python3.13/site-packages/pycparser/yacctab.py`
**Lines:** `369`
...
```bash
mypy .venv/lib/python3.13/site-packages/pycparser/yacctab.py --strict
```

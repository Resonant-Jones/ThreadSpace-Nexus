...
**File:** `.venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/yaml.py`
**Lines:** `61`
...
```bash
mypy .venv/lib/python3.13/site-packages/pydantic_settings/sources/providers/yaml.py --strict
```

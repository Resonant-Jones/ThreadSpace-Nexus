# 🧠 Mypy Fix Guide: `yaml_rewrite.py`
...
**File:** `.venv/lib/python3.13/site-packages/pre_commit/yaml_rewrite.py`
**Lines:** `52`
...
```bash
mypy .venv/lib/python3.13/site-packages/pre_commit/yaml_rewrite.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/yang.py`
**Lines:** `103`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/yang.py --strict
```

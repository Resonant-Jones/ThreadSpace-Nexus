...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/yara.py`
**Lines:** `69`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/yara.py --strict
```

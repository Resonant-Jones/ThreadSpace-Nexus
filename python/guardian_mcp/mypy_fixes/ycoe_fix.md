...
**File:** `.venv/lib/python3.13/site-packages/nltk/corpus/reader/ycoe.py`
**Lines:** `256`
...
```bash
mypy .venv/lib/python3.13/site-packages/nltk/corpus/reader/ycoe.py --strict
```

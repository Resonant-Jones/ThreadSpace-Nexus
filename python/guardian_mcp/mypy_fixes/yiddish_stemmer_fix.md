# 🧠 Mypy Fix Guide: `yiddish_stemmer.py`
...
**File:** `.venv/lib/python3.13/site-packages/snowballstemmer/yiddish_stemmer.py`
**Lines:** `855`
...
```bash
mypy .venv/lib/python3.13/site-packages/snowballstemmer/yiddish_stemmer.py --strict
```

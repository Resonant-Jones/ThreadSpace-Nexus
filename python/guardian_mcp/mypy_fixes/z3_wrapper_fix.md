...
**File:** `.venv/lib/python3.13/site-packages/sympy/logic/algorithms/z3_wrapper.py`
**Lines:** `115`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/logic/algorithms/z3_wrapper.py --strict
```

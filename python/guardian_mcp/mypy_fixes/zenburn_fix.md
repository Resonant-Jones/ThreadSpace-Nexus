...
**File:** `.venv/lib/python3.13/site-packages/pygments/styles/zenburn.py`
**Lines:** `83`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/styles/zenburn.py --strict
```

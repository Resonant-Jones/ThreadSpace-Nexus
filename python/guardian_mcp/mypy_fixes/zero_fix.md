...
**File:** `.venv/lib/python3.13/site-packages/markdown_it/presets/zero.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/markdown_it/presets/zero.py --strict
```

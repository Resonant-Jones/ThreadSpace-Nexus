...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/zeta.py`
**Lines:** `1154`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/zeta.py --strict
```

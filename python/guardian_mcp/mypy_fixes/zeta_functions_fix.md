# 🧠 Mypy Fix Guide: `zeta_functions.py`
...
**File:** `.venv/lib/python3.13/site-packages/sympy/functions/special/zeta_functions.py`
**Lines:** `786`
...
```bash
mypy .venv/lib/python3.13/site-packages/sympy/functions/special/zeta_functions.py --strict
```

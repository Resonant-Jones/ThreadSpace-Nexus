...
**File:** `.venv/lib/python3.13/site-packages/mpmath/functions/zetazeros.py`
**Lines:** `1018`
...
```bash
mypy .venv/lib/python3.13/site-packages/mpmath/functions/zetazeros.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/pygments/lexers/zig.py`
**Lines:** `125`
...
```bash
mypy .venv/lib/python3.13/site-packages/pygments/lexers/zig.py --strict
```

...
**File:** `.venv/lib/python3.13/site-packages/fsspec/implementations/zip.py`
**Lines:** `177`
...
```bash
mypy .venv/lib/python3.13/site-packages/fsspec/implementations/zip.py --strict
```

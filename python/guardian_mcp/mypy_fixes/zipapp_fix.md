...
**File:** `.venv/lib/python3.13/site-packages/virtualenv/util/zipapp.py`
**Lines:** `43`
...
```bash
mypy .venv/lib/python3.13/site-packages/virtualenv/util/zipapp.py --strict
```

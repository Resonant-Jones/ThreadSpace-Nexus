...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/compilers/C/zos.py`
**Lines:** `230`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/compilers/C/zos.py --strict
```

# 🧠 Mypy Fix Guide: `zosccompiler.py`
...
**File:** `.venv/lib/python3.13/site-packages/setuptools/_distutils/zosccompiler.py`
**Lines:** `3`
...
```bash
mypy .venv/lib/python3.13/site-packages/setuptools/_distutils/zosccompiler.py --strict
```
